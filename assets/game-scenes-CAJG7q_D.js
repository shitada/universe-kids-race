const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-D0q6IT18.js","assets/game-core-vbmm6xSm.js","assets/three-D-dORC6w.js"])))=>i.map(i=>d[i]);
import{g as Ct,T as I,a as nt,L as Bt,b as Ot,_ as it,c as L,d as X,P as N,u as It,C as Rt,S as kt,e as Dt,B as Lt,f as Ht,h as _t,A as Gt,i as St,j as Ft,k as Nt,l as tt,m as zt}from"./game-core-vbmm6xSm.js";import{h as ot,f as rt,d as lt,g as ht,G as V,l as $t,M as jt,m as qt,a as x,S as P,k as gt,R as yt,n as B,o as ct,p as W,c as ut,P as dt,V as xt,q as Ut}from"./three-D-dORC6w.js";class mt{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const e=document.getElementById("ui-overlay");if(!e)return;const s=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
