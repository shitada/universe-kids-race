import{ab as R,ac as k,ad as B,e as T,h as O,P as F,ae as G,af as Z,Z as j,ag as V}from"./game-core-LV5LGXDP.js";import{v as X,P as Y,u as W,w as U}from"./three-BsQe5WE2.js";import{a as C,c as $}from"./game-scenes-JKCPjaRv.js";const M=120,q=1.5,J=.015;function K(A={}){const e=A.createRenderer??R,i=A.createPreviewMesh??k,t=A.raf??requestAnimationFrame,n=A.caf??cancelAnimationFrame;let a=!1,s=!1,l=null,d=null,r=null,c=null,m=null,u=null,b=null,h=null,o=!1;const p=()=>l||(l=document.createElement("canvas"),l.setAttribute("data-companion-preview-canvas",""),l.style.cssText=`
      width: 100%;
      height: 100%;
      display: block;
    ...
    `,i.appendChild(t);const n=document.createElement("div");n.style.cssText=`
      ...
      width: 100%;
      min-width: 0;
    `;for(const a of Z){const s=this.discoveredConstellations.includes(a.stageNumber),l=document.createElement("div");l.setAttribute("data-constellation-card",""),l.setAttribute("data-stage",String(a.stageNumber)),l.style.cssText=`
    ...
    `,r.appendChild(m),this.getDetailPreviewController().show(e,m),s.appendChild(r);const u=document.createElement("div");u.textContent=e.trivia,u.style.cssText=`
      ...
      text-align: center;
    `,s.appendChild(u);const b=this.bestStageStars[e.stageNumber]??0,h=$(e.stageNumber,b,{label:"メダル",hint:b>0?`⭐ ベスト ${b}`:void 0,size:"hero",scope:"encyclopedia-detail"});h.style.marginTop="0.2rem",s.appendChild(h);const o=j(e.stageNumber);if(o){const f=document.createElement("div"),x=this.discoveredConstellations.includes(e.stageNumber);f.setAttribute("data-detail-constellation",""),f.style.cssText=`
        margin-top: 0.45rem;
