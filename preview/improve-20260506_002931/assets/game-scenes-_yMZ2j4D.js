const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-Dvc1aV8V.js","assets/game-core-rJZxCOOc.js","assets/three-BsQe5WE2.js"])))=>i.map(i=>d[i]);
import{D as mt,i as A,g as Ct,a as Rt,S as J,T as H,b as K,c as ee,L as fe,d as ye,_ as Bt,e as N,f as q,h as j,s as ie,j as pt,k as se,l as be,P as st,u as ne,C as ve,m as Se,n as Ee,B as xe,o as Ce,M as we,p as Te,q as Ae,r as Me,t as Pe,v as Be,w as ke,x as Re,y as Oe,z as Ie,A as De,E as Le,F as Ge,G as ze,H as He,I as Ne,J as ae,W as _e,K as $e,N as Fe,O as Ve,Q as oe,R as Ue,U as Ot,V as je,X as We,Y as Ze,Z as Ye,$ as qe,a0 as Xe,a1 as Qe,a2 as $t,a3 as re,a4 as Ke,a5 as gt,a6 as Z,a7 as Je,a8 as wt,a9 as ti,aa as ei,ab as ii,ac as Tt,ad as si,ae as ni,af as ai,ag as oi,ah as ri}from"./game-core-rJZxCOOc.js";import{n as It,l as Dt,j as Lt,m as Gt,G as nt,r as li,a as ci,s as hi,M as D,h as $,C as Ft,B as Vt,D as Ut,R as jt,t as _,u as St,v as ct,i as ht,P as Et,V as W,w as le,x as ui}from"./three-BsQe5WE2.js";class zt{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const e=document.getElementById("ui-overlay");if(!e)return;const i=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
    ...
    `,o.addEventListener("pointerdown",c=>{c.stopPropagation(),t()}),s.appendChild(o),this.injectAnimations(),this.overlayEl.appendChild(s),e.appendChild(this.overlayEl)}hide(){this.overlayEl&&(this.overlayEl.remove(),this.overlayEl=null)}createCard(t,e,i,s,n){const a=document.createElement("div");a.setAttribute("data-tutorial-card",""),a.style.cssText=`
    ...
    `,a.appendChild(o),a.appendChild(c),a.appendChild(u),a}isCompactHeight(){return window.innerHeight<=zt.COMPACT_HEIGHT_THRESHOLD}injectAnimations(){if(document.getElementById("tutorial-animations"))return;const t=document.createElement("style");t.id="tutorial-animations",t.textContent=`
      @keyframes swipe {
    ...
    `,document.head.appendChild(t)}}class di{overlayEl=null;activePressCleanups=new Set;show(t,e){if(this.overlayEl)return;const i=document.getElementById("ui-overlay");if(!i)return;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-title-reset-confirm-overlay",""),this.overlayEl.setAttribute("role","dialog"),this.overlayEl.setAttribute("aria-modal","true"),this.overlayEl.setAttribute("aria-label","さいしょからに もどしますか"),this.overlayEl.style.cssText=`
      ...
      padding: 1.5rem;
      background: rgba(0, 0, 32, 0.92);
    `;let s=!1;const n=()=>{s||(s=!0,this.hide(),e())},a=()=>{s||(s=!0,this.hide(),t())};this.overlayEl.addEventListener("pointerdown",d=>{d.target===this.overlayEl&&n()});const o=document.createElement("div");o.setAttribute("data-title-reset-confirm-card",""),o.style.cssText=`
    ...
    `,b=(d,S)=>{let x=!1,T=!1;const y=()=>{B(!0)},p=()=>{d.style.transform="scale(0.92)"},M=()=>{d.style.transform="scale(1)"},B=(h=!1)=>{x=!1,T=h,M(),this.activePressCleanups.delete(y),document.removeEventListener("pointerup",C,!0),document.removeEventListener("pointercancel",w,!0)},C=h=>{const E=h.target===d||h.target instanceof Node&&d.contains(h.target),P=x&&E;B(!E),P&&S()},w=()=>{B(!0)};d.addEventListener("pointerdown",h=>{h.stopPropagation(),x=!0,T=!1,p(),this.activePressCleanups.add(y),document.addEventListener("pointerup",C,!0),document.addEventListener("pointercancel",w,!0)}),d.addEventListener("pointerenter",()=>{x&&p()}),d.addEventListener("pointerleave",()=>{x&&M()}),d.addEventListener("pointercancel",()=>B(!0)),d.addEventListener("click",h=>{if(h.stopPropagation(),T){T=!1;return}x||S()})},g=document.createElement("button");g.setAttribute("data-title-reset-cancel",""),g.textContent="やめる",g.style.cssText=f,g.style.background="rgba(255, 255, 255, 0.18)",g.style.color="#ffffff",b(g,n),m.appendChild(g);const r=document.createElement("button");r.setAttribute("data-title-reset-confirm",""),r.textContent="うん！ さいしょから",r.style.cssText=f,r.style.background="linear-gradient(135deg, #FF9F68, #FFE66D)",r.style.color="#3b1f00",b(r,a),m.appendChild(r),i.appendChild(this.overlayEl)}hide(){if(!this.overlayEl)return;const t=Array.from(this.activePressCleanups);this.activePressCleanups.clear();for(const e of t)e();this.overlayEl.remove(),this.overlayEl=null}}function Ht(l){const t=l.topRem??.8,e=window.innerHeight<=500,i=document.createElement("button");let s=l.initialMuted;const n=()=>{i.textContent=s?"🔇":"🔊",i.setAttribute("aria-label",s?"サウンド オフ":"サウンド オン")};i.setAttribute("data-mute-button",""),i.style.position="absolute",i.style.top=`${t}rem`,i.style.right="1rem",i.style.fontSize=e?"clamp(1.1rem, 3.5vmin, 1.4rem)":"clamp(1.4rem, 4vmin, 1.8rem)",i.style.background="rgba(255, 255, 255, 0.15)",i.style.border="none",i.style.borderRadius="50%",i.style.width=e?"2.4rem":"3rem",i.style.height=e?"2.4rem":"3rem",i.style.display="flex",i.style.alignItems="center",i.style.justifyContent="center",i.style.cursor="pointer",i.style.pointerEvents="auto",i.style.touchAction="manipulation",i.style.transform="scale(1)",i.style.transition="transform 0.08s ease-out",n();const a=()=>{i.style.transform="scale(1)"};return i.addEventListener("pointerdown",o=>{o.stopPropagation(),i.style.transform="scale(0.9)",l.onToggle()}),i.addEventListener("pointerup",a),i.addEventListener("pointercancel",a),i.addEventListener("pointerleave",a),l.container.appendChild(i),{element:i,setMuted(o){s=o,n()},remove(){i.remove()}}}const ft=[{value:0,labelKey:"colorSettings.audio.volume.quiet"},{value:25,labelKey:"colorSettings.audio.volume.small"},{value:50,labelKey:"colorSettings.audio.volume.normal"},{value:75,labelKey:"colorSettings.audio.volume.loud"},{value:100,labelKey:"colorSettings.audio.volume.max"}],Wt=[{value:"color-only",labelKey:"colorSettings.colorVision.option.colorOnly",icon:"🎨"},{value:"color-and-marks",labelKey:"colorSettings.colorVision.option.colorAndMarks",icon:"★"}],Zt=[{value:"strong",labelKey:"colorSettings.vibration.option.strong"},{value:"medium",labelKey:"colorSettings.vibration.option.medium"},{value:"weak",labelKey:"colorSettings.vibration.option.weak"},{value:"off",labelKey:"colorSettings.vibration.option.off"}],Yt=[{value:"ja",labelKey:"colorSettings.language.option.ja",icon:"🇯🇵"},{value:"en",labelKey:"colorSettings.language.option.en",icon:"🇬🇧"}],qt={strong:{shortLabel:"colorSettings.motion.option.strong.shortLabel",description:"colorSettings.motion.option.strong.description"},medium:{shortLabel:"colorSettings.motion.option.medium.shortLabel",description:"colorSettings.motion.option.medium.description"},gentle:{shortLabel:"colorSettings.motion.option.gentle.shortLabel",description:"colorSettings.motion.option.gentle.description"},minimal:{shortLabel:"colorSettings.motion.option.minimal.shortLabel",description:"colorSettings.motion.option.minimal.description"}};function Xt(l){const t=ft.find(e=>e.value===l)??ft[2];return A.t(t.labelKey)}class mi{overlay=null;toggleButton=null;descriptionEl=null;highContrast=!1;colorVisionSupportMode="color-only";bgmVolume=100;sfxVolume=100;vibrationIntensity="medium";motionSensitivity="strong";restReminderEnabled=!0;language=mt;bgmVolumeDescriptionEl=null;sfxVolumeDescriptionEl=null;bgmVolumeSlider=null;sfxVolumeSlider=null;colorVisionDescriptionEl=null;colorVisionButtons=new Map;vibrationDescriptionEl=null;vibrationButtons=new Map;motionDescriptionEl=null;motionButtons=new Map;restReminderDescriptionEl=null;restReminderToggleButton=null;motionPreviewEl=null;motionPreviewTokenEl=null;motionPreviewCaptionEl=null;languageDescriptionEl=null;languageButtons=new Map;motionPreviewTimeoutId=null;motionPreviewFrameId=null;onToggle=null;onColorVisionSupportModeChange=null;onBGMVolumeChange=null;onSFXVolumeChange=null;onVibrationIntensityChange=null;onMotionSensitivityChange=null;onRestReminderToggle=null;onLanguageChange=null;languageUnsubscribe=null;show(t){const e=document.getElementById("ui-overlay");if(e){if(this.highContrast=t.initialHighContrast,this.colorVisionSupportMode=t.initialColorVisionSupportMode,this.bgmVolume=t.initialBGMVolume,this.sfxVolume=t.initialSFXVolume,this.vibrationIntensity=t.initialVibrationIntensity,this.motionSensitivity=t.initialMotionSensitivity,this.restReminderEnabled=t.initialRestReminderEnabled,this.language=t.initialLanguage,this.onToggle=t.onToggle,this.onColorVisionSupportModeChange=t.onColorVisionSupportModeChange,this.onBGMVolumeChange=t.onBGMVolumeChange,this.onSFXVolumeChange=t.onSFXVolumeChange,this.onVibrationIntensityChange=t.onVibrationIntensityChange,this.onMotionSensitivityChange=t.onMotionSensitivityChange,this.onRestReminderToggle=t.onRestReminderToggle,this.onLanguageChange=t.onLanguageChange,A.setLanguage(this.language,{notify:!1}),this.languageUnsubscribe?.(),this.languageUnsubscribe=A.subscribe(i=>{this.language=i,this.render()}),!this.overlay){const i=window.innerHeight<=760;this.overlay=document.createElement("div"),this.overlay.setAttribute("data-color-accessibility-settings",""),this.overlay.style.cssText=`
      ...
      `;for(const h of Yt){const E=document.createElement("button");E.setAttribute("data-language-button",h.value),E.style.cssText=`
          min-height: 3.25rem;
        ...
        gap: 0.65rem;
        margin-bottom: 0.95rem;
      `;for(const h of Wt){const E=document.createElement("button");E.setAttribute("data-color-vision-mode-button",h.value),E.style.cssText=`
          min-height: 3.25rem;
          padding: 0.8rem 0.9rem;
          border-radius: 1rem;
          border: 2px solid rgba(255, 255, 255, 0.4);
          ...
          touch-action: manipulation;
          transition: transform 0.08s ease-out, border-color 0.12s ease-out, background 0.12s ease-out;
        `,E.addEventListener("click",()=>{this.colorVisionSupportMode=h.value,this.render(),this.onColorVisionSupportModeChange?.(h.value)}),this.colorVisionButtons.set(h.value,E),d.appendChild(E)}const S=document.createElement("h3");S.setAttribute("data-vibration-title",""),S.style.cssText="margin: 0.9rem 0 0.45rem; font-size: clamp(1rem, 3.8vmin, 1.2rem);",this.vibrationDescriptionEl=document.createElement("p"),this.vibrationDescriptionEl.style.cssText="margin: 0 0 0.8rem; font-size: clamp(0.9rem, 3.2vmin, 1rem); line-height: 1.5;";const x=document.createElement("div");x.setAttribute("data-vibration-intensity-group",""),x.style.cssText=`
        display: grid;
        grid-template-columns: repeat(2, minmax(0, 1fr));
        gap: 0.65rem;
        margin-bottom: 0.95rem;
      `;for(const h of Zt){const E=document.createElement("button");E.setAttribute("data-vibration-intensity-button",h.value),E.style.cssText=`
          min-height: 3.25rem;
          padding: 0.8rem 0.9rem;
          border-radius: 1rem;
          border: 2px solid rgba(255, 255, 255, 0.4);
          ...
          touch-action: manipulation;
          transition: transform 0.08s ease-out, border-color 0.12s ease-out, background 0.12s ease-out;
        `,E.addEventListener("click",()=>{this.vibrationIntensity=h.value,this.render(),this.onVibrationIntensityChange?.(h.value)}),this.vibrationButtons.set(h.value,E),x.appendChild(E)}const T=document.createElement("h3");T.setAttribute("data-motion-title",""),T.style.cssText="margin: 1.1rem 0 0.45rem; font-size: clamp(1rem, 3.8vmin, 1.2rem);";const y=document.createElement("p");y.setAttribute("data-motion-hint",""),y.style.cssText="margin: 0 0 0.5rem; font-size: clamp(0.9rem, 3.2vmin, 1rem); line-height: 1.5;",this.motionDescriptionEl=document.createElement("p"),this.motionDescriptionEl.style.cssText="margin: 0 0 0.8rem; font-size: clamp(0.9rem, 3.2vmin, 1rem); line-height: 1.5;";const p=document.createElement("div");p.setAttribute("data-motion-sensitivity-group",""),p.style.cssText=`
        display: grid;
        grid-template-columns: repeat(2, minmax(0, 1fr));
        gap: 0.65rem;
        margin-bottom: 0.95rem;
      `;const M=["strong","medium","gentle","minimal"];for(const h of M){const E=Ct(h),P=document.createElement("button");P.setAttribute("data-motion-sensitivity-button",h),P.style.cssText=`
          display: flex;
          flex-direction: column;
          align-items: center;
          justify-content: center;
          ...
          touch-action: manipulation;
          transition: transform 0.08s ease-out, border-color 0.12s ease-out, background 0.12s ease-out;
        `;const F=document.createElement("span");F.textContent=E.emoji,F.style.cssText="font-size: clamp(1.25rem, 4.8vmin, 1.7rem); line-height: 1;";const V=document.createElement("span");V.textContent=E.stars,V.style.cssText="font-size: clamp(0.82rem, 2.9vmin, 0.95rem); letter-spacing: 0.08em;";const U=document.createElement("span");U.setAttribute("data-motion-label",h),U.style.cssText="font-size: clamp(0.9rem, 3vmin, 1rem);",P.append(F,V,U),P.addEventListener("click",()=>{this.motionSensitivity=h,this.render(),this.playMotionPreview(),this.onMotionSensitivityChange?.(h)}),this.motionButtons.set(h,P),p.appendChild(P)}this.motionPreviewEl=document.createElement("div"),this.motionPreviewEl.setAttribute("data-motion-preview",""),this.motionPreviewEl.style.cssText=`
        position: relative;
        min-height: 5.8rem;
        margin: 0 0 1rem;
        padding: 0.8rem 0.9rem;
    ...
    `,m.appendChild(f);const b=document.createElement("div");b.setAttribute("data-stats-stage-clears",""),b.style.cssText=`
      ...
      gap: 0.45rem;
      text-align: left;
    `;const g=Array.from({length:H},(d,S)=>S+1).map(d=>({stageNumber:d,clearCount:s.stageClearCounts[d]??0})).filter(d=>d.clearCount>0);if(g.length===0){const d=document.createElement("div");d.textContent="まだ きろくが ないよ",d.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: ${n?"1rem":"1.1rem"};
        font-weight: 700;
        text-align: center;
        color: rgba(255, 255, 255, 0.88);
      `,b.appendChild(d)}else for(const{stageNumber:d,clearCount:S}of g){const x=K(d),T=document.createElement("div");T.setAttribute("data-stats-stage-clear-row",String(d)),T.style.cssText=`
          display: flex;
          align-items: center;
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.actionCleanups.add(I(r,{onActivate:()=>{this.hide(),e()},onPressChange:d=>{r.style.transform=d?"scale(0.96)":"scale(1)"}})),o.appendChild(r),a.appendChild(o),i.appendChild(a)}hide(){const t=Array.from(this.actionCleanups);this.actionCleanups.clear();for(const e of t)e();this.overlayEl?.remove(),this.overlayEl=null}createSummaryCard(t,e,i){const s=document.createElement("div");s.setAttribute(i,""),s.style.cssText=`
    ...
    `,s.append(n,a),s}}const Y={strong:{rippleDurationMs:360,markerDurationMs:300,rippleScale:2.35,markerScale:1},medium:{rippleDurationMs:340,markerDurationMs:300,rippleScale:2.05,markerScale:.98},gentle:{rippleDurationMs:320,markerDurationMs:280,rippleScale:1.75,markerScale:.94},minimal:{rippleDurationMs:280,markerDurationMs:240,rippleScale:1.45,markerScale:.9}};class Q{static STYLE_ID="touch-feedback-overlay-styles";static UI_ROOT_LISTENER_OPTIONS={capture:!0,passive:!0};root=null;activeEntries=new Map;pooledEntries=[];uiRootCleanups=new Set;motionSensitivity="strong";attach(){const t=this.ensureRoot();t.isConnected||document.body.appendChild(t)}hide(){this.clearUiRoots();for(const t of this.activeEntries.keys())this.releaseGameplayTouch(t);for(this.activeEntries.clear();this.pooledEntries.length>0;)this.pooledEntries.pop()?.host.remove();this.root?.remove()}dispose(){this.hide(),this.root=null}setMotionSensitivity(t){this.motionSensitivity=t;const e=this.ensureRoot(),i=Y[t];e.style.setProperty("--touch-feedback-ripple-duration",`${i.rippleDurationMs}ms`),e.style.setProperty("--touch-feedback-marker-duration",`${i.markerDurationMs}ms`),e.style.setProperty("--touch-feedback-ripple-scale",`${i.rippleScale}`),e.style.setProperty("--touch-feedback-marker-scale",`${i.markerScale}`)}bindUiRoots(t){this.clearUiRoots();for(const e of t){if(!e)continue;const i=s=>{const n=s.target;if(!(n instanceof Element)||this.root?.contains(n))return;const a=n.closest('button, [role="button"], [data-touch-feedback-button]');if(!(a instanceof HTMLElement)||!e.contains(a))return;const o=s;typeof o.clientX!="number"||typeof o.clientY!="number"||this.showUiTouch(o.clientX,o.clientY)};e.addEventListener("pointerdown",i,Q.UI_ROOT_LISTENER_OPTIONS),this.uiRootCleanups.add(()=>{e.removeEventListener("pointerdown",i,Q.UI_ROOT_LISTENER_OPTIONS)})}}showGameplayTouch(t,e,i,s){const n=this.activeEntries.get(t)??this.acquireEntry(t);this.activeEntries.set(t,n),this.activateEntry(n,e,i,this.toGameplayVariant(s))}moveGameplayTouch(t,e,i,s){this.showGameplayTouch(t,e,i,s)}releaseGameplayTouch(t){const e=this.activeEntries.get(t);e&&(this.activeEntries.delete(t),e.activePointerId=null,this.recycleWhenIdle(e))}showUiTouch(t,e){const i=this.acquireEntry(null);this.activateEntry(i,t,e,"ui"),this.recycleWhenIdle(i)}ensureRoot(){if(this.root)return this.root;this.injectStyles();const t=document.createElement("div");return t.setAttribute("data-touch-feedback-root",""),t.style.cssText=`
      ...
      --touch-feedback-ripple-duration: ${Y.strong.rippleDurationMs}ms;
      --touch-feedback-marker-duration: ${Y.strong.markerDurationMs}ms;
      --touch-feedback-ripple-scale: ${Y.strong.rippleScale};
      --touch-feedback-marker-scale: ${Y.strong.markerScale};
    ...
    `,document.head.appendChild(t)}acquireEntry(t){const e=this.pooledEntries.pop()??this.createEntry();return e.activePointerId=t,e.releaseScheduled=!1,this.ensureRoot().appendChild(e.host),e}createEntry(){const t=document.createElement("div");t.setAttribute("data-touch-feedback-entry","");const e=document.createElement("div");e.setAttribute("data-touch-feedback-ripple","");const i=document.createElement("div");i.setAttribute("data-touch-feedback-marker",""),t.append(e,i);const s={host:t,marker:i,ripple:e,markerTimeoutId:null,rippleTimeoutId:null,releaseScheduled:!1,activePointerId:null,animationToggle:!1},n=a=>{a.target instanceof HTMLElement&&(a.target.removeAttribute("data-touch-feedback-anim"),this.recycleWhenIdle(s))};return e.addEventListener("animationend",n),i.addEventListener("animationend",n),s}activateEntry(t,e,i,s){const n=t.animationToggle?"a":"b";t.animationToggle=!t.animationToggle,t.releaseScheduled=!1,t.host.style.left=`${e}px`,t.host.style.top=`${i}px`,t.host.setAttribute("data-touch-feedback-variant",s),t.ripple.setAttribute("data-touch-feedback-anim",n),t.marker.setAttribute("data-touch-feedback-anim",n),t.markerTimeoutId!==null&&window.clearTimeout(t.markerTimeoutId),t.rippleTimeoutId!==null&&window.clearTimeout(t.rippleTimeoutId);const a=Y[this.motionSensitivity].rippleDurationMs,o=Y[this.motionSensitivity].markerDurationMs;t.rippleTimeoutId=window.setTimeout(()=>{t.rippleTimeoutId=null,t.ripple.removeAttribute("data-touch-feedback-anim"),this.recycleWhenIdle(t)},a+24),t.markerTimeoutId=window.setTimeout(()=>{t.markerTimeoutId=null,t.marker.removeAttribute("data-touch-feedback-anim"),this.recycleWhenIdle(t)},o+24)}recycleWhenIdle(t){if(t.activePointerId!==null||t.releaseScheduled)return;const e=t.ripple.hasAttribute("data-touch-feedback-anim"),i=t.marker.hasAttribute("data-touch-feedback-anim");e||i||(t.releaseScheduled=!0,t.host.remove(),t.host.removeAttribute("data-touch-feedback-variant"),t.markerTimeoutId!==null&&(window.clearTimeout(t.markerTimeoutId),t.markerTimeoutId=null),t.rippleTimeoutId!==null&&(window.clearTimeout(t.rippleTimeoutId),t.rippleTimeoutId=null),this.pooledEntries.push(t))}clearUiRoots(){const t=Array.from(this.uiRootCleanups);this.uiRootCleanups.clear();for(const e of t)e()}toGameplayVariant(t){switch(t){case"left":return"game-left";case"right":return"game-right";default:return"game-center"}}}function Qt(l,t){if(!Number.isFinite(l)||l<=0||t<=0)return"ずかん";const e=Math.min(l,t);return e>=t?`ずかん ${t} / ${t} 🎉`:`ずかん ${e} / ${t}`}function bi(l){switch(l){case"hero":return{gap:"0.35rem",label:"0.92rem",medal:"1.7rem",hint:"0.98rem"};case"compact":return{gap:"0.18rem",label:"0.7rem",medal:"1rem",hint:"0.76rem"};default:return{gap:"0.26rem",label:"0.8rem",medal:"1.25rem",hint:"0.84rem"}}}function kt(l,t,e={}){const i=ee(l,t),s=e.size??"regular",n=bi(s),a=document.createElement("div");if(a.setAttribute("data-stage-medal-display",""),a.setAttribute("data-stage-medal-stage",String(l)),a.setAttribute("data-stage-medal-tier",i.tier),a.setAttribute("data-stage-medal-earned",String(i.earnedCount)),e.scope&&a.setAttribute("data-stage-medal-scope",e.scope),a.style.cssText=`
    display: flex;
    flex-direction: column;
    align-items: center;
    gap: ${n.gap};
  ...
  `;for(const m of i.slots){const f=document.createElement("span");f.setAttribute("data-stage-medal-slot",m.tier),f.setAttribute("data-stage-medal-threshold",String(m.threshold)),f.setAttribute("data-stage-medal-reached",String(m.reached)),f.textContent=m.icon,f.style.cssText=`
    ...
    `,o.appendChild(f)}a.appendChild(o);const c=e.hint??(i.nextThreshold===null?"かんぺき！":`つぎ ⭐ ${i.nextThreshold}`),u=document.createElement("div");return u.setAttribute("data-stage-medal-hint",""),u.textContent=c,u.style.cssText=`
    font-family: 'Zen Maru Gothic', sans-serif;
    font-size: ${n.hint};
    font-weight: 700;
    color: ${i.nextThreshold===null?"#FFE66D":"rgba(255, 255, 255, 0.86)"};
  `,a.appendChild(u),a}const Kt=2e3,yt=new Map,bt=new Map,vt=new Map;let ut=null,dt=null;function et(l,t){if(typeof document>"u"){const i=typeof OffscreenCanvas=="function",s=i?new OffscreenCanvas(l,t):{width:l,height:t};return{canvas:s,ctx:i?s.getContext("2d"):null}}const e=document.createElement("canvas");return e.width=l,e.height=t,{canvas:e,ctx:e.getContext("2d")}}function tt(l,t){let e=yt.get(l);return e||(e=t(),e.generateMipmaps=!1,e.minFilter=hi,e.needsUpdate=!0,yt.set(l,e)),e}function O(l,t){let e=bt.get(l);return e||(e=t(),bt.set(l,e)),e}function L(l,t){let e=vt.get(l);return e||(e=t(),vt.set(l,e)),e}function k(l,t){const e=new ci(l,t);return e.userData.sharedAssets=!0,e}function ce(){if(!ut){const l=new Dt,t=new Float32Array(Kt*3);for(let e=0;e<Kt*3;e+=3)t[e]=(Math.random()-.5)*200,t[e+1]=(Math.random()-.5)*200,t[e+2]=(Math.random()-.5)*400;l.setAttribute("position",new Lt(t,3)),ut=l}dt||(dt=new Gt({color:16777215,size:.2,sizeAttenuation:!0}))}function vi(){const{canvas:l,ctx:t}=et(256,256);if(!t)return new _(l);t.fillStyle="#888888",t.fillRect(0,0,256,256);for(let e=0;e<30;e++){const i=Math.random()*256,s=Math.random()*256,n=3+Math.random()*12;t.beginPath(),t.arc(i,s,n,0,Math.PI*2),t.fillStyle=`rgba(60,60,60,${.3+Math.random()*.4})`,t.fill()}return new _(l)}function Si(){const{canvas:l,ctx:t}=et(256,256);if(!t)return new _(l);t.fillStyle="#ddaa44",t.fillRect(0,0,256,256);for(let e=0;e<8;e++){t.beginPath();const i=128+(Math.random()-.5)*100,s=128+(Math.random()-.5)*100;t.strokeStyle=`rgba(200,150,60,${.3+Math.random()*.3})`,t.lineWidth=3+Math.random()*5;for(let n=0;n<Math.PI*4;n+=.1){const a=10+n*8;t.lineTo(i+Math.cos(n)*a,s+Math.sin(n)*a)}t.stroke()}return new _(l)}function Ei(){const{canvas:l,ctx:t}=et(256,256);if(!t)return new _(l);const e=["#cc7733","#dd9955","#bb6622","#eebb77","#aa5511","#ddaa66"];for(let i=0;i<256;i++){const s=Math.floor(i/(256/e.length))%e.length;t.fillStyle=e[s],t.fillRect(0,i,256,1)}return new _(l)}function xi(){const{canvas:l,ctx:t}=et(512,256);return t?(t.fillStyle="#2266aa",t.fillRect(0,0,512,256),t.fillStyle="#886644",t.beginPath(),t.ellipse(300,80,80,40,.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(280,150,30,50,.1,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(100,90,25,60,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(110,170,20,40,-.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(420,170,25,15,0,0,Math.PI*2),t.fill(),t.fillStyle="#447733",t.beginPath(),t.ellipse(290,75,40,20,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(95,85,15,30,.2,0,Math.PI*2),t.fill(),new _(l)):new _(l)}function Ci(){const{canvas:l,ctx:t}=et(512,256);if(!t)return new _(l);t.clearRect(0,0,512,256),t.fillStyle="rgba(255,255,255,0.6)";for(let e=0;e<20;e++){const i=Math.random()*512,s=Math.random()*256;t.beginPath(),t.ellipse(i,s,20+Math.random()*40,8+Math.random()*15,Math.random()*Math.PI,0,Math.PI*2),t.fill()}return new _(l)}function wi(){const{canvas:l,ctx:t}=et(256,128);if(!t)return new _(l);t.fillStyle="#d7dde8",t.fillRect(0,0,256,128),t.fillStyle="#8bbcff",t.fillRect(0,0,256,28),t.fillStyle="#90a4bf";for(let e=0;e<256;e+=24)t.fillRect(e,40,4,88);t.fillStyle="#4a6c9a";for(let e=44;e<128;e+=16)t.fillRect(0,e,256,6);return new _(l)}function Ti(){yt.clear(),bt.clear(),vt.clear(),ut=null,dt=null}const Ai={planetTextureCache:yt,planetGeometryCache:bt,planetMaterialCache:vt,getBgStarsGeometry:()=>ut,getBgStarsMaterial:()=>dt};function he(l,t,e){const i=new nt;let s=null;switch(l){case 2:{const n=tt("mercury",vi),a=O("mercury:sphere",()=>new $(10,24,24)),o=L("mercury:mat",()=>new D({map:n})),c=k(a,o);i.add(c),s=c;break}case 3:{const n=tt("venus",Si),a=O("venus:sphere",()=>new $(14,24,24)),o=L("venus:mat",()=>new D({map:n})),c=k(a,o);i.add(c),s=c;break}case 5:{const n=tt("jupiter",Ei),a=O("jupiter:sphere",()=>new $(20,24,24)),o=L("jupiter:mat",()=>new D({map:n})),c=k(a,o);i.add(c),s=c;break}case 6:{const n=O("saturn:sphere",()=>new $(15,24,24)),a=t.planetColor,o=L(`saturn:mat:${a}`,()=>new D({color:a})),c=k(n,o);i.add(c);const u=O("saturn:ring",()=>new jt(20,30,48)),m=L("saturn:ringMat",()=>new D({color:15645542,side:Ut})),f=k(u,m);f.rotation.x=Math.PI/3,i.add(f),s=c;break}case 7:{const n=O("uranus:sphere",()=>new $(16,24,24)),a=L("uranus:mat",()=>new D({color:6737117})),o=k(n,a);i.add(o);const c=O("uranus:ring",()=>new jt(21,28,48)),u=L("uranus:ringMat",()=>new D({color:10083822,side:Ut})),m=k(c,u);m.rotation.z=Math.PI/2,i.add(m),s=o;break}case 9:{const n=O("pluto:sphere",()=>new $(8,24,24)),a=L("pluto:mat",()=>new D({color:12298922})),o=k(n,a);i.add(o),s=o;break}case 10:{const n=O("sun:sphere",()=>new $(25,24,24)),a=L("sun:mat",()=>new D({color:16763904,emissive:16755200,emissiveIntensity:.5})),o=k(n,a);i.add(o),i.add(new li(16763904,2,200)),s=o;break}case 11:{const n=tt("station:panel",wi),a=O("station:core",()=>new Ft(3.2,3.2,12,12)),o=O("station:module",()=>new Ft(1.7,1.7,6,10)),c=O("station:truss",()=>new Vt(18,.9,.9)),u=O("station:panelGeo",()=>new Vt(8,3.6,.18)),m=O("station:dish",()=>new $(1.4,12,12,0,Math.PI)),f=L("station:metal",()=>new D({color:14213354})),b=L("station:moduleMat",()=>new D({color:11057099})),g=L("station:panelMat",()=>new D({map:n,color:16777215})),r=new nt,d=k(a,f);d.rotation.z=Math.PI/2,r.add(d);const S=k(c,b);r.add(S);const x=k(o,b);x.position.x=-6,x.rotation.z=Math.PI/2,r.add(x);const T=k(o,b);T.position.x=6,T.rotation.z=Math.PI/2,r.add(T);const y=k(u,g);y.position.set(-11,0,0),r.add(y);const p=k(u,g);p.position.set(11,0,0),r.add(p);const M=k(m,f);M.position.set(0,3.2,0),M.rotation.x=-Math.PI/2,r.add(M),i.add(r),s=r;break}case 12:{const n=tt("earth",xi),a=O("earth:sphere",()=>new $(15,32,32)),o=L("earth:mat",()=>new D({map:n})),c=tt("earth:cloud",Ci),u=O("earth:cloudSphere",()=>new $(15.5,32,32)),m=L("earth:cloudMat",()=>new D({map:c,transparent:!0,opacity:.3})),f=new nt;f.add(k(a,o)),f.add(k(u,m)),i.add(f),s=f;break}default:{const n=O("default:sphere",()=>new $(15,24,24)),a=t.planetColor,o=L(`default:mat:${a}`,()=>new D({color:a})),c=k(n,o);i.add(c),s=c;break}}return i.position.set(0,0,e),{planet:i,spinTarget:s}}function ue(l,t,e){return he(l,t,e)}function de(l){ce();const t=new It(ut,dt);return t.userData.sharedAssets=!0,t.geometry.setDrawRange(0,l),t}function Nt(l){!Number.isInteger(l)||l<1||l>H||typeof document>"u"&&typeof OffscreenCanvas!="function"||(ce(),he(l,K(l),0))}let at=null,ot=null;function Mi(){if(!at){const l=new Dt,t=new Float32Array(3e3);for(let e=0;e<3e3;e++)t[e]=(Math.random()-.5)*200;l.setAttribute("position",new Lt(t,3)),at=l}return at}function Pi(){return ot||(ot=new Gt({color:16777215,size:.3,sizeAttenuation:!0})),ot}function Bi(){at=null,ot=null}const ki={getBgStarsGeometry:()=>at,getBgStarsMaterial:()=>ot};function Ri(l){const t=window.requestIdleCallback;if(typeof t=="function"){t(l,{timeout:1500});return}window.setTimeout(l,800)}function me(l){return new Set(l.filter(t=>Number.isInteger(t)&&t>=1&&t<=H)).size}function Oi(l){return me(l)>=H}function At(l){const t=Oi(l.unlockedPlanets),e=t?1:Math.min(l.clearedStage+1,H),i=K(e),s=l.bestStageStars?.[e]??0,n=l.colorAccessibility?.colorVisionSupportMode??j,a=se(e,i.destinationReading,n);return t?{startStage:e,destination:a,emoji:i.emoji,statusLabel:"ぜんぶ あつめたよ！",destinationLabel:`${a}へ もういちど しゅっぱつ！`,buttonHint:`${i.emoji} ステージ ${e} から もういちど あそぶ`,bestStars:s}:{startStage:e,destination:a,emoji:i.emoji,statusLabel:l.clearedStage>0?"つづきから しゅっぱつ！":"はじめての しゅっぱつ！",destinationLabel:`${a}へ むかおう！`,buttonHint:`${i.emoji} ステージ ${e} から スタート`,bestStars:s}}function Ii(l){return l.clearedStage>0||me(l.unlockedPlanets)>0||Object.keys(l.bestStageStars??{}).length>0}class Di{threeScene;ambientLight=new St(16777215,1);camera;lastAspect=0;sceneManager;saveManager;audioManager;stars=null;companionParade=null;overlay=null;muteHandle=null;tutorialOverlay=new zt;titleResetConfirmOverlay=new di;colorAccessibilitySettings=new mi;spaceshipCustomizer=new pi;statsOverlay=new yi;encyclopediaOverlay=null;encyclopediaOverlayPromise=null;companionFactory=null;companionFactoryPromise=null;loadEncyclopediaOverlay;loadTitleCompanionFactory;loadingOverlay;loadFailureOverlay;scheduleIdleTask;encyclopediaBtn=null;isOpeningEncyclopedia=!1;isActive=!1;touchFeedbackOverlay=new Q;encyclopediaRequestToken=0;companionParadeRequestToken=0;bgmPending=!1;overlayButtonCleanups=new Set;colorSettingsButton=null;unsubscribeLanguageChange=null;constructor(t,e,i,s={}){this.sceneManager=t,this.saveManager=e,this.audioManager=i,this.loadingOverlay=s.loadingOverlay??new fe,this.loadFailureOverlay=s.loadFailureOverlay??new ye,this.scheduleIdleTask=s.scheduleIdleTask??Ri,this.loadEncyclopediaOverlay=s.loadEncyclopediaOverlay??(()=>Bt(()=>import("./EncyclopediaOverlay-Dvc1aV8V.js"),__vite__mapDeps([0,1,2]))),this.loadTitleCompanionFactory=s.loadTitleCompanionFactory??(()=>Bt(()=>import("./game-core-rJZxCOOc.js").then(o=>o.ar),__vite__mapDeps([1,2]))),this.threeScene=new ct,this.threeScene.background=new ht(32);const{width:n,height:a}=N();this.camera=new Et(60,n/a,.1,1e3),this.camera.position.set(0,0,5)}enter(t){this.isActive=!0,this.encyclopediaRequestToken+=1,this.companionParadeRequestToken+=1,this.lastAspect=0,this.stars=new It(Mi(),Pi()),this.stars.userData.sharedAssets=!0,this.stars.rotation.set(0,0,0),this.threeScene.add(this.stars),this.ambientLight.parent||this.threeScene.add(this.ambientLight);const e=this.saveManager.load();A.setLanguage(e.language??mt,{notify:!1}),this.createCompanionParade(e.unlockedPlanets),this.createOverlay(),this.createMuteButton(),this.touchFeedbackOverlay.setMotionSensitivity(e.colorAccessibility?.motionSensitivity??q()),this.touchFeedbackOverlay.attach(),this.touchFeedbackOverlay.bindUiRoots([document.getElementById("hud"),document.getElementById("ui-overlay")]),this.prefetchEncyclopediaOnIdle(),this.prewarmNextAdventureOnIdle(At(e).startStage),this.audioManager.isInitialized()?(this.audioManager.playBGM(0),this.bgmPending=!1):this.bgmPending=!0,e.tutorialShown||this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide(),this.saveManager.markTutorialShown()})}createMuteButton(){const t=document.getElementById("hud")??document.getElementById("ui-overlay");t&&(this.muteHandle=Ht({initialMuted:this.audioManager.isMuted(),container:t,onToggle:()=>{this.ensureTitleAudioInitialized(!0);const e=this.audioManager.toggleMute();this.muteHandle?.setMuted(e);const i=this.saveManager.load();i.muted=e,this.saveManager.save(i)}}))}getEncyclopediaOverlay(){return this.encyclopediaOverlay?Promise.resolve(this.encyclopediaOverlay):this.encyclopediaOverlayPromise?this.encyclopediaOverlayPromise:(this.encyclopediaOverlayPromise=this.loadEncyclopediaOverlay().then(({EncyclopediaOverlay:t})=>{const e=new t;return this.encyclopediaOverlay=e,e}).finally(()=>{this.encyclopediaOverlayPromise=null}),this.encyclopediaOverlayPromise)}getTitleCompanionFactory(){return this.companionFactory?Promise.resolve(this.companionFactory):this.companionFactoryPromise?this.companionFactoryPromise:(this.companionFactoryPromise=this.loadTitleCompanionFactory().then(t=>(this.companionFactory=t,t)).finally(()=>{this.companionFactoryPromise=null}),this.companionFactoryPromise)}showEncyclopedia(){if(!this.isActive||!this.encyclopediaOverlay)return;const t=this.saveManager.load();this.encyclopediaOverlay.show(t.unlockedPlanets,()=>this.refreshEncyclopediaButtonLabel(),e=>{this.ensureTitleAudioInitialized(!1),this.sceneManager.requestTransition("stage",{stageNumber:e,totalScore:0,totalStarCount:0,launchSource:"encyclopedia"})},t.bestStageStars??{},t.discoveredConstellations??[],t.colorAccessibility?.colorVisionSupportMode??j,t.discoveredMonthlyEncounters??[],t.discoveredSpaceGems??[])}isCurrentEncyclopediaRequest(t){return this.isActive&&this.encyclopediaRequestToken===t}prefetchEncyclopediaOnIdle(){const t=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{!this.isCurrentEncyclopediaRequest(t)||this.encyclopediaOverlay||this.encyclopediaOverlayPromise||this.getEncyclopediaOverlay().catch(()=>{})})}prewarmNextAdventureOnIdle(t){if(t>H)return;const e=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{this.isCurrentEncyclopediaRequest(e)&&Nt(t)})}async openEncyclopedia(){if(!this.isActive)return;if(this.loadFailureOverlay.hide(),this.encyclopediaOverlay){this.showEncyclopedia();return}if(this.isOpeningEncyclopedia)return;const t=this.encyclopediaRequestToken;this.isOpeningEncyclopedia=!0,this.loadingOverlay.show("ずかんを よんでるよ...");try{if(await this.getEncyclopediaOverlay(),!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),this.showEncyclopedia()}catch(e){if(!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),console.error("Failed to load encyclopedia overlay",e),this.loadFailureOverlay.show({title:"ずかんを もういちど よんでみよう！",message:"「もういちど よむ」を おして つづきを たのしもう！",primaryAction:{label:"もういちど よむ",onSelect:()=>this.openEncyclopedia()}})}finally{this.encyclopediaRequestToken===t&&(this.isOpeningEncyclopedia=!1)}}persistHighContrastSetting(t){const e=this.saveManager.load(),i=e.colorAccessibility?.motionSensitivity??q(),s=e.colorAccessibility?.colorVisionSupportMode??j;e.colorAccessibility=this.buildColorAccessibilitySettings(t,i,s),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}persistVibrationIntensitySetting(t){const e=this.saveManager.load();e.vibrationSettings={intensity:t},this.saveManager.save(e),ie(t)}persistRestReminderSetting(t){const e=this.saveManager.load();e.restReminderSettings={enabled:t},this.saveManager.save(e)}persistLanguageSetting(t){const e=this.saveManager.load();t===mt?delete e.language:e.language=t,this.saveManager.save(e)}persistBGMVolumeSetting(t){const e=this.saveManager.load();e.audioSettings=this.buildAudioSettings(t,e.audioSettings?.sfxVolume??100),e.audioSettings||delete e.audioSettings,this.saveManager.save(e),this.audioManager.setBGMVolume(t)}persistSFXVolumeSetting(t){const e=this.saveManager.load();e.audioSettings=this.buildAudioSettings(e.audioSettings?.bgmVolume??100,t),e.audioSettings||delete e.audioSettings,this.saveManager.save(e),this.audioManager.setSFXVolume(t)}persistMotionSensitivitySetting(t){const e=this.saveManager.load(),i=e.colorAccessibility?.highContrast===!0,s=e.colorAccessibility?.colorVisionSupportMode??j;e.colorAccessibility=this.buildColorAccessibilitySettings(i,t,s),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}persistColorVisionSupportModeSetting(t){const e=this.saveManager.load(),i=e.colorAccessibility?.highContrast===!0,s=e.colorAccessibility?.motionSensitivity??q();e.colorAccessibility=this.buildColorAccessibilitySettings(i,s,t),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}buildColorAccessibilitySettings(t,e,i){const s=q();if(!(!t&&e===s&&i===j))return{...t?{highContrast:!0}:{},...e!==s?{motionSensitivity:e}:{},...i!==j?{colorVisionSupportMode:i}:{}}}buildAudioSettings(t,e){if(!(t===100&&e===100))return{...t!==100?{bgmVolume:t}:{},...e!==100?{sfxVolume:e}:{}}}createOverlay(){const t=document.getElementById("ui-overlay");if(!t)return;const e=this.saveManager.load(),i=At(e),s=Ii(e);this.overlay=document.createElement("div"),this.unsubscribeLanguageChange?.(),this.unsubscribeLanguageChange=A.subscribe(()=>this.applyLocalizedText()),this.overlay.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      justify-content: center;
    ...
    `;const f=document.createElement("div");f.textContent=i.destinationLabel,f.style.cssText=`
      ...
      font-weight: 700;
      color: rgba(255, 255, 255, 0.92);
    `;const b=ee(i.startStage,i.bestStars),g=kt(i.startStage,i.bestStars,{label:"メダル",hint:b.nextThreshold===null?"かんぺき！":`${b.icon} いま ・ つぎ ⭐ ${b.nextThreshold}`,size:"regular",scope:"title-next-adventure"});g.style.marginTop=n?"0.35rem":"0.55rem",o.appendChild(c),o.appendChild(u),o.appendChild(m),o.appendChild(f),o.appendChild(g);const r=document.createElement("div");r.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
    ...
    `;const B=document.createElement("button");B.textContent="あそびかた",B.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(I(B,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide()})},onPressChange:h=>{B.style.transform=h?"scale(0.96)":"scale(1)"}}));const C=document.createElement("button");C.setAttribute("data-color-settings-button",""),C.textContent=A.t("titleScene.colorSettingsButton"),this.colorSettingsButton=C,C.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${n?"0.82rem":"1rem"};
      font-weight: 700;
      padding: ${n?"0.45rem 0.55rem":"0.55rem 0.8rem"};
      ...
      transition: transform 0.08s ease-out;
      white-space: nowrap;
    `,this.overlayButtonCleanups.add(I(C,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.colorAccessibilitySettings.show({initialHighContrast:this.saveManager.load().colorAccessibility?.highContrast===!0,initialColorVisionSupportMode:this.saveManager.load().colorAccessibility?.colorVisionSupportMode??j,initialBGMVolume:this.saveManager.load().audioSettings?.bgmVolume??100,initialSFXVolume:this.saveManager.load().audioSettings?.sfxVolume??100,initialVibrationIntensity:this.saveManager.load().vibrationSettings?.intensity??"medium",initialMotionSensitivity:this.saveManager.load().colorAccessibility?.motionSensitivity??q(),initialRestReminderEnabled:this.saveManager.load().restReminderSettings?.enabled??be,initialLanguage:this.saveManager.load().language??mt,onToggle:h=>this.persistHighContrastSetting(h),onColorVisionSupportModeChange:h=>this.persistColorVisionSupportModeSetting(h),onBGMVolumeChange:h=>this.persistBGMVolumeSetting(h),onSFXVolumeChange:h=>this.persistSFXVolumeSetting(h),onVibrationIntensityChange:h=>this.persistVibrationIntensitySetting(h),onMotionSensitivityChange:h=>this.persistMotionSensitivitySetting(h),onRestReminderToggle:h=>this.persistRestReminderSetting(h),onLanguageChange:h=>this.persistLanguageSetting(h)})},onPressChange:h=>{C.style.transform=h?"scale(0.96)":"scale(1)"}}));const w=document.createElement("button");if(w.textContent=Qt(e.unlockedPlanets.length,st.length),w.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${n?"0.82rem":"1rem"};
      font-weight: 700;
      padding: ${n?"0.45rem 0.55rem":"0.55rem 0.8rem"};
    ...
    `;const s=document.createElement("div");s.setAttribute("data-pause-card",""),s.style.cssText=`
      ...
      text-align: center;
      font-family: 'Zen Maru Gothic', sans-serif;
    `,s.addEventListener("pointerdown",u=>{u.stopPropagation()}),this.overlayEl.appendChild(s);const n=document.createElement("div");n.textContent="ひとやすみ ちゅう",n.style.cssText=`
    ...
    `,document.head.appendChild(t)}}const Hi=1,Ni=.4;class Jt{overlayEl=null;numberEl=null;phase="idle";elapsed=0;currentStep=0;stepDuration;goDuration;onTick;onGo;onComplete=null;steps=["3","2","1"];constructor(t={}){this.stepDuration=t.stepDuration??Hi,this.goDuration=t.goDuration??Ni,this.onTick=t.onTick,this.onGo=t.onGo}show(t){if(this.phase!=="idle"&&this.phase!=="done")return;const e=document.getElementById("ui-overlay")??document.body;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-countdown-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
    ...
    `;const i=document.createElement("div");i.style.cssText="display:flex; align-items:flex-start; justify-content:space-between; gap:0.5rem;";const s=document.createElement("div");s.setAttribute("data-constellation-message-text",""),s.style.cssText=`
      ...
      text-wrap: balance;
    `;const n=document.createElement("div");n.setAttribute("data-constellation-status",""),n.style.cssText=`
      min-width: 4.25rem;
      min-height: 2rem;
    ...
    `;const a=document.createElementNS("http://www.w3.org/2000/svg","svg");return a.setAttribute("data-constellation-minimap",""),a.setAttribute("viewBox","0 0 200 88"),a.setAttribute("width","100%"),a.setAttribute("height","88"),a.setAttribute("role","img"),a.style.cssText="display:block; width:100%; height:5.5rem; overflow:visible;",i.append(s,n),e.append(i,a),t.appendChild(e),this.element=e,this.messageElement=s,this.statusElement=n,this.miniMapElement=a,this.ensurePointerElement(),this.applyTheme(),e}ensurePointerElement(){if(this.pointerElement)return this.pointerElement;const t=document.getElementById("ui-overlay")??document.body,e=document.createElement("div");e.setAttribute("data-constellation-pointer",""),e.style.cssText=`
      position: fixed;
      display: none;
    ...
    `,document.head.appendChild(t)}buildGuideMessage(t,e){const i=t.points.length-e;return e===0?`${t.reading} を つくろう！⭐`:i<=1?`${t.reading} の さいごだよ！⭐`:`${t.reading} の つぎは ここだよ！⭐`}buildGuideStatus(t,e){const i=Math.max(0,t.points.length-e);return i===0?"やったね！✨":`あと${i}こ！`}buildMiniMapMarkup(t,e){const i=t.points,s=200,n=88,a=22,o=16,c=i.map(w=>w.x),u=i.map(w=>w.y),m=Math.min(...c),f=Math.max(...c),b=Math.min(...u),g=Math.max(...u),r=Math.max(f-m,1),d=Math.max(g-b,1),S=Math.min((s-a*2)/r,(n-o*2)/d),x=r*S,T=d*S,y=(s-x)/2,p=(n-T)/2,M=w=>{const h=i[w];return{x:y+(h.x-m)*S,y:n-(p+(h.y-b)*S)}},B=i.slice(0,-1).map((w,h)=>{const E=M(h),P=M(h+1);return`<line class="${h<e-1?"constellation-line-active":"constellation-line-faint"}" x1="${E.x}" y1="${E.y}" x2="${P.x}" y2="${P.y}" />`}).join(""),C=i.map((w,h)=>{const E=M(h),P=h<e?"collected":h===e?"next":"pending",F=`constellation-star-${P}`,V=`${h+1}`;return`${P==="next"?`<circle data-constellation-next-star="" class="constellation-star-ring" cx="${E.x}" cy="${E.y}" r="14" />`:""}<circle data-constellation-star="${P}" class="${F}" cx="${E.x}" cy="${E.y}" r="7.5" /><text x="${E.x}" y="${E.y+.5}">${V}</text>`}).join("");return`
      <rect x="3" y="3" width="194" height="82" rx="20" fill="var(--constellation-card-subtle)" />
      ${B}
      ${C}
    `}isReducedMotion(){if(this.motionSensitivity==="gentle"||this.motionSensitivity==="minimal")return!0;const t=globalThis.matchMedia;if(typeof t!="function")return!1;try{return t("(prefers-reduced-motion: reduce)").matches}catch{return!1}}}const Vi=4;class Ui{overlayEl=null;cardEl=null;titleEl=null;messageEl=null;elapsed=0;visible=!1;highContrastMode=!1;totalDuration;constructor(t={}){this.totalDuration=t.totalDuration??Vi}show(t){const e=document.getElementById("ui-overlay")??document.body;ne();const i=N().height<=500;(!this.overlayEl||!this.cardEl||!this.titleEl||!this.messageEl)&&(this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-seasonal-event-notice",""),this.overlayEl.style.cssText=`
        position: absolute;
    ...
    `;const s=document.createElement("section");s.style.cssText=`
      ...
      color: #fff;
      font-family: 'Zen Maru Gothic', sans-serif;
    `;const n=document.createElement("div");n.textContent="🌟 ボーナスタイム",n.style.cssText=`
    ...
    `,this.overlayButtonCleanups.add(I(n,{onActivate:()=>{this.inputSystem.resetPointers?.(),this.sceneManager.requestTransition("title")},onPressChange:o=>{n.style.transform=o?"scale(0.96)":"scale(1)"}})),e.append(i,n);const a=document.createElement("div");a.style.cssText=`
      align-self: center;
    ...
    `,this.overlay.appendChild(s),this.overlay.appendChild(n),this.overlay.appendChild(a),this.overlay.appendChild(this.exitCta),i.appendChild(this.overlay)}update(t){this.bgStars&&(this.bgStars.rotation.y+=t*.03),this.updateCelebration(t)}setupCelebration(){this.companionGroup=new nt,this.companionMeshes=[],this.circleX.length=0,this.circleZ.length=0,this.popinSettled.length=0,this.celebrationElapsed=0,this.thankYouShown=!1,this.canExit=!1,this.exitTriggered=!1;for(let t=0;t<st.length;t++){const e=st[t],i=Ot.createCompanionMesh(e),s=t*(2*Math.PI/st.length),n=Math.cos(s)*z.CIRCLE_RADIUS,a=Math.sin(s)*z.CIRCLE_RADIUS;this.circleX.push(n),this.circleZ.push(a),i.position.set(n,0,a),i.scale.set(0,0,0),this.companionMeshes.push(i),this.popinSettled.push(!1),this.companionGroup.add(i)}this.threeScene.add(this.companionGroup)}updateCelebration(t){if(this.companionMeshes.length===0)return;this.celebrationElapsed+=t;const e=z.POPIN_DELAY*(this.companionMeshes.length-1)+z.POPIN_DURATION,i=this.celebrationElapsed>e,s=i?Math.abs(Math.sin(this.celebrationElapsed*z.BOUNCE_SPEED))*z.BOUNCE_HEIGHT:0;for(let n=0;n<this.companionMeshes.length;n++){const a=this.companionMeshes[n];if(this.popinSettled[n]){i&&(a.position.y=s),a.rotation.y+=t*2;continue}const o=n*z.POPIN_DELAY;if(!(this.celebrationElapsed<o)){if(this.celebrationElapsed<o+z.POPIN_DURATION){const c=(this.celebrationElapsed-o)/z.POPIN_DURATION,u=this.bounceEase(c);a.scale.set(u,u,u)}else a.scale.set(1,1,1),this.popinSettled[n]=!0;i&&(a.position.y=s),a.rotation.y+=t*2}}!this.thankYouShown&&this.celebrationElapsed>=z.THANK_YOU_DELAY&&(this.showThankYouText(),this.thankYouShown=!0)}bounceEase(t){return t<.6?t/.6*1.2:1.2-(t-.6)/.4*.2}showThankYouText(){if(!this.overlay||!this.exitCta)return;const t=document.createElement("div");t.setAttribute("data-ending-thank-you",""),t.textContent="みんな ありがとう！",t.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: 2rem;
      font-weight: 900;
      color: #FFD700;
