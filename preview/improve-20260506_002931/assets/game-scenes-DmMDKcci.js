const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-DEiZqSwT.js","assets/game-core-Lpf1DKkL.js","assets/three-BsQe5WE2.js"])))=>i.map(i=>d[i]);
import{g as it,D as Et,S as $,T as I,a as _,b as zt,L as Xt,c as Qt,_ as bt,d as L,e as G,f as N,s as Ht,h as at,i as Gt,j as Kt,P as U,u as Nt,C as Jt,k as te,l as ee,B as se,m as ie,M as ae,n as ne,o as oe,p as re,q as le,r as he,t as ce,v as de,w as ue,x as me,y as pe,z as fe,A as Ft,W as ge,E as ye,F as be,G as _t,H as ve,I as St,J as Ee,K as Se,R as Ce,N as xe,O as we,Q as Ae,U as Te,V as Bt,X as $t,Y as Me,Z as nt,$ as V,a0 as Pe,a1 as mt,a2 as Be,a3 as pt,a4 as Re,a5 as ke,a6 as Oe,a7 as Ie,a8 as De}from"./game-core-Lpf1DKkL.js";import{n as Ct,l as xt,j as wt,m as At,G as ot,r as Le,a as ze,s as He,M as P,h as z,D as Rt,R as kt,t as H,u as dt,v as Q,i as K,P as ut,V as j,w as jt,x as Ge}from"./three-BsQe5WE2.js";class Tt{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const e=document.getElementById("ui-overlay");if(!e)return;const s=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
    ...
    `,y=(u,w)=>{let g=!1,m=!1;const S=()=>{T(!0)},C=()=>{u.style.transform="scale(0.92)"},A=()=>{u.style.transform="scale(1)"},T=(b=!1)=>{g=!1,m=b,A(),this.activePressCleanups.delete(S),document.removeEventListener("pointerup",E,!0),document.removeEventListener("pointercancel",x,!0)},E=b=>{const D=b.target===u||b.target instanceof Node&&u.contains(b.target),st=g&&D;T(!D),st&&w()},x=()=>{T(!0)};u.addEventListener("pointerdown",b=>{b.stopPropagation(),g=!0,m=!1,C(),this.activePressCleanups.add(S),document.addEventListener("pointerup",E,!0),document.addEventListener("pointercancel",x,!0)}),u.addEventListener("pointerenter",()=>{g&&C()}),u.addEventListener("pointerleave",()=>{g&&A()}),u.addEventListener("pointercancel",()=>T(!0)),u.addEventListener("click",b=>{if(b.stopPropagation(),m){m=!1;return}g||w()})},p=document.createElement("button");p.setAttribute("data-title-reset-cancel",""),p.textContent="やめる",p.style.cssText=f,p.style.background="rgba(255, 255, 255, 0.18)",p.style.color="#ffffff",y(p,a),d.appendChild(p);const r=document.createElement("button");r.setAttribute("data-title-reset-confirm",""),r.textContent="うん！ さいしょから",r.style.cssText=f,r.style.background="linear-gradient(135deg, #FF9F68, #FFE66D)",r.style.color="#3b1f00",y(r,n),d.appendChild(r),s.appendChild(this.overlayEl)}hide(){if(!this.overlayEl)return;const t=Array.from(this.activePressCleanups);this.activePressCleanups.clear();for(const e of t)e();this.overlayEl.remove(),this.overlayEl=null}}function Mt(l){const t=l.topRem??.8,e=window.innerHeight<=500,s=document.createElement("button");let i=l.initialMuted;const a=()=>{s.textContent=i?"🔇":"🔊",s.setAttribute("aria-label",i?"サウンド オフ":"サウンド オン")};s.setAttribute("data-mute-button",""),s.style.position="absolute",s.style.top=`${t}rem`,s.style.right="1rem",s.style.fontSize=e?"clamp(1.1rem, 3.5vmin, 1.4rem)":"clamp(1.4rem, 4vmin, 1.8rem)",s.style.background="rgba(255, 255, 255, 0.15)",s.style.border="none",s.style.borderRadius="50%",s.style.width=e?"2.4rem":"3rem",s.style.height=e?"2.4rem":"3rem",s.style.display="flex",s.style.alignItems="center",s.style.justifyContent="center",s.style.cursor="pointer",s.style.pointerEvents="auto",s.style.touchAction="manipulation",s.style.transform="scale(1)",s.style.transition="transform 0.08s ease-out",a();const n=()=>{s.style.transform="scale(1)"};return s.addEventListener("pointerdown",o=>{o.stopPropagation(),s.style.transform="scale(0.9)",l.onToggle()}),s.addEventListener("pointerup",n),s.addEventListener("pointercancel",n),s.addEventListener("pointerleave",n),l.container.appendChild(s),{element:s,setMuted(o){i=o,a()},remove(){s.remove()}}}class Fe{overlay=null;toggleButton=null;descriptionEl=null;highContrast=!1;colorVisionSupportMode="color-only";vibrationIntensity="medium";motionSensitivity="strong";restReminderEnabled=!0;colorVisionDescriptionEl=null;colorVisionButtons=new Map;vibrationDescriptionEl=null;vibrationButtons=new Map;motionDescriptionEl=null;motionButtons=new Map;restReminderDescriptionEl=null;restReminderToggleButton=null;motionPreviewEl=null;motionPreviewTokenEl=null;motionPreviewCaptionEl=null;motionPreviewTimeoutId=null;motionPreviewFrameId=null;onToggle=null;onColorVisionSupportModeChange=null;onVibrationIntensityChange=null;onMotionSensitivityChange=null;onRestReminderToggle=null;show(t){const e=document.getElementById("ui-overlay");if(e){if(this.highContrast=t.initialHighContrast,this.colorVisionSupportMode=t.initialColorVisionSupportMode,this.vibrationIntensity=t.initialVibrationIntensity,this.motionSensitivity=t.initialMotionSensitivity,this.restReminderEnabled=t.initialRestReminderEnabled,this.onToggle=t.onToggle,this.onColorVisionSupportModeChange=t.onColorVisionSupportModeChange,this.onVibrationIntensityChange=t.onVibrationIntensityChange,this.onMotionSensitivityChange=t.onMotionSensitivityChange,this.onRestReminderToggle=t.onRestReminderToggle,!this.overlay){this.overlay=document.createElement("div"),this.overlay.setAttribute("data-color-accessibility-settings",""),this.overlay.style.cssText=`
      ...
      `;const h=[{value:"color-only",label:"いろだけ",icon:"🎨"},{value:"color-and-marks",label:"いろとマーク",icon:"★"}];for(const S of h){const C=document.createElement("button");C.setAttribute("data-color-vision-mode-button",S.value),C.textContent=`${S.icon} ${S.label}`,C.style.cssText=`
          min-height: 3.25rem;
        ...
        `,C.addEventListener("click",()=>{this.colorVisionSupportMode=S.value,this.render(),this.onColorVisionSupportModeChange?.(S.value)}),this.colorVisionButtons.set(S.value,C),o.appendChild(C)}const c=document.createElement("h3");c.textContent="しんどうの つよさ",c.style.cssText="margin: 0.9rem 0 0.45rem; font-size: clamp(1rem, 3.8vmin, 1.2rem);",this.vibrationDescriptionEl=document.createElement("p"),this.vibrationDescriptionEl.style.cssText="margin: 0 0 0.8rem; font-size: clamp(0.9rem, 3.2vmin, 1rem); line-height: 1.5;";const d=document.createElement("div");d.setAttribute("data-vibration-intensity-group",""),d.style.cssText=`
        display: grid;
        grid-template-columns: repeat(2, minmax(0, 1fr));
        gap: 0.65rem;
        margin-bottom: 0.95rem;
      `;const f=[{value:"strong",label:"つよい"},{value:"medium",label:"ふつう"},{value:"weak",label:"やさしい"},{value:"off",label:"オフ"}];for(const S of f){const C=document.createElement("button");C.setAttribute("data-vibration-intensity-button",S.value),C.textContent=S.label,C.style.cssText=`
          min-height: 3.25rem;
          padding: 0.8rem 0.9rem;
          border-radius: 1rem;
          border: 2px solid rgba(255, 255, 255, 0.4);
      ...
      `;const u=["strong","medium","gentle","minimal"];for(const S of u){const C=it(S),A=document.createElement("button");A.setAttribute("data-motion-sensitivity-button",S),A.style.cssText=`
          ...
          touch-action: manipulation;
          transition: transform 0.08s ease-out, border-color 0.12s ease-out, background 0.12s ease-out;
        `;const T=document.createElement("span");T.textContent=C.emoji,T.style.cssText="font-size: clamp(1.25rem, 4.8vmin, 1.7rem); line-height: 1;";const E=document.createElement("span");E.textContent=C.stars,E.style.cssText="font-size: clamp(0.82rem, 2.9vmin, 0.95rem); letter-spacing: 0.08em;";const x=document.createElement("span");x.textContent=C.shortLabel,x.style.cssText="font-size: clamp(0.9rem, 3vmin, 1rem);",A.append(T,E,x),A.addEventListener("click",()=>{this.motionSensitivity=S,this.render(),this.playMotionPreview(),this.onMotionSensitivityChange?.(S)}),this.motionButtons.set(S,A),r.appendChild(A)}this.motionPreviewEl=document.createElement("div"),this.motionPreviewEl.setAttribute("data-motion-preview",""),this.motionPreviewEl.style.cssText=`
        position: relative;
        min-height: 5.8rem;
        margin: 0 0 1rem;
        padding: 0.8rem 0.9rem;
    ...
    `;const p=Array.from({length:I},(u,w)=>w+1).map(u=>({stageNumber:u,clearCount:i.stageClearCounts[u]??0})).filter(u=>u.clearCount>0);if(p.length===0){const u=document.createElement("div");u.textContent="まだ きろくが ないよ",u.style.cssText=`
      ...
      `,y.appendChild(u)}else for(const{stageNumber:u,clearCount:w}of p){const g=_(u),m=document.createElement("div");m.setAttribute("data-stats-stage-clear-row",String(u)),m.style.cssText=`
          ...
          font-weight: 700;
        `;const S=document.createElement("span");S.textContent=`${g.emoji} ステージ ${u} ${g.destinationReading}`;const C=document.createElement("span");C.textContent=`${w}かい`,C.style.color="#FFE66D",m.append(S,C),y.appendChild(m)}d.appendChild(y),o.appendChild(d);const r=document.createElement("button");r.textContent="もどる",r.style.cssText=`
      margin-top: 1rem;
    ...
    `;const n=document.createElement("div");return n.textContent=e,n.style.cssText=`
      ...
      font-weight: 900;
      color: #FFE66D;
    `,i.append(a,n),i}}function Ot(l,t){if(!Number.isFinite(l)||l<=0||t<=0)return"ずかん";const e=Math.min(l,t);return e>=t?`ずかん ${t} / ${t} 🎉`:`ずかん ${e} / ${t}`}function We(l){switch(l){case"hero":return{gap:"0.35rem",label:"0.92rem",medal:"1.7rem",hint:"0.98rem"};case"compact":return{gap:"0.18rem",label:"0.7rem",medal:"1rem",hint:"0.76rem"};default:return{gap:"0.26rem",label:"0.8rem",medal:"1.25rem",hint:"0.84rem"}}}function vt(l,t,e={}){const s=zt(l,t),i=e.size??"regular",a=We(i),n=document.createElement("div");if(n.setAttribute("data-stage-medal-display",""),n.setAttribute("data-stage-medal-stage",String(l)),n.setAttribute("data-stage-medal-tier",s.tier),n.setAttribute("data-stage-medal-earned",String(s.earnedCount)),e.scope&&n.setAttribute("data-stage-medal-scope",e.scope),n.style.cssText=`
    display: flex;
    flex-direction: column;
    align-items: center;
    gap: ${a.gap};
  ...
  `,n.appendChild(c),n}const It=2e3,rt=new Map,lt=new Map,ht=new Map;let J=null,tt=null;function et(l,t){if(typeof document>"u"){const s=typeof OffscreenCanvas=="function",i=s?new OffscreenCanvas(l,t):{width:l,height:t};return{canvas:i,ctx:s?i.getContext("2d"):null}}const e=document.createElement("canvas");return e.width=l,e.height=t,{canvas:e,ctx:e.getContext("2d")}}function W(l,t){let e=rt.get(l);return e||(e=t(),e.generateMipmaps=!1,e.minFilter=He,e.needsUpdate=!0,rt.set(l,e)),e}function B(l,t){let e=lt.get(l);return e||(e=t(),lt.set(l,e)),e}function R(l,t){let e=ht.get(l);return e||(e=t(),ht.set(l,e)),e}function k(l,t){const e=new ze(l,t);return e.userData.sharedAssets=!0,e}function Vt(){if(!J){const l=new xt,t=new Float32Array(It*3);for(let e=0;e<It*3;e+=3)t[e]=(Math.random()-.5)*200,t[e+1]=(Math.random()-.5)*200,t[e+2]=(Math.random()-.5)*400;l.setAttribute("position",new wt(t,3)),J=l}tt||(tt=new At({color:16777215,size:.2,sizeAttenuation:!0}))}function Ue(){const{canvas:l,ctx:t}=et(256,256);if(!t)return new H(l);t.fillStyle="#888888",t.fillRect(0,0,256,256);for(let e=0;e<30;e++){const s=Math.random()*256,i=Math.random()*256,a=3+Math.random()*12;t.beginPath(),t.arc(s,i,a,0,Math.PI*2),t.fillStyle=`rgba(60,60,60,${.3+Math.random()*.4})`,t.fill()}return new H(l)}function Ze(){const{canvas:l,ctx:t}=et(256,256);if(!t)return new H(l);t.fillStyle="#ddaa44",t.fillRect(0,0,256,256);for(let e=0;e<8;e++){t.beginPath();const s=128+(Math.random()-.5)*100,i=128+(Math.random()-.5)*100;t.strokeStyle=`rgba(200,150,60,${.3+Math.random()*.3})`,t.lineWidth=3+Math.random()*5;for(let a=0;a<Math.PI*4;a+=.1){const n=10+a*8;t.lineTo(s+Math.cos(a)*n,i+Math.sin(a)*n)}t.stroke()}return new H(l)}function qe(){const{canvas:l,ctx:t}=et(256,256);if(!t)return new H(l);const e=["#cc7733","#dd9955","#bb6622","#eebb77","#aa5511","#ddaa66"];for(let s=0;s<256;s++){const i=Math.floor(s/(256/e.length))%e.length;t.fillStyle=e[i],t.fillRect(0,s,256,1)}return new H(l)}function Ye(){const{canvas:l,ctx:t}=et(512,256);return t?(t.fillStyle="#2266aa",t.fillRect(0,0,512,256),t.fillStyle="#886644",t.beginPath(),t.ellipse(300,80,80,40,.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(280,150,30,50,.1,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(100,90,25,60,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(110,170,20,40,-.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(420,170,25,15,0,0,Math.PI*2),t.fill(),t.fillStyle="#447733",t.beginPath(),t.ellipse(290,75,40,20,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(95,85,15,30,.2,0,Math.PI*2),t.fill(),new H(l)):new H(l)}function Xe(){const{canvas:l,ctx:t}=et(512,256);if(!t)return new H(l);t.clearRect(0,0,512,256),t.fillStyle="rgba(255,255,255,0.6)";for(let e=0;e<20;e++){const s=Math.random()*512,i=Math.random()*256;t.beginPath(),t.ellipse(s,i,20+Math.random()*40,8+Math.random()*15,Math.random()*Math.PI,0,Math.PI*2),t.fill()}return new H(l)}function Qe(){rt.clear(),lt.clear(),ht.clear(),J=null,tt=null}const Ke={planetTextureCache:rt,planetGeometryCache:lt,planetMaterialCache:ht,getBgStarsGeometry:()=>J,getBgStarsMaterial:()=>tt};function Wt(l,t,e){const s=new ot;let i=null;switch(l){case 2:{const a=W("mercury",Ue),n=B("mercury:sphere",()=>new z(10,24,24)),o=R("mercury:mat",()=>new P({map:a})),h=k(n,o);s.add(h),i=h;break}case 3:{const a=W("venus",Ze),n=B("venus:sphere",()=>new z(14,24,24)),o=R("venus:mat",()=>new P({map:a})),h=k(n,o);s.add(h),i=h;break}case 5:{const a=W("jupiter",qe),n=B("jupiter:sphere",()=>new z(20,24,24)),o=R("jupiter:mat",()=>new P({map:a})),h=k(n,o);s.add(h),i=h;break}case 6:{const a=B("saturn:sphere",()=>new z(15,24,24)),n=t.planetColor,o=R(`saturn:mat:${n}`,()=>new P({color:n})),h=k(a,o);s.add(h);const c=B("saturn:ring",()=>new kt(20,30,48)),d=R("saturn:ringMat",()=>new P({color:15645542,side:Rt})),f=k(c,d);f.rotation.x=Math.PI/3,s.add(f),i=h;break}case 7:{const a=B("uranus:sphere",()=>new z(16,24,24)),n=R("uranus:mat",()=>new P({color:6737117})),o=k(a,n);s.add(o);const h=B("uranus:ring",()=>new kt(21,28,48)),c=R("uranus:ringMat",()=>new P({color:10083822,side:Rt})),d=k(h,c);d.rotation.z=Math.PI/2,s.add(d),i=o;break}case 9:{const a=B("pluto:sphere",()=>new z(8,24,24)),n=R("pluto:mat",()=>new P({color:12298922})),o=k(a,n);s.add(o),i=o;break}case 10:{const a=B("sun:sphere",()=>new z(25,24,24)),n=R("sun:mat",()=>new P({color:16763904,emissive:16755200,emissiveIntensity:.5})),o=k(a,n);s.add(o),s.add(new Le(16763904,2,200)),i=o;break}case 11:{const a=W("earth",Ye),n=B("earth:sphere",()=>new z(15,32,32)),o=R("earth:mat",()=>new P({map:a})),h=W("earth:cloud",Xe),c=B("earth:cloudSphere",()=>new z(15.5,32,32)),d=R("earth:cloudMat",()=>new P({map:h,transparent:!0,opacity:.3})),f=new ot;f.add(k(n,o)),f.add(k(c,d)),s.add(f),i=f;break}default:{const a=B("default:sphere",()=>new z(15,24,24)),n=t.planetColor,o=R(`default:mat:${n}`,()=>new P({color:n})),h=k(a,o);s.add(h),i=h;break}}return s.position.set(0,0,e),{planet:s,spinTarget:i}}function Ut(l,t,e){return Wt(l,t,e)}function Zt(l){Vt();const t=new Ct(J,tt);return t.userData.sharedAssets=!0,t.geometry.setDrawRange(0,l),t}function Pt(l){!Number.isInteger(l)||l<1||l>I||typeof document>"u"&&typeof OffscreenCanvas!="function"||(Vt(),Wt(l,_(l),0))}let Z=null,q=null;function Je(){if(!Z){const l=new xt,t=new Float32Array(3e3);for(let e=0;e<3e3;e++)t[e]=(Math.random()-.5)*200;l.setAttribute("position",new wt(t,3)),Z=l}return Z}function ts(){return q||(q=new At({color:16777215,size:.3,sizeAttenuation:!0})),q}function es(){Z=null,q=null}const ss={getBgStarsGeometry:()=>Z,getBgStarsMaterial:()=>q};function is(l){const t=window.requestIdleCallback;if(typeof t=="function"){t(l,{timeout:1500});return}window.setTimeout(l,800)}function qt(l){return new Set(l.filter(t=>Number.isInteger(t)&&t>=1&&t<=I)).size}function as(l){return qt(l)>=I}function ft(l){const t=as(l.unlockedPlanets),e=t?1:Math.min(l.clearedStage+1,I),s=_(e),i=l.bestStageStars?.[e]??0,a=l.colorAccessibility?.colorVisionSupportMode??G,n=Gt(e,s.destinationReading,a);return t?{startStage:e,destination:n,emoji:s.emoji,statusLabel:"ぜんぶ あつめたよ！",destinationLabel:`${n}へ もういちど しゅっぱつ！`,buttonHint:`${s.emoji} ステージ ${e} から もういちど あそぶ`,bestStars:i}:{startStage:e,destination:n,emoji:s.emoji,statusLabel:l.clearedStage>0?"つづきから しゅっぱつ！":"はじめての しゅっぱつ！",destinationLabel:`${n}へ むかおう！`,buttonHint:`${s.emoji} ステージ ${e} から スタート`,bestStars:i}}function ns(l){return l.clearedStage>0||qt(l.unlockedPlanets)>0||Object.keys(l.bestStageStars??{}).length>0}class os{threeScene;ambientLight=new dt(16777215,1);camera;lastAspect=0;sceneManager;saveManager;audioManager;stars=null;companionParade=null;overlay=null;muteHandle=null;tutorialOverlay=new Tt;titleResetConfirmOverlay=new Ne;colorAccessibilitySettings=new Fe;spaceshipCustomizer=new _e;statsOverlay=new Ve;encyclopediaOverlay=null;encyclopediaOverlayPromise=null;companionFactory=null;companionFactoryPromise=null;loadEncyclopediaOverlay;loadTitleCompanionFactory;loadingOverlay;loadFailureOverlay;scheduleIdleTask;encyclopediaBtn=null;isOpeningEncyclopedia=!1;isActive=!1;encyclopediaRequestToken=0;companionParadeRequestToken=0;bgmPending=!1;overlayButtonCleanups=new Set;constructor(t,e,s,i={}){this.sceneManager=t,this.saveManager=e,this.audioManager=s,this.loadingOverlay=i.loadingOverlay??new Xt,this.loadFailureOverlay=i.loadFailureOverlay??new Qt,this.scheduleIdleTask=i.scheduleIdleTask??is,this.loadEncyclopediaOverlay=i.loadEncyclopediaOverlay??(()=>bt(()=>import("./EncyclopediaOverlay-DEiZqSwT.js"),__vite__mapDeps([0,1,2]))),this.loadTitleCompanionFactory=i.loadTitleCompanionFactory??(()=>bt(()=>import("./game-core-Lpf1DKkL.js").then(o=>o.ah),__vite__mapDeps([1,2]))),this.threeScene=new Q,this.threeScene.background=new K(32);const{width:a,height:n}=L();this.camera=new ut(60,a/n,.1,1e3),this.camera.position.set(0,0,5)}enter(t){this.isActive=!0,this.encyclopediaRequestToken+=1,this.companionParadeRequestToken+=1,this.lastAspect=0,this.stars=new Ct(Je(),ts()),this.stars.userData.sharedAssets=!0,this.stars.rotation.set(0,0,0),this.threeScene.add(this.stars),this.ambientLight.parent||this.threeScene.add(this.ambientLight);const e=this.saveManager.load();this.createCompanionParade(e.unlockedPlanets),this.createOverlay(),this.createMuteButton(),this.prefetchEncyclopediaOnIdle(),this.prewarmNextAdventureOnIdle(ft(e).startStage),this.audioManager.isInitialized()?(this.audioManager.playBGM(0),this.bgmPending=!1):this.bgmPending=!0,e.tutorialShown||this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide(),this.saveManager.markTutorialShown()})}createMuteButton(){const t=document.getElementById("hud")??document.getElementById("ui-overlay");t&&(this.muteHandle=Mt({initialMuted:this.audioManager.isMuted(),container:t,onToggle:()=>{this.ensureTitleAudioInitialized(!0);const e=this.audioManager.toggleMute();this.muteHandle?.setMuted(e);const s=this.saveManager.load();s.muted=e,this.saveManager.save(s)}}))}getEncyclopediaOverlay(){return this.encyclopediaOverlay?Promise.resolve(this.encyclopediaOverlay):this.encyclopediaOverlayPromise?this.encyclopediaOverlayPromise:(this.encyclopediaOverlayPromise=this.loadEncyclopediaOverlay().then(({EncyclopediaOverlay:t})=>{const e=new t;return this.encyclopediaOverlay=e,e}).finally(()=>{this.encyclopediaOverlayPromise=null}),this.encyclopediaOverlayPromise)}getTitleCompanionFactory(){return this.companionFactory?Promise.resolve(this.companionFactory):this.companionFactoryPromise?this.companionFactoryPromise:(this.companionFactoryPromise=this.loadTitleCompanionFactory().then(t=>(this.companionFactory=t,t)).finally(()=>{this.companionFactoryPromise=null}),this.companionFactoryPromise)}showEncyclopedia(){if(!this.isActive||!this.encyclopediaOverlay)return;const t=this.saveManager.load();this.encyclopediaOverlay.show(t.unlockedPlanets,()=>this.refreshEncyclopediaButtonLabel(),e=>{this.ensureTitleAudioInitialized(!1),this.sceneManager.requestTransition("stage",{stageNumber:e,totalScore:0,totalStarCount:0,launchSource:"encyclopedia"})},t.bestStageStars??{},t.discoveredConstellations??[],t.colorAccessibility?.colorVisionSupportMode??G,t.discoveredMonthlyEncounters??[])}isCurrentEncyclopediaRequest(t){return this.isActive&&this.encyclopediaRequestToken===t}prefetchEncyclopediaOnIdle(){const t=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{!this.isCurrentEncyclopediaRequest(t)||this.encyclopediaOverlay||this.encyclopediaOverlayPromise||this.getEncyclopediaOverlay().catch(()=>{})})}prewarmNextAdventureOnIdle(t){if(t>I)return;const e=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{this.isCurrentEncyclopediaRequest(e)&&Pt(t)})}async openEncyclopedia(){if(!this.isActive)return;if(this.loadFailureOverlay.hide(),this.encyclopediaOverlay){this.showEncyclopedia();return}if(this.isOpeningEncyclopedia)return;const t=this.encyclopediaRequestToken;this.isOpeningEncyclopedia=!0,this.loadingOverlay.show("ずかんを よんでるよ...");try{if(await this.getEncyclopediaOverlay(),!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),this.showEncyclopedia()}catch(e){if(!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),console.error("Failed to load encyclopedia overlay",e),this.loadFailureOverlay.show({title:"ずかんを もういちど よんでみよう！",message:"「もういちど よむ」を おして つづきを たのしもう！",primaryAction:{label:"もういちど よむ",onSelect:()=>this.openEncyclopedia()}})}finally{this.encyclopediaRequestToken===t&&(this.isOpeningEncyclopedia=!1)}}persistHighContrastSetting(t){const e=this.saveManager.load(),s=e.colorAccessibility?.motionSensitivity??N,i=e.colorAccessibility?.colorVisionSupportMode??G;e.colorAccessibility=this.buildColorAccessibilitySettings(t,s,i),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}persistVibrationIntensitySetting(t){const e=this.saveManager.load();e.vibrationSettings={intensity:t},this.saveManager.save(e),Ht(t)}persistRestReminderSetting(t){const e=this.saveManager.load();e.restReminderSettings={enabled:t},this.saveManager.save(e)}persistMotionSensitivitySetting(t){const e=this.saveManager.load(),s=e.colorAccessibility?.highContrast===!0,i=e.colorAccessibility?.colorVisionSupportMode??G;e.colorAccessibility=this.buildColorAccessibilitySettings(s,t,i),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}persistColorVisionSupportModeSetting(t){const e=this.saveManager.load(),s=e.colorAccessibility?.highContrast===!0,i=e.colorAccessibility?.motionSensitivity??N;e.colorAccessibility=this.buildColorAccessibilitySettings(s,i,t),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}buildColorAccessibilitySettings(t,e,s){if(!(!t&&e===N&&s===G))return{...t?{highContrast:!0}:{},...e!==N?{motionSensitivity:e}:{},...s!==G?{colorVisionSupportMode:s}:{}}}createOverlay(){const t=document.getElementById("ui-overlay");if(!t)return;const e=this.saveManager.load(),s=ft(e),i=ns(e);this.overlay=document.createElement("div"),this.overlay.style.cssText=`
    ...
    `;const S=document.createElement("button");S.setAttribute("data-spaceship-customizer-button",""),S.textContent="うちゅうせんをかざろう",S.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(M(S,{onActivate:()=>{const b=this.saveManager.load();this.spaceshipCustomizer.show({initialCustomization:b.spaceshipCustomization??Et,onComplete:D=>{const st=this.saveManager.load();st.spaceshipCustomization=D,this.saveManager.save(st)}})},onPressChange:b=>{S.style.transform=b?"scale(0.96)":"scale(1)"}}));const C=document.createElement("button");C.setAttribute("data-stats-button",""),C.textContent="あそびの きろく",C.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${a?"0.9rem":"1.05rem"};
      font-weight: 900;
      padding: ${a?"0.55rem 0.65rem":"0.7rem 0.85rem"};
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(M(C,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.statsOverlay.show(this.saveManager.load().gameplayStats,()=>{})},onPressChange:b=>{C.style.transform=b?"scale(0.96)":"scale(1)"}}));const A=document.createElement("div");A.setAttribute("data-title-footer-actions",""),A.style.cssText=`
      display: grid;
    ...
    `,this.overlayButtonCleanups.add(M(E,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.colorAccessibilitySettings.show({initialHighContrast:this.saveManager.load().colorAccessibility?.highContrast===!0,initialColorVisionSupportMode:this.saveManager.load().colorAccessibility?.colorVisionSupportMode??G,initialVibrationIntensity:this.saveManager.load().vibrationSettings?.intensity??"medium",initialMotionSensitivity:this.saveManager.load().colorAccessibility?.motionSensitivity??N,initialRestReminderEnabled:this.saveManager.load().restReminderSettings?.enabled??Kt,onToggle:b=>this.persistHighContrastSetting(b),onColorVisionSupportModeChange:b=>this.persistColorVisionSupportModeSetting(b),onVibrationIntensityChange:b=>this.persistVibrationIntensitySetting(b),onMotionSensitivityChange:b=>this.persistMotionSensitivitySetting(b),onRestReminderToggle:b=>this.persistRestReminderSetting(b)})},onPressChange:b=>{E.style.transform=b?"scale(0.96)":"scale(1)"}}));const x=document.createElement("button");if(x.textContent=Ot(e.unlockedPlanets.length,U.length),x.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.encyclopediaBtn=x,this.overlayButtonCleanups.add(M(x,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.openEncyclopedia()},onPressChange:b=>{x.style.transform=b?"scale(0.96)":"scale(1)"}})),r.appendChild(u),r.appendChild(g),r.appendChild(w),m.appendChild(S),m.appendChild(C),i){const b=document.createElement("button");b.setAttribute("data-reset-progress-button",""),b.textContent="さいしょから",b.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: ${a?"0.9rem":"1.05rem"};
        font-weight: 900;
        padding: ${a?"0.55rem 0.65rem":"0.7rem 0.85rem"};
    ...
    `,document.head.appendChild(t)}}const cs=1,ds=.4;class Dt{overlayEl=null;numberEl=null;phase="idle";elapsed=0;currentStep=0;stepDuration;goDuration;onTick;onGo;onComplete=null;steps=["3","2","1"];constructor(t={}){this.stepDuration=t.stepDuration??cs,this.goDuration=t.goDuration??ds,this.onTick=t.onTick,this.onGo=t.onGo}show(t){if(this.phase!=="idle"&&this.phase!=="done")return;const e=document.getElementById("ui-overlay")??document.body;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-countdown-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
