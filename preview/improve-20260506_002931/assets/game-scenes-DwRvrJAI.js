const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-Cx7wQPcG.js","assets/game-core-TRzzez5v.js","assets/three-BsQe5WE2.js"])))=>i.map(i=>d[i]);
import{g as it,D as Et,S as _,T as I,a as F,b as Gt,L as Qt,c as Kt,_ as bt,d as L,e as z,f as $,s as Ht,h as nt,i as zt,j as Jt,P as W,u as Nt,C as te,k as ee,l as se,B as ie,m as ne,M as ae,n as oe,o as re,p as le,q as he,r as ce,t as de,v as ue,w as me,x as pe,y as fe,z as ge,A as Ft,W as ye,E as be,F as ve,G as _t,H as Ee,I as St,J as Se,K as xe,R as Ce,N as we,O as Ae,Q as Te,U as Me,V as Bt,X as $t,Y as Pe,Z as at,$ as V,a0 as Be,a1 as mt,a2 as Re,a3 as pt,a4 as ke,a5 as Oe,a6 as Ie,a7 as De,a8 as Le}from"./game-core-TRzzez5v.js";import{n as xt,l as Ct,j as wt,m as At,G as ot,r as Ge,a as He,s as ze,M as P,h as G,D as Rt,R as kt,t as H,u as dt,v as Q,i as K,P as ut,V as j,w as jt,x as Ne}from"./three-BsQe5WE2.js";class Tt{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const e=document.getElementById("ui-overlay");if(!e)return;const s=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
    ...
    `,a.appendChild(o),a.appendChild(h),a.appendChild(c),a}isCompactHeight(){return window.innerHeight<=Tt.COMPACT_HEIGHT_THRESHOLD}injectAnimations(){if(document.getElementById("tutorial-animations"))return;const t=document.createElement("style");t.id="tutorial-animations",t.textContent=`
      @keyframes swipe {
    ...
    `;const p=Array.from({length:I},(u,w)=>w+1).map(u=>({stageNumber:u,clearCount:i.stageClearCounts[u]??0})).filter(u=>u.clearCount>0);if(p.length===0){const u=document.createElement("div");u.textContent="まだ きろくが ないよ",u.style.cssText=`
      ...
      `,y.appendChild(u)}else for(const{stageNumber:u,clearCount:w}of p){const g=F(u),m=document.createElement("div");m.setAttribute("data-stats-stage-clear-row",String(u)),m.style.cssText=`
          display: flex;
          align-items: center;
    ...
    `;const a=document.createElement("div");return a.textContent=e,a.style.cssText=`
      ...
      font-weight: 900;
      color: #FFE66D;
    `,i.append(n,a),i}}function Ot(l,t){if(!Number.isFinite(l)||l<=0||t<=0)return"ずかん";const e=Math.min(l,t);return e>=t?`ずかん ${t} / ${t} 🎉`:`ずかん ${e} / ${t}`}function We(l){switch(l){case"hero":return{gap:"0.35rem",label:"0.92rem",medal:"1.7rem",hint:"0.98rem"};case"compact":return{gap:"0.18rem",label:"0.7rem",medal:"1rem",hint:"0.76rem"};default:return{gap:"0.26rem",label:"0.8rem",medal:"1.25rem",hint:"0.84rem"}}}function vt(l,t,e={}){const s=Gt(l,t),i=e.size??"regular",n=We(i),a=document.createElement("div");if(a.setAttribute("data-stage-medal-display",""),a.setAttribute("data-stage-medal-stage",String(l)),a.setAttribute("data-stage-medal-tier",s.tier),a.setAttribute("data-stage-medal-earned",String(s.earnedCount)),e.scope&&a.setAttribute("data-stage-medal-scope",e.scope),a.style.cssText=`
    display: flex;
    flex-direction: column;
    align-items: center;
    gap: ${n.gap};
  `,e.label){const d=document.createElement("div");d.textContent=e.label,d.style.cssText=`
    ...
    `,a.appendChild(d)}const o=document.createElement("div");o.style.cssText=`
    display: flex;
    align-items: center;
    justify-content: center;
    gap: ${n.gap};
  ...
  `,a.appendChild(c),a}const It=2e3,rt=new Map,lt=new Map,ht=new Map;let J=null,tt=null;function et(l,t){if(typeof document>"u"){const s=typeof OffscreenCanvas=="function",i=s?new OffscreenCanvas(l,t):{width:l,height:t};return{canvas:i,ctx:s?i.getContext("2d"):null}}const e=document.createElement("canvas");return e.width=l,e.height=t,{canvas:e,ctx:e.getContext("2d")}}function U(l,t){let e=rt.get(l);return e||(e=t(),e.generateMipmaps=!1,e.minFilter=ze,e.needsUpdate=!0,rt.set(l,e)),e}function B(l,t){let e=lt.get(l);return e||(e=t(),lt.set(l,e)),e}function R(l,t){let e=ht.get(l);return e||(e=t(),ht.set(l,e)),e}function k(l,t){const e=new He(l,t);return e.userData.sharedAssets=!0,e}function Vt(){if(!J){const l=new Ct,t=new Float32Array(It*3);for(let e=0;e<It*3;e+=3)t[e]=(Math.random()-.5)*200,t[e+1]=(Math.random()-.5)*200,t[e+2]=(Math.random()-.5)*400;l.setAttribute("position",new wt(t,3)),J=l}tt||(tt=new At({color:16777215,size:.2,sizeAttenuation:!0}))}function Ze(){const{canvas:l,ctx:t}=et(256,256);if(!t)return new H(l);t.fillStyle="#888888",t.fillRect(0,0,256,256);for(let e=0;e<30;e++){const s=Math.random()*256,i=Math.random()*256,n=3+Math.random()*12;t.beginPath(),t.arc(s,i,n,0,Math.PI*2),t.fillStyle=`rgba(60,60,60,${.3+Math.random()*.4})`,t.fill()}return new H(l)}function qe(){const{canvas:l,ctx:t}=et(256,256);if(!t)return new H(l);t.fillStyle="#ddaa44",t.fillRect(0,0,256,256);for(let e=0;e<8;e++){t.beginPath();const s=128+(Math.random()-.5)*100,i=128+(Math.random()-.5)*100;t.strokeStyle=`rgba(200,150,60,${.3+Math.random()*.3})`,t.lineWidth=3+Math.random()*5;for(let n=0;n<Math.PI*4;n+=.1){const a=10+n*8;t.lineTo(s+Math.cos(n)*a,i+Math.sin(n)*a)}t.stroke()}return new H(l)}function Ye(){const{canvas:l,ctx:t}=et(256,256);if(!t)return new H(l);const e=["#cc7733","#dd9955","#bb6622","#eebb77","#aa5511","#ddaa66"];for(let s=0;s<256;s++){const i=Math.floor(s/(256/e.length))%e.length;t.fillStyle=e[i],t.fillRect(0,s,256,1)}return new H(l)}function Xe(){const{canvas:l,ctx:t}=et(512,256);return t?(t.fillStyle="#2266aa",t.fillRect(0,0,512,256),t.fillStyle="#886644",t.beginPath(),t.ellipse(300,80,80,40,.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(280,150,30,50,.1,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(100,90,25,60,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(110,170,20,40,-.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(420,170,25,15,0,0,Math.PI*2),t.fill(),t.fillStyle="#447733",t.beginPath(),t.ellipse(290,75,40,20,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(95,85,15,30,.2,0,Math.PI*2),t.fill(),new H(l)):new H(l)}function Qe(){const{canvas:l,ctx:t}=et(512,256);if(!t)return new H(l);t.clearRect(0,0,512,256),t.fillStyle="rgba(255,255,255,0.6)";for(let e=0;e<20;e++){const s=Math.random()*512,i=Math.random()*256;t.beginPath(),t.ellipse(s,i,20+Math.random()*40,8+Math.random()*15,Math.random()*Math.PI,0,Math.PI*2),t.fill()}return new H(l)}function Ke(){rt.clear(),lt.clear(),ht.clear(),J=null,tt=null}const Je={planetTextureCache:rt,planetGeometryCache:lt,planetMaterialCache:ht,getBgStarsGeometry:()=>J,getBgStarsMaterial:()=>tt};function Ut(l,t,e){const s=new ot;let i=null;switch(l){case 2:{const n=U("mercury",Ze),a=B("mercury:sphere",()=>new G(10,24,24)),o=R("mercury:mat",()=>new P({map:n})),h=k(a,o);s.add(h),i=h;break}case 3:{const n=U("venus",qe),a=B("venus:sphere",()=>new G(14,24,24)),o=R("venus:mat",()=>new P({map:n})),h=k(a,o);s.add(h),i=h;break}case 5:{const n=U("jupiter",Ye),a=B("jupiter:sphere",()=>new G(20,24,24)),o=R("jupiter:mat",()=>new P({map:n})),h=k(a,o);s.add(h),i=h;break}case 6:{const n=B("saturn:sphere",()=>new G(15,24,24)),a=t.planetColor,o=R(`saturn:mat:${a}`,()=>new P({color:a})),h=k(n,o);s.add(h);const c=B("saturn:ring",()=>new kt(20,30,48)),d=R("saturn:ringMat",()=>new P({color:15645542,side:Rt})),f=k(c,d);f.rotation.x=Math.PI/3,s.add(f),i=h;break}case 7:{const n=B("uranus:sphere",()=>new G(16,24,24)),a=R("uranus:mat",()=>new P({color:6737117})),o=k(n,a);s.add(o);const h=B("uranus:ring",()=>new kt(21,28,48)),c=R("uranus:ringMat",()=>new P({color:10083822,side:Rt})),d=k(h,c);d.rotation.z=Math.PI/2,s.add(d),i=o;break}case 9:{const n=B("pluto:sphere",()=>new G(8,24,24)),a=R("pluto:mat",()=>new P({color:12298922})),o=k(n,a);s.add(o),i=o;break}case 10:{const n=B("sun:sphere",()=>new G(25,24,24)),a=R("sun:mat",()=>new P({color:16763904,emissive:16755200,emissiveIntensity:.5})),o=k(n,a);s.add(o),s.add(new Ge(16763904,2,200)),i=o;break}case 11:{const n=U("earth",Xe),a=B("earth:sphere",()=>new G(15,32,32)),o=R("earth:mat",()=>new P({map:n})),h=U("earth:cloud",Qe),c=B("earth:cloudSphere",()=>new G(15.5,32,32)),d=R("earth:cloudMat",()=>new P({map:h,transparent:!0,opacity:.3})),f=new ot;f.add(k(a,o)),f.add(k(c,d)),s.add(f),i=f;break}default:{const n=B("default:sphere",()=>new G(15,24,24)),a=t.planetColor,o=R(`default:mat:${a}`,()=>new P({color:a})),h=k(n,o);s.add(h),i=h;break}}return s.position.set(0,0,e),{planet:s,spinTarget:i}}function Wt(l,t,e){return Ut(l,t,e)}function Zt(l){Vt();const t=new xt(J,tt);return t.userData.sharedAssets=!0,t.geometry.setDrawRange(0,l),t}function Pt(l){!Number.isInteger(l)||l<1||l>I||typeof document>"u"&&typeof OffscreenCanvas!="function"||(Vt(),Ut(l,F(l),0))}let Z=null,q=null;function ts(){if(!Z){const l=new Ct,t=new Float32Array(3e3);for(let e=0;e<3e3;e++)t[e]=(Math.random()-.5)*200;l.setAttribute("position",new wt(t,3)),Z=l}return Z}function es(){return q||(q=new At({color:16777215,size:.3,sizeAttenuation:!0})),q}function ss(){Z=null,q=null}const is={getBgStarsGeometry:()=>Z,getBgStarsMaterial:()=>q};function ns(l){const t=window.requestIdleCallback;if(typeof t=="function"){t(l,{timeout:1500});return}window.setTimeout(l,800)}function qt(l){return new Set(l.filter(t=>Number.isInteger(t)&&t>=1&&t<=I)).size}function as(l){return qt(l)>=I}function ft(l){const t=as(l.unlockedPlanets),e=t?1:Math.min(l.clearedStage+1,I),s=F(e),i=l.bestStageStars?.[e]??0,n=l.colorAccessibility?.colorVisionSupportMode??z,a=zt(e,s.destinationReading,n);return t?{startStage:e,destination:a,emoji:s.emoji,statusLabel:"ぜんぶ あつめたよ！",destinationLabel:`${a}へ もういちど しゅっぱつ！`,buttonHint:`${s.emoji} ステージ ${e} から もういちど あそぶ`,bestStars:i}:{startStage:e,destination:a,emoji:s.emoji,statusLabel:l.clearedStage>0?"つづきから しゅっぱつ！":"はじめての しゅっぱつ！",destinationLabel:`${a}へ むかおう！`,buttonHint:`${s.emoji} ステージ ${e} から スタート`,bestStars:i}}function os(l){return l.clearedStage>0||qt(l.unlockedPlanets)>0||Object.keys(l.bestStageStars??{}).length>0}class rs{threeScene;ambientLight=new dt(16777215,1);camera;lastAspect=0;sceneManager;saveManager;audioManager;stars=null;companionParade=null;overlay=null;muteHandle=null;tutorialOverlay=new Tt;titleResetConfirmOverlay=new Fe;colorAccessibilitySettings=new _e;spaceshipCustomizer=new $e;statsOverlay=new Ue;encyclopediaOverlay=null;encyclopediaOverlayPromise=null;companionFactory=null;companionFactoryPromise=null;loadEncyclopediaOverlay;loadTitleCompanionFactory;loadingOverlay;loadFailureOverlay;scheduleIdleTask;encyclopediaBtn=null;isOpeningEncyclopedia=!1;isActive=!1;encyclopediaRequestToken=0;companionParadeRequestToken=0;bgmPending=!1;overlayButtonCleanups=new Set;constructor(t,e,s,i={}){this.sceneManager=t,this.saveManager=e,this.audioManager=s,this.loadingOverlay=i.loadingOverlay??new Qt,this.loadFailureOverlay=i.loadFailureOverlay??new Kt,this.scheduleIdleTask=i.scheduleIdleTask??ns,this.loadEncyclopediaOverlay=i.loadEncyclopediaOverlay??(()=>bt(()=>import("./EncyclopediaOverlay-Cx7wQPcG.js"),__vite__mapDeps([0,1,2]))),this.loadTitleCompanionFactory=i.loadTitleCompanionFactory??(()=>bt(()=>import("./game-core-TRzzez5v.js").then(o=>o.ah),__vite__mapDeps([1,2]))),this.threeScene=new Q,this.threeScene.background=new K(32);const{width:n,height:a}=L();this.camera=new ut(60,n/a,.1,1e3),this.camera.position.set(0,0,5)}enter(t){this.isActive=!0,this.encyclopediaRequestToken+=1,this.companionParadeRequestToken+=1,this.lastAspect=0,this.stars=new xt(ts(),es()),this.stars.userData.sharedAssets=!0,this.stars.rotation.set(0,0,0),this.threeScene.add(this.stars),this.ambientLight.parent||this.threeScene.add(this.ambientLight);const e=this.saveManager.load();this.createCompanionParade(e.unlockedPlanets),this.createOverlay(),this.createMuteButton(),this.prefetchEncyclopediaOnIdle(),this.prewarmNextAdventureOnIdle(ft(e).startStage),this.audioManager.isInitialized()?(this.audioManager.playBGM(0),this.bgmPending=!1):this.bgmPending=!0,e.tutorialShown||this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide(),this.saveManager.markTutorialShown()})}createMuteButton(){const t=document.getElementById("hud")??document.getElementById("ui-overlay");t&&(this.muteHandle=Mt({initialMuted:this.audioManager.isMuted(),container:t,onToggle:()=>{this.ensureTitleAudioInitialized(!0);const e=this.audioManager.toggleMute();this.muteHandle?.setMuted(e);const s=this.saveManager.load();s.muted=e,this.saveManager.save(s)}}))}getEncyclopediaOverlay(){return this.encyclopediaOverlay?Promise.resolve(this.encyclopediaOverlay):this.encyclopediaOverlayPromise?this.encyclopediaOverlayPromise:(this.encyclopediaOverlayPromise=this.loadEncyclopediaOverlay().then(({EncyclopediaOverlay:t})=>{const e=new t;return this.encyclopediaOverlay=e,e}).finally(()=>{this.encyclopediaOverlayPromise=null}),this.encyclopediaOverlayPromise)}getTitleCompanionFactory(){return this.companionFactory?Promise.resolve(this.companionFactory):this.companionFactoryPromise?this.companionFactoryPromise:(this.companionFactoryPromise=this.loadTitleCompanionFactory().then(t=>(this.companionFactory=t,t)).finally(()=>{this.companionFactoryPromise=null}),this.companionFactoryPromise)}showEncyclopedia(){if(!this.isActive||!this.encyclopediaOverlay)return;const t=this.saveManager.load();this.encyclopediaOverlay.show(t.unlockedPlanets,()=>this.refreshEncyclopediaButtonLabel(),e=>{this.ensureTitleAudioInitialized(!1),this.sceneManager.requestTransition("stage",{stageNumber:e,totalScore:0,totalStarCount:0,launchSource:"encyclopedia"})},t.bestStageStars??{},t.discoveredConstellations??[],t.colorAccessibility?.colorVisionSupportMode??z,t.discoveredMonthlyEncounters??[])}isCurrentEncyclopediaRequest(t){return this.isActive&&this.encyclopediaRequestToken===t}prefetchEncyclopediaOnIdle(){const t=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{!this.isCurrentEncyclopediaRequest(t)||this.encyclopediaOverlay||this.encyclopediaOverlayPromise||this.getEncyclopediaOverlay().catch(()=>{})})}prewarmNextAdventureOnIdle(t){if(t>I)return;const e=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{this.isCurrentEncyclopediaRequest(e)&&Pt(t)})}async openEncyclopedia(){if(!this.isActive)return;if(this.loadFailureOverlay.hide(),this.encyclopediaOverlay){this.showEncyclopedia();return}if(this.isOpeningEncyclopedia)return;const t=this.encyclopediaRequestToken;this.isOpeningEncyclopedia=!0,this.loadingOverlay.show("ずかんを よんでるよ...");try{if(await this.getEncyclopediaOverlay(),!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),this.showEncyclopedia()}catch(e){if(!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),console.error("Failed to load encyclopedia overlay",e),this.loadFailureOverlay.show({title:"ずかんを もういちど よんでみよう！",message:"「もういちど よむ」を おして つづきを たのしもう！",primaryAction:{label:"もういちど よむ",onSelect:()=>this.openEncyclopedia()}})}finally{this.encyclopediaRequestToken===t&&(this.isOpeningEncyclopedia=!1)}}persistHighContrastSetting(t){const e=this.saveManager.load(),s=e.colorAccessibility?.motionSensitivity??$(),i=e.colorAccessibility?.colorVisionSupportMode??z;e.colorAccessibility=this.buildColorAccessibilitySettings(t,s,i),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}persistVibrationIntensitySetting(t){const e=this.saveManager.load();e.vibrationSettings={intensity:t},this.saveManager.save(e),Ht(t)}persistRestReminderSetting(t){const e=this.saveManager.load();e.restReminderSettings={enabled:t},this.saveManager.save(e)}persistMotionSensitivitySetting(t){const e=this.saveManager.load(),s=e.colorAccessibility?.highContrast===!0,i=e.colorAccessibility?.colorVisionSupportMode??z;e.colorAccessibility=this.buildColorAccessibilitySettings(s,t,i),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}persistColorVisionSupportModeSetting(t){const e=this.saveManager.load(),s=e.colorAccessibility?.highContrast===!0,i=e.colorAccessibility?.motionSensitivity??$();e.colorAccessibility=this.buildColorAccessibilitySettings(s,i,t),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}buildColorAccessibilitySettings(t,e,s){const i=$();if(!(!t&&e===i&&s===z))return{...t?{highContrast:!0}:{},...e!==i?{motionSensitivity:e}:{},...s!==z?{colorVisionSupportMode:s}:{}}}createOverlay(){const t=document.getElementById("ui-overlay");if(!t)return;const e=this.saveManager.load(),s=ft(e),i=os(e);this.overlay=document.createElement("div"),this.overlay.style.cssText=`
    ...
    `;const f=document.createElement("div");f.textContent=s.destinationLabel,f.style.cssText=`
      ...
      font-weight: 700;
      color: rgba(255, 255, 255, 0.92);
    `;const y=Gt(s.startStage,s.bestStars),p=vt(s.startStage,s.bestStars,{label:"メダル",hint:y.nextThreshold===null?"かんぺき！":`${y.icon} いま ・ つぎ ⭐ ${y.nextThreshold}`,size:"regular",scope:"title-next-adventure"});p.style.marginTop=n?"0.35rem":"0.55rem",o.appendChild(h),o.appendChild(c),o.appendChild(d),o.appendChild(f),o.appendChild(p);const r=document.createElement("div");r.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
    ...
    `,this.overlay.appendChild(i),this.overlay.appendChild(n),this.overlay.appendChild(a),this.overlay.appendChild(this.exitCta),s.appendChild(this.overlay)}update(t){this.bgStars&&(this.bgStars.rotation.y+=t*.03),this.updateCelebration(t)}setupCelebration(){this.companionGroup=new ot,this.companionMeshes=[],this.circleX.length=0,this.circleZ.length=0,this.popinSettled.length=0,this.celebrationElapsed=0,this.thankYouShown=!1,this.canExit=!1,this.exitTriggered=!1;for(let t=0;t<W.length;t++){const e=W[t],s=St.createCompanionMesh(e),i=t*(2*Math.PI/W.length),n=Math.cos(i)*O.CIRCLE_RADIUS,a=Math.sin(i)*O.CIRCLE_RADIUS;this.circleX.push(n),this.circleZ.push(a),s.position.set(n,0,a),s.scale.set(0,0,0),this.companionMeshes.push(s),this.popinSettled.push(!1),this.companionGroup.add(s)}this.threeScene.add(this.companionGroup)}updateCelebration(t){if(this.companionMeshes.length===0)return;this.celebrationElapsed+=t;const e=O.POPIN_DELAY*(this.companionMeshes.length-1)+O.POPIN_DURATION,s=this.celebrationElapsed>e,i=s?Math.abs(Math.sin(this.celebrationElapsed*O.BOUNCE_SPEED))*O.BOUNCE_HEIGHT:0;for(let n=0;n<this.companionMeshes.length;n++){const a=this.companionMeshes[n];if(this.popinSettled[n]){s&&(a.position.y=i),a.rotation.y+=t*2;continue}const o=n*O.POPIN_DELAY;if(!(this.celebrationElapsed<o)){if(this.celebrationElapsed<o+O.POPIN_DURATION){const h=(this.celebrationElapsed-o)/O.POPIN_DURATION,c=this.bounceEase(h);a.scale.set(c,c,c)}else a.scale.set(1,1,1),this.popinSettled[n]=!0;s&&(a.position.y=i),a.rotation.y+=t*2}}!this.thankYouShown&&this.celebrationElapsed>=O.THANK_YOU_DELAY&&(this.showThankYouText(),this.thankYouShown=!0)}bounceEase(t){return t<.6?t/.6*1.2:1.2-(t-.6)/.4*.2}showThankYouText(){if(!this.overlay||!this.exitCta)return;const t=document.createElement("div");t.setAttribute("data-ending-thank-you",""),t.textContent="みんな ありがとう！",t.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: 2rem;
      font-weight: 900;
      color: #FFD700;
