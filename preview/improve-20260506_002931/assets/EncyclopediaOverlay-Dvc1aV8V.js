import{aj as k,ak as R,al as G,h as T,j as B,P as O,am as F,an as j,ao as Z,a4 as V,ap as X}from"./game-core-rJZxCOOc.js";import{v as Y,P as W,u as U,w as q}from"./three-BsQe5WE2.js";import{a as C,c as $}from"./game-scenes-_yMZ2j4D.js";const M=120,J=1.5,K=.015;function Q(A={}){const e=A.createRenderer??k,i=A.createPreviewMesh??R,t=A.raf??requestAnimationFrame,n=A.caf??cancelAnimationFrame;let a=!1,r=!1,s=null,l=null,d=null,o=null,m=null,h=null,g=null,f=null,c=!1;const p=()=>s||(s=document.createElement("canvas"),s.setAttribute("data-companion-preview-canvas",""),s.style.cssText=`
      width: 100%;
      height: 100%;
      display: block;
