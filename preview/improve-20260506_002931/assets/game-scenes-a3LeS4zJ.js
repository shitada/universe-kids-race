const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-Cj6IMXX5.js","assets/game-core-ayU1xai4.js","assets/three-CCkbs3tE.js"])))=>i.map(i=>d[i]);
import{g as K,D as ft,S as N,T as R,a as Y,b as Rt,L as $t,c as jt,_ as mt,d as L,e as F,s as Dt,f as tt,P as j,u as Ht,C as Wt,h as Ut,i as Zt,B as qt,j as Yt,M as Vt,k as Xt,l as Qt,m as Kt,n as Jt,o as te,p as ee,q as se,r as ie,t as ae,v as ne,W as oe,A as re,w as le,x as he,y as ce,z as Lt,E as de,F as ue,R as me,G as pe,H as fe,I as ge,J as ye,K as Tt,N as be,O as ve,Q as rt,U as J,V as Ee,X as lt,Y as ht,Z as Se,$ as we,a0 as xe}from"./game-core-ayU1xai4.js";import{m as gt,k as yt,i as bt,l as vt,G as et,q as Ce,a as Ae,r as Te,M,g as D,D as Mt,R as Pt,s as H,t as Et,u as st,h as St,P as wt,V as $,v as Me,w as Pe}from"./three-CCkbs3tE.js";class xt{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const e=document.getElementById("ui-overlay");if(!e)return;const s=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
    ...
    `,n.appendChild(o),n.appendChild(h),n.appendChild(d),n}isCompactHeight(){return window.innerHeight<=xt.COMPACT_HEIGHT_THRESHOLD}injectAnimations(){if(document.getElementById("tutorial-animations"))return;const t=document.createElement("style");t.id="tutorial-animations",t.textContent=`
      @keyframes swipe {
    ...
    `,o.appendChild(u);const g=`
      ...
      white-space: nowrap;
    `,p=(c,m)=>{let E=!1,S=!1;const w=()=>{A(!0)},x=()=>{c.style.transform="scale(0.92)"},I=()=>{c.style.transform="scale(1)"},A=(C=!1)=>{E=!1,S=C,I(),this.activePressCleanups.delete(w),document.removeEventListener("pointerup",v,!0),document.removeEventListener("pointercancel",y,!0)},v=C=>{const z=C.target===c||C.target instanceof Node&&c.contains(C.target),_t=E&&z;A(!z),_t&&m()},y=()=>{A(!0)};c.addEventListener("pointerdown",C=>{C.stopPropagation(),E=!0,S=!1,x(),this.activePressCleanups.add(w),document.addEventListener("pointerup",v,!0),document.addEventListener("pointercancel",y,!0)}),c.addEventListener("pointerenter",()=>{E&&x()}),c.addEventListener("pointerleave",()=>{E&&I()}),c.addEventListener("pointercancel",()=>A(!0)),c.addEventListener("click",C=>{if(C.stopPropagation(),S){S=!1;return}E||m()})},r=document.createElement("button");r.setAttribute("data-title-reset-cancel",""),r.textContent="やめる",r.style.cssText=g,r.style.background="rgba(255, 255, 255, 0.18)",r.style.color="#ffffff",p(r,a),u.appendChild(r);const f=document.createElement("button");f.setAttribute("data-title-reset-confirm",""),f.textContent="うん！ さいしょから",f.style.cssText=g,f.style.background="linear-gradient(135deg, #FF9F68, #FFE66D)",f.style.color="#3b1f00",p(f,n),u.appendChild(f),s.appendChild(this.overlayEl)}hide(){if(!this.overlayEl)return;const t=Array.from(this.activePressCleanups);this.activePressCleanups.clear();for(const e of t)e();this.overlayEl.remove(),this.overlayEl=null}}function Ct(l){const t=l.topRem??.8,e=window.innerHeight<=500,s=document.createElement("button");let i=l.initialMuted;const a=()=>{s.textContent=i?"🔇":"🔊",s.setAttribute("aria-label",i?"サウンド オフ":"サウンド オン")};s.setAttribute("data-mute-button",""),s.style.position="absolute",s.style.top=`${t}rem`,s.style.right="1rem",s.style.fontSize=e?"clamp(1.1rem, 3.5vmin, 1.4rem)":"clamp(1.4rem, 4vmin, 1.8rem)",s.style.background="rgba(255, 255, 255, 0.15)",s.style.border="none",s.style.borderRadius="50%",s.style.width=e?"2.4rem":"3rem",s.style.height=e?"2.4rem":"3rem",s.style.display="flex",s.style.alignItems="center",s.style.justifyContent="center",s.style.cursor="pointer",s.style.pointerEvents="auto",s.style.touchAction="manipulation",s.style.transform="scale(1)",s.style.transition="transform 0.08s ease-out",a();const n=()=>{s.style.transform="scale(1)"};return s.addEventListener("pointerdown",o=>{o.stopPropagation(),s.style.transform="scale(0.9)",l.onToggle()}),s.addEventListener("pointerup",n),s.addEventListener("pointercancel",n),s.addEventListener("pointerleave",n),l.container.appendChild(s),{element:s,setMuted(o){i=o,a()},remove(){s.remove()}}}class Oe{overlay=null;toggleButton=null;descriptionEl=null;highContrast=!1;vibrationIntensity="medium";motionSensitivity="strong";vibrationDescriptionEl=null;vibrationButtons=new Map;motionDescriptionEl=null;motionButtons=new Map;motionPreviewEl=null;motionPreviewTokenEl=null;motionPreviewCaptionEl=null;motionPreviewTimeoutId=null;motionPreviewFrameId=null;onToggle=null;onVibrationIntensityChange=null;onMotionSensitivityChange=null;show(t){const e=document.getElementById("ui-overlay");if(e){if(this.highContrast=t.initialHighContrast,this.vibrationIntensity=t.initialVibrationIntensity,this.motionSensitivity=t.initialMotionSensitivity,this.onToggle=t.onToggle,this.onVibrationIntensityChange=t.onVibrationIntensityChange,this.onMotionSensitivityChange=t.onMotionSensitivityChange,!this.overlay){this.overlay=document.createElement("div"),this.overlay.setAttribute("data-color-accessibility-settings",""),this.overlay.style.cssText=`
        position: absolute;
        inset: 0;
        display: flex;
        align-items: center;
      ...
      `;const o=[{value:"strong",label:"つよい"},{value:"medium",label:"ふつう"},{value:"weak",label:"やさしい"},{value:"off",label:"オフ"}];for(const c of o){const m=document.createElement("button");m.setAttribute("data-vibration-intensity-button",c.value),m.textContent=c.label,m.style.cssText=`
        ...
        gap: 0.65rem;
        margin-bottom: 0.95rem;
      `;const g=["strong","medium","gentle","minimal"];for(const c of g){const m=K(c),E=document.createElement("button");E.setAttribute("data-motion-sensitivity-button",c),E.style.cssText=`
          display: flex;
          flex-direction: column;
          align-items: center;
          justify-content: center;
          ...
          touch-action: manipulation;
          transition: transform 0.08s ease-out, border-color 0.12s ease-out, background 0.12s ease-out;
        `;const S=document.createElement("span");S.textContent=m.emoji,S.style.cssText="font-size: clamp(1.25rem, 4.8vmin, 1.7rem); line-height: 1;";const w=document.createElement("span");w.textContent=m.stars,w.style.cssText="font-size: clamp(0.82rem, 2.9vmin, 0.95rem); letter-spacing: 0.08em;";const x=document.createElement("span");x.textContent=m.shortLabel,x.style.cssText="font-size: clamp(0.9rem, 3vmin, 1rem);",E.append(S,w,x),E.addEventListener("click",()=>{this.motionSensitivity=c,this.render(),this.playMotionPreview(),this.onMotionSensitivityChange?.(c)}),this.motionButtons.set(c,E),u.appendChild(E)}this.motionPreviewEl=document.createElement("div"),this.motionPreviewEl.setAttribute("data-motion-preview",""),this.motionPreviewEl.style.cssText=`
        position: relative;
        min-height: 5.8rem;
        margin: 0 0 1rem;
        padding: 0.8rem 0.9rem;
    ...
    `;const a=document.createElement("span");return a.textContent=e.label,a.style.cssText="font-family: Zen Maru Gothic, sans-serif; font-size: 0.82rem; font-weight: 700;",s.appendChild(i),s.appendChild(a),this.buttonCleanups.add(T(s,{onActivate:()=>this.selectColor(t,e.key),onPressChange:n=>{s.style.transform=n?"scale(0.95)":"scale(1)"}})),this.optionButtons.set(`${t}:${e.key}`,s),s}selectColor(t,e){this.draft={...this.draft,[t]:e},this.render()}render(){const t=N.normalizeCustomization(this.draft);this.draft=t,this.previewBody?.style.setProperty("background",`#${N.getColorHex(t.bodyColor).toString(16).padStart(6,"0")}`),this.previewWings?.style.setProperty("background",`#${N.getColorHex(t.wingColor).toString(16).padStart(6,"0")}`),this.previewNose&&(this.previewNose.style.borderBottomColor=`#${N.getColorHex(t.noseColor).toString(16).padStart(6,"0")}`);for(const e of this.colorOptions)this.renderOptionState("bodyColor",e.key,t.bodyColor===e.key),this.renderOptionState("noseColor",e.key,t.noseColor===e.key),this.renderOptionState("wingColor",e.key,t.wingColor===e.key)}renderOptionState(t,e,s){const i=this.optionButtons.get(`${t}:${e}`);i&&(i.setAttribute("aria-pressed",s?"true":"false"),i.style.borderColor=s?"#ffe66d":"transparent",i.style.background=s?"rgba(255, 230, 109, 0.18)":"rgba(255, 255, 255, 0.12)")}}function Ie(l){return{totalPlayTimeSeconds:l?.totalPlayTimeSeconds??0,totalStarsCollected:l?.totalStarsCollected??0,totalBoostUses:l?.totalBoostUses??0,stageClearCounts:{...l?.stageClearCounts??{}}}}function Re(l){const t=Math.max(0,Math.round(l)),e=Math.floor(t/3600),s=Math.floor(t%3600/60),i=t%60;return e>0?`${e}じかん ${s}ふん`:s>0?`${s}ふん ${i}びょう`:`${i}びょう`}class De{overlayEl=null;actionCleanups=new Set;show(t,e){this.hide();const s=document.getElementById("ui-overlay");if(!s)return;const i=Ie(t),a=window.innerHeight<=720,n=document.createElement("div");n.setAttribute("data-stats-overlay",""),n.style.cssText=`
      position: absolute;
      inset: 0;
      z-index: 35;
      display: flex;
    ...
    `;const r=Array.from({length:R},(c,m)=>m+1).map(c=>({stageNumber:c,clearCount:i.stageClearCounts[c]??0})).filter(c=>c.clearCount>0);if(r.length===0){const c=document.createElement("div");c.textContent="まだ きろくが ないよ",c.style.cssText=`
      ...
      `,p.appendChild(c)}else for(const{stageNumber:c,clearCount:m}of r){const E=Y(c),S=document.createElement("div");S.setAttribute("data-stats-stage-clear-row",String(c)),S.style.cssText=`
          display: flex;
          align-items: center;
          ...
          font-weight: 700;
        `;const w=document.createElement("span");w.textContent=`${E.emoji} ステージ ${c} ${E.destinationReading}`;const x=document.createElement("span");x.textContent=`${m}かい`,x.style.color="#FFE66D",S.append(w,x),p.appendChild(S)}u.appendChild(p),o.appendChild(u);const f=document.createElement("button");f.textContent="もどる",f.style.cssText=`
      margin-top: 1rem;
    ...
    `;const n=document.createElement("div");return n.textContent=e,n.style.cssText=`
      ...
      font-weight: 900;
      color: #FFE66D;
    `,i.append(a,n),i}}function Bt(l,t){if(!Number.isFinite(l)||l<=0||t<=0)return"ずかん";const e=Math.min(l,t);return e>=t?`ずかん ${t} / ${t} 🎉`:`ずかん ${e} / ${t}`}function He(l){switch(l){case"hero":return{gap:"0.35rem",label:"0.92rem",medal:"1.7rem",hint:"0.98rem"};case"compact":return{gap:"0.18rem",label:"0.7rem",medal:"1rem",hint:"0.76rem"};default:return{gap:"0.26rem",label:"0.8rem",medal:"1.25rem",hint:"0.84rem"}}}function pt(l,t,e={}){const s=Rt(l,t),i=e.size??"regular",a=He(i),n=document.createElement("div");if(n.setAttribute("data-stage-medal-display",""),n.setAttribute("data-stage-medal-stage",String(l)),n.setAttribute("data-stage-medal-tier",s.tier),n.setAttribute("data-stage-medal-earned",String(s.earnedCount)),e.scope&&n.setAttribute("data-stage-medal-scope",e.scope),n.style.cssText=`
    display: flex;
    flex-direction: column;
    align-items: center;
    gap: ${a.gap};
  ...
  `,n.appendChild(d),n}const Ot=2e3,it=new Map,at=new Map,nt=new Map;let V=null,X=null;function Q(l,t){if(typeof document>"u"){const s=typeof OffscreenCanvas=="function",i=s?new OffscreenCanvas(l,t):{width:l,height:t};return{canvas:i,ctx:s?i.getContext("2d"):null}}const e=document.createElement("canvas");return e.width=l,e.height=t,{canvas:e,ctx:e.getContext("2d")}}function _(l,t){let e=it.get(l);return e||(e=t(),e.generateMipmaps=!1,e.minFilter=Te,e.needsUpdate=!0,it.set(l,e)),e}function P(l,t){let e=at.get(l);return e||(e=t(),at.set(l,e)),e}function B(l,t){let e=nt.get(l);return e||(e=t(),nt.set(l,e)),e}function O(l,t){const e=new Ae(l,t);return e.userData.sharedAssets=!0,e}function zt(){if(!V){const l=new yt,t=new Float32Array(Ot*3);for(let e=0;e<Ot*3;e+=3)t[e]=(Math.random()-.5)*200,t[e+1]=(Math.random()-.5)*200,t[e+2]=(Math.random()-.5)*400;l.setAttribute("position",new bt(t,3)),V=l}X||(X=new vt({color:16777215,size:.2,sizeAttenuation:!0}))}function Le(){const{canvas:l,ctx:t}=Q(256,256);if(!t)return new H(l);t.fillStyle="#888888",t.fillRect(0,0,256,256);for(let e=0;e<30;e++){const s=Math.random()*256,i=Math.random()*256,a=3+Math.random()*12;t.beginPath(),t.arc(s,i,a,0,Math.PI*2),t.fillStyle=`rgba(60,60,60,${.3+Math.random()*.4})`,t.fill()}return new H(l)}function ze(){const{canvas:l,ctx:t}=Q(256,256);if(!t)return new H(l);t.fillStyle="#ddaa44",t.fillRect(0,0,256,256);for(let e=0;e<8;e++){t.beginPath();const s=128+(Math.random()-.5)*100,i=128+(Math.random()-.5)*100;t.strokeStyle=`rgba(200,150,60,${.3+Math.random()*.3})`,t.lineWidth=3+Math.random()*5;for(let a=0;a<Math.PI*4;a+=.1){const n=10+a*8;t.lineTo(s+Math.cos(a)*n,i+Math.sin(a)*n)}t.stroke()}return new H(l)}function Ge(){const{canvas:l,ctx:t}=Q(256,256);if(!t)return new H(l);const e=["#cc7733","#dd9955","#bb6622","#eebb77","#aa5511","#ddaa66"];for(let s=0;s<256;s++){const i=Math.floor(s/(256/e.length))%e.length;t.fillStyle=e[i],t.fillRect(0,s,256,1)}return new H(l)}function Ne(){const{canvas:l,ctx:t}=Q(512,256);return t?(t.fillStyle="#2266aa",t.fillRect(0,0,512,256),t.fillStyle="#886644",t.beginPath(),t.ellipse(300,80,80,40,.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(280,150,30,50,.1,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(100,90,25,60,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(110,170,20,40,-.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(420,170,25,15,0,0,Math.PI*2),t.fill(),t.fillStyle="#447733",t.beginPath(),t.ellipse(290,75,40,20,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(95,85,15,30,.2,0,Math.PI*2),t.fill(),new H(l)):new H(l)}function Fe(){const{canvas:l,ctx:t}=Q(512,256);if(!t)return new H(l);t.clearRect(0,0,512,256),t.fillStyle="rgba(255,255,255,0.6)";for(let e=0;e<20;e++){const s=Math.random()*512,i=Math.random()*256;t.beginPath(),t.ellipse(s,i,20+Math.random()*40,8+Math.random()*15,Math.random()*Math.PI,0,Math.PI*2),t.fill()}return new H(l)}function _e(){it.clear(),at.clear(),nt.clear(),V=null,X=null}const $e={planetTextureCache:it,planetGeometryCache:at,planetMaterialCache:nt,getBgStarsGeometry:()=>V,getBgStarsMaterial:()=>X};function Gt(l,t,e){const s=new et;let i=null;switch(l){case 2:{const a=_("mercury",Le),n=P("mercury:sphere",()=>new D(10,24,24)),o=B("mercury:mat",()=>new M({map:a})),h=O(n,o);s.add(h),i=h;break}case 3:{const a=_("venus",ze),n=P("venus:sphere",()=>new D(14,24,24)),o=B("venus:mat",()=>new M({map:a})),h=O(n,o);s.add(h),i=h;break}case 5:{const a=_("jupiter",Ge),n=P("jupiter:sphere",()=>new D(20,24,24)),o=B("jupiter:mat",()=>new M({map:a})),h=O(n,o);s.add(h),i=h;break}case 6:{const a=P("saturn:sphere",()=>new D(15,24,24)),n=t.planetColor,o=B(`saturn:mat:${n}`,()=>new M({color:n})),h=O(a,o);s.add(h);const d=P("saturn:ring",()=>new Pt(20,30,48)),u=B("saturn:ringMat",()=>new M({color:15645542,side:Mt})),g=O(d,u);g.rotation.x=Math.PI/3,s.add(g),i=h;break}case 7:{const a=P("uranus:sphere",()=>new D(16,24,24)),n=B("uranus:mat",()=>new M({color:6737117})),o=O(a,n);s.add(o);const h=P("uranus:ring",()=>new Pt(21,28,48)),d=B("uranus:ringMat",()=>new M({color:10083822,side:Mt})),u=O(h,d);u.rotation.z=Math.PI/2,s.add(u),i=o;break}case 9:{const a=P("pluto:sphere",()=>new D(8,24,24)),n=B("pluto:mat",()=>new M({color:12298922})),o=O(a,n);s.add(o),i=o;break}case 10:{const a=P("sun:sphere",()=>new D(25,24,24)),n=B("sun:mat",()=>new M({color:16763904,emissive:16755200,emissiveIntensity:.5})),o=O(a,n);s.add(o),s.add(new Ce(16763904,2,200)),i=o;break}case 11:{const a=_("earth",Ne),n=P("earth:sphere",()=>new D(15,32,32)),o=B("earth:mat",()=>new M({map:a})),h=_("earth:cloud",Fe),d=P("earth:cloudSphere",()=>new D(15.5,32,32)),u=B("earth:cloudMat",()=>new M({map:h,transparent:!0,opacity:.3})),g=new et;g.add(O(n,o)),g.add(O(d,u)),s.add(g),i=g;break}default:{const a=P("default:sphere",()=>new D(15,24,24)),n=t.planetColor,o=B(`default:mat:${n}`,()=>new M({color:n})),h=O(a,o);s.add(h),i=h;break}}return s.position.set(0,0,e),{planet:s,spinTarget:i}}function je(l,t,e){return Gt(l,t,e)}function We(l){zt();const t=new gt(V,X);return t.userData.sharedAssets=!0,t.geometry.setDrawRange(0,l),t}function At(l){!Number.isInteger(l)||l<1||l>R||typeof document>"u"&&typeof OffscreenCanvas!="function"||(zt(),Gt(l,Y(l),0))}let W=null,U=null;function Ue(){if(!W){const l=new yt,t=new Float32Array(3e3);for(let e=0;e<3e3;e++)t[e]=(Math.random()-.5)*200;l.setAttribute("position",new bt(t,3)),W=l}return W}function Ze(){return U||(U=new vt({color:16777215,size:.3,sizeAttenuation:!0})),U}function qe(){W=null,U=null}const Ye={getBgStarsGeometry:()=>W,getBgStarsMaterial:()=>U};function Ve(l){const t=window.requestIdleCallback;if(typeof t=="function"){t(l,{timeout:1500});return}window.setTimeout(l,800)}function Nt(l){return new Set(l.filter(t=>Number.isInteger(t)&&t>=1&&t<=R)).size}function Xe(l){return Nt(l)>=R}function ct(l){const t=Xe(l.unlockedPlanets),e=t?1:Math.min(l.clearedStage+1,R),s=Y(e),i=l.bestStageStars?.[e]??0;return t?{startStage:e,destination:s.destinationReading,emoji:s.emoji,statusLabel:"ぜんぶ あつめたよ！",destinationLabel:`${s.destinationReading}へ もういちど しゅっぱつ！`,buttonHint:`${s.emoji} ステージ ${e} から もういちど あそぶ`,bestStars:i}:{startStage:e,destination:s.destinationReading,emoji:s.emoji,statusLabel:l.clearedStage>0?"つづきから しゅっぱつ！":"はじめての しゅっぱつ！",destinationLabel:`${s.destinationReading}へ むかおう！`,buttonHint:`${s.emoji} ステージ ${e} から スタート`,bestStars:i}}function Qe(l){return l.clearedStage>0||Nt(l.unlockedPlanets)>0||Object.keys(l.bestStageStars??{}).length>0}class Ke{threeScene;ambientLight=new Et(16777215,1);camera;lastAspect=0;sceneManager;saveManager;audioManager;stars=null;companionParade=null;overlay=null;muteHandle=null;tutorialOverlay=new xt;titleResetConfirmOverlay=new Be;colorAccessibilitySettings=new Oe;spaceshipCustomizer=new ke;statsOverlay=new De;encyclopediaOverlay=null;encyclopediaOverlayPromise=null;companionFactory=null;companionFactoryPromise=null;loadEncyclopediaOverlay;loadTitleCompanionFactory;loadingOverlay;loadFailureOverlay;scheduleIdleTask;encyclopediaBtn=null;isOpeningEncyclopedia=!1;isActive=!1;encyclopediaRequestToken=0;companionParadeRequestToken=0;bgmPending=!1;overlayButtonCleanups=new Set;constructor(t,e,s,i={}){this.sceneManager=t,this.saveManager=e,this.audioManager=s,this.loadingOverlay=i.loadingOverlay??new $t,this.loadFailureOverlay=i.loadFailureOverlay??new jt,this.scheduleIdleTask=i.scheduleIdleTask??Ve,this.loadEncyclopediaOverlay=i.loadEncyclopediaOverlay??(()=>mt(()=>import("./EncyclopediaOverlay-Cj6IMXX5.js"),__vite__mapDeps([0,1,2]))),this.loadTitleCompanionFactory=i.loadTitleCompanionFactory??(()=>mt(()=>import("./game-core-ayU1xai4.js").then(o=>o.a7),__vite__mapDeps([1,2]))),this.threeScene=new st,this.threeScene.background=new St(32);const{width:a,height:n}=L();this.camera=new wt(60,a/n,.1,1e3),this.camera.position.set(0,0,5)}enter(t){this.isActive=!0,this.encyclopediaRequestToken+=1,this.companionParadeRequestToken+=1,this.lastAspect=0,this.stars=new gt(Ue(),Ze()),this.stars.userData.sharedAssets=!0,this.stars.rotation.set(0,0,0),this.threeScene.add(this.stars),this.ambientLight.parent||this.threeScene.add(this.ambientLight);const e=this.saveManager.load();this.createCompanionParade(e.unlockedPlanets),this.createOverlay(),this.createMuteButton(),this.prefetchEncyclopediaOnIdle(),this.prewarmNextAdventureOnIdle(ct(e).startStage),this.audioManager.isInitialized()?(this.audioManager.playBGM(0),this.bgmPending=!1):this.bgmPending=!0,e.tutorialShown||this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide(),this.saveManager.markTutorialShown()})}createMuteButton(){const t=document.getElementById("hud")??document.getElementById("ui-overlay");t&&(this.muteHandle=Ct({initialMuted:this.audioManager.isMuted(),container:t,onToggle:()=>{this.ensureTitleAudioInitialized(!0);const e=this.audioManager.toggleMute();this.muteHandle?.setMuted(e);const s=this.saveManager.load();s.muted=e,this.saveManager.save(s)}}))}getEncyclopediaOverlay(){return this.encyclopediaOverlay?Promise.resolve(this.encyclopediaOverlay):this.encyclopediaOverlayPromise?this.encyclopediaOverlayPromise:(this.encyclopediaOverlayPromise=this.loadEncyclopediaOverlay().then(({EncyclopediaOverlay:t})=>{const e=new t;return this.encyclopediaOverlay=e,e}).finally(()=>{this.encyclopediaOverlayPromise=null}),this.encyclopediaOverlayPromise)}getTitleCompanionFactory(){return this.companionFactory?Promise.resolve(this.companionFactory):this.companionFactoryPromise?this.companionFactoryPromise:(this.companionFactoryPromise=this.loadTitleCompanionFactory().then(t=>(this.companionFactory=t,t)).finally(()=>{this.companionFactoryPromise=null}),this.companionFactoryPromise)}showEncyclopedia(){if(!this.isActive||!this.encyclopediaOverlay)return;const t=this.saveManager.load();this.encyclopediaOverlay.show(t.unlockedPlanets,()=>this.refreshEncyclopediaButtonLabel(),e=>{this.ensureTitleAudioInitialized(!1),this.sceneManager.requestTransition("stage",{stageNumber:e,totalScore:0,totalStarCount:0,launchSource:"encyclopedia"})},t.bestStageStars??{},t.discoveredConstellations??[])}isCurrentEncyclopediaRequest(t){return this.isActive&&this.encyclopediaRequestToken===t}prefetchEncyclopediaOnIdle(){const t=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{!this.isCurrentEncyclopediaRequest(t)||this.encyclopediaOverlay||this.encyclopediaOverlayPromise||this.getEncyclopediaOverlay().catch(()=>{})})}prewarmNextAdventureOnIdle(t){if(t>R)return;const e=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{this.isCurrentEncyclopediaRequest(e)&&At(t)})}async openEncyclopedia(){if(!this.isActive)return;if(this.loadFailureOverlay.hide(),this.encyclopediaOverlay){this.showEncyclopedia();return}if(this.isOpeningEncyclopedia)return;const t=this.encyclopediaRequestToken;this.isOpeningEncyclopedia=!0,this.loadingOverlay.show("ずかんを よんでるよ...");try{if(await this.getEncyclopediaOverlay(),!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),this.showEncyclopedia()}catch(e){if(!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),console.error("Failed to load encyclopedia overlay",e),this.loadFailureOverlay.show({title:"ずかんを もういちど よんでみよう！",message:"「もういちど よむ」を おして つづきを たのしもう！",primaryAction:{label:"もういちど よむ",onSelect:()=>this.openEncyclopedia()}})}finally{this.encyclopediaRequestToken===t&&(this.isOpeningEncyclopedia=!1)}}persistHighContrastSetting(t){const e=this.saveManager.load(),s=e.colorAccessibility?.motionSensitivity??F;e.colorAccessibility=this.buildColorAccessibilitySettings(t,s),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}persistVibrationIntensitySetting(t){const e=this.saveManager.load();e.vibrationSettings={intensity:t},this.saveManager.save(e),Dt(t)}persistMotionSensitivitySetting(t){const e=this.saveManager.load(),s=e.colorAccessibility?.highContrast===!0;e.colorAccessibility=this.buildColorAccessibilitySettings(s,t),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}buildColorAccessibilitySettings(t,e){if(!(!t&&e===F))return{...t?{highContrast:!0}:{},...e!==F?{motionSensitivity:e}:{}}}createOverlay(){const t=document.getElementById("ui-overlay");if(!t)return;const e=this.saveManager.load(),s=ct(e),i=Qe(e);this.overlay=document.createElement("div"),this.overlay.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      justify-content: center;
    ...
    `;const c=document.createElement("button");c.textContent="あそぶ",c.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(T(c,{onActivate:()=>{this.ensureTitleAudioInitialized(!1);const y=this.saveManager.load(),C=ct(y).startStage;this.sceneManager.requestTransition("stage",{stageNumber:C,totalScore:0,totalStarCount:0,launchSource:"campaign"})},onPressChange:y=>{c.style.transform=y?"scale(0.96)":"scale(1)"}}));const m=document.createElement("div");m.setAttribute("data-play-button-hint",""),m.textContent=s.buttonHint,m.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${a?"0.85rem":"1rem"};
      font-weight: 700;
      color: rgba(255, 255, 255, 0.88);
      text-shadow: 0 2px 10px rgba(0, 0, 0, 0.35);
    `;const E=document.createElement("div");E.setAttribute("data-title-secondary-actions",""),E.style.cssText=`
      display: grid;
    ...
    `;const S=document.createElement("button");S.setAttribute("data-spaceship-customizer-button",""),S.textContent="うちゅうせんをかざろう",S.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(T(S,{onActivate:()=>{const y=this.saveManager.load();this.spaceshipCustomizer.show({initialCustomization:y.spaceshipCustomization??ft,onComplete:C=>{const z=this.saveManager.load();z.spaceshipCustomization=C,this.saveManager.save(z)}})},onPressChange:y=>{S.style.transform=y?"scale(0.96)":"scale(1)"}}));const w=document.createElement("button");w.setAttribute("data-stats-button",""),w.textContent="あそびの きろく",w.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${a?"0.9rem":"1.05rem"};
      font-weight: 900;
      padding: ${a?"0.55rem 0.65rem":"0.7rem 0.85rem"};
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(T(w,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.statsOverlay.show(this.saveManager.load().gameplayStats,()=>{})},onPressChange:y=>{w.style.transform=y?"scale(0.96)":"scale(1)"}}));const x=document.createElement("div");x.setAttribute("data-title-footer-actions",""),x.style.cssText=`
      display: grid;
      ...
      align-items: stretch;
    `;const I=document.createElement("button");I.textContent="あそびかた",I.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(T(I,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide()})},onPressChange:y=>{I.style.transform=y?"scale(0.96)":"scale(1)"}}));const A=document.createElement("button");A.setAttribute("data-color-settings-button",""),A.textContent="みやすさ・しんどう",A.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${a?"0.82rem":"1rem"};
      font-weight: 700;
      padding: ${a?"0.45rem 0.55rem":"0.55rem 0.8rem"};
      ...
      transition: transform 0.08s ease-out;
      white-space: nowrap;
    `,this.overlayButtonCleanups.add(T(A,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.colorAccessibilitySettings.show({initialHighContrast:this.saveManager.load().colorAccessibility?.highContrast===!0,initialVibrationIntensity:this.saveManager.load().vibrationSettings?.intensity??"medium",initialMotionSensitivity:this.saveManager.load().colorAccessibility?.motionSensitivity??F,onToggle:y=>this.persistHighContrastSetting(y),onVibrationIntensityChange:y=>this.persistVibrationIntensitySetting(y),onMotionSensitivityChange:y=>this.persistMotionSensitivitySetting(y)})},onPressChange:y=>{A.style.transform=y?"scale(0.96)":"scale(1)"}}));const v=document.createElement("button");if(v.textContent=Bt(e.unlockedPlanets.length,j.length),v.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${a?"0.82rem":"1rem"};
      font-weight: 700;
      padding: ${a?"0.45rem 0.55rem":"0.55rem 0.8rem"};
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.encyclopediaBtn=v,this.overlayButtonCleanups.add(T(v,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.openEncyclopedia()},onPressChange:y=>{v.style.transform=y?"scale(0.96)":"scale(1)"}})),f.appendChild(c),f.appendChild(m),E.appendChild(S),E.appendChild(w),i){const y=document.createElement("button");y.setAttribute("data-reset-progress-button",""),y.textContent="さいしょから",y.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: ${a?"0.9rem":"1.05rem"};
        font-weight: 900;
        padding: ${a?"0.55rem 0.65rem":"0.7rem 0.85rem"};
    ...
    `,document.head.appendChild(t)}}const ss=1,is=.4;class kt{overlayEl=null;numberEl=null;phase="idle";elapsed=0;currentStep=0;stepDuration;goDuration;onTick;onGo;onComplete=null;steps=["3","2","1"];constructor(t={}){this.stepDuration=t.stepDuration??ss,this.goDuration=t.goDuration??is,this.onTick=t.onTick,this.onGo=t.onGo}show(t){if(this.phase!=="idle"&&this.phase!=="done")return;const e=document.getElementById("ui-overlay")??document.body;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-countdown-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
    ...
    `,document.head.appendChild(t)}getActiveSide(t){return t==="active-left"?"left":t==="active-right"?"right":t==="assist-left"?"left":t==="assist-right"?"right":t==="hidden"?"none":"both"}getGuideEmphasis(t,e){return e==="active-left"?t==="left"?"primary":"secondary":e==="active-right"?t==="right"?"primary":"secondary":e==="assist-left"?t==="left"?"primary":"secondary":e==="assist-right"?t==="right"?"primary":"secondary":e==="hidden"?"hidden":"balanced"}updateInstruction(t){if(!this.instructionEl)return;const e=this.getInstructionMessage(t);this.instructionEl.textContent=e,this.instructionEl.setAttribute("data-touch-guide-message",e)}getInstructionMessage(t){return t==="intro"?"ひだりか みぎを さわると うごけるよ":t==="idle"?"ひつような ときは ひだりか みぎを さわって うごこう":t==="assist-left"?"ひだりへ よけよう":t==="assist-right"?"みぎへ よけよう":""}}class ot{static DEFAULT_DURATION=4.2;static CELEBRATION_DURATION=3.6;element=null;timer=0;message=null;highContrast=!1;showHint(t){this.showMessage(t,ot.DEFAULT_DURATION)}showCelebration(t){this.showMessage(t,ot.CELEBRATION_DURATION)}tick(t){this.timer<=0||(this.timer=Math.max(0,this.timer-t),this.timer===0&&this.hide())}hide(){this.timer=0,this.message=null,this.element&&(this.element.style.display="none",this.element.textContent="",this.element.removeAttribute("data-constellation-message"))}setHighContrastMode(t){this.highContrast=t,this.element&&this.applyElementStyle(this.element)}getMessage(){return this.message}showMessage(t,e){const s=this.ensureElement();this.timer=e,this.message=t,s.textContent=t,s.setAttribute("data-constellation-message",t),s.style.display="flex"}ensureElement(){if(this.element)return this.element;const t=document.getElementById("ui-overlay"),e=document.createElement("div");return e.setAttribute("data-constellation-hint",""),e.setAttribute("aria-live","polite"),this.applyElementStyle(e),e.style.display="none",t?.appendChild(e),this.element=e,e}applyElementStyle(t){t.style.cssText=`
      ...
      z-index: 35;
      box-shadow: 0 10px 24px rgba(0, 0, 0, 0.24);
    `}}const rs=4;class ls{overlayEl=null;cardEl=null;titleEl=null;messageEl=null;elapsed=0;visible=!1;highContrastMode=!1;totalDuration;constructor(t={}){this.totalDuration=t.totalDuration??rs}show(t){const e=document.getElementById("ui-overlay")??document.body;Ht();const s=L().height<=500;(!this.overlayEl||!this.cardEl||!this.titleEl||!this.messageEl)&&(this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-seasonal-event-notice",""),this.overlayEl.style.cssText=`
        position: absolute;
    ...
    `,this.overlay.appendChild(i),this.overlay.appendChild(a),this.overlay.appendChild(n),this.overlay.appendChild(this.exitCta),s.appendChild(this.overlay)}update(t){this.bgStars&&(this.bgStars.rotation.y+=t*.03),this.updateCelebration(t)}setupCelebration(){this.companionGroup=new et,this.companionMeshes=[],this.circleX.length=0,this.circleZ.length=0,this.popinSettled.length=0,this.celebrationElapsed=0,this.thankYouShown=!1,this.canExit=!1,this.exitTriggered=!1;for(let t=0;t<j.length;t++){const e=j[t],s=Lt.createCompanionMesh(e),i=t*(2*Math.PI/j.length),a=Math.cos(i)*k.CIRCLE_RADIUS,n=Math.sin(i)*k.CIRCLE_RADIUS;this.circleX.push(a),this.circleZ.push(n),s.position.set(a,0,n),s.scale.set(0,0,0),this.companionMeshes.push(s),this.popinSettled.push(!1),this.companionGroup.add(s)}this.threeScene.add(this.companionGroup)}updateCelebration(t){if(this.companionMeshes.length===0)return;this.celebrationElapsed+=t;const e=k.POPIN_DELAY*(this.companionMeshes.length-1)+k.POPIN_DURATION,s=this.celebrationElapsed>e,i=s?Math.abs(Math.sin(this.celebrationElapsed*k.BOUNCE_SPEED))*k.BOUNCE_HEIGHT:0;for(let a=0;a<this.companionMeshes.length;a++){const n=this.companionMeshes[a];if(this.popinSettled[a]){s&&(n.position.y=i),n.rotation.y+=t*2;continue}const o=a*k.POPIN_DELAY;if(!(this.celebrationElapsed<o)){if(this.celebrationElapsed<o+k.POPIN_DURATION){const h=(this.celebrationElapsed-o)/k.POPIN_DURATION,d=this.bounceEase(h);n.scale.set(d,d,d)}else n.scale.set(1,1,1),this.popinSettled[a]=!0;s&&(n.position.y=i),n.rotation.y+=t*2}}!this.thankYouShown&&this.celebrationElapsed>=k.THANK_YOU_DELAY&&(this.showThankYouText(),this.thankYouShown=!0)}bounceEase(t){return t<.6?t/.6*1.2:1.2-(t-.6)/.4*.2}showThankYouText(){if(!this.overlay||!this.exitCta)return;const t=document.createElement("div");t.setAttribute("data-ending-thank-you",""),t.textContent="みんな ありがとう！",t.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: 2rem;
      font-weight: 900;
      color: #FFD700;
