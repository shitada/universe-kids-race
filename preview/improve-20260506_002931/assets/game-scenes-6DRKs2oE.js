const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-cgk63h1L.js","assets/game-core-Bnr71eB_.js","assets/three-BsQe5WE2.js"])))=>i.map(i=>d[i]);
import{g as st,D as St,S as $,T as I,a as _,b as Ht,L as Xt,c as Qt,_ as bt,d as L,e as G,f as N,s as zt,h as at,i as Gt,P as W,u as Nt,C as Kt,j as Jt,k as te,B as ee,l as se,M as ie,m as ae,n as ne,o as oe,p as re,q as le,r as he,t as ce,v as de,w as ue,x as Ft,W as me,A as pe,y as fe,z as _t,E as ge,F as Et,G as ye,H as be,R as ve,I as Se,J as Ee,K as Ce,N as xe,O as Bt,Q as $t,U as we,V as nt,X as it,Y as Ae,Z as mt,$ as pt,a0 as Te,a1 as Me,a2 as Pe,a3 as Be,a4 as ke}from"./game-core-Bnr71eB_.js";import{n as Ct,l as xt,j as wt,m as At,G as ot,r as Oe,a as Re,s as Ie,M as P,h as H,D as kt,R as Ot,t as z,u as dt,v as X,i as Q,P as ut,V as j,w as jt,x as De}from"./three-BsQe5WE2.js";class Tt{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const e=document.getElementById("ui-overlay");if(!e)return;const s=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
    ...
    `,n.appendChild(o),n.appendChild(h),n.appendChild(d),n}isCompactHeight(){return window.innerHeight<=Tt.COMPACT_HEIGHT_THRESHOLD}injectAnimations(){if(document.getElementById("tutorial-animations"))return;const t=document.createElement("style");t.id="tutorial-animations",t.textContent=`
      @keyframes swipe {
    ...
    `,o.appendChild(u);const m=`
      ...
      white-space: nowrap;
    `,p=(c,f)=>{let C=!1,S=!1;const E=()=>{A(!0)},w=()=>{c.style.transform="scale(0.92)"},M=()=>{c.style.transform="scale(1)"},A=(y=!1)=>{C=!1,S=y,M(),this.activePressCleanups.delete(E),document.removeEventListener("pointerup",v,!0),document.removeEventListener("pointercancel",x,!0)},v=y=>{const D=y.target===c||y.target instanceof Node&&c.contains(y.target),et=C&&D;A(!D),et&&f()},x=()=>{A(!0)};c.addEventListener("pointerdown",y=>{y.stopPropagation(),C=!0,S=!1,w(),this.activePressCleanups.add(E),document.addEventListener("pointerup",v,!0),document.addEventListener("pointercancel",x,!0)}),c.addEventListener("pointerenter",()=>{C&&w()}),c.addEventListener("pointerleave",()=>{C&&M()}),c.addEventListener("pointercancel",()=>A(!0)),c.addEventListener("click",y=>{if(y.stopPropagation(),S){S=!1;return}C||f()})},r=document.createElement("button");r.setAttribute("data-title-reset-cancel",""),r.textContent="やめる",r.style.cssText=m,r.style.background="rgba(255, 255, 255, 0.18)",r.style.color="#ffffff",p(r,a),u.appendChild(r);const g=document.createElement("button");g.setAttribute("data-title-reset-confirm",""),g.textContent="うん！ さいしょから",g.style.cssText=m,g.style.background="linear-gradient(135deg, #FF9F68, #FFE66D)",g.style.color="#3b1f00",p(g,n),u.appendChild(g),s.appendChild(this.overlayEl)}hide(){if(!this.overlayEl)return;const t=Array.from(this.activePressCleanups);this.activePressCleanups.clear();for(const e of t)e();this.overlayEl.remove(),this.overlayEl=null}}function Mt(l){const t=l.topRem??.8,e=window.innerHeight<=500,s=document.createElement("button");let i=l.initialMuted;const a=()=>{s.textContent=i?"🔇":"🔊",s.setAttribute("aria-label",i?"サウンド オフ":"サウンド オン")};s.setAttribute("data-mute-button",""),s.style.position="absolute",s.style.top=`${t}rem`,s.style.right="1rem",s.style.fontSize=e?"clamp(1.1rem, 3.5vmin, 1.4rem)":"clamp(1.4rem, 4vmin, 1.8rem)",s.style.background="rgba(255, 255, 255, 0.15)",s.style.border="none",s.style.borderRadius="50%",s.style.width=e?"2.4rem":"3rem",s.style.height=e?"2.4rem":"3rem",s.style.display="flex",s.style.alignItems="center",s.style.justifyContent="center",s.style.cursor="pointer",s.style.pointerEvents="auto",s.style.touchAction="manipulation",s.style.transform="scale(1)",s.style.transition="transform 0.08s ease-out",a();const n=()=>{s.style.transform="scale(1)"};return s.addEventListener("pointerdown",o=>{o.stopPropagation(),s.style.transform="scale(0.9)",l.onToggle()}),s.addEventListener("pointerup",n),s.addEventListener("pointercancel",n),s.addEventListener("pointerleave",n),l.container.appendChild(s),{element:s,setMuted(o){i=o,a()},remove(){s.remove()}}}class He{overlay=null;toggleButton=null;descriptionEl=null;highContrast=!1;colorVisionSupportMode="color-only";vibrationIntensity="medium";motionSensitivity="strong";colorVisionDescriptionEl=null;colorVisionButtons=new Map;vibrationDescriptionEl=null;vibrationButtons=new Map;motionDescriptionEl=null;motionButtons=new Map;motionPreviewEl=null;motionPreviewTokenEl=null;motionPreviewCaptionEl=null;motionPreviewTimeoutId=null;motionPreviewFrameId=null;onToggle=null;onColorVisionSupportModeChange=null;onVibrationIntensityChange=null;onMotionSensitivityChange=null;show(t){const e=document.getElementById("ui-overlay");if(e){if(this.highContrast=t.initialHighContrast,this.colorVisionSupportMode=t.initialColorVisionSupportMode,this.vibrationIntensity=t.initialVibrationIntensity,this.motionSensitivity=t.initialMotionSensitivity,this.onToggle=t.onToggle,this.onColorVisionSupportModeChange=t.onColorVisionSupportModeChange,this.onVibrationIntensityChange=t.onVibrationIntensityChange,this.onMotionSensitivityChange=t.onMotionSensitivityChange,!this.overlay){this.overlay=document.createElement("div"),this.overlay.setAttribute("data-color-accessibility-settings",""),this.overlay.style.cssText=`
        position: absolute;
        inset: 0;
        display: flex;
        align-items: center;
      ...
      `;const i=document.createElement("h2");i.textContent="みやすさ・しんどう せってい",i.style.cssText="margin: 0 0 0.65rem; font-size: clamp(1.25rem, 4.6vmin, 1.7rem);",this.descriptionEl=document.createElement("p"),this.descriptionEl.style.cssText="margin: 0 0 1rem; font-size: clamp(0.95rem, 3.4vmin, 1.05rem); line-height: 1.55;",this.toggleButton=document.createElement("button"),this.toggleButton.setAttribute("data-color-accessibility-toggle",""),this.toggleButton.style.cssText=`
        ...
        cursor: pointer;
        touch-action: manipulation;
      `,this.toggleButton.addEventListener("click",()=>{this.highContrast=!this.highContrast,this.render(),this.onToggle?.(this.highContrast)});const a=document.createElement("h3");a.textContent="いろの みわけかた",a.style.cssText="margin: 0.9rem 0 0.45rem; font-size: clamp(1rem, 3.8vmin, 1.2rem);",this.colorVisionDescriptionEl=document.createElement("p"),this.colorVisionDescriptionEl.style.cssText="margin: 0 0 0.8rem; font-size: clamp(0.9rem, 3.2vmin, 1rem); line-height: 1.5;";const n=document.createElement("div");n.setAttribute("data-color-vision-mode-group",""),n.style.cssText=`
        display: grid;
        grid-template-columns: repeat(2, minmax(0, 1fr));
        gap: 0.65rem;
        margin-bottom: 0.95rem;
      `;const o=[{value:"color-only",label:"いろだけ",icon:"🎨"},{value:"color-and-marks",label:"いろとマーク",icon:"★"}];for(const S of o){const E=document.createElement("button");E.setAttribute("data-color-vision-mode-button",S.value),E.textContent=`${S.icon} ${S.label}`,E.style.cssText=`
          min-height: 3.25rem;
        ...
        `,E.addEventListener("click",()=>{this.colorVisionSupportMode=S.value,this.render(),this.onColorVisionSupportModeChange?.(S.value)}),this.colorVisionButtons.set(S.value,E),n.appendChild(E)}const h=document.createElement("h3");h.textContent="しんどうの つよさ",h.style.cssText="margin: 0.9rem 0 0.45rem; font-size: clamp(1rem, 3.8vmin, 1.2rem);",this.vibrationDescriptionEl=document.createElement("p"),this.vibrationDescriptionEl.style.cssText="margin: 0 0 0.8rem; font-size: clamp(0.9rem, 3.2vmin, 1rem); line-height: 1.5;";const d=document.createElement("div");d.setAttribute("data-vibration-intensity-group",""),d.style.cssText=`
        display: grid;
        grid-template-columns: repeat(2, minmax(0, 1fr));
        gap: 0.65rem;
        margin-bottom: 0.95rem;
      `;const u=[{value:"strong",label:"つよい"},{value:"medium",label:"ふつう"},{value:"weak",label:"やさしい"},{value:"off",label:"オフ"}];for(const S of u){const E=document.createElement("button");E.setAttribute("data-vibration-intensity-button",S.value),E.textContent=S.label,E.style.cssText=`
          min-height: 3.25rem;
          padding: 0.8rem 0.9rem;
          border-radius: 1rem;
          border: 2px solid rgba(255, 255, 255, 0.4);
          ...
          touch-action: manipulation;
          transition: transform 0.08s ease-out, border-color 0.12s ease-out, background 0.12s ease-out;
        `,E.addEventListener("click",()=>{this.vibrationIntensity=S.value,this.render(),this.onVibrationIntensityChange?.(S.value)}),this.vibrationButtons.set(S.value,E),d.appendChild(E)}const m=document.createElement("h3");m.textContent="うごきの つよさ",m.style.cssText="margin: 1.1rem 0 0.45rem; font-size: clamp(1rem, 3.8vmin, 1.2rem);";const p=document.createElement("p");p.textContent="えらんで みると うごきの おためしが みえるよ",p.style.cssText="margin: 0 0 0.5rem; font-size: clamp(0.9rem, 3.2vmin, 1rem); line-height: 1.5;",this.motionDescriptionEl=document.createElement("p"),this.motionDescriptionEl.style.cssText="margin: 0 0 0.8rem; font-size: clamp(0.9rem, 3.2vmin, 1rem); line-height: 1.5;";const r=document.createElement("div");r.setAttribute("data-motion-sensitivity-group",""),r.style.cssText=`
        display: grid;
        grid-template-columns: repeat(2, minmax(0, 1fr));
        gap: 0.65rem;
        margin-bottom: 0.95rem;
      `;const g=["strong","medium","gentle","minimal"];for(const S of g){const E=st(S),w=document.createElement("button");w.setAttribute("data-motion-sensitivity-button",S),w.style.cssText=`
          display: flex;
          flex-direction: column;
          align-items: center;
          justify-content: center;
          ...
          touch-action: manipulation;
          transition: transform 0.08s ease-out, border-color 0.12s ease-out, background 0.12s ease-out;
        `;const M=document.createElement("span");M.textContent=E.emoji,M.style.cssText="font-size: clamp(1.25rem, 4.8vmin, 1.7rem); line-height: 1;";const A=document.createElement("span");A.textContent=E.stars,A.style.cssText="font-size: clamp(0.82rem, 2.9vmin, 0.95rem); letter-spacing: 0.08em;";const v=document.createElement("span");v.textContent=E.shortLabel,v.style.cssText="font-size: clamp(0.9rem, 3vmin, 1rem);",w.append(M,A,v),w.addEventListener("click",()=>{this.motionSensitivity=S,this.render(),this.playMotionPreview(),this.onMotionSensitivityChange?.(S)}),this.motionButtons.set(S,w),r.appendChild(w)}this.motionPreviewEl=document.createElement("div"),this.motionPreviewEl.setAttribute("data-motion-preview",""),this.motionPreviewEl.style.cssText=`
        position: relative;
        min-height: 5.8rem;
        margin: 0 0 1rem;
        padding: 0.8rem 0.9rem;
      ...
      `,this.motionPreviewCaptionEl=document.createElement("p"),this.motionPreviewCaptionEl.setAttribute("data-motion-preview-caption",""),this.motionPreviewCaptionEl.style.cssText="margin: 0; font-size: clamp(0.9rem, 3vmin, 1rem); line-height: 1.5;",c.append(f,this.motionPreviewTokenEl),this.motionPreviewEl.append(c,this.motionPreviewCaptionEl);const C=document.createElement("button");C.textContent="とじる",C.style.cssText=`
        ...
        cursor: pointer;
        touch-action: manipulation;
      `,C.addEventListener("click",()=>this.hide()),s.appendChild(i),s.appendChild(this.descriptionEl),s.appendChild(this.toggleButton),s.appendChild(a),s.appendChild(this.colorVisionDescriptionEl),s.appendChild(n),s.appendChild(h),s.appendChild(this.vibrationDescriptionEl),s.appendChild(d),s.appendChild(m),s.appendChild(p),s.appendChild(this.motionDescriptionEl),s.appendChild(r),s.appendChild(this.motionPreviewEl),s.appendChild(C),this.overlay.appendChild(s)}this.render(),e.appendChild(this.overlay)}}hide(){this.clearMotionPreviewTimers(),this.overlay?.remove()}isVisible(){return this.overlay?.isConnected===!0}render(){if(!this.toggleButton||!this.descriptionEl||!this.colorVisionDescriptionEl||!this.vibrationDescriptionEl||!this.motionDescriptionEl)return;this.descriptionEl.textContent=this.highContrast?"ふちや しまもようを つよくして みやすく しているよ。":"ひかりかたを やさしくして いつもの みために しているよ。",this.toggleButton.textContent=this.highContrast?"みやすくする: ON":"みやすくする: OFF",this.toggleButton.setAttribute("aria-pressed",this.highContrast?"true":"false"),this.colorVisionDescriptionEl.textContent=this.colorVisionSupportMode==="color-and-marks"?"にじりゅうせいは ★、わくせいは しるしつきで わかるよ。":"いまは いろを みながら あそぶ モードだよ。";for(const[s,i]of this.colorVisionButtons.entries()){const a=s===this.colorVisionSupportMode;i.setAttribute("aria-pressed",a?"true":"false"),i.style.borderColor=a?"#fff27a":"rgba(255, 255, 255, 0.4)",i.style.background=a?"linear-gradient(135deg, rgba(255, 242, 122, 0.94), rgba(118, 240, 255, 0.92))":"rgba(255, 255, 255, 0.08)",i.style.color=a?"#102040":"#fff",i.style.transform=a?"scale(1.02)":"scale(1)"}const t={strong:"しっかり つたえる しんどうだよ。",medium:"ちょうどよく わかる つよさだよ。",weak:"やさしく ふるえて つたえるよ。",off:"しんどうの かわりに がめんが すこし ゆれるよ。"};this.vibrationDescriptionEl.textContent=t[this.vibrationIntensity];for(const[s,i]of this.vibrationButtons.entries()){const a=s===this.vibrationIntensity;i.setAttribute("aria-pressed",a?"true":"false"),i.style.borderColor=a?"#fff27a":"rgba(255, 255, 255, 0.4)",i.style.background=a?"linear-gradient(135deg, rgba(255, 242, 122, 0.94), rgba(118, 240, 255, 0.92))":"rgba(255, 255, 255, 0.08)",i.style.color=a?"#102040":"#fff",i.style.transform=a?"scale(1.02)":"scale(1)"}const e=st(this.motionSensitivity);this.motionDescriptionEl.textContent=e.description;for(const[s,i]of this.motionButtons.entries()){const a=s===this.motionSensitivity;i.setAttribute("aria-pressed",a?"true":"false"),i.style.borderColor=a?"#fff27a":"rgba(255, 255, 255, 0.4)",i.style.background=a?"linear-gradient(135deg, rgba(255, 242, 122, 0.94), rgba(118, 240, 255, 0.92))":"rgba(255, 255, 255, 0.08)",i.style.color=a?"#102040":"#fff",i.style.transform=a?"scale(1.02)":"scale(1)"}this.motionPreviewEl?.dataset.previewActive!=="true"&&this.resetMotionPreview()}playMotionPreview(){if(!this.motionPreviewEl||!this.motionPreviewTokenEl||!this.motionPreviewCaptionEl)return;this.clearMotionPreviewTimers();const t=st(this.motionSensitivity);this.motionPreviewEl.dataset.previewActive="true",this.motionPreviewTokenEl.textContent=t.emoji,this.motionPreviewTokenEl.style.background="rgba(255, 242, 122, 0.92)",this.motionPreviewTokenEl.style.boxShadow=t.previewGlow,this.motionPreviewTokenEl.style.transition="none",this.motionPreviewTokenEl.style.left="0.35rem",this.motionPreviewTokenEl.style.transform="translateY(-50%) scale(1)",this.motionPreviewCaptionEl.textContent=`${t.emoji} ${t.shortLabel} で おためしちゅう`,this.motionPreviewFrameId=window.requestAnimationFrame(()=>{this.motionPreviewTokenEl&&(this.motionPreviewTokenEl.style.transition=`left ${t.previewDurationMs}ms ease-in-out, transform ${t.previewDurationMs}ms ease-in-out`,this.motionPreviewTokenEl.style.left="calc(100% - 2.45rem)",this.motionPreviewTokenEl.style.transform=`translateY(-50%) scale(${t.previewScale})`)}),this.motionPreviewTimeoutId=window.setTimeout(()=>{this.resetMotionPreview()},t.previewDurationMs+260)}resetMotionPreview(){if(!this.motionPreviewEl||!this.motionPreviewTokenEl||!this.motionPreviewCaptionEl)return;const t=st(this.motionSensitivity);this.motionPreviewEl.dataset.previewActive="false",this.motionPreviewTokenEl.textContent=t.emoji,this.motionPreviewTokenEl.style.transition="none",this.motionPreviewTokenEl.style.left="0.35rem",this.motionPreviewTokenEl.style.transform="translateY(-50%) scale(1)",this.motionPreviewTokenEl.style.background="rgba(255, 242, 122, 0.92)",this.motionPreviewTokenEl.style.boxShadow=t.previewGlow,this.motionPreviewCaptionEl.textContent=`${t.stars} ${t.shortLabel} を えらぶと おためしするよ`}clearMotionPreviewTimers(){this.motionPreviewTimeoutId!==null&&(window.clearTimeout(this.motionPreviewTimeoutId),this.motionPreviewTimeoutId=null),this.motionPreviewFrameId!==null&&(window.cancelAnimationFrame(this.motionPreviewFrameId),this.motionPreviewFrameId=null)}}function T(l,t){let e=!1,s=!1,i=null,a=null;const n=t.documentTarget??document,o=t.stopPropagation??!0,h=()=>{t.canActivate?.()!==!1&&t.onActivate()},d=v=>{t.onPressChange?.(v)},u=v=>{const x=v;return typeof x.clientX=="number"&&typeof x.clientY=="number"?{x:x.clientX,y:x.clientY}:null},m=v=>{const x=v;return typeof x.pointerId=="number"?x.pointerId:null},p=v=>{const x=m(v);return i===null||x===null||x===i},r=v=>{if(!e||a===null||t.moveTolerancePx===void 0)return!1;const x=u(v);return x===null?!1:Math.hypot(x.x-a.x,x.y-a.y)>t.moveTolerancePx},g=v=>{e=!1,s=v,i=null,a=null,d(!1),n.removeEventListener("pointermove",C,!0),n.removeEventListener("pointerup",c,!0),n.removeEventListener("pointercancel",f,!0)},c=v=>{if(!e||!p(v))return;if(r(v)){g(!0);return}const x=v.target,y=x===l||x instanceof Node&&l.contains(x),D=e&&y;g(D||!y),D&&h()},f=()=>{g(!0)},C=v=>{!e||!p(v)||r(v)&&g(!0)},S=v=>{t.canActivate?.()!==!1&&((t.preventDefaultOnPointerDown??!1)&&v.preventDefault(),o&&v.stopPropagation(),e=!0,s=!1,i=m(v),a=u(v),d(!0),t.moveTolerancePx!==void 0&&n.addEventListener("pointermove",C,!0),n.addEventListener("pointerup",c,!0),n.addEventListener("pointercancel",f,!0))},E=()=>{e&&d(!0)},w=()=>{e&&d(!1)},M=()=>{g(!0)},A=v=>{if(o&&v.stopPropagation(),(t.preventDefaultOnClick??!1)&&v.preventDefault(),s){s=!1;return}e||h()};return l.addEventListener("pointerdown",S),l.addEventListener("pointerenter",E),l.addEventListener("pointerleave",w),l.addEventListener("pointercancel",M),l.addEventListener("click",A),()=>{g(!1),l.removeEventListener("pointerdown",S),l.removeEventListener("pointerenter",E),l.removeEventListener("pointerleave",w),l.removeEventListener("pointercancel",M),l.removeEventListener("click",A)}}class ze{overlay=null;previewBody=null;previewNose=null;previewWings=null;buttonCleanups=new Set;optionButtons=new Map;draft={...St};colorOptions=$.getColorOptions();show(t){this.hide();const e=document.getElementById("ui-overlay");if(!e)return;this.draft=$.normalizeCustomization(t.initialCustomization),this.overlay=document.createElement("div"),this.overlay.setAttribute("data-spaceship-customizer",""),this.overlay.setAttribute("role","dialog"),this.overlay.setAttribute("aria-modal","true"),this.overlay.setAttribute("aria-label","うちゅうせんを かざろう"),this.overlay.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
    ...
    `,s.style.overflowY="hidden",s.style.height="100%",s.style.maxHeight="720px",s.addEventListener("pointerdown",d=>d.stopPropagation()),this.overlay.appendChild(s);const i=document.createElement("h2");i.textContent="うちゅうせんを かざろう",i.style.cssText="margin: 0 0 0.3rem; font-size: clamp(1.25rem, 4.3vmin, 1.85rem); color: #ffe66d;";const a=document.createElement("p");a.textContent="おおきな ボタンで えらぶと、すぐに みためが かわるよ。",a.style.cssText="margin: 0 0 0.45rem; font-size: clamp(0.85rem, 2.8vmin, 1rem); line-height: 1.35;",s.appendChild(i),s.appendChild(a);const n=document.createElement("div");n.setAttribute("data-spaceship-customizer-content",""),n.style.cssText="display: grid; grid-template-columns: minmax(12rem, 15rem) minmax(0, 1fr); gap: 0.65rem; align-items: stretch; margin: 0.45rem 0 0.65rem;",n.appendChild(this.createPreviewCard());const o=document.createElement("div");o.setAttribute("data-spaceship-customizer-sections",""),o.style.cssText="display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 0.5rem; align-items: stretch;",o.appendChild(this.createPartSection("bodyColor","ほんたい")),o.appendChild(this.createPartSection("noseColor","ノーズ")),o.appendChild(this.createPartSection("wingColor","つばさ")),n.appendChild(o),s.appendChild(n);const h=document.createElement("button");h.textContent="かんりょう",h.setAttribute("data-spaceship-customizer-done",""),h.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.buttonCleanups.add(T(h,{onActivate:()=>{const d={...this.draft};this.hide(),t.onComplete(d)},onPressChange:d=>{h.style.transform=d?"scale(0.96)":"scale(1)"}})),s.appendChild(h),e.appendChild(this.overlay),this.render()}hide(){const t=Array.from(this.buttonCleanups);this.buttonCleanups.clear();for(const e of t)e();this.optionButtons.clear(),this.overlay?.remove(),this.overlay=null,this.previewBody=null,this.previewNose=null,this.previewWings=null}isVisible(){return this.overlay?.isConnected===!0}createPreviewCard(){const t=document.createElement("div");t.setAttribute("data-spaceship-customizer-preview-card",""),t.style.cssText=`
      width: 100%;
      margin: 0;
      height: 100%;
      padding: 0.6rem;
    ...
    `,o.appendChild(h);const d=document.createElement("div");d.style.cssText=`
      ...
      gap: 0.8rem;
      margin-bottom: 1rem;
    `,d.append(this.createSummaryCard("あそんだ じかん",Ne(i.totalPlayTimeSeconds),"data-stats-total-play-time"),this.createSummaryCard("とった ほし",`${i.totalStarsCollected}こ`,"data-stats-total-stars"),this.createSummaryCard("ブースト",`${i.totalBoostUses}かい`,"data-stats-total-boosts")),o.appendChild(d);const u=document.createElement("div");u.style.cssText=`
      margin-top: 0.5rem;
      padding: ${a?"0.9rem 0.8rem":"1rem"};
      border-radius: 20px;
      background: rgba(255, 255, 255, 0.1);
    `;const m=document.createElement("div");m.textContent="ステージ クリア かいすう",m.style.cssText=`
      margin-bottom: 0.75rem;
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${a?"1.1rem":"1.25rem"};
      font-weight: 900;
      color: #FFE66D;
    `,u.appendChild(m);const p=document.createElement("div");p.setAttribute("data-stats-stage-clears",""),p.style.cssText=`
      display: flex;
      flex-direction: column;
      gap: 0.45rem;
      text-align: left;
    `;const r=Array.from({length:I},(c,f)=>f+1).map(c=>({stageNumber:c,clearCount:i.stageClearCounts[c]??0})).filter(c=>c.clearCount>0);if(r.length===0){const c=document.createElement("div");c.textContent="まだ きろくが ないよ",c.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: ${a?"1rem":"1.1rem"};
        font-weight: 700;
        text-align: center;
        color: rgba(255, 255, 255, 0.88);
      `,p.appendChild(c)}else for(const{stageNumber:c,clearCount:f}of r){const C=_(c),S=document.createElement("div");S.setAttribute("data-stats-stage-clear-row",String(c)),S.style.cssText=`
          display: flex;
          align-items: center;
          ...
          font-weight: 700;
        `;const E=document.createElement("span");E.textContent=`${C.emoji} ステージ ${c} ${C.destinationReading}`;const w=document.createElement("span");w.textContent=`${f}かい`,w.style.color="#FFE66D",S.append(E,w),p.appendChild(S)}u.appendChild(p),o.appendChild(u);const g=document.createElement("button");g.textContent="もどる",g.style.cssText=`
      margin-top: 1rem;
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.actionCleanups.add(T(g,{onActivate:()=>{this.hide(),e()},onPressChange:c=>{g.style.transform=c?"scale(0.96)":"scale(1)"}})),o.appendChild(g),n.appendChild(o),s.appendChild(n)}hide(){const t=Array.from(this.actionCleanups);this.actionCleanups.clear();for(const e of t)e();this.overlayEl?.remove(),this.overlayEl=null}createSummaryCard(t,e,s){const i=document.createElement("div");i.setAttribute(s,""),i.style.cssText=`
    ...
    `;const n=document.createElement("div");return n.textContent=e,n.style.cssText=`
      ...
      font-weight: 900;
      color: #FFE66D;
    `,i.append(a,n),i}}function Rt(l,t){if(!Number.isFinite(l)||l<=0||t<=0)return"ずかん";const e=Math.min(l,t);return e>=t?`ずかん ${t} / ${t} 🎉`:`ずかん ${e} / ${t}`}function _e(l){switch(l){case"hero":return{gap:"0.35rem",label:"0.92rem",medal:"1.7rem",hint:"0.98rem"};case"compact":return{gap:"0.18rem",label:"0.7rem",medal:"1rem",hint:"0.76rem"};default:return{gap:"0.26rem",label:"0.8rem",medal:"1.25rem",hint:"0.84rem"}}}function vt(l,t,e={}){const s=Ht(l,t),i=e.size??"regular",a=_e(i),n=document.createElement("div");if(n.setAttribute("data-stage-medal-display",""),n.setAttribute("data-stage-medal-stage",String(l)),n.setAttribute("data-stage-medal-tier",s.tier),n.setAttribute("data-stage-medal-earned",String(s.earnedCount)),e.scope&&n.setAttribute("data-stage-medal-scope",e.scope),n.style.cssText=`
    display: flex;
    flex-direction: column;
    align-items: center;
    gap: ${a.gap};
  `,e.label){const u=document.createElement("div");u.textContent=e.label,u.style.cssText=`
    ...
    justify-content: center;
    gap: ${a.gap};
  `;for(const u of s.slots){const m=document.createElement("span");m.setAttribute("data-stage-medal-slot",u.tier),m.setAttribute("data-stage-medal-threshold",String(u.threshold)),m.setAttribute("data-stage-medal-reached",String(u.reached)),m.textContent=u.icon,m.style.cssText=`
      font-size: ${a.medal};
      line-height: 1;
    ...
    `,o.appendChild(m)}n.appendChild(o);const h=e.hint??(s.nextThreshold===null?"かんぺき！":`つぎ ⭐ ${s.nextThreshold}`),d=document.createElement("div");return d.setAttribute("data-stage-medal-hint",""),d.textContent=h,d.style.cssText=`
    font-family: 'Zen Maru Gothic', sans-serif;
    font-size: ${a.hint};
    font-weight: 700;
    color: ${s.nextThreshold===null?"#FFE66D":"rgba(255, 255, 255, 0.86)"};
  `,n.appendChild(d),n}const It=2e3,rt=new Map,lt=new Map,ht=new Map;let K=null,J=null;function tt(l,t){if(typeof document>"u"){const s=typeof OffscreenCanvas=="function",i=s?new OffscreenCanvas(l,t):{width:l,height:t};return{canvas:i,ctx:s?i.getContext("2d"):null}}const e=document.createElement("canvas");return e.width=l,e.height=t,{canvas:e,ctx:e.getContext("2d")}}function V(l,t){let e=rt.get(l);return e||(e=t(),e.generateMipmaps=!1,e.minFilter=Ie,e.needsUpdate=!0,rt.set(l,e)),e}function B(l,t){let e=lt.get(l);return e||(e=t(),lt.set(l,e)),e}function k(l,t){let e=ht.get(l);return e||(e=t(),ht.set(l,e)),e}function O(l,t){const e=new Re(l,t);return e.userData.sharedAssets=!0,e}function Vt(){if(!K){const l=new xt,t=new Float32Array(It*3);for(let e=0;e<It*3;e+=3)t[e]=(Math.random()-.5)*200,t[e+1]=(Math.random()-.5)*200,t[e+2]=(Math.random()-.5)*400;l.setAttribute("position",new wt(t,3)),K=l}J||(J=new At({color:16777215,size:.2,sizeAttenuation:!0}))}function $e(){const{canvas:l,ctx:t}=tt(256,256);if(!t)return new z(l);t.fillStyle="#888888",t.fillRect(0,0,256,256);for(let e=0;e<30;e++){const s=Math.random()*256,i=Math.random()*256,a=3+Math.random()*12;t.beginPath(),t.arc(s,i,a,0,Math.PI*2),t.fillStyle=`rgba(60,60,60,${.3+Math.random()*.4})`,t.fill()}return new z(l)}function je(){const{canvas:l,ctx:t}=tt(256,256);if(!t)return new z(l);t.fillStyle="#ddaa44",t.fillRect(0,0,256,256);for(let e=0;e<8;e++){t.beginPath();const s=128+(Math.random()-.5)*100,i=128+(Math.random()-.5)*100;t.strokeStyle=`rgba(200,150,60,${.3+Math.random()*.3})`,t.lineWidth=3+Math.random()*5;for(let a=0;a<Math.PI*4;a+=.1){const n=10+a*8;t.lineTo(s+Math.cos(a)*n,i+Math.sin(a)*n)}t.stroke()}return new z(l)}function Ve(){const{canvas:l,ctx:t}=tt(256,256);if(!t)return new z(l);const e=["#cc7733","#dd9955","#bb6622","#eebb77","#aa5511","#ddaa66"];for(let s=0;s<256;s++){const i=Math.floor(s/(256/e.length))%e.length;t.fillStyle=e[i],t.fillRect(0,s,256,1)}return new z(l)}function We(){const{canvas:l,ctx:t}=tt(512,256);return t?(t.fillStyle="#2266aa",t.fillRect(0,0,512,256),t.fillStyle="#886644",t.beginPath(),t.ellipse(300,80,80,40,.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(280,150,30,50,.1,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(100,90,25,60,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(110,170,20,40,-.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(420,170,25,15,0,0,Math.PI*2),t.fill(),t.fillStyle="#447733",t.beginPath(),t.ellipse(290,75,40,20,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(95,85,15,30,.2,0,Math.PI*2),t.fill(),new z(l)):new z(l)}function Ue(){const{canvas:l,ctx:t}=tt(512,256);if(!t)return new z(l);t.clearRect(0,0,512,256),t.fillStyle="rgba(255,255,255,0.6)";for(let e=0;e<20;e++){const s=Math.random()*512,i=Math.random()*256;t.beginPath(),t.ellipse(s,i,20+Math.random()*40,8+Math.random()*15,Math.random()*Math.PI,0,Math.PI*2),t.fill()}return new z(l)}function Ze(){rt.clear(),lt.clear(),ht.clear(),K=null,J=null}const qe={planetTextureCache:rt,planetGeometryCache:lt,planetMaterialCache:ht,getBgStarsGeometry:()=>K,getBgStarsMaterial:()=>J};function Wt(l,t,e){const s=new ot;let i=null;switch(l){case 2:{const a=V("mercury",$e),n=B("mercury:sphere",()=>new H(10,24,24)),o=k("mercury:mat",()=>new P({map:a})),h=O(n,o);s.add(h),i=h;break}case 3:{const a=V("venus",je),n=B("venus:sphere",()=>new H(14,24,24)),o=k("venus:mat",()=>new P({map:a})),h=O(n,o);s.add(h),i=h;break}case 5:{const a=V("jupiter",Ve),n=B("jupiter:sphere",()=>new H(20,24,24)),o=k("jupiter:mat",()=>new P({map:a})),h=O(n,o);s.add(h),i=h;break}case 6:{const a=B("saturn:sphere",()=>new H(15,24,24)),n=t.planetColor,o=k(`saturn:mat:${n}`,()=>new P({color:n})),h=O(a,o);s.add(h);const d=B("saturn:ring",()=>new Ot(20,30,48)),u=k("saturn:ringMat",()=>new P({color:15645542,side:kt})),m=O(d,u);m.rotation.x=Math.PI/3,s.add(m),i=h;break}case 7:{const a=B("uranus:sphere",()=>new H(16,24,24)),n=k("uranus:mat",()=>new P({color:6737117})),o=O(a,n);s.add(o);const h=B("uranus:ring",()=>new Ot(21,28,48)),d=k("uranus:ringMat",()=>new P({color:10083822,side:kt})),u=O(h,d);u.rotation.z=Math.PI/2,s.add(u),i=o;break}case 9:{const a=B("pluto:sphere",()=>new H(8,24,24)),n=k("pluto:mat",()=>new P({color:12298922})),o=O(a,n);s.add(o),i=o;break}case 10:{const a=B("sun:sphere",()=>new H(25,24,24)),n=k("sun:mat",()=>new P({color:16763904,emissive:16755200,emissiveIntensity:.5})),o=O(a,n);s.add(o),s.add(new Oe(16763904,2,200)),i=o;break}case 11:{const a=V("earth",We),n=B("earth:sphere",()=>new H(15,32,32)),o=k("earth:mat",()=>new P({map:a})),h=V("earth:cloud",Ue),d=B("earth:cloudSphere",()=>new H(15.5,32,32)),u=k("earth:cloudMat",()=>new P({map:h,transparent:!0,opacity:.3})),m=new ot;m.add(O(n,o)),m.add(O(d,u)),s.add(m),i=m;break}default:{const a=B("default:sphere",()=>new H(15,24,24)),n=t.planetColor,o=k(`default:mat:${n}`,()=>new P({color:n})),h=O(a,o);s.add(h),i=h;break}}return s.position.set(0,0,e),{planet:s,spinTarget:i}}function Ut(l,t,e){return Wt(l,t,e)}function Zt(l){Vt();const t=new Ct(K,J);return t.userData.sharedAssets=!0,t.geometry.setDrawRange(0,l),t}function Pt(l){!Number.isInteger(l)||l<1||l>I||typeof document>"u"&&typeof OffscreenCanvas!="function"||(Vt(),Wt(l,_(l),0))}let U=null,Z=null;function Ye(){if(!U){const l=new xt,t=new Float32Array(3e3);for(let e=0;e<3e3;e++)t[e]=(Math.random()-.5)*200;l.setAttribute("position",new wt(t,3)),U=l}return U}function Xe(){return Z||(Z=new At({color:16777215,size:.3,sizeAttenuation:!0})),Z}function Qe(){U=null,Z=null}const Ke={getBgStarsGeometry:()=>U,getBgStarsMaterial:()=>Z};function Je(l){const t=window.requestIdleCallback;if(typeof t=="function"){t(l,{timeout:1500});return}window.setTimeout(l,800)}function qt(l){return new Set(l.filter(t=>Number.isInteger(t)&&t>=1&&t<=I)).size}function ts(l){return qt(l)>=I}function ft(l){const t=ts(l.unlockedPlanets),e=t?1:Math.min(l.clearedStage+1,I),s=_(e),i=l.bestStageStars?.[e]??0,a=l.colorAccessibility?.colorVisionSupportMode??G,n=Gt(e,s.destinationReading,a);return t?{startStage:e,destination:n,emoji:s.emoji,statusLabel:"ぜんぶ あつめたよ！",destinationLabel:`${n}へ もういちど しゅっぱつ！`,buttonHint:`${s.emoji} ステージ ${e} から もういちど あそぶ`,bestStars:i}:{startStage:e,destination:n,emoji:s.emoji,statusLabel:l.clearedStage>0?"つづきから しゅっぱつ！":"はじめての しゅっぱつ！",destinationLabel:`${n}へ むかおう！`,buttonHint:`${s.emoji} ステージ ${e} から スタート`,bestStars:i}}function es(l){return l.clearedStage>0||qt(l.unlockedPlanets)>0||Object.keys(l.bestStageStars??{}).length>0}class ss{threeScene;ambientLight=new dt(16777215,1);camera;lastAspect=0;sceneManager;saveManager;audioManager;stars=null;companionParade=null;overlay=null;muteHandle=null;tutorialOverlay=new Tt;titleResetConfirmOverlay=new Le;colorAccessibilitySettings=new He;spaceshipCustomizer=new ze;statsOverlay=new Fe;encyclopediaOverlay=null;encyclopediaOverlayPromise=null;companionFactory=null;companionFactoryPromise=null;loadEncyclopediaOverlay;loadTitleCompanionFactory;loadingOverlay;loadFailureOverlay;scheduleIdleTask;encyclopediaBtn=null;isOpeningEncyclopedia=!1;isActive=!1;encyclopediaRequestToken=0;companionParadeRequestToken=0;bgmPending=!1;overlayButtonCleanups=new Set;constructor(t,e,s,i={}){this.sceneManager=t,this.saveManager=e,this.audioManager=s,this.loadingOverlay=i.loadingOverlay??new Xt,this.loadFailureOverlay=i.loadFailureOverlay??new Qt,this.scheduleIdleTask=i.scheduleIdleTask??Je,this.loadEncyclopediaOverlay=i.loadEncyclopediaOverlay??(()=>bt(()=>import("./EncyclopediaOverlay-cgk63h1L.js"),__vite__mapDeps([0,1,2]))),this.loadTitleCompanionFactory=i.loadTitleCompanionFactory??(()=>bt(()=>import("./game-core-Bnr71eB_.js").then(o=>o.ac),__vite__mapDeps([1,2]))),this.threeScene=new X,this.threeScene.background=new Q(32);const{width:a,height:n}=L();this.camera=new ut(60,a/n,.1,1e3),this.camera.position.set(0,0,5)}enter(t){this.isActive=!0,this.encyclopediaRequestToken+=1,this.companionParadeRequestToken+=1,this.lastAspect=0,this.stars=new Ct(Ye(),Xe()),this.stars.userData.sharedAssets=!0,this.stars.rotation.set(0,0,0),this.threeScene.add(this.stars),this.ambientLight.parent||this.threeScene.add(this.ambientLight);const e=this.saveManager.load();this.createCompanionParade(e.unlockedPlanets),this.createOverlay(),this.createMuteButton(),this.prefetchEncyclopediaOnIdle(),this.prewarmNextAdventureOnIdle(ft(e).startStage),this.audioManager.isInitialized()?(this.audioManager.playBGM(0),this.bgmPending=!1):this.bgmPending=!0,e.tutorialShown||this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide(),this.saveManager.markTutorialShown()})}createMuteButton(){const t=document.getElementById("hud")??document.getElementById("ui-overlay");t&&(this.muteHandle=Mt({initialMuted:this.audioManager.isMuted(),container:t,onToggle:()=>{this.ensureTitleAudioInitialized(!0);const e=this.audioManager.toggleMute();this.muteHandle?.setMuted(e);const s=this.saveManager.load();s.muted=e,this.saveManager.save(s)}}))}getEncyclopediaOverlay(){return this.encyclopediaOverlay?Promise.resolve(this.encyclopediaOverlay):this.encyclopediaOverlayPromise?this.encyclopediaOverlayPromise:(this.encyclopediaOverlayPromise=this.loadEncyclopediaOverlay().then(({EncyclopediaOverlay:t})=>{const e=new t;return this.encyclopediaOverlay=e,e}).finally(()=>{this.encyclopediaOverlayPromise=null}),this.encyclopediaOverlayPromise)}getTitleCompanionFactory(){return this.companionFactory?Promise.resolve(this.companionFactory):this.companionFactoryPromise?this.companionFactoryPromise:(this.companionFactoryPromise=this.loadTitleCompanionFactory().then(t=>(this.companionFactory=t,t)).finally(()=>{this.companionFactoryPromise=null}),this.companionFactoryPromise)}showEncyclopedia(){if(!this.isActive||!this.encyclopediaOverlay)return;const t=this.saveManager.load();this.encyclopediaOverlay.show(t.unlockedPlanets,()=>this.refreshEncyclopediaButtonLabel(),e=>{this.ensureTitleAudioInitialized(!1),this.sceneManager.requestTransition("stage",{stageNumber:e,totalScore:0,totalStarCount:0,launchSource:"encyclopedia"})},t.bestStageStars??{},t.discoveredConstellations??[],t.colorAccessibility?.colorVisionSupportMode??G)}isCurrentEncyclopediaRequest(t){return this.isActive&&this.encyclopediaRequestToken===t}prefetchEncyclopediaOnIdle(){const t=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{!this.isCurrentEncyclopediaRequest(t)||this.encyclopediaOverlay||this.encyclopediaOverlayPromise||this.getEncyclopediaOverlay().catch(()=>{})})}prewarmNextAdventureOnIdle(t){if(t>I)return;const e=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{this.isCurrentEncyclopediaRequest(e)&&Pt(t)})}async openEncyclopedia(){if(!this.isActive)return;if(this.loadFailureOverlay.hide(),this.encyclopediaOverlay){this.showEncyclopedia();return}if(this.isOpeningEncyclopedia)return;const t=this.encyclopediaRequestToken;this.isOpeningEncyclopedia=!0,this.loadingOverlay.show("ずかんを よんでるよ...");try{if(await this.getEncyclopediaOverlay(),!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),this.showEncyclopedia()}catch(e){if(!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),console.error("Failed to load encyclopedia overlay",e),this.loadFailureOverlay.show({title:"ずかんを もういちど よんでみよう！",message:"「もういちど よむ」を おして つづきを たのしもう！",primaryAction:{label:"もういちど よむ",onSelect:()=>this.openEncyclopedia()}})}finally{this.encyclopediaRequestToken===t&&(this.isOpeningEncyclopedia=!1)}}persistHighContrastSetting(t){const e=this.saveManager.load(),s=e.colorAccessibility?.motionSensitivity??N,i=e.colorAccessibility?.colorVisionSupportMode??G;e.colorAccessibility=this.buildColorAccessibilitySettings(t,s,i),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}persistVibrationIntensitySetting(t){const e=this.saveManager.load();e.vibrationSettings={intensity:t},this.saveManager.save(e),zt(t)}persistMotionSensitivitySetting(t){const e=this.saveManager.load(),s=e.colorAccessibility?.highContrast===!0,i=e.colorAccessibility?.colorVisionSupportMode??G;e.colorAccessibility=this.buildColorAccessibilitySettings(s,t,i),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}persistColorVisionSupportModeSetting(t){const e=this.saveManager.load(),s=e.colorAccessibility?.highContrast===!0,i=e.colorAccessibility?.motionSensitivity??N;e.colorAccessibility=this.buildColorAccessibilitySettings(s,i,t),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}buildColorAccessibilitySettings(t,e,s){if(!(!t&&e===N&&s===G))return{...t?{highContrast:!0}:{},...e!==N?{motionSensitivity:e}:{},...s!==G?{colorVisionSupportMode:s}:{}}}createOverlay(){const t=document.getElementById("ui-overlay");if(!t)return;const e=this.saveManager.load(),s=ft(e),i=es(e);this.overlay=document.createElement("div"),this.overlay.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      justify-content: center;
    ...
    `;const m=document.createElement("div");m.textContent=s.destinationLabel,m.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${a?"0.85rem":"1rem"};
      font-weight: 700;
      color: rgba(255, 255, 255, 0.92);
    `;const p=Ht(s.startStage,s.bestStars),r=vt(s.startStage,s.bestStars,{label:"メダル",hint:p.nextThreshold===null?"かんぺき！":`${p.icon} いま ・ つぎ ⭐ ${p.nextThreshold}`,size:"regular",scope:"title-next-adventure"});r.style.marginTop=a?"0.35rem":"0.55rem",o.appendChild(h),o.appendChild(d),o.appendChild(u),o.appendChild(m),o.appendChild(r);const g=document.createElement("div");g.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
    ...
    `;const c=document.createElement("button");c.textContent="あそぶ",c.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(T(c,{onActivate:()=>{this.ensureTitleAudioInitialized(!1);const y=this.saveManager.load(),D=ft(y).startStage;this.sceneManager.requestTransition("stage",{stageNumber:D,totalScore:0,totalStarCount:0,launchSource:"campaign"})},onPressChange:y=>{c.style.transform=y?"scale(0.96)":"scale(1)"}}));const f=document.createElement("div");f.setAttribute("data-play-button-hint",""),f.textContent=s.buttonHint,f.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${a?"0.85rem":"1rem"};
      font-weight: 700;
      color: rgba(255, 255, 255, 0.88);
      text-shadow: 0 2px 10px rgba(0, 0, 0, 0.35);
    `;const C=document.createElement("button");C.textContent="うちゅうで あそぶ",C.setAttribute("data-free-play-button",""),C.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${a?"1.05rem":"1.35rem"};
      font-weight: 900;
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(T(C,{onActivate:()=>{this.ensureTitleAudioInitialized(!1),this.sceneManager.requestTransition("freePlay",{})},onPressChange:y=>{C.style.transform=y?"scale(0.96)":"scale(1)"}}));const S=document.createElement("div");S.setAttribute("data-title-secondary-actions",""),S.style.cssText=`
      display: grid;
    ...
    `;const E=document.createElement("button");E.setAttribute("data-spaceship-customizer-button",""),E.textContent="うちゅうせんをかざろう",E.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(T(E,{onActivate:()=>{const y=this.saveManager.load();this.spaceshipCustomizer.show({initialCustomization:y.spaceshipCustomization??St,onComplete:D=>{const et=this.saveManager.load();et.spaceshipCustomization=D,this.saveManager.save(et)}})},onPressChange:y=>{E.style.transform=y?"scale(0.96)":"scale(1)"}}));const w=document.createElement("button");w.setAttribute("data-stats-button",""),w.textContent="あそびの きろく",w.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${a?"0.9rem":"1.05rem"};
      font-weight: 900;
      padding: ${a?"0.55rem 0.65rem":"0.7rem 0.85rem"};
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(T(w,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.statsOverlay.show(this.saveManager.load().gameplayStats,()=>{})},onPressChange:y=>{w.style.transform=y?"scale(0.96)":"scale(1)"}}));const M=document.createElement("div");M.setAttribute("data-title-footer-actions",""),M.style.cssText=`
      display: grid;
      ...
      align-items: stretch;
    `;const A=document.createElement("button");A.textContent="あそびかた",A.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(T(A,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide()})},onPressChange:y=>{A.style.transform=y?"scale(0.96)":"scale(1)"}}));const v=document.createElement("button");v.setAttribute("data-color-settings-button",""),v.textContent="みやすさ・しんどう",v.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${a?"0.82rem":"1rem"};
      font-weight: 700;
      padding: ${a?"0.45rem 0.55rem":"0.55rem 0.8rem"};
      ...
      transition: transform 0.08s ease-out;
      white-space: nowrap;
    `,this.overlayButtonCleanups.add(T(v,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.colorAccessibilitySettings.show({initialHighContrast:this.saveManager.load().colorAccessibility?.highContrast===!0,initialColorVisionSupportMode:this.saveManager.load().colorAccessibility?.colorVisionSupportMode??G,initialVibrationIntensity:this.saveManager.load().vibrationSettings?.intensity??"medium",initialMotionSensitivity:this.saveManager.load().colorAccessibility?.motionSensitivity??N,onToggle:y=>this.persistHighContrastSetting(y),onColorVisionSupportModeChange:y=>this.persistColorVisionSupportModeSetting(y),onVibrationIntensityChange:y=>this.persistVibrationIntensitySetting(y),onMotionSensitivityChange:y=>this.persistMotionSensitivitySetting(y)})},onPressChange:y=>{v.style.transform=y?"scale(0.96)":"scale(1)"}}));const x=document.createElement("button");if(x.textContent=Rt(e.unlockedPlanets.length,W.length),x.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${a?"0.82rem":"1rem"};
      font-weight: 700;
      padding: ${a?"0.45rem 0.55rem":"0.55rem 0.8rem"};
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.encyclopediaBtn=x,this.overlayButtonCleanups.add(T(x,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.openEncyclopedia()},onPressChange:y=>{x.style.transform=y?"scale(0.96)":"scale(1)"}})),g.appendChild(c),g.appendChild(C),g.appendChild(f),S.appendChild(E),S.appendChild(w),i){const y=document.createElement("button");y.setAttribute("data-reset-progress-button",""),y.textContent="さいしょから",y.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: ${a?"0.9rem":"1.05rem"};
        font-weight: 900;
        padding: ${a?"0.55rem 0.65rem":"0.7rem 0.85rem"};
      ...
      pointer-events: auto;
      z-index: 60;
    `,this.overlayEl.style.background="rgba(0, 0, 32, 0.92)";let i=!1;const a=()=>{i||(i=!0,this.hide(),e())},n=()=>{i||(i=!0,this.hide(),t())};this.overlayEl.addEventListener("pointerdown",g=>{g.target===this.overlayEl&&a()});const o=document.createElement("div");o.setAttribute("data-home-confirm-card",""),o.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
    ...
    `,o.addEventListener("pointerdown",g=>{g.stopPropagation()}),this.overlayEl.appendChild(o);const h=document.createElement("div");h.textContent="タイトルへ もどる？",h.style.cssText=`
      font-size: 1.8rem;
      font-weight: 900;
      text-shadow: 0 0 15px rgba(255, 215, 0, 0.5);
      margin-bottom: 1.2rem;
    ...
    `,o.appendChild(d);const u=`
      ...
      transition: transform 0.08s ease-out;
      white-space: nowrap;
    `,m=(g,c)=>{const f=T(g,{onActivate:c,onPressChange:C=>{g.style.transform=C?"scale(0.9)":"scale(1)"}});this.activePressCleanups.add(f)},p=document.createElement("button");p.setAttribute("data-home-confirm-back",""),p.setAttribute("aria-label","タイトルへ もどる"),p.textContent="🏠 タイトルへ もどる",p.style.cssText=u,p.style.fontFamily="'Zen Maru Gothic', sans-serif",p.style.background="rgba(255, 255, 255, 0.18)",p.style.color="#ffffff",p.style.minWidth="88px",p.style.minHeight="88px",p.style.touchAction="manipulation",p.style.transform="scale(1)",p.style.transition="transform 0.08s ease-out",p.style.whiteSpace="nowrap",m(p,n),d.appendChild(p);const r=document.createElement("button");r.setAttribute("data-home-confirm-continue",""),r.setAttribute("aria-label","つづける"),r.textContent="✋ つづける",r.style.cssText=u,r.style.fontFamily="'Zen Maru Gothic', sans-serif",r.style.background="linear-gradient(135deg, #FF6B6B, #FFE66D)",r.style.color="#FFD700",r.style.textShadow="0 1px 2px rgba(0, 0, 32, 0.6)",r.style.minWidth="88px",r.style.minHeight="88px",r.style.touchAction="manipulation",r.style.transform="scale(1)",r.style.transition="transform 0.08s ease-out",r.style.whiteSpace="nowrap",m(r,a),d.appendChild(r),s.appendChild(this.overlayEl)}hide(){if(this.overlayEl){const t=Array.from(this.activePressCleanups);this.activePressCleanups.clear();for(const e of t)e();this.overlayEl.remove(),this.overlayEl=null}}isVisible(){return this.overlayEl!==null}}class Yt{overlayEl=null;activePressCleanups=new Set;show(t,e){if(this.overlayEl)return;const s=document.getElementById("ui-overlay")??document.body;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-pause-overlay",""),this.overlayEl.setAttribute("role","dialog"),this.overlayEl.setAttribute("aria-modal","true"),this.overlayEl.setAttribute("aria-label","やすみちゅう"),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
    ...
    `,i.appendChild(n);const o=document.createElement("div");o.style.cssText=`
      ...
      align-items: stretch;
      width: 100%;
    `,i.appendChild(o);const h=(d,u,m,p,r,g)=>{const c=document.createElement("button");c.setAttribute(u,""),c.setAttribute("aria-label",m),c.textContent=d,c.style.cssText=`
        flex: 1 1 140px;
        padding: 1rem 1.2rem;
        border: none;
        border-radius: 1.6rem;
    ...
    `,document.head.appendChild(t)}}const os=1,rs=.4;class Dt{overlayEl=null;numberEl=null;phase="idle";elapsed=0;currentStep=0;stepDuration;goDuration;onTick;onGo;onComplete=null;steps=["3","2","1"];constructor(t={}){this.stepDuration=t.stepDuration??os,this.goDuration=t.goDuration??rs,this.onTick=t.onTick,this.onGo=t.onGo}show(t){if(this.phase!=="idle"&&this.phase!=="done")return;const e=document.getElementById("ui-overlay")??document.body;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-countdown-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
    ...
    `,this.overlayButtonCleanups.add(T(a,{onActivate:()=>{this.inputSystem.resetPointers?.(),this.sceneManager.requestTransition("title")},onPressChange:o=>{a.style.transform=o?"scale(0.96)":"scale(1)"}})),e.append(s,a);const n=document.createElement("div");n.style.cssText=`
      align-self: center;
    ...
    `,this.overlay.appendChild(i),this.overlay.appendChild(a),this.overlay.appendChild(n),this.overlay.appendChild(this.exitCta),s.appendChild(this.overlay)}update(t){this.bgStars&&(this.bgStars.rotation.y+=t*.03),this.updateCelebration(t)}setupCelebration(){this.companionGroup=new ot,this.companionMeshes=[],this.circleX.length=0,this.circleZ.length=0,this.popinSettled.length=0,this.celebrationElapsed=0,this.thankYouShown=!1,this.canExit=!1,this.exitTriggered=!1;for(let t=0;t<W.length;t++){const e=W[t],s=Et.createCompanionMesh(e),i=t*(2*Math.PI/W.length),a=Math.cos(i)*R.CIRCLE_RADIUS,n=Math.sin(i)*R.CIRCLE_RADIUS;this.circleX.push(a),this.circleZ.push(n),s.position.set(a,0,n),s.scale.set(0,0,0),this.companionMeshes.push(s),this.popinSettled.push(!1),this.companionGroup.add(s)}this.threeScene.add(this.companionGroup)}updateCelebration(t){if(this.companionMeshes.length===0)return;this.celebrationElapsed+=t;const e=R.POPIN_DELAY*(this.companionMeshes.length-1)+R.POPIN_DURATION,s=this.celebrationElapsed>e,i=s?Math.abs(Math.sin(this.celebrationElapsed*R.BOUNCE_SPEED))*R.BOUNCE_HEIGHT:0;for(let a=0;a<this.companionMeshes.length;a++){const n=this.companionMeshes[a];if(this.popinSettled[a]){s&&(n.position.y=i),n.rotation.y+=t*2;continue}const o=a*R.POPIN_DELAY;if(!(this.celebrationElapsed<o)){if(this.celebrationElapsed<o+R.POPIN_DURATION){const h=(this.celebrationElapsed-o)/R.POPIN_DURATION,d=this.bounceEase(h);n.scale.set(d,d,d)}else n.scale.set(1,1,1),this.popinSettled[a]=!0;s&&(n.position.y=i),n.rotation.y+=t*2}}!this.thankYouShown&&this.celebrationElapsed>=R.THANK_YOU_DELAY&&(this.showThankYouText(),this.thankYouShown=!0)}bounceEase(t){return t<.6?t/.6*1.2:1.2-(t-.6)/.4*.2}showThankYouText(){if(!this.overlay||!this.exitCta)return;const t=document.createElement("div");t.setAttribute("data-ending-thank-you",""),t.textContent="みんな ありがとう！",t.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: 2rem;
      font-weight: 900;
      color: #FFD700;
