const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-B02iNqkP.js","assets/game-core-Cp8aEKWe.js","assets/three-BsQe5WE2.js"])))=>i.map(i=>d[i]);
import{D as mt,i as w,g as Ct,a as Rt,S as K,T as H,b as Q,c as ee,L as fe,d as ye,_ as Bt,e as N,f as Y,h as j,s as ie,j as pt,k as se,l as be,P as st,u as ne,C as ve,m as Se,n as Ee,B as xe,o as Ce,M as we,p as Te,q as Ae,r as Me,t as Pe,v as Be,w as ke,x as Re,y as Oe,z as Ie,A as De,E as Le,F as Ge,G as ze,H as He,I as ae,W as Ne,J as _e,K as $e,N as Fe,O as oe,Q as Ve,R as Ot,U as Ue,V as je,X as We,Y as Ze,Z as Ye,$ as qe,a0 as Xe,a1 as $t,a2 as re,a3 as Qe,a4 as gt,a5 as J,a6 as Ke,a7 as wt,a8 as Je,a9 as Tt,aa as ti,ab as ei,ac as ii,ad as si,ae as ni}from"./game-core-Cp8aEKWe.js";import{n as It,l as Dt,j as Lt,m as Gt,G as nt,r as ai,a as oi,s as ri,M as D,h as $,C as Ft,B as Vt,D as Ut,R as jt,t as _,u as St,v as ct,i as ht,P as Et,V as W,w as le,x as li}from"./three-BsQe5WE2.js";class zt{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const e=document.getElementById("ui-overlay");if(!e)return;const i=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
    ...
    `,b=(d,C)=>{let y=!1,p=!1;const A=()=>{B(!0)},T=()=>{d.style.transform="scale(0.92)"},M=()=>{d.style.transform="scale(1)"},B=(h=!1)=>{y=!1,p=h,M(),this.activePressCleanups.delete(A),document.removeEventListener("pointerup",E,!0),document.removeEventListener("pointercancel",x,!0)},E=h=>{const S=h.target===d||h.target instanceof Node&&d.contains(h.target),P=y&&S;B(!S),P&&C()},x=()=>{B(!0)};d.addEventListener("pointerdown",h=>{h.stopPropagation(),y=!0,p=!1,T(),this.activePressCleanups.add(A),document.addEventListener("pointerup",E,!0),document.addEventListener("pointercancel",x,!0)}),d.addEventListener("pointerenter",()=>{y&&T()}),d.addEventListener("pointerleave",()=>{y&&M()}),d.addEventListener("pointercancel",()=>B(!0)),d.addEventListener("click",h=>{if(h.stopPropagation(),p){p=!1;return}y||C()})},g=document.createElement("button");g.setAttribute("data-title-reset-cancel",""),g.textContent="やめる",g.style.cssText=f,g.style.background="rgba(255, 255, 255, 0.18)",g.style.color="#ffffff",b(g,n),m.appendChild(g);const r=document.createElement("button");r.setAttribute("data-title-reset-confirm",""),r.textContent="うん！ さいしょから",r.style.cssText=f,r.style.background="linear-gradient(135deg, #FF9F68, #FFE66D)",r.style.color="#3b1f00",b(r,a),m.appendChild(r),i.appendChild(this.overlayEl)}hide(){if(!this.overlayEl)return;const t=Array.from(this.activePressCleanups);this.activePressCleanups.clear();for(const e of t)e();this.overlayEl.remove(),this.overlayEl=null}}function Ht(l){const t=l.topRem??.8,e=window.innerHeight<=500,i=document.createElement("button");let s=l.initialMuted;const n=()=>{i.textContent=s?"🔇":"🔊",i.setAttribute("aria-label",s?"サウンド オフ":"サウンド オン")};i.setAttribute("data-mute-button",""),i.style.position="absolute",i.style.top=`${t}rem`,i.style.right="1rem",i.style.fontSize=e?"clamp(1.1rem, 3.5vmin, 1.4rem)":"clamp(1.4rem, 4vmin, 1.8rem)",i.style.background="rgba(255, 255, 255, 0.15)",i.style.border="none",i.style.borderRadius="50%",i.style.width=e?"2.4rem":"3rem",i.style.height=e?"2.4rem":"3rem",i.style.display="flex",i.style.alignItems="center",i.style.justifyContent="center",i.style.cursor="pointer",i.style.pointerEvents="auto",i.style.touchAction="manipulation",i.style.transform="scale(1)",i.style.transition="transform 0.08s ease-out",n();const a=()=>{i.style.transform="scale(1)"};return i.addEventListener("pointerdown",o=>{o.stopPropagation(),i.style.transform="scale(0.9)",l.onToggle()}),i.addEventListener("pointerup",a),i.addEventListener("pointercancel",a),i.addEventListener("pointerleave",a),l.container.appendChild(i),{element:i,setMuted(o){s=o,n()},remove(){i.remove()}}}const ft=[{value:0,labelKey:"colorSettings.audio.volume.quiet"},{value:25,labelKey:"colorSettings.audio.volume.small"},{value:50,labelKey:"colorSettings.audio.volume.normal"},{value:75,labelKey:"colorSettings.audio.volume.loud"},{value:100,labelKey:"colorSettings.audio.volume.max"}],Wt=[{value:"color-only",labelKey:"colorSettings.colorVision.option.colorOnly",icon:"🎨"},{value:"color-and-marks",labelKey:"colorSettings.colorVision.option.colorAndMarks",icon:"★"}],Zt=[{value:"strong",labelKey:"colorSettings.vibration.option.strong"},{value:"medium",labelKey:"colorSettings.vibration.option.medium"},{value:"weak",labelKey:"colorSettings.vibration.option.weak"},{value:"off",labelKey:"colorSettings.vibration.option.off"}],Yt=[{value:"ja",labelKey:"colorSettings.language.option.ja",icon:"🇯🇵"},{value:"en",labelKey:"colorSettings.language.option.en",icon:"🇬🇧"}],qt={strong:{shortLabel:"colorSettings.motion.option.strong.shortLabel",description:"colorSettings.motion.option.strong.description"},medium:{shortLabel:"colorSettings.motion.option.medium.shortLabel",description:"colorSettings.motion.option.medium.description"},gentle:{shortLabel:"colorSettings.motion.option.gentle.shortLabel",description:"colorSettings.motion.option.gentle.description"},minimal:{shortLabel:"colorSettings.motion.option.minimal.shortLabel",description:"colorSettings.motion.option.minimal.description"}};function Xt(l){const t=ft.find(e=>e.value===l)??ft[2];return w.t(t.labelKey)}class hi{overlay=null;toggleButton=null;descriptionEl=null;highContrast=!1;colorVisionSupportMode="color-only";bgmVolume=100;sfxVolume=100;vibrationIntensity="medium";motionSensitivity="strong";restReminderEnabled=!0;language=mt;bgmVolumeDescriptionEl=null;sfxVolumeDescriptionEl=null;bgmVolumeSlider=null;sfxVolumeSlider=null;colorVisionDescriptionEl=null;colorVisionButtons=new Map;vibrationDescriptionEl=null;vibrationButtons=new Map;motionDescriptionEl=null;motionButtons=new Map;restReminderDescriptionEl=null;restReminderToggleButton=null;motionPreviewEl=null;motionPreviewTokenEl=null;motionPreviewCaptionEl=null;languageDescriptionEl=null;languageButtons=new Map;motionPreviewTimeoutId=null;motionPreviewFrameId=null;onToggle=null;onColorVisionSupportModeChange=null;onBGMVolumeChange=null;onSFXVolumeChange=null;onVibrationIntensityChange=null;onMotionSensitivityChange=null;onRestReminderToggle=null;onLanguageChange=null;languageUnsubscribe=null;show(t){const e=document.getElementById("ui-overlay");if(e){if(this.highContrast=t.initialHighContrast,this.colorVisionSupportMode=t.initialColorVisionSupportMode,this.bgmVolume=t.initialBGMVolume,this.sfxVolume=t.initialSFXVolume,this.vibrationIntensity=t.initialVibrationIntensity,this.motionSensitivity=t.initialMotionSensitivity,this.restReminderEnabled=t.initialRestReminderEnabled,this.language=t.initialLanguage,this.onToggle=t.onToggle,this.onColorVisionSupportModeChange=t.onColorVisionSupportModeChange,this.onBGMVolumeChange=t.onBGMVolumeChange,this.onSFXVolumeChange=t.onSFXVolumeChange,this.onVibrationIntensityChange=t.onVibrationIntensityChange,this.onMotionSensitivityChange=t.onMotionSensitivityChange,this.onRestReminderToggle=t.onRestReminderToggle,this.onLanguageChange=t.onLanguageChange,w.setLanguage(this.language,{notify:!1}),this.languageUnsubscribe?.(),this.languageUnsubscribe=w.subscribe(i=>{this.language=i,this.render()}),!this.overlay){const i=window.innerHeight<=760;this.overlay=document.createElement("div"),this.overlay.setAttribute("data-color-accessibility-settings",""),this.overlay.style.cssText=`
      ...
      `;for(const h of Yt){const S=document.createElement("button");S.setAttribute("data-language-button",h.value),S.style.cssText=`
          min-height: 3.25rem;
        ...
        `,S.addEventListener("click",()=>{w.setLanguage(h.value),this.onLanguageChange?.(h.value)}),this.languageButtons.set(h.value,S),g.appendChild(S)}const r=document.createElement("h3");r.setAttribute("data-color-vision-title",""),r.style.cssText="margin: 0.9rem 0 0.45rem; font-size: clamp(1rem, 3.8vmin, 1.2rem);",this.colorVisionDescriptionEl=document.createElement("p"),this.colorVisionDescriptionEl.style.cssText="margin: 0 0 0.8rem; font-size: clamp(0.9rem, 3.2vmin, 1rem); line-height: 1.5;";const d=document.createElement("div");d.setAttribute("data-color-vision-mode-group",""),d.style.cssText=`
        display: grid;
        grid-template-columns: repeat(2, minmax(0, 1fr));
        gap: 0.65rem;
        margin-bottom: 0.95rem;
      `;for(const h of Wt){const S=document.createElement("button");S.setAttribute("data-color-vision-mode-button",h.value),S.style.cssText=`
          min-height: 3.25rem;
          padding: 0.8rem 0.9rem;
          border-radius: 1rem;
          border: 2px solid rgba(255, 255, 255, 0.4);
          ...
          touch-action: manipulation;
          transition: transform 0.08s ease-out, border-color 0.12s ease-out, background 0.12s ease-out;
        `,S.addEventListener("click",()=>{this.colorVisionSupportMode=h.value,this.render(),this.onColorVisionSupportModeChange?.(h.value)}),this.colorVisionButtons.set(h.value,S),d.appendChild(S)}const C=document.createElement("h3");C.setAttribute("data-vibration-title",""),C.style.cssText="margin: 0.9rem 0 0.45rem; font-size: clamp(1rem, 3.8vmin, 1.2rem);",this.vibrationDescriptionEl=document.createElement("p"),this.vibrationDescriptionEl.style.cssText="margin: 0 0 0.8rem; font-size: clamp(0.9rem, 3.2vmin, 1rem); line-height: 1.5;";const y=document.createElement("div");y.setAttribute("data-vibration-intensity-group",""),y.style.cssText=`
        display: grid;
        grid-template-columns: repeat(2, minmax(0, 1fr));
        gap: 0.65rem;
        margin-bottom: 0.95rem;
      `;for(const h of Zt){const S=document.createElement("button");S.setAttribute("data-vibration-intensity-button",h.value),S.style.cssText=`
          min-height: 3.25rem;
          padding: 0.8rem 0.9rem;
          border-radius: 1rem;
          border: 2px solid rgba(255, 255, 255, 0.4);
          ...
          touch-action: manipulation;
          transition: transform 0.08s ease-out, border-color 0.12s ease-out, background 0.12s ease-out;
        `,S.addEventListener("click",()=>{this.vibrationIntensity=h.value,this.render(),this.onVibrationIntensityChange?.(h.value)}),this.vibrationButtons.set(h.value,S),y.appendChild(S)}const p=document.createElement("h3");p.setAttribute("data-motion-title",""),p.style.cssText="margin: 1.1rem 0 0.45rem; font-size: clamp(1rem, 3.8vmin, 1.2rem);";const A=document.createElement("p");A.setAttribute("data-motion-hint",""),A.style.cssText="margin: 0 0 0.5rem; font-size: clamp(0.9rem, 3.2vmin, 1rem); line-height: 1.5;",this.motionDescriptionEl=document.createElement("p"),this.motionDescriptionEl.style.cssText="margin: 0 0 0.8rem; font-size: clamp(0.9rem, 3.2vmin, 1rem); line-height: 1.5;";const T=document.createElement("div");T.setAttribute("data-motion-sensitivity-group",""),T.style.cssText=`
        display: grid;
        grid-template-columns: repeat(2, minmax(0, 1fr));
        gap: 0.65rem;
        margin-bottom: 0.95rem;
      `;const M=["strong","medium","gentle","minimal"];for(const h of M){const S=Ct(h),P=document.createElement("button");P.setAttribute("data-motion-sensitivity-button",h),P.style.cssText=`
          display: flex;
          flex-direction: column;
          align-items: center;
          justify-content: center;
          ...
          touch-action: manipulation;
          transition: transform 0.08s ease-out, border-color 0.12s ease-out, background 0.12s ease-out;
        `;const F=document.createElement("span");F.textContent=S.emoji,F.style.cssText="font-size: clamp(1.25rem, 4.8vmin, 1.7rem); line-height: 1;";const V=document.createElement("span");V.textContent=S.stars,V.style.cssText="font-size: clamp(0.82rem, 2.9vmin, 0.95rem); letter-spacing: 0.08em;";const U=document.createElement("span");U.setAttribute("data-motion-label",h),U.style.cssText="font-size: clamp(0.9rem, 3vmin, 1rem);",P.append(F,V,U),P.addEventListener("click",()=>{this.motionSensitivity=h,this.render(),this.playMotionPreview(),this.onMotionSensitivityChange?.(h)}),this.motionButtons.set(h,P),T.appendChild(P)}this.motionPreviewEl=document.createElement("div"),this.motionPreviewEl.setAttribute("data-motion-preview",""),this.motionPreviewEl.style.cssText=`
        position: relative;
        min-height: 5.8rem;
        margin: 0 0 1rem;
        padding: 0.8rem 0.9rem;
    ...
    `,m.appendChild(f);const b=document.createElement("div");b.setAttribute("data-stats-stage-clears",""),b.style.cssText=`
      ...
      gap: 0.45rem;
      text-align: left;
    `;const g=Array.from({length:H},(d,C)=>C+1).map(d=>({stageNumber:d,clearCount:s.stageClearCounts[d]??0})).filter(d=>d.clearCount>0);if(g.length===0){const d=document.createElement("div");d.textContent="まだ きろくが ないよ",d.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: ${n?"1rem":"1.1rem"};
        font-weight: 700;
        text-align: center;
        color: rgba(255, 255, 255, 0.88);
      `,b.appendChild(d)}else for(const{stageNumber:d,clearCount:C}of g){const y=Q(d),p=document.createElement("div");p.setAttribute("data-stats-stage-clear-row",String(d)),p.style.cssText=`
          display: flex;
          align-items: center;
          ...
          font-weight: 700;
        `;const A=document.createElement("span");A.textContent=`${y.emoji} ステージ ${d} ${y.destinationReading}`;const T=document.createElement("span");T.textContent=`${C}かい`,T.style.color="#FFE66D",p.append(A,T),b.appendChild(p)}m.appendChild(b),o.appendChild(m);const r=document.createElement("button");r.textContent="もどる",r.style.cssText=`
      margin-top: 1rem;
    ...
    `,this.root=t,this.setMotionSensitivity(this.motionSensitivity),t}injectStyles(){if(document.getElementById(X.STYLE_ID))return;const t=document.createElement("style");t.id=X.STYLE_ID,t.textContent=`
  ...
  `,a.appendChild(u),a}const Kt=2e3,yt=new Map,bt=new Map,vt=new Map;let ut=null,dt=null;function et(l,t){if(typeof document>"u"){const i=typeof OffscreenCanvas=="function",s=i?new OffscreenCanvas(l,t):{width:l,height:t};return{canvas:s,ctx:i?s.getContext("2d"):null}}const e=document.createElement("canvas");return e.width=l,e.height=t,{canvas:e,ctx:e.getContext("2d")}}function tt(l,t){let e=yt.get(l);return e||(e=t(),e.generateMipmaps=!1,e.minFilter=ri,e.needsUpdate=!0,yt.set(l,e)),e}function O(l,t){let e=bt.get(l);return e||(e=t(),bt.set(l,e)),e}function L(l,t){let e=vt.get(l);return e||(e=t(),vt.set(l,e)),e}function k(l,t){const e=new oi(l,t);return e.userData.sharedAssets=!0,e}function ce(){if(!ut){const l=new Dt,t=new Float32Array(Kt*3);for(let e=0;e<Kt*3;e+=3)t[e]=(Math.random()-.5)*200,t[e+1]=(Math.random()-.5)*200,t[e+2]=(Math.random()-.5)*400;l.setAttribute("position",new Lt(t,3)),ut=l}dt||(dt=new Gt({color:16777215,size:.2,sizeAttenuation:!0}))}function fi(){const{canvas:l,ctx:t}=et(256,256);if(!t)return new _(l);t.fillStyle="#888888",t.fillRect(0,0,256,256);for(let e=0;e<30;e++){const i=Math.random()*256,s=Math.random()*256,n=3+Math.random()*12;t.beginPath(),t.arc(i,s,n,0,Math.PI*2),t.fillStyle=`rgba(60,60,60,${.3+Math.random()*.4})`,t.fill()}return new _(l)}function yi(){const{canvas:l,ctx:t}=et(256,256);if(!t)return new _(l);t.fillStyle="#ddaa44",t.fillRect(0,0,256,256);for(let e=0;e<8;e++){t.beginPath();const i=128+(Math.random()-.5)*100,s=128+(Math.random()-.5)*100;t.strokeStyle=`rgba(200,150,60,${.3+Math.random()*.3})`,t.lineWidth=3+Math.random()*5;for(let n=0;n<Math.PI*4;n+=.1){const a=10+n*8;t.lineTo(i+Math.cos(n)*a,s+Math.sin(n)*a)}t.stroke()}return new _(l)}function bi(){const{canvas:l,ctx:t}=et(256,256);if(!t)return new _(l);const e=["#cc7733","#dd9955","#bb6622","#eebb77","#aa5511","#ddaa66"];for(let i=0;i<256;i++){const s=Math.floor(i/(256/e.length))%e.length;t.fillStyle=e[s],t.fillRect(0,i,256,1)}return new _(l)}function vi(){const{canvas:l,ctx:t}=et(512,256);return t?(t.fillStyle="#2266aa",t.fillRect(0,0,512,256),t.fillStyle="#886644",t.beginPath(),t.ellipse(300,80,80,40,.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(280,150,30,50,.1,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(100,90,25,60,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(110,170,20,40,-.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(420,170,25,15,0,0,Math.PI*2),t.fill(),t.fillStyle="#447733",t.beginPath(),t.ellipse(290,75,40,20,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(95,85,15,30,.2,0,Math.PI*2),t.fill(),new _(l)):new _(l)}function Si(){const{canvas:l,ctx:t}=et(512,256);if(!t)return new _(l);t.clearRect(0,0,512,256),t.fillStyle="rgba(255,255,255,0.6)";for(let e=0;e<20;e++){const i=Math.random()*512,s=Math.random()*256;t.beginPath(),t.ellipse(i,s,20+Math.random()*40,8+Math.random()*15,Math.random()*Math.PI,0,Math.PI*2),t.fill()}return new _(l)}function Ei(){const{canvas:l,ctx:t}=et(256,128);if(!t)return new _(l);t.fillStyle="#d7dde8",t.fillRect(0,0,256,128),t.fillStyle="#8bbcff",t.fillRect(0,0,256,28),t.fillStyle="#90a4bf";for(let e=0;e<256;e+=24)t.fillRect(e,40,4,88);t.fillStyle="#4a6c9a";for(let e=44;e<128;e+=16)t.fillRect(0,e,256,6);return new _(l)}function xi(){yt.clear(),bt.clear(),vt.clear(),ut=null,dt=null}const Ci={planetTextureCache:yt,planetGeometryCache:bt,planetMaterialCache:vt,getBgStarsGeometry:()=>ut,getBgStarsMaterial:()=>dt};function he(l,t,e){const i=new nt;let s=null;switch(l){case 2:{const n=tt("mercury",fi),a=O("mercury:sphere",()=>new $(10,24,24)),o=L("mercury:mat",()=>new D({map:n})),c=k(a,o);i.add(c),s=c;break}case 3:{const n=tt("venus",yi),a=O("venus:sphere",()=>new $(14,24,24)),o=L("venus:mat",()=>new D({map:n})),c=k(a,o);i.add(c),s=c;break}case 5:{const n=tt("jupiter",bi),a=O("jupiter:sphere",()=>new $(20,24,24)),o=L("jupiter:mat",()=>new D({map:n})),c=k(a,o);i.add(c),s=c;break}case 6:{const n=O("saturn:sphere",()=>new $(15,24,24)),a=t.planetColor,o=L(`saturn:mat:${a}`,()=>new D({color:a})),c=k(n,o);i.add(c);const u=O("saturn:ring",()=>new jt(20,30,48)),m=L("saturn:ringMat",()=>new D({color:15645542,side:Ut})),f=k(u,m);f.rotation.x=Math.PI/3,i.add(f),s=c;break}case 7:{const n=O("uranus:sphere",()=>new $(16,24,24)),a=L("uranus:mat",()=>new D({color:6737117})),o=k(n,a);i.add(o);const c=O("uranus:ring",()=>new jt(21,28,48)),u=L("uranus:ringMat",()=>new D({color:10083822,side:Ut})),m=k(c,u);m.rotation.z=Math.PI/2,i.add(m),s=o;break}case 9:{const n=O("pluto:sphere",()=>new $(8,24,24)),a=L("pluto:mat",()=>new D({color:12298922})),o=k(n,a);i.add(o),s=o;break}case 10:{const n=O("sun:sphere",()=>new $(25,24,24)),a=L("sun:mat",()=>new D({color:16763904,emissive:16755200,emissiveIntensity:.5})),o=k(n,a);i.add(o),i.add(new ai(16763904,2,200)),s=o;break}case 11:{const n=tt("station:panel",Ei),a=O("station:core",()=>new Ft(3.2,3.2,12,12)),o=O("station:module",()=>new Ft(1.7,1.7,6,10)),c=O("station:truss",()=>new Vt(18,.9,.9)),u=O("station:panelGeo",()=>new Vt(8,3.6,.18)),m=O("station:dish",()=>new $(1.4,12,12,0,Math.PI)),f=L("station:metal",()=>new D({color:14213354})),b=L("station:moduleMat",()=>new D({color:11057099})),g=L("station:panelMat",()=>new D({map:n,color:16777215})),r=new nt,d=k(a,f);d.rotation.z=Math.PI/2,r.add(d);const C=k(c,b);r.add(C);const y=k(o,b);y.position.x=-6,y.rotation.z=Math.PI/2,r.add(y);const p=k(o,b);p.position.x=6,p.rotation.z=Math.PI/2,r.add(p);const A=k(u,g);A.position.set(-11,0,0),r.add(A);const T=k(u,g);T.position.set(11,0,0),r.add(T);const M=k(m,f);M.position.set(0,3.2,0),M.rotation.x=-Math.PI/2,r.add(M),i.add(r),s=r;break}case 12:{const n=tt("earth",vi),a=O("earth:sphere",()=>new $(15,32,32)),o=L("earth:mat",()=>new D({map:n})),c=tt("earth:cloud",Si),u=O("earth:cloudSphere",()=>new $(15.5,32,32)),m=L("earth:cloudMat",()=>new D({map:c,transparent:!0,opacity:.3})),f=new nt;f.add(k(a,o)),f.add(k(u,m)),i.add(f),s=f;break}default:{const n=O("default:sphere",()=>new $(15,24,24)),a=t.planetColor,o=L(`default:mat:${a}`,()=>new D({color:a})),c=k(n,o);i.add(c),s=c;break}}return i.position.set(0,0,e),{planet:i,spinTarget:s}}function ue(l,t,e){return he(l,t,e)}function de(l){ce();const t=new It(ut,dt);return t.userData.sharedAssets=!0,t.geometry.setDrawRange(0,l),t}function Nt(l){!Number.isInteger(l)||l<1||l>H||typeof document>"u"&&typeof OffscreenCanvas!="function"||(ce(),he(l,Q(l),0))}let at=null,ot=null;function wi(){if(!at){const l=new Dt,t=new Float32Array(3e3);for(let e=0;e<3e3;e++)t[e]=(Math.random()-.5)*200;l.setAttribute("position",new Lt(t,3)),at=l}return at}function Ti(){return ot||(ot=new Gt({color:16777215,size:.3,sizeAttenuation:!0})),ot}function Ai(){at=null,ot=null}const Mi={getBgStarsGeometry:()=>at,getBgStarsMaterial:()=>ot};function Pi(l){const t=window.requestIdleCallback;if(typeof t=="function"){t(l,{timeout:1500});return}window.setTimeout(l,800)}function me(l){return new Set(l.filter(t=>Number.isInteger(t)&&t>=1&&t<=H)).size}function Bi(l){return me(l)>=H}function At(l){const t=Bi(l.unlockedPlanets),e=t?1:Math.min(l.clearedStage+1,H),i=Q(e),s=l.bestStageStars?.[e]??0,n=l.colorAccessibility?.colorVisionSupportMode??j,a=se(e,i.destinationReading,n);return t?{startStage:e,destination:a,emoji:i.emoji,statusLabel:"ぜんぶ あつめたよ！",destinationLabel:`${a}へ もういちど しゅっぱつ！`,buttonHint:`${i.emoji} ステージ ${e} から もういちど あそぶ`,bestStars:s}:{startStage:e,destination:a,emoji:i.emoji,statusLabel:l.clearedStage>0?"つづきから しゅっぱつ！":"はじめての しゅっぱつ！",destinationLabel:`${a}へ むかおう！`,buttonHint:`${i.emoji} ステージ ${e} から スタート`,bestStars:s}}function ki(l){return l.clearedStage>0||me(l.unlockedPlanets)>0||Object.keys(l.bestStageStars??{}).length>0}class Ri{threeScene;ambientLight=new St(16777215,1);camera;lastAspect=0;sceneManager;saveManager;audioManager;stars=null;companionParade=null;overlay=null;muteHandle=null;tutorialOverlay=new zt;titleResetConfirmOverlay=new ci;colorAccessibilitySettings=new hi;spaceshipCustomizer=new ui;statsOverlay=new pi;encyclopediaOverlay=null;encyclopediaOverlayPromise=null;companionFactory=null;companionFactoryPromise=null;loadEncyclopediaOverlay;loadTitleCompanionFactory;loadingOverlay;loadFailureOverlay;scheduleIdleTask;encyclopediaBtn=null;isOpeningEncyclopedia=!1;isActive=!1;touchFeedbackOverlay=new X;encyclopediaRequestToken=0;companionParadeRequestToken=0;bgmPending=!1;overlayButtonCleanups=new Set;colorSettingsButton=null;unsubscribeLanguageChange=null;constructor(t,e,i,s={}){this.sceneManager=t,this.saveManager=e,this.audioManager=i,this.loadingOverlay=s.loadingOverlay??new fe,this.loadFailureOverlay=s.loadFailureOverlay??new ye,this.scheduleIdleTask=s.scheduleIdleTask??Pi,this.loadEncyclopediaOverlay=s.loadEncyclopediaOverlay??(()=>Bt(()=>import("./EncyclopediaOverlay-B02iNqkP.js"),__vite__mapDeps([0,1,2]))),this.loadTitleCompanionFactory=s.loadTitleCompanionFactory??(()=>Bt(()=>import("./game-core-Cp8aEKWe.js").then(o=>o.an),__vite__mapDeps([1,2]))),this.threeScene=new ct,this.threeScene.background=new ht(32);const{width:n,height:a}=N();this.camera=new Et(60,n/a,.1,1e3),this.camera.position.set(0,0,5)}enter(t){this.isActive=!0,this.encyclopediaRequestToken+=1,this.companionParadeRequestToken+=1,this.lastAspect=0,this.stars=new It(wi(),Ti()),this.stars.userData.sharedAssets=!0,this.stars.rotation.set(0,0,0),this.threeScene.add(this.stars),this.ambientLight.parent||this.threeScene.add(this.ambientLight);const e=this.saveManager.load();w.setLanguage(e.language??mt,{notify:!1}),this.createCompanionParade(e.unlockedPlanets),this.createOverlay(),this.createMuteButton(),this.touchFeedbackOverlay.setMotionSensitivity(e.colorAccessibility?.motionSensitivity??Y()),this.touchFeedbackOverlay.attach(),this.touchFeedbackOverlay.bindUiRoots([document.getElementById("hud"),document.getElementById("ui-overlay")]),this.prefetchEncyclopediaOnIdle(),this.prewarmNextAdventureOnIdle(At(e).startStage),this.audioManager.isInitialized()?(this.audioManager.playBGM(0),this.bgmPending=!1):this.bgmPending=!0,e.tutorialShown||this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide(),this.saveManager.markTutorialShown()})}createMuteButton(){const t=document.getElementById("hud")??document.getElementById("ui-overlay");t&&(this.muteHandle=Ht({initialMuted:this.audioManager.isMuted(),container:t,onToggle:()=>{this.ensureTitleAudioInitialized(!0);const e=this.audioManager.toggleMute();this.muteHandle?.setMuted(e);const i=this.saveManager.load();i.muted=e,this.saveManager.save(i)}}))}getEncyclopediaOverlay(){return this.encyclopediaOverlay?Promise.resolve(this.encyclopediaOverlay):this.encyclopediaOverlayPromise?this.encyclopediaOverlayPromise:(this.encyclopediaOverlayPromise=this.loadEncyclopediaOverlay().then(({EncyclopediaOverlay:t})=>{const e=new t;return this.encyclopediaOverlay=e,e}).finally(()=>{this.encyclopediaOverlayPromise=null}),this.encyclopediaOverlayPromise)}getTitleCompanionFactory(){return this.companionFactory?Promise.resolve(this.companionFactory):this.companionFactoryPromise?this.companionFactoryPromise:(this.companionFactoryPromise=this.loadTitleCompanionFactory().then(t=>(this.companionFactory=t,t)).finally(()=>{this.companionFactoryPromise=null}),this.companionFactoryPromise)}showEncyclopedia(){if(!this.isActive||!this.encyclopediaOverlay)return;const t=this.saveManager.load();this.encyclopediaOverlay.show(t.unlockedPlanets,()=>this.refreshEncyclopediaButtonLabel(),e=>{this.ensureTitleAudioInitialized(!1),this.sceneManager.requestTransition("stage",{stageNumber:e,totalScore:0,totalStarCount:0,launchSource:"encyclopedia"})},t.bestStageStars??{},t.discoveredConstellations??[],t.colorAccessibility?.colorVisionSupportMode??j,t.discoveredMonthlyEncounters??[])}isCurrentEncyclopediaRequest(t){return this.isActive&&this.encyclopediaRequestToken===t}prefetchEncyclopediaOnIdle(){const t=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{!this.isCurrentEncyclopediaRequest(t)||this.encyclopediaOverlay||this.encyclopediaOverlayPromise||this.getEncyclopediaOverlay().catch(()=>{})})}prewarmNextAdventureOnIdle(t){if(t>H)return;const e=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{this.isCurrentEncyclopediaRequest(e)&&Nt(t)})}async openEncyclopedia(){if(!this.isActive)return;if(this.loadFailureOverlay.hide(),this.encyclopediaOverlay){this.showEncyclopedia();return}if(this.isOpeningEncyclopedia)return;const t=this.encyclopediaRequestToken;this.isOpeningEncyclopedia=!0,this.loadingOverlay.show("ずかんを よんでるよ...");try{if(await this.getEncyclopediaOverlay(),!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),this.showEncyclopedia()}catch(e){if(!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),console.error("Failed to load encyclopedia overlay",e),this.loadFailureOverlay.show({title:"ずかんを もういちど よんでみよう！",message:"「もういちど よむ」を おして つづきを たのしもう！",primaryAction:{label:"もういちど よむ",onSelect:()=>this.openEncyclopedia()}})}finally{this.encyclopediaRequestToken===t&&(this.isOpeningEncyclopedia=!1)}}persistHighContrastSetting(t){const e=this.saveManager.load(),i=e.colorAccessibility?.motionSensitivity??Y(),s=e.colorAccessibility?.colorVisionSupportMode??j;e.colorAccessibility=this.buildColorAccessibilitySettings(t,i,s),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}persistVibrationIntensitySetting(t){const e=this.saveManager.load();e.vibrationSettings={intensity:t},this.saveManager.save(e),ie(t)}persistRestReminderSetting(t){const e=this.saveManager.load();e.restReminderSettings={enabled:t},this.saveManager.save(e)}persistLanguageSetting(t){const e=this.saveManager.load();t===mt?delete e.language:e.language=t,this.saveManager.save(e)}persistBGMVolumeSetting(t){const e=this.saveManager.load();e.audioSettings=this.buildAudioSettings(t,e.audioSettings?.sfxVolume??100),e.audioSettings||delete e.audioSettings,this.saveManager.save(e),this.audioManager.setBGMVolume(t)}persistSFXVolumeSetting(t){const e=this.saveManager.load();e.audioSettings=this.buildAudioSettings(e.audioSettings?.bgmVolume??100,t),e.audioSettings||delete e.audioSettings,this.saveManager.save(e),this.audioManager.setSFXVolume(t)}persistMotionSensitivitySetting(t){const e=this.saveManager.load(),i=e.colorAccessibility?.highContrast===!0,s=e.colorAccessibility?.colorVisionSupportMode??j;e.colorAccessibility=this.buildColorAccessibilitySettings(i,t,s),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}persistColorVisionSupportModeSetting(t){const e=this.saveManager.load(),i=e.colorAccessibility?.highContrast===!0,s=e.colorAccessibility?.motionSensitivity??Y();e.colorAccessibility=this.buildColorAccessibilitySettings(i,s,t),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}buildColorAccessibilitySettings(t,e,i){const s=Y();if(!(!t&&e===s&&i===j))return{...t?{highContrast:!0}:{},...e!==s?{motionSensitivity:e}:{},...i!==j?{colorVisionSupportMode:i}:{}}}buildAudioSettings(t,e){if(!(t===100&&e===100))return{...t!==100?{bgmVolume:t}:{},...e!==100?{sfxVolume:e}:{}}}createOverlay(){const t=document.getElementById("ui-overlay");if(!t)return;const e=this.saveManager.load(),i=At(e),s=ki(e);this.overlay=document.createElement("div"),this.unsubscribeLanguageChange?.(),this.unsubscribeLanguageChange=w.subscribe(()=>this.applyLocalizedText()),this.overlay.style.cssText=`
    ...
    `;const d=document.createElement("button");d.textContent="あそぶ",d.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(I(d,{onActivate:()=>{this.ensureTitleAudioInitialized(!1);const h=this.saveManager.load(),S=At(h).startStage;this.sceneManager.requestTransition("stage",{stageNumber:S,totalScore:0,totalStarCount:0,launchSource:"campaign"})},onPressChange:h=>{d.style.transform=h?"scale(0.96)":"scale(1)"}}));const C=document.createElement("div");C.setAttribute("data-play-button-hint",""),C.textContent=i.buttonHint,C.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${n?"0.85rem":"1rem"};
      font-weight: 700;
      color: rgba(255, 255, 255, 0.88);
    ...
    `;const y=document.createElement("button");y.textContent="うちゅうで あそぶ",y.setAttribute("data-free-play-button",""),y.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(I(y,{onActivate:()=>{this.ensureTitleAudioInitialized(!1),this.sceneManager.requestTransition("freePlay",{})},onPressChange:h=>{y.style.transform=h?"scale(0.96)":"scale(1)"}}));const p=document.createElement("div");p.setAttribute("data-title-secondary-actions",""),p.style.cssText=`
      display: grid;
    ...
    `;const A=document.createElement("button");A.setAttribute("data-spaceship-customizer-button",""),A.textContent="うちゅうせんをかざろう",A.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(I(A,{onActivate:()=>{const h=this.saveManager.load();this.spaceshipCustomizer.show({initialCustomization:h.spaceshipCustomization??Rt,onComplete:S=>{const P=this.saveManager.load();P.spaceshipCustomization=S,this.saveManager.save(P)}})},onPressChange:h=>{A.style.transform=h?"scale(0.96)":"scale(1)"}}));const T=document.createElement("button");T.setAttribute("data-stats-button",""),T.textContent="あそびの きろく",T.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${n?"0.9rem":"1.05rem"};
      font-weight: 900;
      padding: ${n?"0.55rem 0.65rem":"0.7rem 0.85rem"};
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(I(T,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.statsOverlay.show(this.saveManager.load().gameplayStats,()=>{})},onPressChange:h=>{T.style.transform=h?"scale(0.96)":"scale(1)"}}));const M=document.createElement("div");M.setAttribute("data-title-footer-actions",""),M.style.cssText=`
      display: grid;
    ...
    `;const B=document.createElement("button");B.textContent="あそびかた",B.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(I(B,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide()})},onPressChange:h=>{B.style.transform=h?"scale(0.96)":"scale(1)"}}));const E=document.createElement("button");E.setAttribute("data-color-settings-button",""),E.textContent=w.t("titleScene.colorSettingsButton"),this.colorSettingsButton=E,E.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${n?"0.82rem":"1rem"};
      font-weight: 700;
      padding: ${n?"0.45rem 0.55rem":"0.55rem 0.8rem"};
      ...
      transition: transform 0.08s ease-out;
      white-space: nowrap;
    `,this.overlayButtonCleanups.add(I(E,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.colorAccessibilitySettings.show({initialHighContrast:this.saveManager.load().colorAccessibility?.highContrast===!0,initialColorVisionSupportMode:this.saveManager.load().colorAccessibility?.colorVisionSupportMode??j,initialBGMVolume:this.saveManager.load().audioSettings?.bgmVolume??100,initialSFXVolume:this.saveManager.load().audioSettings?.sfxVolume??100,initialVibrationIntensity:this.saveManager.load().vibrationSettings?.intensity??"medium",initialMotionSensitivity:this.saveManager.load().colorAccessibility?.motionSensitivity??Y(),initialRestReminderEnabled:this.saveManager.load().restReminderSettings?.enabled??be,initialLanguage:this.saveManager.load().language??mt,onToggle:h=>this.persistHighContrastSetting(h),onColorVisionSupportModeChange:h=>this.persistColorVisionSupportModeSetting(h),onBGMVolumeChange:h=>this.persistBGMVolumeSetting(h),onSFXVolumeChange:h=>this.persistSFXVolumeSetting(h),onVibrationIntensityChange:h=>this.persistVibrationIntensitySetting(h),onMotionSensitivityChange:h=>this.persistMotionSensitivitySetting(h),onRestReminderToggle:h=>this.persistRestReminderSetting(h),onLanguageChange:h=>this.persistLanguageSetting(h)})},onPressChange:h=>{E.style.transform=h?"scale(0.96)":"scale(1)"}}));const x=document.createElement("button");if(x.textContent=Qt(e.unlockedPlanets.length,st.length),x.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${n?"0.82rem":"1rem"};
      font-weight: 700;
      padding: ${n?"0.45rem 0.55rem":"0.55rem 0.8rem"};
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.encyclopediaBtn=x,this.overlayButtonCleanups.add(I(x,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.openEncyclopedia()},onPressChange:h=>{x.style.transform=h?"scale(0.96)":"scale(1)"}})),r.appendChild(d),r.appendChild(y),r.appendChild(C),p.appendChild(A),p.appendChild(T),s){const h=document.createElement("button");h.setAttribute("data-reset-progress-button",""),h.textContent="さいしょから",h.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: ${n?"0.9rem":"1.05rem"};
        font-weight: 900;
        padding: ${n?"0.55rem 0.65rem":"0.7rem 0.85rem"};
