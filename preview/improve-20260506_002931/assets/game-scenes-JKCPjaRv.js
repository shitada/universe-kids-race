const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-LkyaIn0D.js","assets/game-core-LV5LGXDP.js","assets/three-BsQe5WE2.js"])))=>i.map(i=>d[i]);
import{g as lt,D as Tt,S as W,T as L,a as U,b as jt,L as oe,c as re,_ as wt,d as z,e as $,f as q,s as Ut,h as ht,i as Wt,j as le,P as K,u as Zt,C as he,k as ce,l as de,B as ue,m as me,M as pe,n as ge,o as fe,p as ye,q as be,r as ve,t as Ee,v as Se,w as xe,x as Ce,y as we,z as Ae,A as Te,E as qt,W as Me,F as Pe,G as Be,H as Yt,I as Re,J as Mt,K as ke,N as Oe,R as Ie,O as De,Q as Ge,U as Le,V as ze,X as Lt,Y as Xt,Z as He,$ as ct,a0 as Z,a1 as Fe,a2 as vt,a3 as Ne,a4 as Et,a5 as $e,a6 as _e,a7 as Ve,a8 as je,a9 as Ue}from"./game-core-LV5LGXDP.js";import{n as Pt,l as Bt,j as Rt,m as kt,G as dt,r as We,a as Ze,s as qe,M as k,h as H,D as zt,R as Ht,t as F,u as ft,v as st,i as nt,P as yt,V as Y,w as Qt,x as Ye}from"./three-BsQe5WE2.js";class Ot{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const e=document.getElementById("ui-overlay");if(!e)return;const i=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
    ...
    `;const c=document.createElement("div");return c.textContent=i,c.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
    ...
    `,i.style.overflowY="hidden",i.style.height="100%",i.style.maxHeight="720px",i.addEventListener("pointerdown",c=>c.stopPropagation()),this.overlay.appendChild(i);const s=document.createElement("h2");s.textContent="うちゅうせんを かざろう",s.style.cssText="margin: 0 0 0.3rem; font-size: clamp(1.25rem, 4.3vmin, 1.85rem); color: #ffe66d;";const n=document.createElement("p");n.textContent="おおきな ボタンで えらぶと、すぐに みためが かわるよ。",n.style.cssText="margin: 0 0 0.45rem; font-size: clamp(0.85rem, 2.8vmin, 1rem); line-height: 1.35;",i.appendChild(s),i.appendChild(n);const a=document.createElement("div");a.setAttribute("data-spaceship-customizer-content",""),a.style.cssText="display: grid; grid-template-columns: minmax(12rem, 15rem) minmax(0, 1fr); gap: 0.65rem; align-items: stretch; margin: 0.45rem 0 0.65rem;",a.appendChild(this.createPreviewCard());const o=document.createElement("div");o.setAttribute("data-spaceship-customizer-sections",""),o.style.cssText="display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 0.5rem; align-items: stretch;",o.appendChild(this.createPartSection("bodyColor","ほんたい")),o.appendChild(this.createPartSection("noseColor","ノーズ")),o.appendChild(this.createPartSection("wingColor","つばさ")),a.appendChild(o),i.appendChild(a);const h=document.createElement("button");h.textContent="かんりょう",h.setAttribute("data-spaceship-customizer-done",""),h.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.buttonCleanups.add(M(h,{onActivate:()=>{const c={...this.draft};this.hide(),t.onComplete(c)},onPressChange:c=>{h.style.transform=c?"scale(0.96)":"scale(1)"}})),i.appendChild(h),e.appendChild(this.overlay),this.render()}hide(){const t=Array.from(this.buttonCleanups);this.buttonCleanups.clear();for(const e of t)e();this.optionButtons.clear(),this.overlay?.remove(),this.overlay=null,this.previewBody=null,this.previewNose=null,this.previewWings=null}isVisible(){return this.overlay?.isConnected===!0}createPreviewCard(){const t=document.createElement("div");t.setAttribute("data-spaceship-customizer-preview-card",""),t.style.cssText=`
      width: 100%;
      margin: 0;
      height: 100%;
      padding: 0.6rem;
    ...
    `,o.appendChild(h);const c=document.createElement("div");c.style.cssText=`
      ...
      gap: 0.8rem;
      margin-bottom: 1rem;
    `,c.append(this.createSummaryCard("あそんだ じかん",ti(s.totalPlayTimeSeconds),"data-stats-total-play-time"),this.createSummaryCard("とった ほし",`${s.totalStarsCollected}こ`,"data-stats-total-stars"),this.createSummaryCard("ブースト",`${s.totalBoostUses}かい`,"data-stats-total-boosts")),o.appendChild(c);const m=document.createElement("div");m.style.cssText=`
      margin-top: 0.5rem;
    ...
    `,m.appendChild(f);const b=document.createElement("div");b.setAttribute("data-stats-stage-clears",""),b.style.cssText=`
      ...
      gap: 0.45rem;
      text-align: left;
    `;const g=Array.from({length:L},(u,x)=>x+1).map(u=>({stageNumber:u,clearCount:s.stageClearCounts[u]??0})).filter(u=>u.clearCount>0);if(g.length===0){const u=document.createElement("div");u.textContent="まだ きろくが ないよ",u.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.actionCleanups.add(M(r,{onActivate:()=>{this.hide(),e()},onPressChange:u=>{r.style.transform=u?"scale(0.96)":"scale(1)"}})),o.appendChild(r),a.appendChild(o),i.appendChild(a)}hide(){const t=Array.from(this.actionCleanups);this.actionCleanups.clear();for(const e of t)e();this.overlayEl?.remove(),this.overlayEl=null}createSummaryCard(t,e,i){const s=document.createElement("div");s.setAttribute(i,""),s.style.cssText=`
    ...
    `;const a=document.createElement("div");return a.textContent=e,a.style.cssText=`
      ...
      font-weight: 900;
      color: #FFE66D;
    `,s.append(n,a),s}}function Nt(l,t){if(!Number.isFinite(l)||l<=0||t<=0)return"ずかん";const e=Math.min(l,t);return e>=t?`ずかん ${t} / ${t} 🎉`:`ずかん ${e} / ${t}`}function ii(l){switch(l){case"hero":return{gap:"0.35rem",label:"0.92rem",medal:"1.7rem",hint:"0.98rem"};case"compact":return{gap:"0.18rem",label:"0.7rem",medal:"1rem",hint:"0.76rem"};default:return{gap:"0.26rem",label:"0.8rem",medal:"1.25rem",hint:"0.84rem"}}}function At(l,t,e={}){const i=jt(l,t),s=e.size??"regular",n=ii(s),a=document.createElement("div");if(a.setAttribute("data-stage-medal-display",""),a.setAttribute("data-stage-medal-stage",String(l)),a.setAttribute("data-stage-medal-tier",i.tier),a.setAttribute("data-stage-medal-earned",String(i.earnedCount)),e.scope&&a.setAttribute("data-stage-medal-scope",e.scope),a.style.cssText=`
    display: flex;
    flex-direction: column;
    align-items: center;
    gap: ${n.gap};
  ...
  `;for(const m of i.slots){const f=document.createElement("span");f.setAttribute("data-stage-medal-slot",m.tier),f.setAttribute("data-stage-medal-threshold",String(m.threshold)),f.setAttribute("data-stage-medal-reached",String(m.reached)),f.textContent=m.icon,f.style.cssText=`
    ...
    `,o.appendChild(f)}a.appendChild(o);const h=e.hint??(i.nextThreshold===null?"かんぺき！":`つぎ ⭐ ${i.nextThreshold}`),c=document.createElement("div");return c.setAttribute("data-stage-medal-hint",""),c.textContent=h,c.style.cssText=`
    font-family: 'Zen Maru Gothic', sans-serif;
    font-size: ${n.hint};
    font-weight: 700;
    color: ${i.nextThreshold===null?"#FFE66D":"rgba(255, 255, 255, 0.86)"};
  `,a.appendChild(c),a}const $t=2e3,ut=new Map,mt=new Map,pt=new Map;let at=null,ot=null;function rt(l,t){if(typeof document>"u"){const i=typeof OffscreenCanvas=="function",s=i?new OffscreenCanvas(l,t):{width:l,height:t};return{canvas:s,ctx:i?s.getContext("2d"):null}}const e=document.createElement("canvas");return e.width=l,e.height=t,{canvas:e,ctx:e.getContext("2d")}}function Q(l,t){let e=ut.get(l);return e||(e=t(),e.generateMipmaps=!1,e.minFilter=qe,e.needsUpdate=!0,ut.set(l,e)),e}function O(l,t){let e=mt.get(l);return e||(e=t(),mt.set(l,e)),e}function I(l,t){let e=pt.get(l);return e||(e=t(),pt.set(l,e)),e}function D(l,t){const e=new Ze(l,t);return e.userData.sharedAssets=!0,e}function Jt(){if(!at){const l=new Bt,t=new Float32Array($t*3);for(let e=0;e<$t*3;e+=3)t[e]=(Math.random()-.5)*200,t[e+1]=(Math.random()-.5)*200,t[e+2]=(Math.random()-.5)*400;l.setAttribute("position",new Rt(t,3)),at=l}ot||(ot=new kt({color:16777215,size:.2,sizeAttenuation:!0}))}function si(){const{canvas:l,ctx:t}=rt(256,256);if(!t)return new F(l);t.fillStyle="#888888",t.fillRect(0,0,256,256);for(let e=0;e<30;e++){const i=Math.random()*256,s=Math.random()*256,n=3+Math.random()*12;t.beginPath(),t.arc(i,s,n,0,Math.PI*2),t.fillStyle=`rgba(60,60,60,${.3+Math.random()*.4})`,t.fill()}return new F(l)}function ni(){const{canvas:l,ctx:t}=rt(256,256);if(!t)return new F(l);t.fillStyle="#ddaa44",t.fillRect(0,0,256,256);for(let e=0;e<8;e++){t.beginPath();const i=128+(Math.random()-.5)*100,s=128+(Math.random()-.5)*100;t.strokeStyle=`rgba(200,150,60,${.3+Math.random()*.3})`,t.lineWidth=3+Math.random()*5;for(let n=0;n<Math.PI*4;n+=.1){const a=10+n*8;t.lineTo(i+Math.cos(n)*a,s+Math.sin(n)*a)}t.stroke()}return new F(l)}function ai(){const{canvas:l,ctx:t}=rt(256,256);if(!t)return new F(l);const e=["#cc7733","#dd9955","#bb6622","#eebb77","#aa5511","#ddaa66"];for(let i=0;i<256;i++){const s=Math.floor(i/(256/e.length))%e.length;t.fillStyle=e[s],t.fillRect(0,i,256,1)}return new F(l)}function oi(){const{canvas:l,ctx:t}=rt(512,256);return t?(t.fillStyle="#2266aa",t.fillRect(0,0,512,256),t.fillStyle="#886644",t.beginPath(),t.ellipse(300,80,80,40,.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(280,150,30,50,.1,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(100,90,25,60,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(110,170,20,40,-.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(420,170,25,15,0,0,Math.PI*2),t.fill(),t.fillStyle="#447733",t.beginPath(),t.ellipse(290,75,40,20,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(95,85,15,30,.2,0,Math.PI*2),t.fill(),new F(l)):new F(l)}function ri(){const{canvas:l,ctx:t}=rt(512,256);if(!t)return new F(l);t.clearRect(0,0,512,256),t.fillStyle="rgba(255,255,255,0.6)";for(let e=0;e<20;e++){const i=Math.random()*512,s=Math.random()*256;t.beginPath(),t.ellipse(i,s,20+Math.random()*40,8+Math.random()*15,Math.random()*Math.PI,0,Math.PI*2),t.fill()}return new F(l)}function li(){ut.clear(),mt.clear(),pt.clear(),at=null,ot=null}const hi={planetTextureCache:ut,planetGeometryCache:mt,planetMaterialCache:pt,getBgStarsGeometry:()=>at,getBgStarsMaterial:()=>ot};function te(l,t,e){const i=new dt;let s=null;switch(l){case 2:{const n=Q("mercury",si),a=O("mercury:sphere",()=>new H(10,24,24)),o=I("mercury:mat",()=>new k({map:n})),h=D(a,o);i.add(h),s=h;break}case 3:{const n=Q("venus",ni),a=O("venus:sphere",()=>new H(14,24,24)),o=I("venus:mat",()=>new k({map:n})),h=D(a,o);i.add(h),s=h;break}case 5:{const n=Q("jupiter",ai),a=O("jupiter:sphere",()=>new H(20,24,24)),o=I("jupiter:mat",()=>new k({map:n})),h=D(a,o);i.add(h),s=h;break}case 6:{const n=O("saturn:sphere",()=>new H(15,24,24)),a=t.planetColor,o=I(`saturn:mat:${a}`,()=>new k({color:a})),h=D(n,o);i.add(h);const c=O("saturn:ring",()=>new Ht(20,30,48)),m=I("saturn:ringMat",()=>new k({color:15645542,side:zt})),f=D(c,m);f.rotation.x=Math.PI/3,i.add(f),s=h;break}case 7:{const n=O("uranus:sphere",()=>new H(16,24,24)),a=I("uranus:mat",()=>new k({color:6737117})),o=D(n,a);i.add(o);const h=O("uranus:ring",()=>new Ht(21,28,48)),c=I("uranus:ringMat",()=>new k({color:10083822,side:zt})),m=D(h,c);m.rotation.z=Math.PI/2,i.add(m),s=o;break}case 9:{const n=O("pluto:sphere",()=>new H(8,24,24)),a=I("pluto:mat",()=>new k({color:12298922})),o=D(n,a);i.add(o),s=o;break}case 10:{const n=O("sun:sphere",()=>new H(25,24,24)),a=I("sun:mat",()=>new k({color:16763904,emissive:16755200,emissiveIntensity:.5})),o=D(n,a);i.add(o),i.add(new We(16763904,2,200)),s=o;break}case 11:{const n=Q("earth",oi),a=O("earth:sphere",()=>new H(15,32,32)),o=I("earth:mat",()=>new k({map:n})),h=Q("earth:cloud",ri),c=O("earth:cloudSphere",()=>new H(15.5,32,32)),m=I("earth:cloudMat",()=>new k({map:h,transparent:!0,opacity:.3})),f=new dt;f.add(D(a,o)),f.add(D(c,m)),i.add(f),s=f;break}default:{const n=O("default:sphere",()=>new H(15,24,24)),a=t.planetColor,o=I(`default:mat:${a}`,()=>new k({color:a})),h=D(n,o);i.add(h),s=h;break}}return i.position.set(0,0,e),{planet:i,spinTarget:s}}function ee(l,t,e){return te(l,t,e)}function ie(l){Jt();const t=new Pt(at,ot);return t.userData.sharedAssets=!0,t.geometry.setDrawRange(0,l),t}function Dt(l){!Number.isInteger(l)||l<1||l>L||typeof document>"u"&&typeof OffscreenCanvas!="function"||(Jt(),te(l,U(l),0))}let J=null,tt=null;function ci(){if(!J){const l=new Bt,t=new Float32Array(3e3);for(let e=0;e<3e3;e++)t[e]=(Math.random()-.5)*200;l.setAttribute("position",new Rt(t,3)),J=l}return J}function di(){return tt||(tt=new kt({color:16777215,size:.3,sizeAttenuation:!0})),tt}function ui(){J=null,tt=null}const mi={getBgStarsGeometry:()=>J,getBgStarsMaterial:()=>tt};function pi(l){const t=window.requestIdleCallback;if(typeof t=="function"){t(l,{timeout:1500});return}window.setTimeout(l,800)}function se(l){return new Set(l.filter(t=>Number.isInteger(t)&&t>=1&&t<=L)).size}function gi(l){return se(l)>=L}function St(l){const t=gi(l.unlockedPlanets),e=t?1:Math.min(l.clearedStage+1,L),i=U(e),s=l.bestStageStars?.[e]??0,n=l.colorAccessibility?.colorVisionSupportMode??$,a=Wt(e,i.destinationReading,n);return t?{startStage:e,destination:a,emoji:i.emoji,statusLabel:"ぜんぶ あつめたよ！",destinationLabel:`${a}へ もういちど しゅっぱつ！`,buttonHint:`${i.emoji} ステージ ${e} から もういちど あそぶ`,bestStars:s}:{startStage:e,destination:a,emoji:i.emoji,statusLabel:l.clearedStage>0?"つづきから しゅっぱつ！":"はじめての しゅっぱつ！",destinationLabel:`${a}へ むかおう！`,buttonHint:`${i.emoji} ステージ ${e} から スタート`,bestStars:s}}function fi(l){return l.clearedStage>0||se(l.unlockedPlanets)>0||Object.keys(l.bestStageStars??{}).length>0}class yi{threeScene;ambientLight=new ft(16777215,1);camera;lastAspect=0;sceneManager;saveManager;audioManager;stars=null;companionParade=null;overlay=null;muteHandle=null;tutorialOverlay=new Ot;titleResetConfirmOverlay=new Xe;colorAccessibilitySettings=new Qe;spaceshipCustomizer=new Ke;statsOverlay=new ei;encyclopediaOverlay=null;encyclopediaOverlayPromise=null;companionFactory=null;companionFactoryPromise=null;loadEncyclopediaOverlay;loadTitleCompanionFactory;loadingOverlay;loadFailureOverlay;scheduleIdleTask;encyclopediaBtn=null;isOpeningEncyclopedia=!1;isActive=!1;encyclopediaRequestToken=0;companionParadeRequestToken=0;bgmPending=!1;overlayButtonCleanups=new Set;constructor(t,e,i,s={}){this.sceneManager=t,this.saveManager=e,this.audioManager=i,this.loadingOverlay=s.loadingOverlay??new oe,this.loadFailureOverlay=s.loadFailureOverlay??new re,this.scheduleIdleTask=s.scheduleIdleTask??pi,this.loadEncyclopediaOverlay=s.loadEncyclopediaOverlay??(()=>wt(()=>import("./EncyclopediaOverlay-LkyaIn0D.js"),__vite__mapDeps([0,1,2]))),this.loadTitleCompanionFactory=s.loadTitleCompanionFactory??(()=>wt(()=>import("./game-core-LV5LGXDP.js").then(o=>o.ai),__vite__mapDeps([1,2]))),this.threeScene=new st,this.threeScene.background=new nt(32);const{width:n,height:a}=z();this.camera=new yt(60,n/a,.1,1e3),this.camera.position.set(0,0,5)}enter(t){this.isActive=!0,this.encyclopediaRequestToken+=1,this.companionParadeRequestToken+=1,this.lastAspect=0,this.stars=new Pt(ci(),di()),this.stars.userData.sharedAssets=!0,this.stars.rotation.set(0,0,0),this.threeScene.add(this.stars),this.ambientLight.parent||this.threeScene.add(this.ambientLight);const e=this.saveManager.load();this.createCompanionParade(e.unlockedPlanets),this.createOverlay(),this.createMuteButton(),this.prefetchEncyclopediaOnIdle(),this.prewarmNextAdventureOnIdle(St(e).startStage),this.audioManager.isInitialized()?(this.audioManager.playBGM(0),this.bgmPending=!1):this.bgmPending=!0,e.tutorialShown||this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide(),this.saveManager.markTutorialShown()})}createMuteButton(){const t=document.getElementById("hud")??document.getElementById("ui-overlay");t&&(this.muteHandle=It({initialMuted:this.audioManager.isMuted(),container:t,onToggle:()=>{this.ensureTitleAudioInitialized(!0);const e=this.audioManager.toggleMute();this.muteHandle?.setMuted(e);const i=this.saveManager.load();i.muted=e,this.saveManager.save(i)}}))}getEncyclopediaOverlay(){return this.encyclopediaOverlay?Promise.resolve(this.encyclopediaOverlay):this.encyclopediaOverlayPromise?this.encyclopediaOverlayPromise:(this.encyclopediaOverlayPromise=this.loadEncyclopediaOverlay().then(({EncyclopediaOverlay:t})=>{const e=new t;return this.encyclopediaOverlay=e,e}).finally(()=>{this.encyclopediaOverlayPromise=null}),this.encyclopediaOverlayPromise)}getTitleCompanionFactory(){return this.companionFactory?Promise.resolve(this.companionFactory):this.companionFactoryPromise?this.companionFactoryPromise:(this.companionFactoryPromise=this.loadTitleCompanionFactory().then(t=>(this.companionFactory=t,t)).finally(()=>{this.companionFactoryPromise=null}),this.companionFactoryPromise)}showEncyclopedia(){if(!this.isActive||!this.encyclopediaOverlay)return;const t=this.saveManager.load();this.encyclopediaOverlay.show(t.unlockedPlanets,()=>this.refreshEncyclopediaButtonLabel(),e=>{this.ensureTitleAudioInitialized(!1),this.sceneManager.requestTransition("stage",{stageNumber:e,totalScore:0,totalStarCount:0,launchSource:"encyclopedia"})},t.bestStageStars??{},t.discoveredConstellations??[],t.colorAccessibility?.colorVisionSupportMode??$,t.discoveredMonthlyEncounters??[])}isCurrentEncyclopediaRequest(t){return this.isActive&&this.encyclopediaRequestToken===t}prefetchEncyclopediaOnIdle(){const t=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{!this.isCurrentEncyclopediaRequest(t)||this.encyclopediaOverlay||this.encyclopediaOverlayPromise||this.getEncyclopediaOverlay().catch(()=>{})})}prewarmNextAdventureOnIdle(t){if(t>L)return;const e=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{this.isCurrentEncyclopediaRequest(e)&&Dt(t)})}async openEncyclopedia(){if(!this.isActive)return;if(this.loadFailureOverlay.hide(),this.encyclopediaOverlay){this.showEncyclopedia();return}if(this.isOpeningEncyclopedia)return;const t=this.encyclopediaRequestToken;this.isOpeningEncyclopedia=!0,this.loadingOverlay.show("ずかんを よんでるよ...");try{if(await this.getEncyclopediaOverlay(),!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),this.showEncyclopedia()}catch(e){if(!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),console.error("Failed to load encyclopedia overlay",e),this.loadFailureOverlay.show({title:"ずかんを もういちど よんでみよう！",message:"「もういちど よむ」を おして つづきを たのしもう！",primaryAction:{label:"もういちど よむ",onSelect:()=>this.openEncyclopedia()}})}finally{this.encyclopediaRequestToken===t&&(this.isOpeningEncyclopedia=!1)}}persistHighContrastSetting(t){const e=this.saveManager.load(),i=e.colorAccessibility?.motionSensitivity??q(),s=e.colorAccessibility?.colorVisionSupportMode??$;e.colorAccessibility=this.buildColorAccessibilitySettings(t,i,s),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}persistVibrationIntensitySetting(t){const e=this.saveManager.load();e.vibrationSettings={intensity:t},this.saveManager.save(e),Ut(t)}persistRestReminderSetting(t){const e=this.saveManager.load();e.restReminderSettings={enabled:t},this.saveManager.save(e)}persistBGMVolumeSetting(t){const e=this.saveManager.load();e.audioSettings=this.buildAudioSettings(t,e.audioSettings?.sfxVolume??100),e.audioSettings||delete e.audioSettings,this.saveManager.save(e),this.audioManager.setBGMVolume(t)}persistSFXVolumeSetting(t){const e=this.saveManager.load();e.audioSettings=this.buildAudioSettings(e.audioSettings?.bgmVolume??100,t),e.audioSettings||delete e.audioSettings,this.saveManager.save(e),this.audioManager.setSFXVolume(t)}persistMotionSensitivitySetting(t){const e=this.saveManager.load(),i=e.colorAccessibility?.highContrast===!0,s=e.colorAccessibility?.colorVisionSupportMode??$;e.colorAccessibility=this.buildColorAccessibilitySettings(i,t,s),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}persistColorVisionSupportModeSetting(t){const e=this.saveManager.load(),i=e.colorAccessibility?.highContrast===!0,s=e.colorAccessibility?.motionSensitivity??q();e.colorAccessibility=this.buildColorAccessibilitySettings(i,s,t),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}buildColorAccessibilitySettings(t,e,i){const s=q();if(!(!t&&e===s&&i===$))return{...t?{highContrast:!0}:{},...e!==s?{motionSensitivity:e}:{},...i!==$?{colorVisionSupportMode:i}:{}}}buildAudioSettings(t,e){if(!(t===100&&e===100))return{...t!==100?{bgmVolume:t}:{},...e!==100?{sfxVolume:e}:{}}}createOverlay(){const t=document.getElementById("ui-overlay");if(!t)return;const e=this.saveManager.load(),i=St(e),s=fi(e);this.overlay=document.createElement("div"),this.overlay.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      justify-content: center;
    ...
    `;const c=document.createElement("div");c.textContent=i.statusLabel,c.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
    ...
    `;const f=document.createElement("div");f.textContent=i.destinationLabel,f.style.cssText=`
      ...
      font-weight: 700;
      color: rgba(255, 255, 255, 0.92);
    `;const b=jt(i.startStage,i.bestStars),g=At(i.startStage,i.bestStars,{label:"メダル",hint:b.nextThreshold===null?"かんぺき！":`${b.icon} いま ・ つぎ ⭐ ${b.nextThreshold}`,size:"regular",scope:"title-next-adventure"});g.style.marginTop=n?"0.35rem":"0.55rem",o.appendChild(h),o.appendChild(c),o.appendChild(m),o.appendChild(f),o.appendChild(g);const r=document.createElement("div");r.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
    ...
    `,this.overlayButtonCleanups.add(M(E,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.colorAccessibilitySettings.show({initialHighContrast:this.saveManager.load().colorAccessibility?.highContrast===!0,initialColorVisionSupportMode:this.saveManager.load().colorAccessibility?.colorVisionSupportMode??$,initialBGMVolume:this.saveManager.load().audioSettings?.bgmVolume??100,initialSFXVolume:this.saveManager.load().audioSettings?.sfxVolume??100,initialVibrationIntensity:this.saveManager.load().vibrationSettings?.intensity??"medium",initialMotionSensitivity:this.saveManager.load().colorAccessibility?.motionSensitivity??q(),initialRestReminderEnabled:this.saveManager.load().restReminderSettings?.enabled??le,onToggle:d=>this.persistHighContrastSetting(d),onColorVisionSupportModeChange:d=>this.persistColorVisionSupportModeSetting(d),onBGMVolumeChange:d=>this.persistBGMVolumeSetting(d),onSFXVolumeChange:d=>this.persistSFXVolumeSetting(d),onVibrationIntensityChange:d=>this.persistVibrationIntensitySetting(d),onMotionSensitivityChange:d=>this.persistMotionSensitivitySetting(d),onRestReminderToggle:d=>this.persistRestReminderSetting(d)})},onPressChange:d=>{E.style.transform=d?"scale(0.96)":"scale(1)"}}));const S=document.createElement("button");if(S.textContent=Nt(e.unlockedPlanets.length,K.length),S.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.encyclopediaBtn=S,this.overlayButtonCleanups.add(M(S,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.openEncyclopedia()},onPressChange:d=>{S.style.transform=d?"scale(0.96)":"scale(1)"}})),r.appendChild(u),r.appendChild(y),r.appendChild(x),p.appendChild(A),p.appendChild(w),s){const d=document.createElement("button");d.setAttribute("data-reset-progress-button",""),d.textContent="さいしょから",d.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: ${n?"0.9rem":"1.05rem"};
        font-weight: 900;
        padding: ${n?"0.55rem 0.65rem":"0.7rem 0.85rem"};
    ...
    `;const s=document.createElement("div");s.setAttribute("data-pause-card",""),s.style.cssText=`
      ...
      text-align: center;
      font-family: 'Zen Maru Gothic', sans-serif;
    `,s.addEventListener("pointerdown",c=>{c.stopPropagation()}),this.overlayEl.appendChild(s);const n=document.createElement("div");n.textContent="ひとやすみ ちゅう",n.style.cssText=`
    ...
    `,s.appendChild(a);const o=document.createElement("div");o.style.cssText=`
      ...
      align-items: stretch;
      width: 100%;
    `,s.appendChild(o);const h=(c,m,f,b,g,r)=>{const u=document.createElement("button");u.setAttribute(m,""),u.setAttribute("aria-label",f),u.textContent=c,u.style.cssText=`
        flex: 1 1 140px;
        padding: 1rem 1.2rem;
        border: none;
        border-radius: 1.6rem;
    ...
    `,document.head.appendChild(t)}}const Si=1,xi=.4;class _t{overlayEl=null;numberEl=null;phase="idle";elapsed=0;currentStep=0;stepDuration;goDuration;onTick;onGo;onComplete=null;steps=["3","2","1"];constructor(t={}){this.stepDuration=t.stepDuration??Si,this.goDuration=t.goDuration??xi,this.onTick=t.onTick,this.onGo=t.onGo}show(t){if(this.phase!=="idle"&&this.phase!=="done")return;const e=document.getElementById("ui-overlay")??document.body;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-countdown-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
    ...
    `,document.head.appendChild(t)}getActiveSide(t){return t==="active-left"?"left":t==="active-right"?"right":t==="assist-left"?"left":t==="assist-right"?"right":t==="hidden"?"none":"both"}getGuideEmphasis(t,e){return e==="active-left"?t==="left"?"primary":"secondary":e==="active-right"?t==="right"?"primary":"secondary":e==="assist-left"?t==="left"?"primary":"secondary":e==="assist-right"?t==="right"?"primary":"secondary":e==="hidden"?"hidden":"balanced"}updateInstruction(t){if(!this.instructionEl)return;const e=this.getInstructionMessage(t);this.instructionEl.textContent=e,this.instructionEl.setAttribute("data-touch-guide-message",e)}getInstructionMessage(t){return t==="intro"?"ひだりか みぎを さわると うごけるよ":t==="idle"?"ひつような ときは ひだりか みぎを さわって うごこう":t==="assist-left"?"ひだりへ よけよう":t==="assist-right"?"みぎへ よけよう":""}}class gt{static DEFAULT_DURATION=4.2;static CELEBRATION_DURATION=3.6;element=null;timer=0;message=null;highContrast=!1;showHint(t){this.showMessage(t,gt.DEFAULT_DURATION)}showCelebration(t){this.showMessage(t,gt.CELEBRATION_DURATION)}tick(t){this.timer<=0||(this.timer=Math.max(0,this.timer-t),this.timer===0&&this.hide())}hide(){this.timer=0,this.message=null,this.element&&(this.element.style.display="none",this.element.textContent="",this.element.removeAttribute("data-constellation-message"))}setHighContrastMode(t){this.highContrast=t,this.element&&this.applyElementStyle(this.element)}getMessage(){return this.message}showMessage(t,e){const i=this.ensureElement();this.timer=e,this.message=t,i.textContent=t,i.setAttribute("data-constellation-message",t),i.style.display="flex"}ensureElement(){if(this.element)return this.element;const t=document.getElementById("ui-overlay"),e=document.createElement("div");return e.setAttribute("data-constellation-hint",""),e.setAttribute("aria-live","polite"),this.applyElementStyle(e),e.style.display="none",t?.appendChild(e),this.element=e,e}applyElementStyle(t){t.style.cssText=`
      ...
      z-index: 35;
      box-shadow: 0 10px 24px rgba(0, 0, 0, 0.24);
    `}}const Ti=4;class Mi{overlayEl=null;cardEl=null;titleEl=null;messageEl=null;elapsed=0;visible=!1;highContrastMode=!1;totalDuration;constructor(t={}){this.totalDuration=t.totalDuration??Ti}show(t){const e=document.getElementById("ui-overlay")??document.body;Zt();const i=z().height<=500;(!this.overlayEl||!this.cardEl||!this.titleEl||!this.messageEl)&&(this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-seasonal-event-notice",""),this.overlayEl.style.cssText=`
        position: absolute;
    ...
    `,this.overlayButtonCleanups.add(M(n,{onActivate:()=>{this.inputSystem.resetPointers?.(),this.sceneManager.requestTransition("title")},onPressChange:o=>{n.style.transform=o?"scale(0.96)":"scale(1)"}})),e.append(i,n);const a=document.createElement("div");a.style.cssText=`
      align-self: center;
    ...
    `,a.textContent="← → で ゆったり うちゅうさんぽ",this.overlay.append(e,a),t.appendChild(this.overlay),this.updateStageLabel(),this.updateCompanionBadge()}updateCamera(){if(!this.ship)return;const t=this.ship.mesh.position;this.camera.position.x+=(t.x*.32-this.camera.position.x)*.12,this.camera.position.y=2.8,this.camera.position.z=t.z+12,this.currentLookAt.set(t.x*.18,t.y+.4,t.z-18),this.camera.lookAt(this.currentLookAt)}updatePlanet(t){!this.currentPlanet||!this.ship||(this.currentPlanet.position.set(0,.5,this.ship.mesh.position.z-52),this.currentPlanet.rotation.y+=t*.08,this.currentPlanetSpinTarget?.rotateY(t*.22))}updateStageRotation(t){this.stageTimeRemaining-=t,!(this.stageTimeRemaining>0)&&this.applyStage(this.pickRandomStage(this.currentStageNumber))}applyStage(t){this.currentStageNumber=t,this.currentStageConfig=U(t),this.stageTimeRemaining=this.sampleStageDuration(),this.clearPlanet();const{planet:e,spinTarget:i}=ee(t,this.currentStageConfig,-52);e.name="free-play-stage-planet",this.currentPlanet=e,this.currentPlanetSpinTarget=i,this.threeScene.add(e),this.stageAtmosphereEffect.start(Xt(t)),this.effectSystem.setCurrentStage(t),this.updateStageLabel()}clearPlanet(){this.currentPlanet&&(this.currentPlanet.parent?.remove(this.currentPlanet),this.currentPlanet=null,this.currentPlanetSpinTarget=null)}updateStageLabel(){this.stageLabel&&(this.stageLabel.textContent=`${this.currentStageConfig.emoji} ${this.currentStageConfig.destinationReading}の そらで あそんでるよ`)}updateCompanionBadge(){if(!this.companionBadge)return;const t=this.companionManager?.getCount()??0;this.companionBadge.textContent=t>0?`👾 なかま ${t}にん と いっしょ！`:"👾 なかまを あつめると ここに くるよ！"}sampleStageDuration(){return this.stageDurationSeconds*(.8+this.randomProvider()*.4)}pickRandomStage(t){const e=Array.from({length:L},(n,a)=>a+1),i=t===void 0?e:e.filter(n=>n!==t),s=Math.min(i.length-1,Math.floor(this.randomProvider()*i.length));return i[s]}}const _i=Object.freeze(Object.defineProperty({__proto__:null,FreePlayScene:Ii},Symbol.toStringTag,{value:"Module"}));let et=null,it=null;function Di(){if(!et){const l=new Bt,t=new Float32Array(3e3);for(let e=0;e<3e3;e++)t[e]=(Math.random()-.5)*200;l.setAttribute("position",new Rt(t,3)),et=l}return et}function Gi(){return it||(it=new kt({color:16777215,size:.3})),it}function Li(){et=null,it=null}const zi={getBgStarsGeometry:()=>et,getBgStarsMaterial:()=>it};class G{static CIRCLE_RADIUS=3;static POPIN_DELAY=.2;static POPIN_DURATION=.3;static BOUNCE_SPEED=3;static BOUNCE_HEIGHT=.5;static THANK_YOU_DELAY=2.5;threeScene;camera;lastAspect=0;sceneManager;saveManager;audioManager;overlay=null;muteHandle=null;bgStars=null;companionMeshes=[];companionGroup=null;circleX=[];circleZ=[];popinSettled=[];celebrationElapsed=0;thankYouShown=!1;canExit=!1;exitTriggered=!1;exitCta=null;constructor(t,e,i){this.sceneManager=t,this.saveManager=e,this.audioManager=i,this.threeScene=new st;const{width:s,height:n}=z();this.camera=new yt(60,s/n,.1,1e3),this.camera.position.set(0,0,5)}enter(t){this.lastAspect=0,this.canExit=!1,this.exitTriggered=!1,this.exitCta=null;const e=t.totalScore??0,i=t.totalStarCount??0;this.threeScene=new st,this.threeScene.background=new nt(48),this.bgStars=new Pt(Di(),Gi()),this.bgStars.userData.sharedAssets=!0,this.bgStars.rotation.set(0,0,0),this.threeScene.add(this.bgStars),this.threeScene.add(new ft(16777215,1));const s=this.saveManager.load();s.clearedStage=0,this.saveManager.save(s),this.audioManager.playBGM(-1),this.setupCelebration(),this.createOverlay(e,i),this.createMuteButton()}createMuteButton(){const t=document.getElementById("hud")??document.getElementById("ui-overlay");t&&(this.muteHandle=It({initialMuted:this.audioManager.isMuted(),container:t,onToggle:()=>{const e=this.audioManager.toggleMute();this.muteHandle?.setMuted(e);const i=this.saveManager.load();i.muted=e,this.saveManager.save(i)}}))}createOverlay(t,e){const i=document.getElementById("ui-overlay");if(!i)return;this.overlay=document.createElement("div"),this.overlay.setAttribute("data-ending-overlay",""),this.overlay.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      justify-content: center;
