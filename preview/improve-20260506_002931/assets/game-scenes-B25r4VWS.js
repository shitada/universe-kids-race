const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-DM1L5kFW.js","assets/game-core-CyE5GdjP.js","assets/three-BsQe5WE2.js"])))=>i.map(i=>d[i]);
import{D as ht,i as C,g as Et,a as Pt,S as q,T as G,b as Z,c as Qt,L as de,d as me,_ as Mt,e as H,f as $,h as X,s as Kt,j as ct,k as Jt,l as pe,P as J,u as te,C as ge,m as fe,n as ye,B as be,o as ve,M as Se,p as Ee,q as xe,r as Ce,t as we,v as Te,w as Ae,x as Me,y as Be,z as Pe,A as Re,E as Oe,F as ke,G as Ie,H as De,I as ee,W as Le,J as ze,K as Ge,N as He,O as ie,Q as Ne,R as Rt,U as _e,V as Fe,X as $e,Y as Ve,Z as Ue,$ as je,a0 as We,a1 as Nt,a2 as se,a3 as Ze,a4 as ut,a5 as Y,a6 as qe,a7 as xt,a8 as Ye,a9 as Ct,aa as Xe,ab as Qe,ac as Ke,ad as Je,ae as ti}from"./game-core-CyE5GdjP.js";import{n as Ot,l as kt,j as It,m as Dt,G as dt,r as ei,a as ii,s as si,M as k,h as N,D as _t,R as Ft,t as _,u as bt,v as nt,i as at,P as vt,V as j,w as ne,x as ni}from"./three-BsQe5WE2.js";class Lt{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const e=document.getElementById("ui-overlay");if(!e)return;const i=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
    ...
    `,a.appendChild(o),a.appendChild(h),a.appendChild(u),a}isCompactHeight(){return window.innerHeight<=Lt.COMPACT_HEIGHT_THRESHOLD}injectAnimations(){if(document.getElementById("tutorial-animations"))return;const t=document.createElement("style");t.id="tutorial-animations",t.textContent=`
      @keyframes swipe {
    ...
    `,b=(d,w)=>{let y=!1,p=!1;const A=()=>{M(!0)},T=()=>{d.style.transform="scale(0.92)"},R=()=>{d.style.transform="scale(1)"},M=(c=!1)=>{y=!1,p=c,R(),this.activePressCleanups.delete(A),document.removeEventListener("pointerup",S,!0),document.removeEventListener("pointercancel",x,!0)},S=c=>{const E=c.target===d||c.target instanceof Node&&d.contains(c.target),P=y&&E;M(!E),P&&w()},x=()=>{M(!0)};d.addEventListener("pointerdown",c=>{c.stopPropagation(),y=!0,p=!1,T(),this.activePressCleanups.add(A),document.addEventListener("pointerup",S,!0),document.addEventListener("pointercancel",x,!0)}),d.addEventListener("pointerenter",()=>{y&&T()}),d.addEventListener("pointerleave",()=>{y&&R()}),d.addEventListener("pointercancel",()=>M(!0)),d.addEventListener("click",c=>{if(c.stopPropagation(),p){p=!1;return}y||w()})},g=document.createElement("button");g.setAttribute("data-title-reset-cancel",""),g.textContent="やめる",g.style.cssText=f,g.style.background="rgba(255, 255, 255, 0.18)",g.style.color="#ffffff",b(g,n),m.appendChild(g);const r=document.createElement("button");r.setAttribute("data-title-reset-confirm",""),r.textContent="うん！ さいしょから",r.style.cssText=f,r.style.background="linear-gradient(135deg, #FF9F68, #FFE66D)",r.style.color="#3b1f00",b(r,a),m.appendChild(r),i.appendChild(this.overlayEl)}hide(){if(!this.overlayEl)return;const t=Array.from(this.activePressCleanups);this.activePressCleanups.clear();for(const e of t)e();this.overlayEl.remove(),this.overlayEl=null}}function zt(l){const t=l.topRem??.8,e=window.innerHeight<=500,i=document.createElement("button");let s=l.initialMuted;const n=()=>{i.textContent=s?"🔇":"🔊",i.setAttribute("aria-label",s?"サウンド オフ":"サウンド オン")};i.setAttribute("data-mute-button",""),i.style.position="absolute",i.style.top=`${t}rem`,i.style.right="1rem",i.style.fontSize=e?"clamp(1.1rem, 3.5vmin, 1.4rem)":"clamp(1.4rem, 4vmin, 1.8rem)",i.style.background="rgba(255, 255, 255, 0.15)",i.style.border="none",i.style.borderRadius="50%",i.style.width=e?"2.4rem":"3rem",i.style.height=e?"2.4rem":"3rem",i.style.display="flex",i.style.alignItems="center",i.style.justifyContent="center",i.style.cursor="pointer",i.style.pointerEvents="auto",i.style.touchAction="manipulation",i.style.transform="scale(1)",i.style.transition="transform 0.08s ease-out",n();const a=()=>{i.style.transform="scale(1)"};return i.addEventListener("pointerdown",o=>{o.stopPropagation(),i.style.transform="scale(0.9)",l.onToggle()}),i.addEventListener("pointerup",a),i.addEventListener("pointercancel",a),i.addEventListener("pointerleave",a),l.container.appendChild(i),{element:i,setMuted(o){s=o,n()},remove(){i.remove()}}}const mt=[{value:0,labelKey:"colorSettings.audio.volume.quiet"},{value:25,labelKey:"colorSettings.audio.volume.small"},{value:50,labelKey:"colorSettings.audio.volume.normal"},{value:75,labelKey:"colorSettings.audio.volume.loud"},{value:100,labelKey:"colorSettings.audio.volume.max"}],$t=[{value:"color-only",labelKey:"colorSettings.colorVision.option.colorOnly",icon:"🎨"},{value:"color-and-marks",labelKey:"colorSettings.colorVision.option.colorAndMarks",icon:"★"}],Vt=[{value:"strong",labelKey:"colorSettings.vibration.option.strong"},{value:"medium",labelKey:"colorSettings.vibration.option.medium"},{value:"weak",labelKey:"colorSettings.vibration.option.weak"},{value:"off",labelKey:"colorSettings.vibration.option.off"}],Ut=[{value:"ja",labelKey:"colorSettings.language.option.ja",icon:"🇯🇵"},{value:"en",labelKey:"colorSettings.language.option.en",icon:"🇬🇧"}],jt={strong:{shortLabel:"colorSettings.motion.option.strong.shortLabel",description:"colorSettings.motion.option.strong.description"},medium:{shortLabel:"colorSettings.motion.option.medium.shortLabel",description:"colorSettings.motion.option.medium.description"},gentle:{shortLabel:"colorSettings.motion.option.gentle.shortLabel",description:"colorSettings.motion.option.gentle.description"},minimal:{shortLabel:"colorSettings.motion.option.minimal.shortLabel",description:"colorSettings.motion.option.minimal.description"}};function Wt(l){const t=mt.find(e=>e.value===l)??mt[2];return C.t(t.labelKey)}class oi{overlay=null;toggleButton=null;descriptionEl=null;highContrast=!1;colorVisionSupportMode="color-only";bgmVolume=100;sfxVolume=100;vibrationIntensity="medium";motionSensitivity="strong";restReminderEnabled=!0;language=ht;bgmVolumeDescriptionEl=null;sfxVolumeDescriptionEl=null;bgmVolumeSlider=null;sfxVolumeSlider=null;colorVisionDescriptionEl=null;colorVisionButtons=new Map;vibrationDescriptionEl=null;vibrationButtons=new Map;motionDescriptionEl=null;motionButtons=new Map;restReminderDescriptionEl=null;restReminderToggleButton=null;motionPreviewEl=null;motionPreviewTokenEl=null;motionPreviewCaptionEl=null;languageDescriptionEl=null;languageButtons=new Map;motionPreviewTimeoutId=null;motionPreviewFrameId=null;onToggle=null;onColorVisionSupportModeChange=null;onBGMVolumeChange=null;onSFXVolumeChange=null;onVibrationIntensityChange=null;onMotionSensitivityChange=null;onRestReminderToggle=null;onLanguageChange=null;languageUnsubscribe=null;show(t){const e=document.getElementById("ui-overlay");if(e){if(this.highContrast=t.initialHighContrast,this.colorVisionSupportMode=t.initialColorVisionSupportMode,this.bgmVolume=t.initialBGMVolume,this.sfxVolume=t.initialSFXVolume,this.vibrationIntensity=t.initialVibrationIntensity,this.motionSensitivity=t.initialMotionSensitivity,this.restReminderEnabled=t.initialRestReminderEnabled,this.language=t.initialLanguage,this.onToggle=t.onToggle,this.onColorVisionSupportModeChange=t.onColorVisionSupportModeChange,this.onBGMVolumeChange=t.onBGMVolumeChange,this.onSFXVolumeChange=t.onSFXVolumeChange,this.onVibrationIntensityChange=t.onVibrationIntensityChange,this.onMotionSensitivityChange=t.onMotionSensitivityChange,this.onRestReminderToggle=t.onRestReminderToggle,this.onLanguageChange=t.onLanguageChange,C.setLanguage(this.language,{notify:!1}),this.languageUnsubscribe?.(),this.languageUnsubscribe=C.subscribe(i=>{this.language=i,this.render()}),!this.overlay){const i=window.innerHeight<=760;this.overlay=document.createElement("div"),this.overlay.setAttribute("data-color-accessibility-settings",""),this.overlay.style.cssText=`
      ...
      `;for(const c of Ut){const E=document.createElement("button");E.setAttribute("data-language-button",c.value),E.style.cssText=`
          min-height: 3.25rem;
      ...
      `;for(const c of $t){const E=document.createElement("button");E.setAttribute("data-color-vision-mode-button",c.value),E.style.cssText=`
          ...
          touch-action: manipulation;
          transition: transform 0.08s ease-out, border-color 0.12s ease-out, background 0.12s ease-out;
        `,E.addEventListener("click",()=>{this.colorVisionSupportMode=c.value,this.render(),this.onColorVisionSupportModeChange?.(c.value)}),this.colorVisionButtons.set(c.value,E),d.appendChild(E)}const w=document.createElement("h3");w.setAttribute("data-vibration-title",""),w.style.cssText="margin: 0.9rem 0 0.45rem; font-size: clamp(1rem, 3.8vmin, 1.2rem);",this.vibrationDescriptionEl=document.createElement("p"),this.vibrationDescriptionEl.style.cssText="margin: 0 0 0.8rem; font-size: clamp(0.9rem, 3.2vmin, 1rem); line-height: 1.5;";const y=document.createElement("div");y.setAttribute("data-vibration-intensity-group",""),y.style.cssText=`
        display: grid;
        grid-template-columns: repeat(2, minmax(0, 1fr));
        gap: 0.65rem;
        margin-bottom: 0.95rem;
      `;for(const c of Vt){const E=document.createElement("button");E.setAttribute("data-vibration-intensity-button",c.value),E.style.cssText=`
        ...
        gap: 0.65rem;
        margin-bottom: 0.95rem;
      `;const R=["strong","medium","gentle","minimal"];for(const c of R){const E=Et(c),P=document.createElement("button");P.setAttribute("data-motion-sensitivity-button",c),P.style.cssText=`
          display: flex;
          flex-direction: column;
          align-items: center;
          justify-content: center;
          ...
          touch-action: manipulation;
          transition: transform 0.08s ease-out, border-color 0.12s ease-out, background 0.12s ease-out;
        `;const U=document.createElement("span");U.textContent=E.emoji,U.style.cssText="font-size: clamp(1.25rem, 4.8vmin, 1.7rem); line-height: 1;";const V=document.createElement("span");V.textContent=E.stars,V.style.cssText="font-size: clamp(0.82rem, 2.9vmin, 0.95rem); letter-spacing: 0.08em;";const F=document.createElement("span");F.setAttribute("data-motion-label",c),F.style.cssText="font-size: clamp(0.9rem, 3vmin, 1rem);",P.append(U,V,F),P.addEventListener("click",()=>{this.motionSensitivity=c,this.render(),this.playMotionPreview(),this.onMotionSensitivityChange?.(c)}),this.motionButtons.set(c,P),T.appendChild(P)}this.motionPreviewEl=document.createElement("div"),this.motionPreviewEl.setAttribute("data-motion-preview",""),this.motionPreviewEl.style.cssText=`
        position: relative;
        min-height: 5.8rem;
        margin: 0 0 1rem;
        padding: 0.8rem 0.9rem;
    ...
    `,i.style.overflowY="hidden",i.style.height="100%",i.style.maxHeight="720px",i.addEventListener("pointerdown",u=>u.stopPropagation()),this.overlay.appendChild(i);const s=document.createElement("h2");s.textContent="うちゅうせんを かざろう",s.style.cssText="margin: 0 0 0.3rem; font-size: clamp(1.25rem, 4.3vmin, 1.85rem); color: #ffe66d;";const n=document.createElement("p");n.textContent="おおきな ボタンで えらぶと、すぐに みためが かわるよ。",n.style.cssText="margin: 0 0 0.45rem; font-size: clamp(0.85rem, 2.8vmin, 1rem); line-height: 1.35;",i.appendChild(s),i.appendChild(n);const a=document.createElement("div");a.setAttribute("data-spaceship-customizer-content",""),a.style.cssText="display: grid; grid-template-columns: minmax(12rem, 15rem) minmax(0, 1fr); gap: 0.65rem; align-items: stretch; margin: 0.45rem 0 0.65rem;",a.appendChild(this.createPreviewCard());const o=document.createElement("div");o.setAttribute("data-spaceship-customizer-sections",""),o.style.cssText="display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 0.5rem; align-items: stretch;",o.appendChild(this.createPartSection("bodyColor","ほんたい")),o.appendChild(this.createPartSection("noseColor","ノーズ")),o.appendChild(this.createPartSection("wingColor","つばさ")),a.appendChild(o),i.appendChild(a);const h=document.createElement("button");h.textContent="かんりょう",h.setAttribute("data-spaceship-customizer-done",""),h.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.buttonCleanups.add(B(h,{onActivate:()=>{const u={...this.draft};this.hide(),t.onComplete(u)},onPressChange:u=>{h.style.transform=u?"scale(0.96)":"scale(1)"}})),i.appendChild(h),e.appendChild(this.overlay),this.render()}hide(){const t=Array.from(this.buttonCleanups);this.buttonCleanups.clear();for(const e of t)e();this.optionButtons.clear(),this.overlay?.remove(),this.overlay=null,this.previewBody=null,this.previewNose=null,this.previewWings=null}isVisible(){return this.overlay?.isConnected===!0}createPreviewCard(){const t=document.createElement("div");t.setAttribute("data-spaceship-customizer-preview-card",""),t.style.cssText=`
      width: 100%;
      margin: 0;
      height: 100%;
      padding: 0.6rem;
    ...
    `,m.appendChild(f);const b=document.createElement("div");b.setAttribute("data-stats-stage-clears",""),b.style.cssText=`
      ...
      gap: 0.45rem;
      text-align: left;
    `;const g=Array.from({length:G},(d,w)=>w+1).map(d=>({stageNumber:d,clearCount:s.stageClearCounts[d]??0})).filter(d=>d.clearCount>0);if(g.length===0){const d=document.createElement("div");d.textContent="まだ きろくが ないよ",d.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: ${n?"1rem":"1.1rem"};
        font-weight: 700;
        text-align: center;
        color: rgba(255, 255, 255, 0.88);
      `,b.appendChild(d)}else for(const{stageNumber:d,clearCount:w}of g){const y=Z(d),p=document.createElement("div");p.setAttribute("data-stats-stage-clear-row",String(d)),p.style.cssText=`
          display: flex;
          align-items: center;
          ...
          font-weight: 700;
        `;const A=document.createElement("span");A.textContent=`${y.emoji} ステージ ${d} ${y.destinationReading}`;const T=document.createElement("span");T.textContent=`${w}かい`,T.style.color="#FFE66D",p.append(A,T),b.appendChild(p)}m.appendChild(b),o.appendChild(m);const r=document.createElement("button");r.textContent="もどる",r.style.cssText=`
      margin-top: 1rem;
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.actionCleanups.add(B(r,{onActivate:()=>{this.hide(),e()},onPressChange:d=>{r.style.transform=d?"scale(0.96)":"scale(1)"}})),o.appendChild(r),a.appendChild(o),i.appendChild(a)}hide(){const t=Array.from(this.actionCleanups);this.actionCleanups.clear();for(const e of t)e();this.overlayEl?.remove(),this.overlayEl=null}createSummaryCard(t,e,i){const s=document.createElement("div");s.setAttribute(i,""),s.style.cssText=`
    ...
    `;const a=document.createElement("div");return a.textContent=e,a.style.cssText=`
      ...
      font-weight: 900;
      color: #FFE66D;
    `,s.append(n,a),s}}function Zt(l,t){if(!Number.isFinite(l)||l<=0||t<=0)return"ずかん";const e=Math.min(l,t);return e>=t?`ずかん ${t} / ${t} 🎉`:`ずかん ${e} / ${t}`}function ui(l){switch(l){case"hero":return{gap:"0.35rem",label:"0.92rem",medal:"1.7rem",hint:"0.98rem"};case"compact":return{gap:"0.18rem",label:"0.7rem",medal:"1rem",hint:"0.76rem"};default:return{gap:"0.26rem",label:"0.8rem",medal:"1.25rem",hint:"0.84rem"}}}function Bt(l,t,e={}){const i=Qt(l,t),s=e.size??"regular",n=ui(s),a=document.createElement("div");if(a.setAttribute("data-stage-medal-display",""),a.setAttribute("data-stage-medal-stage",String(l)),a.setAttribute("data-stage-medal-tier",i.tier),a.setAttribute("data-stage-medal-earned",String(i.earnedCount)),e.scope&&a.setAttribute("data-stage-medal-scope",e.scope),a.style.cssText=`
    display: flex;
    flex-direction: column;
    align-items: center;
    gap: ${n.gap};
  ...
  `;for(const m of i.slots){const f=document.createElement("span");f.setAttribute("data-stage-medal-slot",m.tier),f.setAttribute("data-stage-medal-threshold",String(m.threshold)),f.setAttribute("data-stage-medal-reached",String(m.reached)),f.textContent=m.icon,f.style.cssText=`
    ...
    `,o.appendChild(f)}a.appendChild(o);const h=e.hint??(i.nextThreshold===null?"かんぺき！":`つぎ ⭐ ${i.nextThreshold}`),u=document.createElement("div");return u.setAttribute("data-stage-medal-hint",""),u.textContent=h,u.style.cssText=`
    font-family: 'Zen Maru Gothic', sans-serif;
    font-size: ${n.hint};
    font-weight: 700;
    color: ${i.nextThreshold===null?"#FFE66D":"rgba(255, 255, 255, 0.86)"};
  `,a.appendChild(u),a}const qt=2e3,pt=new Map,gt=new Map,ft=new Map;let ot=null,rt=null;function lt(l,t){if(typeof document>"u"){const i=typeof OffscreenCanvas=="function",s=i?new OffscreenCanvas(l,t):{width:l,height:t};return{canvas:s,ctx:i?s.getContext("2d"):null}}const e=document.createElement("canvas");return e.width=l,e.height=t,{canvas:e,ctx:e.getContext("2d")}}function K(l,t){let e=pt.get(l);return e||(e=t(),e.generateMipmaps=!1,e.minFilter=si,e.needsUpdate=!0,pt.set(l,e)),e}function I(l,t){let e=gt.get(l);return e||(e=t(),gt.set(l,e)),e}function D(l,t){let e=ft.get(l);return e||(e=t(),ft.set(l,e)),e}function L(l,t){const e=new ii(l,t);return e.userData.sharedAssets=!0,e}function ae(){if(!ot){const l=new kt,t=new Float32Array(qt*3);for(let e=0;e<qt*3;e+=3)t[e]=(Math.random()-.5)*200,t[e+1]=(Math.random()-.5)*200,t[e+2]=(Math.random()-.5)*400;l.setAttribute("position",new It(t,3)),ot=l}rt||(rt=new Dt({color:16777215,size:.2,sizeAttenuation:!0}))}function di(){const{canvas:l,ctx:t}=lt(256,256);if(!t)return new _(l);t.fillStyle="#888888",t.fillRect(0,0,256,256);for(let e=0;e<30;e++){const i=Math.random()*256,s=Math.random()*256,n=3+Math.random()*12;t.beginPath(),t.arc(i,s,n,0,Math.PI*2),t.fillStyle=`rgba(60,60,60,${.3+Math.random()*.4})`,t.fill()}return new _(l)}function mi(){const{canvas:l,ctx:t}=lt(256,256);if(!t)return new _(l);t.fillStyle="#ddaa44",t.fillRect(0,0,256,256);for(let e=0;e<8;e++){t.beginPath();const i=128+(Math.random()-.5)*100,s=128+(Math.random()-.5)*100;t.strokeStyle=`rgba(200,150,60,${.3+Math.random()*.3})`,t.lineWidth=3+Math.random()*5;for(let n=0;n<Math.PI*4;n+=.1){const a=10+n*8;t.lineTo(i+Math.cos(n)*a,s+Math.sin(n)*a)}t.stroke()}return new _(l)}function pi(){const{canvas:l,ctx:t}=lt(256,256);if(!t)return new _(l);const e=["#cc7733","#dd9955","#bb6622","#eebb77","#aa5511","#ddaa66"];for(let i=0;i<256;i++){const s=Math.floor(i/(256/e.length))%e.length;t.fillStyle=e[s],t.fillRect(0,i,256,1)}return new _(l)}function gi(){const{canvas:l,ctx:t}=lt(512,256);return t?(t.fillStyle="#2266aa",t.fillRect(0,0,512,256),t.fillStyle="#886644",t.beginPath(),t.ellipse(300,80,80,40,.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(280,150,30,50,.1,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(100,90,25,60,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(110,170,20,40,-.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(420,170,25,15,0,0,Math.PI*2),t.fill(),t.fillStyle="#447733",t.beginPath(),t.ellipse(290,75,40,20,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(95,85,15,30,.2,0,Math.PI*2),t.fill(),new _(l)):new _(l)}function fi(){const{canvas:l,ctx:t}=lt(512,256);if(!t)return new _(l);t.clearRect(0,0,512,256),t.fillStyle="rgba(255,255,255,0.6)";for(let e=0;e<20;e++){const i=Math.random()*512,s=Math.random()*256;t.beginPath(),t.ellipse(i,s,20+Math.random()*40,8+Math.random()*15,Math.random()*Math.PI,0,Math.PI*2),t.fill()}return new _(l)}function yi(){pt.clear(),gt.clear(),ft.clear(),ot=null,rt=null}const bi={planetTextureCache:pt,planetGeometryCache:gt,planetMaterialCache:ft,getBgStarsGeometry:()=>ot,getBgStarsMaterial:()=>rt};function oe(l,t,e){const i=new dt;let s=null;switch(l){case 2:{const n=K("mercury",di),a=I("mercury:sphere",()=>new N(10,24,24)),o=D("mercury:mat",()=>new k({map:n})),h=L(a,o);i.add(h),s=h;break}case 3:{const n=K("venus",mi),a=I("venus:sphere",()=>new N(14,24,24)),o=D("venus:mat",()=>new k({map:n})),h=L(a,o);i.add(h),s=h;break}case 5:{const n=K("jupiter",pi),a=I("jupiter:sphere",()=>new N(20,24,24)),o=D("jupiter:mat",()=>new k({map:n})),h=L(a,o);i.add(h),s=h;break}case 6:{const n=I("saturn:sphere",()=>new N(15,24,24)),a=t.planetColor,o=D(`saturn:mat:${a}`,()=>new k({color:a})),h=L(n,o);i.add(h);const u=I("saturn:ring",()=>new Ft(20,30,48)),m=D("saturn:ringMat",()=>new k({color:15645542,side:_t})),f=L(u,m);f.rotation.x=Math.PI/3,i.add(f),s=h;break}case 7:{const n=I("uranus:sphere",()=>new N(16,24,24)),a=D("uranus:mat",()=>new k({color:6737117})),o=L(n,a);i.add(o);const h=I("uranus:ring",()=>new Ft(21,28,48)),u=D("uranus:ringMat",()=>new k({color:10083822,side:_t})),m=L(h,u);m.rotation.z=Math.PI/2,i.add(m),s=o;break}case 9:{const n=I("pluto:sphere",()=>new N(8,24,24)),a=D("pluto:mat",()=>new k({color:12298922})),o=L(n,a);i.add(o),s=o;break}case 10:{const n=I("sun:sphere",()=>new N(25,24,24)),a=D("sun:mat",()=>new k({color:16763904,emissive:16755200,emissiveIntensity:.5})),o=L(n,a);i.add(o),i.add(new ei(16763904,2,200)),s=o;break}case 11:{const n=K("earth",gi),a=I("earth:sphere",()=>new N(15,32,32)),o=D("earth:mat",()=>new k({map:n})),h=K("earth:cloud",fi),u=I("earth:cloudSphere",()=>new N(15.5,32,32)),m=D("earth:cloudMat",()=>new k({map:h,transparent:!0,opacity:.3})),f=new dt;f.add(L(a,o)),f.add(L(u,m)),i.add(f),s=f;break}default:{const n=I("default:sphere",()=>new N(15,24,24)),a=t.planetColor,o=D(`default:mat:${a}`,()=>new k({color:a})),h=L(n,o);i.add(h),s=h;break}}return i.position.set(0,0,e),{planet:i,spinTarget:s}}function re(l,t,e){return oe(l,t,e)}function le(l){ae();const t=new Ot(ot,rt);return t.userData.sharedAssets=!0,t.geometry.setDrawRange(0,l),t}function Gt(l){!Number.isInteger(l)||l<1||l>G||typeof document>"u"&&typeof OffscreenCanvas!="function"||(ae(),oe(l,Z(l),0))}let tt=null,et=null;function vi(){if(!tt){const l=new kt,t=new Float32Array(3e3);for(let e=0;e<3e3;e++)t[e]=(Math.random()-.5)*200;l.setAttribute("position",new It(t,3)),tt=l}return tt}function Si(){return et||(et=new Dt({color:16777215,size:.3,sizeAttenuation:!0})),et}function Ei(){tt=null,et=null}const xi={getBgStarsGeometry:()=>tt,getBgStarsMaterial:()=>et};function Ci(l){const t=window.requestIdleCallback;if(typeof t=="function"){t(l,{timeout:1500});return}window.setTimeout(l,800)}function he(l){return new Set(l.filter(t=>Number.isInteger(t)&&t>=1&&t<=G)).size}function wi(l){return he(l)>=G}function wt(l){const t=wi(l.unlockedPlanets),e=t?1:Math.min(l.clearedStage+1,G),i=Z(e),s=l.bestStageStars?.[e]??0,n=l.colorAccessibility?.colorVisionSupportMode??$,a=Jt(e,i.destinationReading,n);return t?{startStage:e,destination:a,emoji:i.emoji,statusLabel:"ぜんぶ あつめたよ！",destinationLabel:`${a}へ もういちど しゅっぱつ！`,buttonHint:`${i.emoji} ステージ ${e} から もういちど あそぶ`,bestStars:s}:{startStage:e,destination:a,emoji:i.emoji,statusLabel:l.clearedStage>0?"つづきから しゅっぱつ！":"はじめての しゅっぱつ！",destinationLabel:`${a}へ むかおう！`,buttonHint:`${i.emoji} ステージ ${e} から スタート`,bestStars:s}}function Ti(l){return l.clearedStage>0||he(l.unlockedPlanets)>0||Object.keys(l.bestStageStars??{}).length>0}class Ai{threeScene;ambientLight=new bt(16777215,1);camera;lastAspect=0;sceneManager;saveManager;audioManager;stars=null;companionParade=null;overlay=null;muteHandle=null;tutorialOverlay=new Lt;titleResetConfirmOverlay=new ai;colorAccessibilitySettings=new oi;spaceshipCustomizer=new ri;statsOverlay=new ci;encyclopediaOverlay=null;encyclopediaOverlayPromise=null;companionFactory=null;companionFactoryPromise=null;loadEncyclopediaOverlay;loadTitleCompanionFactory;loadingOverlay;loadFailureOverlay;scheduleIdleTask;encyclopediaBtn=null;isOpeningEncyclopedia=!1;isActive=!1;encyclopediaRequestToken=0;companionParadeRequestToken=0;bgmPending=!1;overlayButtonCleanups=new Set;colorSettingsButton=null;unsubscribeLanguageChange=null;constructor(t,e,i,s={}){this.sceneManager=t,this.saveManager=e,this.audioManager=i,this.loadingOverlay=s.loadingOverlay??new de,this.loadFailureOverlay=s.loadFailureOverlay??new me,this.scheduleIdleTask=s.scheduleIdleTask??Ci,this.loadEncyclopediaOverlay=s.loadEncyclopediaOverlay??(()=>Mt(()=>import("./EncyclopediaOverlay-DM1L5kFW.js"),__vite__mapDeps([0,1,2]))),this.loadTitleCompanionFactory=s.loadTitleCompanionFactory??(()=>Mt(()=>import("./game-core-CyE5GdjP.js").then(o=>o.an),__vite__mapDeps([1,2]))),this.threeScene=new nt,this.threeScene.background=new at(32);const{width:n,height:a}=H();this.camera=new vt(60,n/a,.1,1e3),this.camera.position.set(0,0,5)}enter(t){this.isActive=!0,this.encyclopediaRequestToken+=1,this.companionParadeRequestToken+=1,this.lastAspect=0,this.stars=new Ot(vi(),Si()),this.stars.userData.sharedAssets=!0,this.stars.rotation.set(0,0,0),this.threeScene.add(this.stars),this.ambientLight.parent||this.threeScene.add(this.ambientLight);const e=this.saveManager.load();C.setLanguage(e.language??ht,{notify:!1}),this.createCompanionParade(e.unlockedPlanets),this.createOverlay(),this.createMuteButton(),this.prefetchEncyclopediaOnIdle(),this.prewarmNextAdventureOnIdle(wt(e).startStage),this.audioManager.isInitialized()?(this.audioManager.playBGM(0),this.bgmPending=!1):this.bgmPending=!0,e.tutorialShown||this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide(),this.saveManager.markTutorialShown()})}createMuteButton(){const t=document.getElementById("hud")??document.getElementById("ui-overlay");t&&(this.muteHandle=zt({initialMuted:this.audioManager.isMuted(),container:t,onToggle:()=>{this.ensureTitleAudioInitialized(!0);const e=this.audioManager.toggleMute();this.muteHandle?.setMuted(e);const i=this.saveManager.load();i.muted=e,this.saveManager.save(i)}}))}getEncyclopediaOverlay(){return this.encyclopediaOverlay?Promise.resolve(this.encyclopediaOverlay):this.encyclopediaOverlayPromise?this.encyclopediaOverlayPromise:(this.encyclopediaOverlayPromise=this.loadEncyclopediaOverlay().then(({EncyclopediaOverlay:t})=>{const e=new t;return this.encyclopediaOverlay=e,e}).finally(()=>{this.encyclopediaOverlayPromise=null}),this.encyclopediaOverlayPromise)}getTitleCompanionFactory(){return this.companionFactory?Promise.resolve(this.companionFactory):this.companionFactoryPromise?this.companionFactoryPromise:(this.companionFactoryPromise=this.loadTitleCompanionFactory().then(t=>(this.companionFactory=t,t)).finally(()=>{this.companionFactoryPromise=null}),this.companionFactoryPromise)}showEncyclopedia(){if(!this.isActive||!this.encyclopediaOverlay)return;const t=this.saveManager.load();this.encyclopediaOverlay.show(t.unlockedPlanets,()=>this.refreshEncyclopediaButtonLabel(),e=>{this.ensureTitleAudioInitialized(!1),this.sceneManager.requestTransition("stage",{stageNumber:e,totalScore:0,totalStarCount:0,launchSource:"encyclopedia"})},t.bestStageStars??{},t.discoveredConstellations??[],t.colorAccessibility?.colorVisionSupportMode??$,t.discoveredMonthlyEncounters??[])}isCurrentEncyclopediaRequest(t){return this.isActive&&this.encyclopediaRequestToken===t}prefetchEncyclopediaOnIdle(){const t=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{!this.isCurrentEncyclopediaRequest(t)||this.encyclopediaOverlay||this.encyclopediaOverlayPromise||this.getEncyclopediaOverlay().catch(()=>{})})}prewarmNextAdventureOnIdle(t){if(t>G)return;const e=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{this.isCurrentEncyclopediaRequest(e)&&Gt(t)})}async openEncyclopedia(){if(!this.isActive)return;if(this.loadFailureOverlay.hide(),this.encyclopediaOverlay){this.showEncyclopedia();return}if(this.isOpeningEncyclopedia)return;const t=this.encyclopediaRequestToken;this.isOpeningEncyclopedia=!0,this.loadingOverlay.show("ずかんを よんでるよ...");try{if(await this.getEncyclopediaOverlay(),!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),this.showEncyclopedia()}catch(e){if(!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),console.error("Failed to load encyclopedia overlay",e),this.loadFailureOverlay.show({title:"ずかんを もういちど よんでみよう！",message:"「もういちど よむ」を おして つづきを たのしもう！",primaryAction:{label:"もういちど よむ",onSelect:()=>this.openEncyclopedia()}})}finally{this.encyclopediaRequestToken===t&&(this.isOpeningEncyclopedia=!1)}}persistHighContrastSetting(t){const e=this.saveManager.load(),i=e.colorAccessibility?.motionSensitivity??X(),s=e.colorAccessibility?.colorVisionSupportMode??$;e.colorAccessibility=this.buildColorAccessibilitySettings(t,i,s),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}persistVibrationIntensitySetting(t){const e=this.saveManager.load();e.vibrationSettings={intensity:t},this.saveManager.save(e),Kt(t)}persistRestReminderSetting(t){const e=this.saveManager.load();e.restReminderSettings={enabled:t},this.saveManager.save(e)}persistLanguageSetting(t){const e=this.saveManager.load();t===ht?delete e.language:e.language=t,this.saveManager.save(e)}persistBGMVolumeSetting(t){const e=this.saveManager.load();e.audioSettings=this.buildAudioSettings(t,e.audioSettings?.sfxVolume??100),e.audioSettings||delete e.audioSettings,this.saveManager.save(e),this.audioManager.setBGMVolume(t)}persistSFXVolumeSetting(t){const e=this.saveManager.load();e.audioSettings=this.buildAudioSettings(e.audioSettings?.bgmVolume??100,t),e.audioSettings||delete e.audioSettings,this.saveManager.save(e),this.audioManager.setSFXVolume(t)}persistMotionSensitivitySetting(t){const e=this.saveManager.load(),i=e.colorAccessibility?.highContrast===!0,s=e.colorAccessibility?.colorVisionSupportMode??$;e.colorAccessibility=this.buildColorAccessibilitySettings(i,t,s),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}persistColorVisionSupportModeSetting(t){const e=this.saveManager.load(),i=e.colorAccessibility?.highContrast===!0,s=e.colorAccessibility?.motionSensitivity??X();e.colorAccessibility=this.buildColorAccessibilitySettings(i,s,t),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}buildColorAccessibilitySettings(t,e,i){const s=X();if(!(!t&&e===s&&i===$))return{...t?{highContrast:!0}:{},...e!==s?{motionSensitivity:e}:{},...i!==$?{colorVisionSupportMode:i}:{}}}buildAudioSettings(t,e){if(!(t===100&&e===100))return{...t!==100?{bgmVolume:t}:{},...e!==100?{sfxVolume:e}:{}}}createOverlay(){const t=document.getElementById("ui-overlay");if(!t)return;const e=this.saveManager.load(),i=wt(e),s=Ti(e);this.overlay=document.createElement("div"),this.unsubscribeLanguageChange?.(),this.unsubscribeLanguageChange=C.subscribe(()=>this.applyLocalizedText()),this.overlay.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      justify-content: center;
    ...
    `;const f=document.createElement("div");f.textContent=i.destinationLabel,f.style.cssText=`
      ...
      font-weight: 700;
      color: rgba(255, 255, 255, 0.92);
    `;const b=Qt(i.startStage,i.bestStars),g=Bt(i.startStage,i.bestStars,{label:"メダル",hint:b.nextThreshold===null?"かんぺき！":`${b.icon} いま ・ つぎ ⭐ ${b.nextThreshold}`,size:"regular",scope:"title-next-adventure"});g.style.marginTop=n?"0.35rem":"0.55rem",o.appendChild(h),o.appendChild(u),o.appendChild(m),o.appendChild(f),o.appendChild(g);const r=document.createElement("div");r.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
    ...
    `;const d=document.createElement("button");d.textContent="あそぶ",d.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(B(d,{onActivate:()=>{this.ensureTitleAudioInitialized(!1);const c=this.saveManager.load(),E=wt(c).startStage;this.sceneManager.requestTransition("stage",{stageNumber:E,totalScore:0,totalStarCount:0,launchSource:"campaign"})},onPressChange:c=>{d.style.transform=c?"scale(0.96)":"scale(1)"}}));const w=document.createElement("div");w.setAttribute("data-play-button-hint",""),w.textContent=i.buttonHint,w.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${n?"0.85rem":"1rem"};
      font-weight: 700;
      color: rgba(255, 255, 255, 0.88);
    ...
    `;const y=document.createElement("button");y.textContent="うちゅうで あそぶ",y.setAttribute("data-free-play-button",""),y.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(B(y,{onActivate:()=>{this.ensureTitleAudioInitialized(!1),this.sceneManager.requestTransition("freePlay",{})},onPressChange:c=>{y.style.transform=c?"scale(0.96)":"scale(1)"}}));const p=document.createElement("div");p.setAttribute("data-title-secondary-actions",""),p.style.cssText=`
      display: grid;
    ...
    `;const A=document.createElement("button");A.setAttribute("data-spaceship-customizer-button",""),A.textContent="うちゅうせんをかざろう",A.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(B(A,{onActivate:()=>{const c=this.saveManager.load();this.spaceshipCustomizer.show({initialCustomization:c.spaceshipCustomization??Pt,onComplete:E=>{const P=this.saveManager.load();P.spaceshipCustomization=E,this.saveManager.save(P)}})},onPressChange:c=>{A.style.transform=c?"scale(0.96)":"scale(1)"}}));const T=document.createElement("button");T.setAttribute("data-stats-button",""),T.textContent="あそびの きろく",T.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${n?"0.9rem":"1.05rem"};
      font-weight: 900;
      padding: ${n?"0.55rem 0.65rem":"0.7rem 0.85rem"};
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(B(T,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.statsOverlay.show(this.saveManager.load().gameplayStats,()=>{})},onPressChange:c=>{T.style.transform=c?"scale(0.96)":"scale(1)"}}));const R=document.createElement("div");R.setAttribute("data-title-footer-actions",""),R.style.cssText=`
      display: grid;
    ...
    `;const M=document.createElement("button");M.textContent="あそびかた",M.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(B(M,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide()})},onPressChange:c=>{M.style.transform=c?"scale(0.96)":"scale(1)"}}));const S=document.createElement("button");S.setAttribute("data-color-settings-button",""),S.textContent=C.t("titleScene.colorSettingsButton"),this.colorSettingsButton=S,S.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${n?"0.82rem":"1rem"};
      font-weight: 700;
      padding: ${n?"0.45rem 0.55rem":"0.55rem 0.8rem"};
    ...
    `,this.overlayButtonCleanups.add(B(S,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.colorAccessibilitySettings.show({initialHighContrast:this.saveManager.load().colorAccessibility?.highContrast===!0,initialColorVisionSupportMode:this.saveManager.load().colorAccessibility?.colorVisionSupportMode??$,initialBGMVolume:this.saveManager.load().audioSettings?.bgmVolume??100,initialSFXVolume:this.saveManager.load().audioSettings?.sfxVolume??100,initialVibrationIntensity:this.saveManager.load().vibrationSettings?.intensity??"medium",initialMotionSensitivity:this.saveManager.load().colorAccessibility?.motionSensitivity??X(),initialRestReminderEnabled:this.saveManager.load().restReminderSettings?.enabled??pe,initialLanguage:this.saveManager.load().language??ht,onToggle:c=>this.persistHighContrastSetting(c),onColorVisionSupportModeChange:c=>this.persistColorVisionSupportModeSetting(c),onBGMVolumeChange:c=>this.persistBGMVolumeSetting(c),onSFXVolumeChange:c=>this.persistSFXVolumeSetting(c),onVibrationIntensityChange:c=>this.persistVibrationIntensitySetting(c),onMotionSensitivityChange:c=>this.persistMotionSensitivitySetting(c),onRestReminderToggle:c=>this.persistRestReminderSetting(c),onLanguageChange:c=>this.persistLanguageSetting(c)})},onPressChange:c=>{S.style.transform=c?"scale(0.96)":"scale(1)"}}));const x=document.createElement("button");if(x.textContent=Zt(e.unlockedPlanets.length,J.length),x.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.encyclopediaBtn=x,this.overlayButtonCleanups.add(B(x,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.openEncyclopedia()},onPressChange:c=>{x.style.transform=c?"scale(0.96)":"scale(1)"}})),r.appendChild(d),r.appendChild(y),r.appendChild(w),p.appendChild(A),p.appendChild(T),s){const c=document.createElement("button");c.setAttribute("data-reset-progress-button",""),c.textContent="さいしょから",c.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: ${n?"0.9rem":"1.05rem"};
        font-weight: 900;
        padding: ${n?"0.55rem 0.65rem":"0.7rem 0.85rem"};
    ...
    `,document.head.appendChild(t)}}const Ri=1,Oi=.4;class Yt{overlayEl=null;numberEl=null;phase="idle";elapsed=0;currentStep=0;stepDuration;goDuration;onTick;onGo;onComplete=null;steps=["3","2","1"];constructor(t={}){this.stepDuration=t.stepDuration??Ri,this.goDuration=t.goDuration??Oi,this.onTick=t.onTick,this.onGo=t.onGo}show(t){if(this.phase!=="idle"&&this.phase!=="done")return;const e=document.getElementById("ui-overlay")??document.body;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-countdown-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
    ...
    `,this.overlayButtonCleanups.add(B(n,{onActivate:()=>{this.inputSystem.resetPointers?.(),this.sceneManager.requestTransition("title")},onPressChange:o=>{n.style.transform=o?"scale(0.96)":"scale(1)"}})),e.append(i,n);const a=document.createElement("div");a.style.cssText=`
      align-self: center;
    ...
    `,a.textContent="← → で ゆったり うちゅうさんぽ",this.overlay.append(e,a),t.appendChild(this.overlay),this.updateStageLabel(),this.updateCompanionBadge()}updateCamera(){if(!this.ship)return;const t=this.ship.mesh.position;this.camera.position.x+=(t.x*.32-this.camera.position.x)*.12,this.camera.position.y=2.8,this.camera.position.z=t.z+12,this.currentLookAt.set(t.x*.18,t.y+.4,t.z-18),this.camera.lookAt(this.currentLookAt)}updatePlanet(t){!this.currentPlanet||!this.ship||(this.currentPlanet.position.set(0,.5,this.ship.mesh.position.z-52),this.currentPlanet.rotation.y+=t*.08,this.currentPlanetSpinTarget?.rotateY(t*.22))}updateStageRotation(t){this.stageTimeRemaining-=t,!(this.stageTimeRemaining>0)&&this.applyStage(this.pickRandomStage(this.currentStageNumber))}applyStage(t){this.currentStageNumber=t,this.currentStageConfig=Z(t),this.stageTimeRemaining=this.sampleStageDuration(),this.clearPlanet();const{planet:e,spinTarget:i}=re(t,this.currentStageConfig,-52);e.name="free-play-stage-planet",this.currentPlanet=e,this.currentPlanetSpinTarget=i,this.threeScene.add(e),this.stageAtmosphereEffect.start(se(t)),this.effectSystem.setCurrentStage(t),this.updateStageLabel()}clearPlanet(){this.currentPlanet&&(this.currentPlanet.parent?.remove(this.currentPlanet),this.currentPlanet=null,this.currentPlanetSpinTarget=null)}updateStageLabel(){this.stageLabel&&(this.stageLabel.textContent=`${this.currentStageConfig.emoji} ${this.currentStageConfig.destinationReading}の そらで あそんでるよ`)}updateCompanionBadge(){if(!this.companionBadge)return;const t=this.companionManager?.getCount()??0;this.companionBadge.textContent=t>0?`👾 なかま ${t}にん と いっしょ！`:"👾 なかまを あつめると ここに くるよ！"}sampleStageDuration(){return this.stageDurationSeconds*(.8+this.randomProvider()*.4)}pickRandomStage(t){const e=Array.from({length:G},(n,a)=>a+1),i=t===void 0?e:e.filter(n=>n!==t),s=Math.min(i.length-1,Math.floor(this.randomProvider()*i.length));return i[s]}}const Ki=Object.freeze(Object.defineProperty({__proto__:null,FreePlayScene:Vi},Symbol.toStringTag,{value:"Module"}));let it=null,st=null;function Ui(){if(!it){const l=new kt,t=new Float32Array(3e3);for(let e=0;e<3e3;e++)t[e]=(Math.random()-.5)*200;l.setAttribute("position",new It(t,3)),it=l}return it}function ji(){return st||(st=new Dt({color:16777215,size:.3})),st}function Wi(){it=null,st=null}const Zi={getBgStarsGeometry:()=>it,getBgStarsMaterial:()=>st};class z{static CIRCLE_RADIUS=3;static POPIN_DELAY=.2;static POPIN_DURATION=.3;static BOUNCE_SPEED=3;static BOUNCE_HEIGHT=.5;static THANK_YOU_DELAY=2.5;threeScene;camera;lastAspect=0;sceneManager;saveManager;audioManager;overlay=null;muteHandle=null;bgStars=null;companionMeshes=[];companionGroup=null;circleX=[];circleZ=[];popinSettled=[];celebrationElapsed=0;thankYouShown=!1;canExit=!1;exitTriggered=!1;exitCta=null;constructor(t,e,i){this.sceneManager=t,this.saveManager=e,this.audioManager=i,this.threeScene=new nt;const{width:s,height:n}=H();this.camera=new vt(60,s/n,.1,1e3),this.camera.position.set(0,0,5)}enter(t){this.lastAspect=0,this.canExit=!1,this.exitTriggered=!1,this.exitCta=null;const e=t.totalScore??0,i=t.totalStarCount??0;this.threeScene=new nt,this.threeScene.background=new at(48),this.bgStars=new Ot(Ui(),ji()),this.bgStars.userData.sharedAssets=!0,this.bgStars.rotation.set(0,0,0),this.threeScene.add(this.bgStars),this.threeScene.add(new bt(16777215,1));const s=this.saveManager.load();s.clearedStage=0,this.saveManager.save(s),this.audioManager.playBGM(-1),this.setupCelebration(),this.createOverlay(e,i),this.createMuteButton()}createMuteButton(){const t=document.getElementById("hud")??document.getElementById("ui-overlay");t&&(this.muteHandle=zt({initialMuted:this.audioManager.isMuted(),container:t,onToggle:()=>{const e=this.audioManager.toggleMute();this.muteHandle?.setMuted(e);const i=this.saveManager.load();i.muted=e,this.saveManager.save(i)}}))}createOverlay(t,e){const i=document.getElementById("ui-overlay");if(!i)return;this.overlay=document.createElement("div"),this.overlay.setAttribute("data-ending-overlay",""),this.overlay.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      justify-content: center;
