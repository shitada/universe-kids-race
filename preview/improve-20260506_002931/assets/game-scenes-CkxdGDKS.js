const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-C7H9xiAG.js","assets/game-core-BBrrPWfA.js","assets/three-BsQe5WE2.js"])))=>i.map(i=>d[i]);
import{g as it,D as Et,S as $,T as I,a as _,b as Gt,L as Qt,c as Kt,_ as bt,d as L,e as z,f as N,s as Ht,h as at,i as zt,j as Jt,P as W,u as Nt,C as te,k as ee,l as se,B as ie,m as ae,M as ne,n as oe,o as re,p as le,q as he,r as ce,t as de,v as ue,w as me,x as pe,y as fe,z as ge,A as Ft,W as ye,E as be,F as ve,G as _t,H as Ee,I as St,J as Se,K as xe,R as Ce,N as we,O as Ae,Q as Te,U as Me,V as Bt,X as $t,Y as Pe,Z as nt,$ as V,a0 as Be,a1 as mt,a2 as Re,a3 as pt,a4 as ke,a5 as Oe,a6 as Ie,a7 as De,a8 as Le}from"./game-core-BBrrPWfA.js";import{n as xt,l as Ct,j as wt,m as At,G as ot,r as Ge,a as He,s as ze,M as P,h as G,D as Rt,R as kt,t as H,u as dt,v as Q,i as K,P as ut,V as j,w as jt,x as Ne}from"./three-BsQe5WE2.js";class Tt{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const e=document.getElementById("ui-overlay");if(!e)return;const s=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
    ...
    `,n.appendChild(o),n.appendChild(h),n.appendChild(c),n}isCompactHeight(){return window.innerHeight<=Tt.COMPACT_HEIGHT_THRESHOLD}injectAnimations(){if(document.getElementById("tutorial-animations"))return;const t=document.createElement("style");t.id="tutorial-animations",t.textContent=`
      @keyframes swipe {
    ...
    `,document.head.appendChild(t)}}class Fe{overlayEl=null;activePressCleanups=new Set;show(t,e){if(this.overlayEl)return;const s=document.getElementById("ui-overlay");if(!s)return;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-title-reset-confirm-overlay",""),this.overlayEl.setAttribute("role","dialog"),this.overlayEl.setAttribute("aria-modal","true"),this.overlayEl.setAttribute("aria-label","さいしょからに もどしますか"),this.overlayEl.style.cssText=`
      ...
      padding: 1.5rem;
      background: rgba(0, 0, 32, 0.92);
    `;let i=!1;const a=()=>{i||(i=!0,this.hide(),e())},n=()=>{i||(i=!0,this.hide(),t())};this.overlayEl.addEventListener("pointerdown",u=>{u.target===this.overlayEl&&a()});const o=document.createElement("div");o.setAttribute("data-title-reset-confirm-card",""),o.style.cssText=`
    ...
    `,o.appendChild(c);const d=document.createElement("div");d.style.cssText=`
      display: flex;
      gap: 0.8rem;
      justify-content: center;
      flex-wrap: wrap;
    `,o.appendChild(d);const f=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: 1.1rem;
      font-weight: 900;
      min-width: 88px;
      ...
      white-space: nowrap;
    `,y=(u,w)=>{let g=!1,m=!1;const S=()=>{T(!0)},x=()=>{u.style.transform="scale(0.92)"},A=()=>{u.style.transform="scale(1)"},T=(b=!1)=>{g=!1,m=b,A(),this.activePressCleanups.delete(S),document.removeEventListener("pointerup",E,!0),document.removeEventListener("pointercancel",C,!0)},E=b=>{const D=b.target===u||b.target instanceof Node&&u.contains(b.target),st=g&&D;T(!D),st&&w()},C=()=>{T(!0)};u.addEventListener("pointerdown",b=>{b.stopPropagation(),g=!0,m=!1,x(),this.activePressCleanups.add(S),document.addEventListener("pointerup",E,!0),document.addEventListener("pointercancel",C,!0)}),u.addEventListener("pointerenter",()=>{g&&x()}),u.addEventListener("pointerleave",()=>{g&&A()}),u.addEventListener("pointercancel",()=>T(!0)),u.addEventListener("click",b=>{if(b.stopPropagation(),m){m=!1;return}g||w()})},p=document.createElement("button");p.setAttribute("data-title-reset-cancel",""),p.textContent="やめる",p.style.cssText=f,p.style.background="rgba(255, 255, 255, 0.18)",p.style.color="#ffffff",y(p,a),d.appendChild(p);const r=document.createElement("button");r.setAttribute("data-title-reset-confirm",""),r.textContent="うん！ さいしょから",r.style.cssText=f,r.style.background="linear-gradient(135deg, #FF9F68, #FFE66D)",r.style.color="#3b1f00",y(r,n),d.appendChild(r),s.appendChild(this.overlayEl)}hide(){if(!this.overlayEl)return;const t=Array.from(this.activePressCleanups);this.activePressCleanups.clear();for(const e of t)e();this.overlayEl.remove(),this.overlayEl=null}}function Mt(l){const t=l.topRem??.8,e=window.innerHeight<=500,s=document.createElement("button");let i=l.initialMuted;const a=()=>{s.textContent=i?"🔇":"🔊",s.setAttribute("aria-label",i?"サウンド オフ":"サウンド オン")};s.setAttribute("data-mute-button",""),s.style.position="absolute",s.style.top=`${t}rem`,s.style.right="1rem",s.style.fontSize=e?"clamp(1.1rem, 3.5vmin, 1.4rem)":"clamp(1.4rem, 4vmin, 1.8rem)",s.style.background="rgba(255, 255, 255, 0.15)",s.style.border="none",s.style.borderRadius="50%",s.style.width=e?"2.4rem":"3rem",s.style.height=e?"2.4rem":"3rem",s.style.display="flex",s.style.alignItems="center",s.style.justifyContent="center",s.style.cursor="pointer",s.style.pointerEvents="auto",s.style.touchAction="manipulation",s.style.transform="scale(1)",s.style.transition="transform 0.08s ease-out",a();const n=()=>{s.style.transform="scale(1)"};return s.addEventListener("pointerdown",o=>{o.stopPropagation(),s.style.transform="scale(0.9)",l.onToggle()}),s.addEventListener("pointerup",n),s.addEventListener("pointercancel",n),s.addEventListener("pointerleave",n),l.container.appendChild(s),{element:s,setMuted(o){i=o,a()},remove(){s.remove()}}}class _e{overlay=null;toggleButton=null;descriptionEl=null;highContrast=!1;colorVisionSupportMode="color-only";vibrationIntensity="medium";motionSensitivity="strong";restReminderEnabled=!0;colorVisionDescriptionEl=null;colorVisionButtons=new Map;vibrationDescriptionEl=null;vibrationButtons=new Map;motionDescriptionEl=null;motionButtons=new Map;restReminderDescriptionEl=null;restReminderToggleButton=null;motionPreviewEl=null;motionPreviewTokenEl=null;motionPreviewCaptionEl=null;motionPreviewTimeoutId=null;motionPreviewFrameId=null;onToggle=null;onColorVisionSupportModeChange=null;onVibrationIntensityChange=null;onMotionSensitivityChange=null;onRestReminderToggle=null;show(t){const e=document.getElementById("ui-overlay");if(e){if(this.highContrast=t.initialHighContrast,this.colorVisionSupportMode=t.initialColorVisionSupportMode,this.vibrationIntensity=t.initialVibrationIntensity,this.motionSensitivity=t.initialMotionSensitivity,this.restReminderEnabled=t.initialRestReminderEnabled,this.onToggle=t.onToggle,this.onColorVisionSupportModeChange=t.onColorVisionSupportModeChange,this.onVibrationIntensityChange=t.onVibrationIntensityChange,this.onMotionSensitivityChange=t.onMotionSensitivityChange,this.onRestReminderToggle=t.onRestReminderToggle,!this.overlay){this.overlay=document.createElement("div"),this.overlay.setAttribute("data-color-accessibility-settings",""),this.overlay.style.cssText=`
        position: absolute;
        inset: 0;
        display: flex;
        align-items: center;
      ...
      `,this.toggleButton.addEventListener("click",()=>{this.highContrast=!this.highContrast,this.render(),this.onToggle?.(this.highContrast)});const a=document.createElement("h3");a.textContent="やすみじかんの おしらせ",a.style.cssText="margin: 0.9rem 0 0.45rem; font-size: clamp(1rem, 3.8vmin, 1.2rem);",this.restReminderDescriptionEl=document.createElement("p"),this.restReminderDescriptionEl.style.cssText="margin: 0 0 0.6rem; font-size: clamp(0.9rem, 3.2vmin, 1rem); line-height: 1.5;",this.restReminderToggleButton=document.createElement("button"),this.restReminderToggleButton.setAttribute("data-rest-reminder-toggle",""),this.restReminderToggleButton.style.cssText=`
        ...
        cursor: pointer;
        touch-action: manipulation;
      `,this.restReminderToggleButton.addEventListener("click",()=>{this.restReminderEnabled=!this.restReminderEnabled,this.render(),this.onRestReminderToggle?.(this.restReminderEnabled)});const n=document.createElement("h3");n.textContent="いろの みわけかた",n.style.cssText="margin: 0.9rem 0 0.45rem; font-size: clamp(1rem, 3.8vmin, 1.2rem);",this.colorVisionDescriptionEl=document.createElement("p"),this.colorVisionDescriptionEl.style.cssText="margin: 0 0 0.8rem; font-size: clamp(0.9rem, 3.2vmin, 1rem); line-height: 1.5;";const o=document.createElement("div");o.setAttribute("data-color-vision-mode-group",""),o.style.cssText=`
        display: grid;
        grid-template-columns: repeat(2, minmax(0, 1fr));
        gap: 0.65rem;
        margin-bottom: 0.95rem;
      `;const h=[{value:"color-only",label:"いろだけ",icon:"🎨"},{value:"color-and-marks",label:"いろとマーク",icon:"★"}];for(const S of h){const x=document.createElement("button");x.setAttribute("data-color-vision-mode-button",S.value),x.textContent=`${S.icon} ${S.label}`,x.style.cssText=`
          min-height: 3.25rem;
        ...
        `,x.addEventListener("click",()=>{this.colorVisionSupportMode=S.value,this.render(),this.onColorVisionSupportModeChange?.(S.value)}),this.colorVisionButtons.set(S.value,x),o.appendChild(x)}const c=document.createElement("h3");c.textContent="しんどうの つよさ",c.style.cssText="margin: 0.9rem 0 0.45rem; font-size: clamp(1rem, 3.8vmin, 1.2rem);",this.vibrationDescriptionEl=document.createElement("p"),this.vibrationDescriptionEl.style.cssText="margin: 0 0 0.8rem; font-size: clamp(0.9rem, 3.2vmin, 1rem); line-height: 1.5;";const d=document.createElement("div");d.setAttribute("data-vibration-intensity-group",""),d.style.cssText=`
        display: grid;
        grid-template-columns: repeat(2, minmax(0, 1fr));
        gap: 0.65rem;
        margin-bottom: 0.95rem;
      `;const f=[{value:"strong",label:"つよい"},{value:"medium",label:"ふつう"},{value:"weak",label:"やさしい"},{value:"off",label:"オフ"}];for(const S of f){const x=document.createElement("button");x.setAttribute("data-vibration-intensity-button",S.value),x.textContent=S.label,x.style.cssText=`
          min-height: 3.25rem;
          padding: 0.8rem 0.9rem;
          border-radius: 1rem;
          border: 2px solid rgba(255, 255, 255, 0.4);
          ...
          touch-action: manipulation;
          transition: transform 0.08s ease-out, border-color 0.12s ease-out, background 0.12s ease-out;
        `,x.addEventListener("click",()=>{this.vibrationIntensity=S.value,this.render(),this.onVibrationIntensityChange?.(S.value)}),this.vibrationButtons.set(S.value,x),d.appendChild(x)}const y=document.createElement("h3");y.textContent="うごきの つよさ",y.style.cssText="margin: 1.1rem 0 0.45rem; font-size: clamp(1rem, 3.8vmin, 1.2rem);";const p=document.createElement("p");p.textContent="えらんで みると うごきの おためしが みえるよ",p.style.cssText="margin: 0 0 0.5rem; font-size: clamp(0.9rem, 3.2vmin, 1rem); line-height: 1.5;",this.motionDescriptionEl=document.createElement("p"),this.motionDescriptionEl.style.cssText="margin: 0 0 0.8rem; font-size: clamp(0.9rem, 3.2vmin, 1rem); line-height: 1.5;";const r=document.createElement("div");r.setAttribute("data-motion-sensitivity-group",""),r.style.cssText=`
        display: grid;
        grid-template-columns: repeat(2, minmax(0, 1fr));
        gap: 0.65rem;
        margin-bottom: 0.95rem;
      `;const u=["strong","medium","gentle","minimal"];for(const S of u){const x=it(S),A=document.createElement("button");A.setAttribute("data-motion-sensitivity-button",S),A.style.cssText=`
          display: flex;
          flex-direction: column;
          align-items: center;
          justify-content: center;
          ...
          touch-action: manipulation;
          transition: transform 0.08s ease-out, border-color 0.12s ease-out, background 0.12s ease-out;
        `;const T=document.createElement("span");T.textContent=x.emoji,T.style.cssText="font-size: clamp(1.25rem, 4.8vmin, 1.7rem); line-height: 1;";const E=document.createElement("span");E.textContent=x.stars,E.style.cssText="font-size: clamp(0.82rem, 2.9vmin, 0.95rem); letter-spacing: 0.08em;";const C=document.createElement("span");C.textContent=x.shortLabel,C.style.cssText="font-size: clamp(0.9rem, 3vmin, 1rem);",A.append(T,E,C),A.addEventListener("click",()=>{this.motionSensitivity=S,this.render(),this.playMotionPreview(),this.onMotionSensitivityChange?.(S)}),this.motionButtons.set(S,A),r.appendChild(A)}this.motionPreviewEl=document.createElement("div"),this.motionPreviewEl.setAttribute("data-motion-preview",""),this.motionPreviewEl.style.cssText=`
        position: relative;
        min-height: 5.8rem;
        margin: 0 0 1rem;
        padding: 0.8rem 0.9rem;
      ...
      `,this.motionPreviewCaptionEl=document.createElement("p"),this.motionPreviewCaptionEl.setAttribute("data-motion-preview-caption",""),this.motionPreviewCaptionEl.style.cssText="margin: 0; font-size: clamp(0.9rem, 3vmin, 1rem); line-height: 1.5;",w.append(g,this.motionPreviewTokenEl),this.motionPreviewEl.append(w,this.motionPreviewCaptionEl);const m=document.createElement("button");m.textContent="とじる",m.style.cssText=`
        ...
        cursor: pointer;
        touch-action: manipulation;
      `,m.addEventListener("click",()=>this.hide()),s.appendChild(i),s.appendChild(this.descriptionEl),s.appendChild(this.toggleButton),s.appendChild(a),s.appendChild(this.restReminderDescriptionEl),s.appendChild(this.restReminderToggleButton),s.appendChild(n),s.appendChild(this.colorVisionDescriptionEl),s.appendChild(o),s.appendChild(c),s.appendChild(this.vibrationDescriptionEl),s.appendChild(d),s.appendChild(y),s.appendChild(p),s.appendChild(this.motionDescriptionEl),s.appendChild(r),s.appendChild(this.motionPreviewEl),s.appendChild(m),this.overlay.appendChild(s)}this.render(),e.appendChild(this.overlay)}}hide(){this.clearMotionPreviewTimers(),this.overlay?.remove()}isVisible(){return this.overlay?.isConnected===!0}render(){if(!this.toggleButton||!this.descriptionEl||!this.restReminderDescriptionEl||!this.restReminderToggleButton||!this.colorVisionDescriptionEl||!this.vibrationDescriptionEl||!this.motionDescriptionEl)return;this.descriptionEl.textContent=this.highContrast?"ふちや しまもようを つよくして みやすく しているよ。":"ひかりかたを やさしくして いつもの みために しているよ。",this.toggleButton.textContent=this.highContrast?"みやすくする: ON":"みやすくする: OFF",this.toggleButton.setAttribute("aria-pressed",this.highContrast?"true":"false"),this.restReminderDescriptionEl.textContent=this.restReminderEnabled?"15ぷんごとに そっと やすもうって つたえるよ。":"いまは おしらせを ださずに あそべるよ。",this.restReminderToggleButton.textContent=this.restReminderEnabled?"やすみじかんの おしらせ: ON":"やすみじかんの おしらせ: OFF",this.restReminderToggleButton.setAttribute("aria-pressed",this.restReminderEnabled?"true":"false"),this.colorVisionDescriptionEl.textContent=this.colorVisionSupportMode==="color-and-marks"?"にじりゅうせいは ★、わくせいは しるしつきで わかるよ。":"いまは いろを みながら あそぶ モードだよ。";for(const[s,i]of this.colorVisionButtons.entries()){const a=s===this.colorVisionSupportMode;i.setAttribute("aria-pressed",a?"true":"false"),i.style.borderColor=a?"#fff27a":"rgba(255, 255, 255, 0.4)",i.style.background=a?"linear-gradient(135deg, rgba(255, 242, 122, 0.94), rgba(118, 240, 255, 0.92))":"rgba(255, 255, 255, 0.08)",i.style.color=a?"#102040":"#fff",i.style.transform=a?"scale(1.02)":"scale(1)"}const t={strong:"しっかり つたえる しんどうだよ。",medium:"ちょうどよく わかる つよさだよ。",weak:"やさしく ふるえて つたえるよ。",off:"しんどうの かわりに がめんが すこし ゆれるよ。"};this.vibrationDescriptionEl.textContent=t[this.vibrationIntensity];for(const[s,i]of this.vibrationButtons.entries()){const a=s===this.vibrationIntensity;i.setAttribute("aria-pressed",a?"true":"false"),i.style.borderColor=a?"#fff27a":"rgba(255, 255, 255, 0.4)",i.style.background=a?"linear-gradient(135deg, rgba(255, 242, 122, 0.94), rgba(118, 240, 255, 0.92))":"rgba(255, 255, 255, 0.08)",i.style.color=a?"#102040":"#fff",i.style.transform=a?"scale(1.02)":"scale(1)"}const e=it(this.motionSensitivity);this.motionDescriptionEl.textContent=e.description;for(const[s,i]of this.motionButtons.entries()){const a=s===this.motionSensitivity;i.setAttribute("aria-pressed",a?"true":"false"),i.style.borderColor=a?"#fff27a":"rgba(255, 255, 255, 0.4)",i.style.background=a?"linear-gradient(135deg, rgba(255, 242, 122, 0.94), rgba(118, 240, 255, 0.92))":"rgba(255, 255, 255, 0.08)",i.style.color=a?"#102040":"#fff",i.style.transform=a?"scale(1.02)":"scale(1)"}this.motionPreviewEl?.dataset.previewActive!=="true"&&this.resetMotionPreview()}playMotionPreview(){if(!this.motionPreviewEl||!this.motionPreviewTokenEl||!this.motionPreviewCaptionEl)return;this.clearMotionPreviewTimers();const t=it(this.motionSensitivity);this.motionPreviewEl.dataset.previewActive="true",this.motionPreviewTokenEl.textContent=t.emoji,this.motionPreviewTokenEl.style.background="rgba(255, 242, 122, 0.92)",this.motionPreviewTokenEl.style.boxShadow=t.previewGlow,this.motionPreviewTokenEl.style.transition="none",this.motionPreviewTokenEl.style.left="0.35rem",this.motionPreviewTokenEl.style.transform="translateY(-50%) scale(1)",this.motionPreviewCaptionEl.textContent=`${t.emoji} ${t.shortLabel} で おためしちゅう`,this.motionPreviewFrameId=window.requestAnimationFrame(()=>{this.motionPreviewTokenEl&&(this.motionPreviewTokenEl.style.transition=`left ${t.previewDurationMs}ms ease-in-out, transform ${t.previewDurationMs}ms ease-in-out`,this.motionPreviewTokenEl.style.left="calc(100% - 2.45rem)",this.motionPreviewTokenEl.style.transform=`translateY(-50%) scale(${t.previewScale})`)}),this.motionPreviewTimeoutId=window.setTimeout(()=>{this.resetMotionPreview()},t.previewDurationMs+260)}resetMotionPreview(){if(!this.motionPreviewEl||!this.motionPreviewTokenEl||!this.motionPreviewCaptionEl)return;const t=it(this.motionSensitivity);this.motionPreviewEl.dataset.previewActive="false",this.motionPreviewTokenEl.textContent=t.emoji,this.motionPreviewTokenEl.style.transition="none",this.motionPreviewTokenEl.style.left="0.35rem",this.motionPreviewTokenEl.style.transform="translateY(-50%) scale(1)",this.motionPreviewTokenEl.style.background="rgba(255, 242, 122, 0.92)",this.motionPreviewTokenEl.style.boxShadow=t.previewGlow,this.motionPreviewCaptionEl.textContent=`${t.stars} ${t.shortLabel} を えらぶと おためしするよ`}clearMotionPreviewTimers(){this.motionPreviewTimeoutId!==null&&(window.clearTimeout(this.motionPreviewTimeoutId),this.motionPreviewTimeoutId=null),this.motionPreviewFrameId!==null&&(window.cancelAnimationFrame(this.motionPreviewFrameId),this.motionPreviewFrameId=null)}}function M(l,t){let e=!1,s=!1,i=null,a=null;const n=t.documentTarget??document,o=t.stopPropagation??!0,h=()=>{t.canActivate?.()!==!1&&t.onActivate()},c=E=>{t.onPressChange?.(E)},d=E=>{const C=E;return typeof C.clientX=="number"&&typeof C.clientY=="number"?{x:C.clientX,y:C.clientY}:null},f=E=>{const C=E;return typeof C.pointerId=="number"?C.pointerId:null},y=E=>{const C=f(E);return i===null||C===null||C===i},p=E=>{if(!e||a===null||t.moveTolerancePx===void 0)return!1;const C=d(E);return C===null?!1:Math.hypot(C.x-a.x,C.y-a.y)>t.moveTolerancePx},r=E=>{e=!1,s=E,i=null,a=null,c(!1),n.removeEventListener("pointermove",g,!0),n.removeEventListener("pointerup",u,!0),n.removeEventListener("pointercancel",w,!0)},u=E=>{if(!e||!y(E))return;if(p(E)){r(!0);return}const C=E.target,b=C===l||C instanceof Node&&l.contains(C),D=e&&b;r(D||!b),D&&h()},w=()=>{r(!0)},g=E=>{!e||!y(E)||p(E)&&r(!0)},m=E=>{t.canActivate?.()!==!1&&((t.preventDefaultOnPointerDown??!1)&&E.preventDefault(),o&&E.stopPropagation(),e=!0,s=!1,i=f(E),a=d(E),c(!0),t.moveTolerancePx!==void 0&&n.addEventListener("pointermove",g,!0),n.addEventListener("pointerup",u,!0),n.addEventListener("pointercancel",w,!0))},S=()=>{e&&c(!0)},x=()=>{e&&c(!1)},A=()=>{r(!0)},T=E=>{if(o&&E.stopPropagation(),(t.preventDefaultOnClick??!1)&&E.preventDefault(),s){s=!1;return}e||h()};return l.addEventListener("pointerdown",m),l.addEventListener("pointerenter",S),l.addEventListener("pointerleave",x),l.addEventListener("pointercancel",A),l.addEventListener("click",T),()=>{r(!1),l.removeEventListener("pointerdown",m),l.removeEventListener("pointerenter",S),l.removeEventListener("pointerleave",x),l.removeEventListener("pointercancel",A),l.removeEventListener("click",T)}}class $e{overlay=null;previewBody=null;previewNose=null;previewWings=null;buttonCleanups=new Set;optionButtons=new Map;draft={...Et};colorOptions=$.getColorOptions();show(t){this.hide();const e=document.getElementById("ui-overlay");if(!e)return;this.draft=$.normalizeCustomization(t.initialCustomization),this.overlay=document.createElement("div"),this.overlay.setAttribute("data-spaceship-customizer",""),this.overlay.setAttribute("role","dialog"),this.overlay.setAttribute("aria-modal","true"),this.overlay.setAttribute("aria-label","うちゅうせんを かざろう"),this.overlay.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
    ...
    `;const a=document.createElement("span");return a.textContent=e.label,a.style.cssText="font-family: Zen Maru Gothic, sans-serif; font-size: 0.82rem; font-weight: 700;",s.appendChild(i),s.appendChild(a),this.buttonCleanups.add(M(s,{onActivate:()=>this.selectColor(t,e.key),onPressChange:n=>{s.style.transform=n?"scale(0.95)":"scale(1)"}})),this.optionButtons.set(`${t}:${e.key}`,s),s}selectColor(t,e){this.draft={...this.draft,[t]:e},this.render()}render(){const t=$.normalizeCustomization(this.draft);this.draft=t,this.previewBody?.style.setProperty("background",`#${$.getColorHex(t.bodyColor).toString(16).padStart(6,"0")}`),this.previewWings?.style.setProperty("background",`#${$.getColorHex(t.wingColor).toString(16).padStart(6,"0")}`),this.previewNose&&(this.previewNose.style.borderBottomColor=`#${$.getColorHex(t.noseColor).toString(16).padStart(6,"0")}`);for(const e of this.colorOptions)this.renderOptionState("bodyColor",e.key,t.bodyColor===e.key),this.renderOptionState("noseColor",e.key,t.noseColor===e.key),this.renderOptionState("wingColor",e.key,t.wingColor===e.key)}renderOptionState(t,e,s){const i=this.optionButtons.get(`${t}:${e}`);i&&(i.setAttribute("aria-pressed",s?"true":"false"),i.style.borderColor=s?"#ffe66d":"transparent",i.style.background=s?"rgba(255, 230, 109, 0.18)":"rgba(255, 255, 255, 0.12)")}}function je(l){return{totalPlayTimeSeconds:l?.totalPlayTimeSeconds??0,totalStarsCollected:l?.totalStarsCollected??0,totalBoostUses:l?.totalBoostUses??0,stageClearCounts:{...l?.stageClearCounts??{}}}}function Ve(l){const t=Math.max(0,Math.round(l)),e=Math.floor(t/3600),s=Math.floor(t%3600/60),i=t%60;return e>0?`${e}じかん ${s}ふん`:s>0?`${s}ふん ${i}びょう`:`${i}びょう`}class Ue{overlayEl=null;actionCleanups=new Set;show(t,e){this.hide();const s=document.getElementById("ui-overlay");if(!s)return;const i=je(t),a=window.innerHeight<=720,n=document.createElement("div");n.setAttribute("data-stats-overlay",""),n.style.cssText=`
      position: absolute;
      inset: 0;
      z-index: 35;
      display: flex;
    ...
    `,o.appendChild(h);const c=document.createElement("div");c.style.cssText=`
      ...
      gap: 0.8rem;
      margin-bottom: 1rem;
    `,c.append(this.createSummaryCard("あそんだ じかん",Ve(i.totalPlayTimeSeconds),"data-stats-total-play-time"),this.createSummaryCard("とった ほし",`${i.totalStarsCollected}こ`,"data-stats-total-stars"),this.createSummaryCard("ブースト",`${i.totalBoostUses}かい`,"data-stats-total-boosts")),o.appendChild(c);const d=document.createElement("div");d.style.cssText=`
      margin-top: 0.5rem;
    ...
    `;const f=document.createElement("div");f.textContent="ステージ クリア かいすう",f.style.cssText=`
      ...
      font-weight: 900;
      color: #FFE66D;
    `,d.appendChild(f);const y=document.createElement("div");y.setAttribute("data-stats-stage-clears",""),y.style.cssText=`
      display: flex;
      flex-direction: column;
      gap: 0.45rem;
      text-align: left;
    `;const p=Array.from({length:I},(u,w)=>w+1).map(u=>({stageNumber:u,clearCount:i.stageClearCounts[u]??0})).filter(u=>u.clearCount>0);if(p.length===0){const u=document.createElement("div");u.textContent="まだ きろくが ないよ",u.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: ${a?"1rem":"1.1rem"};
        font-weight: 700;
        text-align: center;
        color: rgba(255, 255, 255, 0.88);
      `,y.appendChild(u)}else for(const{stageNumber:u,clearCount:w}of p){const g=_(u),m=document.createElement("div");m.setAttribute("data-stats-stage-clear-row",String(u)),m.style.cssText=`
          display: flex;
          align-items: center;
          ...
          font-weight: 700;
        `;const S=document.createElement("span");S.textContent=`${g.emoji} ステージ ${u} ${g.destinationReading}`;const x=document.createElement("span");x.textContent=`${w}かい`,x.style.color="#FFE66D",m.append(S,x),y.appendChild(m)}d.appendChild(y),o.appendChild(d);const r=document.createElement("button");r.textContent="もどる",r.style.cssText=`
      margin-top: 1rem;
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.actionCleanups.add(M(r,{onActivate:()=>{this.hide(),e()},onPressChange:u=>{r.style.transform=u?"scale(0.96)":"scale(1)"}})),o.appendChild(r),n.appendChild(o),s.appendChild(n)}hide(){const t=Array.from(this.actionCleanups);this.actionCleanups.clear();for(const e of t)e();this.overlayEl?.remove(),this.overlayEl=null}createSummaryCard(t,e,s){const i=document.createElement("div");i.setAttribute(s,""),i.style.cssText=`
    ...
    `;const n=document.createElement("div");return n.textContent=e,n.style.cssText=`
      ...
      font-weight: 900;
      color: #FFE66D;
    `,i.append(a,n),i}}function Ot(l,t){if(!Number.isFinite(l)||l<=0||t<=0)return"ずかん";const e=Math.min(l,t);return e>=t?`ずかん ${t} / ${t} 🎉`:`ずかん ${e} / ${t}`}function We(l){switch(l){case"hero":return{gap:"0.35rem",label:"0.92rem",medal:"1.7rem",hint:"0.98rem"};case"compact":return{gap:"0.18rem",label:"0.7rem",medal:"1rem",hint:"0.76rem"};default:return{gap:"0.26rem",label:"0.8rem",medal:"1.25rem",hint:"0.84rem"}}}function vt(l,t,e={}){const s=Gt(l,t),i=e.size??"regular",a=We(i),n=document.createElement("div");if(n.setAttribute("data-stage-medal-display",""),n.setAttribute("data-stage-medal-stage",String(l)),n.setAttribute("data-stage-medal-tier",s.tier),n.setAttribute("data-stage-medal-earned",String(s.earnedCount)),e.scope&&n.setAttribute("data-stage-medal-scope",e.scope),n.style.cssText=`
    display: flex;
    flex-direction: column;
    align-items: center;
    gap: ${a.gap};
  `,e.label){const d=document.createElement("div");d.textContent=e.label,d.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${a.label};
      font-weight: 700;
      color: rgba(255, 255, 255, 0.84);
      letter-spacing: 0.06em;
    `,n.appendChild(d)}const o=document.createElement("div");o.style.cssText=`
    display: flex;
    align-items: center;
    justify-content: center;
    gap: ${a.gap};
  `;for(const d of s.slots){const f=document.createElement("span");f.setAttribute("data-stage-medal-slot",d.tier),f.setAttribute("data-stage-medal-threshold",String(d.threshold)),f.setAttribute("data-stage-medal-reached",String(d.reached)),f.textContent=d.icon,f.style.cssText=`
      font-size: ${a.medal};
      line-height: 1;
    ...
    `,o.appendChild(f)}n.appendChild(o);const h=e.hint??(s.nextThreshold===null?"かんぺき！":`つぎ ⭐ ${s.nextThreshold}`),c=document.createElement("div");return c.setAttribute("data-stage-medal-hint",""),c.textContent=h,c.style.cssText=`
    font-family: 'Zen Maru Gothic', sans-serif;
    font-size: ${a.hint};
    font-weight: 700;
    color: ${s.nextThreshold===null?"#FFE66D":"rgba(255, 255, 255, 0.86)"};
  `,n.appendChild(c),n}const It=2e3,rt=new Map,lt=new Map,ht=new Map;let J=null,tt=null;function et(l,t){if(typeof document>"u"){const s=typeof OffscreenCanvas=="function",i=s?new OffscreenCanvas(l,t):{width:l,height:t};return{canvas:i,ctx:s?i.getContext("2d"):null}}const e=document.createElement("canvas");return e.width=l,e.height=t,{canvas:e,ctx:e.getContext("2d")}}function U(l,t){let e=rt.get(l);return e||(e=t(),e.generateMipmaps=!1,e.minFilter=ze,e.needsUpdate=!0,rt.set(l,e)),e}function B(l,t){let e=lt.get(l);return e||(e=t(),lt.set(l,e)),e}function R(l,t){let e=ht.get(l);return e||(e=t(),ht.set(l,e)),e}function k(l,t){const e=new He(l,t);return e.userData.sharedAssets=!0,e}function Vt(){if(!J){const l=new Ct,t=new Float32Array(It*3);for(let e=0;e<It*3;e+=3)t[e]=(Math.random()-.5)*200,t[e+1]=(Math.random()-.5)*200,t[e+2]=(Math.random()-.5)*400;l.setAttribute("position",new wt(t,3)),J=l}tt||(tt=new At({color:16777215,size:.2,sizeAttenuation:!0}))}function Ze(){const{canvas:l,ctx:t}=et(256,256);if(!t)return new H(l);t.fillStyle="#888888",t.fillRect(0,0,256,256);for(let e=0;e<30;e++){const s=Math.random()*256,i=Math.random()*256,a=3+Math.random()*12;t.beginPath(),t.arc(s,i,a,0,Math.PI*2),t.fillStyle=`rgba(60,60,60,${.3+Math.random()*.4})`,t.fill()}return new H(l)}function qe(){const{canvas:l,ctx:t}=et(256,256);if(!t)return new H(l);t.fillStyle="#ddaa44",t.fillRect(0,0,256,256);for(let e=0;e<8;e++){t.beginPath();const s=128+(Math.random()-.5)*100,i=128+(Math.random()-.5)*100;t.strokeStyle=`rgba(200,150,60,${.3+Math.random()*.3})`,t.lineWidth=3+Math.random()*5;for(let a=0;a<Math.PI*4;a+=.1){const n=10+a*8;t.lineTo(s+Math.cos(a)*n,i+Math.sin(a)*n)}t.stroke()}return new H(l)}function Ye(){const{canvas:l,ctx:t}=et(256,256);if(!t)return new H(l);const e=["#cc7733","#dd9955","#bb6622","#eebb77","#aa5511","#ddaa66"];for(let s=0;s<256;s++){const i=Math.floor(s/(256/e.length))%e.length;t.fillStyle=e[i],t.fillRect(0,s,256,1)}return new H(l)}function Xe(){const{canvas:l,ctx:t}=et(512,256);return t?(t.fillStyle="#2266aa",t.fillRect(0,0,512,256),t.fillStyle="#886644",t.beginPath(),t.ellipse(300,80,80,40,.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(280,150,30,50,.1,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(100,90,25,60,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(110,170,20,40,-.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(420,170,25,15,0,0,Math.PI*2),t.fill(),t.fillStyle="#447733",t.beginPath(),t.ellipse(290,75,40,20,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(95,85,15,30,.2,0,Math.PI*2),t.fill(),new H(l)):new H(l)}function Qe(){const{canvas:l,ctx:t}=et(512,256);if(!t)return new H(l);t.clearRect(0,0,512,256),t.fillStyle="rgba(255,255,255,0.6)";for(let e=0;e<20;e++){const s=Math.random()*512,i=Math.random()*256;t.beginPath(),t.ellipse(s,i,20+Math.random()*40,8+Math.random()*15,Math.random()*Math.PI,0,Math.PI*2),t.fill()}return new H(l)}function Ke(){rt.clear(),lt.clear(),ht.clear(),J=null,tt=null}const Je={planetTextureCache:rt,planetGeometryCache:lt,planetMaterialCache:ht,getBgStarsGeometry:()=>J,getBgStarsMaterial:()=>tt};function Ut(l,t,e){const s=new ot;let i=null;switch(l){case 2:{const a=U("mercury",Ze),n=B("mercury:sphere",()=>new G(10,24,24)),o=R("mercury:mat",()=>new P({map:a})),h=k(n,o);s.add(h),i=h;break}case 3:{const a=U("venus",qe),n=B("venus:sphere",()=>new G(14,24,24)),o=R("venus:mat",()=>new P({map:a})),h=k(n,o);s.add(h),i=h;break}case 5:{const a=U("jupiter",Ye),n=B("jupiter:sphere",()=>new G(20,24,24)),o=R("jupiter:mat",()=>new P({map:a})),h=k(n,o);s.add(h),i=h;break}case 6:{const a=B("saturn:sphere",()=>new G(15,24,24)),n=t.planetColor,o=R(`saturn:mat:${n}`,()=>new P({color:n})),h=k(a,o);s.add(h);const c=B("saturn:ring",()=>new kt(20,30,48)),d=R("saturn:ringMat",()=>new P({color:15645542,side:Rt})),f=k(c,d);f.rotation.x=Math.PI/3,s.add(f),i=h;break}case 7:{const a=B("uranus:sphere",()=>new G(16,24,24)),n=R("uranus:mat",()=>new P({color:6737117})),o=k(a,n);s.add(o);const h=B("uranus:ring",()=>new kt(21,28,48)),c=R("uranus:ringMat",()=>new P({color:10083822,side:Rt})),d=k(h,c);d.rotation.z=Math.PI/2,s.add(d),i=o;break}case 9:{const a=B("pluto:sphere",()=>new G(8,24,24)),n=R("pluto:mat",()=>new P({color:12298922})),o=k(a,n);s.add(o),i=o;break}case 10:{const a=B("sun:sphere",()=>new G(25,24,24)),n=R("sun:mat",()=>new P({color:16763904,emissive:16755200,emissiveIntensity:.5})),o=k(a,n);s.add(o),s.add(new Ge(16763904,2,200)),i=o;break}case 11:{const a=U("earth",Xe),n=B("earth:sphere",()=>new G(15,32,32)),o=R("earth:mat",()=>new P({map:a})),h=U("earth:cloud",Qe),c=B("earth:cloudSphere",()=>new G(15.5,32,32)),d=R("earth:cloudMat",()=>new P({map:h,transparent:!0,opacity:.3})),f=new ot;f.add(k(n,o)),f.add(k(c,d)),s.add(f),i=f;break}default:{const a=B("default:sphere",()=>new G(15,24,24)),n=t.planetColor,o=R(`default:mat:${n}`,()=>new P({color:n})),h=k(a,o);s.add(h),i=h;break}}return s.position.set(0,0,e),{planet:s,spinTarget:i}}function Wt(l,t,e){return Ut(l,t,e)}function Zt(l){Vt();const t=new xt(J,tt);return t.userData.sharedAssets=!0,t.geometry.setDrawRange(0,l),t}function Pt(l){!Number.isInteger(l)||l<1||l>I||typeof document>"u"&&typeof OffscreenCanvas!="function"||(Vt(),Ut(l,_(l),0))}let Z=null,q=null;function ts(){if(!Z){const l=new Ct,t=new Float32Array(3e3);for(let e=0;e<3e3;e++)t[e]=(Math.random()-.5)*200;l.setAttribute("position",new wt(t,3)),Z=l}return Z}function es(){return q||(q=new At({color:16777215,size:.3,sizeAttenuation:!0})),q}function ss(){Z=null,q=null}const is={getBgStarsGeometry:()=>Z,getBgStarsMaterial:()=>q};function as(l){const t=window.requestIdleCallback;if(typeof t=="function"){t(l,{timeout:1500});return}window.setTimeout(l,800)}function qt(l){return new Set(l.filter(t=>Number.isInteger(t)&&t>=1&&t<=I)).size}function ns(l){return qt(l)>=I}function ft(l){const t=ns(l.unlockedPlanets),e=t?1:Math.min(l.clearedStage+1,I),s=_(e),i=l.bestStageStars?.[e]??0,a=l.colorAccessibility?.colorVisionSupportMode??z,n=zt(e,s.destinationReading,a);return t?{startStage:e,destination:n,emoji:s.emoji,statusLabel:"ぜんぶ あつめたよ！",destinationLabel:`${n}へ もういちど しゅっぱつ！`,buttonHint:`${s.emoji} ステージ ${e} から もういちど あそぶ`,bestStars:i}:{startStage:e,destination:n,emoji:s.emoji,statusLabel:l.clearedStage>0?"つづきから しゅっぱつ！":"はじめての しゅっぱつ！",destinationLabel:`${n}へ むかおう！`,buttonHint:`${s.emoji} ステージ ${e} から スタート`,bestStars:i}}function os(l){return l.clearedStage>0||qt(l.unlockedPlanets)>0||Object.keys(l.bestStageStars??{}).length>0}class rs{threeScene;ambientLight=new dt(16777215,1);camera;lastAspect=0;sceneManager;saveManager;audioManager;stars=null;companionParade=null;overlay=null;muteHandle=null;tutorialOverlay=new Tt;titleResetConfirmOverlay=new Fe;colorAccessibilitySettings=new _e;spaceshipCustomizer=new $e;statsOverlay=new Ue;encyclopediaOverlay=null;encyclopediaOverlayPromise=null;companionFactory=null;companionFactoryPromise=null;loadEncyclopediaOverlay;loadTitleCompanionFactory;loadingOverlay;loadFailureOverlay;scheduleIdleTask;encyclopediaBtn=null;isOpeningEncyclopedia=!1;isActive=!1;encyclopediaRequestToken=0;companionParadeRequestToken=0;bgmPending=!1;overlayButtonCleanups=new Set;constructor(t,e,s,i={}){this.sceneManager=t,this.saveManager=e,this.audioManager=s,this.loadingOverlay=i.loadingOverlay??new Qt,this.loadFailureOverlay=i.loadFailureOverlay??new Kt,this.scheduleIdleTask=i.scheduleIdleTask??as,this.loadEncyclopediaOverlay=i.loadEncyclopediaOverlay??(()=>bt(()=>import("./EncyclopediaOverlay-C7H9xiAG.js"),__vite__mapDeps([0,1,2]))),this.loadTitleCompanionFactory=i.loadTitleCompanionFactory??(()=>bt(()=>import("./game-core-BBrrPWfA.js").then(o=>o.ah),__vite__mapDeps([1,2]))),this.threeScene=new Q,this.threeScene.background=new K(32);const{width:a,height:n}=L();this.camera=new ut(60,a/n,.1,1e3),this.camera.position.set(0,0,5)}enter(t){this.isActive=!0,this.encyclopediaRequestToken+=1,this.companionParadeRequestToken+=1,this.lastAspect=0,this.stars=new xt(ts(),es()),this.stars.userData.sharedAssets=!0,this.stars.rotation.set(0,0,0),this.threeScene.add(this.stars),this.ambientLight.parent||this.threeScene.add(this.ambientLight);const e=this.saveManager.load();this.createCompanionParade(e.unlockedPlanets),this.createOverlay(),this.createMuteButton(),this.prefetchEncyclopediaOnIdle(),this.prewarmNextAdventureOnIdle(ft(e).startStage),this.audioManager.isInitialized()?(this.audioManager.playBGM(0),this.bgmPending=!1):this.bgmPending=!0,e.tutorialShown||this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide(),this.saveManager.markTutorialShown()})}createMuteButton(){const t=document.getElementById("hud")??document.getElementById("ui-overlay");t&&(this.muteHandle=Mt({initialMuted:this.audioManager.isMuted(),container:t,onToggle:()=>{this.ensureTitleAudioInitialized(!0);const e=this.audioManager.toggleMute();this.muteHandle?.setMuted(e);const s=this.saveManager.load();s.muted=e,this.saveManager.save(s)}}))}getEncyclopediaOverlay(){return this.encyclopediaOverlay?Promise.resolve(this.encyclopediaOverlay):this.encyclopediaOverlayPromise?this.encyclopediaOverlayPromise:(this.encyclopediaOverlayPromise=this.loadEncyclopediaOverlay().then(({EncyclopediaOverlay:t})=>{const e=new t;return this.encyclopediaOverlay=e,e}).finally(()=>{this.encyclopediaOverlayPromise=null}),this.encyclopediaOverlayPromise)}getTitleCompanionFactory(){return this.companionFactory?Promise.resolve(this.companionFactory):this.companionFactoryPromise?this.companionFactoryPromise:(this.companionFactoryPromise=this.loadTitleCompanionFactory().then(t=>(this.companionFactory=t,t)).finally(()=>{this.companionFactoryPromise=null}),this.companionFactoryPromise)}showEncyclopedia(){if(!this.isActive||!this.encyclopediaOverlay)return;const t=this.saveManager.load();this.encyclopediaOverlay.show(t.unlockedPlanets,()=>this.refreshEncyclopediaButtonLabel(),e=>{this.ensureTitleAudioInitialized(!1),this.sceneManager.requestTransition("stage",{stageNumber:e,totalScore:0,totalStarCount:0,launchSource:"encyclopedia"})},t.bestStageStars??{},t.discoveredConstellations??[],t.colorAccessibility?.colorVisionSupportMode??z,t.discoveredMonthlyEncounters??[])}isCurrentEncyclopediaRequest(t){return this.isActive&&this.encyclopediaRequestToken===t}prefetchEncyclopediaOnIdle(){const t=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{!this.isCurrentEncyclopediaRequest(t)||this.encyclopediaOverlay||this.encyclopediaOverlayPromise||this.getEncyclopediaOverlay().catch(()=>{})})}prewarmNextAdventureOnIdle(t){if(t>I)return;const e=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{this.isCurrentEncyclopediaRequest(e)&&Pt(t)})}async openEncyclopedia(){if(!this.isActive)return;if(this.loadFailureOverlay.hide(),this.encyclopediaOverlay){this.showEncyclopedia();return}if(this.isOpeningEncyclopedia)return;const t=this.encyclopediaRequestToken;this.isOpeningEncyclopedia=!0,this.loadingOverlay.show("ずかんを よんでるよ...");try{if(await this.getEncyclopediaOverlay(),!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),this.showEncyclopedia()}catch(e){if(!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),console.error("Failed to load encyclopedia overlay",e),this.loadFailureOverlay.show({title:"ずかんを もういちど よんでみよう！",message:"「もういちど よむ」を おして つづきを たのしもう！",primaryAction:{label:"もういちど よむ",onSelect:()=>this.openEncyclopedia()}})}finally{this.encyclopediaRequestToken===t&&(this.isOpeningEncyclopedia=!1)}}persistHighContrastSetting(t){const e=this.saveManager.load(),s=e.colorAccessibility?.motionSensitivity??N,i=e.colorAccessibility?.colorVisionSupportMode??z;e.colorAccessibility=this.buildColorAccessibilitySettings(t,s,i),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}persistVibrationIntensitySetting(t){const e=this.saveManager.load();e.vibrationSettings={intensity:t},this.saveManager.save(e),Ht(t)}persistRestReminderSetting(t){const e=this.saveManager.load();e.restReminderSettings={enabled:t},this.saveManager.save(e)}persistMotionSensitivitySetting(t){const e=this.saveManager.load(),s=e.colorAccessibility?.highContrast===!0,i=e.colorAccessibility?.colorVisionSupportMode??z;e.colorAccessibility=this.buildColorAccessibilitySettings(s,t,i),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}persistColorVisionSupportModeSetting(t){const e=this.saveManager.load(),s=e.colorAccessibility?.highContrast===!0,i=e.colorAccessibility?.motionSensitivity??N;e.colorAccessibility=this.buildColorAccessibilitySettings(s,i,t),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}buildColorAccessibilitySettings(t,e,s){if(!(!t&&e===N&&s===z))return{...t?{highContrast:!0}:{},...e!==N?{motionSensitivity:e}:{},...s!==z?{colorVisionSupportMode:s}:{}}}createOverlay(){const t=document.getElementById("ui-overlay");if(!t)return;const e=this.saveManager.load(),s=ft(e),i=os(e);this.overlay=document.createElement("div"),this.overlay.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      justify-content: center;
    ...
    `;const f=document.createElement("div");f.textContent=s.destinationLabel,f.style.cssText=`
      ...
      font-weight: 700;
      color: rgba(255, 255, 255, 0.92);
    `;const y=Gt(s.startStage,s.bestStars),p=vt(s.startStage,s.bestStars,{label:"メダル",hint:y.nextThreshold===null?"かんぺき！":`${y.icon} いま ・ つぎ ⭐ ${y.nextThreshold}`,size:"regular",scope:"title-next-adventure"});p.style.marginTop=a?"0.35rem":"0.55rem",o.appendChild(h),o.appendChild(c),o.appendChild(d),o.appendChild(f),o.appendChild(p);const r=document.createElement("div");r.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
    ...
    `;const u=document.createElement("button");u.textContent="あそぶ",u.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(M(u,{onActivate:()=>{this.ensureTitleAudioInitialized(!1);const b=this.saveManager.load(),D=ft(b).startStage;this.sceneManager.requestTransition("stage",{stageNumber:D,totalScore:0,totalStarCount:0,launchSource:"campaign"})},onPressChange:b=>{u.style.transform=b?"scale(0.96)":"scale(1)"}}));const w=document.createElement("div");w.setAttribute("data-play-button-hint",""),w.textContent=s.buttonHint,w.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${a?"0.85rem":"1rem"};
      font-weight: 700;
      color: rgba(255, 255, 255, 0.88);
      text-shadow: 0 2px 10px rgba(0, 0, 0, 0.35);
    `;const g=document.createElement("button");g.textContent="うちゅうで あそぶ",g.setAttribute("data-free-play-button",""),g.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${a?"1.05rem":"1.35rem"};
      font-weight: 900;
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(M(g,{onActivate:()=>{this.ensureTitleAudioInitialized(!1),this.sceneManager.requestTransition("freePlay",{})},onPressChange:b=>{g.style.transform=b?"scale(0.96)":"scale(1)"}}));const m=document.createElement("div");m.setAttribute("data-title-secondary-actions",""),m.style.cssText=`
      display: grid;
      grid-template-columns: repeat(${i?3:2}, minmax(0, 1fr));
      gap: ${a?"0.45rem":"0.55rem"};
      width: 100%;
      align-items: stretch;
    `;const S=document.createElement("button");S.setAttribute("data-spaceship-customizer-button",""),S.textContent="うちゅうせんをかざろう",S.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(M(S,{onActivate:()=>{const b=this.saveManager.load();this.spaceshipCustomizer.show({initialCustomization:b.spaceshipCustomization??Et,onComplete:D=>{const st=this.saveManager.load();st.spaceshipCustomization=D,this.saveManager.save(st)}})},onPressChange:b=>{S.style.transform=b?"scale(0.96)":"scale(1)"}}));const x=document.createElement("button");x.setAttribute("data-stats-button",""),x.textContent="あそびの きろく",x.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${a?"0.9rem":"1.05rem"};
      font-weight: 900;
      padding: ${a?"0.55rem 0.65rem":"0.7rem 0.85rem"};
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(M(x,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.statsOverlay.show(this.saveManager.load().gameplayStats,()=>{})},onPressChange:b=>{x.style.transform=b?"scale(0.96)":"scale(1)"}}));const A=document.createElement("div");A.setAttribute("data-title-footer-actions",""),A.style.cssText=`
      display: grid;
    ...
    `;const T=document.createElement("button");T.textContent="あそびかた",T.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(M(T,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide()})},onPressChange:b=>{T.style.transform=b?"scale(0.96)":"scale(1)"}}));const E=document.createElement("button");E.setAttribute("data-color-settings-button",""),E.textContent="みやすさ・しんどう",E.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${a?"0.82rem":"1rem"};
      font-weight: 700;
      padding: ${a?"0.45rem 0.55rem":"0.55rem 0.8rem"};
      ...
      transition: transform 0.08s ease-out;
      white-space: nowrap;
    `,this.overlayButtonCleanups.add(M(E,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.colorAccessibilitySettings.show({initialHighContrast:this.saveManager.load().colorAccessibility?.highContrast===!0,initialColorVisionSupportMode:this.saveManager.load().colorAccessibility?.colorVisionSupportMode??z,initialVibrationIntensity:this.saveManager.load().vibrationSettings?.intensity??"medium",initialMotionSensitivity:this.saveManager.load().colorAccessibility?.motionSensitivity??N,initialRestReminderEnabled:this.saveManager.load().restReminderSettings?.enabled??Jt,onToggle:b=>this.persistHighContrastSetting(b),onColorVisionSupportModeChange:b=>this.persistColorVisionSupportModeSetting(b),onVibrationIntensityChange:b=>this.persistVibrationIntensitySetting(b),onMotionSensitivityChange:b=>this.persistMotionSensitivitySetting(b),onRestReminderToggle:b=>this.persistRestReminderSetting(b)})},onPressChange:b=>{E.style.transform=b?"scale(0.96)":"scale(1)"}}));const C=document.createElement("button");if(C.textContent=Ot(e.unlockedPlanets.length,W.length),C.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${a?"0.82rem":"1rem"};
      font-weight: 700;
      padding: ${a?"0.45rem 0.55rem":"0.55rem 0.8rem"};
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.encyclopediaBtn=C,this.overlayButtonCleanups.add(M(C,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.openEncyclopedia()},onPressChange:b=>{C.style.transform=b?"scale(0.96)":"scale(1)"}})),r.appendChild(u),r.appendChild(g),r.appendChild(w),m.appendChild(S),m.appendChild(x),i){const b=document.createElement("button");b.setAttribute("data-reset-progress-button",""),b.textContent="さいしょから",b.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: ${a?"0.9rem":"1.05rem"};
        font-weight: 900;
        padding: ${a?"0.55rem 0.65rem":"0.7rem 0.85rem"};
      ...
      pointer-events: auto;
      z-index: 60;
    `,this.overlayEl.style.background="rgba(0, 0, 32, 0.92)";let i=!1;const a=()=>{i||(i=!0,this.hide(),e())},n=()=>{i||(i=!0,this.hide(),t())};this.overlayEl.addEventListener("pointerdown",r=>{r.target===this.overlayEl&&a()});const o=document.createElement("div");o.setAttribute("data-home-confirm-card",""),o.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
    ...
    `,o.appendChild(c);const d=`
      ...
      transition: transform 0.08s ease-out;
      white-space: nowrap;
    `,f=(r,u)=>{const w=M(r,{onActivate:u,onPressChange:g=>{r.style.transform=g?"scale(0.9)":"scale(1)"}});this.activePressCleanups.add(w)},y=document.createElement("button");y.setAttribute("data-home-confirm-back",""),y.setAttribute("aria-label","タイトルへ もどる"),y.textContent="🏠 タイトルへ もどる",y.style.cssText=d,y.style.fontFamily="'Zen Maru Gothic', sans-serif",y.style.background="rgba(255, 255, 255, 0.18)",y.style.color="#ffffff",y.style.minWidth="88px",y.style.minHeight="88px",y.style.touchAction="manipulation",y.style.transform="scale(1)",y.style.transition="transform 0.08s ease-out",y.style.whiteSpace="nowrap",f(y,n),c.appendChild(y);const p=document.createElement("button");p.setAttribute("data-home-confirm-continue",""),p.setAttribute("aria-label","つづける"),p.textContent="✋ つづける",p.style.cssText=d,p.style.fontFamily="'Zen Maru Gothic', sans-serif",p.style.background="linear-gradient(135deg, #FF6B6B, #FFE66D)",p.style.color="#FFD700",p.style.textShadow="0 1px 2px rgba(0, 0, 32, 0.6)",p.style.minWidth="88px",p.style.minHeight="88px",p.style.touchAction="manipulation",p.style.transform="scale(1)",p.style.transition="transform 0.08s ease-out",p.style.whiteSpace="nowrap",f(p,a),c.appendChild(p),s.appendChild(this.overlayEl)}hide(){if(this.overlayEl){const t=Array.from(this.activePressCleanups);this.activePressCleanups.clear();for(const e of t)e();this.overlayEl.remove(),this.overlayEl=null}}isVisible(){return this.overlayEl!==null}}class Yt{overlayEl=null;activePressCleanups=new Set;show(t,e){if(this.overlayEl)return;const s=document.getElementById("ui-overlay")??document.body;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-pause-overlay",""),this.overlayEl.setAttribute("role","dialog"),this.overlayEl.setAttribute("aria-modal","true"),this.overlayEl.setAttribute("aria-label","やすみちゅう"),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
    ...
    `;const i=document.createElement("div");i.setAttribute("data-pause-card",""),i.style.cssText=`
      ...
      text-align: center;
      font-family: 'Zen Maru Gothic', sans-serif;
    `,i.addEventListener("pointerdown",c=>{c.stopPropagation()}),this.overlayEl.appendChild(i);const a=document.createElement("div");a.textContent="ひとやすみ ちゅう",a.style.cssText=`
    ...
    `,i.appendChild(n);const o=document.createElement("div");o.style.cssText=`
      ...
      align-items: stretch;
      width: 100%;
    `,i.appendChild(o);const h=(c,d,f,y,p,r)=>{const u=document.createElement("button");u.setAttribute(d,""),u.setAttribute("aria-label",f),u.textContent=c,u.style.cssText=`
        flex: 1 1 140px;
        padding: 1rem 1.2rem;
        border: none;
        border-radius: 1.6rem;
    ...
    `,document.head.appendChild(t)}}const ds=1,us=.4;class Dt{overlayEl=null;numberEl=null;phase="idle";elapsed=0;currentStep=0;stepDuration;goDuration;onTick;onGo;onComplete=null;steps=["3","2","1"];constructor(t={}){this.stepDuration=t.stepDuration??ds,this.goDuration=t.goDuration??us,this.onTick=t.onTick,this.onGo=t.onGo}show(t){if(this.phase!=="idle"&&this.phase!=="done")return;const e=document.getElementById("ui-overlay")??document.body;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-countdown-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
    ...
    `,document.head.appendChild(t)}getActiveSide(t){return t==="active-left"?"left":t==="active-right"?"right":t==="assist-left"?"left":t==="assist-right"?"right":t==="hidden"?"none":"both"}getGuideEmphasis(t,e){return e==="active-left"?t==="left"?"primary":"secondary":e==="active-right"?t==="right"?"primary":"secondary":e==="assist-left"?t==="left"?"primary":"secondary":e==="assist-right"?t==="right"?"primary":"secondary":e==="hidden"?"hidden":"balanced"}updateInstruction(t){if(!this.instructionEl)return;const e=this.getInstructionMessage(t);this.instructionEl.textContent=e,this.instructionEl.setAttribute("data-touch-guide-message",e)}getInstructionMessage(t){return t==="intro"?"ひだりか みぎを さわると うごけるよ":t==="idle"?"ひつような ときは ひだりか みぎを さわって うごこう":t==="assist-left"?"ひだりへ よけよう":t==="assist-right"?"みぎへ よけよう":""}}class ct{static DEFAULT_DURATION=4.2;static CELEBRATION_DURATION=3.6;element=null;timer=0;message=null;highContrast=!1;showHint(t){this.showMessage(t,ct.DEFAULT_DURATION)}showCelebration(t){this.showMessage(t,ct.CELEBRATION_DURATION)}tick(t){this.timer<=0||(this.timer=Math.max(0,this.timer-t),this.timer===0&&this.hide())}hide(){this.timer=0,this.message=null,this.element&&(this.element.style.display="none",this.element.textContent="",this.element.removeAttribute("data-constellation-message"))}setHighContrastMode(t){this.highContrast=t,this.element&&this.applyElementStyle(this.element)}getMessage(){return this.message}showMessage(t,e){const s=this.ensureElement();this.timer=e,this.message=t,s.textContent=t,s.setAttribute("data-constellation-message",t),s.style.display="flex"}ensureElement(){if(this.element)return this.element;const t=document.getElementById("ui-overlay"),e=document.createElement("div");return e.setAttribute("data-constellation-hint",""),e.setAttribute("aria-live","polite"),this.applyElementStyle(e),e.style.display="none",t?.appendChild(e),this.element=e,e}applyElementStyle(t){t.style.cssText=`
      ...
      z-index: 35;
      box-shadow: 0 10px 24px rgba(0, 0, 0, 0.24);
    `}}const gs=4;class ys{overlayEl=null;cardEl=null;titleEl=null;messageEl=null;elapsed=0;visible=!1;highContrastMode=!1;totalDuration;constructor(t={}){this.totalDuration=t.totalDuration??gs}show(t){const e=document.getElementById("ui-overlay")??document.body;Nt();const s=L().height<=500;(!this.overlayEl||!this.cardEl||!this.titleEl||!this.messageEl)&&(this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-seasonal-event-notice",""),this.overlayEl.style.cssText=`
        position: absolute;
    ...
    `,this.overlayButtonCleanups.add(M(a,{onActivate:()=>{this.inputSystem.resetPointers?.(),this.sceneManager.requestTransition("title")},onPressChange:o=>{a.style.transform=o?"scale(0.96)":"scale(1)"}})),e.append(s,a);const n=document.createElement("div");n.style.cssText=`
      align-self: center;
    ...
    `,n.textContent="← → で ゆったり うちゅうさんぽ",this.overlay.append(e,n),t.appendChild(this.overlay),this.updateStageLabel(),this.updateCompanionBadge()}updateCamera(){if(!this.ship)return;const t=this.ship.mesh.position;this.camera.position.x+=(t.x*.32-this.camera.position.x)*.12,this.camera.position.y=2.8,this.camera.position.z=t.z+12,this.currentLookAt.set(t.x*.18,t.y+.4,t.z-18),this.camera.lookAt(this.currentLookAt)}updatePlanet(t){!this.currentPlanet||!this.ship||(this.currentPlanet.position.set(0,.5,this.ship.mesh.position.z-52),this.currentPlanet.rotation.y+=t*.08,this.currentPlanetSpinTarget?.rotateY(t*.22))}updateStageRotation(t){this.stageTimeRemaining-=t,!(this.stageTimeRemaining>0)&&this.applyStage(this.pickRandomStage(this.currentStageNumber))}applyStage(t){this.currentStageNumber=t,this.currentStageConfig=_(t),this.stageTimeRemaining=this.sampleStageDuration(),this.clearPlanet();const{planet:e,spinTarget:s}=Wt(t,this.currentStageConfig,-52);e.name="free-play-stage-planet",this.currentPlanet=e,this.currentPlanetSpinTarget=s,this.threeScene.add(e),this.stageAtmosphereEffect.start($t(t)),this.effectSystem.setCurrentStage(t),this.updateStageLabel()}clearPlanet(){this.currentPlanet&&(this.currentPlanet.parent?.remove(this.currentPlanet),this.currentPlanet=null,this.currentPlanetSpinTarget=null)}updateStageLabel(){this.stageLabel&&(this.stageLabel.textContent=`${this.currentStageConfig.emoji} ${this.currentStageConfig.destinationReading}の そらで あそんでるよ`)}updateCompanionBadge(){if(!this.companionBadge)return;const t=this.companionManager?.getCount()??0;this.companionBadge.textContent=t>0?`👾 なかま ${t}にん と いっしょ！`:"👾 なかまを あつめると ここに くるよ！"}sampleStageDuration(){return this.stageDurationSeconds*(.8+this.randomProvider()*.4)}pickRandomStage(t){const e=Array.from({length:I},(a,n)=>n+1),s=t===void 0?e:e.filter(a=>a!==t),i=Math.min(s.length-1,Math.floor(this.randomProvider()*s.length));return s[i]}}const Os=Object.freeze(Object.defineProperty({__proto__:null,FreePlayScene:Cs},Symbol.toStringTag,{value:"Module"}));let Y=null,X=null;function ws(){if(!Y){const l=new Ct,t=new Float32Array(3e3);for(let e=0;e<3e3;e++)t[e]=(Math.random()-.5)*200;l.setAttribute("position",new wt(t,3)),Y=l}return Y}function As(){return X||(X=new At({color:16777215,size:.3})),X}function Ts(){Y=null,X=null}const Ms={getBgStarsGeometry:()=>Y,getBgStarsMaterial:()=>X};class O{static CIRCLE_RADIUS=3;static POPIN_DELAY=.2;static POPIN_DURATION=.3;static BOUNCE_SPEED=3;static BOUNCE_HEIGHT=.5;static THANK_YOU_DELAY=2.5;threeScene;camera;lastAspect=0;sceneManager;saveManager;audioManager;overlay=null;muteHandle=null;bgStars=null;companionMeshes=[];companionGroup=null;circleX=[];circleZ=[];popinSettled=[];celebrationElapsed=0;thankYouShown=!1;canExit=!1;exitTriggered=!1;exitCta=null;constructor(t,e,s){this.sceneManager=t,this.saveManager=e,this.audioManager=s,this.threeScene=new Q;const{width:i,height:a}=L();this.camera=new ut(60,i/a,.1,1e3),this.camera.position.set(0,0,5)}enter(t){this.lastAspect=0,this.canExit=!1,this.exitTriggered=!1,this.exitCta=null;const e=t.totalScore??0,s=t.totalStarCount??0;this.threeScene=new Q,this.threeScene.background=new K(48),this.bgStars=new xt(ws(),As()),this.bgStars.userData.sharedAssets=!0,this.bgStars.rotation.set(0,0,0),this.threeScene.add(this.bgStars),this.threeScene.add(new dt(16777215,1));const i=this.saveManager.load();i.clearedStage=0,this.saveManager.save(i),this.audioManager.playBGM(-1),this.setupCelebration(),this.createOverlay(e,s),this.createMuteButton()}createMuteButton(){const t=document.getElementById("hud")??document.getElementById("ui-overlay");t&&(this.muteHandle=Mt({initialMuted:this.audioManager.isMuted(),container:t,onToggle:()=>{const e=this.audioManager.toggleMute();this.muteHandle?.setMuted(e);const s=this.saveManager.load();s.muted=e,this.saveManager.save(s)}}))}createOverlay(t,e){const s=document.getElementById("ui-overlay");if(!s)return;this.overlay=document.createElement("div"),this.overlay.setAttribute("data-ending-overlay",""),this.overlay.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      justify-content: center;
    ...
    `,this.overlay.appendChild(i),this.overlay.appendChild(a),this.overlay.appendChild(n),this.overlay.appendChild(this.exitCta),s.appendChild(this.overlay)}update(t){this.bgStars&&(this.bgStars.rotation.y+=t*.03),this.updateCelebration(t)}setupCelebration(){this.companionGroup=new ot,this.companionMeshes=[],this.circleX.length=0,this.circleZ.length=0,this.popinSettled.length=0,this.celebrationElapsed=0,this.thankYouShown=!1,this.canExit=!1,this.exitTriggered=!1;for(let t=0;t<W.length;t++){const e=W[t],s=St.createCompanionMesh(e),i=t*(2*Math.PI/W.length),a=Math.cos(i)*O.CIRCLE_RADIUS,n=Math.sin(i)*O.CIRCLE_RADIUS;this.circleX.push(a),this.circleZ.push(n),s.position.set(a,0,n),s.scale.set(0,0,0),this.companionMeshes.push(s),this.popinSettled.push(!1),this.companionGroup.add(s)}this.threeScene.add(this.companionGroup)}updateCelebration(t){if(this.companionMeshes.length===0)return;this.celebrationElapsed+=t;const e=O.POPIN_DELAY*(this.companionMeshes.length-1)+O.POPIN_DURATION,s=this.celebrationElapsed>e,i=s?Math.abs(Math.sin(this.celebrationElapsed*O.BOUNCE_SPEED))*O.BOUNCE_HEIGHT:0;for(let a=0;a<this.companionMeshes.length;a++){const n=this.companionMeshes[a];if(this.popinSettled[a]){s&&(n.position.y=i),n.rotation.y+=t*2;continue}const o=a*O.POPIN_DELAY;if(!(this.celebrationElapsed<o)){if(this.celebrationElapsed<o+O.POPIN_DURATION){const h=(this.celebrationElapsed-o)/O.POPIN_DURATION,c=this.bounceEase(h);n.scale.set(c,c,c)}else n.scale.set(1,1,1),this.popinSettled[a]=!0;s&&(n.position.y=i),n.rotation.y+=t*2}}!this.thankYouShown&&this.celebrationElapsed>=O.THANK_YOU_DELAY&&(this.showThankYouText(),this.thankYouShown=!0)}bounceEase(t){return t<.6?t/.6*1.2:1.2-(t-.6)/.4*.2}showThankYouText(){if(!this.overlay||!this.exitCta)return;const t=document.createElement("div");t.setAttribute("data-ending-thank-you",""),t.textContent="みんな ありがとう！",t.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: 2rem;
      font-weight: 900;
      color: #FFD700;
