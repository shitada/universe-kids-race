const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-DOS84wQg.js","assets/game-core-CXvkNj1F.js","assets/three-CCkbs3tE.js"])))=>i.map(i=>d[i]);
import{g as K,D as ft,S as N,T as R,a as Y,b as Rt,L as $t,c as jt,_ as mt,d as L,e as F,s as Dt,f as tt,P as j,u as Ht,C as Wt,h as Ut,i as Zt,B as qt,j as Yt,M as Vt,k as Xt,l as Qt,m as Kt,n as Jt,o as te,p as ee,q as se,r as ie,t as ae,v as ne,W as oe,A as re,w as le,x as he,y as ce,z as Lt,E as de,F as ue,R as me,G as pe,H as fe,I as ge,J as ye,K as Tt,N as be,O as ve,Q as rt,U as J,V as Ee,X as lt,Y as ht,Z as Se,$ as we,a0 as xe}from"./game-core-CXvkNj1F.js";import{m as gt,k as yt,i as bt,l as vt,G as et,q as Ce,a as Ae,r as Te,M,g as D,D as Mt,R as Pt,s as H,t as Et,u as st,h as St,P as wt,V as $,v as Me,w as Pe}from"./three-CCkbs3tE.js";class xt{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const e=document.getElementById("ui-overlay");if(!e)return;const s=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
