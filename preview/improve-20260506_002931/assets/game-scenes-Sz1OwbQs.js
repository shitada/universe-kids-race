const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-BfamyCwy.js","assets/game-core-CLcuM7Mh.js","assets/three-BsQe5WE2.js"])))=>i.map(i=>d[i]);
import{D as mt,i as A,g as Ct,a as Rt,S as J,T as z,b as K,c as ee,L as fe,d as ye,_ as kt,e as H,f as X,h as j,s as ie,j as pt,k as se,l as be,P as st,u as ae,C as ve,m as Se,n as Ee,B as xe,o as Ce,M as we,p as Te,q as Ae,r as Me,t as Pe,v as ke,w as Be,x as Re,y as Oe,z as Ie,A as De,E as Le,F as Ge,G as Fe,H as ze,I as He,J as ne,W as Ne,K as _e,N as $e,O as Ve,Q as Ue,R as je,U as oe,V as We,X as Ot,Y as Ye,Z as Ze,$ as Xe,a0 as qe,a1 as Qe,a2 as Ke,a3 as Je,a4 as _t,a5 as re,a6 as ti,a7 as gt,a8 as Y,a9 as ei,aa as wt,ab as ii,ac as si,ad as ai,ae as Tt,af as ni,ag as oi,ah as ri,ai as li,aj as ci}from"./game-core-CLcuM7Mh.js";import{n as It,l as Dt,j as Lt,m as Gt,G as at,r as hi,a as ui,s as di,M as D,h as _,C as $t,B as Vt,D as Ut,R as jt,t as N,u as St,v as ct,i as ht,P as Et,V as W,w as le,x as mi}from"./three-BsQe5WE2.js";class Ft{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const e=document.getElementById("ui-overlay");if(!e)return;const i=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
    ...
    `,b=(d,S)=>{let x=!1,T=!1;const y=()=>{k(!0)},p=()=>{d.style.transform="scale(0.92)"},M=()=>{d.style.transform="scale(1)"},k=(h=!1)=>{x=!1,T=h,M(),this.activePressCleanups.delete(y),document.removeEventListener("pointerup",C,!0),document.removeEventListener("pointercancel",w,!0)},C=h=>{const E=h.target===d||h.target instanceof Node&&d.contains(h.target),P=x&&E;k(!E),P&&S()},w=()=>{k(!0)};d.addEventListener("pointerdown",h=>{h.stopPropagation(),x=!0,T=!1,p(),this.activePressCleanups.add(y),document.addEventListener("pointerup",C,!0),document.addEventListener("pointercancel",w,!0)}),d.addEventListener("pointerenter",()=>{x&&p()}),d.addEventListener("pointerleave",()=>{x&&M()}),d.addEventListener("pointercancel",()=>k(!0)),d.addEventListener("click",h=>{if(h.stopPropagation(),T){T=!1;return}x||S()})},g=document.createElement("button");g.setAttribute("data-title-reset-cancel",""),g.textContent="やめる",g.style.cssText=f,g.style.background="rgba(255, 255, 255, 0.18)",g.style.color="#ffffff",b(g,a),m.appendChild(g);const r=document.createElement("button");r.setAttribute("data-title-reset-confirm",""),r.textContent="うん！ さいしょから",r.style.cssText=f,r.style.background="linear-gradient(135deg, #FF9F68, #FFE66D)",r.style.color="#3b1f00",b(r,n),m.appendChild(r),i.appendChild(this.overlayEl)}hide(){if(!this.overlayEl)return;const t=Array.from(this.activePressCleanups);this.activePressCleanups.clear();for(const e of t)e();this.overlayEl.remove(),this.overlayEl=null}}function zt(l){const t=l.topRem??.8,e=window.innerHeight<=500,i=document.createElement("button");let s=l.initialMuted;const a=()=>{i.textContent=s?"🔇":"🔊",i.setAttribute("aria-label",s?"サウンド オフ":"サウンド オン")};i.setAttribute("data-mute-button",""),i.style.position="absolute",i.style.top=`${t}rem`,i.style.right="1rem",i.style.fontSize=e?"clamp(1.1rem, 3.5vmin, 1.4rem)":"clamp(1.4rem, 4vmin, 1.8rem)",i.style.background="rgba(255, 255, 255, 0.15)",i.style.border="none",i.style.borderRadius="50%",i.style.width=e?"2.4rem":"3rem",i.style.height=e?"2.4rem":"3rem",i.style.display="flex",i.style.alignItems="center",i.style.justifyContent="center",i.style.cursor="pointer",i.style.pointerEvents="auto",i.style.touchAction="manipulation",i.style.transform="scale(1)",i.style.transition="transform 0.08s ease-out",a();const n=()=>{i.style.transform="scale(1)"};return i.addEventListener("pointerdown",o=>{o.stopPropagation(),i.style.transform="scale(0.9)",l.onToggle()}),i.addEventListener("pointerup",n),i.addEventListener("pointercancel",n),i.addEventListener("pointerleave",n),l.container.appendChild(i),{element:i,setMuted(o){s=o,a()},remove(){i.remove()}}}const ft=[{value:0,labelKey:"colorSettings.audio.volume.quiet"},{value:25,labelKey:"colorSettings.audio.volume.small"},{value:50,labelKey:"colorSettings.audio.volume.normal"},{value:75,labelKey:"colorSettings.audio.volume.loud"},{value:100,labelKey:"colorSettings.audio.volume.max"}],Wt=[{value:"color-only",labelKey:"colorSettings.colorVision.option.colorOnly",icon:"🎨"},{value:"color-and-marks",labelKey:"colorSettings.colorVision.option.colorAndMarks",icon:"★"}],Yt=[{value:"strong",labelKey:"colorSettings.visualFeedback.option.strong"},{value:"medium",labelKey:"colorSettings.visualFeedback.option.medium"},{value:"weak",labelKey:"colorSettings.visualFeedback.option.weak"},{value:"off",labelKey:"colorSettings.visualFeedback.option.off"}],Zt=[{value:"ja",labelKey:"colorSettings.language.option.ja",icon:"🇯🇵"},{value:"en",labelKey:"colorSettings.language.option.en",icon:"🇬🇧"}],Xt={strong:{shortLabel:"colorSettings.motion.option.strong.shortLabel",description:"colorSettings.motion.option.strong.description"},medium:{shortLabel:"colorSettings.motion.option.medium.shortLabel",description:"colorSettings.motion.option.medium.description"},gentle:{shortLabel:"colorSettings.motion.option.gentle.shortLabel",description:"colorSettings.motion.option.gentle.description"},minimal:{shortLabel:"colorSettings.motion.option.minimal.shortLabel",description:"colorSettings.motion.option.minimal.description"}};function qt(l){const t=ft.find(e=>e.value===l)??ft[2];return A.t(t.labelKey)}class gi{overlay=null;toggleButton=null;descriptionEl=null;highContrast=!1;colorVisionSupportMode="color-only";bgmVolume=100;sfxVolume=100;visualFeedbackIntensity="medium";motionSensitivity="strong";restReminderEnabled=!0;language=mt;bgmVolumeDescriptionEl=null;sfxVolumeDescriptionEl=null;bgmVolumeSlider=null;sfxVolumeSlider=null;colorVisionDescriptionEl=null;colorVisionButtons=new Map;visualFeedbackDescriptionEl=null;visualFeedbackButtons=new Map;motionDescriptionEl=null;motionButtons=new Map;restReminderDescriptionEl=null;restReminderToggleButton=null;motionPreviewEl=null;motionPreviewTokenEl=null;motionPreviewCaptionEl=null;languageDescriptionEl=null;languageButtons=new Map;motionPreviewTimeoutId=null;motionPreviewFrameId=null;onToggle=null;onColorVisionSupportModeChange=null;onBGMVolumeChange=null;onSFXVolumeChange=null;onVisualEffectIntensityChange=null;onMotionSensitivityChange=null;onRestReminderToggle=null;onLanguageChange=null;languageUnsubscribe=null;show(t){const e=document.getElementById("ui-overlay");if(e){if(this.highContrast=t.initialHighContrast,this.colorVisionSupportMode=t.initialColorVisionSupportMode,this.bgmVolume=t.initialBGMVolume,this.sfxVolume=t.initialSFXVolume,this.visualFeedbackIntensity=t.initialVisualEffectIntensity,this.motionSensitivity=t.initialMotionSensitivity,this.restReminderEnabled=t.initialRestReminderEnabled,this.language=t.initialLanguage,this.onToggle=t.onToggle,this.onColorVisionSupportModeChange=t.onColorVisionSupportModeChange,this.onBGMVolumeChange=t.onBGMVolumeChange,this.onSFXVolumeChange=t.onSFXVolumeChange,this.onVisualEffectIntensityChange=t.onVisualEffectIntensityChange,this.onMotionSensitivityChange=t.onMotionSensitivityChange,this.onRestReminderToggle=t.onRestReminderToggle,this.onLanguageChange=t.onLanguageChange,A.setLanguage(this.language,{notify:!1}),this.languageUnsubscribe?.(),this.languageUnsubscribe=A.subscribe(i=>{this.language=i,this.render()}),!this.overlay){const i=window.innerHeight<=760;this.overlay=document.createElement("div"),this.overlay.setAttribute("data-color-accessibility-settings",""),this.overlay.style.cssText=`
      ...
      `;for(const h of Zt){const E=document.createElement("button");E.setAttribute("data-language-button",h.value),E.style.cssText=`
          min-height: 3.25rem;
      ...
      `;for(const h of Wt){const E=document.createElement("button");E.setAttribute("data-color-vision-mode-button",h.value),E.style.cssText=`
        ...
        gap: 0.65rem;
        margin-bottom: 0.95rem;
      `;for(const h of Yt){const E=document.createElement("button");E.setAttribute("data-visual-feedback-intensity-button",h.value),E.style.cssText=`
          min-height: 3.25rem;
          padding: 0.8rem 0.9rem;
          border-radius: 1rem;
          border: 2px solid rgba(255, 255, 255, 0.4);
  ...
  `,n.appendChild(u),n}const Kt=2e3,yt=new Map,bt=new Map,vt=new Map;let ut=null,dt=null;function et(l,t){if(typeof document>"u"){const i=typeof OffscreenCanvas=="function",s=i?new OffscreenCanvas(l,t):{width:l,height:t};return{canvas:s,ctx:i?s.getContext("2d"):null}}const e=document.createElement("canvas");return e.width=l,e.height=t,{canvas:e,ctx:e.getContext("2d")}}function tt(l,t){let e=yt.get(l);return e||(e=t(),e.generateMipmaps=!1,e.minFilter=di,e.needsUpdate=!0,yt.set(l,e)),e}function O(l,t){let e=bt.get(l);return e||(e=t(),bt.set(l,e)),e}function L(l,t){let e=vt.get(l);return e||(e=t(),vt.set(l,e)),e}function B(l,t){const e=new ui(l,t);return e.userData.sharedAssets=!0,e}function ce(){if(!ut){const l=new Dt,t=new Float32Array(Kt*3);for(let e=0;e<Kt*3;e+=3)t[e]=(Math.random()-.5)*200,t[e+1]=(Math.random()-.5)*200,t[e+2]=(Math.random()-.5)*400;l.setAttribute("position",new Lt(t,3)),ut=l}dt||(dt=new Gt({color:16777215,size:.2,sizeAttenuation:!0}))}function Ei(){const{canvas:l,ctx:t}=et(256,256);if(!t)return new N(l);t.fillStyle="#888888",t.fillRect(0,0,256,256);for(let e=0;e<30;e++){const i=Math.random()*256,s=Math.random()*256,a=3+Math.random()*12;t.beginPath(),t.arc(i,s,a,0,Math.PI*2),t.fillStyle=`rgba(60,60,60,${.3+Math.random()*.4})`,t.fill()}return new N(l)}function xi(){const{canvas:l,ctx:t}=et(256,256);if(!t)return new N(l);t.fillStyle="#ddaa44",t.fillRect(0,0,256,256);for(let e=0;e<8;e++){t.beginPath();const i=128+(Math.random()-.5)*100,s=128+(Math.random()-.5)*100;t.strokeStyle=`rgba(200,150,60,${.3+Math.random()*.3})`,t.lineWidth=3+Math.random()*5;for(let a=0;a<Math.PI*4;a+=.1){const n=10+a*8;t.lineTo(i+Math.cos(a)*n,s+Math.sin(a)*n)}t.stroke()}return new N(l)}function Ci(){const{canvas:l,ctx:t}=et(256,256);if(!t)return new N(l);const e=["#cc7733","#dd9955","#bb6622","#eebb77","#aa5511","#ddaa66"];for(let i=0;i<256;i++){const s=Math.floor(i/(256/e.length))%e.length;t.fillStyle=e[s],t.fillRect(0,i,256,1)}return new N(l)}function wi(){const{canvas:l,ctx:t}=et(512,256);return t?(t.fillStyle="#2266aa",t.fillRect(0,0,512,256),t.fillStyle="#886644",t.beginPath(),t.ellipse(300,80,80,40,.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(280,150,30,50,.1,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(100,90,25,60,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(110,170,20,40,-.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(420,170,25,15,0,0,Math.PI*2),t.fill(),t.fillStyle="#447733",t.beginPath(),t.ellipse(290,75,40,20,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(95,85,15,30,.2,0,Math.PI*2),t.fill(),new N(l)):new N(l)}function Ti(){const{canvas:l,ctx:t}=et(512,256);if(!t)return new N(l);t.clearRect(0,0,512,256),t.fillStyle="rgba(255,255,255,0.6)";for(let e=0;e<20;e++){const i=Math.random()*512,s=Math.random()*256;t.beginPath(),t.ellipse(i,s,20+Math.random()*40,8+Math.random()*15,Math.random()*Math.PI,0,Math.PI*2),t.fill()}return new N(l)}function Ai(){const{canvas:l,ctx:t}=et(256,128);if(!t)return new N(l);t.fillStyle="#d7dde8",t.fillRect(0,0,256,128),t.fillStyle="#8bbcff",t.fillRect(0,0,256,28),t.fillStyle="#90a4bf";for(let e=0;e<256;e+=24)t.fillRect(e,40,4,88);t.fillStyle="#4a6c9a";for(let e=44;e<128;e+=16)t.fillRect(0,e,256,6);return new N(l)}function Mi(){yt.clear(),bt.clear(),vt.clear(),ut=null,dt=null}const Pi={planetTextureCache:yt,planetGeometryCache:bt,planetMaterialCache:vt,getBgStarsGeometry:()=>ut,getBgStarsMaterial:()=>dt};function he(l,t,e){const i=new at;let s=null;switch(l){case 2:{const a=tt("mercury",Ei),n=O("mercury:sphere",()=>new _(10,24,24)),o=L("mercury:mat",()=>new D({map:a})),c=B(n,o);i.add(c),s=c;break}case 3:{const a=tt("venus",xi),n=O("venus:sphere",()=>new _(14,24,24)),o=L("venus:mat",()=>new D({map:a})),c=B(n,o);i.add(c),s=c;break}case 5:{const a=tt("jupiter",Ci),n=O("jupiter:sphere",()=>new _(20,24,24)),o=L("jupiter:mat",()=>new D({map:a})),c=B(n,o);i.add(c),s=c;break}case 6:{const a=O("saturn:sphere",()=>new _(15,24,24)),n=t.planetColor,o=L(`saturn:mat:${n}`,()=>new D({color:n})),c=B(a,o);i.add(c);const u=O("saturn:ring",()=>new jt(20,30,48)),m=L("saturn:ringMat",()=>new D({color:15645542,side:Ut})),f=B(u,m);f.rotation.x=Math.PI/3,i.add(f),s=c;break}case 7:{const a=O("uranus:sphere",()=>new _(16,24,24)),n=L("uranus:mat",()=>new D({color:6737117})),o=B(a,n);i.add(o);const c=O("uranus:ring",()=>new jt(21,28,48)),u=L("uranus:ringMat",()=>new D({color:10083822,side:Ut})),m=B(c,u);m.rotation.z=Math.PI/2,i.add(m),s=o;break}case 9:{const a=O("pluto:sphere",()=>new _(8,24,24)),n=L("pluto:mat",()=>new D({color:12298922})),o=B(a,n);i.add(o),s=o;break}case 10:{const a=O("sun:sphere",()=>new _(25,24,24)),n=L("sun:mat",()=>new D({color:16763904,emissive:16755200,emissiveIntensity:.5})),o=B(a,n);i.add(o),i.add(new hi(16763904,2,200)),s=o;break}case 11:{const a=tt("station:panel",Ai),n=O("station:core",()=>new $t(3.2,3.2,12,12)),o=O("station:module",()=>new $t(1.7,1.7,6,10)),c=O("station:truss",()=>new Vt(18,.9,.9)),u=O("station:panelGeo",()=>new Vt(8,3.6,.18)),m=O("station:dish",()=>new _(1.4,12,12,0,Math.PI)),f=L("station:metal",()=>new D({color:14213354})),b=L("station:moduleMat",()=>new D({color:11057099})),g=L("station:panelMat",()=>new D({map:a,color:16777215})),r=new at,d=B(n,f);d.rotation.z=Math.PI/2,r.add(d);const S=B(c,b);r.add(S);const x=B(o,b);x.position.x=-6,x.rotation.z=Math.PI/2,r.add(x);const T=B(o,b);T.position.x=6,T.rotation.z=Math.PI/2,r.add(T);const y=B(u,g);y.position.set(-11,0,0),r.add(y);const p=B(u,g);p.position.set(11,0,0),r.add(p);const M=B(m,f);M.position.set(0,3.2,0),M.rotation.x=-Math.PI/2,r.add(M),i.add(r),s=r;break}case 12:{const a=tt("earth",wi),n=O("earth:sphere",()=>new _(15,32,32)),o=L("earth:mat",()=>new D({map:a})),c=tt("earth:cloud",Ti),u=O("earth:cloudSphere",()=>new _(15.5,32,32)),m=L("earth:cloudMat",()=>new D({map:c,transparent:!0,opacity:.3})),f=new at;f.add(B(n,o)),f.add(B(u,m)),i.add(f),s=f;break}default:{const a=O("default:sphere",()=>new _(15,24,24)),n=t.planetColor,o=L(`default:mat:${n}`,()=>new D({color:n})),c=B(a,o);i.add(c),s=c;break}}return i.position.set(0,0,e),{planet:i,spinTarget:s}}function ue(l,t,e){return he(l,t,e)}function de(l){ce();const t=new It(ut,dt);return t.userData.sharedAssets=!0,t.geometry.setDrawRange(0,l),t}function Ht(l){!Number.isInteger(l)||l<1||l>z||typeof document>"u"&&typeof OffscreenCanvas!="function"||(ce(),he(l,K(l),0))}let nt=null,ot=null;function ki(){if(!nt){const l=new Dt,t=new Float32Array(3e3);for(let e=0;e<3e3;e++)t[e]=(Math.random()-.5)*200;l.setAttribute("position",new Lt(t,3)),nt=l}return nt}function Bi(){return ot||(ot=new Gt({color:16777215,size:.3,sizeAttenuation:!0})),ot}function Ri(){nt=null,ot=null}const Oi={getBgStarsGeometry:()=>nt,getBgStarsMaterial:()=>ot};function Ii(l){const t=window.requestIdleCallback;if(typeof t=="function"){t(l,{timeout:1500});return}window.setTimeout(l,800)}function me(l){return new Set(l.filter(t=>Number.isInteger(t)&&t>=1&&t<=z)).size}function Di(l){return me(l)>=z}function At(l){const t=Di(l.unlockedPlanets),e=t?1:Math.min(l.clearedStage+1,z),i=K(e),s=l.bestStageStars?.[e]??0,a=l.colorAccessibility?.colorVisionSupportMode??j,n=se(e,i.destinationReading,a);return t?{startStage:e,destination:n,emoji:i.emoji,statusLabel:"ぜんぶ あつめたよ！",destinationLabel:`${n}へ もういちど しゅっぱつ！`,buttonHint:`${i.emoji} ステージ ${e} から もういちど あそぶ`,bestStars:s}:{startStage:e,destination:n,emoji:i.emoji,statusLabel:l.clearedStage>0?"つづきから しゅっぱつ！":"はじめての しゅっぱつ！",destinationLabel:`${n}へ むかおう！`,buttonHint:`${i.emoji} ステージ ${e} から スタート`,bestStars:s}}function Li(l){return l.clearedStage>0||me(l.unlockedPlanets)>0||Object.keys(l.bestStageStars??{}).length>0}class Gi{threeScene;ambientLight=new St(16777215,1);camera;lastAspect=0;sceneManager;saveManager;audioManager;stars=null;companionParade=null;overlay=null;muteHandle=null;tutorialOverlay=new Ft;titleResetConfirmOverlay=new pi;colorAccessibilitySettings=new gi;spaceshipCustomizer=new fi;statsOverlay=new vi;encyclopediaOverlay=null;encyclopediaOverlayPromise=null;companionFactory=null;companionFactoryPromise=null;loadEncyclopediaOverlay;loadTitleCompanionFactory;loadingOverlay;loadFailureOverlay;scheduleIdleTask;encyclopediaBtn=null;isOpeningEncyclopedia=!1;isActive=!1;touchFeedbackOverlay=new Q;encyclopediaRequestToken=0;companionParadeRequestToken=0;bgmPending=!1;overlayButtonCleanups=new Set;colorSettingsButton=null;unsubscribeLanguageChange=null;constructor(t,e,i,s={}){this.sceneManager=t,this.saveManager=e,this.audioManager=i,this.loadingOverlay=s.loadingOverlay??new fe,this.loadFailureOverlay=s.loadFailureOverlay??new ye,this.scheduleIdleTask=s.scheduleIdleTask??Ii,this.loadEncyclopediaOverlay=s.loadEncyclopediaOverlay??(()=>kt(()=>import("./EncyclopediaOverlay-BfamyCwy.js"),__vite__mapDeps([0,1,2]))),this.loadTitleCompanionFactory=s.loadTitleCompanionFactory??(()=>kt(()=>import("./game-core-CLcuM7Mh.js").then(o=>o.at),__vite__mapDeps([1,2]))),this.threeScene=new ct,this.threeScene.background=new ht(32);const{width:a,height:n}=H();this.camera=new Et(60,a/n,.1,1e3),this.camera.position.set(0,0,5)}enter(t){this.isActive=!0,this.encyclopediaRequestToken+=1,this.companionParadeRequestToken+=1,this.lastAspect=0,this.stars=new It(ki(),Bi()),this.stars.userData.sharedAssets=!0,this.stars.rotation.set(0,0,0),this.threeScene.add(this.stars),this.ambientLight.parent||this.threeScene.add(this.ambientLight);const e=this.saveManager.load();A.setLanguage(e.language??mt,{notify:!1}),this.createCompanionParade(e.unlockedPlanets),this.createOverlay(),this.createMuteButton(),this.touchFeedbackOverlay.setMotionSensitivity(e.colorAccessibility?.motionSensitivity??X()),this.touchFeedbackOverlay.attach(),this.touchFeedbackOverlay.bindUiRoots([document.getElementById("hud"),document.getElementById("ui-overlay")]),this.prefetchEncyclopediaOnIdle(),this.prewarmNextAdventureOnIdle(At(e).startStage),this.audioManager.isInitialized()?(this.audioManager.playBGM(0),this.bgmPending=!1):this.bgmPending=!0,e.tutorialShown||this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide(),this.saveManager.markTutorialShown()})}createMuteButton(){const t=document.getElementById("hud")??document.getElementById("ui-overlay");t&&(this.muteHandle=zt({initialMuted:this.audioManager.isMuted(),container:t,onToggle:()=>{this.ensureTitleAudioInitialized(!0);const e=this.audioManager.toggleMute();this.muteHandle?.setMuted(e);const i=this.saveManager.load();i.muted=e,this.saveManager.save(i)}}))}getEncyclopediaOverlay(){return this.encyclopediaOverlay?Promise.resolve(this.encyclopediaOverlay):this.encyclopediaOverlayPromise?this.encyclopediaOverlayPromise:(this.encyclopediaOverlayPromise=this.loadEncyclopediaOverlay().then(({EncyclopediaOverlay:t})=>{const e=new t;return this.encyclopediaOverlay=e,e}).finally(()=>{this.encyclopediaOverlayPromise=null}),this.encyclopediaOverlayPromise)}getTitleCompanionFactory(){return this.companionFactory?Promise.resolve(this.companionFactory):this.companionFactoryPromise?this.companionFactoryPromise:(this.companionFactoryPromise=this.loadTitleCompanionFactory().then(t=>(this.companionFactory=t,t)).finally(()=>{this.companionFactoryPromise=null}),this.companionFactoryPromise)}showEncyclopedia(){if(!this.isActive||!this.encyclopediaOverlay)return;const t=this.saveManager.load();this.encyclopediaOverlay.show(t.unlockedPlanets,()=>this.refreshEncyclopediaButtonLabel(),e=>{this.ensureTitleAudioInitialized(!1),this.sceneManager.requestTransition("stage",{stageNumber:e,totalScore:0,totalStarCount:0,launchSource:"encyclopedia"})},t.bestStageStars??{},t.discoveredConstellations??[],t.colorAccessibility?.colorVisionSupportMode??j,t.discoveredMonthlyEncounters??[],t.discoveredSpaceGems??[])}isCurrentEncyclopediaRequest(t){return this.isActive&&this.encyclopediaRequestToken===t}prefetchEncyclopediaOnIdle(){const t=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{!this.isCurrentEncyclopediaRequest(t)||this.encyclopediaOverlay||this.encyclopediaOverlayPromise||this.getEncyclopediaOverlay().catch(()=>{})})}prewarmNextAdventureOnIdle(t){if(t>z)return;const e=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{this.isCurrentEncyclopediaRequest(e)&&Ht(t)})}async openEncyclopedia(){if(!this.isActive)return;if(this.loadFailureOverlay.hide(),this.encyclopediaOverlay){this.showEncyclopedia();return}if(this.isOpeningEncyclopedia)return;const t=this.encyclopediaRequestToken;this.isOpeningEncyclopedia=!0,this.loadingOverlay.show("ずかんを よんでるよ...");try{if(await this.getEncyclopediaOverlay(),!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),this.showEncyclopedia()}catch(e){if(!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),console.error("Failed to load encyclopedia overlay",e),this.loadFailureOverlay.show({title:"ずかんを もういちど よんでみよう！",message:"「もういちど よむ」を おして つづきを たのしもう！",primaryAction:{label:"もういちど よむ",onSelect:()=>this.openEncyclopedia()}})}finally{this.encyclopediaRequestToken===t&&(this.isOpeningEncyclopedia=!1)}}persistHighContrastSetting(t){const e=this.saveManager.load(),i=e.colorAccessibility?.motionSensitivity??X(),s=e.colorAccessibility?.colorVisionSupportMode??j;e.colorAccessibility=this.buildColorAccessibilitySettings(t,i,s),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}persistVisualFeedbackIntensitySetting(t){const e=this.saveManager.load();e.visualFeedbackSettings={intensity:t},this.saveManager.save(e),ie(t)}persistRestReminderSetting(t){const e=this.saveManager.load();e.restReminderSettings={enabled:t},this.saveManager.save(e)}persistLanguageSetting(t){const e=this.saveManager.load();t===mt?delete e.language:e.language=t,this.saveManager.save(e)}persistBGMVolumeSetting(t){const e=this.saveManager.load();e.audioSettings=this.buildAudioSettings(t,e.audioSettings?.sfxVolume??100),e.audioSettings||delete e.audioSettings,this.saveManager.save(e),this.audioManager.setBGMVolume(t)}persistSFXVolumeSetting(t){const e=this.saveManager.load();e.audioSettings=this.buildAudioSettings(e.audioSettings?.bgmVolume??100,t),e.audioSettings||delete e.audioSettings,this.saveManager.save(e),this.audioManager.setSFXVolume(t)}persistMotionSensitivitySetting(t){const e=this.saveManager.load(),i=e.colorAccessibility?.highContrast===!0,s=e.colorAccessibility?.colorVisionSupportMode??j;e.colorAccessibility=this.buildColorAccessibilitySettings(i,t,s),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}persistColorVisionSupportModeSetting(t){const e=this.saveManager.load(),i=e.colorAccessibility?.highContrast===!0,s=e.colorAccessibility?.motionSensitivity??X();e.colorAccessibility=this.buildColorAccessibilitySettings(i,s,t),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}buildColorAccessibilitySettings(t,e,i){const s=X();if(!(!t&&e===s&&i===j))return{...t?{highContrast:!0}:{},...e!==s?{motionSensitivity:e}:{},...i!==j?{colorVisionSupportMode:i}:{}}}buildAudioSettings(t,e){if(!(t===100&&e===100))return{...t!==100?{bgmVolume:t}:{},...e!==100?{sfxVolume:e}:{}}}createOverlay(){const t=document.getElementById("ui-overlay");if(!t)return;const e=this.saveManager.load(),i=At(e),s=Li(e);this.overlay=document.createElement("div"),this.unsubscribeLanguageChange?.(),this.unsubscribeLanguageChange=A.subscribe(()=>this.applyLocalizedText()),this.overlay.style.cssText=`
    ...
    `,document.head.appendChild(t)}}const Ni=1,_i=.4;class Jt{overlayEl=null;numberEl=null;phase="idle";elapsed=0;currentStep=0;stepDuration;goDuration;onTick;onGo;onComplete=null;steps=["3","2","1"];constructor(t={}){this.stepDuration=t.stepDuration??Ni,this.goDuration=t.goDuration??_i,this.onTick=t.onTick,this.onGo=t.onGo}show(t){if(this.phase!=="idle"&&this.phase!=="done")return;const e=document.getElementById("ui-overlay")??document.body;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-countdown-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
