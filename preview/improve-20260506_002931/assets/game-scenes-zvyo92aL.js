const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-Dlvg-QfK.js","assets/game-core-DAq5R5A_.js","assets/three-BsQe5WE2.js"])))=>i.map(i=>d[i]);
import{D as ut,i as C,g as Ct,a as Rt,S as Q,T as z,b as X,c as Jt,L as pe,d as ge,_ as Pt,e as H,f as W,h as $,s as te,j as dt,k as ee,l as fe,P as et,u as ie,C as ye,m as be,n as ve,B as Se,o as Ee,M as xe,p as Ce,q as we,r as Te,t as Ae,v as Me,w as Be,x as Pe,y as ke,z as Re,A as Oe,E as Ie,F as De,G as Le,H as Ge,I as se,W as ze,J as He,K as Ne,N as _e,O as ae,Q as Fe,R as Ot,U as $e,V as Ve,X as Ue,Y as je,Z as We,$ as Ze,a0 as Ye,a1 as Ft,a2 as ne,a3 as qe,a4 as mt,a5 as K,a6 as Xe,a7 as wt,a8 as Qe,a9 as Tt,aa as Ke,ab as Je,ac as ti,ad as ei,ae as ii}from"./game-core-DAq5R5A_.js";import{n as It,l as Dt,j as Lt,m as Gt,G as pt,r as si,a as ai,s as ni,M as O,h as N,D as $t,R as Vt,t as _,u as St,v as ot,i as rt,P as Et,V as Z,w as oe,x as oi}from"./three-BsQe5WE2.js";class zt{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const e=document.getElementById("ui-overlay");if(!e)return;const i=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
    ...
    `,b=(d,w)=>{let y=!1,p=!1;const A=()=>{M(!0)},T=()=>{d.style.transform="scale(0.92)"},k=()=>{d.style.transform="scale(1)"},M=(c=!1)=>{y=!1,p=c,k(),this.activePressCleanups.delete(A),document.removeEventListener("pointerup",S,!0),document.removeEventListener("pointercancel",x,!0)},S=c=>{const E=c.target===d||c.target instanceof Node&&d.contains(c.target),P=y&&E;M(!E),P&&w()},x=()=>{M(!0)};d.addEventListener("pointerdown",c=>{c.stopPropagation(),y=!0,p=!1,T(),this.activePressCleanups.add(A),document.addEventListener("pointerup",S,!0),document.addEventListener("pointercancel",x,!0)}),d.addEventListener("pointerenter",()=>{y&&T()}),d.addEventListener("pointerleave",()=>{y&&k()}),d.addEventListener("pointercancel",()=>M(!0)),d.addEventListener("click",c=>{if(c.stopPropagation(),p){p=!1;return}y||w()})},g=document.createElement("button");g.setAttribute("data-title-reset-cancel",""),g.textContent="やめる",g.style.cssText=f,g.style.background="rgba(255, 255, 255, 0.18)",g.style.color="#ffffff",b(g,a),m.appendChild(g);const r=document.createElement("button");r.setAttribute("data-title-reset-confirm",""),r.textContent="うん！ さいしょから",r.style.cssText=f,r.style.background="linear-gradient(135deg, #FF9F68, #FFE66D)",r.style.color="#3b1f00",b(r,n),m.appendChild(r),i.appendChild(this.overlayEl)}hide(){if(!this.overlayEl)return;const t=Array.from(this.activePressCleanups);this.activePressCleanups.clear();for(const e of t)e();this.overlayEl.remove(),this.overlayEl=null}}function Ht(l){const t=l.topRem??.8,e=window.innerHeight<=500,i=document.createElement("button");let s=l.initialMuted;const a=()=>{i.textContent=s?"🔇":"🔊",i.setAttribute("aria-label",s?"サウンド オフ":"サウンド オン")};i.setAttribute("data-mute-button",""),i.style.position="absolute",i.style.top=`${t}rem`,i.style.right="1rem",i.style.fontSize=e?"clamp(1.1rem, 3.5vmin, 1.4rem)":"clamp(1.4rem, 4vmin, 1.8rem)",i.style.background="rgba(255, 255, 255, 0.15)",i.style.border="none",i.style.borderRadius="50%",i.style.width=e?"2.4rem":"3rem",i.style.height=e?"2.4rem":"3rem",i.style.display="flex",i.style.alignItems="center",i.style.justifyContent="center",i.style.cursor="pointer",i.style.pointerEvents="auto",i.style.touchAction="manipulation",i.style.transform="scale(1)",i.style.transition="transform 0.08s ease-out",a();const n=()=>{i.style.transform="scale(1)"};return i.addEventListener("pointerdown",o=>{o.stopPropagation(),i.style.transform="scale(0.9)",l.onToggle()}),i.addEventListener("pointerup",n),i.addEventListener("pointercancel",n),i.addEventListener("pointerleave",n),l.container.appendChild(i),{element:i,setMuted(o){s=o,a()},remove(){i.remove()}}}const gt=[{value:0,labelKey:"colorSettings.audio.volume.quiet"},{value:25,labelKey:"colorSettings.audio.volume.small"},{value:50,labelKey:"colorSettings.audio.volume.normal"},{value:75,labelKey:"colorSettings.audio.volume.loud"},{value:100,labelKey:"colorSettings.audio.volume.max"}],Ut=[{value:"color-only",labelKey:"colorSettings.colorVision.option.colorOnly",icon:"🎨"},{value:"color-and-marks",labelKey:"colorSettings.colorVision.option.colorAndMarks",icon:"★"}],jt=[{value:"strong",labelKey:"colorSettings.vibration.option.strong"},{value:"medium",labelKey:"colorSettings.vibration.option.medium"},{value:"weak",labelKey:"colorSettings.vibration.option.weak"},{value:"off",labelKey:"colorSettings.vibration.option.off"}],Wt=[{value:"ja",labelKey:"colorSettings.language.option.ja",icon:"🇯🇵"},{value:"en",labelKey:"colorSettings.language.option.en",icon:"🇬🇧"}],Zt={strong:{shortLabel:"colorSettings.motion.option.strong.shortLabel",description:"colorSettings.motion.option.strong.description"},medium:{shortLabel:"colorSettings.motion.option.medium.shortLabel",description:"colorSettings.motion.option.medium.description"},gentle:{shortLabel:"colorSettings.motion.option.gentle.shortLabel",description:"colorSettings.motion.option.gentle.description"},minimal:{shortLabel:"colorSettings.motion.option.minimal.shortLabel",description:"colorSettings.motion.option.minimal.description"}};function Yt(l){const t=gt.find(e=>e.value===l)??gt[2];return C.t(t.labelKey)}class li{overlay=null;toggleButton=null;descriptionEl=null;highContrast=!1;colorVisionSupportMode="color-only";bgmVolume=100;sfxVolume=100;vibrationIntensity="medium";motionSensitivity="strong";restReminderEnabled=!0;language=ut;bgmVolumeDescriptionEl=null;sfxVolumeDescriptionEl=null;bgmVolumeSlider=null;sfxVolumeSlider=null;colorVisionDescriptionEl=null;colorVisionButtons=new Map;vibrationDescriptionEl=null;vibrationButtons=new Map;motionDescriptionEl=null;motionButtons=new Map;restReminderDescriptionEl=null;restReminderToggleButton=null;motionPreviewEl=null;motionPreviewTokenEl=null;motionPreviewCaptionEl=null;languageDescriptionEl=null;languageButtons=new Map;motionPreviewTimeoutId=null;motionPreviewFrameId=null;onToggle=null;onColorVisionSupportModeChange=null;onBGMVolumeChange=null;onSFXVolumeChange=null;onVibrationIntensityChange=null;onMotionSensitivityChange=null;onRestReminderToggle=null;onLanguageChange=null;languageUnsubscribe=null;show(t){const e=document.getElementById("ui-overlay");if(e){if(this.highContrast=t.initialHighContrast,this.colorVisionSupportMode=t.initialColorVisionSupportMode,this.bgmVolume=t.initialBGMVolume,this.sfxVolume=t.initialSFXVolume,this.vibrationIntensity=t.initialVibrationIntensity,this.motionSensitivity=t.initialMotionSensitivity,this.restReminderEnabled=t.initialRestReminderEnabled,this.language=t.initialLanguage,this.onToggle=t.onToggle,this.onColorVisionSupportModeChange=t.onColorVisionSupportModeChange,this.onBGMVolumeChange=t.onBGMVolumeChange,this.onSFXVolumeChange=t.onSFXVolumeChange,this.onVibrationIntensityChange=t.onVibrationIntensityChange,this.onMotionSensitivityChange=t.onMotionSensitivityChange,this.onRestReminderToggle=t.onRestReminderToggle,this.onLanguageChange=t.onLanguageChange,C.setLanguage(this.language,{notify:!1}),this.languageUnsubscribe?.(),this.languageUnsubscribe=C.subscribe(i=>{this.language=i,this.render()}),!this.overlay){const i=window.innerHeight<=760;this.overlay=document.createElement("div"),this.overlay.setAttribute("data-color-accessibility-settings",""),this.overlay.style.cssText=`
      ...
      `;for(const c of Wt){const E=document.createElement("button");E.setAttribute("data-language-button",c.value),E.style.cssText=`
          min-height: 3.25rem;
        ...
        gap: 0.65rem;
        margin-bottom: 0.95rem;
      `;for(const c of Ut){const E=document.createElement("button");E.setAttribute("data-color-vision-mode-button",c.value),E.style.cssText=`
          min-height: 3.25rem;
          padding: 0.8rem 0.9rem;
          border-radius: 1rem;
          border: 2px solid rgba(255, 255, 255, 0.4);
        ...
        gap: 0.65rem;
        margin-bottom: 0.95rem;
      `;for(const c of jt){const E=document.createElement("button");E.setAttribute("data-vibration-intensity-button",c.value),E.style.cssText=`
          min-height: 3.25rem;
          padding: 0.8rem 0.9rem;
          border-radius: 1rem;
          border: 2px solid rgba(255, 255, 255, 0.4);
        ...
        gap: 0.65rem;
        margin-bottom: 0.95rem;
      `;const k=["strong","medium","gentle","minimal"];for(const c of k){const E=Ct(c),P=document.createElement("button");P.setAttribute("data-motion-sensitivity-button",c),P.style.cssText=`
          display: flex;
          flex-direction: column;
          align-items: center;
          justify-content: center;
    ...
    `,m.appendChild(f);const b=document.createElement("div");b.setAttribute("data-stats-stage-clears",""),b.style.cssText=`
      ...
      gap: 0.45rem;
      text-align: left;
    `;const g=Array.from({length:z},(d,w)=>w+1).map(d=>({stageNumber:d,clearCount:s.stageClearCounts[d]??0})).filter(d=>d.clearCount>0);if(g.length===0){const d=document.createElement("div");d.textContent="まだ きろくが ないよ",d.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: ${a?"1rem":"1.1rem"};
        font-weight: 700;
        text-align: center;
        color: rgba(255, 255, 255, 0.88);
      `,b.appendChild(d)}else for(const{stageNumber:d,clearCount:w}of g){const y=X(d),p=document.createElement("div");p.setAttribute("data-stats-stage-clear-row",String(d)),p.style.cssText=`
          display: flex;
          align-items: center;
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.actionCleanups.add(B(r,{onActivate:()=>{this.hide(),e()},onPressChange:d=>{r.style.transform=d?"scale(0.96)":"scale(1)"}})),o.appendChild(r),n.appendChild(o),i.appendChild(n)}hide(){const t=Array.from(this.actionCleanups);this.actionCleanups.clear();for(const e of t)e();this.overlayEl?.remove(),this.overlayEl=null}createSummaryCard(t,e,i){const s=document.createElement("div");s.setAttribute(i,""),s.style.cssText=`
  ...
  `,n.appendChild(u),n}const Xt=2e3,ft=new Map,yt=new Map,bt=new Map;let lt=null,ht=null;function ct(l,t){if(typeof document>"u"){const i=typeof OffscreenCanvas=="function",s=i?new OffscreenCanvas(l,t):{width:l,height:t};return{canvas:s,ctx:i?s.getContext("2d"):null}}const e=document.createElement("canvas");return e.width=l,e.height=t,{canvas:e,ctx:e.getContext("2d")}}function tt(l,t){let e=ft.get(l);return e||(e=t(),e.generateMipmaps=!1,e.minFilter=ni,e.needsUpdate=!0,ft.set(l,e)),e}function I(l,t){let e=yt.get(l);return e||(e=t(),yt.set(l,e)),e}function D(l,t){let e=bt.get(l);return e||(e=t(),bt.set(l,e)),e}function L(l,t){const e=new ai(l,t);return e.userData.sharedAssets=!0,e}function re(){if(!lt){const l=new Dt,t=new Float32Array(Xt*3);for(let e=0;e<Xt*3;e+=3)t[e]=(Math.random()-.5)*200,t[e+1]=(Math.random()-.5)*200,t[e+2]=(Math.random()-.5)*400;l.setAttribute("position",new Lt(t,3)),lt=l}ht||(ht=new Gt({color:16777215,size:.2,sizeAttenuation:!0}))}function pi(){const{canvas:l,ctx:t}=ct(256,256);if(!t)return new _(l);t.fillStyle="#888888",t.fillRect(0,0,256,256);for(let e=0;e<30;e++){const i=Math.random()*256,s=Math.random()*256,a=3+Math.random()*12;t.beginPath(),t.arc(i,s,a,0,Math.PI*2),t.fillStyle=`rgba(60,60,60,${.3+Math.random()*.4})`,t.fill()}return new _(l)}function gi(){const{canvas:l,ctx:t}=ct(256,256);if(!t)return new _(l);t.fillStyle="#ddaa44",t.fillRect(0,0,256,256);for(let e=0;e<8;e++){t.beginPath();const i=128+(Math.random()-.5)*100,s=128+(Math.random()-.5)*100;t.strokeStyle=`rgba(200,150,60,${.3+Math.random()*.3})`,t.lineWidth=3+Math.random()*5;for(let a=0;a<Math.PI*4;a+=.1){const n=10+a*8;t.lineTo(i+Math.cos(a)*n,s+Math.sin(a)*n)}t.stroke()}return new _(l)}function fi(){const{canvas:l,ctx:t}=ct(256,256);if(!t)return new _(l);const e=["#cc7733","#dd9955","#bb6622","#eebb77","#aa5511","#ddaa66"];for(let i=0;i<256;i++){const s=Math.floor(i/(256/e.length))%e.length;t.fillStyle=e[s],t.fillRect(0,i,256,1)}return new _(l)}function yi(){const{canvas:l,ctx:t}=ct(512,256);return t?(t.fillStyle="#2266aa",t.fillRect(0,0,512,256),t.fillStyle="#886644",t.beginPath(),t.ellipse(300,80,80,40,.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(280,150,30,50,.1,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(100,90,25,60,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(110,170,20,40,-.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(420,170,25,15,0,0,Math.PI*2),t.fill(),t.fillStyle="#447733",t.beginPath(),t.ellipse(290,75,40,20,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(95,85,15,30,.2,0,Math.PI*2),t.fill(),new _(l)):new _(l)}function bi(){const{canvas:l,ctx:t}=ct(512,256);if(!t)return new _(l);t.clearRect(0,0,512,256),t.fillStyle="rgba(255,255,255,0.6)";for(let e=0;e<20;e++){const i=Math.random()*512,s=Math.random()*256;t.beginPath(),t.ellipse(i,s,20+Math.random()*40,8+Math.random()*15,Math.random()*Math.PI,0,Math.PI*2),t.fill()}return new _(l)}function vi(){ft.clear(),yt.clear(),bt.clear(),lt=null,ht=null}const Si={planetTextureCache:ft,planetGeometryCache:yt,planetMaterialCache:bt,getBgStarsGeometry:()=>lt,getBgStarsMaterial:()=>ht};function le(l,t,e){const i=new pt;let s=null;switch(l){case 2:{const a=tt("mercury",pi),n=I("mercury:sphere",()=>new N(10,24,24)),o=D("mercury:mat",()=>new O({map:a})),h=L(n,o);i.add(h),s=h;break}case 3:{const a=tt("venus",gi),n=I("venus:sphere",()=>new N(14,24,24)),o=D("venus:mat",()=>new O({map:a})),h=L(n,o);i.add(h),s=h;break}case 5:{const a=tt("jupiter",fi),n=I("jupiter:sphere",()=>new N(20,24,24)),o=D("jupiter:mat",()=>new O({map:a})),h=L(n,o);i.add(h),s=h;break}case 6:{const a=I("saturn:sphere",()=>new N(15,24,24)),n=t.planetColor,o=D(`saturn:mat:${n}`,()=>new O({color:n})),h=L(a,o);i.add(h);const u=I("saturn:ring",()=>new Vt(20,30,48)),m=D("saturn:ringMat",()=>new O({color:15645542,side:$t})),f=L(u,m);f.rotation.x=Math.PI/3,i.add(f),s=h;break}case 7:{const a=I("uranus:sphere",()=>new N(16,24,24)),n=D("uranus:mat",()=>new O({color:6737117})),o=L(a,n);i.add(o);const h=I("uranus:ring",()=>new Vt(21,28,48)),u=D("uranus:ringMat",()=>new O({color:10083822,side:$t})),m=L(h,u);m.rotation.z=Math.PI/2,i.add(m),s=o;break}case 9:{const a=I("pluto:sphere",()=>new N(8,24,24)),n=D("pluto:mat",()=>new O({color:12298922})),o=L(a,n);i.add(o),s=o;break}case 10:{const a=I("sun:sphere",()=>new N(25,24,24)),n=D("sun:mat",()=>new O({color:16763904,emissive:16755200,emissiveIntensity:.5})),o=L(a,n);i.add(o),i.add(new si(16763904,2,200)),s=o;break}case 11:{const a=tt("earth",yi),n=I("earth:sphere",()=>new N(15,32,32)),o=D("earth:mat",()=>new O({map:a})),h=tt("earth:cloud",bi),u=I("earth:cloudSphere",()=>new N(15.5,32,32)),m=D("earth:cloudMat",()=>new O({map:h,transparent:!0,opacity:.3})),f=new pt;f.add(L(n,o)),f.add(L(u,m)),i.add(f),s=f;break}default:{const a=I("default:sphere",()=>new N(15,24,24)),n=t.planetColor,o=D(`default:mat:${n}`,()=>new O({color:n})),h=L(a,o);i.add(h),s=h;break}}return i.position.set(0,0,e),{planet:i,spinTarget:s}}function he(l,t,e){return le(l,t,e)}function ce(l){re();const t=new It(lt,ht);return t.userData.sharedAssets=!0,t.geometry.setDrawRange(0,l),t}function Nt(l){!Number.isInteger(l)||l<1||l>z||typeof document>"u"&&typeof OffscreenCanvas!="function"||(re(),le(l,X(l),0))}let it=null,st=null;function Ei(){if(!it){const l=new Dt,t=new Float32Array(3e3);for(let e=0;e<3e3;e++)t[e]=(Math.random()-.5)*200;l.setAttribute("position",new Lt(t,3)),it=l}return it}function xi(){return st||(st=new Gt({color:16777215,size:.3,sizeAttenuation:!0})),st}function Ci(){it=null,st=null}const wi={getBgStarsGeometry:()=>it,getBgStarsMaterial:()=>st};function Ti(l){const t=window.requestIdleCallback;if(typeof t=="function"){t(l,{timeout:1500});return}window.setTimeout(l,800)}function ue(l){return new Set(l.filter(t=>Number.isInteger(t)&&t>=1&&t<=z)).size}function Ai(l){return ue(l)>=z}function At(l){const t=Ai(l.unlockedPlanets),e=t?1:Math.min(l.clearedStage+1,z),i=X(e),s=l.bestStageStars?.[e]??0,a=l.colorAccessibility?.colorVisionSupportMode??$,n=ee(e,i.destinationReading,a);return t?{startStage:e,destination:n,emoji:i.emoji,statusLabel:"ぜんぶ あつめたよ！",destinationLabel:`${n}へ もういちど しゅっぱつ！`,buttonHint:`${i.emoji} ステージ ${e} から もういちど あそぶ`,bestStars:s}:{startStage:e,destination:n,emoji:i.emoji,statusLabel:l.clearedStage>0?"つづきから しゅっぱつ！":"はじめての しゅっぱつ！",destinationLabel:`${n}へ むかおう！`,buttonHint:`${i.emoji} ステージ ${e} から スタート`,bestStars:s}}function Mi(l){return l.clearedStage>0||ue(l.unlockedPlanets)>0||Object.keys(l.bestStageStars??{}).length>0}class Bi{threeScene;ambientLight=new St(16777215,1);camera;lastAspect=0;sceneManager;saveManager;audioManager;stars=null;companionParade=null;overlay=null;muteHandle=null;tutorialOverlay=new zt;titleResetConfirmOverlay=new ri;colorAccessibilitySettings=new li;spaceshipCustomizer=new hi;statsOverlay=new di;encyclopediaOverlay=null;encyclopediaOverlayPromise=null;companionFactory=null;companionFactoryPromise=null;loadEncyclopediaOverlay;loadTitleCompanionFactory;loadingOverlay;loadFailureOverlay;scheduleIdleTask;encyclopediaBtn=null;isOpeningEncyclopedia=!1;isActive=!1;touchFeedbackOverlay=new q;encyclopediaRequestToken=0;companionParadeRequestToken=0;bgmPending=!1;overlayButtonCleanups=new Set;colorSettingsButton=null;unsubscribeLanguageChange=null;constructor(t,e,i,s={}){this.sceneManager=t,this.saveManager=e,this.audioManager=i,this.loadingOverlay=s.loadingOverlay??new pe,this.loadFailureOverlay=s.loadFailureOverlay??new ge,this.scheduleIdleTask=s.scheduleIdleTask??Ti,this.loadEncyclopediaOverlay=s.loadEncyclopediaOverlay??(()=>Pt(()=>import("./EncyclopediaOverlay-Dlvg-QfK.js"),__vite__mapDeps([0,1,2]))),this.loadTitleCompanionFactory=s.loadTitleCompanionFactory??(()=>Pt(()=>import("./game-core-DAq5R5A_.js").then(o=>o.an),__vite__mapDeps([1,2]))),this.threeScene=new ot,this.threeScene.background=new rt(32);const{width:a,height:n}=H();this.camera=new Et(60,a/n,.1,1e3),this.camera.position.set(0,0,5)}enter(t){this.isActive=!0,this.encyclopediaRequestToken+=1,this.companionParadeRequestToken+=1,this.lastAspect=0,this.stars=new It(Ei(),xi()),this.stars.userData.sharedAssets=!0,this.stars.rotation.set(0,0,0),this.threeScene.add(this.stars),this.ambientLight.parent||this.threeScene.add(this.ambientLight);const e=this.saveManager.load();C.setLanguage(e.language??ut,{notify:!1}),this.createCompanionParade(e.unlockedPlanets),this.createOverlay(),this.createMuteButton(),this.touchFeedbackOverlay.setMotionSensitivity(e.colorAccessibility?.motionSensitivity??W()),this.touchFeedbackOverlay.attach(),this.touchFeedbackOverlay.bindUiRoots([document.getElementById("hud"),document.getElementById("ui-overlay")]),this.prefetchEncyclopediaOnIdle(),this.prewarmNextAdventureOnIdle(At(e).startStage),this.audioManager.isInitialized()?(this.audioManager.playBGM(0),this.bgmPending=!1):this.bgmPending=!0,e.tutorialShown||this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide(),this.saveManager.markTutorialShown()})}createMuteButton(){const t=document.getElementById("hud")??document.getElementById("ui-overlay");t&&(this.muteHandle=Ht({initialMuted:this.audioManager.isMuted(),container:t,onToggle:()=>{this.ensureTitleAudioInitialized(!0);const e=this.audioManager.toggleMute();this.muteHandle?.setMuted(e);const i=this.saveManager.load();i.muted=e,this.saveManager.save(i)}}))}getEncyclopediaOverlay(){return this.encyclopediaOverlay?Promise.resolve(this.encyclopediaOverlay):this.encyclopediaOverlayPromise?this.encyclopediaOverlayPromise:(this.encyclopediaOverlayPromise=this.loadEncyclopediaOverlay().then(({EncyclopediaOverlay:t})=>{const e=new t;return this.encyclopediaOverlay=e,e}).finally(()=>{this.encyclopediaOverlayPromise=null}),this.encyclopediaOverlayPromise)}getTitleCompanionFactory(){return this.companionFactory?Promise.resolve(this.companionFactory):this.companionFactoryPromise?this.companionFactoryPromise:(this.companionFactoryPromise=this.loadTitleCompanionFactory().then(t=>(this.companionFactory=t,t)).finally(()=>{this.companionFactoryPromise=null}),this.companionFactoryPromise)}showEncyclopedia(){if(!this.isActive||!this.encyclopediaOverlay)return;const t=this.saveManager.load();this.encyclopediaOverlay.show(t.unlockedPlanets,()=>this.refreshEncyclopediaButtonLabel(),e=>{this.ensureTitleAudioInitialized(!1),this.sceneManager.requestTransition("stage",{stageNumber:e,totalScore:0,totalStarCount:0,launchSource:"encyclopedia"})},t.bestStageStars??{},t.discoveredConstellations??[],t.colorAccessibility?.colorVisionSupportMode??$,t.discoveredMonthlyEncounters??[])}isCurrentEncyclopediaRequest(t){return this.isActive&&this.encyclopediaRequestToken===t}prefetchEncyclopediaOnIdle(){const t=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{!this.isCurrentEncyclopediaRequest(t)||this.encyclopediaOverlay||this.encyclopediaOverlayPromise||this.getEncyclopediaOverlay().catch(()=>{})})}prewarmNextAdventureOnIdle(t){if(t>z)return;const e=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{this.isCurrentEncyclopediaRequest(e)&&Nt(t)})}async openEncyclopedia(){if(!this.isActive)return;if(this.loadFailureOverlay.hide(),this.encyclopediaOverlay){this.showEncyclopedia();return}if(this.isOpeningEncyclopedia)return;const t=this.encyclopediaRequestToken;this.isOpeningEncyclopedia=!0,this.loadingOverlay.show("ずかんを よんでるよ...");try{if(await this.getEncyclopediaOverlay(),!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),this.showEncyclopedia()}catch(e){if(!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),console.error("Failed to load encyclopedia overlay",e),this.loadFailureOverlay.show({title:"ずかんを もういちど よんでみよう！",message:"「もういちど よむ」を おして つづきを たのしもう！",primaryAction:{label:"もういちど よむ",onSelect:()=>this.openEncyclopedia()}})}finally{this.encyclopediaRequestToken===t&&(this.isOpeningEncyclopedia=!1)}}persistHighContrastSetting(t){const e=this.saveManager.load(),i=e.colorAccessibility?.motionSensitivity??W(),s=e.colorAccessibility?.colorVisionSupportMode??$;e.colorAccessibility=this.buildColorAccessibilitySettings(t,i,s),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}persistVibrationIntensitySetting(t){const e=this.saveManager.load();e.vibrationSettings={intensity:t},this.saveManager.save(e),te(t)}persistRestReminderSetting(t){const e=this.saveManager.load();e.restReminderSettings={enabled:t},this.saveManager.save(e)}persistLanguageSetting(t){const e=this.saveManager.load();t===ut?delete e.language:e.language=t,this.saveManager.save(e)}persistBGMVolumeSetting(t){const e=this.saveManager.load();e.audioSettings=this.buildAudioSettings(t,e.audioSettings?.sfxVolume??100),e.audioSettings||delete e.audioSettings,this.saveManager.save(e),this.audioManager.setBGMVolume(t)}persistSFXVolumeSetting(t){const e=this.saveManager.load();e.audioSettings=this.buildAudioSettings(e.audioSettings?.bgmVolume??100,t),e.audioSettings||delete e.audioSettings,this.saveManager.save(e),this.audioManager.setSFXVolume(t)}persistMotionSensitivitySetting(t){const e=this.saveManager.load(),i=e.colorAccessibility?.highContrast===!0,s=e.colorAccessibility?.colorVisionSupportMode??$;e.colorAccessibility=this.buildColorAccessibilitySettings(i,t,s),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}persistColorVisionSupportModeSetting(t){const e=this.saveManager.load(),i=e.colorAccessibility?.highContrast===!0,s=e.colorAccessibility?.motionSensitivity??W();e.colorAccessibility=this.buildColorAccessibilitySettings(i,s,t),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}buildColorAccessibilitySettings(t,e,i){const s=W();if(!(!t&&e===s&&i===$))return{...t?{highContrast:!0}:{},...e!==s?{motionSensitivity:e}:{},...i!==$?{colorVisionSupportMode:i}:{}}}buildAudioSettings(t,e){if(!(t===100&&e===100))return{...t!==100?{bgmVolume:t}:{},...e!==100?{sfxVolume:e}:{}}}createOverlay(){const t=document.getElementById("ui-overlay");if(!t)return;const e=this.saveManager.load(),i=At(e),s=Mi(e);this.overlay=document.createElement("div"),this.unsubscribeLanguageChange?.(),this.unsubscribeLanguageChange=C.subscribe(()=>this.applyLocalizedText()),this.overlay.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      justify-content: center;
    ...
    `;const f=document.createElement("div");f.textContent=i.destinationLabel,f.style.cssText=`
      ...
      font-weight: 700;
      color: rgba(255, 255, 255, 0.92);
    `;const b=Jt(i.startStage,i.bestStars),g=kt(i.startStage,i.bestStars,{label:"メダル",hint:b.nextThreshold===null?"かんぺき！":`${b.icon} いま ・ つぎ ⭐ ${b.nextThreshold}`,size:"regular",scope:"title-next-adventure"});g.style.marginTop=a?"0.35rem":"0.55rem",o.appendChild(h),o.appendChild(u),o.appendChild(m),o.appendChild(f),o.appendChild(g);const r=document.createElement("div");r.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
    ...
    `;const A=document.createElement("button");A.setAttribute("data-spaceship-customizer-button",""),A.textContent="うちゅうせんをかざろう",A.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(B(A,{onActivate:()=>{const c=this.saveManager.load();this.spaceshipCustomizer.show({initialCustomization:c.spaceshipCustomization??Rt,onComplete:E=>{const P=this.saveManager.load();P.spaceshipCustomization=E,this.saveManager.save(P)}})},onPressChange:c=>{A.style.transform=c?"scale(0.96)":"scale(1)"}}));const T=document.createElement("button");T.setAttribute("data-stats-button",""),T.textContent="あそびの きろく",T.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${a?"0.9rem":"1.05rem"};
      font-weight: 900;
      padding: ${a?"0.55rem 0.65rem":"0.7rem 0.85rem"};
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(B(T,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.statsOverlay.show(this.saveManager.load().gameplayStats,()=>{})},onPressChange:c=>{T.style.transform=c?"scale(0.96)":"scale(1)"}}));const k=document.createElement("div");k.setAttribute("data-title-footer-actions",""),k.style.cssText=`
      display: grid;
    ...
    `,document.head.appendChild(t)}}const Oi=1,Ii=.4;class Qt{overlayEl=null;numberEl=null;phase="idle";elapsed=0;currentStep=0;stepDuration;goDuration;onTick;onGo;onComplete=null;steps=["3","2","1"];constructor(t={}){this.stepDuration=t.stepDuration??Oi,this.goDuration=t.goDuration??Ii,this.onTick=t.onTick,this.onGo=t.onGo}show(t){if(this.phase!=="idle"&&this.phase!=="done")return;const e=document.getElementById("ui-overlay")??document.body;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-countdown-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
    ...
    `,document.head.appendChild(t)}getActiveSide(t){return t==="active-left"?"left":t==="active-right"?"right":t==="assist-left"?"left":t==="assist-right"?"right":t==="hidden"?"none":"both"}getGuideEmphasis(t,e){return e==="active-left"?t==="left"?"primary":"secondary":e==="active-right"?t==="right"?"primary":"secondary":e==="assist-left"?t==="left"?"primary":"secondary":e==="assist-right"?t==="right"?"primary":"secondary":e==="hidden"?"hidden":"balanced"}updateInstruction(t){if(!this.instructionEl)return;const e=this.getInstructionMessage(t);this.instructionEl.textContent=e,this.instructionEl.setAttribute("data-touch-guide-message",e)}getInstructionMessage(t){return t==="intro"?"ひだりか みぎを さわると うごけるよ":t==="idle"?"ひつような ときは ひだりか みぎを さわって うごこう":t==="assist-left"?"ひだりへ よけよう":t==="assist-right"?"みぎへ よけよう":""}}class vt{static DEFAULT_DURATION=4.2;static CELEBRATION_DURATION=3.6;element=null;timer=0;message=null;highContrast=!1;showHint(t){this.showMessage(t,vt.DEFAULT_DURATION)}showCelebration(t){this.showMessage(t,vt.CELEBRATION_DURATION)}tick(t){this.timer<=0||(this.timer=Math.max(0,this.timer-t),this.timer===0&&this.hide())}hide(){this.timer=0,this.message=null,this.element&&(this.element.style.display="none",this.element.textContent="",this.element.removeAttribute("data-constellation-message"))}setHighContrastMode(t){this.highContrast=t,this.element&&this.applyElementStyle(this.element)}getMessage(){return this.message}showMessage(t,e){const i=this.ensureElement();this.timer=e,this.message=t,i.textContent=t,i.setAttribute("data-constellation-message",t),i.style.display="flex"}ensureElement(){if(this.element)return this.element;const t=document.getElementById("ui-overlay"),e=document.createElement("div");return e.setAttribute("data-constellation-hint",""),e.setAttribute("aria-live","polite"),this.applyElementStyle(e),e.style.display="none",t?.appendChild(e),this.element=e,e}applyElementStyle(t){t.style.cssText=`
      ...
      z-index: 35;
      box-shadow: 0 10px 24px rgba(0, 0, 0, 0.24);
    `}}const zi=4;class Hi{overlayEl=null;cardEl=null;titleEl=null;messageEl=null;elapsed=0;visible=!1;highContrastMode=!1;totalDuration;constructor(t={}){this.totalDuration=t.totalDuration??zi}show(t){const e=document.getElementById("ui-overlay")??document.body;ie();const i=H().height<=500;(!this.overlayEl||!this.cardEl||!this.titleEl||!this.messageEl)&&(this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-seasonal-event-notice",""),this.overlayEl.style.cssText=`
        position: absolute;
    ...
    `,this.overlayButtonCleanups.add(B(a,{onActivate:()=>{this.inputSystem.resetPointers?.(),this.sceneManager.requestTransition("title")},onPressChange:o=>{a.style.transform=o?"scale(0.96)":"scale(1)"}})),e.append(i,a);const n=document.createElement("div");n.style.cssText=`
      align-self: center;
