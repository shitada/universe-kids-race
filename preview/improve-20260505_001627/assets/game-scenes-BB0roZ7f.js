const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-C_D_gt4F.js","assets/game-core-ChkC_kRh.js","assets/three-By3JikJA.js"])))=>i.map(i=>d[i]);
import{D as ct,S as z,T as D,g as st,a as Tt,L as kt,b as Dt,_ as rt,c as G,d as V,P as N,u as Ht,C as Lt,e as Gt,f as zt,B as _t,h as Ft,M as Nt,i as $t,j as Ut,k as jt,l as Zt,m as qt,A as Yt,n as Xt,o as Vt,p as Mt,q as Wt,r as Qt,s as Kt,t as Jt,v as te,w as ee,x as it,y as at,z as se,E as ie,F as ae}from"./game-core-ChkC_kRh.js";import{m as dt,k as ut,i as mt,l as pt,G as W,o as ne,a as oe,p as re,M as B,g as k,D as Et,R as St,q as H,r as ft,s as Q,h as gt,P as yt,V as lt,t as le,u as he}from"./three-By3JikJA.js";class bt{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const e=document.getElementById("ui-overlay");if(!e)return;const s=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
    ...
    `,n.appendChild(o),n.appendChild(h),n.appendChild(d),n}isCompactHeight(){return window.innerHeight<=bt.COMPACT_HEIGHT_THRESHOLD}injectAnimations(){if(document.getElementById("tutorial-animations"))return;const t=document.createElement("style");t.id="tutorial-animations",t.textContent=`
      @keyframes swipe {
    ...
    `,o.appendChild(h);const d=document.createElement("div");d.style.cssText=`
      ...
      gap: 0.8rem;
      margin-bottom: 1rem;
    `,d.append(this.createSummaryCard("あそんだ じかん",pe(i.totalPlayTimeSeconds),"data-stats-total-play-time"),this.createSummaryCard("とった ほし",`${i.totalStarsCollected}こ`,"data-stats-total-stars"),this.createSummaryCard("ブースト",`${i.totalBoostUses}かい`,"data-stats-total-boosts")),o.appendChild(d);const c=document.createElement("div");c.style.cssText=`
      margin-top: 0.5rem;
      padding: ${a?"0.9rem 0.8rem":"1rem"};
      border-radius: 20px;
      background: rgba(255, 255, 255, 0.1);
    `;const l=document.createElement("div");l.textContent="ステージ クリア かいすう",l.style.cssText=`
      margin-bottom: 0.75rem;
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${a?"1.1rem":"1.25rem"};
      font-weight: 900;
      color: #FFE66D;
    `,c.appendChild(l);const g=document.createElement("div");g.setAttribute("data-stats-stage-clears",""),g.style.cssText=`
      display: flex;
      flex-direction: column;
      gap: 0.45rem;
      text-align: left;
    `;const m=Array.from({length:D},(p,S)=>S+1).map(p=>({stageNumber:p,clearCount:i.stageClearCounts[p]??0})).filter(p=>p.clearCount>0);if(m.length===0){const p=document.createElement("div");p.textContent="まだ きろくが ないよ",p.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: ${a?"1rem":"1.1rem"};
        font-weight: 700;
        text-align: center;
        color: rgba(255, 255, 255, 0.88);
      `,g.appendChild(p)}else for(const{stageNumber:p,clearCount:S}of m){const v=st(p),C=document.createElement("div");C.setAttribute("data-stats-stage-clear-row",String(p)),C.style.cssText=`
          display: flex;
          align-items: center;
          ...
          font-weight: 700;
        `;const w=document.createElement("span");w.textContent=`${v.emoji} ステージ ${p} ${v.destinationReading}`;const x=document.createElement("span");x.textContent=`${S}かい`,x.style.color="#FFE66D",C.append(w,x),g.appendChild(C)}c.appendChild(g),o.appendChild(c);const u=document.createElement("button");u.textContent="もどる",u.style.cssText=`
      margin-top: 1rem;
    ...
    `;const n=document.createElement("div");return n.textContent=e,n.style.cssText=`
      ...
      font-weight: 900;
      color: #FFE66D;
    `,i.append(a,n),i}}function xt(r,t){if(!Number.isFinite(r)||r<=0||t<=0)return"ずかん";const e=Math.min(r,t);return e>=t?`ずかん ${t} / ${t} 🎉`:`ずかん ${e} / ${t}`}function ge(r){switch(r){case"hero":return{gap:"0.35rem",label:"0.92rem",medal:"1.7rem",hint:"0.98rem"};case"compact":return{gap:"0.18rem",label:"0.7rem",medal:"1rem",hint:"0.76rem"};default:return{gap:"0.26rem",label:"0.8rem",medal:"1.25rem",hint:"0.84rem"}}}function ht(r,t,e={}){const s=Tt(r,t),i=e.size??"regular",a=ge(i),n=document.createElement("div");if(n.setAttribute("data-stage-medal-display",""),n.setAttribute("data-stage-medal-stage",String(r)),n.setAttribute("data-stage-medal-tier",s.tier),n.setAttribute("data-stage-medal-earned",String(s.earnedCount)),e.scope&&n.setAttribute("data-stage-medal-scope",e.scope),n.style.cssText=`
    display: flex;
    flex-direction: column;
    align-items: center;
    gap: ${a.gap};
  `,e.label){const c=document.createElement("div");c.textContent=e.label,c.style.cssText=`
    ...
    justify-content: center;
    gap: ${a.gap};
  `;for(const c of s.slots){const l=document.createElement("span");l.setAttribute("data-stage-medal-slot",c.tier),l.setAttribute("data-stage-medal-threshold",String(c.threshold)),l.setAttribute("data-stage-medal-reached",String(c.reached)),l.textContent=c.icon,l.style.cssText=`
      font-size: ${a.medal};
      line-height: 1;
  ...
  `,n.appendChild(d),n}const wt=2e3,K=new Map,J=new Map,tt=new Map;let q=null,Y=null;function X(r,t){if(typeof document>"u"){const s=typeof OffscreenCanvas=="function",i=s?new OffscreenCanvas(r,t):{width:r,height:t};return{canvas:i,ctx:s?i.getContext("2d"):null}}const e=document.createElement("canvas");return e.width=r,e.height=t,{canvas:e,ctx:e.getContext("2d")}}function F(r,t){let e=K.get(r);return e||(e=t(),e.generateMipmaps=!1,e.minFilter=re,e.needsUpdate=!0,K.set(r,e)),e}function P(r,t){let e=J.get(r);return e||(e=t(),J.set(r,e)),e}function O(r,t){let e=tt.get(r);return e||(e=t(),tt.set(r,e)),e}function R(r,t){const e=new oe(r,t);return e.userData.sharedAssets=!0,e}function Bt(){if(!q){const r=new ut,t=new Float32Array(wt*3);for(let e=0;e<wt*3;e+=3)t[e]=(Math.random()-.5)*200,t[e+1]=(Math.random()-.5)*200,t[e+2]=(Math.random()-.5)*400;r.setAttribute("position",new mt(t,3)),q=r}Y||(Y=new pt({color:16777215,size:.2,sizeAttenuation:!0}))}function ye(){const{canvas:r,ctx:t}=X(256,256);if(!t)return new H(r);t.fillStyle="#888888",t.fillRect(0,0,256,256);for(let e=0;e<30;e++){const s=Math.random()*256,i=Math.random()*256,a=3+Math.random()*12;t.beginPath(),t.arc(s,i,a,0,Math.PI*2),t.fillStyle=`rgba(60,60,60,${.3+Math.random()*.4})`,t.fill()}return new H(r)}function be(){const{canvas:r,ctx:t}=X(256,256);if(!t)return new H(r);t.fillStyle="#ddaa44",t.fillRect(0,0,256,256);for(let e=0;e<8;e++){t.beginPath();const s=128+(Math.random()-.5)*100,i=128+(Math.random()-.5)*100;t.strokeStyle=`rgba(200,150,60,${.3+Math.random()*.3})`,t.lineWidth=3+Math.random()*5;for(let a=0;a<Math.PI*4;a+=.1){const n=10+a*8;t.lineTo(s+Math.cos(a)*n,i+Math.sin(a)*n)}t.stroke()}return new H(r)}function ve(){const{canvas:r,ctx:t}=X(256,256);if(!t)return new H(r);const e=["#cc7733","#dd9955","#bb6622","#eebb77","#aa5511","#ddaa66"];for(let s=0;s<256;s++){const i=Math.floor(s/(256/e.length))%e.length;t.fillStyle=e[i],t.fillRect(0,s,256,1)}return new H(r)}function Ce(){const{canvas:r,ctx:t}=X(512,256);return t?(t.fillStyle="#2266aa",t.fillRect(0,0,512,256),t.fillStyle="#886644",t.beginPath(),t.ellipse(300,80,80,40,.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(280,150,30,50,.1,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(100,90,25,60,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(110,170,20,40,-.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(420,170,25,15,0,0,Math.PI*2),t.fill(),t.fillStyle="#447733",t.beginPath(),t.ellipse(290,75,40,20,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(95,85,15,30,.2,0,Math.PI*2),t.fill(),new H(r)):new H(r)}function Ee(){const{canvas:r,ctx:t}=X(512,256);if(!t)return new H(r);t.clearRect(0,0,512,256),t.fillStyle="rgba(255,255,255,0.6)";for(let e=0;e<20;e++){const s=Math.random()*512,i=Math.random()*256;t.beginPath(),t.ellipse(s,i,20+Math.random()*40,8+Math.random()*15,Math.random()*Math.PI,0,Math.PI*2),t.fill()}return new H(r)}function Se(){K.clear(),J.clear(),tt.clear(),q=null,Y=null}const xe={planetTextureCache:K,planetGeometryCache:J,planetMaterialCache:tt,getBgStarsGeometry:()=>q,getBgStarsMaterial:()=>Y};function Pt(r,t,e){const s=new W;let i=null;switch(r){case 2:{const a=F("mercury",ye),n=P("mercury:sphere",()=>new k(10,24,24)),o=O("mercury:mat",()=>new B({map:a})),h=R(n,o);s.add(h),i=h;break}case 3:{const a=F("venus",be),n=P("venus:sphere",()=>new k(14,24,24)),o=O("venus:mat",()=>new B({map:a})),h=R(n,o);s.add(h),i=h;break}case 5:{const a=F("jupiter",ve),n=P("jupiter:sphere",()=>new k(20,24,24)),o=O("jupiter:mat",()=>new B({map:a})),h=R(n,o);s.add(h),i=h;break}case 6:{const a=P("saturn:sphere",()=>new k(15,24,24)),n=t.planetColor,o=O(`saturn:mat:${n}`,()=>new B({color:n})),h=R(a,o);s.add(h);const d=P("saturn:ring",()=>new St(20,30,48)),c=O("saturn:ringMat",()=>new B({color:15645542,side:Et})),l=R(d,c);l.rotation.x=Math.PI/3,s.add(l),i=h;break}case 7:{const a=P("uranus:sphere",()=>new k(16,24,24)),n=O("uranus:mat",()=>new B({color:6737117})),o=R(a,n);s.add(o);const h=P("uranus:ring",()=>new St(21,28,48)),d=O("uranus:ringMat",()=>new B({color:10083822,side:Et})),c=R(h,d);c.rotation.z=Math.PI/2,s.add(c),i=o;break}case 9:{const a=P("pluto:sphere",()=>new k(8,24,24)),n=O("pluto:mat",()=>new B({color:12298922})),o=R(a,n);s.add(o),i=o;break}case 10:{const a=P("sun:sphere",()=>new k(25,24,24)),n=O("sun:mat",()=>new B({color:16763904,emissive:16755200,emissiveIntensity:.5})),o=R(a,n);s.add(o),s.add(new ne(16763904,2,200)),i=o;break}case 11:{const a=F("earth",Ce),n=P("earth:sphere",()=>new k(15,32,32)),o=O("earth:mat",()=>new B({map:a})),h=F("earth:cloud",Ee),d=P("earth:cloudSphere",()=>new k(15.5,32,32)),c=O("earth:cloudMat",()=>new B({map:h,transparent:!0,opacity:.3})),l=new W;l.add(R(n,o)),l.add(R(d,c)),s.add(l),i=l;break}default:{const a=P("default:sphere",()=>new k(15,24,24)),n=t.planetColor,o=O(`default:mat:${n}`,()=>new B({color:n})),h=R(a,o);s.add(h),i=h;break}}return s.position.set(0,0,e),{planet:s,spinTarget:i}}function we(r,t,e){return Pt(r,t,e)}function Ae(r){Bt();const t=new dt(q,Y);return t.userData.sharedAssets=!0,t.geometry.setDrawRange(0,r),t}function Ct(r){!Number.isInteger(r)||r<1||r>D||typeof document>"u"&&typeof OffscreenCanvas!="function"||(Bt(),Pt(r,st(r),0))}let $=null,U=null;function Te(){if(!$){const r=new ut,t=new Float32Array(3e3);for(let e=0;e<3e3;e++)t[e]=(Math.random()-.5)*200;r.setAttribute("position",new mt(t,3)),$=r}return $}function Me(){return U||(U=new pt({color:16777215,size:.3,sizeAttenuation:!0})),U}function Be(){$=null,U=null}const Pe={getBgStarsGeometry:()=>$,getBgStarsMaterial:()=>U};function Oe(r){const t=window.requestIdleCallback;if(typeof t=="function"){t(r,{timeout:1500});return}window.setTimeout(r,800)}function Ot(r){return new Set(r.filter(t=>Number.isInteger(t)&&t>=1&&t<=D)).size}function Re(r){return Ot(r)>=D}function nt(r){const t=Re(r.unlockedPlanets),e=t?1:Math.min(r.clearedStage+1,D),s=st(e),i=r.bestStageStars?.[e]??0;return t?{startStage:e,destination:s.destinationReading,emoji:s.emoji,statusLabel:"ぜんぶ あつめたよ！",destinationLabel:`${s.destinationReading}へ もういちど しゅっぱつ！`,buttonHint:`${s.emoji} ステージ ${e} から もういちど あそぶ`,bestStars:i}:{startStage:e,destination:s.destinationReading,emoji:s.emoji,statusLabel:r.clearedStage>0?"つづきから しゅっぱつ！":"はじめての しゅっぱつ！",destinationLabel:`${s.destinationReading}へ むかおう！`,buttonHint:`${s.emoji} ステージ ${e} から スタート`,bestStars:i}}function Ie(r){return r.clearedStage>0||Ot(r.unlockedPlanets)>0||Object.keys(r.bestStageStars??{}).length>0}class ke{threeScene;ambientLight=new ft(16777215,1);camera;lastAspect=0;sceneManager;saveManager;audioManager;stars=null;companionParade=null;overlay=null;muteHandle=null;tutorialOverlay=new bt;titleResetConfirmOverlay=new ce;colorAccessibilitySettings=new de;spaceshipCustomizer=new ue;statsOverlay=new fe;encyclopediaOverlay=null;encyclopediaOverlayPromise=null;companionFactory=null;companionFactoryPromise=null;loadEncyclopediaOverlay;loadTitleCompanionFactory;loadingOverlay;loadFailureOverlay;scheduleIdleTask;encyclopediaBtn=null;isOpeningEncyclopedia=!1;isActive=!1;encyclopediaRequestToken=0;companionParadeRequestToken=0;bgmPending=!1;overlayButtonCleanups=new Set;constructor(t,e,s,i={}){this.sceneManager=t,this.saveManager=e,this.audioManager=s,this.loadingOverlay=i.loadingOverlay??new kt,this.loadFailureOverlay=i.loadFailureOverlay??new Dt,this.scheduleIdleTask=i.scheduleIdleTask??Oe,this.loadEncyclopediaOverlay=i.loadEncyclopediaOverlay??(()=>rt(()=>import("./EncyclopediaOverlay-C_D_gt4F.js"),__vite__mapDeps([0,1,2]))),this.loadTitleCompanionFactory=i.loadTitleCompanionFactory??(()=>rt(()=>import("./game-core-ChkC_kRh.js").then(o=>o.O),__vite__mapDeps([1,2]))),this.threeScene=new Q,this.threeScene.background=new gt(32);const{width:a,height:n}=G();this.camera=new yt(60,a/n,.1,1e3),this.camera.position.set(0,0,5)}enter(t){this.isActive=!0,this.encyclopediaRequestToken+=1,this.companionParadeRequestToken+=1,this.lastAspect=0,this.stars=new dt(Te(),Me()),this.stars.userData.sharedAssets=!0,this.stars.rotation.set(0,0,0),this.threeScene.add(this.stars),this.ambientLight.parent||this.threeScene.add(this.ambientLight);const e=this.saveManager.load();this.createCompanionParade(e.unlockedPlanets),this.createOverlay(),this.createMuteButton(),this.prefetchEncyclopediaOnIdle(),this.prewarmNextAdventureOnIdle(nt(e).startStage),this.audioManager.isInitialized()?(this.audioManager.playBGM(0),this.bgmPending=!1):this.bgmPending=!0,e.tutorialShown||this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide(),this.saveManager.markTutorialShown()})}createMuteButton(){const t=document.getElementById("hud")??document.getElementById("ui-overlay");t&&(this.muteHandle=vt({initialMuted:this.audioManager.isMuted(),container:t,onToggle:()=>{this.ensureTitleAudioInitialized(!0);const e=this.audioManager.toggleMute();this.muteHandle?.setMuted(e);const s=this.saveManager.load();s.muted=e,this.saveManager.save(s)}}))}getEncyclopediaOverlay(){return this.encyclopediaOverlay?Promise.resolve(this.encyclopediaOverlay):this.encyclopediaOverlayPromise?this.encyclopediaOverlayPromise:(this.encyclopediaOverlayPromise=this.loadEncyclopediaOverlay().then(({EncyclopediaOverlay:t})=>{const e=new t;return this.encyclopediaOverlay=e,e}).finally(()=>{this.encyclopediaOverlayPromise=null}),this.encyclopediaOverlayPromise)}getTitleCompanionFactory(){return this.companionFactory?Promise.resolve(this.companionFactory):this.companionFactoryPromise?this.companionFactoryPromise:(this.companionFactoryPromise=this.loadTitleCompanionFactory().then(t=>(this.companionFactory=t,t)).finally(()=>{this.companionFactoryPromise=null}),this.companionFactoryPromise)}showEncyclopedia(){if(!this.isActive||!this.encyclopediaOverlay)return;const t=this.saveManager.load();this.encyclopediaOverlay.show(t.unlockedPlanets,()=>this.refreshEncyclopediaButtonLabel(),e=>{this.ensureTitleAudioInitialized(!1),this.sceneManager.requestTransition("stage",{stageNumber:e,totalScore:0,totalStarCount:0,launchSource:"encyclopedia"})},t.bestStageStars??{},t.discoveredConstellations??[])}isCurrentEncyclopediaRequest(t){return this.isActive&&this.encyclopediaRequestToken===t}prefetchEncyclopediaOnIdle(){const t=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{!this.isCurrentEncyclopediaRequest(t)||this.encyclopediaOverlay||this.encyclopediaOverlayPromise||this.getEncyclopediaOverlay().catch(()=>{})})}prewarmNextAdventureOnIdle(t){if(t>D)return;const e=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{this.isCurrentEncyclopediaRequest(e)&&Ct(t)})}async openEncyclopedia(){if(!this.isActive)return;if(this.loadFailureOverlay.hide(),this.encyclopediaOverlay){this.showEncyclopedia();return}if(this.isOpeningEncyclopedia)return;const t=this.encyclopediaRequestToken;this.isOpeningEncyclopedia=!0,this.loadingOverlay.show("ずかんを よんでるよ...");try{if(await this.getEncyclopediaOverlay(),!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),this.showEncyclopedia()}catch(e){if(!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),console.error("Failed to load encyclopedia overlay",e),this.loadFailureOverlay.show({title:"ずかんを もういちど よんでみよう！",message:"「もういちど よむ」を おして つづきを たのしもう！",primaryAction:{label:"もういちど よむ",onSelect:()=>this.openEncyclopedia()}})}finally{this.encyclopediaRequestToken===t&&(this.isOpeningEncyclopedia=!1)}}persistHighContrastSetting(t){const e=this.saveManager.load();t?e.colorAccessibility={highContrast:!0}:delete e.colorAccessibility,this.saveManager.save(e)}createOverlay(){const t=document.getElementById("ui-overlay");if(!t)return;const e=this.saveManager.load(),s=nt(e);this.overlay=document.createElement("div"),this.overlay.style.cssText=`
    ...
    `;const c=document.createElement("div");c.textContent=s.destinationLabel,c.style.cssText=`
      ...
      font-weight: 700;
      color: rgba(255, 255, 255, 0.92);
    `;const l=Tt(s.startStage,s.bestStars),g=ht(s.startStage,s.bestStars,{label:"メダル",hint:l.nextThreshold===null?"かんぺき！":`${l.icon} いま ・ つぎ ⭐ ${l.nextThreshold}`,size:"regular",scope:"title-next-adventure"});g.style.marginTop="0.7rem",n.appendChild(o),n.appendChild(h),n.appendChild(d),n.appendChild(c),n.appendChild(g);const m=document.createElement("div");m.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      gap: 0.65rem;
    ...
    `;const S=document.createElement("button");S.setAttribute("data-spaceship-customizer-button",""),S.textContent="うちゅうせんをかざろう",S.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(T(S,{onActivate:()=>{const b=this.saveManager.load();this.spaceshipCustomizer.show({initialCustomization:b.spaceshipCustomization??ct,onComplete:A=>{const y=this.saveManager.load();y.spaceshipCustomization=A,this.saveManager.save(y)}})},onPressChange:b=>{S.style.transform=b?"scale(0.96)":"scale(1)"}}));const v=document.createElement("button");v.setAttribute("data-stats-button",""),v.textContent="あそびの きろく",v.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
    ...
    `,this.overlayButtonCleanups.add(T(w,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.colorAccessibilitySettings.show({initialHighContrast:this.saveManager.load().colorAccessibility?.highContrast===!0,onToggle:b=>this.persistHighContrastSetting(b)})},onPressChange:b=>{w.style.transform=b?"translateX(-50%) scale(0.96)":"translateX(-50%) scale(1)"}}));const x=document.createElement("button");if(x.textContent=xt(e.unlockedPlanets.length,N.length),x.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,x.style.position="absolute",x.style.bottom=i?"1rem":"2rem",x.style.left=i?"1rem":"2rem",this.encyclopediaBtn=x,this.overlayButtonCleanups.add(T(x,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.openEncyclopedia()},onPressChange:b=>{x.style.transform=b?"scale(0.96)":"scale(1)"}})),m.appendChild(u),m.appendChild(p),m.appendChild(S),m.appendChild(v),Ie(e)){const b=document.createElement("button");b.setAttribute("data-reset-progress-button",""),b.textContent="さいしょから",b.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: 1.15rem;
        font-weight: 900;
    ...
    `,o.addEventListener("pointerdown",u=>{u.stopPropagation()}),this.overlayEl.appendChild(o);const h=document.createElement("div");h.textContent="タイトルへ もどる？",h.style.cssText=`
      font-size: 1.8rem;
      font-weight: 900;
      text-shadow: 0 0 15px rgba(255, 215, 0, 0.5);
      margin-bottom: 1.2rem;
    ...
    `,o.appendChild(d);const c=`
      ...
      transition: transform 0.08s ease-out;
      white-space: nowrap;
    `,l=(u,p)=>{const S=T(u,{onActivate:p,onPressChange:v=>{u.style.transform=v?"scale(0.9)":"scale(1)"}});this.activePressCleanups.add(S)},g=document.createElement("button");g.setAttribute("data-home-confirm-back",""),g.setAttribute("aria-label","タイトルへ もどる"),g.textContent="🏠 タイトルへ もどる",g.style.cssText=c,g.style.fontFamily="'Zen Maru Gothic', sans-serif",g.style.background="rgba(255, 255, 255, 0.18)",g.style.color="#ffffff",g.style.minWidth="88px",g.style.minHeight="88px",g.style.touchAction="manipulation",g.style.transform="scale(1)",g.style.transition="transform 0.08s ease-out",g.style.whiteSpace="nowrap",l(g,n),d.appendChild(g);const m=document.createElement("button");m.setAttribute("data-home-confirm-continue",""),m.setAttribute("aria-label","つづける"),m.textContent="✋ つづける",m.style.cssText=c,m.style.fontFamily="'Zen Maru Gothic', sans-serif",m.style.background="linear-gradient(135deg, #FF6B6B, #FFE66D)",m.style.color="#FFD700",m.style.textShadow="0 1px 2px rgba(0, 0, 32, 0.6)",m.style.minWidth="88px",m.style.minHeight="88px",m.style.touchAction="manipulation",m.style.transform="scale(1)",m.style.transition="transform 0.08s ease-out",m.style.whiteSpace="nowrap",l(m,a),d.appendChild(m),s.appendChild(this.overlayEl)}hide(){if(this.overlayEl){const t=Array.from(this.activePressCleanups);this.activePressCleanups.clear();for(const e of t)e();this.overlayEl.remove(),this.overlayEl=null}}isVisible(){return this.overlayEl!==null}}class Rt{overlayEl=null;activePressCleanups=new Set;show(t,e){if(this.overlayEl)return;const s=document.getElementById("ui-overlay")??document.body;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-pause-overlay",""),this.overlayEl.setAttribute("role","dialog"),this.overlayEl.setAttribute("aria-modal","true"),this.overlayEl.setAttribute("aria-label","やすみちゅう"),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
    ...
    `,i.appendChild(n);const o=document.createElement("div");o.style.cssText=`
      ...
      align-items: stretch;
      width: 100%;
    `,i.appendChild(o);const h=(d,c,l,g,m,u)=>{const p=document.createElement("button");p.setAttribute(c,""),p.setAttribute("aria-label",l),p.textContent=d,p.style.cssText=`
        flex: 1 1 140px;
        padding: 1rem 1.2rem;
        border: none;
        border-radius: 1.6rem;
    ...
    `,document.head.appendChild(t)}}const Ge=1,ze=.4;class At{overlayEl=null;numberEl=null;phase="idle";elapsed=0;currentStep=0;stepDuration;goDuration;onTick;onGo;onComplete=null;steps=["3","2","1"];constructor(t={}){this.stepDuration=t.stepDuration??Ge,this.goDuration=t.goDuration??ze,this.onTick=t.onTick,this.onGo=t.onGo}show(t){if(this.phase!=="idle"&&this.phase!=="done")return;const e=document.getElementById("ui-overlay")??document.body;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-countdown-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
