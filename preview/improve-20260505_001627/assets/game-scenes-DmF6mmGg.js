const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-By1xqciB.js","assets/game-core-C1I9qHVK.js","assets/three-By3JikJA.js"])))=>i.map(i=>d[i]);
import{D as ht,S as z,T as D,g as et,a as At,L as It,b as kt,_ as ot,c as L,d as V,P as N,u as Dt,C as Ht,e as Gt,f as Lt,B as zt,h as _t,M as Ft,i as Nt,j as $t,A as jt,k as Ut,l as Zt,m as Tt,n as qt,o as Yt,p as Xt,q as st,t as it,r as Vt,s as Wt,v as Qt}from"./game-core-C1I9qHVK.js";import{m as ct,k as dt,i as ut,l as mt,G as W,o as Kt,a as Jt,p as te,M as B,g as k,D as Ct,R as Et,q as H,r as pt,s as Q,h as ft,P as gt,V as rt,t as ee,u as se}from"./three-By3JikJA.js";class yt{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const s=document.getElementById("ui-overlay");if(!s)return;const e=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
