const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-Bu7D_A5H.js","assets/game-core-RztmsZ0Q.js","assets/three-D-dORC6w.js"])))=>i.map(i=>d[i]);
import{g as Ct,T as I,a as nt,L as Bt,b as Ot,_ as it,c as L,d as X,P as N,u as It,C as Rt,S as kt,e as Dt,B as Lt,f as Ht,h as _t,A as Gt,i as St,j as Ft,k as Nt,l as tt,m as zt}from"./game-core-RztmsZ0Q.js";import{h as ot,f as rt,d as lt,g as ht,G as V,l as $t,M as jt,m as qt,a as x,S as P,k as gt,R as yt,n as B,o as ct,p as W,c as ut,P as dt,V as xt,q as Ut}from"./three-D-dORC6w.js";class mt{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const e=document.getElementById("ui-overlay");if(!e)return;const s=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
    ...
    `,o.appendChild(c);const d=`
      ...
      white-space: nowrap;
    `,y=(p,C)=>{let b=!1,v=!1;const O=()=>{R(!0)},H=()=>{p.style.transform="scale(0.92)"},_=()=>{p.style.transform="scale(1)"},R=(S=!1)=>{b=!1,v=S,_(),this.activePressCleanups.delete(O),document.removeEventListener("pointerup",g,!0),document.removeEventListener("pointercancel",E,!0)},g=S=>{const G=S.target===p||S.target instanceof Node&&p.contains(S.target),Pt=b&&G;R(!G),Pt&&C()},E=()=>{R(!0)};p.addEventListener("pointerdown",S=>{S.stopPropagation(),b=!0,v=!1,H(),this.activePressCleanups.add(O),document.addEventListener("pointerup",g,!0),document.addEventListener("pointercancel",E,!0)}),p.addEventListener("pointerenter",()=>{b&&H()}),p.addEventListener("pointerleave",()=>{b&&_()}),p.addEventListener("pointercancel",()=>R(!0)),p.addEventListener("click",S=>{if(S.stopPropagation(),v){v=!1;return}b||C()})},m=document.createElement("button");m.setAttribute("data-title-reset-cancel",""),m.textContent="やめる",m.style.cssText=d,m.style.background="rgba(255, 255, 255, 0.18)",m.style.color="#ffffff",y(m,a),c.appendChild(m);const f=document.createElement("button");f.setAttribute("data-title-reset-confirm",""),f.textContent="うん！ さいしょから",f.style.cssText=d,f.style.background="linear-gradient(135deg, #FF9F68, #FFE66D)",f.style.color="#3b1f00",y(f,n),c.appendChild(f),s.appendChild(this.overlayEl)}hide(){if(!this.overlayEl)return;const t=Array.from(this.activePressCleanups);this.activePressCleanups.clear();for(const e of t)e();this.overlayEl.remove(),this.overlayEl=null}}function pt(r){const t=r.topRem??.8,e=window.innerHeight<=500,s=document.createElement("button");let i=r.initialMuted;const a=()=>{s.textContent=i?"🔇":"🔊",s.setAttribute("aria-label",i?"サウンド オフ":"サウンド オン")};s.setAttribute("data-mute-button",""),s.style.position="absolute",s.style.top=`${t}rem`,s.style.right="1rem",s.style.fontSize=e?"clamp(1.1rem, 3.5vmin, 1.4rem)":"clamp(1.4rem, 4vmin, 1.8rem)",s.style.background="rgba(255, 255, 255, 0.15)",s.style.border="none",s.style.borderRadius="50%",s.style.width=e?"2.4rem":"3rem",s.style.height=e?"2.4rem":"3rem",s.style.display="flex",s.style.alignItems="center",s.style.justifyContent="center",s.style.cursor="pointer",s.style.pointerEvents="auto",s.style.touchAction="manipulation",s.style.transform="scale(1)",s.style.transition="transform 0.08s ease-out",a();const n=()=>{s.style.transform="scale(1)"};return s.addEventListener("pointerdown",o=>{o.stopPropagation(),s.style.transform="scale(0.9)",r.onToggle()}),s.addEventListener("pointerup",n),s.addEventListener("pointercancel",n),s.addEventListener("pointerleave",n),r.container.appendChild(s),{element:s,setMuted(o){i=o,a()},remove(){s.remove()}}}function bt(r,t){if(!Number.isFinite(r)||r<=0||t<=0)return"ずかん";const e=Math.min(r,t);return e>=t?`ずかん ${t} / ${t} 🎉`:`ずかん ${e} / ${t}`}function D(r,t){let e=!1,s=!1,i=null,a=null;const n=t.documentTarget??document,o=t.stopPropagation??!0,h=()=>{t.canActivate?.()!==!1&&t.onActivate()},l=g=>{t.onPressChange?.(g)},c=g=>{const E=g;return typeof E.clientX=="number"&&typeof E.clientY=="number"?{x:E.clientX,y:E.clientY}:null},d=g=>{const E=g;return typeof E.pointerId=="number"?E.pointerId:null},y=g=>{const E=d(g);return i===null||E===null||E===i},m=g=>{if(!e||a===null||t.moveTolerancePx===void 0)return!1;const E=c(g);return E===null?!1:Math.hypot(E.x-a.x,E.y-a.y)>t.moveTolerancePx},f=g=>{e=!1,s=g,i=null,a=null,l(!1),n.removeEventListener("pointermove",b,!0),n.removeEventListener("pointerup",p,!0),n.removeEventListener("pointercancel",C,!0)},p=g=>{if(!e||!y(g))return;if(m(g)){f(!0);return}const E=g.target,S=E===r||E instanceof Node&&r.contains(E),G=e&&S;f(G||!S),G&&h()},C=()=>{f(!0)},b=g=>{!e||!y(g)||m(g)&&f(!0)},v=g=>{t.canActivate?.()!==!1&&((t.preventDefaultOnPointerDown??!1)&&g.preventDefault(),o&&g.stopPropagation(),e=!0,s=!1,i=d(g),a=c(g),l(!0),t.moveTolerancePx!==void 0&&n.addEventListener("pointermove",b,!0),n.addEventListener("pointerup",p,!0),n.addEventListener("pointercancel",C,!0))},O=()=>{e&&l(!0)},H=()=>{e&&l(!1)},_=()=>{f(!0)},R=g=>{if(o&&g.stopPropagation(),(t.preventDefaultOnClick??!1)&&g.preventDefault(),s){s=!1;return}e||h()};return r.addEventListener("pointerdown",v),r.addEventListener("pointerenter",O),r.addEventListener("pointerleave",H),r.addEventListener("pointercancel",_),r.addEventListener("click",R),()=>{f(!1),r.removeEventListener("pointerdown",v),r.removeEventListener("pointerenter",O),r.removeEventListener("pointerleave",H),r.removeEventListener("pointercancel",_),r.removeEventListener("click",R)}}function Zt(r){switch(r){case"hero":return{gap:"0.35rem",label:"0.92rem",medal:"1.7rem",hint:"0.98rem"};case"compact":return{gap:"0.18rem",label:"0.7rem",medal:"1rem",hint:"0.76rem"};default:return{gap:"0.26rem",label:"0.8rem",medal:"1.25rem",hint:"0.84rem"}}}function at(r,t,e={}){const s=Ct(r,t),i=e.size??"regular",a=Zt(i),n=document.createElement("div");if(n.setAttribute("data-stage-medal-display",""),n.setAttribute("data-stage-medal-stage",String(r)),n.setAttribute("data-stage-medal-tier",s.tier),n.setAttribute("data-stage-medal-earned",String(s.earnedCount)),e.scope&&n.setAttribute("data-stage-medal-scope",e.scope),n.style.cssText=`
    display: flex;
    flex-direction: column;
    align-items: center;
    gap: ${a.gap};
  `,e.label){const c=document.createElement("div");c.textContent=e.label,c.style.cssText=`
    ...
    justify-content: center;
    gap: ${a.gap};
  `;for(const c of s.slots){const d=document.createElement("span");d.setAttribute("data-stage-medal-slot",c.tier),d.setAttribute("data-stage-medal-threshold",String(c.threshold)),d.setAttribute("data-stage-medal-reached",String(c.reached)),d.textContent=c.icon,d.style.cssText=`
      font-size: ${a.medal};
      line-height: 1;
  ...
  `,n.appendChild(l),n}const vt=2e3,Q=new Map,K=new Map,J=new Map;let U=null,Y=null;function Z(r,t){if(typeof document>"u"){const s=typeof OffscreenCanvas=="function",i=s?new OffscreenCanvas(r,t):{width:r,height:t};return{canvas:i,ctx:s?i.getContext("2d"):null}}const e=document.createElement("canvas");return e.width=r,e.height=t,{canvas:e,ctx:e.getContext("2d")}}function F(r,t){let e=Q.get(r);return e||(e=t(),e.generateMipmaps=!1,e.minFilter=qt,e.needsUpdate=!0,Q.set(r,e)),e}function w(r,t){let e=K.get(r);return e||(e=t(),K.set(r,e)),e}function A(r,t){let e=J.get(r);return e||(e=t(),J.set(r,e)),e}function T(r,t){const e=new jt(r,t);return e.userData.sharedAssets=!0,e}function wt(){if(!U){const r=new rt,t=new Float32Array(vt*3);for(let e=0;e<vt*3;e+=3)t[e]=(Math.random()-.5)*200,t[e+1]=(Math.random()-.5)*200,t[e+2]=(Math.random()-.5)*400;r.setAttribute("position",new lt(t,3)),U=r}Y||(Y=new ht({color:16777215,size:.2,sizeAttenuation:!0}))}function Xt(){const{canvas:r,ctx:t}=Z(256,256);if(!t)return new B(r);t.fillStyle="#888888",t.fillRect(0,0,256,256);for(let e=0;e<30;e++){const s=Math.random()*256,i=Math.random()*256,a=3+Math.random()*12;t.beginPath(),t.arc(s,i,a,0,Math.PI*2),t.fillStyle=`rgba(60,60,60,${.3+Math.random()*.4})`,t.fill()}return new B(r)}function Vt(){const{canvas:r,ctx:t}=Z(256,256);if(!t)return new B(r);t.fillStyle="#ddaa44",t.fillRect(0,0,256,256);for(let e=0;e<8;e++){t.beginPath();const s=128+(Math.random()-.5)*100,i=128+(Math.random()-.5)*100;t.strokeStyle=`rgba(200,150,60,${.3+Math.random()*.3})`,t.lineWidth=3+Math.random()*5;for(let a=0;a<Math.PI*4;a+=.1){const n=10+a*8;t.lineTo(s+Math.cos(a)*n,i+Math.sin(a)*n)}t.stroke()}return new B(r)}function Wt(){const{canvas:r,ctx:t}=Z(256,256);if(!t)return new B(r);const e=["#cc7733","#dd9955","#bb6622","#eebb77","#aa5511","#ddaa66"];for(let s=0;s<256;s++){const i=Math.floor(s/(256/e.length))%e.length;t.fillStyle=e[i],t.fillRect(0,s,256,1)}return new B(r)}function Qt(){const{canvas:r,ctx:t}=Z(512,256);return t?(t.fillStyle="#2266aa",t.fillRect(0,0,512,256),t.fillStyle="#886644",t.beginPath(),t.ellipse(300,80,80,40,.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(280,150,30,50,.1,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(100,90,25,60,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(110,170,20,40,-.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(420,170,25,15,0,0,Math.PI*2),t.fill(),t.fillStyle="#447733",t.beginPath(),t.ellipse(290,75,40,20,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(95,85,15,30,.2,0,Math.PI*2),t.fill(),new B(r)):new B(r)}function Kt(){const{canvas:r,ctx:t}=Z(512,256);if(!t)return new B(r);t.clearRect(0,0,512,256),t.fillStyle="rgba(255,255,255,0.6)";for(let e=0;e<20;e++){const s=Math.random()*512,i=Math.random()*256;t.beginPath(),t.ellipse(s,i,20+Math.random()*40,8+Math.random()*15,Math.random()*Math.PI,0,Math.PI*2),t.fill()}return new B(r)}function Jt(){Q.clear(),K.clear(),J.clear(),U=null,Y=null}const te={planetTextureCache:Q,planetGeometryCache:K,planetMaterialCache:J,getBgStarsGeometry:()=>U,getBgStarsMaterial:()=>Y};function At(r,t,e){const s=new V;let i=null;switch(r){case 2:{const a=F("mercury",Xt),n=w("mercury:sphere",()=>new P(10,24,24)),o=A("mercury:mat",()=>new x({map:a})),h=T(n,o);s.add(h),i=h;break}case 3:{const a=F("venus",Vt),n=w("venus:sphere",()=>new P(14,24,24)),o=A("venus:mat",()=>new x({map:a})),h=T(n,o);s.add(h),i=h;break}case 5:{const a=F("jupiter",Wt),n=w("jupiter:sphere",()=>new P(20,24,24)),o=A("jupiter:mat",()=>new x({map:a})),h=T(n,o);s.add(h),i=h;break}case 6:{const a=w("saturn:sphere",()=>new P(15,24,24)),n=t.planetColor,o=A(`saturn:mat:${n}`,()=>new x({color:n})),h=T(a,o);s.add(h);const l=w("saturn:ring",()=>new yt(20,30,48)),c=A("saturn:ringMat",()=>new x({color:15645542,side:gt})),d=T(l,c);d.rotation.x=Math.PI/3,s.add(d),i=h;break}case 7:{const a=w("uranus:sphere",()=>new P(16,24,24)),n=A("uranus:mat",()=>new x({color:6737117})),o=T(a,n);s.add(o);const h=w("uranus:ring",()=>new yt(21,28,48)),l=A("uranus:ringMat",()=>new x({color:10083822,side:gt})),c=T(h,l);c.rotation.z=Math.PI/2,s.add(c),i=o;break}case 9:{const a=w("pluto:sphere",()=>new P(8,24,24)),n=A("pluto:mat",()=>new x({color:12298922})),o=T(a,n);s.add(o),i=o;break}case 10:{const a=w("sun:sphere",()=>new P(25,24,24)),n=A("sun:mat",()=>new x({color:16763904,emissive:16755200,emissiveIntensity:.5})),o=T(a,n);s.add(o),s.add(new $t(16763904,2,200)),i=o;break}case 11:{const a=F("earth",Qt),n=w("earth:sphere",()=>new P(15,32,32)),o=A("earth:mat",()=>new x({map:a})),h=F("earth:cloud",Kt),l=w("earth:cloudSphere",()=>new P(15.5,32,32)),c=A("earth:cloudMat",()=>new x({map:h,transparent:!0,opacity:.3})),d=new V;d.add(T(n,o)),d.add(T(l,c)),s.add(d),i=d;break}default:{const a=w("default:sphere",()=>new P(15,24,24)),n=t.planetColor,o=A(`default:mat:${n}`,()=>new x({color:n})),h=T(a,o);s.add(h),i=h;break}}return s.position.set(0,0,e),{planet:s,spinTarget:i}}function ee(r,t,e){return At(r,t,e)}function se(r){wt();const t=new ot(U,Y);return t.userData.sharedAssets=!0,t.geometry.setDrawRange(0,r),t}function ft(r){!Number.isInteger(r)||r<1||r>I||typeof document>"u"&&typeof OffscreenCanvas!="function"||(wt(),At(r,nt(r),0))}let z=null,$=null;function ie(){if(!z){const r=new rt,t=new Float32Array(3e3);for(let e=0;e<3e3;e++)t[e]=(Math.random()-.5)*200;r.setAttribute("position",new lt(t,3)),z=r}return z}function ae(){return $||($=new ht({color:16777215,size:.3,sizeAttenuation:!0})),$}function ne(){z=null,$=null}const oe={getBgStarsGeometry:()=>z,getBgStarsMaterial:()=>$};function re(r){const t=window.requestIdleCallback;if(typeof t=="function"){t(r,{timeout:1500});return}window.setTimeout(r,800)}function Tt(r){return new Set(r.filter(t=>Number.isInteger(t)&&t>=1&&t<=I)).size}function le(r){return Tt(r)>=I}function et(r){const t=le(r.unlockedPlanets),e=t?1:Math.min(r.clearedStage+1,I),s=nt(e),i=r.bestStageStars?.[e]??0;return t?{startStage:e,destination:s.destinationReading,emoji:s.emoji,statusLabel:"ぜんぶ あつめたよ！",destinationLabel:`${s.destinationReading}へ もういちど しゅっぱつ！`,buttonHint:`${s.emoji} ステージ ${e} から もういちど あそぶ`,bestStars:i}:{startStage:e,destination:s.destinationReading,emoji:s.emoji,statusLabel:r.clearedStage>0?"つづきから しゅっぱつ！":"はじめての しゅっぱつ！",destinationLabel:`${s.destinationReading}へ むかおう！`,buttonHint:`${s.emoji} ステージ ${e} から スタート`,bestStars:i}}function he(r){return r.clearedStage>0||Tt(r.unlockedPlanets)>0||Object.keys(r.bestStageStars??{}).length>0}class ce{threeScene;ambientLight=new ct(16777215,1);camera;lastAspect=0;sceneManager;saveManager;audioManager;stars=null;companionParade=null;overlay=null;muteHandle=null;tutorialOverlay=new mt;titleResetConfirmOverlay=new Yt;encyclopediaOverlay=null;encyclopediaOverlayPromise=null;companionFactory=null;companionFactoryPromise=null;loadEncyclopediaOverlay;loadTitleCompanionFactory;loadingOverlay;loadFailureOverlay;scheduleIdleTask;encyclopediaBtn=null;isOpeningEncyclopedia=!1;isActive=!1;encyclopediaRequestToken=0;companionParadeRequestToken=0;bgmPending=!1;overlayButtonCleanups=new Set;constructor(t,e,s,i={}){this.sceneManager=t,this.saveManager=e,this.audioManager=s,this.loadingOverlay=i.loadingOverlay??new Bt,this.loadFailureOverlay=i.loadFailureOverlay??new Ot,this.scheduleIdleTask=i.scheduleIdleTask??re,this.loadEncyclopediaOverlay=i.loadEncyclopediaOverlay??(()=>it(()=>import("./EncyclopediaOverlay-Bu7D_A5H.js"),__vite__mapDeps([0,1,2]))),this.loadTitleCompanionFactory=i.loadTitleCompanionFactory??(()=>it(()=>import("./game-core-RztmsZ0Q.js").then(o=>o.s),__vite__mapDeps([1,2]))),this.threeScene=new W,this.threeScene.background=new ut(32);const{width:a,height:n}=L();this.camera=new dt(60,a/n,.1,1e3),this.camera.position.set(0,0,5)}enter(t){this.isActive=!0,this.encyclopediaRequestToken+=1,this.companionParadeRequestToken+=1,this.lastAspect=0,this.stars=new ot(ie(),ae()),this.stars.userData.sharedAssets=!0,this.stars.rotation.set(0,0,0),this.threeScene.add(this.stars),this.ambientLight.parent||this.threeScene.add(this.ambientLight);const e=this.saveManager.load();this.createCompanionParade(e.unlockedPlanets),this.createOverlay(),this.createMuteButton(),this.prefetchEncyclopediaOnIdle(),this.prewarmNextAdventureOnIdle(et(e).startStage),this.audioManager.isInitialized()?(this.audioManager.playBGM(0),this.bgmPending=!1):this.bgmPending=!0,e.tutorialShown||this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide(),this.saveManager.markTutorialShown()})}createMuteButton(){const t=document.getElementById("hud")??document.getElementById("ui-overlay");t&&(this.muteHandle=pt({initialMuted:this.audioManager.isMuted(),container:t,onToggle:()=>{this.ensureTitleAudioInitialized(!0);const e=this.audioManager.toggleMute();this.muteHandle?.setMuted(e);const s=this.saveManager.load();s.muted=e,this.saveManager.save(s)}}))}getEncyclopediaOverlay(){return this.encyclopediaOverlay?Promise.resolve(this.encyclopediaOverlay):this.encyclopediaOverlayPromise?this.encyclopediaOverlayPromise:(this.encyclopediaOverlayPromise=this.loadEncyclopediaOverlay().then(({EncyclopediaOverlay:t})=>{const e=new t;return this.encyclopediaOverlay=e,e}).finally(()=>{this.encyclopediaOverlayPromise=null}),this.encyclopediaOverlayPromise)}getTitleCompanionFactory(){return this.companionFactory?Promise.resolve(this.companionFactory):this.companionFactoryPromise?this.companionFactoryPromise:(this.companionFactoryPromise=this.loadTitleCompanionFactory().then(t=>(this.companionFactory=t,t)).finally(()=>{this.companionFactoryPromise=null}),this.companionFactoryPromise)}showEncyclopedia(){if(!this.isActive||!this.encyclopediaOverlay)return;const t=this.saveManager.load();this.encyclopediaOverlay.show(t.unlockedPlanets,()=>this.refreshEncyclopediaButtonLabel(),e=>{this.ensureTitleAudioInitialized(!1),this.sceneManager.requestTransition("stage",{stageNumber:e,totalScore:0,totalStarCount:0,launchSource:"encyclopedia"})},t.bestStageStars??{})}isCurrentEncyclopediaRequest(t){return this.isActive&&this.encyclopediaRequestToken===t}prefetchEncyclopediaOnIdle(){const t=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{!this.isCurrentEncyclopediaRequest(t)||this.encyclopediaOverlay||this.encyclopediaOverlayPromise||this.getEncyclopediaOverlay().catch(()=>{})})}prewarmNextAdventureOnIdle(t){if(t>I)return;const e=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{this.isCurrentEncyclopediaRequest(e)&&ft(t)})}async openEncyclopedia(){if(!this.isActive)return;if(this.loadFailureOverlay.hide(),this.encyclopediaOverlay){this.showEncyclopedia();return}if(this.isOpeningEncyclopedia)return;const t=this.encyclopediaRequestToken;this.isOpeningEncyclopedia=!0,this.loadingOverlay.show("ずかんを よんでるよ...");try{if(await this.getEncyclopediaOverlay(),!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),this.showEncyclopedia()}catch(e){if(!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),console.error("Failed to load encyclopedia overlay",e),this.loadFailureOverlay.show({title:"ずかんの じゅんびが できなかったよ",message:"「もういちど よむ」を おしてね",primaryAction:{label:"もういちど よむ",onSelect:()=>this.openEncyclopedia()}})}finally{this.encyclopediaRequestToken===t&&(this.isOpeningEncyclopedia=!1)}}createOverlay(){const t=document.getElementById("ui-overlay");if(!t)return;const e=this.saveManager.load(),s=et(e);this.overlay=document.createElement("div"),this.overlay.style.cssText=`
    ...
    `;const c=document.createElement("div");c.textContent=s.destinationLabel,c.style.cssText=`
      ...
      font-weight: 700;
      color: rgba(255, 255, 255, 0.92);
    `;const d=Ct(s.startStage,s.bestStars),y=at(s.startStage,s.bestStars,{label:"メダル",hint:d.nextThreshold===null?"かんぺき！":`${d.icon} いま ・ つぎ ⭐ ${d.nextThreshold}`,size:"regular",scope:"title-next-adventure"});y.style.marginTop="0.7rem",n.appendChild(o),n.appendChild(h),n.appendChild(l),n.appendChild(c),n.appendChild(y);const m=document.createElement("div");m.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      gap: 0.65rem;
    ...
    `;const C=document.createElement("button");C.textContent="あそびかた",C.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,C.style.position="absolute",C.style.bottom=i?"1rem":"2rem",C.style.right=i?"1rem":"2rem",this.overlayButtonCleanups.add(D(C,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide()})},onPressChange:v=>{C.style.transform=v?"scale(0.96)":"scale(1)"}}));const b=document.createElement("button");if(b.textContent=bt(e.unlockedPlanets.length,N.length),b.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${i?"0.95rem":"1.2rem"};
      font-weight: 700;
      padding: ${i?"0.4rem 1rem":"0.6rem 1.5rem"};
    ...
    `,i.appendChild(n);const o=document.createElement("div");o.style.cssText=`
      ...
      align-items: stretch;
      width: 100%;
    `,i.appendChild(o);const h=(l,c,d,y,m,f)=>{const p=document.createElement("button");p.setAttribute(c,""),p.setAttribute("aria-label",d),p.textContent=l,p.style.cssText=`
        flex: 1 1 140px;
        padding: 1rem 1.2rem;
        border: none;
        border-radius: 1.6rem;
    ...
    `,this.overlay.appendChild(i),this.overlay.appendChild(a),this.overlay.appendChild(n),this.overlay.appendChild(this.exitCta),s.appendChild(this.overlay)}update(t){this.bgStars&&(this.bgStars.rotation.y+=t*.03),this.updateCelebration(t)}setupCelebration(){this.companionGroup=new V,this.companionMeshes=[],this.circleX.length=0,this.circleZ.length=0,this.popinSettled.length=0,this.celebrationElapsed=0,this.thankYouShown=!1,this.canExit=!1,this.exitTriggered=!1;for(let t=0;t<N.length;t++){const e=N[t],s=St.createCompanionMesh(e),i=t*(2*Math.PI/N.length),a=Math.cos(i)*M.CIRCLE_RADIUS,n=Math.sin(i)*M.CIRCLE_RADIUS;this.circleX.push(a),this.circleZ.push(n),s.position.set(a,0,n),s.scale.set(0,0,0),this.companionMeshes.push(s),this.popinSettled.push(!1),this.companionGroup.add(s)}this.threeScene.add(this.companionGroup)}updateCelebration(t){if(this.companionMeshes.length===0)return;this.celebrationElapsed+=t;const e=M.POPIN_DELAY*(this.companionMeshes.length-1)+M.POPIN_DURATION,s=this.celebrationElapsed>e,i=s?Math.abs(Math.sin(this.celebrationElapsed*M.BOUNCE_SPEED))*M.BOUNCE_HEIGHT:0;for(let a=0;a<this.companionMeshes.length;a++){const n=this.companionMeshes[a];if(this.popinSettled[a]){s&&(n.position.y=i),n.rotation.y+=t*2;continue}const o=a*M.POPIN_DELAY;if(!(this.celebrationElapsed<o)){if(this.celebrationElapsed<o+M.POPIN_DURATION){const h=(this.celebrationElapsed-o)/M.POPIN_DURATION,l=this.bounceEase(h);n.scale.set(l,l,l)}else n.scale.set(1,1,1),this.popinSettled[a]=!0;s&&(n.position.y=i),n.rotation.y+=t*2}}!this.thankYouShown&&this.celebrationElapsed>=M.THANK_YOU_DELAY&&(this.showThankYouText(),this.thankYouShown=!0)}bounceEase(t){return t<.6?t/.6*1.2:1.2-(t-.6)/.4*.2}showThankYouText(){if(!this.overlay||!this.exitCta)return;const t=document.createElement("div");t.setAttribute("data-ending-thank-you",""),t.textContent="みんな ありがとう！",t.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: 2rem;
      font-weight: 900;
      color: #FFD700;
