const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-DKU4a1Ny.js","assets/game-core-B3fzniSi.js","assets/three-CCkbs3tE.js"])))=>i.map(i=>d[i]);
import{g as Q,D as ft,S as G,T as D,a as ot,b as Rt,L as $t,c as jt,_ as mt,d as L,e as F,s as Dt,f as J,P as j,u as Ht,C as Ut,h as Zt,i as qt,B as Wt,j as Yt,M as Vt,k as Xt,l as Qt,m as Kt,n as Jt,o as te,p as ee,q as se,r as ie,t as ae,v as ne,A as oe,w as re,x as le,y as he,z as Lt,E as ce,F as de,R as ue,G as me,H as pe,I as fe,J as ge,K as Tt,N as ye,O as be,Q as rt,U as K,V as ve,W as lt,X as ht,Y as Ee,Z as Se,$ as Ce}from"./game-core-B3fzniSi.js";import{m as gt,k as yt,i as bt,l as vt,G as tt,q as xe,a as we,r as Ae,M as P,g as R,D as Mt,R as Pt,s as H,t as Et,u as et,h as St,P as Ct,V as $,v as Te,w as Me}from"./three-CCkbs3tE.js";class xt{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const e=document.getElementById("ui-overlay");if(!e)return;const s=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
    ...
    `,this.buttonCleanups.add(T(h,{onActivate:()=>{const d={...this.draft};this.hide(),t.onComplete(d)},onPressChange:d=>{h.style.transform=d?"scale(0.96)":"scale(1)"}})),s.appendChild(h),e.appendChild(this.overlay),this.render()}hide(){const t=Array.from(this.buttonCleanups);this.buttonCleanups.clear();for(const e of t)e();this.optionButtons.clear(),this.overlay?.remove(),this.overlay=null,this.previewBody=null,this.previewNose=null,this.previewWings=null}isVisible(){return this.overlay?.isConnected===!0}createPreviewCard(){const t=document.createElement("div");t.setAttribute("data-spaceship-customizer-preview-card",""),t.style.cssText=`
      ...
      box-shadow: inset 0 0 0 2px rgba(255, 255, 255, 0.12);
    `;const e=document.createElement("div");e.textContent="プレビュー",e.style.cssText="margin-bottom: 0.45rem; font-size: 0.9rem; font-weight: 700; color: #dff4ff;",t.appendChild(e);const s=document.createElement("div");s.setAttribute("data-spaceship-customizer-preview",""),s.style.cssText=`
      position: relative;
      width: min(100%, 14rem);
      height: 8.8rem;
      margin: 0 auto;
    ...
    `,s.appendChild(this.previewWings),s.appendChild(this.previewBody),s.appendChild(this.previewNose),s.appendChild(a),t.appendChild(s),t}createPartSection(t,e){const s=document.createElement("div");s.style.cssText=`
      ...
      background: rgba(255, 255, 255, 0.08);
      text-align: left;
    `;const i=document.createElement("div");i.textContent=e,i.style.cssText="margin-bottom: 0.4rem; font-size: 0.95rem; font-weight: 900; color: #ffe66d; text-align: center;",s.appendChild(i);const a=document.createElement("div");a.style.cssText="display: grid; grid-template-columns: minmax(0, 1fr); gap: 0.45rem;";for(const n of this.colorOptions)a.appendChild(this.createColorButton(t,n));return s.appendChild(a),s}createColorButton(t,e){const s=document.createElement("button");s.type="button",s.setAttribute("data-spaceship-color-option",`${t}:${e.key}`),s.style.cssText=`
      width: 100%;
      min-height: 58px;
    ...
    `;const r=Array.from({length:D},(c,m)=>m+1).map(c=>({stageNumber:c,clearCount:i.stageClearCounts[c]??0})).filter(c=>c.clearCount>0);if(r.length===0){const c=document.createElement("div");c.textContent="まだ きろくが ないよ",c.style.cssText=`
      ...
      `,p.appendChild(c)}else for(const{stageNumber:c,clearCount:m}of r){const E=ot(c),S=document.createElement("div");S.setAttribute("data-stats-stage-clear-row",String(c)),S.style.cssText=`
          ...
          font-weight: 700;
        `;const w=document.createElement("span");w.textContent=`${E.emoji} ステージ ${c} ${E.destinationReading}`;const C=document.createElement("span");C.textContent=`${m}かい`,C.style.color="#FFE66D",S.append(w,C),p.appendChild(S)}u.appendChild(p),o.appendChild(u);const f=document.createElement("button");f.textContent="もどる",f.style.cssText=`
      margin-top: 1rem;
  ...
  `,n.appendChild(d),n}const kt=2e3,st=new Map,it=new Map,at=new Map;let Y=null,V=null;function X(l,t){if(typeof document>"u"){const s=typeof OffscreenCanvas=="function",i=s?new OffscreenCanvas(l,t):{width:l,height:t};return{canvas:i,ctx:s?i.getContext("2d"):null}}const e=document.createElement("canvas");return e.width=l,e.height=t,{canvas:e,ctx:e.getContext("2d")}}function _(l,t){let e=st.get(l);return e||(e=t(),e.generateMipmaps=!1,e.minFilter=Ae,e.needsUpdate=!0,st.set(l,e)),e}function B(l,t){let e=it.get(l);return e||(e=t(),it.set(l,e)),e}function k(l,t){let e=at.get(l);return e||(e=t(),at.set(l,e)),e}function O(l,t){const e=new we(l,t);return e.userData.sharedAssets=!0,e}function zt(){if(!Y){const l=new yt,t=new Float32Array(kt*3);for(let e=0;e<kt*3;e+=3)t[e]=(Math.random()-.5)*200,t[e+1]=(Math.random()-.5)*200,t[e+2]=(Math.random()-.5)*400;l.setAttribute("position",new bt(t,3)),Y=l}V||(V=new vt({color:16777215,size:.2,sizeAttenuation:!0}))}function He(){const{canvas:l,ctx:t}=X(256,256);if(!t)return new H(l);t.fillStyle="#888888",t.fillRect(0,0,256,256);for(let e=0;e<30;e++){const s=Math.random()*256,i=Math.random()*256,a=3+Math.random()*12;t.beginPath(),t.arc(s,i,a,0,Math.PI*2),t.fillStyle=`rgba(60,60,60,${.3+Math.random()*.4})`,t.fill()}return new H(l)}function Le(){const{canvas:l,ctx:t}=X(256,256);if(!t)return new H(l);t.fillStyle="#ddaa44",t.fillRect(0,0,256,256);for(let e=0;e<8;e++){t.beginPath();const s=128+(Math.random()-.5)*100,i=128+(Math.random()-.5)*100;t.strokeStyle=`rgba(200,150,60,${.3+Math.random()*.3})`,t.lineWidth=3+Math.random()*5;for(let a=0;a<Math.PI*4;a+=.1){const n=10+a*8;t.lineTo(s+Math.cos(a)*n,i+Math.sin(a)*n)}t.stroke()}return new H(l)}function ze(){const{canvas:l,ctx:t}=X(256,256);if(!t)return new H(l);const e=["#cc7733","#dd9955","#bb6622","#eebb77","#aa5511","#ddaa66"];for(let s=0;s<256;s++){const i=Math.floor(s/(256/e.length))%e.length;t.fillStyle=e[i],t.fillRect(0,s,256,1)}return new H(l)}function Ge(){const{canvas:l,ctx:t}=X(512,256);return t?(t.fillStyle="#2266aa",t.fillRect(0,0,512,256),t.fillStyle="#886644",t.beginPath(),t.ellipse(300,80,80,40,.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(280,150,30,50,.1,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(100,90,25,60,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(110,170,20,40,-.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(420,170,25,15,0,0,Math.PI*2),t.fill(),t.fillStyle="#447733",t.beginPath(),t.ellipse(290,75,40,20,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(95,85,15,30,.2,0,Math.PI*2),t.fill(),new H(l)):new H(l)}function Fe(){const{canvas:l,ctx:t}=X(512,256);if(!t)return new H(l);t.clearRect(0,0,512,256),t.fillStyle="rgba(255,255,255,0.6)";for(let e=0;e<20;e++){const s=Math.random()*512,i=Math.random()*256;t.beginPath(),t.ellipse(s,i,20+Math.random()*40,8+Math.random()*15,Math.random()*Math.PI,0,Math.PI*2),t.fill()}return new H(l)}function Ne(){st.clear(),it.clear(),at.clear(),Y=null,V=null}const _e={planetTextureCache:st,planetGeometryCache:it,planetMaterialCache:at,getBgStarsGeometry:()=>Y,getBgStarsMaterial:()=>V};function Gt(l,t,e){const s=new tt;let i=null;switch(l){case 2:{const a=_("mercury",He),n=B("mercury:sphere",()=>new R(10,24,24)),o=k("mercury:mat",()=>new P({map:a})),h=O(n,o);s.add(h),i=h;break}case 3:{const a=_("venus",Le),n=B("venus:sphere",()=>new R(14,24,24)),o=k("venus:mat",()=>new P({map:a})),h=O(n,o);s.add(h),i=h;break}case 5:{const a=_("jupiter",ze),n=B("jupiter:sphere",()=>new R(20,24,24)),o=k("jupiter:mat",()=>new P({map:a})),h=O(n,o);s.add(h),i=h;break}case 6:{const a=B("saturn:sphere",()=>new R(15,24,24)),n=t.planetColor,o=k(`saturn:mat:${n}`,()=>new P({color:n})),h=O(a,o);s.add(h);const d=B("saturn:ring",()=>new Pt(20,30,48)),u=k("saturn:ringMat",()=>new P({color:15645542,side:Mt})),g=O(d,u);g.rotation.x=Math.PI/3,s.add(g),i=h;break}case 7:{const a=B("uranus:sphere",()=>new R(16,24,24)),n=k("uranus:mat",()=>new P({color:6737117})),o=O(a,n);s.add(o);const h=B("uranus:ring",()=>new Pt(21,28,48)),d=k("uranus:ringMat",()=>new P({color:10083822,side:Mt})),u=O(h,d);u.rotation.z=Math.PI/2,s.add(u),i=o;break}case 9:{const a=B("pluto:sphere",()=>new R(8,24,24)),n=k("pluto:mat",()=>new P({color:12298922})),o=O(a,n);s.add(o),i=o;break}case 10:{const a=B("sun:sphere",()=>new R(25,24,24)),n=k("sun:mat",()=>new P({color:16763904,emissive:16755200,emissiveIntensity:.5})),o=O(a,n);s.add(o),s.add(new xe(16763904,2,200)),i=o;break}case 11:{const a=_("earth",Ge),n=B("earth:sphere",()=>new R(15,32,32)),o=k("earth:mat",()=>new P({map:a})),h=_("earth:cloud",Fe),d=B("earth:cloudSphere",()=>new R(15.5,32,32)),u=k("earth:cloudMat",()=>new P({map:h,transparent:!0,opacity:.3})),g=new tt;g.add(O(n,o)),g.add(O(d,u)),s.add(g),i=g;break}default:{const a=B("default:sphere",()=>new R(15,24,24)),n=t.planetColor,o=k(`default:mat:${n}`,()=>new P({color:n})),h=O(a,o);s.add(h),i=h;break}}return s.position.set(0,0,e),{planet:s,spinTarget:i}}function $e(l,t,e){return Gt(l,t,e)}function je(l){zt();const t=new gt(Y,V);return t.userData.sharedAssets=!0,t.geometry.setDrawRange(0,l),t}function At(l){!Number.isInteger(l)||l<1||l>D||typeof document>"u"&&typeof OffscreenCanvas!="function"||(zt(),Gt(l,ot(l),0))}let U=null,Z=null;function Ue(){if(!U){const l=new yt,t=new Float32Array(3e3);for(let e=0;e<3e3;e++)t[e]=(Math.random()-.5)*200;l.setAttribute("position",new bt(t,3)),U=l}return U}function Ze(){return Z||(Z=new vt({color:16777215,size:.3,sizeAttenuation:!0})),Z}function qe(){U=null,Z=null}const We={getBgStarsGeometry:()=>U,getBgStarsMaterial:()=>Z};function Ye(l){const t=window.requestIdleCallback;if(typeof t=="function"){t(l,{timeout:1500});return}window.setTimeout(l,800)}function Ft(l){return new Set(l.filter(t=>Number.isInteger(t)&&t>=1&&t<=D)).size}function Ve(l){return Ft(l)>=D}function ct(l){const t=Ve(l.unlockedPlanets),e=t?1:Math.min(l.clearedStage+1,D),s=ot(e),i=l.bestStageStars?.[e]??0;return t?{startStage:e,destination:s.destinationReading,emoji:s.emoji,statusLabel:"ぜんぶ あつめたよ！",destinationLabel:`${s.destinationReading}へ もういちど しゅっぱつ！`,buttonHint:`${s.emoji} ステージ ${e} から もういちど あそぶ`,bestStars:i}:{startStage:e,destination:s.destinationReading,emoji:s.emoji,statusLabel:l.clearedStage>0?"つづきから しゅっぱつ！":"はじめての しゅっぱつ！",destinationLabel:`${s.destinationReading}へ むかおう！`,buttonHint:`${s.emoji} ステージ ${e} から スタート`,bestStars:i}}function Xe(l){return l.clearedStage>0||Ft(l.unlockedPlanets)>0||Object.keys(l.bestStageStars??{}).length>0}class Qe{threeScene;ambientLight=new Et(16777215,1);camera;lastAspect=0;sceneManager;saveManager;audioManager;stars=null;companionParade=null;overlay=null;muteHandle=null;tutorialOverlay=new xt;titleResetConfirmOverlay=new Pe;colorAccessibilitySettings=new Be;spaceshipCustomizer=new ke;statsOverlay=new Re;encyclopediaOverlay=null;encyclopediaOverlayPromise=null;companionFactory=null;companionFactoryPromise=null;loadEncyclopediaOverlay;loadTitleCompanionFactory;loadingOverlay;loadFailureOverlay;scheduleIdleTask;encyclopediaBtn=null;isOpeningEncyclopedia=!1;isActive=!1;encyclopediaRequestToken=0;companionParadeRequestToken=0;bgmPending=!1;overlayButtonCleanups=new Set;constructor(t,e,s,i={}){this.sceneManager=t,this.saveManager=e,this.audioManager=s,this.loadingOverlay=i.loadingOverlay??new $t,this.loadFailureOverlay=i.loadFailureOverlay??new jt,this.scheduleIdleTask=i.scheduleIdleTask??Ye,this.loadEncyclopediaOverlay=i.loadEncyclopediaOverlay??(()=>mt(()=>import("./EncyclopediaOverlay-DKU4a1Ny.js"),__vite__mapDeps([0,1,2]))),this.loadTitleCompanionFactory=i.loadTitleCompanionFactory??(()=>mt(()=>import("./game-core-B3fzniSi.js").then(o=>o.a6),__vite__mapDeps([1,2]))),this.threeScene=new et,this.threeScene.background=new St(32);const{width:a,height:n}=L();this.camera=new Ct(60,a/n,.1,1e3),this.camera.position.set(0,0,5)}enter(t){this.isActive=!0,this.encyclopediaRequestToken+=1,this.companionParadeRequestToken+=1,this.lastAspect=0,this.stars=new gt(Ue(),Ze()),this.stars.userData.sharedAssets=!0,this.stars.rotation.set(0,0,0),this.threeScene.add(this.stars),this.ambientLight.parent||this.threeScene.add(this.ambientLight);const e=this.saveManager.load();this.createCompanionParade(e.unlockedPlanets),this.createOverlay(),this.createMuteButton(),this.prefetchEncyclopediaOnIdle(),this.prewarmNextAdventureOnIdle(ct(e).startStage),this.audioManager.isInitialized()?(this.audioManager.playBGM(0),this.bgmPending=!1):this.bgmPending=!0,e.tutorialShown||this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide(),this.saveManager.markTutorialShown()})}createMuteButton(){const t=document.getElementById("hud")??document.getElementById("ui-overlay");t&&(this.muteHandle=wt({initialMuted:this.audioManager.isMuted(),container:t,onToggle:()=>{this.ensureTitleAudioInitialized(!0);const e=this.audioManager.toggleMute();this.muteHandle?.setMuted(e);const s=this.saveManager.load();s.muted=e,this.saveManager.save(s)}}))}getEncyclopediaOverlay(){return this.encyclopediaOverlay?Promise.resolve(this.encyclopediaOverlay):this.encyclopediaOverlayPromise?this.encyclopediaOverlayPromise:(this.encyclopediaOverlayPromise=this.loadEncyclopediaOverlay().then(({EncyclopediaOverlay:t})=>{const e=new t;return this.encyclopediaOverlay=e,e}).finally(()=>{this.encyclopediaOverlayPromise=null}),this.encyclopediaOverlayPromise)}getTitleCompanionFactory(){return this.companionFactory?Promise.resolve(this.companionFactory):this.companionFactoryPromise?this.companionFactoryPromise:(this.companionFactoryPromise=this.loadTitleCompanionFactory().then(t=>(this.companionFactory=t,t)).finally(()=>{this.companionFactoryPromise=null}),this.companionFactoryPromise)}showEncyclopedia(){if(!this.isActive||!this.encyclopediaOverlay)return;const t=this.saveManager.load();this.encyclopediaOverlay.show(t.unlockedPlanets,()=>this.refreshEncyclopediaButtonLabel(),e=>{this.ensureTitleAudioInitialized(!1),this.sceneManager.requestTransition("stage",{stageNumber:e,totalScore:0,totalStarCount:0,launchSource:"encyclopedia"})},t.bestStageStars??{},t.discoveredConstellations??[])}isCurrentEncyclopediaRequest(t){return this.isActive&&this.encyclopediaRequestToken===t}prefetchEncyclopediaOnIdle(){const t=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{!this.isCurrentEncyclopediaRequest(t)||this.encyclopediaOverlay||this.encyclopediaOverlayPromise||this.getEncyclopediaOverlay().catch(()=>{})})}prewarmNextAdventureOnIdle(t){if(t>D)return;const e=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{this.isCurrentEncyclopediaRequest(e)&&At(t)})}async openEncyclopedia(){if(!this.isActive)return;if(this.loadFailureOverlay.hide(),this.encyclopediaOverlay){this.showEncyclopedia();return}if(this.isOpeningEncyclopedia)return;const t=this.encyclopediaRequestToken;this.isOpeningEncyclopedia=!0,this.loadingOverlay.show("ずかんを よんでるよ...");try{if(await this.getEncyclopediaOverlay(),!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),this.showEncyclopedia()}catch(e){if(!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),console.error("Failed to load encyclopedia overlay",e),this.loadFailureOverlay.show({title:"ずかんを もういちど よんでみよう！",message:"「もういちど よむ」を おして つづきを たのしもう！",primaryAction:{label:"もういちど よむ",onSelect:()=>this.openEncyclopedia()}})}finally{this.encyclopediaRequestToken===t&&(this.isOpeningEncyclopedia=!1)}}persistHighContrastSetting(t){const e=this.saveManager.load(),s=e.colorAccessibility?.motionSensitivity??F;e.colorAccessibility=this.buildColorAccessibilitySettings(t,s),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}persistVibrationIntensitySetting(t){const e=this.saveManager.load();e.vibrationSettings={intensity:t},this.saveManager.save(e),Dt(t)}persistMotionSensitivitySetting(t){const e=this.saveManager.load(),s=e.colorAccessibility?.highContrast===!0;e.colorAccessibility=this.buildColorAccessibilitySettings(s,t),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}buildColorAccessibilitySettings(t,e){if(!(!t&&e===F))return{...t?{highContrast:!0}:{},...e!==F?{motionSensitivity:e}:{}}}createOverlay(){const t=document.getElementById("ui-overlay");if(!t)return;const e=this.saveManager.load(),s=ct(e);this.overlay=document.createElement("div"),this.overlay.style.cssText=`
    ...
    `;const u=document.createElement("div");u.textContent=s.destinationLabel,u.style.cssText=`
      ...
      font-weight: 700;
      color: rgba(255, 255, 255, 0.92);
    `;const g=Rt(s.startStage,s.bestStars),p=pt(s.startStage,s.bestStars,{label:"メダル",hint:g.nextThreshold===null?"かんぺき！":`${g.icon} いま ・ つぎ ⭐ ${g.nextThreshold}`,size:"regular",scope:"title-next-adventure"});p.style.marginTop="0.7rem",n.appendChild(o),n.appendChild(h),n.appendChild(d),n.appendChild(u),n.appendChild(p);const r=document.createElement("div");r.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      gap: 0.65rem;
    ...
    `,this.overlayButtonCleanups.add(T(w,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.colorAccessibilitySettings.show({initialHighContrast:this.saveManager.load().colorAccessibility?.highContrast===!0,initialVibrationIntensity:this.saveManager.load().vibrationSettings?.intensity??"medium",initialMotionSensitivity:this.saveManager.load().colorAccessibility?.motionSensitivity??F,onToggle:b=>this.persistHighContrastSetting(b),onVibrationIntensityChange:b=>this.persistVibrationIntensitySetting(b),onMotionSensitivityChange:b=>this.persistMotionSensitivitySetting(b)})},onPressChange:b=>{w.style.transform=b?"translateX(-50%) scale(0.96)":"translateX(-50%) scale(1)"}}));const C=document.createElement("button");if(C.textContent=Bt(e.unlockedPlanets.length,j.length),C.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,C.style.position="absolute",C.style.bottom=i?"1rem":"2rem",C.style.left=i?"1rem":"2rem",this.encyclopediaBtn=C,this.overlayButtonCleanups.add(T(C,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.openEncyclopedia()},onPressChange:b=>{C.style.transform=b?"scale(0.96)":"scale(1)"}})),r.appendChild(f),r.appendChild(c),r.appendChild(m),r.appendChild(E),Xe(e)){const b=document.createElement("button");b.setAttribute("data-reset-progress-button",""),b.textContent="さいしょから",b.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: 1.15rem;
        font-weight: 900;
    ...
    `);n.setAttribute("data-stage-clear-next-name","");const o=this.createHeading(t.trivia,`
      ...
      color: #dfeaff;
      line-height: 1.35;
    `);return o.setAttribute("data-stage-clear-next-trivia",""),e.append(s,i,a,n,o),e}createActionButtons(t){const e=document.createElement("div");e.setAttribute("data-stage-clear-actions",""),e.style.cssText=`
      display: flex;
      flex-direction: row;
      align-items: stretch;
      justify-content: center;
