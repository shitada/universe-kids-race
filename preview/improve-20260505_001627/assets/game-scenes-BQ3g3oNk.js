const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-A9JPDQLe.js","assets/game-core-D0-SjBGp.js","assets/three-CHPsZt9E.js"])))=>i.map(i=>d[i]);
import{D as rt,S as G,g as wt,T as H,a as lt,L as It,b as kt,_ as nt,c as _,d as V,P as F,u as Dt,C as Ht,e as Lt,f as _t,B as Gt,h as zt,i as Nt,j as Ft,A as $t,k as At,l as jt,m as Ut,n as et,t as st,o as qt,s as Zt,p as Yt}from"./game-core-D0-SjBGp.js";import{m as ht,k as ct,i as dt,l as ut,G as W,n as Xt,a as Vt,o as Wt,M as A,g as k,D as vt,R as Ct,p as D,q as mt,r as Q,h as pt,P as ft,V as Tt,s as Qt}from"./three-CHPsZt9E.js";class gt{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const s=document.getElementById("ui-overlay");if(!s)return;const e=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
    ...
    `;const r=document.createElement("div");return r.textContent=e,r.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${a?"0.8rem":"0.9rem"};
      color: rgba(255, 255, 255, 0.7);
    `,o.appendChild(n),o.appendChild(h),o.appendChild(r),o}isCompactHeight(){return window.innerHeight<=gt.COMPACT_HEIGHT_THRESHOLD}injectAnimations(){if(document.getElementById("tutorial-animations"))return;const t=document.createElement("style");t.id="tutorial-animations",t.textContent=`
      @keyframes swipe {
    ...
    `,document.head.appendChild(t)}}class Kt{overlayEl=null;activePressCleanups=new Set;show(t,s){if(this.overlayEl)return;const e=document.getElementById("ui-overlay");if(!e)return;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-title-reset-confirm-overlay",""),this.overlayEl.setAttribute("role","dialog"),this.overlayEl.setAttribute("aria-modal","true"),this.overlayEl.setAttribute("aria-label","さいしょからに もどしますか"),this.overlayEl.style.cssText=`
      ...
      padding: 1.5rem;
      background: rgba(0, 0, 32, 0.92);
    `;let i=!1;const a=()=>{i||(i=!0,this.hide(),s())},o=()=>{i||(i=!0,this.hide(),t())};this.overlayEl.addEventListener("pointerdown",f=>{f.target===this.overlayEl&&a()});const n=document.createElement("div");n.setAttribute("data-title-reset-confirm-card",""),n.style.cssText=`
      ...
      text-align: center;
      color: #fff;
    `,n.addEventListener("pointerdown",f=>{f.stopPropagation()}),this.overlayEl.appendChild(n);const h=document.createElement("div");h.textContent="さいしょからに する？",h.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: 1.7rem;
      font-weight: 900;
      color: #FFD700;
    ...
    `,n.appendChild(h);const r=document.createElement("div");r.textContent="いまの すすみぐあいだけ きえて、ステージ 1 から あそべるよ",r.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: 1rem;
      font-weight: 700;
      line-height: 1.5;
    ...
    `,n.appendChild(r);const d=document.createElement("div");d.style.cssText=`
      display: flex;
      gap: 0.8rem;
      justify-content: center;
      flex-wrap: wrap;
    `,n.appendChild(d);const m=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: 1.1rem;
      font-weight: 900;
      min-width: 88px;
      ...
      white-space: nowrap;
    `,u=(f,x)=>{let v=!1,S=!1;const E=()=>{I(!0)},b=()=>{f.style.transform="scale(0.92)"},O=()=>{f.style.transform="scale(1)"},I=(w=!1)=>{v=!1,S=w,O(),this.activePressCleanups.delete(E),document.removeEventListener("pointerup",y,!0),document.removeEventListener("pointercancel",C,!0)},y=w=>{const z=w.target===f||w.target instanceof Node&&f.contains(w.target),Rt=v&&z;I(!z),Rt&&x()},C=()=>{I(!0)};f.addEventListener("pointerdown",w=>{w.stopPropagation(),v=!0,S=!1,b(),this.activePressCleanups.add(E),document.addEventListener("pointerup",y,!0),document.addEventListener("pointercancel",C,!0)}),f.addEventListener("pointerenter",()=>{v&&b()}),f.addEventListener("pointerleave",()=>{v&&O()}),f.addEventListener("pointercancel",()=>I(!0)),f.addEventListener("click",w=>{if(w.stopPropagation(),S){S=!1;return}v||x()})},c=document.createElement("button");c.setAttribute("data-title-reset-cancel",""),c.textContent="やめる",c.style.cssText=m,c.style.background="rgba(255, 255, 255, 0.18)",c.style.color="#ffffff",u(c,a),d.appendChild(c);const g=document.createElement("button");g.setAttribute("data-title-reset-confirm",""),g.textContent="うん！ さいしょから",g.style.cssText=m,g.style.background="linear-gradient(135deg, #FF9F68, #FFE66D)",g.style.color="#3b1f00",u(g,o),d.appendChild(g),e.appendChild(this.overlayEl)}hide(){if(!this.overlayEl)return;const t=Array.from(this.activePressCleanups);this.activePressCleanups.clear();for(const s of t)s();this.overlayEl.remove(),this.overlayEl=null}}function yt(l){const t=l.topRem??.8,s=window.innerHeight<=500,e=document.createElement("button");let i=l.initialMuted;const a=()=>{e.textContent=i?"🔇":"🔊",e.setAttribute("aria-label",i?"サウンド オフ":"サウンド オン")};e.setAttribute("data-mute-button",""),e.style.position="absolute",e.style.top=`${t}rem`,e.style.right="1rem",e.style.fontSize=s?"clamp(1.1rem, 3.5vmin, 1.4rem)":"clamp(1.4rem, 4vmin, 1.8rem)",e.style.background="rgba(255, 255, 255, 0.15)",e.style.border="none",e.style.borderRadius="50%",e.style.width=s?"2.4rem":"3rem",e.style.height=s?"2.4rem":"3rem",e.style.display="flex",e.style.alignItems="center",e.style.justifyContent="center",e.style.cursor="pointer",e.style.pointerEvents="auto",e.style.touchAction="manipulation",e.style.transform="scale(1)",e.style.transition="transform 0.08s ease-out",a();const o=()=>{e.style.transform="scale(1)"};return e.addEventListener("pointerdown",n=>{n.stopPropagation(),e.style.transform="scale(0.9)",l.onToggle()}),e.addEventListener("pointerup",o),e.addEventListener("pointercancel",o),e.addEventListener("pointerleave",o),l.container.appendChild(e),{element:e,setMuted(n){i=n,a()},remove(){e.remove()}}}class Jt{overlay=null;toggleButton=null;descriptionEl=null;highContrast=!1;show(t){const s=document.getElementById("ui-overlay");if(s){if(this.highContrast=t.initialHighContrast,!this.overlay){this.overlay=document.createElement("div"),this.overlay.setAttribute("data-color-accessibility-settings",""),this.overlay.style.cssText=`
        position: absolute;
        inset: 0;
        display: flex;
        align-items: center;
      ...
      `,this.toggleButton.addEventListener("click",()=>{this.highContrast=!this.highContrast,this.render(),t.onToggle(this.highContrast)});const a=document.createElement("button");a.textContent="とじる",a.style.cssText=`
        ...
        cursor: pointer;
        touch-action: manipulation;
      `,a.addEventListener("click",()=>this.hide()),e.appendChild(i),e.appendChild(this.descriptionEl),e.appendChild(this.toggleButton),e.appendChild(a),this.overlay.appendChild(e)}this.render(),s.appendChild(this.overlay)}}hide(){this.overlay?.remove()}isVisible(){return this.overlay?.isConnected===!0}render(){!this.toggleButton||!this.descriptionEl||(this.descriptionEl.textContent=this.highContrast?"いろだけじゃなく ふちや しまもようで わかりやすくしているよ。":"いろだけでなく かたちや うごきでも みわけられるようにするよ。",this.toggleButton.textContent=this.highContrast?"みやすくする: ON":"みやすくする: OFF",this.toggleButton.setAttribute("aria-pressed",this.highContrast?"true":"false"))}}function R(l,t){let s=!1,e=!1,i=null,a=null;const o=t.documentTarget??document,n=t.stopPropagation??!0,h=()=>{t.canActivate?.()!==!1&&t.onActivate()},r=y=>{t.onPressChange?.(y)},d=y=>{const C=y;return typeof C.clientX=="number"&&typeof C.clientY=="number"?{x:C.clientX,y:C.clientY}:null},m=y=>{const C=y;return typeof C.pointerId=="number"?C.pointerId:null},u=y=>{const C=m(y);return i===null||C===null||C===i},c=y=>{if(!s||a===null||t.moveTolerancePx===void 0)return!1;const C=d(y);return C===null?!1:Math.hypot(C.x-a.x,C.y-a.y)>t.moveTolerancePx},g=y=>{s=!1,e=y,i=null,a=null,r(!1),o.removeEventListener("pointermove",v,!0),o.removeEventListener("pointerup",f,!0),o.removeEventListener("pointercancel",x,!0)},f=y=>{if(!s||!u(y))return;if(c(y)){g(!0);return}const C=y.target,w=C===l||C instanceof Node&&l.contains(C),z=s&&w;g(z||!w),z&&h()},x=()=>{g(!0)},v=y=>{!s||!u(y)||c(y)&&g(!0)},S=y=>{t.canActivate?.()!==!1&&((t.preventDefaultOnPointerDown??!1)&&y.preventDefault(),n&&y.stopPropagation(),s=!0,e=!1,i=m(y),a=d(y),r(!0),t.moveTolerancePx!==void 0&&o.addEventListener("pointermove",v,!0),o.addEventListener("pointerup",f,!0),o.addEventListener("pointercancel",x,!0))},E=()=>{s&&r(!0)},b=()=>{s&&r(!1)},O=()=>{g(!0)},I=y=>{if(n&&y.stopPropagation(),(t.preventDefaultOnClick??!1)&&y.preventDefault(),e){e=!1;return}s||h()};return l.addEventListener("pointerdown",S),l.addEventListener("pointerenter",E),l.addEventListener("pointerleave",b),l.addEventListener("pointercancel",O),l.addEventListener("click",I),()=>{g(!1),l.removeEventListener("pointerdown",S),l.removeEventListener("pointerenter",E),l.removeEventListener("pointerleave",b),l.removeEventListener("pointercancel",O),l.removeEventListener("click",I)}}class te{overlay=null;previewBody=null;previewNose=null;previewWings=null;buttonCleanups=new Set;optionButtons=new Map;draft={...rt};colorOptions=G.getColorOptions();show(t){this.hide();const s=document.getElementById("ui-overlay");if(!s)return;this.draft=G.normalizeCustomization(t.initialCustomization),this.overlay=document.createElement("div"),this.overlay.setAttribute("data-spaceship-customizer",""),this.overlay.setAttribute("role","dialog"),this.overlay.setAttribute("aria-modal","true"),this.overlay.setAttribute("aria-label","うちゅうせんを かざろう"),this.overlay.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
    ...
    `;const a=document.createElement("span");return a.textContent=s.label,a.style.cssText="font-family: Zen Maru Gothic, sans-serif; font-size: 0.95rem; font-weight: 700;",e.appendChild(i),e.appendChild(a),this.buttonCleanups.add(R(e,{onActivate:()=>this.selectColor(t,s.key),onPressChange:o=>{e.style.transform=o?"scale(0.95)":"scale(1)"}})),this.optionButtons.set(`${t}:${s.key}`,e),e}selectColor(t,s){this.draft={...this.draft,[t]:s},this.render()}render(){const t=G.normalizeCustomization(this.draft);this.draft=t,this.previewBody?.style.setProperty("background",`#${G.getColorHex(t.bodyColor).toString(16).padStart(6,"0")}`),this.previewWings?.style.setProperty("background",`#${G.getColorHex(t.wingColor).toString(16).padStart(6,"0")}`),this.previewNose&&(this.previewNose.style.borderBottomColor=`#${G.getColorHex(t.noseColor).toString(16).padStart(6,"0")}`);for(const s of this.colorOptions)this.renderOptionState("bodyColor",s.key,t.bodyColor===s.key),this.renderOptionState("noseColor",s.key,t.noseColor===s.key),this.renderOptionState("wingColor",s.key,t.wingColor===s.key)}renderOptionState(t,s,e){const i=this.optionButtons.get(`${t}:${s}`);i&&(i.setAttribute("aria-pressed",e?"true":"false"),i.style.borderColor=e?"#ffe66d":"transparent",i.style.background=e?"rgba(255, 230, 109, 0.18)":"rgba(255, 255, 255, 0.12)")}}function xt(l,t){if(!Number.isFinite(l)||l<=0||t<=0)return"ずかん";const s=Math.min(l,t);return s>=t?`ずかん ${t} / ${t} 🎉`:`ずかん ${s} / ${t}`}function ee(l){switch(l){case"hero":return{gap:"0.35rem",label:"0.92rem",medal:"1.7rem",hint:"0.98rem"};case"compact":return{gap:"0.18rem",label:"0.7rem",medal:"1rem",hint:"0.76rem"};default:return{gap:"0.26rem",label:"0.8rem",medal:"1.25rem",hint:"0.84rem"}}}function ot(l,t,s={}){const e=wt(l,t),i=s.size??"regular",a=ee(i),o=document.createElement("div");if(o.setAttribute("data-stage-medal-display",""),o.setAttribute("data-stage-medal-stage",String(l)),o.setAttribute("data-stage-medal-tier",e.tier),o.setAttribute("data-stage-medal-earned",String(e.earnedCount)),s.scope&&o.setAttribute("data-stage-medal-scope",s.scope),o.style.cssText=`
    display: flex;
    flex-direction: column;
    align-items: center;
    gap: ${a.gap};
  `,s.label){const d=document.createElement("div");d.textContent=s.label,d.style.cssText=`
    ...
    justify-content: center;
    gap: ${a.gap};
  `;for(const d of e.slots){const m=document.createElement("span");m.setAttribute("data-stage-medal-slot",d.tier),m.setAttribute("data-stage-medal-threshold",String(d.threshold)),m.setAttribute("data-stage-medal-reached",String(d.reached)),m.textContent=d.icon,m.style.cssText=`
      font-size: ${a.medal};
      line-height: 1;
    ...
    `,n.appendChild(m)}o.appendChild(n);const h=s.hint??(e.nextThreshold===null?"かんぺき！":`つぎ ⭐ ${e.nextThreshold}`),r=document.createElement("div");return r.setAttribute("data-stage-medal-hint",""),r.textContent=h,r.style.cssText=`
    font-family: 'Zen Maru Gothic', sans-serif;
    font-size: ${a.hint};
    font-weight: 700;
    color: ${e.nextThreshold===null?"#FFE66D":"rgba(255, 255, 255, 0.86)"};
  `,o.appendChild(r),o}const Et=2e3,K=new Map,J=new Map,tt=new Map;let Z=null,Y=null;function X(l,t){if(typeof document>"u"){const e=typeof OffscreenCanvas=="function",i=e?new OffscreenCanvas(l,t):{width:l,height:t};return{canvas:i,ctx:e?i.getContext("2d"):null}}const s=document.createElement("canvas");return s.width=l,s.height=t,{canvas:s,ctx:s.getContext("2d")}}function N(l,t){let s=K.get(l);return s||(s=t(),s.generateMipmaps=!1,s.minFilter=Wt,s.needsUpdate=!0,K.set(l,s)),s}function T(l,t){let s=J.get(l);return s||(s=t(),J.set(l,s)),s}function M(l,t){let s=tt.get(l);return s||(s=t(),tt.set(l,s)),s}function B(l,t){const s=new Vt(l,t);return s.userData.sharedAssets=!0,s}function Mt(){if(!Z){const l=new ct,t=new Float32Array(Et*3);for(let s=0;s<Et*3;s+=3)t[s]=(Math.random()-.5)*200,t[s+1]=(Math.random()-.5)*200,t[s+2]=(Math.random()-.5)*400;l.setAttribute("position",new dt(t,3)),Z=l}Y||(Y=new ut({color:16777215,size:.2,sizeAttenuation:!0}))}function se(){const{canvas:l,ctx:t}=X(256,256);if(!t)return new D(l);t.fillStyle="#888888",t.fillRect(0,0,256,256);for(let s=0;s<30;s++){const e=Math.random()*256,i=Math.random()*256,a=3+Math.random()*12;t.beginPath(),t.arc(e,i,a,0,Math.PI*2),t.fillStyle=`rgba(60,60,60,${.3+Math.random()*.4})`,t.fill()}return new D(l)}function ie(){const{canvas:l,ctx:t}=X(256,256);if(!t)return new D(l);t.fillStyle="#ddaa44",t.fillRect(0,0,256,256);for(let s=0;s<8;s++){t.beginPath();const e=128+(Math.random()-.5)*100,i=128+(Math.random()-.5)*100;t.strokeStyle=`rgba(200,150,60,${.3+Math.random()*.3})`,t.lineWidth=3+Math.random()*5;for(let a=0;a<Math.PI*4;a+=.1){const o=10+a*8;t.lineTo(e+Math.cos(a)*o,i+Math.sin(a)*o)}t.stroke()}return new D(l)}function ae(){const{canvas:l,ctx:t}=X(256,256);if(!t)return new D(l);const s=["#cc7733","#dd9955","#bb6622","#eebb77","#aa5511","#ddaa66"];for(let e=0;e<256;e++){const i=Math.floor(e/(256/s.length))%s.length;t.fillStyle=s[i],t.fillRect(0,e,256,1)}return new D(l)}function ne(){const{canvas:l,ctx:t}=X(512,256);return t?(t.fillStyle="#2266aa",t.fillRect(0,0,512,256),t.fillStyle="#886644",t.beginPath(),t.ellipse(300,80,80,40,.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(280,150,30,50,.1,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(100,90,25,60,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(110,170,20,40,-.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(420,170,25,15,0,0,Math.PI*2),t.fill(),t.fillStyle="#447733",t.beginPath(),t.ellipse(290,75,40,20,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(95,85,15,30,.2,0,Math.PI*2),t.fill(),new D(l)):new D(l)}function oe(){const{canvas:l,ctx:t}=X(512,256);if(!t)return new D(l);t.clearRect(0,0,512,256),t.fillStyle="rgba(255,255,255,0.6)";for(let s=0;s<20;s++){const e=Math.random()*512,i=Math.random()*256;t.beginPath(),t.ellipse(e,i,20+Math.random()*40,8+Math.random()*15,Math.random()*Math.PI,0,Math.PI*2),t.fill()}return new D(l)}function re(){K.clear(),J.clear(),tt.clear(),Z=null,Y=null}const le={planetTextureCache:K,planetGeometryCache:J,planetMaterialCache:tt,getBgStarsGeometry:()=>Z,getBgStarsMaterial:()=>Y};function Bt(l,t,s){const e=new W;let i=null;switch(l){case 2:{const a=N("mercury",se),o=T("mercury:sphere",()=>new k(10,24,24)),n=M("mercury:mat",()=>new A({map:a})),h=B(o,n);e.add(h),i=h;break}case 3:{const a=N("venus",ie),o=T("venus:sphere",()=>new k(14,24,24)),n=M("venus:mat",()=>new A({map:a})),h=B(o,n);e.add(h),i=h;break}case 5:{const a=N("jupiter",ae),o=T("jupiter:sphere",()=>new k(20,24,24)),n=M("jupiter:mat",()=>new A({map:a})),h=B(o,n);e.add(h),i=h;break}case 6:{const a=T("saturn:sphere",()=>new k(15,24,24)),o=t.planetColor,n=M(`saturn:mat:${o}`,()=>new A({color:o})),h=B(a,n);e.add(h);const r=T("saturn:ring",()=>new Ct(20,30,48)),d=M("saturn:ringMat",()=>new A({color:15645542,side:vt})),m=B(r,d);m.rotation.x=Math.PI/3,e.add(m),i=h;break}case 7:{const a=T("uranus:sphere",()=>new k(16,24,24)),o=M("uranus:mat",()=>new A({color:6737117})),n=B(a,o);e.add(n);const h=T("uranus:ring",()=>new Ct(21,28,48)),r=M("uranus:ringMat",()=>new A({color:10083822,side:vt})),d=B(h,r);d.rotation.z=Math.PI/2,e.add(d),i=n;break}case 9:{const a=T("pluto:sphere",()=>new k(8,24,24)),o=M("pluto:mat",()=>new A({color:12298922})),n=B(a,o);e.add(n),i=n;break}case 10:{const a=T("sun:sphere",()=>new k(25,24,24)),o=M("sun:mat",()=>new A({color:16763904,emissive:16755200,emissiveIntensity:.5})),n=B(a,o);e.add(n),e.add(new Xt(16763904,2,200)),i=n;break}case 11:{const a=N("earth",ne),o=T("earth:sphere",()=>new k(15,32,32)),n=M("earth:mat",()=>new A({map:a})),h=N("earth:cloud",oe),r=T("earth:cloudSphere",()=>new k(15.5,32,32)),d=M("earth:cloudMat",()=>new A({map:h,transparent:!0,opacity:.3})),m=new W;m.add(B(o,n)),m.add(B(r,d)),e.add(m),i=m;break}default:{const a=T("default:sphere",()=>new k(15,24,24)),o=t.planetColor,n=M(`default:mat:${o}`,()=>new A({color:o})),h=B(a,n);e.add(h),i=h;break}}return e.position.set(0,0,s),{planet:e,spinTarget:i}}function he(l,t,s){return Bt(l,t,s)}function ce(l){Mt();const t=new ht(Z,Y);return t.userData.sharedAssets=!0,t.geometry.setDrawRange(0,l),t}function bt(l){!Number.isInteger(l)||l<1||l>H||typeof document>"u"&&typeof OffscreenCanvas!="function"||(Mt(),Bt(l,lt(l),0))}let $=null,j=null;function de(){if(!$){const l=new ct,t=new Float32Array(3e3);for(let s=0;s<3e3;s++)t[s]=(Math.random()-.5)*200;l.setAttribute("position",new dt(t,3)),$=l}return $}function ue(){return j||(j=new ut({color:16777215,size:.3,sizeAttenuation:!0})),j}function me(){$=null,j=null}const pe={getBgStarsGeometry:()=>$,getBgStarsMaterial:()=>j};function fe(l){const t=window.requestIdleCallback;if(typeof t=="function"){t(l,{timeout:1500});return}window.setTimeout(l,800)}function Pt(l){return new Set(l.filter(t=>Number.isInteger(t)&&t>=1&&t<=H)).size}function ge(l){return Pt(l)>=H}function it(l){const t=ge(l.unlockedPlanets),s=t?1:Math.min(l.clearedStage+1,H),e=lt(s),i=l.bestStageStars?.[s]??0;return t?{startStage:s,destination:e.destinationReading,emoji:e.emoji,statusLabel:"ぜんぶ あつめたよ！",destinationLabel:`${e.destinationReading}へ もういちど しゅっぱつ！`,buttonHint:`${e.emoji} ステージ ${s} から もういちど あそぶ`,bestStars:i}:{startStage:s,destination:e.destinationReading,emoji:e.emoji,statusLabel:l.clearedStage>0?"つづきから しゅっぱつ！":"はじめての しゅっぱつ！",destinationLabel:`${e.destinationReading}へ むかおう！`,buttonHint:`${e.emoji} ステージ ${s} から スタート`,bestStars:i}}function ye(l){return l.clearedStage>0||Pt(l.unlockedPlanets)>0||Object.keys(l.bestStageStars??{}).length>0}class be{threeScene;ambientLight=new mt(16777215,1);camera;lastAspect=0;sceneManager;saveManager;audioManager;stars=null;companionParade=null;overlay=null;muteHandle=null;tutorialOverlay=new gt;titleResetConfirmOverlay=new Kt;colorAccessibilitySettings=new Jt;spaceshipCustomizer=new te;encyclopediaOverlay=null;encyclopediaOverlayPromise=null;companionFactory=null;companionFactoryPromise=null;loadEncyclopediaOverlay;loadTitleCompanionFactory;loadingOverlay;loadFailureOverlay;scheduleIdleTask;encyclopediaBtn=null;isOpeningEncyclopedia=!1;isActive=!1;encyclopediaRequestToken=0;companionParadeRequestToken=0;bgmPending=!1;overlayButtonCleanups=new Set;constructor(t,s,e,i={}){this.sceneManager=t,this.saveManager=s,this.audioManager=e,this.loadingOverlay=i.loadingOverlay??new It,this.loadFailureOverlay=i.loadFailureOverlay??new kt,this.scheduleIdleTask=i.scheduleIdleTask??fe,this.loadEncyclopediaOverlay=i.loadEncyclopediaOverlay??(()=>nt(()=>import("./EncyclopediaOverlay-A9JPDQLe.js"),__vite__mapDeps([0,1,2]))),this.loadTitleCompanionFactory=i.loadTitleCompanionFactory??(()=>nt(()=>import("./game-core-D0-SjBGp.js").then(n=>n.y),__vite__mapDeps([1,2]))),this.threeScene=new Q,this.threeScene.background=new pt(32);const{width:a,height:o}=_();this.camera=new ft(60,a/o,.1,1e3),this.camera.position.set(0,0,5)}enter(t){this.isActive=!0,this.encyclopediaRequestToken+=1,this.companionParadeRequestToken+=1,this.lastAspect=0,this.stars=new ht(de(),ue()),this.stars.userData.sharedAssets=!0,this.stars.rotation.set(0,0,0),this.threeScene.add(this.stars),this.ambientLight.parent||this.threeScene.add(this.ambientLight);const s=this.saveManager.load();this.createCompanionParade(s.unlockedPlanets),this.createOverlay(),this.createMuteButton(),this.prefetchEncyclopediaOnIdle(),this.prewarmNextAdventureOnIdle(it(s).startStage),this.audioManager.isInitialized()?(this.audioManager.playBGM(0),this.bgmPending=!1):this.bgmPending=!0,s.tutorialShown||this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide(),this.saveManager.markTutorialShown()})}createMuteButton(){const t=document.getElementById("hud")??document.getElementById("ui-overlay");t&&(this.muteHandle=yt({initialMuted:this.audioManager.isMuted(),container:t,onToggle:()=>{this.ensureTitleAudioInitialized(!0);const s=this.audioManager.toggleMute();this.muteHandle?.setMuted(s);const e=this.saveManager.load();e.muted=s,this.saveManager.save(e)}}))}getEncyclopediaOverlay(){return this.encyclopediaOverlay?Promise.resolve(this.encyclopediaOverlay):this.encyclopediaOverlayPromise?this.encyclopediaOverlayPromise:(this.encyclopediaOverlayPromise=this.loadEncyclopediaOverlay().then(({EncyclopediaOverlay:t})=>{const s=new t;return this.encyclopediaOverlay=s,s}).finally(()=>{this.encyclopediaOverlayPromise=null}),this.encyclopediaOverlayPromise)}getTitleCompanionFactory(){return this.companionFactory?Promise.resolve(this.companionFactory):this.companionFactoryPromise?this.companionFactoryPromise:(this.companionFactoryPromise=this.loadTitleCompanionFactory().then(t=>(this.companionFactory=t,t)).finally(()=>{this.companionFactoryPromise=null}),this.companionFactoryPromise)}showEncyclopedia(){if(!this.isActive||!this.encyclopediaOverlay)return;const t=this.saveManager.load();this.encyclopediaOverlay.show(t.unlockedPlanets,()=>this.refreshEncyclopediaButtonLabel(),s=>{this.ensureTitleAudioInitialized(!1),this.sceneManager.requestTransition("stage",{stageNumber:s,totalScore:0,totalStarCount:0,launchSource:"encyclopedia"})},t.bestStageStars??{})}isCurrentEncyclopediaRequest(t){return this.isActive&&this.encyclopediaRequestToken===t}prefetchEncyclopediaOnIdle(){const t=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{!this.isCurrentEncyclopediaRequest(t)||this.encyclopediaOverlay||this.encyclopediaOverlayPromise||this.getEncyclopediaOverlay().catch(()=>{})})}prewarmNextAdventureOnIdle(t){if(t>H)return;const s=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{this.isCurrentEncyclopediaRequest(s)&&bt(t)})}async openEncyclopedia(){if(!this.isActive)return;if(this.loadFailureOverlay.hide(),this.encyclopediaOverlay){this.showEncyclopedia();return}if(this.isOpeningEncyclopedia)return;const t=this.encyclopediaRequestToken;this.isOpeningEncyclopedia=!0,this.loadingOverlay.show("ずかんを よんでるよ...");try{if(await this.getEncyclopediaOverlay(),!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),this.showEncyclopedia()}catch(s){if(!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),console.error("Failed to load encyclopedia overlay",s),this.loadFailureOverlay.show({title:"ずかんの じゅんびが できなかったよ",message:"「もういちど よむ」を おしてね",primaryAction:{label:"もういちど よむ",onSelect:()=>this.openEncyclopedia()}})}finally{this.encyclopediaRequestToken===t&&(this.isOpeningEncyclopedia=!1)}}persistHighContrastSetting(t){const s=this.saveManager.load();t?s.colorAccessibility={highContrast:!0}:delete s.colorAccessibility,this.saveManager.save(s)}createOverlay(){const t=document.getElementById("ui-overlay");if(!t)return;const s=this.saveManager.load(),e=it(s);this.overlay=document.createElement("div"),this.overlay.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      justify-content: center;
    ...
    `;const h=document.createElement("div");h.textContent=e.statusLabel,h.style.cssText=`
      ...
      font-weight: 900;
      margin-bottom: ${i?"0.15rem":"0.35rem"};
    `;const r=document.createElement("div");r.textContent=`${e.emoji} ステージ ${e.startStage} ・ ${e.destination}`,r.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
    ...
    `;const d=document.createElement("div");d.textContent=e.destinationLabel,d.style.cssText=`
      ...
      font-weight: 700;
      color: rgba(255, 255, 255, 0.92);
    `;const m=wt(e.startStage,e.bestStars),u=ot(e.startStage,e.bestStars,{label:"メダル",hint:m.nextThreshold===null?"かんぺき！":`${m.icon} いま ・ つぎ ⭐ ${m.nextThreshold}`,size:"regular",scope:"title-next-adventure"});u.style.marginTop="0.7rem",o.appendChild(n),o.appendChild(h),o.appendChild(r),o.appendChild(d),o.appendChild(u);const c=document.createElement("div");c.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      gap: 0.65rem;
    `;const g=document.createElement("button");g.textContent="あそぶ",g.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(R(g,{onActivate:()=>{this.ensureTitleAudioInitialized(!1);const b=this.saveManager.load(),O=it(b).startStage;this.sceneManager.requestTransition("stage",{stageNumber:O,totalScore:0,totalStarCount:0,launchSource:"campaign"})},onPressChange:b=>{g.style.transform=b?"scale(0.96)":"scale(1)"}}));const f=document.createElement("div");f.setAttribute("data-play-button-hint",""),f.textContent=e.buttonHint,f.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${i?"0.85rem":"1rem"};
      font-weight: 700;
    ...
    `;const x=document.createElement("button");x.setAttribute("data-spaceship-customizer-button",""),x.textContent="うちゅうせんをかざろう",x.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(R(x,{onActivate:()=>{const b=this.saveManager.load();this.spaceshipCustomizer.show({initialCustomization:b.spaceshipCustomization??rt,onComplete:O=>{const I=this.saveManager.load();I.spaceshipCustomization=O,this.saveManager.save(I)}})},onPressChange:b=>{x.style.transform=b?"scale(0.96)":"scale(1)"}}));const v=document.createElement("button");v.textContent="あそびかた",v.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,v.style.position="absolute",v.style.bottom=i?"1rem":"2rem",v.style.right=i?"1rem":"2rem",this.overlayButtonCleanups.add(R(v,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide()})},onPressChange:b=>{v.style.transform=b?"scale(0.96)":"scale(1)"}}));const S=document.createElement("button");S.setAttribute("data-color-settings-button",""),S.textContent="いろのせってい",S.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      ...
      transition: transform 0.08s ease-out;
      white-space: nowrap;
    `,this.overlayButtonCleanups.add(R(S,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.colorAccessibilitySettings.show({initialHighContrast:this.saveManager.load().colorAccessibility?.highContrast===!0,onToggle:b=>this.persistHighContrastSetting(b)})},onPressChange:b=>{S.style.transform=b?"translateX(-50%) scale(0.96)":"translateX(-50%) scale(1)"}}));const E=document.createElement("button");if(E.textContent=xt(s.unlockedPlanets.length,F.length),E.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${i?"0.95rem":"1.2rem"};
      font-weight: 700;
      padding: ${i?"0.4rem 1rem":"0.6rem 1.5rem"};
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,E.style.position="absolute",E.style.bottom=i?"1rem":"2rem",E.style.left=i?"1rem":"2rem",this.encyclopediaBtn=E,this.overlayButtonCleanups.add(R(E,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.openEncyclopedia()},onPressChange:b=>{E.style.transform=b?"scale(0.96)":"scale(1)"}})),c.appendChild(g),c.appendChild(f),c.appendChild(x),ye(s)){const b=document.createElement("button");b.setAttribute("data-reset-progress-button",""),b.textContent="さいしょから",b.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: 1.15rem;
        font-weight: 900;
      ...
      `,b.addEventListener("pointerdown",O=>{O.stopPropagation(),this.ensureTitleAudioInitialized(!0),this.titleResetConfirmOverlay.show(()=>{this.saveManager.resetProgressPreservingSettings(),this.startCampaign(1)},()=>{})}),c.appendChild(b)}this.overlay.appendChild(a),this.overlay.appendChild(o),this.overlay.appendChild(c),this.overlay.appendChild(v),this.overlay.appendChild(S),this.overlay.appendChild(E),t.appendChild(this.overlay),this.overlay.addEventListener("pointerdown",()=>{this.ensureTitleAudioInitialized(!0)},{once:!0})}ensureTitleAudioInitialized(t){!this.bgmPending&&this.audioManager.isInitialized()||(this.audioManager.initSync(),t&&this.bgmPending&&this.audioManager.playBGM(0),this.bgmPending=!1)}startCampaign(t){this.sceneManager.requestTransition("stage",{stageNumber:t,totalScore:0,totalStarCount:0,launchSource:"campaign"})}refreshEncyclopediaButtonLabel(){if(!this.encyclopediaBtn)return;const t=this.saveManager.load();this.encyclopediaBtn.textContent=xt(t.unlockedPlanets.length,F.length)}async createCompanionParade(t){this.clearCompanionParade();const s=[...new Set(t)].reduce((h,r)=>{const d=V(r);return d&&h.push(d),h},[]);if(s.length===0)return;const e=this.encyclopediaRequestToken,{createCompanionMesh:i}=await this.getTitleCompanionFactory();if(!this.isActive||this.encyclopediaRequestToken!==e)return;const a=new W;a.name="title-companion-parade",a.position.set(0,1.35,-1.2),a.rotation.x=-.12;const o=Math.min(2.1,1.1+s.length*.18),n=Math.min(.45,.18+s.length*.02);s.forEach((h,r)=>{const d=i(h),m=r/s.length*Math.PI*2;d.position.set(Math.cos(m)*o,Math.sin(m)*n,Math.sin(m)*o*.45),d.rotation.y=Math.PI*.15-m,d.scale.setScalar(.6),a.add(d)}),this.companionParade=a,this.threeScene.add(a)}clearCompanionParade(){this.companionParade&&(this.companionParade.parent?.remove(this.companionParade),this.companionParade=null)}update(t){this.stars&&(this.stars.rotation.y+=t*.05),this.companionParade&&(this.companionParade.rotation.y+=t*.35)}exit(){this.isActive=!1,this.encyclopediaRequestToken+=1,this.companionParadeRequestToken+=1,this.isOpeningEncyclopedia=!1,this.tutorialOverlay.hide(),this.titleResetConfirmOverlay.hide(),this.colorAccessibilitySettings.hide(),this.spaceshipCustomizer.hide(),this.encyclopediaOverlay?.hide(),this.loadingOverlay.hide(),this.loadFailureOverlay.hide(),this.audioManager.stopBGM(),this.bgmPending=!1,this.clearCompanionParade(),this.stars&&(this.stars.parent?.remove(this.stars),this.stars=null),this.clearCompanionParade();const t=Array.from(this.overlayButtonCleanups);this.overlayButtonCleanups.clear();for(const s of t)s();this.overlay&&(this.overlay.remove(),this.overlay=null),this.encyclopediaBtn=null,this.muteHandle&&(this.muteHandle.remove(),this.muteHandle=null)}getThreeScene(){return this.threeScene}getCamera(){const{width:t,height:s}=_(),e=t/s;return e!==this.lastAspect&&Number.isFinite(e)&&e>0&&(this.camera.aspect=e,this.camera.updateProjectionMatrix(),this.lastAspect=e),this.camera}}const He=Object.freeze(Object.defineProperty({__proto__:null,TitleScene:be,__resetTitleSceneSharedAssetsForTest:me,__titleSceneSharedAssetsForTest:pe},Symbol.toStringTag,{value:"Module"}));class ve{overlayEl=null;activePressCleanups=new Set;show(t,s){if(this.overlayEl)return;const e=document.getElementById("ui-overlay");if(!e)return;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-home-confirm-overlay",""),this.overlayEl.setAttribute("role","dialog"),this.overlayEl.setAttribute("aria-modal","true"),this.overlayEl.setAttribute("aria-label","ホームへ もどりますか"),this.overlayEl.style.cssText=`
      position: absolute;
      top: 0;
      left: 0;
      right: 0;
    ...
    `,n.addEventListener("pointerdown",g=>{g.stopPropagation()}),this.overlayEl.appendChild(n);const h=document.createElement("div");h.textContent="タイトルへ もどる？",h.style.cssText=`
      ...
      padding: 0 0.6rem;
      white-space: nowrap;
    `,h.style.fontFamily="'Zen Maru Gothic', sans-serif",h.style.color="#FFD700",n.appendChild(h);const r=document.createElement("div");r.style.cssText=`
      display: flex;
      flex-direction: row;
      gap: 1rem;
      align-items: center;
    ...
    `,n.appendChild(r);const d=`
      ...
      transition: transform 0.08s ease-out;
      white-space: nowrap;
    `,m=(g,f)=>{const x=R(g,{onActivate:f,onPressChange:v=>{g.style.transform=v?"scale(0.9)":"scale(1)"}});this.activePressCleanups.add(x)},u=document.createElement("button");u.setAttribute("data-home-confirm-back",""),u.setAttribute("aria-label","タイトルへ もどる"),u.textContent="🏠 タイトルへ もどる",u.style.cssText=d,u.style.fontFamily="'Zen Maru Gothic', sans-serif",u.style.background="rgba(255, 255, 255, 0.18)",u.style.color="#ffffff",u.style.minWidth="88px",u.style.minHeight="88px",u.style.touchAction="manipulation",u.style.transform="scale(1)",u.style.transition="transform 0.08s ease-out",u.style.whiteSpace="nowrap",m(u,o),r.appendChild(u);const c=document.createElement("button");c.setAttribute("data-home-confirm-continue",""),c.setAttribute("aria-label","つづける"),c.textContent="✋ つづける",c.style.cssText=d,c.style.fontFamily="'Zen Maru Gothic', sans-serif",c.style.background="linear-gradient(135deg, #FF6B6B, #FFE66D)",c.style.color="#FFD700",c.style.textShadow="0 1px 2px rgba(0, 0, 32, 0.6)",c.style.minWidth="88px",c.style.minHeight="88px",c.style.touchAction="manipulation",c.style.transform="scale(1)",c.style.transition="transform 0.08s ease-out",c.style.whiteSpace="nowrap",m(c,a),r.appendChild(c),e.appendChild(this.overlayEl)}hide(){if(this.overlayEl){const t=Array.from(this.activePressCleanups);this.activePressCleanups.clear();for(const s of t)s();this.overlayEl.remove(),this.overlayEl=null}}isVisible(){return this.overlayEl!==null}}class Ot{overlayEl=null;activePressCleanups=new Set;show(t,s){if(this.overlayEl)return;const e=document.getElementById("ui-overlay")??document.body;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-pause-overlay",""),this.overlayEl.setAttribute("role","dialog"),this.overlayEl.setAttribute("aria-modal","true"),this.overlayEl.setAttribute("aria-label","やすみちゅう"),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
    ...
    `;const i=document.createElement("div");i.setAttribute("data-pause-card",""),i.style.cssText=`
      ...
      text-align: center;
      font-family: 'Zen Maru Gothic', sans-serif;
    `,i.addEventListener("pointerdown",r=>{r.stopPropagation()}),this.overlayEl.appendChild(i);const a=document.createElement("div");a.textContent="ひとやすみ ちゅう",a.style.cssText=`
    ...
    `,i.appendChild(o);const n=document.createElement("div");n.style.cssText=`
      ...
      align-items: stretch;
      width: 100%;
    `,i.appendChild(n);const h=(r,d,m,u,c,g)=>{const f=document.createElement("button");f.setAttribute(d,""),f.setAttribute("aria-label",m),f.textContent=r,f.style.cssText=`
        flex: 1 1 140px;
        padding: 1rem 1.2rem;
        border: none;
        border-radius: 1.6rem;
    ...
    `,this.overlay.appendChild(i),this.overlay.appendChild(a),this.overlay.appendChild(o),this.overlay.appendChild(this.exitCta),e.appendChild(this.overlay)}update(t){this.bgStars&&(this.bgStars.rotation.y+=t*.03),this.updateCelebration(t)}setupCelebration(){this.companionGroup=new W,this.companionMeshes=[],this.circleX.length=0,this.circleZ.length=0,this.popinSettled.length=0,this.celebrationElapsed=0,this.thankYouShown=!1,this.canExit=!1,this.exitTriggered=!1;for(let t=0;t<F.length;t++){const s=F[t],e=At.createCompanionMesh(s),i=t*(2*Math.PI/F.length),a=Math.cos(i)*P.CIRCLE_RADIUS,o=Math.sin(i)*P.CIRCLE_RADIUS;this.circleX.push(a),this.circleZ.push(o),e.position.set(a,0,o),e.scale.set(0,0,0),this.companionMeshes.push(e),this.popinSettled.push(!1),this.companionGroup.add(e)}this.threeScene.add(this.companionGroup)}updateCelebration(t){if(this.companionMeshes.length===0)return;this.celebrationElapsed+=t;const s=P.POPIN_DELAY*(this.companionMeshes.length-1)+P.POPIN_DURATION,e=this.celebrationElapsed>s,i=e?Math.abs(Math.sin(this.celebrationElapsed*P.BOUNCE_SPEED))*P.BOUNCE_HEIGHT:0;for(let a=0;a<this.companionMeshes.length;a++){const o=this.companionMeshes[a];if(this.popinSettled[a]){e&&(o.position.y=i),o.rotation.y+=t*2;continue}const n=a*P.POPIN_DELAY;if(!(this.celebrationElapsed<n)){if(this.celebrationElapsed<n+P.POPIN_DURATION){const h=(this.celebrationElapsed-n)/P.POPIN_DURATION,r=this.bounceEase(h);o.scale.set(r,r,r)}else o.scale.set(1,1,1),this.popinSettled[a]=!0;e&&(o.position.y=i),o.rotation.y+=t*2}}!this.thankYouShown&&this.celebrationElapsed>=P.THANK_YOU_DELAY&&(this.showThankYouText(),this.thankYouShown=!0)}bounceEase(t){return t<.6?t/.6*1.2:1.2-(t-.6)/.4*.2}showThankYouText(){if(!this.overlay||!this.exitCta)return;const t=document.createElement("div");t.setAttribute("data-ending-thank-you",""),t.textContent="みんな ありがとう！",t.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: 2rem;
      font-weight: 900;
      color: #FFD700;
