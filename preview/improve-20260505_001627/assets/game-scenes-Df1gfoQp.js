const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-KpmMUQD8.js","assets/game-core-BGtwARXY.js","assets/three-Ca1bUDUH.js"])))=>i.map(i=>d[i]);
import{D as rt,S as G,g as wt,T as H,a as lt,L as It,b as kt,_ as nt,c as _,d as V,P as F,u as Dt,C as Ht,e as Lt,f as _t,B as Gt,h as Nt,i as zt,j as Ft,A as $t,k as At,l as jt,m as Ut,n as et,t as st,o as qt,s as Zt,p as Yt}from"./game-core-BGtwARXY.js";import{l as ht,j as ct,h as dt,k as ut,G as W,n as Xt,a as Vt,o as Wt,M as A,m as k,D as vt,R as Ct,p as D,q as mt,r as Q,g as pt,P as ft,V as Tt,s as Qt}from"./three-Ca1bUDUH.js";class gt{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const s=document.getElementById("ui-overlay");if(!s)return;const e=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
    ...
    `,document.head.appendChild(t)}}class Kt{overlayEl=null;activePressCleanups=new Set;show(t,s){if(this.overlayEl)return;const e=document.getElementById("ui-overlay");if(!e)return;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-title-reset-confirm-overlay",""),this.overlayEl.setAttribute("role","dialog"),this.overlayEl.setAttribute("aria-modal","true"),this.overlayEl.setAttribute("aria-label","さいしょからに もどしますか"),this.overlayEl.style.cssText=`
      ...
      padding: 1.5rem;
      background: rgba(0, 0, 32, 0.92);
    `;let i=!1;const a=()=>{i||(i=!0,this.hide(),s())},o=()=>{i||(i=!0,this.hide(),t())};this.overlayEl.addEventListener("pointerdown",p=>{p.target===this.overlayEl&&a()});const n=document.createElement("div");n.setAttribute("data-title-reset-confirm-card",""),n.style.cssText=`
    ...
    `,g=(p,x)=>{let v=!1,S=!1;const E=()=>{I(!0)},b=()=>{p.style.transform="scale(0.92)"},O=()=>{p.style.transform="scale(1)"},I=(w=!1)=>{v=!1,S=w,O(),this.activePressCleanups.delete(E),document.removeEventListener("pointerup",y,!0),document.removeEventListener("pointercancel",C,!0)},y=w=>{const N=w.target===p||w.target instanceof Node&&p.contains(w.target),Rt=v&&N;I(!N),Rt&&x()},C=()=>{I(!0)};p.addEventListener("pointerdown",w=>{w.stopPropagation(),v=!0,S=!1,b(),this.activePressCleanups.add(E),document.addEventListener("pointerup",y,!0),document.addEventListener("pointercancel",C,!0)}),p.addEventListener("pointerenter",()=>{v&&b()}),p.addEventListener("pointerleave",()=>{v&&O()}),p.addEventListener("pointercancel",()=>I(!0)),p.addEventListener("click",w=>{if(w.stopPropagation(),S){S=!1;return}v||x()})},m=document.createElement("button");m.setAttribute("data-title-reset-cancel",""),m.textContent="やめる",m.style.cssText=d,m.style.background="rgba(255, 255, 255, 0.18)",m.style.color="#ffffff",g(m,a),c.appendChild(m);const f=document.createElement("button");f.setAttribute("data-title-reset-confirm",""),f.textContent="うん！ さいしょから",f.style.cssText=d,f.style.background="linear-gradient(135deg, #FF9F68, #FFE66D)",f.style.color="#3b1f00",g(f,o),c.appendChild(f),e.appendChild(this.overlayEl)}hide(){if(!this.overlayEl)return;const t=Array.from(this.activePressCleanups);this.activePressCleanups.clear();for(const s of t)s();this.overlayEl.remove(),this.overlayEl=null}}function yt(r){const t=r.topRem??.8,s=window.innerHeight<=500,e=document.createElement("button");let i=r.initialMuted;const a=()=>{e.textContent=i?"🔇":"🔊",e.setAttribute("aria-label",i?"サウンド オフ":"サウンド オン")};e.setAttribute("data-mute-button",""),e.style.position="absolute",e.style.top=`${t}rem`,e.style.right="1rem",e.style.fontSize=s?"clamp(1.1rem, 3.5vmin, 1.4rem)":"clamp(1.4rem, 4vmin, 1.8rem)",e.style.background="rgba(255, 255, 255, 0.15)",e.style.border="none",e.style.borderRadius="50%",e.style.width=s?"2.4rem":"3rem",e.style.height=s?"2.4rem":"3rem",e.style.display="flex",e.style.alignItems="center",e.style.justifyContent="center",e.style.cursor="pointer",e.style.pointerEvents="auto",e.style.touchAction="manipulation",e.style.transform="scale(1)",e.style.transition="transform 0.08s ease-out",a();const o=()=>{e.style.transform="scale(1)"};return e.addEventListener("pointerdown",n=>{n.stopPropagation(),e.style.transform="scale(0.9)",r.onToggle()}),e.addEventListener("pointerup",o),e.addEventListener("pointercancel",o),e.addEventListener("pointerleave",o),r.container.appendChild(e),{element:e,setMuted(n){i=n,a()},remove(){e.remove()}}}class Jt{overlay=null;toggleButton=null;descriptionEl=null;highContrast=!1;show(t){const s=document.getElementById("ui-overlay");if(s){if(this.highContrast=t.initialHighContrast,!this.overlay){this.overlay=document.createElement("div"),this.overlay.setAttribute("data-color-accessibility-settings",""),this.overlay.style.cssText=`
      ...
      `,this.toggleButton.addEventListener("click",()=>{this.highContrast=!this.highContrast,this.render(),t.onToggle(this.highContrast)});const a=document.createElement("button");a.textContent="とじる",a.style.cssText=`
        ...
        cursor: pointer;
        touch-action: manipulation;
      `,a.addEventListener("click",()=>this.hide()),e.appendChild(i),e.appendChild(this.descriptionEl),e.appendChild(this.toggleButton),e.appendChild(a),this.overlay.appendChild(e)}this.render(),s.appendChild(this.overlay)}}hide(){this.overlay?.remove()}isVisible(){return this.overlay?.isConnected===!0}render(){!this.toggleButton||!this.descriptionEl||(this.descriptionEl.textContent=this.highContrast?"いろだけじゃなく ふちや しまもようで わかりやすくしているよ。":"いろだけでなく かたちや うごきでも みわけられるようにするよ。",this.toggleButton.textContent=this.highContrast?"みやすくする: ON":"みやすくする: OFF",this.toggleButton.setAttribute("aria-pressed",this.highContrast?"true":"false"))}}function R(r,t){let s=!1,e=!1,i=null,a=null;const o=t.documentTarget??document,n=t.stopPropagation??!0,h=()=>{t.canActivate?.()!==!1&&t.onActivate()},l=y=>{t.onPressChange?.(y)},c=y=>{const C=y;return typeof C.clientX=="number"&&typeof C.clientY=="number"?{x:C.clientX,y:C.clientY}:null},d=y=>{const C=y;return typeof C.pointerId=="number"?C.pointerId:null},g=y=>{const C=d(y);return i===null||C===null||C===i},m=y=>{if(!s||a===null||t.moveTolerancePx===void 0)return!1;const C=c(y);return C===null?!1:Math.hypot(C.x-a.x,C.y-a.y)>t.moveTolerancePx},f=y=>{s=!1,e=y,i=null,a=null,l(!1),o.removeEventListener("pointermove",v,!0),o.removeEventListener("pointerup",p,!0),o.removeEventListener("pointercancel",x,!0)},p=y=>{if(!s||!g(y))return;if(m(y)){f(!0);return}const C=y.target,w=C===r||C instanceof Node&&r.contains(C),N=s&&w;f(N||!w),N&&h()},x=()=>{f(!0)},v=y=>{!s||!g(y)||m(y)&&f(!0)},S=y=>{t.canActivate?.()!==!1&&((t.preventDefaultOnPointerDown??!1)&&y.preventDefault(),n&&y.stopPropagation(),s=!0,e=!1,i=d(y),a=c(y),l(!0),t.moveTolerancePx!==void 0&&o.addEventListener("pointermove",v,!0),o.addEventListener("pointerup",p,!0),o.addEventListener("pointercancel",x,!0))},E=()=>{s&&l(!0)},b=()=>{s&&l(!1)},O=()=>{f(!0)},I=y=>{if(n&&y.stopPropagation(),(t.preventDefaultOnClick??!1)&&y.preventDefault(),e){e=!1;return}s||h()};return r.addEventListener("pointerdown",S),r.addEventListener("pointerenter",E),r.addEventListener("pointerleave",b),r.addEventListener("pointercancel",O),r.addEventListener("click",I),()=>{f(!1),r.removeEventListener("pointerdown",S),r.removeEventListener("pointerenter",E),r.removeEventListener("pointerleave",b),r.removeEventListener("pointercancel",O),r.removeEventListener("click",I)}}class te{overlay=null;previewBody=null;previewNose=null;previewWings=null;buttonCleanups=new Set;optionButtons=new Map;draft={...rt};colorOptions=G.getColorOptions();show(t){this.hide();const s=document.getElementById("ui-overlay");if(!s)return;this.draft=G.normalizeCustomization(t.initialCustomization),this.overlay=document.createElement("div"),this.overlay.setAttribute("data-spaceship-customizer",""),this.overlay.setAttribute("role","dialog"),this.overlay.setAttribute("aria-modal","true"),this.overlay.setAttribute("aria-label","うちゅうせんを かざろう"),this.overlay.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
  ...
  `,o.appendChild(l),o}const Et=2e3,K=new Map,J=new Map,tt=new Map;let Z=null,Y=null;function X(r,t){if(typeof document>"u"){const e=typeof OffscreenCanvas=="function",i=e?new OffscreenCanvas(r,t):{width:r,height:t};return{canvas:i,ctx:e?i.getContext("2d"):null}}const s=document.createElement("canvas");return s.width=r,s.height=t,{canvas:s,ctx:s.getContext("2d")}}function z(r,t){let s=K.get(r);return s||(s=t(),s.generateMipmaps=!1,s.minFilter=Wt,s.needsUpdate=!0,K.set(r,s)),s}function T(r,t){let s=J.get(r);return s||(s=t(),J.set(r,s)),s}function M(r,t){let s=tt.get(r);return s||(s=t(),tt.set(r,s)),s}function B(r,t){const s=new Vt(r,t);return s.userData.sharedAssets=!0,s}function Mt(){if(!Z){const r=new ct,t=new Float32Array(Et*3);for(let s=0;s<Et*3;s+=3)t[s]=(Math.random()-.5)*200,t[s+1]=(Math.random()-.5)*200,t[s+2]=(Math.random()-.5)*400;r.setAttribute("position",new dt(t,3)),Z=r}Y||(Y=new ut({color:16777215,size:.2,sizeAttenuation:!0}))}function se(){const{canvas:r,ctx:t}=X(256,256);if(!t)return new D(r);t.fillStyle="#888888",t.fillRect(0,0,256,256);for(let s=0;s<30;s++){const e=Math.random()*256,i=Math.random()*256,a=3+Math.random()*12;t.beginPath(),t.arc(e,i,a,0,Math.PI*2),t.fillStyle=`rgba(60,60,60,${.3+Math.random()*.4})`,t.fill()}return new D(r)}function ie(){const{canvas:r,ctx:t}=X(256,256);if(!t)return new D(r);t.fillStyle="#ddaa44",t.fillRect(0,0,256,256);for(let s=0;s<8;s++){t.beginPath();const e=128+(Math.random()-.5)*100,i=128+(Math.random()-.5)*100;t.strokeStyle=`rgba(200,150,60,${.3+Math.random()*.3})`,t.lineWidth=3+Math.random()*5;for(let a=0;a<Math.PI*4;a+=.1){const o=10+a*8;t.lineTo(e+Math.cos(a)*o,i+Math.sin(a)*o)}t.stroke()}return new D(r)}function ae(){const{canvas:r,ctx:t}=X(256,256);if(!t)return new D(r);const s=["#cc7733","#dd9955","#bb6622","#eebb77","#aa5511","#ddaa66"];for(let e=0;e<256;e++){const i=Math.floor(e/(256/s.length))%s.length;t.fillStyle=s[i],t.fillRect(0,e,256,1)}return new D(r)}function ne(){const{canvas:r,ctx:t}=X(512,256);return t?(t.fillStyle="#2266aa",t.fillRect(0,0,512,256),t.fillStyle="#886644",t.beginPath(),t.ellipse(300,80,80,40,.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(280,150,30,50,.1,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(100,90,25,60,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(110,170,20,40,-.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(420,170,25,15,0,0,Math.PI*2),t.fill(),t.fillStyle="#447733",t.beginPath(),t.ellipse(290,75,40,20,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(95,85,15,30,.2,0,Math.PI*2),t.fill(),new D(r)):new D(r)}function oe(){const{canvas:r,ctx:t}=X(512,256);if(!t)return new D(r);t.clearRect(0,0,512,256),t.fillStyle="rgba(255,255,255,0.6)";for(let s=0;s<20;s++){const e=Math.random()*512,i=Math.random()*256;t.beginPath(),t.ellipse(e,i,20+Math.random()*40,8+Math.random()*15,Math.random()*Math.PI,0,Math.PI*2),t.fill()}return new D(r)}function re(){K.clear(),J.clear(),tt.clear(),Z=null,Y=null}const le={planetTextureCache:K,planetGeometryCache:J,planetMaterialCache:tt,getBgStarsGeometry:()=>Z,getBgStarsMaterial:()=>Y};function Bt(r,t,s){const e=new W;let i=null;switch(r){case 2:{const a=z("mercury",se),o=T("mercury:sphere",()=>new k(10,24,24)),n=M("mercury:mat",()=>new A({map:a})),h=B(o,n);e.add(h),i=h;break}case 3:{const a=z("venus",ie),o=T("venus:sphere",()=>new k(14,24,24)),n=M("venus:mat",()=>new A({map:a})),h=B(o,n);e.add(h),i=h;break}case 5:{const a=z("jupiter",ae),o=T("jupiter:sphere",()=>new k(20,24,24)),n=M("jupiter:mat",()=>new A({map:a})),h=B(o,n);e.add(h),i=h;break}case 6:{const a=T("saturn:sphere",()=>new k(15,24,24)),o=t.planetColor,n=M(`saturn:mat:${o}`,()=>new A({color:o})),h=B(a,n);e.add(h);const l=T("saturn:ring",()=>new Ct(20,30,48)),c=M("saturn:ringMat",()=>new A({color:15645542,side:vt})),d=B(l,c);d.rotation.x=Math.PI/3,e.add(d),i=h;break}case 7:{const a=T("uranus:sphere",()=>new k(16,24,24)),o=M("uranus:mat",()=>new A({color:6737117})),n=B(a,o);e.add(n);const h=T("uranus:ring",()=>new Ct(21,28,48)),l=M("uranus:ringMat",()=>new A({color:10083822,side:vt})),c=B(h,l);c.rotation.z=Math.PI/2,e.add(c),i=n;break}case 9:{const a=T("pluto:sphere",()=>new k(8,24,24)),o=M("pluto:mat",()=>new A({color:12298922})),n=B(a,o);e.add(n),i=n;break}case 10:{const a=T("sun:sphere",()=>new k(25,24,24)),o=M("sun:mat",()=>new A({color:16763904,emissive:16755200,emissiveIntensity:.5})),n=B(a,o);e.add(n),e.add(new Xt(16763904,2,200)),i=n;break}case 11:{const a=z("earth",ne),o=T("earth:sphere",()=>new k(15,32,32)),n=M("earth:mat",()=>new A({map:a})),h=z("earth:cloud",oe),l=T("earth:cloudSphere",()=>new k(15.5,32,32)),c=M("earth:cloudMat",()=>new A({map:h,transparent:!0,opacity:.3})),d=new W;d.add(B(o,n)),d.add(B(l,c)),e.add(d),i=d;break}default:{const a=T("default:sphere",()=>new k(15,24,24)),o=t.planetColor,n=M(`default:mat:${o}`,()=>new A({color:o})),h=B(a,n);e.add(h),i=h;break}}return e.position.set(0,0,s),{planet:e,spinTarget:i}}function he(r,t,s){return Bt(r,t,s)}function ce(r){Mt();const t=new ht(Z,Y);return t.userData.sharedAssets=!0,t.geometry.setDrawRange(0,r),t}function bt(r){!Number.isInteger(r)||r<1||r>H||typeof document>"u"&&typeof OffscreenCanvas!="function"||(Mt(),Bt(r,lt(r),0))}let $=null,j=null;function de(){if(!$){const r=new ct,t=new Float32Array(3e3);for(let s=0;s<3e3;s++)t[s]=(Math.random()-.5)*200;r.setAttribute("position",new dt(t,3)),$=r}return $}function ue(){return j||(j=new ut({color:16777215,size:.3,sizeAttenuation:!0})),j}function me(){$=null,j=null}const pe={getBgStarsGeometry:()=>$,getBgStarsMaterial:()=>j};function fe(r){const t=window.requestIdleCallback;if(typeof t=="function"){t(r,{timeout:1500});return}window.setTimeout(r,800)}function Pt(r){return new Set(r.filter(t=>Number.isInteger(t)&&t>=1&&t<=H)).size}function ge(r){return Pt(r)>=H}function it(r){const t=ge(r.unlockedPlanets),s=t?1:Math.min(r.clearedStage+1,H),e=lt(s),i=r.bestStageStars?.[s]??0;return t?{startStage:s,destination:e.destinationReading,emoji:e.emoji,statusLabel:"ぜんぶ あつめたよ！",destinationLabel:`${e.destinationReading}へ もういちど しゅっぱつ！`,buttonHint:`${e.emoji} ステージ ${s} から もういちど あそぶ`,bestStars:i}:{startStage:s,destination:e.destinationReading,emoji:e.emoji,statusLabel:r.clearedStage>0?"つづきから しゅっぱつ！":"はじめての しゅっぱつ！",destinationLabel:`${e.destinationReading}へ むかおう！`,buttonHint:`${e.emoji} ステージ ${s} から スタート`,bestStars:i}}function ye(r){return r.clearedStage>0||Pt(r.unlockedPlanets)>0||Object.keys(r.bestStageStars??{}).length>0}class be{threeScene;ambientLight=new mt(16777215,1);camera;lastAspect=0;sceneManager;saveManager;audioManager;stars=null;companionParade=null;overlay=null;muteHandle=null;tutorialOverlay=new gt;titleResetConfirmOverlay=new Kt;colorAccessibilitySettings=new Jt;spaceshipCustomizer=new te;encyclopediaOverlay=null;encyclopediaOverlayPromise=null;companionFactory=null;companionFactoryPromise=null;loadEncyclopediaOverlay;loadTitleCompanionFactory;loadingOverlay;loadFailureOverlay;scheduleIdleTask;encyclopediaBtn=null;isOpeningEncyclopedia=!1;isActive=!1;encyclopediaRequestToken=0;companionParadeRequestToken=0;bgmPending=!1;overlayButtonCleanups=new Set;constructor(t,s,e,i={}){this.sceneManager=t,this.saveManager=s,this.audioManager=e,this.loadingOverlay=i.loadingOverlay??new It,this.loadFailureOverlay=i.loadFailureOverlay??new kt,this.scheduleIdleTask=i.scheduleIdleTask??fe,this.loadEncyclopediaOverlay=i.loadEncyclopediaOverlay??(()=>nt(()=>import("./EncyclopediaOverlay-KpmMUQD8.js"),__vite__mapDeps([0,1,2]))),this.loadTitleCompanionFactory=i.loadTitleCompanionFactory??(()=>nt(()=>import("./game-core-BGtwARXY.js").then(n=>n.y),__vite__mapDeps([1,2]))),this.threeScene=new Q,this.threeScene.background=new pt(32);const{width:a,height:o}=_();this.camera=new ft(60,a/o,.1,1e3),this.camera.position.set(0,0,5)}enter(t){this.isActive=!0,this.encyclopediaRequestToken+=1,this.companionParadeRequestToken+=1,this.lastAspect=0,this.stars=new ht(de(),ue()),this.stars.userData.sharedAssets=!0,this.stars.rotation.set(0,0,0),this.threeScene.add(this.stars),this.ambientLight.parent||this.threeScene.add(this.ambientLight);const s=this.saveManager.load();this.createCompanionParade(s.unlockedPlanets),this.createOverlay(),this.createMuteButton(),this.prefetchEncyclopediaOnIdle(),this.prewarmNextAdventureOnIdle(it(s).startStage),this.audioManager.isInitialized()?(this.audioManager.playBGM(0),this.bgmPending=!1):this.bgmPending=!0,s.tutorialShown||this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide(),this.saveManager.markTutorialShown()})}createMuteButton(){const t=document.getElementById("hud")??document.getElementById("ui-overlay");t&&(this.muteHandle=yt({initialMuted:this.audioManager.isMuted(),container:t,onToggle:()=>{this.ensureTitleAudioInitialized(!0);const s=this.audioManager.toggleMute();this.muteHandle?.setMuted(s);const e=this.saveManager.load();e.muted=s,this.saveManager.save(e)}}))}getEncyclopediaOverlay(){return this.encyclopediaOverlay?Promise.resolve(this.encyclopediaOverlay):this.encyclopediaOverlayPromise?this.encyclopediaOverlayPromise:(this.encyclopediaOverlayPromise=this.loadEncyclopediaOverlay().then(({EncyclopediaOverlay:t})=>{const s=new t;return this.encyclopediaOverlay=s,s}).finally(()=>{this.encyclopediaOverlayPromise=null}),this.encyclopediaOverlayPromise)}getTitleCompanionFactory(){return this.companionFactory?Promise.resolve(this.companionFactory):this.companionFactoryPromise?this.companionFactoryPromise:(this.companionFactoryPromise=this.loadTitleCompanionFactory().then(t=>(this.companionFactory=t,t)).finally(()=>{this.companionFactoryPromise=null}),this.companionFactoryPromise)}showEncyclopedia(){if(!this.isActive||!this.encyclopediaOverlay)return;const t=this.saveManager.load();this.encyclopediaOverlay.show(t.unlockedPlanets,()=>this.refreshEncyclopediaButtonLabel(),s=>{this.ensureTitleAudioInitialized(!1),this.sceneManager.requestTransition("stage",{stageNumber:s,totalScore:0,totalStarCount:0,launchSource:"encyclopedia"})},t.bestStageStars??{})}isCurrentEncyclopediaRequest(t){return this.isActive&&this.encyclopediaRequestToken===t}prefetchEncyclopediaOnIdle(){const t=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{!this.isCurrentEncyclopediaRequest(t)||this.encyclopediaOverlay||this.encyclopediaOverlayPromise||this.getEncyclopediaOverlay().catch(()=>{})})}prewarmNextAdventureOnIdle(t){if(t>H)return;const s=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{this.isCurrentEncyclopediaRequest(s)&&bt(t)})}async openEncyclopedia(){if(!this.isActive)return;if(this.loadFailureOverlay.hide(),this.encyclopediaOverlay){this.showEncyclopedia();return}if(this.isOpeningEncyclopedia)return;const t=this.encyclopediaRequestToken;this.isOpeningEncyclopedia=!0,this.loadingOverlay.show("ずかんを よんでるよ...");try{if(await this.getEncyclopediaOverlay(),!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),this.showEncyclopedia()}catch(s){if(!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),console.error("Failed to load encyclopedia overlay",s),this.loadFailureOverlay.show({title:"ずかんの じゅんびが できなかったよ",message:"「もういちど よむ」を おしてね",primaryAction:{label:"もういちど よむ",onSelect:()=>this.openEncyclopedia()}})}finally{this.encyclopediaRequestToken===t&&(this.isOpeningEncyclopedia=!1)}}persistHighContrastSetting(t){const s=this.saveManager.load();t?s.colorAccessibility={highContrast:!0}:delete s.colorAccessibility,this.saveManager.save(s)}createOverlay(){const t=document.getElementById("ui-overlay");if(!t)return;const s=this.saveManager.load(),e=it(s);this.overlay=document.createElement("div"),this.overlay.style.cssText=`
    ...
    `;const c=document.createElement("div");c.textContent=e.destinationLabel,c.style.cssText=`
      ...
      font-weight: 700;
      color: rgba(255, 255, 255, 0.92);
    `;const d=wt(e.startStage,e.bestStars),g=ot(e.startStage,e.bestStars,{label:"メダル",hint:d.nextThreshold===null?"かんぺき！":`${d.icon} いま ・ つぎ ⭐ ${d.nextThreshold}`,size:"regular",scope:"title-next-adventure"});g.style.marginTop="0.7rem",o.appendChild(n),o.appendChild(h),o.appendChild(l),o.appendChild(c),o.appendChild(g);const m=document.createElement("div");m.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      gap: 0.65rem;
    `;const f=document.createElement("button");f.textContent="あそぶ",f.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(R(f,{onActivate:()=>{this.ensureTitleAudioInitialized(!1);const b=this.saveManager.load(),O=it(b).startStage;this.sceneManager.requestTransition("stage",{stageNumber:O,totalScore:0,totalStarCount:0,launchSource:"campaign"})},onPressChange:b=>{f.style.transform=b?"scale(0.96)":"scale(1)"}}));const p=document.createElement("div");p.setAttribute("data-play-button-hint",""),p.textContent=e.buttonHint,p.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${i?"0.85rem":"1rem"};
      font-weight: 700;
    ...
    `,this.overlayButtonCleanups.add(R(S,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.colorAccessibilitySettings.show({initialHighContrast:this.saveManager.load().colorAccessibility?.highContrast===!0,onToggle:b=>this.persistHighContrastSetting(b)})},onPressChange:b=>{S.style.transform=b?"translateX(-50%) scale(0.96)":"translateX(-50%) scale(1)"}}));const E=document.createElement("button");if(E.textContent=xt(s.unlockedPlanets.length,F.length),E.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,E.style.position="absolute",E.style.bottom=i?"1rem":"2rem",E.style.left=i?"1rem":"2rem",this.encyclopediaBtn=E,this.overlayButtonCleanups.add(R(E,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.openEncyclopedia()},onPressChange:b=>{E.style.transform=b?"scale(0.96)":"scale(1)"}})),m.appendChild(f),m.appendChild(p),m.appendChild(x),ye(s)){const b=document.createElement("button");b.setAttribute("data-reset-progress-button",""),b.textContent="さいしょから",b.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: 1.15rem;
        font-weight: 900;
      ...
      pointer-events: auto;
      z-index: 60;
    `,this.overlayEl.style.background="rgba(0, 0, 32, 0.92)";let i=!1;const a=()=>{i||(i=!0,this.hide(),s())},o=()=>{i||(i=!0,this.hide(),t())};this.overlayEl.addEventListener("pointerdown",f=>{f.target===this.overlayEl&&a()});const n=document.createElement("div");n.setAttribute("data-home-confirm-card",""),n.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
    ...
    `,i.appendChild(o);const n=document.createElement("div");n.style.cssText=`
      ...
      align-items: stretch;
      width: 100%;
    `,i.appendChild(n);const h=(l,c,d,g,m,f)=>{const p=document.createElement("button");p.setAttribute(c,""),p.setAttribute("aria-label",d),p.textContent=l,p.style.cssText=`
        flex: 1 1 140px;
        padding: 1rem 1.2rem;
        border: none;
        border-radius: 1.6rem;
