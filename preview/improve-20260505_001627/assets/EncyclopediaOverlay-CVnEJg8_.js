import{$ as k,a0 as z,a1 as N,P as G,f as O,a2 as F,K as Z}from"./game-core-B4buqd7A.js";import{y as j,P as B,x as V,z as W}from"./three-B3e-47pp.js";import{a as w,c as L}from"./game-scenes-BVJ-Rkul.js";const P=120,H=1.5,X=.015;function Y(y={}){const t=y.createRenderer??k,d=y.createPreviewMesh??z,e=y.raf??requestAnimationFrame,n=y.caf??cancelAnimationFrame;let l=!1,s=!1,i=null,a=null,r=null,o=null,c=null,m=null,f=null,p=null,g=!1;const b=()=>i||(i=document.createElement("canvas"),i.setAttribute("data-companion-preview-canvas",""),i.style.cssText=`
      width: 100%;
      height: 100%;
      display: block;
    `,i),u=()=>a||(a=document.createElement("div"),a.setAttribute("data-companion-preview-fallback",""),a.textContent="👾",a.style.cssText=`
      width: 100%;
      height: 100%;
      display: flex;
      align-items: center;
    ...
    `,a),x=()=>{g&&(g=!1,p!==null&&(n(p),p=null))},v=()=>{!o||!m||(o.remove(m),N(m),m=null)},D=()=>{f?.replaceChildren(),i?.remove(),a?.remove(),f=null},I=()=>{!r||!o||!c||r.render(o,c)},_=()=>{if(g||!r||!o||!c||!m)return;g=!0;const C=()=>{!g||l||!r||!o||!c||!m||(m.rotation.y+=X,r.render(o,c),p=e(C))};p=e(C)},R=()=>{if(r&&o&&c)return!0;if(!(typeof window<"u"&&(typeof window.WebGLRenderingContext<"u"||typeof window.WebGL2RenderingContext<"u"))||s)return s=!0,!1;try{const E=Math.min(typeof window<"u"&&window.devicePixelRatio||1,H),A=t(b(),E);A.setPixelRatio(E),A.setSize(P,P,!1),A.setClearColor(0,0);const T=new j,S=new B(32,1,.1,20);S.position.set(0,.15,3.1);const M=new V(16777215,1.5),$=new W(16777215,1.2);return $.position.set(2,3,4),T.add(M,$),r=A,o=T,c=S,!0}catch{return i?.remove(),r=null,o=null,c=null,s=!0,!1}};return{show(C,E){if(!l){if(x(),v(),f=E,!R()){E.replaceChildren(u());return}E.replaceChildren(b()),m=d(C),o?.add(m),I(),_()}},hide(){l||(x(),v(),D())},dispose(){l||(this.hide(),l=!0,r?.forceContextLoss?.(),r?.dispose(),r=null,o=null,c=null,i=null,a=null)}}}class h{static RELEASE_CONFIRM_MOVE_TOLERANCE_PX=12;static GALLERY_TITLE_ID="encyclopedia-gallery-title";static DETAIL_TITLE_ID="encyclopedia-detail-title";overlayEl=null;detailEl=null;isShowingDetail=!1;onSelectStage=null;bestStageStars={};discoveredConstellations=[];detailBackLabel="もどる";detailPreviewController=null;createPreviewController;galleryActionCleanups=new Set;detailActionCleanups=new Set;static COMPACT_HEIGHT_THRESHOLD=720;constructor(t={}){this.createPreviewController=t.createPreviewController??Y}show(t,d,e,n,l=[]){if(this.overlayEl)return;this.onSelectStage=e??null,this.bestStageStars=n??{},this.discoveredConstellations=l,this.detailBackLabel="もどる";const s=document.getElementById("ui-overlay");if(!s)return;this.overlayEl=document.createElement("div"),this.applyOverlayStyle(this.overlayEl,30),this.overlayEl.setAttribute("role","dialog"),this.overlayEl.setAttribute("aria-modal","true"),this.overlayEl.setAttribute("aria-labelledby",h.GALLERY_TITLE_ID);const i=this.isCompactHeight(),a=document.createElement("div");a.setAttribute("data-gallery-content",""),a.style.cssText=`
      width: min(960px, 100%);
    ...
    `;const r=document.createElement("div");r.id=h.GALLERY_TITLE_ID,r.textContent="わくせいずかん",r.style.cssText=`
      ...
      text-align: center;
    `,a.appendChild(r);const o=document.createElement("div");o.setAttribute("data-gallery-grid",""),o.setAttribute("aria-label","わくせい の いちらん"),o.style.cssText=`
      display: grid;
      grid-template-columns: repeat(auto-fit, minmax(${i?"110px":"140px"}, 1fr));
      gap: ${i?"0.7rem":"1rem"};
      width: min(100%, 820px);
      justify-items: center;
    `;for(const m of G){const f=t.includes(m.stageNumber),p=this.createCard(m,f,i);o.appendChild(p)}a.appendChild(o),a.appendChild(this.createConstellationSection(i));const c=document.createElement("button");c.setAttribute("data-gallery-back",""),c.textContent="もどる",c.style.cssText=`
    ...
    `;for(const l of F){const s=this.discoveredConstellations.includes(l.stageNumber),i=document.createElement("div");i.setAttribute("data-constellation-card",""),i.setAttribute("data-stage",String(l.stageNumber)),i.style.cssText=`
      ...
      `;const a=document.createElement("div");a.textContent=`ステージ ${l.stageNumber}`,a.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: ${t?"0.75rem":"0.82rem"};
        font-weight: 700;
      `,i.appendChild(a);const r=document.createElement("div");r.textContent=s?l.name:"？？？",r.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: ${t?"0.95rem":"1rem"};
        font-weight: 900;
        margin-top: 0.2rem;
        text-align: center;
      `,i.appendChild(r),n.appendChild(i)}return d.appendChild(n),d}createCard(t,d,e){const n=document.createElement("div");if(n.setAttribute("data-card",""),n.setAttribute("data-stage",String(t.stageNumber)),n.style.cssText=`
    ...
    `;const s=document.createElement("div");s.setAttribute("data-detail-card",""),s.style.cssText=`
      ...
      overflow-y: auto;
      box-sizing: border-box;
    `;const i=document.createElement("div");i.textContent=t.emoji,i.setAttribute("aria-hidden","true"),i.style.fontSize=e?"3rem":"4rem",s.appendChild(i);const a=document.createElement("div");a.id=h.DETAIL_TITLE_ID,a.textContent=t.encyclopediaLabel,a.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      ...
      margin: 0.5rem 0;
      text-align: center;
    `,s.appendChild(a);const r=document.createElement("div");r.setAttribute("data-detail-companion",""),r.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      gap: 0.6rem;
    ...
    `,r.appendChild(o);const c=document.createElement("div");c.setAttribute("data-detail-companion-preview",""),c.setAttribute("aria-hidden","true"),c.style.cssText=`
      width: ${e?"96px":"120px"};
      height: ${e?"96px":"120px"};
      border-radius: 20px;
      overflow: hidden;
    ...
    `,r.appendChild(c),this.getDetailPreviewController().show(t,c),s.appendChild(r);const m=document.createElement("div");m.textContent=t.trivia,m.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${e?"1rem":"1.2rem"};
      color: #fff;
