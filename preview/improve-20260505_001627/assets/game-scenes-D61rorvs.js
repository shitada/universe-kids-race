const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-12VyBVgN.js","assets/game-core-C3As5Sq_.js","assets/three-By3JikJA.js"])))=>i.map(i=>d[i]);
import{D as ct,S as z,T as D,g as st,a as Tt,L as kt,b as Dt,_ as rt,c as G,d as V,P as N,u as Ht,C as Lt,e as Gt,f as zt,B as _t,h as Ft,M as Nt,i as $t,j as Ut,k as jt,l as Zt,A as qt,m as Yt,n as Xt,o as Mt,p as Vt,q as Wt,r as Qt,s as Kt,t as it,v as at,w as Jt,x as te,y as ee}from"./game-core-C3As5Sq_.js";import{m as dt,k as ut,i as mt,l as pt,G as W,o as se,a as ie,p as ae,M as B,g as k,D as Et,R as xt,q as H,r as ft,s as Q,h as gt,P as yt,V as lt,t as ne,u as oe}from"./three-By3JikJA.js";class bt{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const e=document.getElementById("ui-overlay");if(!e)return;const s=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
    ...
    `,n.appendChild(o),n.appendChild(h),n.appendChild(c),n}isCompactHeight(){return window.innerHeight<=bt.COMPACT_HEIGHT_THRESHOLD}injectAnimations(){if(document.getElementById("tutorial-animations"))return;const t=document.createElement("style");t.id="tutorial-animations",t.textContent=`
      @keyframes swipe {
    ...
    `,document.head.appendChild(t)}}class re{overlayEl=null;activePressCleanups=new Set;show(t,e){if(this.overlayEl)return;const s=document.getElementById("ui-overlay");if(!s)return;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-title-reset-confirm-overlay",""),this.overlayEl.setAttribute("role","dialog"),this.overlayEl.setAttribute("aria-modal","true"),this.overlayEl.setAttribute("aria-label","さいしょからに もどしますか"),this.overlayEl.style.cssText=`
      ...
      padding: 1.5rem;
      background: rgba(0, 0, 32, 0.92);
    `;let i=!1;const a=()=>{i||(i=!0,this.hide(),e())},n=()=>{i||(i=!0,this.hide(),t())};this.overlayEl.addEventListener("pointerdown",m=>{m.target===this.overlayEl&&a()});const o=document.createElement("div");o.setAttribute("data-title-reset-confirm-card",""),o.style.cssText=`
    ...
    `,g=(m,x)=>{let v=!1,C=!1;const w=()=>{A(!0)},S=()=>{m.style.transform="scale(0.92)"},b=()=>{m.style.transform="scale(1)"},A=(M=!1)=>{v=!1,C=M,b(),this.activePressCleanups.delete(w),document.removeEventListener("pointerup",y,!0),document.removeEventListener("pointercancel",E,!0)},y=M=>{const _=M.target===m||M.target instanceof Node&&m.contains(M.target),It=v&&_;A(!_),It&&x()},E=()=>{A(!0)};m.addEventListener("pointerdown",M=>{M.stopPropagation(),v=!0,C=!1,S(),this.activePressCleanups.add(w),document.addEventListener("pointerup",y,!0),document.addEventListener("pointercancel",E,!0)}),m.addEventListener("pointerenter",()=>{v&&S()}),m.addEventListener("pointerleave",()=>{v&&b()}),m.addEventListener("pointercancel",()=>A(!0)),m.addEventListener("click",M=>{if(M.stopPropagation(),C){C=!1;return}v||x()})},u=document.createElement("button");u.setAttribute("data-title-reset-cancel",""),u.textContent="やめる",u.style.cssText=p,u.style.background="rgba(255, 255, 255, 0.18)",u.style.color="#ffffff",g(u,a),l.appendChild(u);const d=document.createElement("button");d.setAttribute("data-title-reset-confirm",""),d.textContent="うん！ さいしょから",d.style.cssText=p,d.style.background="linear-gradient(135deg, #FF9F68, #FFE66D)",d.style.color="#3b1f00",g(d,n),l.appendChild(d),s.appendChild(this.overlayEl)}hide(){if(!this.overlayEl)return;const t=Array.from(this.activePressCleanups);this.activePressCleanups.clear();for(const e of t)e();this.overlayEl.remove(),this.overlayEl=null}}function vt(r){const t=r.topRem??.8,e=window.innerHeight<=500,s=document.createElement("button");let i=r.initialMuted;const a=()=>{s.textContent=i?"🔇":"🔊",s.setAttribute("aria-label",i?"サウンド オフ":"サウンド オン")};s.setAttribute("data-mute-button",""),s.style.position="absolute",s.style.top=`${t}rem`,s.style.right="1rem",s.style.fontSize=e?"clamp(1.1rem, 3.5vmin, 1.4rem)":"clamp(1.4rem, 4vmin, 1.8rem)",s.style.background="rgba(255, 255, 255, 0.15)",s.style.border="none",s.style.borderRadius="50%",s.style.width=e?"2.4rem":"3rem",s.style.height=e?"2.4rem":"3rem",s.style.display="flex",s.style.alignItems="center",s.style.justifyContent="center",s.style.cursor="pointer",s.style.pointerEvents="auto",s.style.touchAction="manipulation",s.style.transform="scale(1)",s.style.transition="transform 0.08s ease-out",a();const n=()=>{s.style.transform="scale(1)"};return s.addEventListener("pointerdown",o=>{o.stopPropagation(),s.style.transform="scale(0.9)",r.onToggle()}),s.addEventListener("pointerup",n),s.addEventListener("pointercancel",n),s.addEventListener("pointerleave",n),r.container.appendChild(s),{element:s,setMuted(o){i=o,a()},remove(){s.remove()}}}class le{overlay=null;toggleButton=null;descriptionEl=null;highContrast=!1;show(t){const e=document.getElementById("ui-overlay");if(e){if(this.highContrast=t.initialHighContrast,!this.overlay){this.overlay=document.createElement("div"),this.overlay.setAttribute("data-color-accessibility-settings",""),this.overlay.style.cssText=`
      ...
      `,this.toggleButton.addEventListener("click",()=>{this.highContrast=!this.highContrast,this.render(),t.onToggle(this.highContrast)});const a=document.createElement("button");a.textContent="とじる",a.style.cssText=`
        ...
        cursor: pointer;
        touch-action: manipulation;
      `,a.addEventListener("click",()=>this.hide()),s.appendChild(i),s.appendChild(this.descriptionEl),s.appendChild(this.toggleButton),s.appendChild(a),this.overlay.appendChild(s)}this.render(),e.appendChild(this.overlay)}}hide(){this.overlay?.remove()}isVisible(){return this.overlay?.isConnected===!0}render(){!this.toggleButton||!this.descriptionEl||(this.descriptionEl.textContent=this.highContrast?"いろだけじゃなく ふちや しまもようで わかりやすくしているよ。":"いろだけでなく かたちや うごきでも みわけられるようにするよ。",this.toggleButton.textContent=this.highContrast?"みやすくする: ON":"みやすくする: OFF",this.toggleButton.setAttribute("aria-pressed",this.highContrast?"true":"false"))}}function T(r,t){let e=!1,s=!1,i=null,a=null;const n=t.documentTarget??document,o=t.stopPropagation??!0,h=()=>{t.canActivate?.()!==!1&&t.onActivate()},c=y=>{t.onPressChange?.(y)},l=y=>{const E=y;return typeof E.clientX=="number"&&typeof E.clientY=="number"?{x:E.clientX,y:E.clientY}:null},p=y=>{const E=y;return typeof E.pointerId=="number"?E.pointerId:null},g=y=>{const E=p(y);return i===null||E===null||E===i},u=y=>{if(!e||a===null||t.moveTolerancePx===void 0)return!1;const E=l(y);return E===null?!1:Math.hypot(E.x-a.x,E.y-a.y)>t.moveTolerancePx},d=y=>{e=!1,s=y,i=null,a=null,c(!1),n.removeEventListener("pointermove",v,!0),n.removeEventListener("pointerup",m,!0),n.removeEventListener("pointercancel",x,!0)},m=y=>{if(!e||!g(y))return;if(u(y)){d(!0);return}const E=y.target,M=E===r||E instanceof Node&&r.contains(E),_=e&&M;d(_||!M),_&&h()},x=()=>{d(!0)},v=y=>{!e||!g(y)||u(y)&&d(!0)},C=y=>{t.canActivate?.()!==!1&&((t.preventDefaultOnPointerDown??!1)&&y.preventDefault(),o&&y.stopPropagation(),e=!0,s=!1,i=p(y),a=l(y),c(!0),t.moveTolerancePx!==void 0&&n.addEventListener("pointermove",v,!0),n.addEventListener("pointerup",m,!0),n.addEventListener("pointercancel",x,!0))},w=()=>{e&&c(!0)},S=()=>{e&&c(!1)},b=()=>{d(!0)},A=y=>{if(o&&y.stopPropagation(),(t.preventDefaultOnClick??!1)&&y.preventDefault(),s){s=!1;return}e||h()};return r.addEventListener("pointerdown",C),r.addEventListener("pointerenter",w),r.addEventListener("pointerleave",S),r.addEventListener("pointercancel",b),r.addEventListener("click",A),()=>{d(!1),r.removeEventListener("pointerdown",C),r.removeEventListener("pointerenter",w),r.removeEventListener("pointerleave",S),r.removeEventListener("pointercancel",b),r.removeEventListener("click",A)}}class he{overlay=null;previewBody=null;previewNose=null;previewWings=null;buttonCleanups=new Set;optionButtons=new Map;draft={...ct};colorOptions=z.getColorOptions();show(t){this.hide();const e=document.getElementById("ui-overlay");if(!e)return;this.draft=z.normalizeCustomization(t.initialCustomization),this.overlay=document.createElement("div"),this.overlay.setAttribute("data-spaceship-customizer",""),this.overlay.setAttribute("role","dialog"),this.overlay.setAttribute("aria-modal","true"),this.overlay.setAttribute("aria-label","うちゅうせんを かざろう"),this.overlay.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
    ...
    `,o.appendChild(h);const c=document.createElement("div");c.style.cssText=`
      ...
      gap: 0.8rem;
      margin-bottom: 1rem;
    `,c.append(this.createSummaryCard("あそんだ じかん",de(i.totalPlayTimeSeconds),"data-stats-total-play-time"),this.createSummaryCard("とった ほし",`${i.totalStarsCollected}こ`,"data-stats-total-stars"),this.createSummaryCard("ブースト",`${i.totalBoostUses}かい`,"data-stats-total-boosts")),o.appendChild(c);const l=document.createElement("div");l.style.cssText=`
      margin-top: 0.5rem;
    ...
    `;const u=Array.from({length:D},(m,x)=>x+1).map(m=>({stageNumber:m,clearCount:i.stageClearCounts[m]??0})).filter(m=>m.clearCount>0);if(u.length===0){const m=document.createElement("div");m.textContent="まだ きろくが ないよ",m.style.cssText=`
      ...
      `,g.appendChild(m)}else for(const{stageNumber:m,clearCount:x}of u){const v=st(m),C=document.createElement("div");C.setAttribute("data-stats-stage-clear-row",String(m)),C.style.cssText=`
          display: flex;
          align-items: center;
          ...
          font-weight: 700;
        `;const w=document.createElement("span");w.textContent=`${v.emoji} ステージ ${m} ${v.destinationReading}`;const S=document.createElement("span");S.textContent=`${x}かい`,S.style.color="#FFE66D",C.append(w,S),g.appendChild(C)}l.appendChild(g),o.appendChild(l);const d=document.createElement("button");d.textContent="もどる",d.style.cssText=`
      margin-top: 1rem;
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.actionCleanups.add(T(d,{onActivate:()=>{this.hide(),e()},onPressChange:m=>{d.style.transform=m?"scale(0.96)":"scale(1)"}})),o.appendChild(d),n.appendChild(o),s.appendChild(n)}hide(){const t=Array.from(this.actionCleanups);this.actionCleanups.clear();for(const e of t)e();this.overlayEl?.remove(),this.overlayEl=null}createSummaryCard(t,e,s){const i=document.createElement("div");i.setAttribute(s,""),i.style.cssText=`
    ...
    `;const n=document.createElement("div");return n.textContent=e,n.style.cssText=`
      ...
      font-weight: 900;
      color: #FFE66D;
    `,i.append(a,n),i}}function St(r,t){if(!Number.isFinite(r)||r<=0||t<=0)return"ずかん";const e=Math.min(r,t);return e>=t?`ずかん ${t} / ${t} 🎉`:`ずかん ${e} / ${t}`}function me(r){switch(r){case"hero":return{gap:"0.35rem",label:"0.92rem",medal:"1.7rem",hint:"0.98rem"};case"compact":return{gap:"0.18rem",label:"0.7rem",medal:"1rem",hint:"0.76rem"};default:return{gap:"0.26rem",label:"0.8rem",medal:"1.25rem",hint:"0.84rem"}}}function ht(r,t,e={}){const s=Tt(r,t),i=e.size??"regular",a=me(i),n=document.createElement("div");if(n.setAttribute("data-stage-medal-display",""),n.setAttribute("data-stage-medal-stage",String(r)),n.setAttribute("data-stage-medal-tier",s.tier),n.setAttribute("data-stage-medal-earned",String(s.earnedCount)),e.scope&&n.setAttribute("data-stage-medal-scope",e.scope),n.style.cssText=`
    display: flex;
    flex-direction: column;
    align-items: center;
    gap: ${a.gap};
  `,e.label){const l=document.createElement("div");l.textContent=e.label,l.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${a.label};
      font-weight: 700;
    ...
    justify-content: center;
    gap: ${a.gap};
  `;for(const l of s.slots){const p=document.createElement("span");p.setAttribute("data-stage-medal-slot",l.tier),p.setAttribute("data-stage-medal-threshold",String(l.threshold)),p.setAttribute("data-stage-medal-reached",String(l.reached)),p.textContent=l.icon,p.style.cssText=`
      font-size: ${a.medal};
      line-height: 1;
    ...
    `,o.appendChild(p)}n.appendChild(o);const h=e.hint??(s.nextThreshold===null?"かんぺき！":`つぎ ⭐ ${s.nextThreshold}`),c=document.createElement("div");return c.setAttribute("data-stage-medal-hint",""),c.textContent=h,c.style.cssText=`
    font-family: 'Zen Maru Gothic', sans-serif;
    font-size: ${a.hint};
    font-weight: 700;
    color: ${s.nextThreshold===null?"#FFE66D":"rgba(255, 255, 255, 0.86)"};
  `,n.appendChild(c),n}const wt=2e3,K=new Map,J=new Map,tt=new Map;let q=null,Y=null;function X(r,t){if(typeof document>"u"){const s=typeof OffscreenCanvas=="function",i=s?new OffscreenCanvas(r,t):{width:r,height:t};return{canvas:i,ctx:s?i.getContext("2d"):null}}const e=document.createElement("canvas");return e.width=r,e.height=t,{canvas:e,ctx:e.getContext("2d")}}function F(r,t){let e=K.get(r);return e||(e=t(),e.generateMipmaps=!1,e.minFilter=ae,e.needsUpdate=!0,K.set(r,e)),e}function P(r,t){let e=J.get(r);return e||(e=t(),J.set(r,e)),e}function O(r,t){let e=tt.get(r);return e||(e=t(),tt.set(r,e)),e}function R(r,t){const e=new ie(r,t);return e.userData.sharedAssets=!0,e}function Bt(){if(!q){const r=new ut,t=new Float32Array(wt*3);for(let e=0;e<wt*3;e+=3)t[e]=(Math.random()-.5)*200,t[e+1]=(Math.random()-.5)*200,t[e+2]=(Math.random()-.5)*400;r.setAttribute("position",new mt(t,3)),q=r}Y||(Y=new pt({color:16777215,size:.2,sizeAttenuation:!0}))}function pe(){const{canvas:r,ctx:t}=X(256,256);if(!t)return new H(r);t.fillStyle="#888888",t.fillRect(0,0,256,256);for(let e=0;e<30;e++){const s=Math.random()*256,i=Math.random()*256,a=3+Math.random()*12;t.beginPath(),t.arc(s,i,a,0,Math.PI*2),t.fillStyle=`rgba(60,60,60,${.3+Math.random()*.4})`,t.fill()}return new H(r)}function fe(){const{canvas:r,ctx:t}=X(256,256);if(!t)return new H(r);t.fillStyle="#ddaa44",t.fillRect(0,0,256,256);for(let e=0;e<8;e++){t.beginPath();const s=128+(Math.random()-.5)*100,i=128+(Math.random()-.5)*100;t.strokeStyle=`rgba(200,150,60,${.3+Math.random()*.3})`,t.lineWidth=3+Math.random()*5;for(let a=0;a<Math.PI*4;a+=.1){const n=10+a*8;t.lineTo(s+Math.cos(a)*n,i+Math.sin(a)*n)}t.stroke()}return new H(r)}function ge(){const{canvas:r,ctx:t}=X(256,256);if(!t)return new H(r);const e=["#cc7733","#dd9955","#bb6622","#eebb77","#aa5511","#ddaa66"];for(let s=0;s<256;s++){const i=Math.floor(s/(256/e.length))%e.length;t.fillStyle=e[i],t.fillRect(0,s,256,1)}return new H(r)}function ye(){const{canvas:r,ctx:t}=X(512,256);return t?(t.fillStyle="#2266aa",t.fillRect(0,0,512,256),t.fillStyle="#886644",t.beginPath(),t.ellipse(300,80,80,40,.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(280,150,30,50,.1,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(100,90,25,60,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(110,170,20,40,-.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(420,170,25,15,0,0,Math.PI*2),t.fill(),t.fillStyle="#447733",t.beginPath(),t.ellipse(290,75,40,20,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(95,85,15,30,.2,0,Math.PI*2),t.fill(),new H(r)):new H(r)}function be(){const{canvas:r,ctx:t}=X(512,256);if(!t)return new H(r);t.clearRect(0,0,512,256),t.fillStyle="rgba(255,255,255,0.6)";for(let e=0;e<20;e++){const s=Math.random()*512,i=Math.random()*256;t.beginPath(),t.ellipse(s,i,20+Math.random()*40,8+Math.random()*15,Math.random()*Math.PI,0,Math.PI*2),t.fill()}return new H(r)}function ve(){K.clear(),J.clear(),tt.clear(),q=null,Y=null}const Ce={planetTextureCache:K,planetGeometryCache:J,planetMaterialCache:tt,getBgStarsGeometry:()=>q,getBgStarsMaterial:()=>Y};function Pt(r,t,e){const s=new W;let i=null;switch(r){case 2:{const a=F("mercury",pe),n=P("mercury:sphere",()=>new k(10,24,24)),o=O("mercury:mat",()=>new B({map:a})),h=R(n,o);s.add(h),i=h;break}case 3:{const a=F("venus",fe),n=P("venus:sphere",()=>new k(14,24,24)),o=O("venus:mat",()=>new B({map:a})),h=R(n,o);s.add(h),i=h;break}case 5:{const a=F("jupiter",ge),n=P("jupiter:sphere",()=>new k(20,24,24)),o=O("jupiter:mat",()=>new B({map:a})),h=R(n,o);s.add(h),i=h;break}case 6:{const a=P("saturn:sphere",()=>new k(15,24,24)),n=t.planetColor,o=O(`saturn:mat:${n}`,()=>new B({color:n})),h=R(a,o);s.add(h);const c=P("saturn:ring",()=>new xt(20,30,48)),l=O("saturn:ringMat",()=>new B({color:15645542,side:Et})),p=R(c,l);p.rotation.x=Math.PI/3,s.add(p),i=h;break}case 7:{const a=P("uranus:sphere",()=>new k(16,24,24)),n=O("uranus:mat",()=>new B({color:6737117})),o=R(a,n);s.add(o);const h=P("uranus:ring",()=>new xt(21,28,48)),c=O("uranus:ringMat",()=>new B({color:10083822,side:Et})),l=R(h,c);l.rotation.z=Math.PI/2,s.add(l),i=o;break}case 9:{const a=P("pluto:sphere",()=>new k(8,24,24)),n=O("pluto:mat",()=>new B({color:12298922})),o=R(a,n);s.add(o),i=o;break}case 10:{const a=P("sun:sphere",()=>new k(25,24,24)),n=O("sun:mat",()=>new B({color:16763904,emissive:16755200,emissiveIntensity:.5})),o=R(a,n);s.add(o),s.add(new se(16763904,2,200)),i=o;break}case 11:{const a=F("earth",ye),n=P("earth:sphere",()=>new k(15,32,32)),o=O("earth:mat",()=>new B({map:a})),h=F("earth:cloud",be),c=P("earth:cloudSphere",()=>new k(15.5,32,32)),l=O("earth:cloudMat",()=>new B({map:h,transparent:!0,opacity:.3})),p=new W;p.add(R(n,o)),p.add(R(c,l)),s.add(p),i=p;break}default:{const a=P("default:sphere",()=>new k(15,24,24)),n=t.planetColor,o=O(`default:mat:${n}`,()=>new B({color:n})),h=R(a,o);s.add(h),i=h;break}}return s.position.set(0,0,e),{planet:s,spinTarget:i}}function Ee(r,t,e){return Pt(r,t,e)}function xe(r){Bt();const t=new dt(q,Y);return t.userData.sharedAssets=!0,t.geometry.setDrawRange(0,r),t}function Ct(r){!Number.isInteger(r)||r<1||r>D||typeof document>"u"&&typeof OffscreenCanvas!="function"||(Bt(),Pt(r,st(r),0))}let $=null,U=null;function Se(){if(!$){const r=new ut,t=new Float32Array(3e3);for(let e=0;e<3e3;e++)t[e]=(Math.random()-.5)*200;r.setAttribute("position",new mt(t,3)),$=r}return $}function we(){return U||(U=new pt({color:16777215,size:.3,sizeAttenuation:!0})),U}function Ae(){$=null,U=null}const Te={getBgStarsGeometry:()=>$,getBgStarsMaterial:()=>U};function Me(r){const t=window.requestIdleCallback;if(typeof t=="function"){t(r,{timeout:1500});return}window.setTimeout(r,800)}function Ot(r){return new Set(r.filter(t=>Number.isInteger(t)&&t>=1&&t<=D)).size}function Be(r){return Ot(r)>=D}function nt(r){const t=Be(r.unlockedPlanets),e=t?1:Math.min(r.clearedStage+1,D),s=st(e),i=r.bestStageStars?.[e]??0;return t?{startStage:e,destination:s.destinationReading,emoji:s.emoji,statusLabel:"ぜんぶ あつめたよ！",destinationLabel:`${s.destinationReading}へ もういちど しゅっぱつ！`,buttonHint:`${s.emoji} ステージ ${e} から もういちど あそぶ`,bestStars:i}:{startStage:e,destination:s.destinationReading,emoji:s.emoji,statusLabel:r.clearedStage>0?"つづきから しゅっぱつ！":"はじめての しゅっぱつ！",destinationLabel:`${s.destinationReading}へ むかおう！`,buttonHint:`${s.emoji} ステージ ${e} から スタート`,bestStars:i}}function Pe(r){return r.clearedStage>0||Ot(r.unlockedPlanets)>0||Object.keys(r.bestStageStars??{}).length>0}class Oe{threeScene;ambientLight=new ft(16777215,1);camera;lastAspect=0;sceneManager;saveManager;audioManager;stars=null;companionParade=null;overlay=null;muteHandle=null;tutorialOverlay=new bt;titleResetConfirmOverlay=new re;colorAccessibilitySettings=new le;spaceshipCustomizer=new he;statsOverlay=new ue;encyclopediaOverlay=null;encyclopediaOverlayPromise=null;companionFactory=null;companionFactoryPromise=null;loadEncyclopediaOverlay;loadTitleCompanionFactory;loadingOverlay;loadFailureOverlay;scheduleIdleTask;encyclopediaBtn=null;isOpeningEncyclopedia=!1;isActive=!1;encyclopediaRequestToken=0;companionParadeRequestToken=0;bgmPending=!1;overlayButtonCleanups=new Set;constructor(t,e,s,i={}){this.sceneManager=t,this.saveManager=e,this.audioManager=s,this.loadingOverlay=i.loadingOverlay??new kt,this.loadFailureOverlay=i.loadFailureOverlay??new Dt,this.scheduleIdleTask=i.scheduleIdleTask??Me,this.loadEncyclopediaOverlay=i.loadEncyclopediaOverlay??(()=>rt(()=>import("./EncyclopediaOverlay-12VyBVgN.js"),__vite__mapDeps([0,1,2]))),this.loadTitleCompanionFactory=i.loadTitleCompanionFactory??(()=>rt(()=>import("./game-core-C3As5Sq_.js").then(o=>o.J),__vite__mapDeps([1,2]))),this.threeScene=new Q,this.threeScene.background=new gt(32);const{width:a,height:n}=G();this.camera=new yt(60,a/n,.1,1e3),this.camera.position.set(0,0,5)}enter(t){this.isActive=!0,this.encyclopediaRequestToken+=1,this.companionParadeRequestToken+=1,this.lastAspect=0,this.stars=new dt(Se(),we()),this.stars.userData.sharedAssets=!0,this.stars.rotation.set(0,0,0),this.threeScene.add(this.stars),this.ambientLight.parent||this.threeScene.add(this.ambientLight);const e=this.saveManager.load();this.createCompanionParade(e.unlockedPlanets),this.createOverlay(),this.createMuteButton(),this.prefetchEncyclopediaOnIdle(),this.prewarmNextAdventureOnIdle(nt(e).startStage),this.audioManager.isInitialized()?(this.audioManager.playBGM(0),this.bgmPending=!1):this.bgmPending=!0,e.tutorialShown||this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide(),this.saveManager.markTutorialShown()})}createMuteButton(){const t=document.getElementById("hud")??document.getElementById("ui-overlay");t&&(this.muteHandle=vt({initialMuted:this.audioManager.isMuted(),container:t,onToggle:()=>{this.ensureTitleAudioInitialized(!0);const e=this.audioManager.toggleMute();this.muteHandle?.setMuted(e);const s=this.saveManager.load();s.muted=e,this.saveManager.save(s)}}))}getEncyclopediaOverlay(){return this.encyclopediaOverlay?Promise.resolve(this.encyclopediaOverlay):this.encyclopediaOverlayPromise?this.encyclopediaOverlayPromise:(this.encyclopediaOverlayPromise=this.loadEncyclopediaOverlay().then(({EncyclopediaOverlay:t})=>{const e=new t;return this.encyclopediaOverlay=e,e}).finally(()=>{this.encyclopediaOverlayPromise=null}),this.encyclopediaOverlayPromise)}getTitleCompanionFactory(){return this.companionFactory?Promise.resolve(this.companionFactory):this.companionFactoryPromise?this.companionFactoryPromise:(this.companionFactoryPromise=this.loadTitleCompanionFactory().then(t=>(this.companionFactory=t,t)).finally(()=>{this.companionFactoryPromise=null}),this.companionFactoryPromise)}showEncyclopedia(){if(!this.isActive||!this.encyclopediaOverlay)return;const t=this.saveManager.load();this.encyclopediaOverlay.show(t.unlockedPlanets,()=>this.refreshEncyclopediaButtonLabel(),e=>{this.ensureTitleAudioInitialized(!1),this.sceneManager.requestTransition("stage",{stageNumber:e,totalScore:0,totalStarCount:0,launchSource:"encyclopedia"})},t.bestStageStars??{},t.discoveredConstellations??[])}isCurrentEncyclopediaRequest(t){return this.isActive&&this.encyclopediaRequestToken===t}prefetchEncyclopediaOnIdle(){const t=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{!this.isCurrentEncyclopediaRequest(t)||this.encyclopediaOverlay||this.encyclopediaOverlayPromise||this.getEncyclopediaOverlay().catch(()=>{})})}prewarmNextAdventureOnIdle(t){if(t>D)return;const e=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{this.isCurrentEncyclopediaRequest(e)&&Ct(t)})}async openEncyclopedia(){if(!this.isActive)return;if(this.loadFailureOverlay.hide(),this.encyclopediaOverlay){this.showEncyclopedia();return}if(this.isOpeningEncyclopedia)return;const t=this.encyclopediaRequestToken;this.isOpeningEncyclopedia=!0,this.loadingOverlay.show("ずかんを よんでるよ...");try{if(await this.getEncyclopediaOverlay(),!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),this.showEncyclopedia()}catch(e){if(!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),console.error("Failed to load encyclopedia overlay",e),this.loadFailureOverlay.show({title:"ずかんを もういちど よんでみよう！",message:"「もういちど よむ」を おして つづきを たのしもう！",primaryAction:{label:"もういちど よむ",onSelect:()=>this.openEncyclopedia()}})}finally{this.encyclopediaRequestToken===t&&(this.isOpeningEncyclopedia=!1)}}persistHighContrastSetting(t){const e=this.saveManager.load();t?e.colorAccessibility={highContrast:!0}:delete e.colorAccessibility,this.saveManager.save(e)}createOverlay(){const t=document.getElementById("ui-overlay");if(!t)return;const e=this.saveManager.load(),s=nt(e);this.overlay=document.createElement("div"),this.overlay.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      justify-content: center;
    ...
    `;const l=document.createElement("div");l.textContent=s.destinationLabel,l.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${i?"0.85rem":"1rem"};
      font-weight: 700;
      color: rgba(255, 255, 255, 0.92);
    `;const p=Tt(s.startStage,s.bestStars),g=ht(s.startStage,s.bestStars,{label:"メダル",hint:p.nextThreshold===null?"かんぺき！":`${p.icon} いま ・ つぎ ⭐ ${p.nextThreshold}`,size:"regular",scope:"title-next-adventure"});g.style.marginTop="0.7rem",n.appendChild(o),n.appendChild(h),n.appendChild(c),n.appendChild(l),n.appendChild(g);const u=document.createElement("div");u.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      gap: 0.65rem;
    `;const d=document.createElement("button");d.textContent="あそぶ",d.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(T(d,{onActivate:()=>{this.ensureTitleAudioInitialized(!1);const b=this.saveManager.load(),A=nt(b).startStage;this.sceneManager.requestTransition("stage",{stageNumber:A,totalScore:0,totalStarCount:0,launchSource:"campaign"})},onPressChange:b=>{d.style.transform=b?"scale(0.96)":"scale(1)"}}));const m=document.createElement("div");m.setAttribute("data-play-button-hint",""),m.textContent=s.buttonHint,m.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${i?"0.85rem":"1rem"};
      font-weight: 700;
      color: rgba(255, 255, 255, 0.88);
    ...
    `;const x=document.createElement("button");x.setAttribute("data-spaceship-customizer-button",""),x.textContent="うちゅうせんをかざろう",x.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(T(x,{onActivate:()=>{const b=this.saveManager.load();this.spaceshipCustomizer.show({initialCustomization:b.spaceshipCustomization??ct,onComplete:A=>{const y=this.saveManager.load();y.spaceshipCustomization=A,this.saveManager.save(y)}})},onPressChange:b=>{x.style.transform=b?"scale(0.96)":"scale(1)"}}));const v=document.createElement("button");v.setAttribute("data-stats-button",""),v.textContent="あそびの きろく",v.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
    ...
    `,this.overlayButtonCleanups.add(T(w,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.colorAccessibilitySettings.show({initialHighContrast:this.saveManager.load().colorAccessibility?.highContrast===!0,onToggle:b=>this.persistHighContrastSetting(b)})},onPressChange:b=>{w.style.transform=b?"translateX(-50%) scale(0.96)":"translateX(-50%) scale(1)"}}));const S=document.createElement("button");if(S.textContent=St(e.unlockedPlanets.length,N.length),S.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,S.style.position="absolute",S.style.bottom=i?"1rem":"2rem",S.style.left=i?"1rem":"2rem",this.encyclopediaBtn=S,this.overlayButtonCleanups.add(T(S,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.openEncyclopedia()},onPressChange:b=>{S.style.transform=b?"scale(0.96)":"scale(1)"}})),u.appendChild(d),u.appendChild(m),u.appendChild(x),u.appendChild(v),Pe(e)){const b=document.createElement("button");b.setAttribute("data-reset-progress-button",""),b.textContent="さいしょから",b.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: 1.15rem;
        font-weight: 900;
      ...
      pointer-events: auto;
      z-index: 60;
    `,this.overlayEl.style.background="rgba(0, 0, 32, 0.92)";let i=!1;const a=()=>{i||(i=!0,this.hide(),e())},n=()=>{i||(i=!0,this.hide(),t())};this.overlayEl.addEventListener("pointerdown",d=>{d.target===this.overlayEl&&a()});const o=document.createElement("div");o.setAttribute("data-home-confirm-card",""),o.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
    ...
    `,o.addEventListener("pointerdown",d=>{d.stopPropagation()}),this.overlayEl.appendChild(o);const h=document.createElement("div");h.textContent="タイトルへ もどる？",h.style.cssText=`
      font-size: 1.8rem;
      font-weight: 900;
      text-shadow: 0 0 15px rgba(255, 215, 0, 0.5);
      margin-bottom: 1.2rem;
    ...
    `,o.appendChild(c);const l=`
      ...
      transition: transform 0.08s ease-out;
      white-space: nowrap;
    `,p=(d,m)=>{const x=T(d,{onActivate:m,onPressChange:v=>{d.style.transform=v?"scale(0.9)":"scale(1)"}});this.activePressCleanups.add(x)},g=document.createElement("button");g.setAttribute("data-home-confirm-back",""),g.setAttribute("aria-label","タイトルへ もどる"),g.textContent="🏠 タイトルへ もどる",g.style.cssText=l,g.style.fontFamily="'Zen Maru Gothic', sans-serif",g.style.background="rgba(255, 255, 255, 0.18)",g.style.color="#ffffff",g.style.minWidth="88px",g.style.minHeight="88px",g.style.touchAction="manipulation",g.style.transform="scale(1)",g.style.transition="transform 0.08s ease-out",g.style.whiteSpace="nowrap",p(g,n),c.appendChild(g);const u=document.createElement("button");u.setAttribute("data-home-confirm-continue",""),u.setAttribute("aria-label","つづける"),u.textContent="✋ つづける",u.style.cssText=l,u.style.fontFamily="'Zen Maru Gothic', sans-serif",u.style.background="linear-gradient(135deg, #FF6B6B, #FFE66D)",u.style.color="#FFD700",u.style.textShadow="0 1px 2px rgba(0, 0, 32, 0.6)",u.style.minWidth="88px",u.style.minHeight="88px",u.style.touchAction="manipulation",u.style.transform="scale(1)",u.style.transition="transform 0.08s ease-out",u.style.whiteSpace="nowrap",p(u,a),c.appendChild(u),s.appendChild(this.overlayEl)}hide(){if(this.overlayEl){const t=Array.from(this.activePressCleanups);this.activePressCleanups.clear();for(const e of t)e();this.overlayEl.remove(),this.overlayEl=null}}isVisible(){return this.overlayEl!==null}}class Rt{overlayEl=null;activePressCleanups=new Set;show(t,e){if(this.overlayEl)return;const s=document.getElementById("ui-overlay")??document.body;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-pause-overlay",""),this.overlayEl.setAttribute("role","dialog"),this.overlayEl.setAttribute("aria-modal","true"),this.overlayEl.setAttribute("aria-label","やすみちゅう"),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
    ...
    `,i.appendChild(n);const o=document.createElement("div");o.style.cssText=`
      ...
      align-items: stretch;
      width: 100%;
    `,i.appendChild(o);const h=(c,l,p,g,u,d)=>{const m=document.createElement("button");m.setAttribute(l,""),m.setAttribute("aria-label",p),m.textContent=c,m.style.cssText=`
        flex: 1 1 140px;
        padding: 1rem 1.2rem;
        border: none;
        border-radius: 1.6rem;
    ...
    `,document.head.appendChild(t)}}const De=1,He=.4;class At{overlayEl=null;numberEl=null;phase="idle";elapsed=0;currentStep=0;stepDuration;goDuration;onTick;onGo;onComplete=null;steps=["3","2","1"];constructor(t={}){this.stepDuration=t.stepDuration??De,this.goDuration=t.goDuration??He,this.onTick=t.onTick,this.onGo=t.onGo}show(t){if(this.phase!=="idle"&&this.phase!=="done")return;const e=document.getElementById("ui-overlay")??document.body;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-countdown-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
