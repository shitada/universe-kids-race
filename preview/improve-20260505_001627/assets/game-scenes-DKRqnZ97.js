const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-DhQqx2KQ.js","assets/game-core-BvExF6kK.js","assets/three-CHPsZt9E.js"])))=>i.map(i=>d[i]);
import{D as lt,S as _,T as D,g as et,a as wt,L as It,b as kt,_ as ot,c as G,d as V,P as N,u as Dt,C as Ht,e as Lt,f as Gt,B as _t,h as zt,i as Ft,j as Nt,A as $t,k as At,l as jt,m as Ut,n as st,t as it,o as Zt,s as qt,p as Yt}from"./game-core-BvExF6kK.js";import{m as ht,k as ct,i as dt,l as ut,G as W,n as Xt,a as Vt,o as Wt,M as B,g as k,D as vt,R as Ct,p as H,q as mt,r as Q,h as pt,P as ft,V as Tt,s as Qt}from"./three-CHPsZt9E.js";class gt{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const s=document.getElementById("ui-overlay");if(!s)return;const e=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
