const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-DmeGiuXQ.js","assets/game-core-Cy7nxrEi.js","assets/three-B3e-47pp.js"])))=>i.map(i=>d[i]);
import{D as ut,S as G,T as D,g as it,a as Pt,L as Gt,b as Nt,_ as ht,c as z,s as Ot,d as W,P as _,u as Rt,C as Ft,e as _t,f as $t,B as jt,h as Ut,M as Zt,i as qt,j as Yt,k as Xt,l as Vt,m as Wt,n as Qt,o as Kt,p as Jt,A as te,q as ee,r as se,t as ie,v as It,w as ae,x as ne,R as oe,y as re,z as le,E as he,F as xt,G as ce,H as de,I as at,J as V,K as ue,N as nt,O as me,Q as pe,U as fe}from"./game-core-Cy7nxrEi.js";import{m as mt,k as pt,i as ft,l as gt,G as Q,v as ge,a as ye,r as be,M as B,g as k,D as wt,t as At,w as H,x as yt,y as K,h as bt,P as vt,V as ct,z as ve,H as Ee}from"./three-B3e-47pp.js";class Et{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const e=document.getElementById("ui-overlay");if(!e)return;const s=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
    ...
    `,n.appendChild(o),n.appendChild(h),n.appendChild(c),n}isCompactHeight(){return window.innerHeight<=Et.COMPACT_HEIGHT_THRESHOLD}injectAnimations(){if(document.getElementById("tutorial-animations"))return;const t=document.createElement("style");t.id="tutorial-animations",t.textContent=`
      @keyframes swipe {
    ...
    `,document.head.appendChild(t)}}class Se{overlayEl=null;activePressCleanups=new Set;show(t,e){if(this.overlayEl)return;const s=document.getElementById("ui-overlay");if(!s)return;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-title-reset-confirm-overlay",""),this.overlayEl.setAttribute("role","dialog"),this.overlayEl.setAttribute("aria-modal","true"),this.overlayEl.setAttribute("aria-label","さいしょからに もどしますか"),this.overlayEl.style.cssText=`
      ...
      padding: 1.5rem;
      background: rgba(0, 0, 32, 0.92);
    `;let i=!1;const a=()=>{i||(i=!0,this.hide(),e())},n=()=>{i||(i=!0,this.hide(),t())};this.overlayEl.addEventListener("pointerdown",d=>{d.target===this.overlayEl&&a()});const o=document.createElement("div");o.setAttribute("data-title-reset-confirm-card",""),o.style.cssText=`
    ...
    `,o.appendChild(u);const m=`
      ...
      white-space: nowrap;
    `,l=(d,p)=>{let E=!1,S=!1;const w=()=>{A(!0)},x=()=>{d.style.transform="scale(0.92)"},v=()=>{d.style.transform="scale(1)"},A=(M=!1)=>{E=!1,S=M,v(),this.activePressCleanups.delete(w),document.removeEventListener("pointerup",b,!0),document.removeEventListener("pointercancel",C,!0)},b=M=>{const N=M.target===d||M.target instanceof Node&&d.contains(M.target),Lt=E&&N;A(!N),Lt&&p()},C=()=>{A(!0)};d.addEventListener("pointerdown",M=>{M.stopPropagation(),E=!0,S=!1,x(),this.activePressCleanups.add(w),document.addEventListener("pointerup",b,!0),document.addEventListener("pointercancel",C,!0)}),d.addEventListener("pointerenter",()=>{E&&x()}),d.addEventListener("pointerleave",()=>{E&&v()}),d.addEventListener("pointercancel",()=>A(!0)),d.addEventListener("click",M=>{if(M.stopPropagation(),S){S=!1;return}E||p()})},f=document.createElement("button");f.setAttribute("data-title-reset-cancel",""),f.textContent="やめる",f.style.cssText=m,f.style.background="rgba(255, 255, 255, 0.18)",f.style.color="#ffffff",l(f,a),u.appendChild(f);const g=document.createElement("button");g.setAttribute("data-title-reset-confirm",""),g.textContent="うん！ さいしょから",g.style.cssText=m,g.style.background="linear-gradient(135deg, #FF9F68, #FFE66D)",g.style.color="#3b1f00",l(g,n),u.appendChild(g),s.appendChild(this.overlayEl)}hide(){if(!this.overlayEl)return;const t=Array.from(this.activePressCleanups);this.activePressCleanups.clear();for(const e of t)e();this.overlayEl.remove(),this.overlayEl=null}}function St(r){const t=r.topRem??.8,e=window.innerHeight<=500,s=document.createElement("button");let i=r.initialMuted;const a=()=>{s.textContent=i?"🔇":"🔊",s.setAttribute("aria-label",i?"サウンド オフ":"サウンド オン")};s.setAttribute("data-mute-button",""),s.style.position="absolute",s.style.top=`${t}rem`,s.style.right="1rem",s.style.fontSize=e?"clamp(1.1rem, 3.5vmin, 1.4rem)":"clamp(1.4rem, 4vmin, 1.8rem)",s.style.background="rgba(255, 255, 255, 0.15)",s.style.border="none",s.style.borderRadius="50%",s.style.width=e?"2.4rem":"3rem",s.style.height=e?"2.4rem":"3rem",s.style.display="flex",s.style.alignItems="center",s.style.justifyContent="center",s.style.cursor="pointer",s.style.pointerEvents="auto",s.style.touchAction="manipulation",s.style.transform="scale(1)",s.style.transition="transform 0.08s ease-out",a();const n=()=>{s.style.transform="scale(1)"};return s.addEventListener("pointerdown",o=>{o.stopPropagation(),s.style.transform="scale(0.9)",r.onToggle()}),s.addEventListener("pointerup",n),s.addEventListener("pointercancel",n),s.addEventListener("pointerleave",n),r.container.appendChild(s),{element:s,setMuted(o){i=o,a()},remove(){s.remove()}}}class Ce{overlay=null;toggleButton=null;descriptionEl=null;highContrast=!1;vibrationIntensity="medium";vibrationDescriptionEl=null;vibrationButtons=new Map;show(t){const e=document.getElementById("ui-overlay");if(e){if(this.highContrast=t.initialHighContrast,this.vibrationIntensity=t.initialVibrationIntensity,!this.overlay){this.overlay=document.createElement("div"),this.overlay.setAttribute("data-color-accessibility-settings",""),this.overlay.style.cssText=`
        position: absolute;
        inset: 0;
        display: flex;
        align-items: center;
      ...
      `;const o=[{value:"strong",label:"つよい"},{value:"medium",label:"ふつう"},{value:"weak",label:"やさしい"},{value:"off",label:"オフ"}];for(const c of o){const u=document.createElement("button");u.setAttribute("data-vibration-intensity-button",c.value),u.textContent=c.label,u.style.cssText=`
        ...
        `,u.addEventListener("click",()=>{this.vibrationIntensity=c.value,this.render(),t.onVibrationIntensityChange(c.value)}),this.vibrationButtons.set(c.value,u),n.appendChild(u)}const h=document.createElement("button");h.textContent="とじる",h.style.cssText=`
        width: 100%;
        padding: 0.8rem 1rem;
        border-radius: 999px;
        ...
        cursor: pointer;
        touch-action: manipulation;
      `,h.addEventListener("click",()=>this.hide()),s.appendChild(i),s.appendChild(this.descriptionEl),s.appendChild(this.toggleButton),s.appendChild(a),s.appendChild(this.vibrationDescriptionEl),s.appendChild(n),s.appendChild(h),this.overlay.appendChild(s)}this.render(),e.appendChild(this.overlay)}}hide(){this.overlay?.remove()}isVisible(){return this.overlay?.isConnected===!0}render(){if(!this.toggleButton||!this.descriptionEl||!this.vibrationDescriptionEl)return;this.descriptionEl.textContent=this.highContrast?"いろだけじゃなく ふちや しまもようで わかりやすくしているよ。":"いろだけでなく かたちや うごきでも みわけられるようにするよ。",this.toggleButton.textContent=this.highContrast?"みやすくする: ON":"みやすくする: OFF",this.toggleButton.setAttribute("aria-pressed",this.highContrast?"true":"false");const t={strong:"しっかり つたえる しんどうだよ。",medium:"ちょうどよく わかる つよさだよ。",weak:"やさしく ふるえて つたえるよ。",off:"しんどうの かわりに がめんが すこし ゆれるよ。"};this.vibrationDescriptionEl.textContent=t[this.vibrationIntensity];for(const[e,s]of this.vibrationButtons.entries()){const i=e===this.vibrationIntensity;s.setAttribute("aria-pressed",i?"true":"false"),s.style.borderColor=i?"#fff27a":"rgba(255, 255, 255, 0.4)",s.style.background=i?"linear-gradient(135deg, rgba(255, 242, 122, 0.94), rgba(118, 240, 255, 0.92))":"rgba(255, 255, 255, 0.08)",s.style.color=i?"#102040":"#fff",s.style.transform=i?"scale(1.02)":"scale(1)"}}}function T(r,t){let e=!1,s=!1,i=null,a=null;const n=t.documentTarget??document,o=t.stopPropagation??!0,h=()=>{t.canActivate?.()!==!1&&t.onActivate()},c=b=>{t.onPressChange?.(b)},u=b=>{const C=b;return typeof C.clientX=="number"&&typeof C.clientY=="number"?{x:C.clientX,y:C.clientY}:null},m=b=>{const C=b;return typeof C.pointerId=="number"?C.pointerId:null},l=b=>{const C=m(b);return i===null||C===null||C===i},f=b=>{if(!e||a===null||t.moveTolerancePx===void 0)return!1;const C=u(b);return C===null?!1:Math.hypot(C.x-a.x,C.y-a.y)>t.moveTolerancePx},g=b=>{e=!1,s=b,i=null,a=null,c(!1),n.removeEventListener("pointermove",E,!0),n.removeEventListener("pointerup",d,!0),n.removeEventListener("pointercancel",p,!0)},d=b=>{if(!e||!l(b))return;if(f(b)){g(!0);return}const C=b.target,M=C===r||C instanceof Node&&r.contains(C),N=e&&M;g(N||!M),N&&h()},p=()=>{g(!0)},E=b=>{!e||!l(b)||f(b)&&g(!0)},S=b=>{t.canActivate?.()!==!1&&((t.preventDefaultOnPointerDown??!1)&&b.preventDefault(),o&&b.stopPropagation(),e=!0,s=!1,i=m(b),a=u(b),c(!0),t.moveTolerancePx!==void 0&&n.addEventListener("pointermove",E,!0),n.addEventListener("pointerup",d,!0),n.addEventListener("pointercancel",p,!0))},w=()=>{e&&c(!0)},x=()=>{e&&c(!1)},v=()=>{g(!0)},A=b=>{if(o&&b.stopPropagation(),(t.preventDefaultOnClick??!1)&&b.preventDefault(),s){s=!1;return}e||h()};return r.addEventListener("pointerdown",S),r.addEventListener("pointerenter",w),r.addEventListener("pointerleave",x),r.addEventListener("pointercancel",v),r.addEventListener("click",A),()=>{g(!1),r.removeEventListener("pointerdown",S),r.removeEventListener("pointerenter",w),r.removeEventListener("pointerleave",x),r.removeEventListener("pointercancel",v),r.removeEventListener("click",A)}}class xe{overlay=null;previewBody=null;previewNose=null;previewWings=null;buttonCleanups=new Set;optionButtons=new Map;draft={...ut};colorOptions=G.getColorOptions();show(t){this.hide();const e=document.getElementById("ui-overlay");if(!e)return;this.draft=G.normalizeCustomization(t.initialCustomization),this.overlay=document.createElement("div"),this.overlay.setAttribute("data-spaceship-customizer",""),this.overlay.setAttribute("role","dialog"),this.overlay.setAttribute("aria-modal","true"),this.overlay.setAttribute("aria-label","うちゅうせんを かざろう"),this.overlay.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
    ...
    `,o.appendChild(h);const c=document.createElement("div");c.style.cssText=`
      ...
      gap: 0.8rem;
      margin-bottom: 1rem;
    `,c.append(this.createSummaryCard("あそんだ じかん",Ae(i.totalPlayTimeSeconds),"data-stats-total-play-time"),this.createSummaryCard("とった ほし",`${i.totalStarsCollected}こ`,"data-stats-total-stars"),this.createSummaryCard("ブースト",`${i.totalBoostUses}かい`,"data-stats-total-boosts")),o.appendChild(c);const u=document.createElement("div");u.style.cssText=`
      margin-top: 0.5rem;
    ...
    `;const m=document.createElement("div");m.textContent="ステージ クリア かいすう",m.style.cssText=`
      ...
      font-weight: 900;
      color: #FFE66D;
    `,u.appendChild(m);const l=document.createElement("div");l.setAttribute("data-stats-stage-clears",""),l.style.cssText=`
      display: flex;
      flex-direction: column;
      gap: 0.45rem;
      text-align: left;
    `;const f=Array.from({length:D},(d,p)=>p+1).map(d=>({stageNumber:d,clearCount:i.stageClearCounts[d]??0})).filter(d=>d.clearCount>0);if(f.length===0){const d=document.createElement("div");d.textContent="まだ きろくが ないよ",d.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: ${a?"1rem":"1.1rem"};
        font-weight: 700;
        text-align: center;
        color: rgba(255, 255, 255, 0.88);
      `,l.appendChild(d)}else for(const{stageNumber:d,clearCount:p}of f){const E=it(d),S=document.createElement("div");S.setAttribute("data-stats-stage-clear-row",String(d)),S.style.cssText=`
          display: flex;
          align-items: center;
          ...
          font-weight: 700;
        `;const w=document.createElement("span");w.textContent=`${E.emoji} ステージ ${d} ${E.destinationReading}`;const x=document.createElement("span");x.textContent=`${p}かい`,x.style.color="#FFE66D",S.append(w,x),l.appendChild(S)}u.appendChild(l),o.appendChild(u);const g=document.createElement("button");g.textContent="もどる",g.style.cssText=`
      margin-top: 1rem;
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.actionCleanups.add(T(g,{onActivate:()=>{this.hide(),e()},onPressChange:d=>{g.style.transform=d?"scale(0.96)":"scale(1)"}})),o.appendChild(g),n.appendChild(o),s.appendChild(n)}hide(){const t=Array.from(this.actionCleanups);this.actionCleanups.clear();for(const e of t)e();this.overlayEl?.remove(),this.overlayEl=null}createSummaryCard(t,e,s){const i=document.createElement("div");i.setAttribute(s,""),i.style.cssText=`
    ...
    `;const n=document.createElement("div");return n.textContent=e,n.style.cssText=`
      ...
      font-weight: 900;
      color: #FFE66D;
    `,i.append(a,n),i}}function Tt(r,t){if(!Number.isFinite(r)||r<=0||t<=0)return"ずかん";const e=Math.min(r,t);return e>=t?`ずかん ${t} / ${t} 🎉`:`ずかん ${e} / ${t}`}function Me(r){switch(r){case"hero":return{gap:"0.35rem",label:"0.92rem",medal:"1.7rem",hint:"0.98rem"};case"compact":return{gap:"0.18rem",label:"0.7rem",medal:"1rem",hint:"0.76rem"};default:return{gap:"0.26rem",label:"0.8rem",medal:"1.25rem",hint:"0.84rem"}}}function dt(r,t,e={}){const s=Pt(r,t),i=e.size??"regular",a=Me(i),n=document.createElement("div");if(n.setAttribute("data-stage-medal-display",""),n.setAttribute("data-stage-medal-stage",String(r)),n.setAttribute("data-stage-medal-tier",s.tier),n.setAttribute("data-stage-medal-earned",String(s.earnedCount)),e.scope&&n.setAttribute("data-stage-medal-scope",e.scope),n.style.cssText=`
    display: flex;
    flex-direction: column;
    align-items: center;
    gap: ${a.gap};
  ...
  `;for(const u of s.slots){const m=document.createElement("span");m.setAttribute("data-stage-medal-slot",u.tier),m.setAttribute("data-stage-medal-threshold",String(u.threshold)),m.setAttribute("data-stage-medal-reached",String(u.reached)),m.textContent=u.icon,m.style.cssText=`
    ...
    `,o.appendChild(m)}n.appendChild(o);const h=e.hint??(s.nextThreshold===null?"かんぺき！":`つぎ ⭐ ${s.nextThreshold}`),c=document.createElement("div");return c.setAttribute("data-stage-medal-hint",""),c.textContent=h,c.style.cssText=`
    font-family: 'Zen Maru Gothic', sans-serif;
    font-size: ${a.hint};
    font-weight: 700;
    color: ${s.nextThreshold===null?"#FFE66D":"rgba(255, 255, 255, 0.86)"};
  `,n.appendChild(c),n}const Mt=2e3,J=new Map,tt=new Map,et=new Map;let q=null,Y=null;function X(r,t){if(typeof document>"u"){const s=typeof OffscreenCanvas=="function",i=s?new OffscreenCanvas(r,t):{width:r,height:t};return{canvas:i,ctx:s?i.getContext("2d"):null}}const e=document.createElement("canvas");return e.width=r,e.height=t,{canvas:e,ctx:e.getContext("2d")}}function F(r,t){let e=J.get(r);return e||(e=t(),e.generateMipmaps=!1,e.minFilter=be,e.needsUpdate=!0,J.set(r,e)),e}function P(r,t){let e=tt.get(r);return e||(e=t(),tt.set(r,e)),e}function O(r,t){let e=et.get(r);return e||(e=t(),et.set(r,e)),e}function R(r,t){const e=new ye(r,t);return e.userData.sharedAssets=!0,e}function kt(){if(!q){const r=new pt,t=new Float32Array(Mt*3);for(let e=0;e<Mt*3;e+=3)t[e]=(Math.random()-.5)*200,t[e+1]=(Math.random()-.5)*200,t[e+2]=(Math.random()-.5)*400;r.setAttribute("position",new ft(t,3)),q=r}Y||(Y=new gt({color:16777215,size:.2,sizeAttenuation:!0}))}function Be(){const{canvas:r,ctx:t}=X(256,256);if(!t)return new H(r);t.fillStyle="#888888",t.fillRect(0,0,256,256);for(let e=0;e<30;e++){const s=Math.random()*256,i=Math.random()*256,a=3+Math.random()*12;t.beginPath(),t.arc(s,i,a,0,Math.PI*2),t.fillStyle=`rgba(60,60,60,${.3+Math.random()*.4})`,t.fill()}return new H(r)}function Pe(){const{canvas:r,ctx:t}=X(256,256);if(!t)return new H(r);t.fillStyle="#ddaa44",t.fillRect(0,0,256,256);for(let e=0;e<8;e++){t.beginPath();const s=128+(Math.random()-.5)*100,i=128+(Math.random()-.5)*100;t.strokeStyle=`rgba(200,150,60,${.3+Math.random()*.3})`,t.lineWidth=3+Math.random()*5;for(let a=0;a<Math.PI*4;a+=.1){const n=10+a*8;t.lineTo(s+Math.cos(a)*n,i+Math.sin(a)*n)}t.stroke()}return new H(r)}function Oe(){const{canvas:r,ctx:t}=X(256,256);if(!t)return new H(r);const e=["#cc7733","#dd9955","#bb6622","#eebb77","#aa5511","#ddaa66"];for(let s=0;s<256;s++){const i=Math.floor(s/(256/e.length))%e.length;t.fillStyle=e[i],t.fillRect(0,s,256,1)}return new H(r)}function Re(){const{canvas:r,ctx:t}=X(512,256);return t?(t.fillStyle="#2266aa",t.fillRect(0,0,512,256),t.fillStyle="#886644",t.beginPath(),t.ellipse(300,80,80,40,.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(280,150,30,50,.1,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(100,90,25,60,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(110,170,20,40,-.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(420,170,25,15,0,0,Math.PI*2),t.fill(),t.fillStyle="#447733",t.beginPath(),t.ellipse(290,75,40,20,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(95,85,15,30,.2,0,Math.PI*2),t.fill(),new H(r)):new H(r)}function Ie(){const{canvas:r,ctx:t}=X(512,256);if(!t)return new H(r);t.clearRect(0,0,512,256),t.fillStyle="rgba(255,255,255,0.6)";for(let e=0;e<20;e++){const s=Math.random()*512,i=Math.random()*256;t.beginPath(),t.ellipse(s,i,20+Math.random()*40,8+Math.random()*15,Math.random()*Math.PI,0,Math.PI*2),t.fill()}return new H(r)}function ke(){J.clear(),tt.clear(),et.clear(),q=null,Y=null}const De={planetTextureCache:J,planetGeometryCache:tt,planetMaterialCache:et,getBgStarsGeometry:()=>q,getBgStarsMaterial:()=>Y};function Dt(r,t,e){const s=new Q;let i=null;switch(r){case 2:{const a=F("mercury",Be),n=P("mercury:sphere",()=>new k(10,24,24)),o=O("mercury:mat",()=>new B({map:a})),h=R(n,o);s.add(h),i=h;break}case 3:{const a=F("venus",Pe),n=P("venus:sphere",()=>new k(14,24,24)),o=O("venus:mat",()=>new B({map:a})),h=R(n,o);s.add(h),i=h;break}case 5:{const a=F("jupiter",Oe),n=P("jupiter:sphere",()=>new k(20,24,24)),o=O("jupiter:mat",()=>new B({map:a})),h=R(n,o);s.add(h),i=h;break}case 6:{const a=P("saturn:sphere",()=>new k(15,24,24)),n=t.planetColor,o=O(`saturn:mat:${n}`,()=>new B({color:n})),h=R(a,o);s.add(h);const c=P("saturn:ring",()=>new At(20,30,48)),u=O("saturn:ringMat",()=>new B({color:15645542,side:wt})),m=R(c,u);m.rotation.x=Math.PI/3,s.add(m),i=h;break}case 7:{const a=P("uranus:sphere",()=>new k(16,24,24)),n=O("uranus:mat",()=>new B({color:6737117})),o=R(a,n);s.add(o);const h=P("uranus:ring",()=>new At(21,28,48)),c=O("uranus:ringMat",()=>new B({color:10083822,side:wt})),u=R(h,c);u.rotation.z=Math.PI/2,s.add(u),i=o;break}case 9:{const a=P("pluto:sphere",()=>new k(8,24,24)),n=O("pluto:mat",()=>new B({color:12298922})),o=R(a,n);s.add(o),i=o;break}case 10:{const a=P("sun:sphere",()=>new k(25,24,24)),n=O("sun:mat",()=>new B({color:16763904,emissive:16755200,emissiveIntensity:.5})),o=R(a,n);s.add(o),s.add(new ge(16763904,2,200)),i=o;break}case 11:{const a=F("earth",Re),n=P("earth:sphere",()=>new k(15,32,32)),o=O("earth:mat",()=>new B({map:a})),h=F("earth:cloud",Ie),c=P("earth:cloudSphere",()=>new k(15.5,32,32)),u=O("earth:cloudMat",()=>new B({map:h,transparent:!0,opacity:.3})),m=new Q;m.add(R(n,o)),m.add(R(c,u)),s.add(m),i=m;break}default:{const a=P("default:sphere",()=>new k(15,24,24)),n=t.planetColor,o=O(`default:mat:${n}`,()=>new B({color:n})),h=R(a,o);s.add(h),i=h;break}}return s.position.set(0,0,e),{planet:s,spinTarget:i}}function He(r,t,e){return Dt(r,t,e)}function ze(r){kt();const t=new mt(q,Y);return t.userData.sharedAssets=!0,t.geometry.setDrawRange(0,r),t}function Ct(r){!Number.isInteger(r)||r<1||r>D||typeof document>"u"&&typeof OffscreenCanvas!="function"||(kt(),Dt(r,it(r),0))}let $=null,j=null;function Le(){if(!$){const r=new pt,t=new Float32Array(3e3);for(let e=0;e<3e3;e++)t[e]=(Math.random()-.5)*200;r.setAttribute("position",new ft(t,3)),$=r}return $}function Ge(){return j||(j=new gt({color:16777215,size:.3,sizeAttenuation:!0})),j}function Ne(){$=null,j=null}const Fe={getBgStarsGeometry:()=>$,getBgStarsMaterial:()=>j};function _e(r){const t=window.requestIdleCallback;if(typeof t=="function"){t(r,{timeout:1500});return}window.setTimeout(r,800)}function Ht(r){return new Set(r.filter(t=>Number.isInteger(t)&&t>=1&&t<=D)).size}function $e(r){return Ht(r)>=D}function ot(r){const t=$e(r.unlockedPlanets),e=t?1:Math.min(r.clearedStage+1,D),s=it(e),i=r.bestStageStars?.[e]??0;return t?{startStage:e,destination:s.destinationReading,emoji:s.emoji,statusLabel:"ぜんぶ あつめたよ！",destinationLabel:`${s.destinationReading}へ もういちど しゅっぱつ！`,buttonHint:`${s.emoji} ステージ ${e} から もういちど あそぶ`,bestStars:i}:{startStage:e,destination:s.destinationReading,emoji:s.emoji,statusLabel:r.clearedStage>0?"つづきから しゅっぱつ！":"はじめての しゅっぱつ！",destinationLabel:`${s.destinationReading}へ むかおう！`,buttonHint:`${s.emoji} ステージ ${e} から スタート`,bestStars:i}}function je(r){return r.clearedStage>0||Ht(r.unlockedPlanets)>0||Object.keys(r.bestStageStars??{}).length>0}class Ue{threeScene;ambientLight=new yt(16777215,1);camera;lastAspect=0;sceneManager;saveManager;audioManager;stars=null;companionParade=null;overlay=null;muteHandle=null;tutorialOverlay=new Et;titleResetConfirmOverlay=new Se;colorAccessibilitySettings=new Ce;spaceshipCustomizer=new xe;statsOverlay=new Te;encyclopediaOverlay=null;encyclopediaOverlayPromise=null;companionFactory=null;companionFactoryPromise=null;loadEncyclopediaOverlay;loadTitleCompanionFactory;loadingOverlay;loadFailureOverlay;scheduleIdleTask;encyclopediaBtn=null;isOpeningEncyclopedia=!1;isActive=!1;encyclopediaRequestToken=0;companionParadeRequestToken=0;bgmPending=!1;overlayButtonCleanups=new Set;constructor(t,e,s,i={}){this.sceneManager=t,this.saveManager=e,this.audioManager=s,this.loadingOverlay=i.loadingOverlay??new Gt,this.loadFailureOverlay=i.loadFailureOverlay??new Nt,this.scheduleIdleTask=i.scheduleIdleTask??_e,this.loadEncyclopediaOverlay=i.loadEncyclopediaOverlay??(()=>ht(()=>import("./EncyclopediaOverlay-DmeGiuXQ.js"),__vite__mapDeps([0,1,2]))),this.loadTitleCompanionFactory=i.loadTitleCompanionFactory??(()=>ht(()=>import("./game-core-Cy7nxrEi.js").then(o=>o.a0),__vite__mapDeps([1,2]))),this.threeScene=new K,this.threeScene.background=new bt(32);const{width:a,height:n}=z();this.camera=new vt(60,a/n,.1,1e3),this.camera.position.set(0,0,5)}enter(t){this.isActive=!0,this.encyclopediaRequestToken+=1,this.companionParadeRequestToken+=1,this.lastAspect=0,this.stars=new mt(Le(),Ge()),this.stars.userData.sharedAssets=!0,this.stars.rotation.set(0,0,0),this.threeScene.add(this.stars),this.ambientLight.parent||this.threeScene.add(this.ambientLight);const e=this.saveManager.load();this.createCompanionParade(e.unlockedPlanets),this.createOverlay(),this.createMuteButton(),this.prefetchEncyclopediaOnIdle(),this.prewarmNextAdventureOnIdle(ot(e).startStage),this.audioManager.isInitialized()?(this.audioManager.playBGM(0),this.bgmPending=!1):this.bgmPending=!0,e.tutorialShown||this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide(),this.saveManager.markTutorialShown()})}createMuteButton(){const t=document.getElementById("hud")??document.getElementById("ui-overlay");t&&(this.muteHandle=St({initialMuted:this.audioManager.isMuted(),container:t,onToggle:()=>{this.ensureTitleAudioInitialized(!0);const e=this.audioManager.toggleMute();this.muteHandle?.setMuted(e);const s=this.saveManager.load();s.muted=e,this.saveManager.save(s)}}))}getEncyclopediaOverlay(){return this.encyclopediaOverlay?Promise.resolve(this.encyclopediaOverlay):this.encyclopediaOverlayPromise?this.encyclopediaOverlayPromise:(this.encyclopediaOverlayPromise=this.loadEncyclopediaOverlay().then(({EncyclopediaOverlay:t})=>{const e=new t;return this.encyclopediaOverlay=e,e}).finally(()=>{this.encyclopediaOverlayPromise=null}),this.encyclopediaOverlayPromise)}getTitleCompanionFactory(){return this.companionFactory?Promise.resolve(this.companionFactory):this.companionFactoryPromise?this.companionFactoryPromise:(this.companionFactoryPromise=this.loadTitleCompanionFactory().then(t=>(this.companionFactory=t,t)).finally(()=>{this.companionFactoryPromise=null}),this.companionFactoryPromise)}showEncyclopedia(){if(!this.isActive||!this.encyclopediaOverlay)return;const t=this.saveManager.load();this.encyclopediaOverlay.show(t.unlockedPlanets,()=>this.refreshEncyclopediaButtonLabel(),e=>{this.ensureTitleAudioInitialized(!1),this.sceneManager.requestTransition("stage",{stageNumber:e,totalScore:0,totalStarCount:0,launchSource:"encyclopedia"})},t.bestStageStars??{},t.discoveredConstellations??[])}isCurrentEncyclopediaRequest(t){return this.isActive&&this.encyclopediaRequestToken===t}prefetchEncyclopediaOnIdle(){const t=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{!this.isCurrentEncyclopediaRequest(t)||this.encyclopediaOverlay||this.encyclopediaOverlayPromise||this.getEncyclopediaOverlay().catch(()=>{})})}prewarmNextAdventureOnIdle(t){if(t>D)return;const e=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{this.isCurrentEncyclopediaRequest(e)&&Ct(t)})}async openEncyclopedia(){if(!this.isActive)return;if(this.loadFailureOverlay.hide(),this.encyclopediaOverlay){this.showEncyclopedia();return}if(this.isOpeningEncyclopedia)return;const t=this.encyclopediaRequestToken;this.isOpeningEncyclopedia=!0,this.loadingOverlay.show("ずかんを よんでるよ...");try{if(await this.getEncyclopediaOverlay(),!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),this.showEncyclopedia()}catch(e){if(!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),console.error("Failed to load encyclopedia overlay",e),this.loadFailureOverlay.show({title:"ずかんを もういちど よんでみよう！",message:"「もういちど よむ」を おして つづきを たのしもう！",primaryAction:{label:"もういちど よむ",onSelect:()=>this.openEncyclopedia()}})}finally{this.encyclopediaRequestToken===t&&(this.isOpeningEncyclopedia=!1)}}persistHighContrastSetting(t){const e=this.saveManager.load();t?e.colorAccessibility={highContrast:!0}:delete e.colorAccessibility,this.saveManager.save(e)}persistVibrationIntensitySetting(t){const e=this.saveManager.load();e.vibrationSettings={intensity:t},this.saveManager.save(e),Ot(t)}createOverlay(){const t=document.getElementById("ui-overlay");if(!t)return;const e=this.saveManager.load(),s=ot(e);this.overlay=document.createElement("div"),this.overlay.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      justify-content: center;
    ...
    `;const h=document.createElement("div");h.textContent=s.statusLabel,h.style.cssText=`
      ...
      font-weight: 900;
      margin-bottom: ${i?"0.15rem":"0.35rem"};
    `;const c=document.createElement("div");c.textContent=`${s.emoji} ステージ ${s.startStage} ・ ${s.destination}`,c.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
    ...
    `;const u=document.createElement("div");u.textContent=s.destinationLabel,u.style.cssText=`
      ...
      font-weight: 700;
      color: rgba(255, 255, 255, 0.92);
    `;const m=Pt(s.startStage,s.bestStars),l=dt(s.startStage,s.bestStars,{label:"メダル",hint:m.nextThreshold===null?"かんぺき！":`${m.icon} いま ・ つぎ ⭐ ${m.nextThreshold}`,size:"regular",scope:"title-next-adventure"});l.style.marginTop="0.7rem",n.appendChild(o),n.appendChild(h),n.appendChild(c),n.appendChild(u),n.appendChild(l);const f=document.createElement("div");f.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      gap: 0.65rem;
    `;const g=document.createElement("button");g.textContent="あそぶ",g.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(T(g,{onActivate:()=>{this.ensureTitleAudioInitialized(!1);const v=this.saveManager.load(),A=ot(v).startStage;this.sceneManager.requestTransition("stage",{stageNumber:A,totalScore:0,totalStarCount:0,launchSource:"campaign"})},onPressChange:v=>{g.style.transform=v?"scale(0.96)":"scale(1)"}}));const d=document.createElement("div");d.setAttribute("data-play-button-hint",""),d.textContent=s.buttonHint,d.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${i?"0.85rem":"1rem"};
      font-weight: 700;
      color: rgba(255, 255, 255, 0.88);
      text-shadow: 0 2px 10px rgba(0, 0, 0, 0.35);
    `;const p=document.createElement("button");p.setAttribute("data-spaceship-customizer-button",""),p.textContent="うちゅうせんをかざろう",p.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${i?"1rem":"1.25rem"};
      font-weight: 900;
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(T(p,{onActivate:()=>{const v=this.saveManager.load();this.spaceshipCustomizer.show({initialCustomization:v.spaceshipCustomization??ut,onComplete:A=>{const b=this.saveManager.load();b.spaceshipCustomization=A,this.saveManager.save(b)}})},onPressChange:v=>{p.style.transform=v?"scale(0.96)":"scale(1)"}}));const E=document.createElement("button");E.setAttribute("data-stats-button",""),E.textContent="あそびの きろく",E.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(T(E,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.statsOverlay.show(this.saveManager.load().gameplayStats,()=>{})},onPressChange:v=>{E.style.transform=v?"scale(0.96)":"scale(1)"}}));const S=document.createElement("button");S.textContent="あそびかた",S.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,S.style.position="absolute",S.style.bottom=i?"1rem":"2rem",S.style.right=i?"1rem":"2rem",this.overlayButtonCleanups.add(T(S,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide()})},onPressChange:v=>{S.style.transform=v?"scale(0.96)":"scale(1)"}}));const w=document.createElement("button");w.setAttribute("data-color-settings-button",""),w.textContent="みやすさ・しんどう",w.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      ...
      transition: transform 0.08s ease-out;
      white-space: nowrap;
    `,this.overlayButtonCleanups.add(T(w,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.colorAccessibilitySettings.show({initialHighContrast:this.saveManager.load().colorAccessibility?.highContrast===!0,initialVibrationIntensity:this.saveManager.load().vibrationSettings?.intensity??"medium",onToggle:v=>this.persistHighContrastSetting(v),onVibrationIntensityChange:v=>this.persistVibrationIntensitySetting(v)})},onPressChange:v=>{w.style.transform=v?"translateX(-50%) scale(0.96)":"translateX(-50%) scale(1)"}}));const x=document.createElement("button");if(x.textContent=Tt(e.unlockedPlanets.length,_.length),x.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${i?"0.95rem":"1.2rem"};
      font-weight: 700;
      padding: ${i?"0.4rem 1rem":"0.6rem 1.5rem"};
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,x.style.position="absolute",x.style.bottom=i?"1rem":"2rem",x.style.left=i?"1rem":"2rem",this.encyclopediaBtn=x,this.overlayButtonCleanups.add(T(x,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.openEncyclopedia()},onPressChange:v=>{x.style.transform=v?"scale(0.96)":"scale(1)"}})),f.appendChild(g),f.appendChild(d),f.appendChild(p),f.appendChild(E),je(e)){const v=document.createElement("button");v.setAttribute("data-reset-progress-button",""),v.textContent="さいしょから",v.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: 1.15rem;
        font-weight: 900;
    ...
    `,o.appendChild(c);const u=`
      ...
      transition: transform 0.08s ease-out;
      white-space: nowrap;
    `,m=(g,d)=>{const p=T(g,{onActivate:d,onPressChange:E=>{g.style.transform=E?"scale(0.9)":"scale(1)"}});this.activePressCleanups.add(p)},l=document.createElement("button");l.setAttribute("data-home-confirm-back",""),l.setAttribute("aria-label","タイトルへ もどる"),l.textContent="🏠 タイトルへ もどる",l.style.cssText=u,l.style.fontFamily="'Zen Maru Gothic', sans-serif",l.style.background="rgba(255, 255, 255, 0.18)",l.style.color="#ffffff",l.style.minWidth="88px",l.style.minHeight="88px",l.style.touchAction="manipulation",l.style.transform="scale(1)",l.style.transition="transform 0.08s ease-out",l.style.whiteSpace="nowrap",m(l,n),c.appendChild(l);const f=document.createElement("button");f.setAttribute("data-home-confirm-continue",""),f.setAttribute("aria-label","つづける"),f.textContent="✋ つづける",f.style.cssText=u,f.style.fontFamily="'Zen Maru Gothic', sans-serif",f.style.background="linear-gradient(135deg, #FF6B6B, #FFE66D)",f.style.color="#FFD700",f.style.textShadow="0 1px 2px rgba(0, 0, 32, 0.6)",f.style.minWidth="88px",f.style.minHeight="88px",f.style.touchAction="manipulation",f.style.transform="scale(1)",f.style.transition="transform 0.08s ease-out",f.style.whiteSpace="nowrap",m(f,a),c.appendChild(f),s.appendChild(this.overlayEl)}hide(){if(this.overlayEl){const t=Array.from(this.activePressCleanups);this.activePressCleanups.clear();for(const e of t)e();this.overlayEl.remove(),this.overlayEl=null}}isVisible(){return this.overlayEl!==null}}class zt{overlayEl=null;activePressCleanups=new Set;show(t,e){if(this.overlayEl)return;const s=document.getElementById("ui-overlay")??document.body;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-pause-overlay",""),this.overlayEl.setAttribute("role","dialog"),this.overlayEl.setAttribute("aria-modal","true"),this.overlayEl.setAttribute("aria-label","やすみちゅう"),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
    ...
    `,i.appendChild(n);const o=document.createElement("div");o.style.cssText=`
      ...
      align-items: stretch;
      width: 100%;
    `,i.appendChild(o);const h=(c,u,m,l,f,g)=>{const d=document.createElement("button");d.setAttribute(u,""),d.setAttribute("aria-label",m),d.textContent=c,d.style.cssText=`
        flex: 1 1 140px;
        padding: 1rem 1.2rem;
        border: none;
        border-radius: 1.6rem;
    ...
    `,document.head.appendChild(t)}}const Xe=1,Ve=.4;class Bt{overlayEl=null;numberEl=null;phase="idle";elapsed=0;currentStep=0;stepDuration;goDuration;onTick;onGo;onComplete=null;steps=["3","2","1"];constructor(t={}){this.stepDuration=t.stepDuration??Xe,this.goDuration=t.goDuration??Ve,this.onTick=t.onTick,this.onGo=t.onGo}show(t){if(this.phase!=="idle"&&this.phase!=="done")return;const e=document.getElementById("ui-overlay")??document.body;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-countdown-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
    ...
    `,document.head.appendChild(t)}getActiveSide(t){return t==="active-left"?"left":t==="active-right"?"right":t==="assist-left"?"left":t==="assist-right"?"right":t==="hidden"?"none":"both"}getGuideEmphasis(t,e){return e==="active-left"?t==="left"?"primary":"secondary":e==="active-right"?t==="right"?"primary":"secondary":e==="assist-left"?t==="left"?"primary":"secondary":e==="assist-right"?t==="right"?"primary":"secondary":e==="hidden"?"hidden":"balanced"}updateInstruction(t){if(!this.instructionEl)return;const e=this.getInstructionMessage(t);this.instructionEl.textContent=e,this.instructionEl.setAttribute("data-touch-guide-message",e)}getInstructionMessage(t){return t==="intro"?"ひだりか みぎを さわると うごけるよ":t==="idle"?"ひつような ときは ひだりか みぎを さわって うごこう":t==="assist-left"?"ひだりへ よけよう":t==="assist-right"?"みぎへ よけよう":""}}class st{static DEFAULT_DURATION=4.2;static CELEBRATION_DURATION=3.6;element=null;timer=0;message=null;highContrast=!1;showHint(t){this.showMessage(t,st.DEFAULT_DURATION)}showCelebration(t){this.showMessage(t,st.CELEBRATION_DURATION)}tick(t){this.timer<=0||(this.timer=Math.max(0,this.timer-t),this.timer===0&&this.hide())}hide(){this.timer=0,this.message=null,this.element&&(this.element.style.display="none",this.element.textContent="",this.element.removeAttribute("data-constellation-message"))}setHighContrastMode(t){this.highContrast=t,this.element&&this.applyElementStyle(this.element)}getMessage(){return this.message}showMessage(t,e){const s=this.ensureElement();this.timer=e,this.message=t,s.textContent=t,s.setAttribute("data-constellation-message",t),s.style.display="flex"}ensureElement(){if(this.element)return this.element;const t=document.getElementById("ui-overlay"),e=document.createElement("div");return e.setAttribute("data-constellation-hint",""),e.setAttribute("aria-live","polite"),this.applyElementStyle(e),e.style.display="none",t?.appendChild(e),this.element=e,e}applyElementStyle(t){t.style.cssText=`
      ...
      z-index: 35;
      box-shadow: 0 10px 24px rgba(0, 0, 0, 0.24);
    `}}const Je=4;class ts{overlayEl=null;cardEl=null;titleEl=null;messageEl=null;elapsed=0;visible=!1;highContrastMode=!1;totalDuration;constructor(t={}){this.totalDuration=t.totalDuration??Je}show(t){const e=document.getElementById("ui-overlay")??document.body;Rt();const s=z().height<=500;(!this.overlayEl||!this.cardEl||!this.titleEl||!this.messageEl)&&(this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-seasonal-event-notice",""),this.overlayEl.style.cssText=`
        position: absolute;
    ...
    `,this.overlay.appendChild(i),this.overlay.appendChild(a),this.overlay.appendChild(n),this.overlay.appendChild(this.exitCta),s.appendChild(this.overlay)}update(t){this.bgStars&&(this.bgStars.rotation.y+=t*.03),this.updateCelebration(t)}setupCelebration(){this.companionGroup=new Q,this.companionMeshes=[],this.circleX.length=0,this.circleZ.length=0,this.popinSettled.length=0,this.celebrationElapsed=0,this.thankYouShown=!1,this.canExit=!1,this.exitTriggered=!1;for(let t=0;t<_.length;t++){const e=_[t],s=It.createCompanionMesh(e),i=t*(2*Math.PI/_.length),a=Math.cos(i)*I.CIRCLE_RADIUS,n=Math.sin(i)*I.CIRCLE_RADIUS;this.circleX.push(a),this.circleZ.push(n),s.position.set(a,0,n),s.scale.set(0,0,0),this.companionMeshes.push(s),this.popinSettled.push(!1),this.companionGroup.add(s)}this.threeScene.add(this.companionGroup)}updateCelebration(t){if(this.companionMeshes.length===0)return;this.celebrationElapsed+=t;const e=I.POPIN_DELAY*(this.companionMeshes.length-1)+I.POPIN_DURATION,s=this.celebrationElapsed>e,i=s?Math.abs(Math.sin(this.celebrationElapsed*I.BOUNCE_SPEED))*I.BOUNCE_HEIGHT:0;for(let a=0;a<this.companionMeshes.length;a++){const n=this.companionMeshes[a];if(this.popinSettled[a]){s&&(n.position.y=i),n.rotation.y+=t*2;continue}const o=a*I.POPIN_DELAY;if(!(this.celebrationElapsed<o)){if(this.celebrationElapsed<o+I.POPIN_DURATION){const h=(this.celebrationElapsed-o)/I.POPIN_DURATION,c=this.bounceEase(h);n.scale.set(c,c,c)}else n.scale.set(1,1,1),this.popinSettled[a]=!0;s&&(n.position.y=i),n.rotation.y+=t*2}}!this.thankYouShown&&this.celebrationElapsed>=I.THANK_YOU_DELAY&&(this.showThankYouText(),this.thankYouShown=!0)}bounceEase(t){return t<.6?t/.6*1.2:1.2-(t-.6)/.4*.2}showThankYouText(){if(!this.overlay||!this.exitCta)return;const t=document.createElement("div");t.setAttribute("data-ending-thank-you",""),t.textContent="みんな ありがとう！",t.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: 2rem;
      font-weight: 900;
      color: #FFD700;
