const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-Cl5OBeH7.js","assets/game-core-CY8DGzTy.js","assets/three-CCkbs3tE.js"])))=>i.map(i=>d[i]);
import{g as Q,D as ft,S as F,T as D,a as ot,b as Rt,L as $t,c as jt,_ as mt,d as L,e as N,s as Dt,f as J,P as j,u as Ht,C as Ut,h as Zt,i as qt,B as Wt,j as Yt,M as Vt,k as Xt,l as Qt,m as Kt,n as Jt,o as te,p as ee,q as se,r as ie,t as ae,v as ne,A as oe,w as re,x as le,y as he,z as Lt,E as ce,F as de,R as ue,G as me,H as pe,I as fe,J as ge,K as Tt,N as ye,O as be,Q as rt,U as K,V as ve,W as lt,X as ht,Y as Ee,Z as Se,$ as xe}from"./game-core-CY8DGzTy.js";import{m as gt,k as yt,i as bt,l as vt,G as tt,q as Ce,a as we,r as Ae,M,g as R,D as Mt,R as Pt,s as H,t as Et,u as et,h as St,P as xt,V as $,v as Te,w as Me}from"./three-CCkbs3tE.js";class Ct{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const e=document.getElementById("ui-overlay");if(!e)return;const s=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
    ...
    `,p=(c,m)=>{let E=!1,S=!1;const x=()=>{A(!0)},C=()=>{c.style.transform="scale(0.92)"},I=()=>{c.style.transform="scale(1)"},A=(w=!1)=>{E=!1,S=w,I(),this.activePressCleanups.delete(x),document.removeEventListener("pointerup",v,!0),document.removeEventListener("pointercancel",y,!0)},v=w=>{const z=w.target===c||w.target instanceof Node&&c.contains(w.target),_t=E&&z;A(!z),_t&&m()},y=()=>{A(!0)};c.addEventListener("pointerdown",w=>{w.stopPropagation(),E=!0,S=!1,C(),this.activePressCleanups.add(x),document.addEventListener("pointerup",v,!0),document.addEventListener("pointercancel",y,!0)}),c.addEventListener("pointerenter",()=>{E&&C()}),c.addEventListener("pointerleave",()=>{E&&I()}),c.addEventListener("pointercancel",()=>A(!0)),c.addEventListener("click",w=>{if(w.stopPropagation(),S){S=!1;return}E||m()})},r=document.createElement("button");r.setAttribute("data-title-reset-cancel",""),r.textContent="やめる",r.style.cssText=g,r.style.background="rgba(255, 255, 255, 0.18)",r.style.color="#ffffff",p(r,a),u.appendChild(r);const f=document.createElement("button");f.setAttribute("data-title-reset-confirm",""),f.textContent="うん！ さいしょから",f.style.cssText=g,f.style.background="linear-gradient(135deg, #FF9F68, #FFE66D)",f.style.color="#3b1f00",p(f,n),u.appendChild(f),s.appendChild(this.overlayEl)}hide(){if(!this.overlayEl)return;const t=Array.from(this.activePressCleanups);this.activePressCleanups.clear();for(const e of t)e();this.overlayEl.remove(),this.overlayEl=null}}function wt(l){const t=l.topRem??.8,e=window.innerHeight<=500,s=document.createElement("button");let i=l.initialMuted;const a=()=>{s.textContent=i?"🔇":"🔊",s.setAttribute("aria-label",i?"サウンド オフ":"サウンド オン")};s.setAttribute("data-mute-button",""),s.style.position="absolute",s.style.top=`${t}rem`,s.style.right="1rem",s.style.fontSize=e?"clamp(1.1rem, 3.5vmin, 1.4rem)":"clamp(1.4rem, 4vmin, 1.8rem)",s.style.background="rgba(255, 255, 255, 0.15)",s.style.border="none",s.style.borderRadius="50%",s.style.width=e?"2.4rem":"3rem",s.style.height=e?"2.4rem":"3rem",s.style.display="flex",s.style.alignItems="center",s.style.justifyContent="center",s.style.cursor="pointer",s.style.pointerEvents="auto",s.style.touchAction="manipulation",s.style.transform="scale(1)",s.style.transition="transform 0.08s ease-out",a();const n=()=>{s.style.transform="scale(1)"};return s.addEventListener("pointerdown",o=>{o.stopPropagation(),s.style.transform="scale(0.9)",l.onToggle()}),s.addEventListener("pointerup",n),s.addEventListener("pointercancel",n),s.addEventListener("pointerleave",n),l.container.appendChild(s),{element:s,setMuted(o){i=o,a()},remove(){s.remove()}}}class Be{overlay=null;toggleButton=null;descriptionEl=null;highContrast=!1;vibrationIntensity="medium";motionSensitivity="strong";vibrationDescriptionEl=null;vibrationButtons=new Map;motionDescriptionEl=null;motionButtons=new Map;motionPreviewEl=null;motionPreviewTokenEl=null;motionPreviewCaptionEl=null;motionPreviewTimeoutId=null;motionPreviewFrameId=null;onToggle=null;onVibrationIntensityChange=null;onMotionSensitivityChange=null;show(t){const e=document.getElementById("ui-overlay");if(e){if(this.highContrast=t.initialHighContrast,this.vibrationIntensity=t.initialVibrationIntensity,this.motionSensitivity=t.initialMotionSensitivity,this.onToggle=t.onToggle,this.onVibrationIntensityChange=t.onVibrationIntensityChange,this.onMotionSensitivityChange=t.onMotionSensitivityChange,!this.overlay){this.overlay=document.createElement("div"),this.overlay.setAttribute("data-color-accessibility-settings",""),this.overlay.style.cssText=`
      ...
      `;const o=[{value:"strong",label:"つよい"},{value:"medium",label:"ふつう"},{value:"weak",label:"やさしい"},{value:"off",label:"オフ"}];for(const c of o){const m=document.createElement("button");m.setAttribute("data-vibration-intensity-button",c.value),m.textContent=c.label,m.style.cssText=`
        ...
        gap: 0.65rem;
        margin-bottom: 0.95rem;
      `;const g=["strong","medium","gentle","minimal"];for(const c of g){const m=Q(c),E=document.createElement("button");E.setAttribute("data-motion-sensitivity-button",c),E.style.cssText=`
          display: flex;
          flex-direction: column;
          align-items: center;
          justify-content: center;
          ...
          touch-action: manipulation;
          transition: transform 0.08s ease-out, border-color 0.12s ease-out, background 0.12s ease-out;
        `;const S=document.createElement("span");S.textContent=m.emoji,S.style.cssText="font-size: clamp(1.25rem, 4.8vmin, 1.7rem); line-height: 1;";const x=document.createElement("span");x.textContent=m.stars,x.style.cssText="font-size: clamp(0.82rem, 2.9vmin, 0.95rem); letter-spacing: 0.08em;";const C=document.createElement("span");C.textContent=m.shortLabel,C.style.cssText="font-size: clamp(0.9rem, 3vmin, 1rem);",E.append(S,x,C),E.addEventListener("click",()=>{this.motionSensitivity=c,this.render(),this.playMotionPreview(),this.onMotionSensitivityChange?.(c)}),this.motionButtons.set(c,E),u.appendChild(E)}this.motionPreviewEl=document.createElement("div"),this.motionPreviewEl.setAttribute("data-motion-preview",""),this.motionPreviewEl.style.cssText=`
        position: relative;
        min-height: 5.8rem;
        margin: 0 0 1rem;
        padding: 0.8rem 0.9rem;
    ...
    `,u.appendChild(g);const p=document.createElement("div");p.setAttribute("data-stats-stage-clears",""),p.style.cssText=`
      ...
      gap: 0.45rem;
      text-align: left;
    `;const r=Array.from({length:D},(c,m)=>m+1).map(c=>({stageNumber:c,clearCount:i.stageClearCounts[c]??0})).filter(c=>c.clearCount>0);if(r.length===0){const c=document.createElement("div");c.textContent="まだ きろくが ないよ",c.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: ${a?"1rem":"1.1rem"};
        font-weight: 700;
        text-align: center;
        color: rgba(255, 255, 255, 0.88);
      `,p.appendChild(c)}else for(const{stageNumber:c,clearCount:m}of r){const E=ot(c),S=document.createElement("div");S.setAttribute("data-stats-stage-clear-row",String(c)),S.style.cssText=`
          display: flex;
          align-items: center;
          ...
          font-weight: 700;
        `;const x=document.createElement("span");x.textContent=`${E.emoji} ステージ ${c} ${E.destinationReading}`;const C=document.createElement("span");C.textContent=`${m}かい`,C.style.color="#FFE66D",S.append(x,C),p.appendChild(S)}u.appendChild(p),o.appendChild(u);const f=document.createElement("button");f.textContent="もどる",f.style.cssText=`
      margin-top: 1rem;
    ...
    `;const n=document.createElement("div");return n.textContent=e,n.style.cssText=`
      ...
      font-weight: 900;
      color: #FFE66D;
    `,i.append(a,n),i}}function Bt(l,t){if(!Number.isFinite(l)||l<=0||t<=0)return"ずかん";const e=Math.min(l,t);return e>=t?`ずかん ${t} / ${t} 🎉`:`ずかん ${e} / ${t}`}function De(l){switch(l){case"hero":return{gap:"0.35rem",label:"0.92rem",medal:"1.7rem",hint:"0.98rem"};case"compact":return{gap:"0.18rem",label:"0.7rem",medal:"1rem",hint:"0.76rem"};default:return{gap:"0.26rem",label:"0.8rem",medal:"1.25rem",hint:"0.84rem"}}}function pt(l,t,e={}){const s=Rt(l,t),i=e.size??"regular",a=De(i),n=document.createElement("div");if(n.setAttribute("data-stage-medal-display",""),n.setAttribute("data-stage-medal-stage",String(l)),n.setAttribute("data-stage-medal-tier",s.tier),n.setAttribute("data-stage-medal-earned",String(s.earnedCount)),e.scope&&n.setAttribute("data-stage-medal-scope",e.scope),n.style.cssText=`
    display: flex;
    flex-direction: column;
    align-items: center;
    gap: ${a.gap};
  ...
  `,n.appendChild(d),n}const kt=2e3,st=new Map,it=new Map,at=new Map;let Y=null,V=null;function X(l,t){if(typeof document>"u"){const s=typeof OffscreenCanvas=="function",i=s?new OffscreenCanvas(l,t):{width:l,height:t};return{canvas:i,ctx:s?i.getContext("2d"):null}}const e=document.createElement("canvas");return e.width=l,e.height=t,{canvas:e,ctx:e.getContext("2d")}}function _(l,t){let e=st.get(l);return e||(e=t(),e.generateMipmaps=!1,e.minFilter=Ae,e.needsUpdate=!0,st.set(l,e)),e}function P(l,t){let e=it.get(l);return e||(e=t(),it.set(l,e)),e}function B(l,t){let e=at.get(l);return e||(e=t(),at.set(l,e)),e}function k(l,t){const e=new we(l,t);return e.userData.sharedAssets=!0,e}function zt(){if(!Y){const l=new yt,t=new Float32Array(kt*3);for(let e=0;e<kt*3;e+=3)t[e]=(Math.random()-.5)*200,t[e+1]=(Math.random()-.5)*200,t[e+2]=(Math.random()-.5)*400;l.setAttribute("position",new bt(t,3)),Y=l}V||(V=new vt({color:16777215,size:.2,sizeAttenuation:!0}))}function He(){const{canvas:l,ctx:t}=X(256,256);if(!t)return new H(l);t.fillStyle="#888888",t.fillRect(0,0,256,256);for(let e=0;e<30;e++){const s=Math.random()*256,i=Math.random()*256,a=3+Math.random()*12;t.beginPath(),t.arc(s,i,a,0,Math.PI*2),t.fillStyle=`rgba(60,60,60,${.3+Math.random()*.4})`,t.fill()}return new H(l)}function Le(){const{canvas:l,ctx:t}=X(256,256);if(!t)return new H(l);t.fillStyle="#ddaa44",t.fillRect(0,0,256,256);for(let e=0;e<8;e++){t.beginPath();const s=128+(Math.random()-.5)*100,i=128+(Math.random()-.5)*100;t.strokeStyle=`rgba(200,150,60,${.3+Math.random()*.3})`,t.lineWidth=3+Math.random()*5;for(let a=0;a<Math.PI*4;a+=.1){const n=10+a*8;t.lineTo(s+Math.cos(a)*n,i+Math.sin(a)*n)}t.stroke()}return new H(l)}function ze(){const{canvas:l,ctx:t}=X(256,256);if(!t)return new H(l);const e=["#cc7733","#dd9955","#bb6622","#eebb77","#aa5511","#ddaa66"];for(let s=0;s<256;s++){const i=Math.floor(s/(256/e.length))%e.length;t.fillStyle=e[i],t.fillRect(0,s,256,1)}return new H(l)}function Ge(){const{canvas:l,ctx:t}=X(512,256);return t?(t.fillStyle="#2266aa",t.fillRect(0,0,512,256),t.fillStyle="#886644",t.beginPath(),t.ellipse(300,80,80,40,.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(280,150,30,50,.1,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(100,90,25,60,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(110,170,20,40,-.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(420,170,25,15,0,0,Math.PI*2),t.fill(),t.fillStyle="#447733",t.beginPath(),t.ellipse(290,75,40,20,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(95,85,15,30,.2,0,Math.PI*2),t.fill(),new H(l)):new H(l)}function Fe(){const{canvas:l,ctx:t}=X(512,256);if(!t)return new H(l);t.clearRect(0,0,512,256),t.fillStyle="rgba(255,255,255,0.6)";for(let e=0;e<20;e++){const s=Math.random()*512,i=Math.random()*256;t.beginPath(),t.ellipse(s,i,20+Math.random()*40,8+Math.random()*15,Math.random()*Math.PI,0,Math.PI*2),t.fill()}return new H(l)}function Ne(){st.clear(),it.clear(),at.clear(),Y=null,V=null}const _e={planetTextureCache:st,planetGeometryCache:it,planetMaterialCache:at,getBgStarsGeometry:()=>Y,getBgStarsMaterial:()=>V};function Gt(l,t,e){const s=new tt;let i=null;switch(l){case 2:{const a=_("mercury",He),n=P("mercury:sphere",()=>new R(10,24,24)),o=B("mercury:mat",()=>new M({map:a})),h=k(n,o);s.add(h),i=h;break}case 3:{const a=_("venus",Le),n=P("venus:sphere",()=>new R(14,24,24)),o=B("venus:mat",()=>new M({map:a})),h=k(n,o);s.add(h),i=h;break}case 5:{const a=_("jupiter",ze),n=P("jupiter:sphere",()=>new R(20,24,24)),o=B("jupiter:mat",()=>new M({map:a})),h=k(n,o);s.add(h),i=h;break}case 6:{const a=P("saturn:sphere",()=>new R(15,24,24)),n=t.planetColor,o=B(`saturn:mat:${n}`,()=>new M({color:n})),h=k(a,o);s.add(h);const d=P("saturn:ring",()=>new Pt(20,30,48)),u=B("saturn:ringMat",()=>new M({color:15645542,side:Mt})),g=k(d,u);g.rotation.x=Math.PI/3,s.add(g),i=h;break}case 7:{const a=P("uranus:sphere",()=>new R(16,24,24)),n=B("uranus:mat",()=>new M({color:6737117})),o=k(a,n);s.add(o);const h=P("uranus:ring",()=>new Pt(21,28,48)),d=B("uranus:ringMat",()=>new M({color:10083822,side:Mt})),u=k(h,d);u.rotation.z=Math.PI/2,s.add(u),i=o;break}case 9:{const a=P("pluto:sphere",()=>new R(8,24,24)),n=B("pluto:mat",()=>new M({color:12298922})),o=k(a,n);s.add(o),i=o;break}case 10:{const a=P("sun:sphere",()=>new R(25,24,24)),n=B("sun:mat",()=>new M({color:16763904,emissive:16755200,emissiveIntensity:.5})),o=k(a,n);s.add(o),s.add(new Ce(16763904,2,200)),i=o;break}case 11:{const a=_("earth",Ge),n=P("earth:sphere",()=>new R(15,32,32)),o=B("earth:mat",()=>new M({map:a})),h=_("earth:cloud",Fe),d=P("earth:cloudSphere",()=>new R(15.5,32,32)),u=B("earth:cloudMat",()=>new M({map:h,transparent:!0,opacity:.3})),g=new tt;g.add(k(n,o)),g.add(k(d,u)),s.add(g),i=g;break}default:{const a=P("default:sphere",()=>new R(15,24,24)),n=t.planetColor,o=B(`default:mat:${n}`,()=>new M({color:n})),h=k(a,o);s.add(h),i=h;break}}return s.position.set(0,0,e),{planet:s,spinTarget:i}}function $e(l,t,e){return Gt(l,t,e)}function je(l){zt();const t=new gt(Y,V);return t.userData.sharedAssets=!0,t.geometry.setDrawRange(0,l),t}function At(l){!Number.isInteger(l)||l<1||l>D||typeof document>"u"&&typeof OffscreenCanvas!="function"||(zt(),Gt(l,ot(l),0))}let U=null,Z=null;function Ue(){if(!U){const l=new yt,t=new Float32Array(3e3);for(let e=0;e<3e3;e++)t[e]=(Math.random()-.5)*200;l.setAttribute("position",new bt(t,3)),U=l}return U}function Ze(){return Z||(Z=new vt({color:16777215,size:.3,sizeAttenuation:!0})),Z}function qe(){U=null,Z=null}const We={getBgStarsGeometry:()=>U,getBgStarsMaterial:()=>Z};function Ye(l){const t=window.requestIdleCallback;if(typeof t=="function"){t(l,{timeout:1500});return}window.setTimeout(l,800)}function Ft(l){return new Set(l.filter(t=>Number.isInteger(t)&&t>=1&&t<=D)).size}function Ve(l){return Ft(l)>=D}function ct(l){const t=Ve(l.unlockedPlanets),e=t?1:Math.min(l.clearedStage+1,D),s=ot(e),i=l.bestStageStars?.[e]??0;return t?{startStage:e,destination:s.destinationReading,emoji:s.emoji,statusLabel:"ぜんぶ あつめたよ！",destinationLabel:`${s.destinationReading}へ もういちど しゅっぱつ！`,buttonHint:`${s.emoji} ステージ ${e} から もういちど あそぶ`,bestStars:i}:{startStage:e,destination:s.destinationReading,emoji:s.emoji,statusLabel:l.clearedStage>0?"つづきから しゅっぱつ！":"はじめての しゅっぱつ！",destinationLabel:`${s.destinationReading}へ むかおう！`,buttonHint:`${s.emoji} ステージ ${e} から スタート`,bestStars:i}}function Xe(l){return l.clearedStage>0||Ft(l.unlockedPlanets)>0||Object.keys(l.bestStageStars??{}).length>0}class Qe{threeScene;ambientLight=new Et(16777215,1);camera;lastAspect=0;sceneManager;saveManager;audioManager;stars=null;companionParade=null;overlay=null;muteHandle=null;tutorialOverlay=new Ct;titleResetConfirmOverlay=new Pe;colorAccessibilitySettings=new Be;spaceshipCustomizer=new ke;statsOverlay=new Re;encyclopediaOverlay=null;encyclopediaOverlayPromise=null;companionFactory=null;companionFactoryPromise=null;loadEncyclopediaOverlay;loadTitleCompanionFactory;loadingOverlay;loadFailureOverlay;scheduleIdleTask;encyclopediaBtn=null;isOpeningEncyclopedia=!1;isActive=!1;encyclopediaRequestToken=0;companionParadeRequestToken=0;bgmPending=!1;overlayButtonCleanups=new Set;constructor(t,e,s,i={}){this.sceneManager=t,this.saveManager=e,this.audioManager=s,this.loadingOverlay=i.loadingOverlay??new $t,this.loadFailureOverlay=i.loadFailureOverlay??new jt,this.scheduleIdleTask=i.scheduleIdleTask??Ye,this.loadEncyclopediaOverlay=i.loadEncyclopediaOverlay??(()=>mt(()=>import("./EncyclopediaOverlay-Cl5OBeH7.js"),__vite__mapDeps([0,1,2]))),this.loadTitleCompanionFactory=i.loadTitleCompanionFactory??(()=>mt(()=>import("./game-core-CY8DGzTy.js").then(o=>o.a6),__vite__mapDeps([1,2]))),this.threeScene=new et,this.threeScene.background=new St(32);const{width:a,height:n}=L();this.camera=new xt(60,a/n,.1,1e3),this.camera.position.set(0,0,5)}enter(t){this.isActive=!0,this.encyclopediaRequestToken+=1,this.companionParadeRequestToken+=1,this.lastAspect=0,this.stars=new gt(Ue(),Ze()),this.stars.userData.sharedAssets=!0,this.stars.rotation.set(0,0,0),this.threeScene.add(this.stars),this.ambientLight.parent||this.threeScene.add(this.ambientLight);const e=this.saveManager.load();this.createCompanionParade(e.unlockedPlanets),this.createOverlay(),this.createMuteButton(),this.prefetchEncyclopediaOnIdle(),this.prewarmNextAdventureOnIdle(ct(e).startStage),this.audioManager.isInitialized()?(this.audioManager.playBGM(0),this.bgmPending=!1):this.bgmPending=!0,e.tutorialShown||this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide(),this.saveManager.markTutorialShown()})}createMuteButton(){const t=document.getElementById("hud")??document.getElementById("ui-overlay");t&&(this.muteHandle=wt({initialMuted:this.audioManager.isMuted(),container:t,onToggle:()=>{this.ensureTitleAudioInitialized(!0);const e=this.audioManager.toggleMute();this.muteHandle?.setMuted(e);const s=this.saveManager.load();s.muted=e,this.saveManager.save(s)}}))}getEncyclopediaOverlay(){return this.encyclopediaOverlay?Promise.resolve(this.encyclopediaOverlay):this.encyclopediaOverlayPromise?this.encyclopediaOverlayPromise:(this.encyclopediaOverlayPromise=this.loadEncyclopediaOverlay().then(({EncyclopediaOverlay:t})=>{const e=new t;return this.encyclopediaOverlay=e,e}).finally(()=>{this.encyclopediaOverlayPromise=null}),this.encyclopediaOverlayPromise)}getTitleCompanionFactory(){return this.companionFactory?Promise.resolve(this.companionFactory):this.companionFactoryPromise?this.companionFactoryPromise:(this.companionFactoryPromise=this.loadTitleCompanionFactory().then(t=>(this.companionFactory=t,t)).finally(()=>{this.companionFactoryPromise=null}),this.companionFactoryPromise)}showEncyclopedia(){if(!this.isActive||!this.encyclopediaOverlay)return;const t=this.saveManager.load();this.encyclopediaOverlay.show(t.unlockedPlanets,()=>this.refreshEncyclopediaButtonLabel(),e=>{this.ensureTitleAudioInitialized(!1),this.sceneManager.requestTransition("stage",{stageNumber:e,totalScore:0,totalStarCount:0,launchSource:"encyclopedia"})},t.bestStageStars??{},t.discoveredConstellations??[])}isCurrentEncyclopediaRequest(t){return this.isActive&&this.encyclopediaRequestToken===t}prefetchEncyclopediaOnIdle(){const t=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{!this.isCurrentEncyclopediaRequest(t)||this.encyclopediaOverlay||this.encyclopediaOverlayPromise||this.getEncyclopediaOverlay().catch(()=>{})})}prewarmNextAdventureOnIdle(t){if(t>D)return;const e=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{this.isCurrentEncyclopediaRequest(e)&&At(t)})}async openEncyclopedia(){if(!this.isActive)return;if(this.loadFailureOverlay.hide(),this.encyclopediaOverlay){this.showEncyclopedia();return}if(this.isOpeningEncyclopedia)return;const t=this.encyclopediaRequestToken;this.isOpeningEncyclopedia=!0,this.loadingOverlay.show("ずかんを よんでるよ...");try{if(await this.getEncyclopediaOverlay(),!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),this.showEncyclopedia()}catch(e){if(!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),console.error("Failed to load encyclopedia overlay",e),this.loadFailureOverlay.show({title:"ずかんを もういちど よんでみよう！",message:"「もういちど よむ」を おして つづきを たのしもう！",primaryAction:{label:"もういちど よむ",onSelect:()=>this.openEncyclopedia()}})}finally{this.encyclopediaRequestToken===t&&(this.isOpeningEncyclopedia=!1)}}persistHighContrastSetting(t){const e=this.saveManager.load(),s=e.colorAccessibility?.motionSensitivity??N;e.colorAccessibility=this.buildColorAccessibilitySettings(t,s),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}persistVibrationIntensitySetting(t){const e=this.saveManager.load();e.vibrationSettings={intensity:t},this.saveManager.save(e),Dt(t)}persistMotionSensitivitySetting(t){const e=this.saveManager.load(),s=e.colorAccessibility?.highContrast===!0;e.colorAccessibility=this.buildColorAccessibilitySettings(s,t),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}buildColorAccessibilitySettings(t,e){if(!(!t&&e===N))return{...t?{highContrast:!0}:{},...e!==N?{motionSensitivity:e}:{}}}createOverlay(){const t=document.getElementById("ui-overlay");if(!t)return;const e=this.saveManager.load(),s=ct(e),i=Xe(e);this.overlay=document.createElement("div"),this.overlay.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      justify-content: center;
    ...
    `;const c=document.createElement("button");c.textContent="あそぶ",c.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(T(c,{onActivate:()=>{this.ensureTitleAudioInitialized(!1);const y=this.saveManager.load(),w=ct(y).startStage;this.sceneManager.requestTransition("stage",{stageNumber:w,totalScore:0,totalStarCount:0,launchSource:"campaign"})},onPressChange:y=>{c.style.transform=y?"scale(0.96)":"scale(1)"}}));const m=document.createElement("div");m.setAttribute("data-play-button-hint",""),m.textContent=s.buttonHint,m.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${a?"0.85rem":"1rem"};
      font-weight: 700;
      color: rgba(255, 255, 255, 0.88);
    ...
    `;const S=document.createElement("button");S.setAttribute("data-spaceship-customizer-button",""),S.textContent="うちゅうせんをかざろう",S.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(T(S,{onActivate:()=>{const y=this.saveManager.load();this.spaceshipCustomizer.show({initialCustomization:y.spaceshipCustomization??ft,onComplete:w=>{const z=this.saveManager.load();z.spaceshipCustomization=w,this.saveManager.save(z)}})},onPressChange:y=>{S.style.transform=y?"scale(0.96)":"scale(1)"}}));const x=document.createElement("button");x.setAttribute("data-stats-button",""),x.textContent="あそびの きろく",x.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${a?"0.9rem":"1.05rem"};
      font-weight: 900;
      padding: ${a?"0.55rem 0.65rem":"0.7rem 0.85rem"};
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(T(x,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.statsOverlay.show(this.saveManager.load().gameplayStats,()=>{})},onPressChange:y=>{x.style.transform=y?"scale(0.96)":"scale(1)"}}));const C=document.createElement("div");C.setAttribute("data-title-footer-actions",""),C.style.cssText=`
      display: grid;
    ...
    `,this.overlayButtonCleanups.add(T(A,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.colorAccessibilitySettings.show({initialHighContrast:this.saveManager.load().colorAccessibility?.highContrast===!0,initialVibrationIntensity:this.saveManager.load().vibrationSettings?.intensity??"medium",initialMotionSensitivity:this.saveManager.load().colorAccessibility?.motionSensitivity??N,onToggle:y=>this.persistHighContrastSetting(y),onVibrationIntensityChange:y=>this.persistVibrationIntensitySetting(y),onMotionSensitivityChange:y=>this.persistMotionSensitivitySetting(y)})},onPressChange:y=>{A.style.transform=y?"scale(0.96)":"scale(1)"}}));const v=document.createElement("button");if(v.textContent=Bt(e.unlockedPlanets.length,j.length),v.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.encyclopediaBtn=v,this.overlayButtonCleanups.add(T(v,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.openEncyclopedia()},onPressChange:y=>{v.style.transform=y?"scale(0.96)":"scale(1)"}})),f.appendChild(c),f.appendChild(m),E.appendChild(S),E.appendChild(x),i){const y=document.createElement("button");y.setAttribute("data-reset-progress-button",""),y.textContent="さいしょから",y.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: ${a?"0.9rem":"1.05rem"};
        font-weight: 900;
        padding: ${a?"0.55rem 0.65rem":"0.7rem 0.85rem"};
