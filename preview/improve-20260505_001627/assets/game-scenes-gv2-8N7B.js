const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-DhOdTQon.js","assets/game-core-rHo03rt-.js","assets/three-By3JikJA.js"])))=>i.map(i=>d[i]);
import{D as ht,S as G,T as D,g as et,a as At,L as It,b as kt,_ as ot,c as z,d as V,P as N,u as Dt,C as Ht,e as Lt,f as zt,B as Gt,h as Ft,i as _t,j as Nt,A as $t,k as jt,l as Ut,m as Tt,n as Zt,o as qt,p as st,t as it,q as Yt,s as Xt,r as Vt}from"./game-core-rHo03rt-.js";import{m as ct,k as dt,i as ut,l as mt,G as W,o as Wt,a as Qt,p as Kt,M as B,g as k,D as Ct,R as xt,q as H,r as pt,s as Q,h as ft,P as gt,V as rt,t as Jt,u as te}from"./three-By3JikJA.js";class yt{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const s=document.getElementById("ui-overlay");if(!s)return;const e=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
    ...
    `,o.appendChild(n),o.appendChild(h),o.appendChild(l),o}isCompactHeight(){return window.innerHeight<=yt.COMPACT_HEIGHT_THRESHOLD}injectAnimations(){if(document.getElementById("tutorial-animations"))return;const t=document.createElement("style");t.id="tutorial-animations",t.textContent=`
      @keyframes swipe {
    ...
    `,n.appendChild(l);const u=document.createElement("div");u.style.cssText=`
      display: flex;
      gap: 0.8rem;
      justify-content: center;
      flex-wrap: wrap;
    `,n.appendChild(u);const p=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: 1.1rem;
      font-weight: 900;
      min-width: 88px;
    ...
    `,n.appendChild(h);const l=document.createElement("div");l.style.cssText=`
      ...
      gap: 0.8rem;
      margin-bottom: 1rem;
    `,l.append(this.createSummaryCard("あそんだ じかん",ne(i.totalPlayTimeSeconds),"data-stats-total-play-time"),this.createSummaryCard("とった ほし",`${i.totalStarsCollected}こ`,"data-stats-total-stars"),this.createSummaryCard("ブースト",`${i.totalBoostUses}かい`,"data-stats-total-boosts")),n.appendChild(l);const u=document.createElement("div");u.style.cssText=`
      margin-top: 0.5rem;
    ...
    `;const p=document.createElement("div");p.textContent="ステージ クリア かいすう",p.style.cssText=`
      ...
      font-weight: 900;
      color: #FFE66D;
    `,u.appendChild(p);const f=document.createElement("div");f.setAttribute("data-stats-stage-clears",""),f.style.cssText=`
      display: flex;
      flex-direction: column;
      gap: 0.45rem;
      text-align: left;
    `;const d=Array.from({length:D},(m,E)=>E+1).map(m=>({stageNumber:m,clearCount:i.stageClearCounts[m]??0})).filter(m=>m.clearCount>0);if(d.length===0){const m=document.createElement("div");m.textContent="まだ きろくが ないよ",m.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: ${a?"1rem":"1.1rem"};
        font-weight: 700;
        text-align: center;
        color: rgba(255, 255, 255, 0.88);
      `,f.appendChild(m)}else for(const{stageNumber:m,clearCount:E}of d){const v=et(m),C=document.createElement("div");C.setAttribute("data-stats-stage-clear-row",String(m)),C.style.cssText=`
          display: flex;
          align-items: center;
          ...
          font-weight: 700;
        `;const w=document.createElement("span");w.textContent=`${v.emoji} ステージ ${m} ${v.destinationReading}`;const S=document.createElement("span");S.textContent=`${E}かい`,S.style.color="#FFE66D",C.append(w,S),f.appendChild(C)}u.appendChild(f),n.appendChild(u);const c=document.createElement("button");c.textContent="もどる",c.style.cssText=`
      margin-top: 1rem;
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.actionCleanups.add(T(c,{onActivate:()=>{this.hide(),s()},onPressChange:m=>{c.style.transform=m?"scale(0.96)":"scale(1)"}})),n.appendChild(c),o.appendChild(n),e.appendChild(o)}hide(){const t=Array.from(this.actionCleanups);this.actionCleanups.clear();for(const s of t)s();this.overlayEl?.remove(),this.overlayEl=null}createSummaryCard(t,s,e){const i=document.createElement("div");i.setAttribute(e,""),i.style.cssText=`
    ...
    `;const o=document.createElement("div");return o.textContent=s,o.style.cssText=`
      ...
      font-weight: 900;
      color: #FFE66D;
    `,i.append(a,o),i}}function Et(r,t){if(!Number.isFinite(r)||r<=0||t<=0)return"ずかん";const s=Math.min(r,t);return s>=t?`ずかん ${t} / ${t} 🎉`:`ずかん ${s} / ${t}`}function re(r){switch(r){case"hero":return{gap:"0.35rem",label:"0.92rem",medal:"1.7rem",hint:"0.98rem"};case"compact":return{gap:"0.18rem",label:"0.7rem",medal:"1rem",hint:"0.76rem"};default:return{gap:"0.26rem",label:"0.8rem",medal:"1.25rem",hint:"0.84rem"}}}function lt(r,t,s={}){const e=At(r,t),i=s.size??"regular",a=re(i),o=document.createElement("div");if(o.setAttribute("data-stage-medal-display",""),o.setAttribute("data-stage-medal-stage",String(r)),o.setAttribute("data-stage-medal-tier",e.tier),o.setAttribute("data-stage-medal-earned",String(e.earnedCount)),s.scope&&o.setAttribute("data-stage-medal-scope",s.scope),o.style.cssText=`
    display: flex;
    flex-direction: column;
    align-items: center;
    gap: ${a.gap};
  `,s.label){const u=document.createElement("div");u.textContent=s.label,u.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${a.label};
      font-weight: 700;
      color: rgba(255, 255, 255, 0.84);
      letter-spacing: 0.06em;
    `,o.appendChild(u)}const n=document.createElement("div");n.style.cssText=`
    display: flex;
    align-items: center;
    justify-content: center;
    gap: ${a.gap};
  `;for(const u of e.slots){const p=document.createElement("span");p.setAttribute("data-stage-medal-slot",u.tier),p.setAttribute("data-stage-medal-threshold",String(u.threshold)),p.setAttribute("data-stage-medal-reached",String(u.reached)),p.textContent=u.icon,p.style.cssText=`
      font-size: ${a.medal};
      line-height: 1;
  ...
  `,o.appendChild(l),o}const St=2e3,K=new Map,J=new Map,tt=new Map;let q=null,Y=null;function X(r,t){if(typeof document>"u"){const e=typeof OffscreenCanvas=="function",i=e?new OffscreenCanvas(r,t):{width:r,height:t};return{canvas:i,ctx:e?i.getContext("2d"):null}}const s=document.createElement("canvas");return s.width=r,s.height=t,{canvas:s,ctx:s.getContext("2d")}}function _(r,t){let s=K.get(r);return s||(s=t(),s.generateMipmaps=!1,s.minFilter=Kt,s.needsUpdate=!0,K.set(r,s)),s}function P(r,t){let s=J.get(r);return s||(s=t(),J.set(r,s)),s}function O(r,t){let s=tt.get(r);return s||(s=t(),tt.set(r,s)),s}function R(r,t){const s=new Qt(r,t);return s.userData.sharedAssets=!0,s}function Mt(){if(!q){const r=new dt,t=new Float32Array(St*3);for(let s=0;s<St*3;s+=3)t[s]=(Math.random()-.5)*200,t[s+1]=(Math.random()-.5)*200,t[s+2]=(Math.random()-.5)*400;r.setAttribute("position",new ut(t,3)),q=r}Y||(Y=new mt({color:16777215,size:.2,sizeAttenuation:!0}))}function le(){const{canvas:r,ctx:t}=X(256,256);if(!t)return new H(r);t.fillStyle="#888888",t.fillRect(0,0,256,256);for(let s=0;s<30;s++){const e=Math.random()*256,i=Math.random()*256,a=3+Math.random()*12;t.beginPath(),t.arc(e,i,a,0,Math.PI*2),t.fillStyle=`rgba(60,60,60,${.3+Math.random()*.4})`,t.fill()}return new H(r)}function he(){const{canvas:r,ctx:t}=X(256,256);if(!t)return new H(r);t.fillStyle="#ddaa44",t.fillRect(0,0,256,256);for(let s=0;s<8;s++){t.beginPath();const e=128+(Math.random()-.5)*100,i=128+(Math.random()-.5)*100;t.strokeStyle=`rgba(200,150,60,${.3+Math.random()*.3})`,t.lineWidth=3+Math.random()*5;for(let a=0;a<Math.PI*4;a+=.1){const o=10+a*8;t.lineTo(e+Math.cos(a)*o,i+Math.sin(a)*o)}t.stroke()}return new H(r)}function ce(){const{canvas:r,ctx:t}=X(256,256);if(!t)return new H(r);const s=["#cc7733","#dd9955","#bb6622","#eebb77","#aa5511","#ddaa66"];for(let e=0;e<256;e++){const i=Math.floor(e/(256/s.length))%s.length;t.fillStyle=s[i],t.fillRect(0,e,256,1)}return new H(r)}function de(){const{canvas:r,ctx:t}=X(512,256);return t?(t.fillStyle="#2266aa",t.fillRect(0,0,512,256),t.fillStyle="#886644",t.beginPath(),t.ellipse(300,80,80,40,.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(280,150,30,50,.1,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(100,90,25,60,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(110,170,20,40,-.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(420,170,25,15,0,0,Math.PI*2),t.fill(),t.fillStyle="#447733",t.beginPath(),t.ellipse(290,75,40,20,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(95,85,15,30,.2,0,Math.PI*2),t.fill(),new H(r)):new H(r)}function ue(){const{canvas:r,ctx:t}=X(512,256);if(!t)return new H(r);t.clearRect(0,0,512,256),t.fillStyle="rgba(255,255,255,0.6)";for(let s=0;s<20;s++){const e=Math.random()*512,i=Math.random()*256;t.beginPath(),t.ellipse(e,i,20+Math.random()*40,8+Math.random()*15,Math.random()*Math.PI,0,Math.PI*2),t.fill()}return new H(r)}function me(){K.clear(),J.clear(),tt.clear(),q=null,Y=null}const pe={planetTextureCache:K,planetGeometryCache:J,planetMaterialCache:tt,getBgStarsGeometry:()=>q,getBgStarsMaterial:()=>Y};function Bt(r,t,s){const e=new W;let i=null;switch(r){case 2:{const a=_("mercury",le),o=P("mercury:sphere",()=>new k(10,24,24)),n=O("mercury:mat",()=>new B({map:a})),h=R(o,n);e.add(h),i=h;break}case 3:{const a=_("venus",he),o=P("venus:sphere",()=>new k(14,24,24)),n=O("venus:mat",()=>new B({map:a})),h=R(o,n);e.add(h),i=h;break}case 5:{const a=_("jupiter",ce),o=P("jupiter:sphere",()=>new k(20,24,24)),n=O("jupiter:mat",()=>new B({map:a})),h=R(o,n);e.add(h),i=h;break}case 6:{const a=P("saturn:sphere",()=>new k(15,24,24)),o=t.planetColor,n=O(`saturn:mat:${o}`,()=>new B({color:o})),h=R(a,n);e.add(h);const l=P("saturn:ring",()=>new xt(20,30,48)),u=O("saturn:ringMat",()=>new B({color:15645542,side:Ct})),p=R(l,u);p.rotation.x=Math.PI/3,e.add(p),i=h;break}case 7:{const a=P("uranus:sphere",()=>new k(16,24,24)),o=O("uranus:mat",()=>new B({color:6737117})),n=R(a,o);e.add(n);const h=P("uranus:ring",()=>new xt(21,28,48)),l=O("uranus:ringMat",()=>new B({color:10083822,side:Ct})),u=R(h,l);u.rotation.z=Math.PI/2,e.add(u),i=n;break}case 9:{const a=P("pluto:sphere",()=>new k(8,24,24)),o=O("pluto:mat",()=>new B({color:12298922})),n=R(a,o);e.add(n),i=n;break}case 10:{const a=P("sun:sphere",()=>new k(25,24,24)),o=O("sun:mat",()=>new B({color:16763904,emissive:16755200,emissiveIntensity:.5})),n=R(a,o);e.add(n),e.add(new Wt(16763904,2,200)),i=n;break}case 11:{const a=_("earth",de),o=P("earth:sphere",()=>new k(15,32,32)),n=O("earth:mat",()=>new B({map:a})),h=_("earth:cloud",ue),l=P("earth:cloudSphere",()=>new k(15.5,32,32)),u=O("earth:cloudMat",()=>new B({map:h,transparent:!0,opacity:.3})),p=new W;p.add(R(o,n)),p.add(R(l,u)),e.add(p),i=p;break}default:{const a=P("default:sphere",()=>new k(15,24,24)),o=t.planetColor,n=O(`default:mat:${o}`,()=>new B({color:o})),h=R(a,n);e.add(h),i=h;break}}return e.position.set(0,0,s),{planet:e,spinTarget:i}}function fe(r,t,s){return Bt(r,t,s)}function ge(r){Mt();const t=new ct(q,Y);return t.userData.sharedAssets=!0,t.geometry.setDrawRange(0,r),t}function vt(r){!Number.isInteger(r)||r<1||r>D||typeof document>"u"&&typeof OffscreenCanvas!="function"||(Mt(),Bt(r,et(r),0))}let $=null,j=null;function ye(){if(!$){const r=new dt,t=new Float32Array(3e3);for(let s=0;s<3e3;s++)t[s]=(Math.random()-.5)*200;r.setAttribute("position",new ut(t,3)),$=r}return $}function be(){return j||(j=new mt({color:16777215,size:.3,sizeAttenuation:!0})),j}function ve(){$=null,j=null}const Ce={getBgStarsGeometry:()=>$,getBgStarsMaterial:()=>j};function xe(r){const t=window.requestIdleCallback;if(typeof t=="function"){t(r,{timeout:1500});return}window.setTimeout(r,800)}function Pt(r){return new Set(r.filter(t=>Number.isInteger(t)&&t>=1&&t<=D)).size}function Ee(r){return Pt(r)>=D}function at(r){const t=Ee(r.unlockedPlanets),s=t?1:Math.min(r.clearedStage+1,D),e=et(s),i=r.bestStageStars?.[s]??0;return t?{startStage:s,destination:e.destinationReading,emoji:e.emoji,statusLabel:"ぜんぶ あつめたよ！",destinationLabel:`${e.destinationReading}へ もういちど しゅっぱつ！`,buttonHint:`${e.emoji} ステージ ${s} から もういちど あそぶ`,bestStars:i}:{startStage:s,destination:e.destinationReading,emoji:e.emoji,statusLabel:r.clearedStage>0?"つづきから しゅっぱつ！":"はじめての しゅっぱつ！",destinationLabel:`${e.destinationReading}へ むかおう！`,buttonHint:`${e.emoji} ステージ ${s} から スタート`,bestStars:i}}function Se(r){return r.clearedStage>0||Pt(r.unlockedPlanets)>0||Object.keys(r.bestStageStars??{}).length>0}class we{threeScene;ambientLight=new pt(16777215,1);camera;lastAspect=0;sceneManager;saveManager;audioManager;stars=null;companionParade=null;overlay=null;muteHandle=null;tutorialOverlay=new yt;titleResetConfirmOverlay=new ee;colorAccessibilitySettings=new se;spaceshipCustomizer=new ie;statsOverlay=new oe;encyclopediaOverlay=null;encyclopediaOverlayPromise=null;companionFactory=null;companionFactoryPromise=null;loadEncyclopediaOverlay;loadTitleCompanionFactory;loadingOverlay;loadFailureOverlay;scheduleIdleTask;encyclopediaBtn=null;isOpeningEncyclopedia=!1;isActive=!1;encyclopediaRequestToken=0;companionParadeRequestToken=0;bgmPending=!1;overlayButtonCleanups=new Set;constructor(t,s,e,i={}){this.sceneManager=t,this.saveManager=s,this.audioManager=e,this.loadingOverlay=i.loadingOverlay??new It,this.loadFailureOverlay=i.loadFailureOverlay??new kt,this.scheduleIdleTask=i.scheduleIdleTask??xe,this.loadEncyclopediaOverlay=i.loadEncyclopediaOverlay??(()=>ot(()=>import("./EncyclopediaOverlay-DhOdTQon.js"),__vite__mapDeps([0,1,2]))),this.loadTitleCompanionFactory=i.loadTitleCompanionFactory??(()=>ot(()=>import("./game-core-rHo03rt-.js").then(n=>n.E),__vite__mapDeps([1,2]))),this.threeScene=new Q,this.threeScene.background=new ft(32);const{width:a,height:o}=z();this.camera=new gt(60,a/o,.1,1e3),this.camera.position.set(0,0,5)}enter(t){this.isActive=!0,this.encyclopediaRequestToken+=1,this.companionParadeRequestToken+=1,this.lastAspect=0,this.stars=new ct(ye(),be()),this.stars.userData.sharedAssets=!0,this.stars.rotation.set(0,0,0),this.threeScene.add(this.stars),this.ambientLight.parent||this.threeScene.add(this.ambientLight);const s=this.saveManager.load();this.createCompanionParade(s.unlockedPlanets),this.createOverlay(),this.createMuteButton(),this.prefetchEncyclopediaOnIdle(),this.prewarmNextAdventureOnIdle(at(s).startStage),this.audioManager.isInitialized()?(this.audioManager.playBGM(0),this.bgmPending=!1):this.bgmPending=!0,s.tutorialShown||this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide(),this.saveManager.markTutorialShown()})}createMuteButton(){const t=document.getElementById("hud")??document.getElementById("ui-overlay");t&&(this.muteHandle=bt({initialMuted:this.audioManager.isMuted(),container:t,onToggle:()=>{this.ensureTitleAudioInitialized(!0);const s=this.audioManager.toggleMute();this.muteHandle?.setMuted(s);const e=this.saveManager.load();e.muted=s,this.saveManager.save(e)}}))}getEncyclopediaOverlay(){return this.encyclopediaOverlay?Promise.resolve(this.encyclopediaOverlay):this.encyclopediaOverlayPromise?this.encyclopediaOverlayPromise:(this.encyclopediaOverlayPromise=this.loadEncyclopediaOverlay().then(({EncyclopediaOverlay:t})=>{const s=new t;return this.encyclopediaOverlay=s,s}).finally(()=>{this.encyclopediaOverlayPromise=null}),this.encyclopediaOverlayPromise)}getTitleCompanionFactory(){return this.companionFactory?Promise.resolve(this.companionFactory):this.companionFactoryPromise?this.companionFactoryPromise:(this.companionFactoryPromise=this.loadTitleCompanionFactory().then(t=>(this.companionFactory=t,t)).finally(()=>{this.companionFactoryPromise=null}),this.companionFactoryPromise)}showEncyclopedia(){if(!this.isActive||!this.encyclopediaOverlay)return;const t=this.saveManager.load();this.encyclopediaOverlay.show(t.unlockedPlanets,()=>this.refreshEncyclopediaButtonLabel(),s=>{this.ensureTitleAudioInitialized(!1),this.sceneManager.requestTransition("stage",{stageNumber:s,totalScore:0,totalStarCount:0,launchSource:"encyclopedia"})},t.bestStageStars??{})}isCurrentEncyclopediaRequest(t){return this.isActive&&this.encyclopediaRequestToken===t}prefetchEncyclopediaOnIdle(){const t=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{!this.isCurrentEncyclopediaRequest(t)||this.encyclopediaOverlay||this.encyclopediaOverlayPromise||this.getEncyclopediaOverlay().catch(()=>{})})}prewarmNextAdventureOnIdle(t){if(t>D)return;const s=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{this.isCurrentEncyclopediaRequest(s)&&vt(t)})}async openEncyclopedia(){if(!this.isActive)return;if(this.loadFailureOverlay.hide(),this.encyclopediaOverlay){this.showEncyclopedia();return}if(this.isOpeningEncyclopedia)return;const t=this.encyclopediaRequestToken;this.isOpeningEncyclopedia=!0,this.loadingOverlay.show("ずかんを よんでるよ...");try{if(await this.getEncyclopediaOverlay(),!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),this.showEncyclopedia()}catch(s){if(!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),console.error("Failed to load encyclopedia overlay",s),this.loadFailureOverlay.show({title:"ずかんの じゅんびが できなかったよ",message:"「もういちど よむ」を おしてね",primaryAction:{label:"もういちど よむ",onSelect:()=>this.openEncyclopedia()}})}finally{this.encyclopediaRequestToken===t&&(this.isOpeningEncyclopedia=!1)}}persistHighContrastSetting(t){const s=this.saveManager.load();t?s.colorAccessibility={highContrast:!0}:delete s.colorAccessibility,this.saveManager.save(s)}createOverlay(){const t=document.getElementById("ui-overlay");if(!t)return;const s=this.saveManager.load(),e=at(s);this.overlay=document.createElement("div"),this.overlay.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      justify-content: center;
    ...
    `;const u=document.createElement("div");u.textContent=e.destinationLabel,u.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${i?"0.85rem":"1rem"};
      font-weight: 700;
      color: rgba(255, 255, 255, 0.92);
    `;const p=At(e.startStage,e.bestStars),f=lt(e.startStage,e.bestStars,{label:"メダル",hint:p.nextThreshold===null?"かんぺき！":`${p.icon} いま ・ つぎ ⭐ ${p.nextThreshold}`,size:"regular",scope:"title-next-adventure"});f.style.marginTop="0.7rem",o.appendChild(n),o.appendChild(h),o.appendChild(l),o.appendChild(u),o.appendChild(f);const d=document.createElement("div");d.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      gap: 0.65rem;
    ...
    `;const E=document.createElement("button");E.setAttribute("data-spaceship-customizer-button",""),E.textContent="うちゅうせんをかざろう",E.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(T(E,{onActivate:()=>{const b=this.saveManager.load();this.spaceshipCustomizer.show({initialCustomization:b.spaceshipCustomization??ht,onComplete:A=>{const y=this.saveManager.load();y.spaceshipCustomization=A,this.saveManager.save(y)}})},onPressChange:b=>{E.style.transform=b?"scale(0.96)":"scale(1)"}}));const v=document.createElement("button");v.setAttribute("data-stats-button",""),v.textContent="あそびの きろく",v.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
    ...
    `,this.overlayButtonCleanups.add(T(w,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.colorAccessibilitySettings.show({initialHighContrast:this.saveManager.load().colorAccessibility?.highContrast===!0,onToggle:b=>this.persistHighContrastSetting(b)})},onPressChange:b=>{w.style.transform=b?"translateX(-50%) scale(0.96)":"translateX(-50%) scale(1)"}}));const S=document.createElement("button");if(S.textContent=Et(s.unlockedPlanets.length,N.length),S.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,S.style.position="absolute",S.style.bottom=i?"1rem":"2rem",S.style.left=i?"1rem":"2rem",this.encyclopediaBtn=S,this.overlayButtonCleanups.add(T(S,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.openEncyclopedia()},onPressChange:b=>{S.style.transform=b?"scale(0.96)":"scale(1)"}})),d.appendChild(c),d.appendChild(m),d.appendChild(E),d.appendChild(v),Se(s)){const b=document.createElement("button");b.setAttribute("data-reset-progress-button",""),b.textContent="さいしょから",b.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: 1.15rem;
        font-weight: 900;
      ...
      pointer-events: auto;
      z-index: 60;
    `,this.overlayEl.style.background="rgba(0, 0, 32, 0.92)";let i=!1;const a=()=>{i||(i=!0,this.hide(),s())},o=()=>{i||(i=!0,this.hide(),t())};this.overlayEl.addEventListener("pointerdown",c=>{c.target===this.overlayEl&&a()});const n=document.createElement("div");n.setAttribute("data-home-confirm-card",""),n.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
    ...
    `,n.addEventListener("pointerdown",c=>{c.stopPropagation()}),this.overlayEl.appendChild(n);const h=document.createElement("div");h.textContent="タイトルへ もどる？",h.style.cssText=`
      font-size: 1.8rem;
      font-weight: 900;
      text-shadow: 0 0 15px rgba(255, 215, 0, 0.5);
      margin-bottom: 1.2rem;
    ...
    `,n.appendChild(l);const u=`
      ...
      transition: transform 0.08s ease-out;
      white-space: nowrap;
    `,p=(c,m)=>{const E=T(c,{onActivate:m,onPressChange:v=>{c.style.transform=v?"scale(0.9)":"scale(1)"}});this.activePressCleanups.add(E)},f=document.createElement("button");f.setAttribute("data-home-confirm-back",""),f.setAttribute("aria-label","タイトルへ もどる"),f.textContent="🏠 タイトルへ もどる",f.style.cssText=u,f.style.fontFamily="'Zen Maru Gothic', sans-serif",f.style.background="rgba(255, 255, 255, 0.18)",f.style.color="#ffffff",f.style.minWidth="88px",f.style.minHeight="88px",f.style.touchAction="manipulation",f.style.transform="scale(1)",f.style.transition="transform 0.08s ease-out",f.style.whiteSpace="nowrap",p(f,o),l.appendChild(f);const d=document.createElement("button");d.setAttribute("data-home-confirm-continue",""),d.setAttribute("aria-label","つづける"),d.textContent="✋ つづける",d.style.cssText=u,d.style.fontFamily="'Zen Maru Gothic', sans-serif",d.style.background="linear-gradient(135deg, #FF6B6B, #FFE66D)",d.style.color="#FFD700",d.style.textShadow="0 1px 2px rgba(0, 0, 32, 0.6)",d.style.minWidth="88px",d.style.minHeight="88px",d.style.touchAction="manipulation",d.style.transform="scale(1)",d.style.transition="transform 0.08s ease-out",d.style.whiteSpace="nowrap",p(d,a),l.appendChild(d),e.appendChild(this.overlayEl)}hide(){if(this.overlayEl){const t=Array.from(this.activePressCleanups);this.activePressCleanups.clear();for(const s of t)s();this.overlayEl.remove(),this.overlayEl=null}}isVisible(){return this.overlayEl!==null}}class Ot{overlayEl=null;activePressCleanups=new Set;show(t,s){if(this.overlayEl)return;const e=document.getElementById("ui-overlay")??document.body;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-pause-overlay",""),this.overlayEl.setAttribute("role","dialog"),this.overlayEl.setAttribute("aria-modal","true"),this.overlayEl.setAttribute("aria-label","やすみちゅう"),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
    ...
    `,i.appendChild(o);const n=document.createElement("div");n.style.cssText=`
      ...
      align-items: stretch;
      width: 100%;
    `,i.appendChild(n);const h=(l,u,p,f,d,c)=>{const m=document.createElement("button");m.setAttribute(u,""),m.setAttribute("aria-label",p),m.textContent=l,m.style.cssText=`
        flex: 1 1 140px;
        padding: 1rem 1.2rem;
        border: none;
        border-radius: 1.6rem;
    ...
    `,document.head.appendChild(t)}}const Be=1,Pe=.4;class wt{overlayEl=null;numberEl=null;phase="idle";elapsed=0;currentStep=0;stepDuration;goDuration;onTick;onGo;onComplete=null;steps=["3","2","1"];constructor(t={}){this.stepDuration=t.stepDuration??Be,this.goDuration=t.goDuration??Pe,this.onTick=t.onTick,this.onGo=t.onGo}show(t){if(this.phase!=="idle"&&this.phase!=="done")return;const s=document.getElementById("ui-overlay")??document.body;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-countdown-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
