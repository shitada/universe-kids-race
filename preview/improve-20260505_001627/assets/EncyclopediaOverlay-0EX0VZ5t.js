import{U as k,V as z,W as N,P as F,d as G,X as O,F as Z}from"./game-core-CBsEIeRx.js";import{y as j,P as B,x as V,z as W}from"./three-B3e-47pp.js";import{a as w,c as L}from"./game-scenes-Bpye0CGD.js";const P=120,X=1.5,H=.015;function Y(y={}){const t=y.createRenderer??k,d=y.createPreviewMesh??z,e=y.raf??requestAnimationFrame,n=y.caf??cancelAnimationFrame;let l=!1,s=!1,i=null,r=null,a=null,o=null,c=null,m=null,f=null,p=null,g=!1;const b=()=>i||(i=document.createElement("canvas"),i.setAttribute("data-companion-preview-canvas",""),i.style.cssText=`
      width: 100%;
      height: 100%;
      display: block;
    ...
    `;for(const m of F){const f=t.includes(m.stageNumber),p=this.createCard(m,f,i);o.appendChild(p)}r.appendChild(o),r.appendChild(this.createConstellationSection(i));const c=document.createElement("button");c.setAttribute("data-gallery-back",""),c.textContent="もどる",c.style.cssText=`
    ...
    `,d.appendChild(e);const n=document.createElement("div");n.style.cssText=`
      ...
      gap: ${t?"0.6rem":"0.8rem"};
      width: 100%;
    `;for(const l of O){const s=this.discoveredConstellations.includes(l.stageNumber),i=document.createElement("div");i.setAttribute("data-constellation-card",""),i.setAttribute("data-stage",String(l.stageNumber)),i.style.cssText=`
