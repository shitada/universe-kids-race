const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-i1AWWH7r.js","assets/game-core-DW7ZLLOz.js","assets/three-Cuq8LVCd.js"])))=>i.map(i=>d[i]);
import{g as xt,T as I,a as ot,L as Ot,b as Rt,_ as at,c as L,d as X,P as N,u as It,C as kt,S as Dt,e as Ht,B as Lt,f as _t,h as Gt,i as Ft,A as Nt,j as St,k as zt,l as $t,m as tt,t as et,n as jt,s as Ut,o as qt}from"./game-core-DW7ZLLOz.js";import{l as rt,j as lt,h as ht,k as ct,G as V,n as Yt,M as Zt,o as Xt,a as w,m as P,D as yt,R as bt,p as O,q as ut,r as W,g as dt,P as mt,V as wt,s as Vt}from"./three-Cuq8LVCd.js";class pt{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const e=document.getElementById("ui-overlay");if(!e)return;const s=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
    ...
    `,o.appendChild(n),o.appendChild(h),o.appendChild(l),o}isCompactHeight(){return window.innerHeight<=pt.COMPACT_HEIGHT_THRESHOLD}injectAnimations(){if(document.getElementById("tutorial-animations"))return;const t=document.createElement("style");t.id="tutorial-animations",t.textContent=`
      @keyframes swipe {
  ...
  `,o.appendChild(l),o}const Et=2e3,Q=new Map,K=new Map,J=new Map;let q=null,Y=null;function Z(r,t){if(typeof document>"u"){const s=typeof OffscreenCanvas=="function",i=s?new OffscreenCanvas(r,t):{width:r,height:t};return{canvas:i,ctx:s?i.getContext("2d"):null}}const e=document.createElement("canvas");return e.width=r,e.height=t,{canvas:e,ctx:e.getContext("2d")}}function F(r,t){let e=Q.get(r);return e||(e=t(),e.generateMipmaps=!1,e.minFilter=Xt,e.needsUpdate=!0,Q.set(r,e)),e}function A(r,t){let e=K.get(r);return e||(e=t(),K.set(r,e)),e}function T(r,t){let e=J.get(r);return e||(e=t(),J.set(r,e)),e}function M(r,t){const e=new Zt(r,t);return e.userData.sharedAssets=!0,e}function At(){if(!q){const r=new lt,t=new Float32Array(Et*3);for(let e=0;e<Et*3;e+=3)t[e]=(Math.random()-.5)*200,t[e+1]=(Math.random()-.5)*200,t[e+2]=(Math.random()-.5)*400;r.setAttribute("position",new ht(t,3)),q=r}Y||(Y=new ct({color:16777215,size:.2,sizeAttenuation:!0}))}function Jt(){const{canvas:r,ctx:t}=Z(256,256);if(!t)return new O(r);t.fillStyle="#888888",t.fillRect(0,0,256,256);for(let e=0;e<30;e++){const s=Math.random()*256,i=Math.random()*256,a=3+Math.random()*12;t.beginPath(),t.arc(s,i,a,0,Math.PI*2),t.fillStyle=`rgba(60,60,60,${.3+Math.random()*.4})`,t.fill()}return new O(r)}function te(){const{canvas:r,ctx:t}=Z(256,256);if(!t)return new O(r);t.fillStyle="#ddaa44",t.fillRect(0,0,256,256);for(let e=0;e<8;e++){t.beginPath();const s=128+(Math.random()-.5)*100,i=128+(Math.random()-.5)*100;t.strokeStyle=`rgba(200,150,60,${.3+Math.random()*.3})`,t.lineWidth=3+Math.random()*5;for(let a=0;a<Math.PI*4;a+=.1){const o=10+a*8;t.lineTo(s+Math.cos(a)*o,i+Math.sin(a)*o)}t.stroke()}return new O(r)}function ee(){const{canvas:r,ctx:t}=Z(256,256);if(!t)return new O(r);const e=["#cc7733","#dd9955","#bb6622","#eebb77","#aa5511","#ddaa66"];for(let s=0;s<256;s++){const i=Math.floor(s/(256/e.length))%e.length;t.fillStyle=e[i],t.fillRect(0,s,256,1)}return new O(r)}function se(){const{canvas:r,ctx:t}=Z(512,256);return t?(t.fillStyle="#2266aa",t.fillRect(0,0,512,256),t.fillStyle="#886644",t.beginPath(),t.ellipse(300,80,80,40,.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(280,150,30,50,.1,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(100,90,25,60,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(110,170,20,40,-.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(420,170,25,15,0,0,Math.PI*2),t.fill(),t.fillStyle="#447733",t.beginPath(),t.ellipse(290,75,40,20,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(95,85,15,30,.2,0,Math.PI*2),t.fill(),new O(r)):new O(r)}function ie(){const{canvas:r,ctx:t}=Z(512,256);if(!t)return new O(r);t.clearRect(0,0,512,256),t.fillStyle="rgba(255,255,255,0.6)";for(let e=0;e<20;e++){const s=Math.random()*512,i=Math.random()*256;t.beginPath(),t.ellipse(s,i,20+Math.random()*40,8+Math.random()*15,Math.random()*Math.PI,0,Math.PI*2),t.fill()}return new O(r)}function ae(){Q.clear(),K.clear(),J.clear(),q=null,Y=null}const ne={planetTextureCache:Q,planetGeometryCache:K,planetMaterialCache:J,getBgStarsGeometry:()=>q,getBgStarsMaterial:()=>Y};function Tt(r,t,e){const s=new V;let i=null;switch(r){case 2:{const a=F("mercury",Jt),o=A("mercury:sphere",()=>new P(10,24,24)),n=T("mercury:mat",()=>new w({map:a})),h=M(o,n);s.add(h),i=h;break}case 3:{const a=F("venus",te),o=A("venus:sphere",()=>new P(14,24,24)),n=T("venus:mat",()=>new w({map:a})),h=M(o,n);s.add(h),i=h;break}case 5:{const a=F("jupiter",ee),o=A("jupiter:sphere",()=>new P(20,24,24)),n=T("jupiter:mat",()=>new w({map:a})),h=M(o,n);s.add(h),i=h;break}case 6:{const a=A("saturn:sphere",()=>new P(15,24,24)),o=t.planetColor,n=T(`saturn:mat:${o}`,()=>new w({color:o})),h=M(a,n);s.add(h);const l=A("saturn:ring",()=>new bt(20,30,48)),c=T("saturn:ringMat",()=>new w({color:15645542,side:yt})),u=M(l,c);u.rotation.x=Math.PI/3,s.add(u),i=h;break}case 7:{const a=A("uranus:sphere",()=>new P(16,24,24)),o=T("uranus:mat",()=>new w({color:6737117})),n=M(a,o);s.add(n);const h=A("uranus:ring",()=>new bt(21,28,48)),l=T("uranus:ringMat",()=>new w({color:10083822,side:yt})),c=M(h,l);c.rotation.z=Math.PI/2,s.add(c),i=n;break}case 9:{const a=A("pluto:sphere",()=>new P(8,24,24)),o=T("pluto:mat",()=>new w({color:12298922})),n=M(a,o);s.add(n),i=n;break}case 10:{const a=A("sun:sphere",()=>new P(25,24,24)),o=T("sun:mat",()=>new w({color:16763904,emissive:16755200,emissiveIntensity:.5})),n=M(a,o);s.add(n),s.add(new Yt(16763904,2,200)),i=n;break}case 11:{const a=F("earth",se),o=A("earth:sphere",()=>new P(15,32,32)),n=T("earth:mat",()=>new w({map:a})),h=F("earth:cloud",ie),l=A("earth:cloudSphere",()=>new P(15.5,32,32)),c=T("earth:cloudMat",()=>new w({map:h,transparent:!0,opacity:.3})),u=new V;u.add(M(o,n)),u.add(M(l,c)),s.add(u),i=u;break}default:{const a=A("default:sphere",()=>new P(15,24,24)),o=t.planetColor,n=T(`default:mat:${o}`,()=>new w({color:o})),h=M(a,n);s.add(h),i=h;break}}return s.position.set(0,0,e),{planet:s,spinTarget:i}}function oe(r,t,e){return Tt(r,t,e)}function re(r){At();const t=new rt(q,Y);return t.userData.sharedAssets=!0,t.geometry.setDrawRange(0,r),t}function gt(r){!Number.isInteger(r)||r<1||r>I||typeof document>"u"&&typeof OffscreenCanvas!="function"||(At(),Tt(r,ot(r),0))}let z=null,$=null;function le(){if(!z){const r=new lt,t=new Float32Array(3e3);for(let e=0;e<3e3;e++)t[e]=(Math.random()-.5)*200;r.setAttribute("position",new ht(t,3)),z=r}return z}function he(){return $||($=new ct({color:16777215,size:.3,sizeAttenuation:!0})),$}function ce(){z=null,$=null}const ue={getBgStarsGeometry:()=>z,getBgStarsMaterial:()=>$};function de(r){const t=window.requestIdleCallback;if(typeof t=="function"){t(r,{timeout:1500});return}window.setTimeout(r,800)}function Mt(r){return new Set(r.filter(t=>Number.isInteger(t)&&t>=1&&t<=I)).size}function me(r){return Mt(r)>=I}function st(r){const t=me(r.unlockedPlanets),e=t?1:Math.min(r.clearedStage+1,I),s=ot(e),i=r.bestStageStars?.[e]??0;return t?{startStage:e,destination:s.destinationReading,emoji:s.emoji,statusLabel:"ぜんぶ あつめたよ！",destinationLabel:`${s.destinationReading}へ もういちど しゅっぱつ！`,buttonHint:`${s.emoji} ステージ ${e} から もういちど あそぶ`,bestStars:i}:{startStage:e,destination:s.destinationReading,emoji:s.emoji,statusLabel:r.clearedStage>0?"つづきから しゅっぱつ！":"はじめての しゅっぱつ！",destinationLabel:`${s.destinationReading}へ むかおう！`,buttonHint:`${s.emoji} ステージ ${e} から スタート`,bestStars:i}}function pe(r){return r.clearedStage>0||Mt(r.unlockedPlanets)>0||Object.keys(r.bestStageStars??{}).length>0}class fe{threeScene;ambientLight=new ut(16777215,1);camera;lastAspect=0;sceneManager;saveManager;audioManager;stars=null;companionParade=null;overlay=null;muteHandle=null;tutorialOverlay=new pt;titleResetConfirmOverlay=new Wt;colorAccessibilitySettings=new Qt;encyclopediaOverlay=null;encyclopediaOverlayPromise=null;companionFactory=null;companionFactoryPromise=null;loadEncyclopediaOverlay;loadTitleCompanionFactory;loadingOverlay;loadFailureOverlay;scheduleIdleTask;encyclopediaBtn=null;isOpeningEncyclopedia=!1;isActive=!1;encyclopediaRequestToken=0;companionParadeRequestToken=0;bgmPending=!1;overlayButtonCleanups=new Set;constructor(t,e,s,i={}){this.sceneManager=t,this.saveManager=e,this.audioManager=s,this.loadingOverlay=i.loadingOverlay??new Ot,this.loadFailureOverlay=i.loadFailureOverlay??new Rt,this.scheduleIdleTask=i.scheduleIdleTask??de,this.loadEncyclopediaOverlay=i.loadEncyclopediaOverlay??(()=>at(()=>import("./EncyclopediaOverlay-i1AWWH7r.js"),__vite__mapDeps([0,1,2]))),this.loadTitleCompanionFactory=i.loadTitleCompanionFactory??(()=>at(()=>import("./game-core-DW7ZLLOz.js").then(n=>n.x),__vite__mapDeps([1,2]))),this.threeScene=new W,this.threeScene.background=new dt(32);const{width:a,height:o}=L();this.camera=new mt(60,a/o,.1,1e3),this.camera.position.set(0,0,5)}enter(t){this.isActive=!0,this.encyclopediaRequestToken+=1,this.companionParadeRequestToken+=1,this.lastAspect=0,this.stars=new rt(le(),he()),this.stars.userData.sharedAssets=!0,this.stars.rotation.set(0,0,0),this.threeScene.add(this.stars),this.ambientLight.parent||this.threeScene.add(this.ambientLight);const e=this.saveManager.load();this.createCompanionParade(e.unlockedPlanets),this.createOverlay(),this.createMuteButton(),this.prefetchEncyclopediaOnIdle(),this.prewarmNextAdventureOnIdle(st(e).startStage),this.audioManager.isInitialized()?(this.audioManager.playBGM(0),this.bgmPending=!1):this.bgmPending=!0,e.tutorialShown||this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide(),this.saveManager.markTutorialShown()})}createMuteButton(){const t=document.getElementById("hud")??document.getElementById("ui-overlay");t&&(this.muteHandle=ft({initialMuted:this.audioManager.isMuted(),container:t,onToggle:()=>{this.ensureTitleAudioInitialized(!0);const e=this.audioManager.toggleMute();this.muteHandle?.setMuted(e);const s=this.saveManager.load();s.muted=e,this.saveManager.save(s)}}))}getEncyclopediaOverlay(){return this.encyclopediaOverlay?Promise.resolve(this.encyclopediaOverlay):this.encyclopediaOverlayPromise?this.encyclopediaOverlayPromise:(this.encyclopediaOverlayPromise=this.loadEncyclopediaOverlay().then(({EncyclopediaOverlay:t})=>{const e=new t;return this.encyclopediaOverlay=e,e}).finally(()=>{this.encyclopediaOverlayPromise=null}),this.encyclopediaOverlayPromise)}getTitleCompanionFactory(){return this.companionFactory?Promise.resolve(this.companionFactory):this.companionFactoryPromise?this.companionFactoryPromise:(this.companionFactoryPromise=this.loadTitleCompanionFactory().then(t=>(this.companionFactory=t,t)).finally(()=>{this.companionFactoryPromise=null}),this.companionFactoryPromise)}showEncyclopedia(){if(!this.isActive||!this.encyclopediaOverlay)return;const t=this.saveManager.load();this.encyclopediaOverlay.show(t.unlockedPlanets,()=>this.refreshEncyclopediaButtonLabel(),e=>{this.ensureTitleAudioInitialized(!1),this.sceneManager.requestTransition("stage",{stageNumber:e,totalScore:0,totalStarCount:0,launchSource:"encyclopedia"})},t.bestStageStars??{})}isCurrentEncyclopediaRequest(t){return this.isActive&&this.encyclopediaRequestToken===t}prefetchEncyclopediaOnIdle(){const t=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{!this.isCurrentEncyclopediaRequest(t)||this.encyclopediaOverlay||this.encyclopediaOverlayPromise||this.getEncyclopediaOverlay().catch(()=>{})})}prewarmNextAdventureOnIdle(t){if(t>I)return;const e=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{this.isCurrentEncyclopediaRequest(e)&&gt(t)})}async openEncyclopedia(){if(!this.isActive)return;if(this.loadFailureOverlay.hide(),this.encyclopediaOverlay){this.showEncyclopedia();return}if(this.isOpeningEncyclopedia)return;const t=this.encyclopediaRequestToken;this.isOpeningEncyclopedia=!0,this.loadingOverlay.show("ずかんを よんでるよ...");try{if(await this.getEncyclopediaOverlay(),!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),this.showEncyclopedia()}catch(e){if(!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),console.error("Failed to load encyclopedia overlay",e),this.loadFailureOverlay.show({title:"ずかんの じゅんびが できなかったよ",message:"「もういちど よむ」を おしてね",primaryAction:{label:"もういちど よむ",onSelect:()=>this.openEncyclopedia()}})}finally{this.encyclopediaRequestToken===t&&(this.isOpeningEncyclopedia=!1)}}persistHighContrastSetting(t){const e=this.saveManager.load();t?e.colorAccessibility={highContrast:!0}:delete e.colorAccessibility,this.saveManager.save(e)}createOverlay(){const t=document.getElementById("ui-overlay");if(!t)return;const e=this.saveManager.load(),s=st(e);this.overlay=document.createElement("div"),this.overlay.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      justify-content: center;
    ...
    `,this.overlayButtonCleanups.add(k(E,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.colorAccessibilitySettings.show({initialHighContrast:this.saveManager.load().colorAccessibility?.highContrast===!0,onToggle:b=>this.persistHighContrastSetting(b)})},onPressChange:b=>{E.style.transform=b?"translateX(-50%) scale(0.96)":"translateX(-50%) scale(1)"}}));const x=document.createElement("button");if(x.textContent=vt(e.unlockedPlanets.length,N.length),x.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,x.style.position="absolute",x.style.bottom=i?"1rem":"2rem",x.style.left=i?"1rem":"2rem",this.encyclopediaBtn=x,this.overlayButtonCleanups.add(k(x,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.openEncyclopedia()},onPressChange:b=>{x.style.transform=b?"scale(0.96)":"scale(1)"}})),m.appendChild(f),m.appendChild(p),pe(e)){const b=document.createElement("button");b.setAttribute("data-reset-progress-button",""),b.textContent="さいしょから",b.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: 1.15rem;
        font-weight: 900;
