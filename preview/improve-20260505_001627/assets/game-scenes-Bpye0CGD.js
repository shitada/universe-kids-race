const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-0EX0VZ5t.js","assets/game-core-CBsEIeRx.js","assets/three-B3e-47pp.js"])))=>i.map(i=>d[i]);
import{D as ut,S as G,T as D,g as it,a as Pt,L as zt,b as Gt,_ as ht,c as z,s as Ot,d as W,P as N,u as Ft,C as _t,e as Nt,f as $t,B as jt,h as Ut,M as Zt,i as qt,j as Yt,k as Xt,l as Vt,m as Wt,n as Qt,o as Kt,A as Jt,p as te,q as ee,r as Rt,t as se,v as ie,R as ae,w as ne,x as oe,y as re,z as xt,E as le,F as he,G as at,H as V,I as ce,J as nt,K as de,N as ue,O as me}from"./game-core-CBsEIeRx.js";import{m as mt,k as pt,i as ft,l as gt,G as Q,v as pe,a as fe,r as ge,M as B,g as k,D as wt,t as At,w as H,x as yt,y as K,h as bt,P as vt,V as ct,z as ye,H as be}from"./three-B3e-47pp.js";class St{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const e=document.getElementById("ui-overlay");if(!e)return;const s=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
    ...
    `,n.appendChild(o),n.appendChild(h),n.appendChild(d),n}isCompactHeight(){return window.innerHeight<=St.COMPACT_HEIGHT_THRESHOLD}injectAnimations(){if(document.getElementById("tutorial-animations"))return;const t=document.createElement("style");t.id="tutorial-animations",t.textContent=`
      @keyframes swipe {
    ...
    `,l=(c,p)=>{let S=!1,C=!1;const w=()=>{A(!0)},x=()=>{c.style.transform="scale(0.92)"},v=()=>{c.style.transform="scale(1)"},A=(M=!1)=>{S=!1,C=M,v(),this.activePressCleanups.delete(w),document.removeEventListener("pointerup",b,!0),document.removeEventListener("pointercancel",E,!0)},b=M=>{const F=M.target===c||M.target instanceof Node&&c.contains(M.target),Lt=S&&F;A(!F),Lt&&p()},E=()=>{A(!0)};c.addEventListener("pointerdown",M=>{M.stopPropagation(),S=!0,C=!1,x(),this.activePressCleanups.add(w),document.addEventListener("pointerup",b,!0),document.addEventListener("pointercancel",E,!0)}),c.addEventListener("pointerenter",()=>{S&&x()}),c.addEventListener("pointerleave",()=>{S&&v()}),c.addEventListener("pointercancel",()=>A(!0)),c.addEventListener("click",M=>{if(M.stopPropagation(),C){C=!1;return}S||p()})},f=document.createElement("button");f.setAttribute("data-title-reset-cancel",""),f.textContent="やめる",f.style.cssText=m,f.style.background="rgba(255, 255, 255, 0.18)",f.style.color="#ffffff",l(f,a),u.appendChild(f);const g=document.createElement("button");g.setAttribute("data-title-reset-confirm",""),g.textContent="うん！ さいしょから",g.style.cssText=m,g.style.background="linear-gradient(135deg, #FF9F68, #FFE66D)",g.style.color="#3b1f00",l(g,n),u.appendChild(g),s.appendChild(this.overlayEl)}hide(){if(!this.overlayEl)return;const t=Array.from(this.activePressCleanups);this.activePressCleanups.clear();for(const e of t)e();this.overlayEl.remove(),this.overlayEl=null}}function Ct(r){const t=r.topRem??.8,e=window.innerHeight<=500,s=document.createElement("button");let i=r.initialMuted;const a=()=>{s.textContent=i?"🔇":"🔊",s.setAttribute("aria-label",i?"サウンド オフ":"サウンド オン")};s.setAttribute("data-mute-button",""),s.style.position="absolute",s.style.top=`${t}rem`,s.style.right="1rem",s.style.fontSize=e?"clamp(1.1rem, 3.5vmin, 1.4rem)":"clamp(1.4rem, 4vmin, 1.8rem)",s.style.background="rgba(255, 255, 255, 0.15)",s.style.border="none",s.style.borderRadius="50%",s.style.width=e?"2.4rem":"3rem",s.style.height=e?"2.4rem":"3rem",s.style.display="flex",s.style.alignItems="center",s.style.justifyContent="center",s.style.cursor="pointer",s.style.pointerEvents="auto",s.style.touchAction="manipulation",s.style.transform="scale(1)",s.style.transition="transform 0.08s ease-out",a();const n=()=>{s.style.transform="scale(1)"};return s.addEventListener("pointerdown",o=>{o.stopPropagation(),s.style.transform="scale(0.9)",r.onToggle()}),s.addEventListener("pointerup",n),s.addEventListener("pointercancel",n),s.addEventListener("pointerleave",n),r.container.appendChild(s),{element:s,setMuted(o){i=o,a()},remove(){s.remove()}}}class Se{overlay=null;toggleButton=null;descriptionEl=null;highContrast=!1;vibrationIntensity="medium";vibrationDescriptionEl=null;vibrationButtons=new Map;show(t){const e=document.getElementById("ui-overlay");if(e){if(this.highContrast=t.initialHighContrast,this.vibrationIntensity=t.initialVibrationIntensity,!this.overlay){this.overlay=document.createElement("div"),this.overlay.setAttribute("data-color-accessibility-settings",""),this.overlay.style.cssText=`
      ...
      `;const o=[{value:"strong",label:"つよい"},{value:"medium",label:"ふつう"},{value:"weak",label:"やさしい"},{value:"off",label:"オフ"}];for(const d of o){const u=document.createElement("button");u.setAttribute("data-vibration-intensity-button",d.value),u.textContent=d.label,u.style.cssText=`
        ...
        `,u.addEventListener("click",()=>{this.vibrationIntensity=d.value,this.render(),t.onVibrationIntensityChange(d.value)}),this.vibrationButtons.set(d.value,u),n.appendChild(u)}const h=document.createElement("button");h.textContent="とじる",h.style.cssText=`
        width: 100%;
        padding: 0.8rem 1rem;
        border-radius: 999px;
    ...
    `,u.appendChild(m);const l=document.createElement("div");l.setAttribute("data-stats-stage-clears",""),l.style.cssText=`
      ...
      gap: 0.45rem;
      text-align: left;
    `;const f=Array.from({length:D},(c,p)=>p+1).map(c=>({stageNumber:c,clearCount:i.stageClearCounts[c]??0})).filter(c=>c.clearCount>0);if(f.length===0){const c=document.createElement("div");c.textContent="まだ きろくが ないよ",c.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: ${a?"1rem":"1.1rem"};
        font-weight: 700;
        text-align: center;
        color: rgba(255, 255, 255, 0.88);
      `,l.appendChild(c)}else for(const{stageNumber:c,clearCount:p}of f){const S=it(c),C=document.createElement("div");C.setAttribute("data-stats-stage-clear-row",String(c)),C.style.cssText=`
          display: flex;
          align-items: center;
          ...
          font-weight: 700;
        `;const w=document.createElement("span");w.textContent=`${S.emoji} ステージ ${c} ${S.destinationReading}`;const x=document.createElement("span");x.textContent=`${p}かい`,x.style.color="#FFE66D",C.append(w,x),l.appendChild(C)}u.appendChild(l),o.appendChild(u);const g=document.createElement("button");g.textContent="もどる",g.style.cssText=`
      margin-top: 1rem;
    ...
    `;const n=document.createElement("div");return n.textContent=e,n.style.cssText=`
      ...
      font-weight: 900;
      color: #FFE66D;
    `,i.append(a,n),i}}function Tt(r,t){if(!Number.isFinite(r)||r<=0||t<=0)return"ずかん";const e=Math.min(r,t);return e>=t?`ずかん ${t} / ${t} 🎉`:`ずかん ${e} / ${t}`}function Ae(r){switch(r){case"hero":return{gap:"0.35rem",label:"0.92rem",medal:"1.7rem",hint:"0.98rem"};case"compact":return{gap:"0.18rem",label:"0.7rem",medal:"1rem",hint:"0.76rem"};default:return{gap:"0.26rem",label:"0.8rem",medal:"1.25rem",hint:"0.84rem"}}}function dt(r,t,e={}){const s=Pt(r,t),i=e.size??"regular",a=Ae(i),n=document.createElement("div");if(n.setAttribute("data-stage-medal-display",""),n.setAttribute("data-stage-medal-stage",String(r)),n.setAttribute("data-stage-medal-tier",s.tier),n.setAttribute("data-stage-medal-earned",String(s.earnedCount)),e.scope&&n.setAttribute("data-stage-medal-scope",e.scope),n.style.cssText=`
    display: flex;
    flex-direction: column;
    align-items: center;
    gap: ${a.gap};
  ...
  `,n.appendChild(d),n}const Mt=2e3,J=new Map,tt=new Map,et=new Map;let q=null,Y=null;function X(r,t){if(typeof document>"u"){const s=typeof OffscreenCanvas=="function",i=s?new OffscreenCanvas(r,t):{width:r,height:t};return{canvas:i,ctx:s?i.getContext("2d"):null}}const e=document.createElement("canvas");return e.width=r,e.height=t,{canvas:e,ctx:e.getContext("2d")}}function _(r,t){let e=J.get(r);return e||(e=t(),e.generateMipmaps=!1,e.minFilter=ge,e.needsUpdate=!0,J.set(r,e)),e}function P(r,t){let e=tt.get(r);return e||(e=t(),tt.set(r,e)),e}function O(r,t){let e=et.get(r);return e||(e=t(),et.set(r,e)),e}function R(r,t){const e=new fe(r,t);return e.userData.sharedAssets=!0,e}function It(){if(!q){const r=new pt,t=new Float32Array(Mt*3);for(let e=0;e<Mt*3;e+=3)t[e]=(Math.random()-.5)*200,t[e+1]=(Math.random()-.5)*200,t[e+2]=(Math.random()-.5)*400;r.setAttribute("position",new ft(t,3)),q=r}Y||(Y=new gt({color:16777215,size:.2,sizeAttenuation:!0}))}function Te(){const{canvas:r,ctx:t}=X(256,256);if(!t)return new H(r);t.fillStyle="#888888",t.fillRect(0,0,256,256);for(let e=0;e<30;e++){const s=Math.random()*256,i=Math.random()*256,a=3+Math.random()*12;t.beginPath(),t.arc(s,i,a,0,Math.PI*2),t.fillStyle=`rgba(60,60,60,${.3+Math.random()*.4})`,t.fill()}return new H(r)}function Me(){const{canvas:r,ctx:t}=X(256,256);if(!t)return new H(r);t.fillStyle="#ddaa44",t.fillRect(0,0,256,256);for(let e=0;e<8;e++){t.beginPath();const s=128+(Math.random()-.5)*100,i=128+(Math.random()-.5)*100;t.strokeStyle=`rgba(200,150,60,${.3+Math.random()*.3})`,t.lineWidth=3+Math.random()*5;for(let a=0;a<Math.PI*4;a+=.1){const n=10+a*8;t.lineTo(s+Math.cos(a)*n,i+Math.sin(a)*n)}t.stroke()}return new H(r)}function Be(){const{canvas:r,ctx:t}=X(256,256);if(!t)return new H(r);const e=["#cc7733","#dd9955","#bb6622","#eebb77","#aa5511","#ddaa66"];for(let s=0;s<256;s++){const i=Math.floor(s/(256/e.length))%e.length;t.fillStyle=e[i],t.fillRect(0,s,256,1)}return new H(r)}function Pe(){const{canvas:r,ctx:t}=X(512,256);return t?(t.fillStyle="#2266aa",t.fillRect(0,0,512,256),t.fillStyle="#886644",t.beginPath(),t.ellipse(300,80,80,40,.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(280,150,30,50,.1,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(100,90,25,60,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(110,170,20,40,-.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(420,170,25,15,0,0,Math.PI*2),t.fill(),t.fillStyle="#447733",t.beginPath(),t.ellipse(290,75,40,20,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(95,85,15,30,.2,0,Math.PI*2),t.fill(),new H(r)):new H(r)}function Oe(){const{canvas:r,ctx:t}=X(512,256);if(!t)return new H(r);t.clearRect(0,0,512,256),t.fillStyle="rgba(255,255,255,0.6)";for(let e=0;e<20;e++){const s=Math.random()*512,i=Math.random()*256;t.beginPath(),t.ellipse(s,i,20+Math.random()*40,8+Math.random()*15,Math.random()*Math.PI,0,Math.PI*2),t.fill()}return new H(r)}function Re(){J.clear(),tt.clear(),et.clear(),q=null,Y=null}const Ie={planetTextureCache:J,planetGeometryCache:tt,planetMaterialCache:et,getBgStarsGeometry:()=>q,getBgStarsMaterial:()=>Y};function kt(r,t,e){const s=new Q;let i=null;switch(r){case 2:{const a=_("mercury",Te),n=P("mercury:sphere",()=>new k(10,24,24)),o=O("mercury:mat",()=>new B({map:a})),h=R(n,o);s.add(h),i=h;break}case 3:{const a=_("venus",Me),n=P("venus:sphere",()=>new k(14,24,24)),o=O("venus:mat",()=>new B({map:a})),h=R(n,o);s.add(h),i=h;break}case 5:{const a=_("jupiter",Be),n=P("jupiter:sphere",()=>new k(20,24,24)),o=O("jupiter:mat",()=>new B({map:a})),h=R(n,o);s.add(h),i=h;break}case 6:{const a=P("saturn:sphere",()=>new k(15,24,24)),n=t.planetColor,o=O(`saturn:mat:${n}`,()=>new B({color:n})),h=R(a,o);s.add(h);const d=P("saturn:ring",()=>new At(20,30,48)),u=O("saturn:ringMat",()=>new B({color:15645542,side:wt})),m=R(d,u);m.rotation.x=Math.PI/3,s.add(m),i=h;break}case 7:{const a=P("uranus:sphere",()=>new k(16,24,24)),n=O("uranus:mat",()=>new B({color:6737117})),o=R(a,n);s.add(o);const h=P("uranus:ring",()=>new At(21,28,48)),d=O("uranus:ringMat",()=>new B({color:10083822,side:wt})),u=R(h,d);u.rotation.z=Math.PI/2,s.add(u),i=o;break}case 9:{const a=P("pluto:sphere",()=>new k(8,24,24)),n=O("pluto:mat",()=>new B({color:12298922})),o=R(a,n);s.add(o),i=o;break}case 10:{const a=P("sun:sphere",()=>new k(25,24,24)),n=O("sun:mat",()=>new B({color:16763904,emissive:16755200,emissiveIntensity:.5})),o=R(a,n);s.add(o),s.add(new pe(16763904,2,200)),i=o;break}case 11:{const a=_("earth",Pe),n=P("earth:sphere",()=>new k(15,32,32)),o=O("earth:mat",()=>new B({map:a})),h=_("earth:cloud",Oe),d=P("earth:cloudSphere",()=>new k(15.5,32,32)),u=O("earth:cloudMat",()=>new B({map:h,transparent:!0,opacity:.3})),m=new Q;m.add(R(n,o)),m.add(R(d,u)),s.add(m),i=m;break}default:{const a=P("default:sphere",()=>new k(15,24,24)),n=t.planetColor,o=O(`default:mat:${n}`,()=>new B({color:n})),h=R(a,o);s.add(h),i=h;break}}return s.position.set(0,0,e),{planet:s,spinTarget:i}}function ke(r,t,e){return kt(r,t,e)}function De(r){It();const t=new mt(q,Y);return t.userData.sharedAssets=!0,t.geometry.setDrawRange(0,r),t}function Et(r){!Number.isInteger(r)||r<1||r>D||typeof document>"u"&&typeof OffscreenCanvas!="function"||(It(),kt(r,it(r),0))}let $=null,j=null;function He(){if(!$){const r=new pt,t=new Float32Array(3e3);for(let e=0;e<3e3;e++)t[e]=(Math.random()-.5)*200;r.setAttribute("position",new ft(t,3)),$=r}return $}function Le(){return j||(j=new gt({color:16777215,size:.3,sizeAttenuation:!0})),j}function ze(){$=null,j=null}const Ge={getBgStarsGeometry:()=>$,getBgStarsMaterial:()=>j};function Fe(r){const t=window.requestIdleCallback;if(typeof t=="function"){t(r,{timeout:1500});return}window.setTimeout(r,800)}function Dt(r){return new Set(r.filter(t=>Number.isInteger(t)&&t>=1&&t<=D)).size}function _e(r){return Dt(r)>=D}function ot(r){const t=_e(r.unlockedPlanets),e=t?1:Math.min(r.clearedStage+1,D),s=it(e),i=r.bestStageStars?.[e]??0;return t?{startStage:e,destination:s.destinationReading,emoji:s.emoji,statusLabel:"ぜんぶ あつめたよ！",destinationLabel:`${s.destinationReading}へ もういちど しゅっぱつ！`,buttonHint:`${s.emoji} ステージ ${e} から もういちど あそぶ`,bestStars:i}:{startStage:e,destination:s.destinationReading,emoji:s.emoji,statusLabel:r.clearedStage>0?"つづきから しゅっぱつ！":"はじめての しゅっぱつ！",destinationLabel:`${s.destinationReading}へ むかおう！`,buttonHint:`${s.emoji} ステージ ${e} から スタート`,bestStars:i}}function Ne(r){return r.clearedStage>0||Dt(r.unlockedPlanets)>0||Object.keys(r.bestStageStars??{}).length>0}class $e{threeScene;ambientLight=new yt(16777215,1);camera;lastAspect=0;sceneManager;saveManager;audioManager;stars=null;companionParade=null;overlay=null;muteHandle=null;tutorialOverlay=new St;titleResetConfirmOverlay=new ve;colorAccessibilitySettings=new Se;spaceshipCustomizer=new Ce;statsOverlay=new we;encyclopediaOverlay=null;encyclopediaOverlayPromise=null;companionFactory=null;companionFactoryPromise=null;loadEncyclopediaOverlay;loadTitleCompanionFactory;loadingOverlay;loadFailureOverlay;scheduleIdleTask;encyclopediaBtn=null;isOpeningEncyclopedia=!1;isActive=!1;encyclopediaRequestToken=0;companionParadeRequestToken=0;bgmPending=!1;overlayButtonCleanups=new Set;constructor(t,e,s,i={}){this.sceneManager=t,this.saveManager=e,this.audioManager=s,this.loadingOverlay=i.loadingOverlay??new zt,this.loadFailureOverlay=i.loadFailureOverlay??new Gt,this.scheduleIdleTask=i.scheduleIdleTask??Fe,this.loadEncyclopediaOverlay=i.loadEncyclopediaOverlay??(()=>ht(()=>import("./EncyclopediaOverlay-0EX0VZ5t.js"),__vite__mapDeps([0,1,2]))),this.loadTitleCompanionFactory=i.loadTitleCompanionFactory??(()=>ht(()=>import("./game-core-CBsEIeRx.js").then(o=>o.Z),__vite__mapDeps([1,2]))),this.threeScene=new K,this.threeScene.background=new bt(32);const{width:a,height:n}=z();this.camera=new vt(60,a/n,.1,1e3),this.camera.position.set(0,0,5)}enter(t){this.isActive=!0,this.encyclopediaRequestToken+=1,this.companionParadeRequestToken+=1,this.lastAspect=0,this.stars=new mt(He(),Le()),this.stars.userData.sharedAssets=!0,this.stars.rotation.set(0,0,0),this.threeScene.add(this.stars),this.ambientLight.parent||this.threeScene.add(this.ambientLight);const e=this.saveManager.load();this.createCompanionParade(e.unlockedPlanets),this.createOverlay(),this.createMuteButton(),this.prefetchEncyclopediaOnIdle(),this.prewarmNextAdventureOnIdle(ot(e).startStage),this.audioManager.isInitialized()?(this.audioManager.playBGM(0),this.bgmPending=!1):this.bgmPending=!0,e.tutorialShown||this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide(),this.saveManager.markTutorialShown()})}createMuteButton(){const t=document.getElementById("hud")??document.getElementById("ui-overlay");t&&(this.muteHandle=Ct({initialMuted:this.audioManager.isMuted(),container:t,onToggle:()=>{this.ensureTitleAudioInitialized(!0);const e=this.audioManager.toggleMute();this.muteHandle?.setMuted(e);const s=this.saveManager.load();s.muted=e,this.saveManager.save(s)}}))}getEncyclopediaOverlay(){return this.encyclopediaOverlay?Promise.resolve(this.encyclopediaOverlay):this.encyclopediaOverlayPromise?this.encyclopediaOverlayPromise:(this.encyclopediaOverlayPromise=this.loadEncyclopediaOverlay().then(({EncyclopediaOverlay:t})=>{const e=new t;return this.encyclopediaOverlay=e,e}).finally(()=>{this.encyclopediaOverlayPromise=null}),this.encyclopediaOverlayPromise)}getTitleCompanionFactory(){return this.companionFactory?Promise.resolve(this.companionFactory):this.companionFactoryPromise?this.companionFactoryPromise:(this.companionFactoryPromise=this.loadTitleCompanionFactory().then(t=>(this.companionFactory=t,t)).finally(()=>{this.companionFactoryPromise=null}),this.companionFactoryPromise)}showEncyclopedia(){if(!this.isActive||!this.encyclopediaOverlay)return;const t=this.saveManager.load();this.encyclopediaOverlay.show(t.unlockedPlanets,()=>this.refreshEncyclopediaButtonLabel(),e=>{this.ensureTitleAudioInitialized(!1),this.sceneManager.requestTransition("stage",{stageNumber:e,totalScore:0,totalStarCount:0,launchSource:"encyclopedia"})},t.bestStageStars??{},t.discoveredConstellations??[])}isCurrentEncyclopediaRequest(t){return this.isActive&&this.encyclopediaRequestToken===t}prefetchEncyclopediaOnIdle(){const t=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{!this.isCurrentEncyclopediaRequest(t)||this.encyclopediaOverlay||this.encyclopediaOverlayPromise||this.getEncyclopediaOverlay().catch(()=>{})})}prewarmNextAdventureOnIdle(t){if(t>D)return;const e=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{this.isCurrentEncyclopediaRequest(e)&&Et(t)})}async openEncyclopedia(){if(!this.isActive)return;if(this.loadFailureOverlay.hide(),this.encyclopediaOverlay){this.showEncyclopedia();return}if(this.isOpeningEncyclopedia)return;const t=this.encyclopediaRequestToken;this.isOpeningEncyclopedia=!0,this.loadingOverlay.show("ずかんを よんでるよ...");try{if(await this.getEncyclopediaOverlay(),!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),this.showEncyclopedia()}catch(e){if(!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),console.error("Failed to load encyclopedia overlay",e),this.loadFailureOverlay.show({title:"ずかんを もういちど よんでみよう！",message:"「もういちど よむ」を おして つづきを たのしもう！",primaryAction:{label:"もういちど よむ",onSelect:()=>this.openEncyclopedia()}})}finally{this.encyclopediaRequestToken===t&&(this.isOpeningEncyclopedia=!1)}}persistHighContrastSetting(t){const e=this.saveManager.load();t?e.colorAccessibility={highContrast:!0}:delete e.colorAccessibility,this.saveManager.save(e)}persistVibrationIntensitySetting(t){const e=this.saveManager.load();e.vibrationSettings={intensity:t},this.saveManager.save(e),Ot(t)}createOverlay(){const t=document.getElementById("ui-overlay");if(!t)return;const e=this.saveManager.load(),s=ot(e);this.overlay=document.createElement("div"),this.overlay.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      justify-content: center;
    ...
    `;const u=document.createElement("div");u.textContent=s.destinationLabel,u.style.cssText=`
      ...
      font-weight: 700;
      color: rgba(255, 255, 255, 0.92);
    `;const m=Pt(s.startStage,s.bestStars),l=dt(s.startStage,s.bestStars,{label:"メダル",hint:m.nextThreshold===null?"かんぺき！":`${m.icon} いま ・ つぎ ⭐ ${m.nextThreshold}`,size:"regular",scope:"title-next-adventure"});l.style.marginTop="0.7rem",n.appendChild(o),n.appendChild(h),n.appendChild(d),n.appendChild(u),n.appendChild(l);const f=document.createElement("div");f.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      gap: 0.65rem;
    ...
    `;const p=document.createElement("button");p.setAttribute("data-spaceship-customizer-button",""),p.textContent="うちゅうせんをかざろう",p.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(T(p,{onActivate:()=>{const v=this.saveManager.load();this.spaceshipCustomizer.show({initialCustomization:v.spaceshipCustomization??ut,onComplete:A=>{const b=this.saveManager.load();b.spaceshipCustomization=A,this.saveManager.save(b)}})},onPressChange:v=>{p.style.transform=v?"scale(0.96)":"scale(1)"}}));const S=document.createElement("button");S.setAttribute("data-stats-button",""),S.textContent="あそびの きろく",S.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(T(S,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.statsOverlay.show(this.saveManager.load().gameplayStats,()=>{})},onPressChange:v=>{S.style.transform=v?"scale(0.96)":"scale(1)"}}));const C=document.createElement("button");C.textContent="あそびかた",C.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,C.style.position="absolute",C.style.bottom=i?"1rem":"2rem",C.style.right=i?"1rem":"2rem",this.overlayButtonCleanups.add(T(C,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide()})},onPressChange:v=>{C.style.transform=v?"scale(0.96)":"scale(1)"}}));const w=document.createElement("button");w.setAttribute("data-color-settings-button",""),w.textContent="みやすさ・しんどう",w.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
    ...
    `,this.overlayButtonCleanups.add(T(w,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.colorAccessibilitySettings.show({initialHighContrast:this.saveManager.load().colorAccessibility?.highContrast===!0,initialVibrationIntensity:this.saveManager.load().vibrationSettings?.intensity??"medium",onToggle:v=>this.persistHighContrastSetting(v),onVibrationIntensityChange:v=>this.persistVibrationIntensitySetting(v)})},onPressChange:v=>{w.style.transform=v?"translateX(-50%) scale(0.96)":"translateX(-50%) scale(1)"}}));const x=document.createElement("button");if(x.textContent=Tt(e.unlockedPlanets.length,N.length),x.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,x.style.position="absolute",x.style.bottom=i?"1rem":"2rem",x.style.left=i?"1rem":"2rem",this.encyclopediaBtn=x,this.overlayButtonCleanups.add(T(x,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.openEncyclopedia()},onPressChange:v=>{x.style.transform=v?"scale(0.96)":"scale(1)"}})),f.appendChild(g),f.appendChild(c),f.appendChild(p),f.appendChild(S),Ne(e)){const v=document.createElement("button");v.setAttribute("data-reset-progress-button",""),v.textContent="さいしょから",v.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: 1.15rem;
        font-weight: 900;
    ...
    `,o.appendChild(d);const u=`
      ...
      transition: transform 0.08s ease-out;
      white-space: nowrap;
    `,m=(g,c)=>{const p=T(g,{onActivate:c,onPressChange:S=>{g.style.transform=S?"scale(0.9)":"scale(1)"}});this.activePressCleanups.add(p)},l=document.createElement("button");l.setAttribute("data-home-confirm-back",""),l.setAttribute("aria-label","タイトルへ もどる"),l.textContent="🏠 タイトルへ もどる",l.style.cssText=u,l.style.fontFamily="'Zen Maru Gothic', sans-serif",l.style.background="rgba(255, 255, 255, 0.18)",l.style.color="#ffffff",l.style.minWidth="88px",l.style.minHeight="88px",l.style.touchAction="manipulation",l.style.transform="scale(1)",l.style.transition="transform 0.08s ease-out",l.style.whiteSpace="nowrap",m(l,n),d.appendChild(l);const f=document.createElement("button");f.setAttribute("data-home-confirm-continue",""),f.setAttribute("aria-label","つづける"),f.textContent="✋ つづける",f.style.cssText=u,f.style.fontFamily="'Zen Maru Gothic', sans-serif",f.style.background="linear-gradient(135deg, #FF6B6B, #FFE66D)",f.style.color="#FFD700",f.style.textShadow="0 1px 2px rgba(0, 0, 32, 0.6)",f.style.minWidth="88px",f.style.minHeight="88px",f.style.touchAction="manipulation",f.style.transform="scale(1)",f.style.transition="transform 0.08s ease-out",f.style.whiteSpace="nowrap",m(f,a),d.appendChild(f),s.appendChild(this.overlayEl)}hide(){if(this.overlayEl){const t=Array.from(this.activePressCleanups);this.activePressCleanups.clear();for(const e of t)e();this.overlayEl.remove(),this.overlayEl=null}}isVisible(){return this.overlayEl!==null}}class Ht{overlayEl=null;activePressCleanups=new Set;show(t,e){if(this.overlayEl)return;const s=document.getElementById("ui-overlay")??document.body;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-pause-overlay",""),this.overlayEl.setAttribute("role","dialog"),this.overlayEl.setAttribute("aria-modal","true"),this.overlayEl.setAttribute("aria-label","やすみちゅう"),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
    ...
    `,i.appendChild(n);const o=document.createElement("div");o.style.cssText=`
      ...
      align-items: stretch;
      width: 100%;
    `,i.appendChild(o);const h=(d,u,m,l,f,g)=>{const c=document.createElement("button");c.setAttribute(u,""),c.setAttribute("aria-label",m),c.textContent=d,c.style.cssText=`
        flex: 1 1 140px;
        padding: 1rem 1.2rem;
        border: none;
        border-radius: 1.6rem;
    ...
    `,document.head.appendChild(t)}}const qe=1,Ye=.4;class Bt{overlayEl=null;numberEl=null;phase="idle";elapsed=0;currentStep=0;stepDuration;goDuration;onTick;onGo;onComplete=null;steps=["3","2","1"];constructor(t={}){this.stepDuration=t.stepDuration??qe,this.goDuration=t.goDuration??Ye,this.onTick=t.onTick,this.onGo=t.onGo}show(t){if(this.phase!=="idle"&&this.phase!=="done")return;const e=document.getElementById("ui-overlay")??document.body;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-countdown-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
