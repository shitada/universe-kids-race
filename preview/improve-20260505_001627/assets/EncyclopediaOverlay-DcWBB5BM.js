import{a1 as k,a2 as z,a3 as N,P as O,f as G,a4 as F,O as Z}from"./game-core-BJMu1i9k.js";import{y as j,P as B,x as V,z as W}from"./three-B3e-47pp.js";import{a as w,c as L}from"./game-scenes-DtIF7X6e.js";const P=120,H=1.5,X=.015;function Y(y={}){const t=y.createRenderer??k,d=y.createPreviewMesh??z,e=y.raf??requestAnimationFrame,n=y.caf??cancelAnimationFrame;let l=!1,s=!1,i=null,a=null,r=null,o=null,c=null,m=null,f=null,p=null,g=!1;const b=()=>i||(i=document.createElement("canvas"),i.setAttribute("data-companion-preview-canvas",""),i.style.cssText=`
      width: 100%;
      height: 100%;
      display: block;
    ...
    `;for(const m of O){const f=t.includes(m.stageNumber),p=this.createCard(m,f,i);o.appendChild(p)}a.appendChild(o),a.appendChild(this.createConstellationSection(i));const c=document.createElement("button");c.setAttribute("data-gallery-back",""),c.textContent="もどる",c.style.cssText=`
