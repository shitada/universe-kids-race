const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-BUAzbyW7.js","assets/game-core-WubKRDTh.js","assets/three-B3e-47pp.js"])))=>i.map(i=>d[i]);
import{g as Q,D as ft,S as G,T as D,a as ot,b as Rt,L as $t,c as jt,_ as mt,d as L,e as F,s as Dt,f as J,P as j,u as Ht,C as Ut,h as Zt,i as qt,B as Yt,j as Vt,M as Xt,k as Wt,l as Qt,m as Kt,n as Jt,o as te,p as ee,q as se,r as ie,A as ae,t as ne,v as oe,w as re,x as Lt,y as le,z as he,R as ce,E as de,F as ue,G as me,H as Tt,I as pe,J as fe,K as rt,N as K,O as ge,Q as lt,U as ht,V as ye,W as be,X as ve}from"./game-core-WubKRDTh.js";import{m as gt,k as yt,i as bt,l as vt,G as tt,v as Ee,a as Se,r as Ce,M as P,g as R,D as Mt,t as Pt,w as H,x as Et,y as et,h as St,P as Ct,V as $,z as xe,H as we}from"./three-B3e-47pp.js";class xt{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const e=document.getElementById("ui-overlay");if(!e)return;const s=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
    ...
    `,o.appendChild(u);const p=`
      ...
      white-space: nowrap;
    `,l=(c,m)=>{let E=!1,S=!1;const w=()=>{A(!0)},C=()=>{c.style.transform="scale(0.92)"},b=()=>{c.style.transform="scale(1)"},A=(M=!1)=>{E=!1,S=M,b(),this.activePressCleanups.delete(w),document.removeEventListener("pointerup",v,!0),document.removeEventListener("pointercancel",x,!0)},v=M=>{const N=M.target===c||M.target instanceof Node&&c.contains(M.target),_t=E&&N;A(!N),_t&&m()},x=()=>{A(!0)};c.addEventListener("pointerdown",M=>{M.stopPropagation(),E=!0,S=!1,C(),this.activePressCleanups.add(w),document.addEventListener("pointerup",v,!0),document.addEventListener("pointercancel",x,!0)}),c.addEventListener("pointerenter",()=>{E&&C()}),c.addEventListener("pointerleave",()=>{E&&b()}),c.addEventListener("pointercancel",()=>A(!0)),c.addEventListener("click",M=>{if(M.stopPropagation(),S){S=!1;return}E||m()})},f=document.createElement("button");f.setAttribute("data-title-reset-cancel",""),f.textContent="やめる",f.style.cssText=p,f.style.background="rgba(255, 255, 255, 0.18)",f.style.color="#ffffff",l(f,a),u.appendChild(f);const g=document.createElement("button");g.setAttribute("data-title-reset-confirm",""),g.textContent="うん！ さいしょから",g.style.cssText=p,g.style.background="linear-gradient(135deg, #FF9F68, #FFE66D)",g.style.color="#3b1f00",l(g,n),u.appendChild(g),s.appendChild(this.overlayEl)}hide(){if(!this.overlayEl)return;const t=Array.from(this.activePressCleanups);this.activePressCleanups.clear();for(const e of t)e();this.overlayEl.remove(),this.overlayEl=null}}function wt(r){const t=r.topRem??.8,e=window.innerHeight<=500,s=document.createElement("button");let i=r.initialMuted;const a=()=>{s.textContent=i?"🔇":"🔊",s.setAttribute("aria-label",i?"サウンド オフ":"サウンド オン")};s.setAttribute("data-mute-button",""),s.style.position="absolute",s.style.top=`${t}rem`,s.style.right="1rem",s.style.fontSize=e?"clamp(1.1rem, 3.5vmin, 1.4rem)":"clamp(1.4rem, 4vmin, 1.8rem)",s.style.background="rgba(255, 255, 255, 0.15)",s.style.border="none",s.style.borderRadius="50%",s.style.width=e?"2.4rem":"3rem",s.style.height=e?"2.4rem":"3rem",s.style.display="flex",s.style.alignItems="center",s.style.justifyContent="center",s.style.cursor="pointer",s.style.pointerEvents="auto",s.style.touchAction="manipulation",s.style.transform="scale(1)",s.style.transition="transform 0.08s ease-out",a();const n=()=>{s.style.transform="scale(1)"};return s.addEventListener("pointerdown",o=>{o.stopPropagation(),s.style.transform="scale(0.9)",r.onToggle()}),s.addEventListener("pointerup",n),s.addEventListener("pointercancel",n),s.addEventListener("pointerleave",n),r.container.appendChild(s),{element:s,setMuted(o){i=o,a()},remove(){s.remove()}}}class Te{overlay=null;toggleButton=null;descriptionEl=null;highContrast=!1;vibrationIntensity="medium";motionSensitivity="strong";vibrationDescriptionEl=null;vibrationButtons=new Map;motionDescriptionEl=null;motionButtons=new Map;motionPreviewEl=null;motionPreviewTokenEl=null;motionPreviewCaptionEl=null;motionPreviewTimeoutId=null;motionPreviewFrameId=null;onToggle=null;onVibrationIntensityChange=null;onMotionSensitivityChange=null;show(t){const e=document.getElementById("ui-overlay");if(e){if(this.highContrast=t.initialHighContrast,this.vibrationIntensity=t.initialVibrationIntensity,this.motionSensitivity=t.initialMotionSensitivity,this.onToggle=t.onToggle,this.onVibrationIntensityChange=t.onVibrationIntensityChange,this.onMotionSensitivityChange=t.onMotionSensitivityChange,!this.overlay){this.overlay=document.createElement("div"),this.overlay.setAttribute("data-color-accessibility-settings",""),this.overlay.style.cssText=`
        position: absolute;
        inset: 0;
        display: flex;
        align-items: center;
      ...
      `;const o=[{value:"strong",label:"つよい"},{value:"medium",label:"ふつう"},{value:"weak",label:"やさしい"},{value:"off",label:"オフ"}];for(const c of o){const m=document.createElement("button");m.setAttribute("data-vibration-intensity-button",c.value),m.textContent=c.label,m.style.cssText=`
        ...
        gap: 0.65rem;
        margin-bottom: 0.95rem;
      `;const p=["strong","medium","gentle","minimal"];for(const c of p){const m=Q(c),E=document.createElement("button");E.setAttribute("data-motion-sensitivity-button",c),E.style.cssText=`
          display: flex;
          flex-direction: column;
          align-items: center;
          justify-content: center;
    ...
    `;const p=document.createElement("div");p.textContent="ステージ クリア かいすう",p.style.cssText=`
      ...
      font-weight: 900;
      color: #FFE66D;
    `,u.appendChild(p);const l=document.createElement("div");l.setAttribute("data-stats-stage-clears",""),l.style.cssText=`
      display: flex;
      flex-direction: column;
      gap: 0.45rem;
      text-align: left;
    `;const f=Array.from({length:D},(c,m)=>m+1).map(c=>({stageNumber:c,clearCount:i.stageClearCounts[c]??0})).filter(c=>c.clearCount>0);if(f.length===0){const c=document.createElement("div");c.textContent="まだ きろくが ないよ",c.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: ${a?"1rem":"1.1rem"};
        font-weight: 700;
        text-align: center;
        color: rgba(255, 255, 255, 0.88);
      `,l.appendChild(c)}else for(const{stageNumber:c,clearCount:m}of f){const E=ot(c),S=document.createElement("div");S.setAttribute("data-stats-stage-clear-row",String(c)),S.style.cssText=`
          display: flex;
          align-items: center;
          ...
          font-weight: 700;
        `;const w=document.createElement("span");w.textContent=`${E.emoji} ステージ ${c} ${E.destinationReading}`;const C=document.createElement("span");C.textContent=`${m}かい`,C.style.color="#FFE66D",S.append(w,C),l.appendChild(S)}u.appendChild(l),o.appendChild(u);const g=document.createElement("button");g.textContent="もどる",g.style.cssText=`
      margin-top: 1rem;
    ...
    `;const n=document.createElement("div");return n.textContent=e,n.style.cssText=`
      ...
      font-weight: 900;
      color: #FFE66D;
    `,i.append(a,n),i}}function Bt(r,t){if(!Number.isFinite(r)||r<=0||t<=0)return"ずかん";const e=Math.min(r,t);return e>=t?`ずかん ${t} / ${t} 🎉`:`ずかん ${e} / ${t}`}function Oe(r){switch(r){case"hero":return{gap:"0.35rem",label:"0.92rem",medal:"1.7rem",hint:"0.98rem"};case"compact":return{gap:"0.18rem",label:"0.7rem",medal:"1rem",hint:"0.76rem"};default:return{gap:"0.26rem",label:"0.8rem",medal:"1.25rem",hint:"0.84rem"}}}function pt(r,t,e={}){const s=Rt(r,t),i=e.size??"regular",a=Oe(i),n=document.createElement("div");if(n.setAttribute("data-stage-medal-display",""),n.setAttribute("data-stage-medal-stage",String(r)),n.setAttribute("data-stage-medal-tier",s.tier),n.setAttribute("data-stage-medal-earned",String(s.earnedCount)),e.scope&&n.setAttribute("data-stage-medal-scope",e.scope),n.style.cssText=`
    display: flex;
    flex-direction: column;
    align-items: center;
    gap: ${a.gap};
  ...
  `,n.appendChild(d),n}const kt=2e3,st=new Map,it=new Map,at=new Map;let V=null,X=null;function W(r,t){if(typeof document>"u"){const s=typeof OffscreenCanvas=="function",i=s?new OffscreenCanvas(r,t):{width:r,height:t};return{canvas:i,ctx:s?i.getContext("2d"):null}}const e=document.createElement("canvas");return e.width=r,e.height=t,{canvas:e,ctx:e.getContext("2d")}}function _(r,t){let e=st.get(r);return e||(e=t(),e.generateMipmaps=!1,e.minFilter=Ce,e.needsUpdate=!0,st.set(r,e)),e}function B(r,t){let e=it.get(r);return e||(e=t(),it.set(r,e)),e}function k(r,t){let e=at.get(r);return e||(e=t(),at.set(r,e)),e}function O(r,t){const e=new Se(r,t);return e.userData.sharedAssets=!0,e}function zt(){if(!V){const r=new yt,t=new Float32Array(kt*3);for(let e=0;e<kt*3;e+=3)t[e]=(Math.random()-.5)*200,t[e+1]=(Math.random()-.5)*200,t[e+2]=(Math.random()-.5)*400;r.setAttribute("position",new bt(t,3)),V=r}X||(X=new vt({color:16777215,size:.2,sizeAttenuation:!0}))}function Ie(){const{canvas:r,ctx:t}=W(256,256);if(!t)return new H(r);t.fillStyle="#888888",t.fillRect(0,0,256,256);for(let e=0;e<30;e++){const s=Math.random()*256,i=Math.random()*256,a=3+Math.random()*12;t.beginPath(),t.arc(s,i,a,0,Math.PI*2),t.fillStyle=`rgba(60,60,60,${.3+Math.random()*.4})`,t.fill()}return new H(r)}function Re(){const{canvas:r,ctx:t}=W(256,256);if(!t)return new H(r);t.fillStyle="#ddaa44",t.fillRect(0,0,256,256);for(let e=0;e<8;e++){t.beginPath();const s=128+(Math.random()-.5)*100,i=128+(Math.random()-.5)*100;t.strokeStyle=`rgba(200,150,60,${.3+Math.random()*.3})`,t.lineWidth=3+Math.random()*5;for(let a=0;a<Math.PI*4;a+=.1){const n=10+a*8;t.lineTo(s+Math.cos(a)*n,i+Math.sin(a)*n)}t.stroke()}return new H(r)}function De(){const{canvas:r,ctx:t}=W(256,256);if(!t)return new H(r);const e=["#cc7733","#dd9955","#bb6622","#eebb77","#aa5511","#ddaa66"];for(let s=0;s<256;s++){const i=Math.floor(s/(256/e.length))%e.length;t.fillStyle=e[i],t.fillRect(0,s,256,1)}return new H(r)}function He(){const{canvas:r,ctx:t}=W(512,256);return t?(t.fillStyle="#2266aa",t.fillRect(0,0,512,256),t.fillStyle="#886644",t.beginPath(),t.ellipse(300,80,80,40,.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(280,150,30,50,.1,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(100,90,25,60,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(110,170,20,40,-.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(420,170,25,15,0,0,Math.PI*2),t.fill(),t.fillStyle="#447733",t.beginPath(),t.ellipse(290,75,40,20,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(95,85,15,30,.2,0,Math.PI*2),t.fill(),new H(r)):new H(r)}function Le(){const{canvas:r,ctx:t}=W(512,256);if(!t)return new H(r);t.clearRect(0,0,512,256),t.fillStyle="rgba(255,255,255,0.6)";for(let e=0;e<20;e++){const s=Math.random()*512,i=Math.random()*256;t.beginPath(),t.ellipse(s,i,20+Math.random()*40,8+Math.random()*15,Math.random()*Math.PI,0,Math.PI*2),t.fill()}return new H(r)}function ze(){st.clear(),it.clear(),at.clear(),V=null,X=null}const Ge={planetTextureCache:st,planetGeometryCache:it,planetMaterialCache:at,getBgStarsGeometry:()=>V,getBgStarsMaterial:()=>X};function Gt(r,t,e){const s=new tt;let i=null;switch(r){case 2:{const a=_("mercury",Ie),n=B("mercury:sphere",()=>new R(10,24,24)),o=k("mercury:mat",()=>new P({map:a})),h=O(n,o);s.add(h),i=h;break}case 3:{const a=_("venus",Re),n=B("venus:sphere",()=>new R(14,24,24)),o=k("venus:mat",()=>new P({map:a})),h=O(n,o);s.add(h),i=h;break}case 5:{const a=_("jupiter",De),n=B("jupiter:sphere",()=>new R(20,24,24)),o=k("jupiter:mat",()=>new P({map:a})),h=O(n,o);s.add(h),i=h;break}case 6:{const a=B("saturn:sphere",()=>new R(15,24,24)),n=t.planetColor,o=k(`saturn:mat:${n}`,()=>new P({color:n})),h=O(a,o);s.add(h);const d=B("saturn:ring",()=>new Pt(20,30,48)),u=k("saturn:ringMat",()=>new P({color:15645542,side:Mt})),p=O(d,u);p.rotation.x=Math.PI/3,s.add(p),i=h;break}case 7:{const a=B("uranus:sphere",()=>new R(16,24,24)),n=k("uranus:mat",()=>new P({color:6737117})),o=O(a,n);s.add(o);const h=B("uranus:ring",()=>new Pt(21,28,48)),d=k("uranus:ringMat",()=>new P({color:10083822,side:Mt})),u=O(h,d);u.rotation.z=Math.PI/2,s.add(u),i=o;break}case 9:{const a=B("pluto:sphere",()=>new R(8,24,24)),n=k("pluto:mat",()=>new P({color:12298922})),o=O(a,n);s.add(o),i=o;break}case 10:{const a=B("sun:sphere",()=>new R(25,24,24)),n=k("sun:mat",()=>new P({color:16763904,emissive:16755200,emissiveIntensity:.5})),o=O(a,n);s.add(o),s.add(new Ee(16763904,2,200)),i=o;break}case 11:{const a=_("earth",He),n=B("earth:sphere",()=>new R(15,32,32)),o=k("earth:mat",()=>new P({map:a})),h=_("earth:cloud",Le),d=B("earth:cloudSphere",()=>new R(15.5,32,32)),u=k("earth:cloudMat",()=>new P({map:h,transparent:!0,opacity:.3})),p=new tt;p.add(O(n,o)),p.add(O(d,u)),s.add(p),i=p;break}default:{const a=B("default:sphere",()=>new R(15,24,24)),n=t.planetColor,o=k(`default:mat:${n}`,()=>new P({color:n})),h=O(a,o);s.add(h),i=h;break}}return s.position.set(0,0,e),{planet:s,spinTarget:i}}function Fe(r,t,e){return Gt(r,t,e)}function Ne(r){zt();const t=new gt(V,X);return t.userData.sharedAssets=!0,t.geometry.setDrawRange(0,r),t}function At(r){!Number.isInteger(r)||r<1||r>D||typeof document>"u"&&typeof OffscreenCanvas!="function"||(zt(),Gt(r,ot(r),0))}let U=null,Z=null;function _e(){if(!U){const r=new yt,t=new Float32Array(3e3);for(let e=0;e<3e3;e++)t[e]=(Math.random()-.5)*200;r.setAttribute("position",new bt(t,3)),U=r}return U}function $e(){return Z||(Z=new vt({color:16777215,size:.3,sizeAttenuation:!0})),Z}function je(){U=null,Z=null}const Ue={getBgStarsGeometry:()=>U,getBgStarsMaterial:()=>Z};function Ze(r){const t=window.requestIdleCallback;if(typeof t=="function"){t(r,{timeout:1500});return}window.setTimeout(r,800)}function Ft(r){return new Set(r.filter(t=>Number.isInteger(t)&&t>=1&&t<=D)).size}function qe(r){return Ft(r)>=D}function ct(r){const t=qe(r.unlockedPlanets),e=t?1:Math.min(r.clearedStage+1,D),s=ot(e),i=r.bestStageStars?.[e]??0;return t?{startStage:e,destination:s.destinationReading,emoji:s.emoji,statusLabel:"ぜんぶ あつめたよ！",destinationLabel:`${s.destinationReading}へ もういちど しゅっぱつ！`,buttonHint:`${s.emoji} ステージ ${e} から もういちど あそぶ`,bestStars:i}:{startStage:e,destination:s.destinationReading,emoji:s.emoji,statusLabel:r.clearedStage>0?"つづきから しゅっぱつ！":"はじめての しゅっぱつ！",destinationLabel:`${s.destinationReading}へ むかおう！`,buttonHint:`${s.emoji} ステージ ${e} から スタート`,bestStars:i}}function Ye(r){return r.clearedStage>0||Ft(r.unlockedPlanets)>0||Object.keys(r.bestStageStars??{}).length>0}class Ve{threeScene;ambientLight=new Et(16777215,1);camera;lastAspect=0;sceneManager;saveManager;audioManager;stars=null;companionParade=null;overlay=null;muteHandle=null;tutorialOverlay=new xt;titleResetConfirmOverlay=new Ae;colorAccessibilitySettings=new Te;spaceshipCustomizer=new Me;statsOverlay=new ke;encyclopediaOverlay=null;encyclopediaOverlayPromise=null;companionFactory=null;companionFactoryPromise=null;loadEncyclopediaOverlay;loadTitleCompanionFactory;loadingOverlay;loadFailureOverlay;scheduleIdleTask;encyclopediaBtn=null;isOpeningEncyclopedia=!1;isActive=!1;encyclopediaRequestToken=0;companionParadeRequestToken=0;bgmPending=!1;overlayButtonCleanups=new Set;constructor(t,e,s,i={}){this.sceneManager=t,this.saveManager=e,this.audioManager=s,this.loadingOverlay=i.loadingOverlay??new $t,this.loadFailureOverlay=i.loadFailureOverlay??new jt,this.scheduleIdleTask=i.scheduleIdleTask??Ze,this.loadEncyclopediaOverlay=i.loadEncyclopediaOverlay??(()=>mt(()=>import("./EncyclopediaOverlay-BUAzbyW7.js"),__vite__mapDeps([0,1,2]))),this.loadTitleCompanionFactory=i.loadTitleCompanionFactory??(()=>mt(()=>import("./game-core-WubKRDTh.js").then(o=>o.a3),__vite__mapDeps([1,2]))),this.threeScene=new et,this.threeScene.background=new St(32);const{width:a,height:n}=L();this.camera=new Ct(60,a/n,.1,1e3),this.camera.position.set(0,0,5)}enter(t){this.isActive=!0,this.encyclopediaRequestToken+=1,this.companionParadeRequestToken+=1,this.lastAspect=0,this.stars=new gt(_e(),$e()),this.stars.userData.sharedAssets=!0,this.stars.rotation.set(0,0,0),this.threeScene.add(this.stars),this.ambientLight.parent||this.threeScene.add(this.ambientLight);const e=this.saveManager.load();this.createCompanionParade(e.unlockedPlanets),this.createOverlay(),this.createMuteButton(),this.prefetchEncyclopediaOnIdle(),this.prewarmNextAdventureOnIdle(ct(e).startStage),this.audioManager.isInitialized()?(this.audioManager.playBGM(0),this.bgmPending=!1):this.bgmPending=!0,e.tutorialShown||this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide(),this.saveManager.markTutorialShown()})}createMuteButton(){const t=document.getElementById("hud")??document.getElementById("ui-overlay");t&&(this.muteHandle=wt({initialMuted:this.audioManager.isMuted(),container:t,onToggle:()=>{this.ensureTitleAudioInitialized(!0);const e=this.audioManager.toggleMute();this.muteHandle?.setMuted(e);const s=this.saveManager.load();s.muted=e,this.saveManager.save(s)}}))}getEncyclopediaOverlay(){return this.encyclopediaOverlay?Promise.resolve(this.encyclopediaOverlay):this.encyclopediaOverlayPromise?this.encyclopediaOverlayPromise:(this.encyclopediaOverlayPromise=this.loadEncyclopediaOverlay().then(({EncyclopediaOverlay:t})=>{const e=new t;return this.encyclopediaOverlay=e,e}).finally(()=>{this.encyclopediaOverlayPromise=null}),this.encyclopediaOverlayPromise)}getTitleCompanionFactory(){return this.companionFactory?Promise.resolve(this.companionFactory):this.companionFactoryPromise?this.companionFactoryPromise:(this.companionFactoryPromise=this.loadTitleCompanionFactory().then(t=>(this.companionFactory=t,t)).finally(()=>{this.companionFactoryPromise=null}),this.companionFactoryPromise)}showEncyclopedia(){if(!this.isActive||!this.encyclopediaOverlay)return;const t=this.saveManager.load();this.encyclopediaOverlay.show(t.unlockedPlanets,()=>this.refreshEncyclopediaButtonLabel(),e=>{this.ensureTitleAudioInitialized(!1),this.sceneManager.requestTransition("stage",{stageNumber:e,totalScore:0,totalStarCount:0,launchSource:"encyclopedia"})},t.bestStageStars??{},t.discoveredConstellations??[])}isCurrentEncyclopediaRequest(t){return this.isActive&&this.encyclopediaRequestToken===t}prefetchEncyclopediaOnIdle(){const t=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{!this.isCurrentEncyclopediaRequest(t)||this.encyclopediaOverlay||this.encyclopediaOverlayPromise||this.getEncyclopediaOverlay().catch(()=>{})})}prewarmNextAdventureOnIdle(t){if(t>D)return;const e=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{this.isCurrentEncyclopediaRequest(e)&&At(t)})}async openEncyclopedia(){if(!this.isActive)return;if(this.loadFailureOverlay.hide(),this.encyclopediaOverlay){this.showEncyclopedia();return}if(this.isOpeningEncyclopedia)return;const t=this.encyclopediaRequestToken;this.isOpeningEncyclopedia=!0,this.loadingOverlay.show("ずかんを よんでるよ...");try{if(await this.getEncyclopediaOverlay(),!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),this.showEncyclopedia()}catch(e){if(!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),console.error("Failed to load encyclopedia overlay",e),this.loadFailureOverlay.show({title:"ずかんを もういちど よんでみよう！",message:"「もういちど よむ」を おして つづきを たのしもう！",primaryAction:{label:"もういちど よむ",onSelect:()=>this.openEncyclopedia()}})}finally{this.encyclopediaRequestToken===t&&(this.isOpeningEncyclopedia=!1)}}persistHighContrastSetting(t){const e=this.saveManager.load(),s=e.colorAccessibility?.motionSensitivity??F;e.colorAccessibility=this.buildColorAccessibilitySettings(t,s),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}persistVibrationIntensitySetting(t){const e=this.saveManager.load();e.vibrationSettings={intensity:t},this.saveManager.save(e),Dt(t)}persistMotionSensitivitySetting(t){const e=this.saveManager.load(),s=e.colorAccessibility?.highContrast===!0;e.colorAccessibility=this.buildColorAccessibilitySettings(s,t),e.colorAccessibility||delete e.colorAccessibility,this.saveManager.save(e)}buildColorAccessibilitySettings(t,e){if(!(!t&&e===F))return{...t?{highContrast:!0}:{},...e!==F?{motionSensitivity:e}:{}}}createOverlay(){const t=document.getElementById("ui-overlay");if(!t)return;const e=this.saveManager.load(),s=ct(e);this.overlay=document.createElement("div"),this.overlay.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      justify-content: center;
    ...
    `;const u=document.createElement("div");u.textContent=s.destinationLabel,u.style.cssText=`
      ...
      font-weight: 700;
      color: rgba(255, 255, 255, 0.92);
    `;const p=Rt(s.startStage,s.bestStars),l=pt(s.startStage,s.bestStars,{label:"メダル",hint:p.nextThreshold===null?"かんぺき！":`${p.icon} いま ・ つぎ ⭐ ${p.nextThreshold}`,size:"regular",scope:"title-next-adventure"});l.style.marginTop="0.7rem",n.appendChild(o),n.appendChild(h),n.appendChild(d),n.appendChild(u),n.appendChild(l);const f=document.createElement("div");f.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      gap: 0.65rem;
    `;const g=document.createElement("button");g.textContent="あそぶ",g.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(T(g,{onActivate:()=>{this.ensureTitleAudioInitialized(!1);const b=this.saveManager.load(),A=ct(b).startStage;this.sceneManager.requestTransition("stage",{stageNumber:A,totalScore:0,totalStarCount:0,launchSource:"campaign"})},onPressChange:b=>{g.style.transform=b?"scale(0.96)":"scale(1)"}}));const c=document.createElement("div");c.setAttribute("data-play-button-hint",""),c.textContent=s.buttonHint,c.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${i?"0.85rem":"1rem"};
      font-weight: 700;
      color: rgba(255, 255, 255, 0.88);
      text-shadow: 0 2px 10px rgba(0, 0, 0, 0.35);
    `;const m=document.createElement("button");m.setAttribute("data-spaceship-customizer-button",""),m.textContent="うちゅうせんをかざろう",m.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: ${i?"1rem":"1.25rem"};
      font-weight: 900;
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,this.overlayButtonCleanups.add(T(m,{onActivate:()=>{const b=this.saveManager.load();this.spaceshipCustomizer.show({initialCustomization:b.spaceshipCustomization??ft,onComplete:A=>{const v=this.saveManager.load();v.spaceshipCustomization=A,this.saveManager.save(v)}})},onPressChange:b=>{m.style.transform=b?"scale(0.96)":"scale(1)"}}));const E=document.createElement("button");E.setAttribute("data-stats-button",""),E.textContent="あそびの きろく",E.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
    ...
    `,this.overlayButtonCleanups.add(T(w,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.colorAccessibilitySettings.show({initialHighContrast:this.saveManager.load().colorAccessibility?.highContrast===!0,initialVibrationIntensity:this.saveManager.load().vibrationSettings?.intensity??"medium",initialMotionSensitivity:this.saveManager.load().colorAccessibility?.motionSensitivity??F,onToggle:b=>this.persistHighContrastSetting(b),onVibrationIntensityChange:b=>this.persistVibrationIntensitySetting(b),onMotionSensitivityChange:b=>this.persistMotionSensitivitySetting(b)})},onPressChange:b=>{w.style.transform=b?"translateX(-50%) scale(0.96)":"translateX(-50%) scale(1)"}}));const C=document.createElement("button");if(C.textContent=Bt(e.unlockedPlanets.length,j.length),C.style.cssText=`
      ...
      transform: scale(1);
      transition: transform 0.08s ease-out;
    `,C.style.position="absolute",C.style.bottom=i?"1rem":"2rem",C.style.left=i?"1rem":"2rem",this.encyclopediaBtn=C,this.overlayButtonCleanups.add(T(C,{onActivate:()=>{this.ensureTitleAudioInitialized(!0),this.openEncyclopedia()},onPressChange:b=>{C.style.transform=b?"scale(0.96)":"scale(1)"}})),f.appendChild(g),f.appendChild(c),f.appendChild(m),f.appendChild(E),Ye(e)){const b=document.createElement("button");b.setAttribute("data-reset-progress-button",""),b.textContent="さいしょから",b.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
        font-size: 1.15rem;
        font-weight: 900;
    ...
    `,o.appendChild(d);const u=`
      ...
      transition: transform 0.08s ease-out;
      white-space: nowrap;
    `,p=(g,c)=>{const m=T(g,{onActivate:c,onPressChange:E=>{g.style.transform=E?"scale(0.9)":"scale(1)"}});this.activePressCleanups.add(m)},l=document.createElement("button");l.setAttribute("data-home-confirm-back",""),l.setAttribute("aria-label","タイトルへ もどる"),l.textContent="🏠 タイトルへ もどる",l.style.cssText=u,l.style.fontFamily="'Zen Maru Gothic', sans-serif",l.style.background="rgba(255, 255, 255, 0.18)",l.style.color="#ffffff",l.style.minWidth="88px",l.style.minHeight="88px",l.style.touchAction="manipulation",l.style.transform="scale(1)",l.style.transition="transform 0.08s ease-out",l.style.whiteSpace="nowrap",p(l,n),d.appendChild(l);const f=document.createElement("button");f.setAttribute("data-home-confirm-continue",""),f.setAttribute("aria-label","つづける"),f.textContent="✋ つづける",f.style.cssText=u,f.style.fontFamily="'Zen Maru Gothic', sans-serif",f.style.background="linear-gradient(135deg, #FF6B6B, #FFE66D)",f.style.color="#FFD700",f.style.textShadow="0 1px 2px rgba(0, 0, 32, 0.6)",f.style.minWidth="88px",f.style.minHeight="88px",f.style.touchAction="manipulation",f.style.transform="scale(1)",f.style.transition="transform 0.08s ease-out",f.style.whiteSpace="nowrap",p(f,a),d.appendChild(f),s.appendChild(this.overlayEl)}hide(){if(this.overlayEl){const t=Array.from(this.activePressCleanups);this.activePressCleanups.clear();for(const e of t)e();this.overlayEl.remove(),this.overlayEl=null}}isVisible(){return this.overlayEl!==null}}class Nt{overlayEl=null;activePressCleanups=new Set;show(t,e){if(this.overlayEl)return;const s=document.getElementById("ui-overlay")??document.body;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-pause-overlay",""),this.overlayEl.setAttribute("role","dialog"),this.overlayEl.setAttribute("aria-modal","true"),this.overlayEl.setAttribute("aria-label","やすみちゅう"),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
    ...
    `,i.appendChild(n);const o=document.createElement("div");o.style.cssText=`
      ...
      align-items: stretch;
      width: 100%;
    `,i.appendChild(o);const h=(d,u,p,l,f,g)=>{const c=document.createElement("button");c.setAttribute(u,""),c.setAttribute("aria-label",p),c.textContent=d,c.style.cssText=`
        flex: 1 1 140px;
        padding: 1rem 1.2rem;
        border: none;
        border-radius: 1.6rem;
    ...
    `,document.head.appendChild(t)}}const Ke=1,Je=.4;class Ot{overlayEl=null;numberEl=null;phase="idle";elapsed=0;currentStep=0;stepDuration;goDuration;onTick;onGo;onComplete=null;steps=["3","2","1"];constructor(t={}){this.stepDuration=t.stepDuration??Ke,this.goDuration=t.goDuration??Je,this.onTick=t.onTick,this.onGo=t.onGo}show(t){if(this.phase!=="idle"&&this.phase!=="done")return;const e=document.getElementById("ui-overlay")??document.body;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-countdown-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
