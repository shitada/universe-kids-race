const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-CoT-85xk.js","assets/game-core-e__JXguG.js","assets/three-Bl4lg4Xh.js"])))=>i.map(i=>d[i]);
import{g as Ct,T as I,a as nt,L as Pt,b as Ot,_ as it,c as L,d as X,P as N,u as Rt,C as It,S as kt,e as Dt,B as Ht,f as Lt,h as _t,A as Gt,i as xt,j as Ft,k as Nt,l as tt,m as zt,s as $t,n as jt}from"./game-core-e__JXguG.js";import{i as ot,g as rt,f as lt,h as ht,G as V,m as Ut,M as qt,n as Yt,a as w,j as P,l as gt,R as yt,o as O,p as ct,q as W,e as ut,P as dt,V as St,r as Zt}from"./three-Bl4lg4Xh.js";class mt{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const e=document.getElementById("ui-overlay");if(!e)return;const s=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
