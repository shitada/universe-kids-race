const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EncyclopediaOverlay-BBVFU9Ib.js","assets/game-core-JM0zEBMC.js","assets/three-CHPsZt9E.js"])))=>i.map(i=>d[i]);
import{D as lt,S as z,T as D,g as et,a as wt,L as It,b as kt,_ as ot,c as G,d as V,P as N,u as Dt,C as Ht,e as Lt,f as Gt,B as zt,h as Ft,i as _t,A as Nt,j as $t,k as jt,l as At,m as Ut,n as Zt,o as st,t as it,p as qt,s as Yt,q as Xt}from"./game-core-JM0zEBMC.js";import{m as ht,k as ct,i as dt,l as ut,G as W,n as Vt,a as Wt,o as Qt,M as B,g as k,D as vt,R as Ct,p as H,q as mt,r as Q,h as pt,P as ft,V as Tt,s as Kt}from"./three-CHPsZt9E.js";class gt{overlayEl=null;static COMPACT_HEIGHT_THRESHOLD=720;show(t){if(this.overlayEl)return;const s=document.getElementById("ui-overlay");if(!s)return;const e=this.isCompactHeight();this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-tutorial-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
    ...
    `;const o=document.createElement("div");return o.textContent=s,o.style.cssText=`
      ...
      font-weight: 900;
      color: #FFE66D;
    `,i.append(a,o),i}}function xt(r,t){if(!Number.isFinite(r)||r<=0||t<=0)return"ずかん";const s=Math.min(r,t);return s>=t?`ずかん ${t} / ${t} 🎉`:`ずかん ${s} / ${t}`}function ne(r){switch(r){case"hero":return{gap:"0.35rem",label:"0.92rem",medal:"1.7rem",hint:"0.98rem"};case"compact":return{gap:"0.18rem",label:"0.7rem",medal:"1rem",hint:"0.76rem"};default:return{gap:"0.26rem",label:"0.8rem",medal:"1.25rem",hint:"0.84rem"}}}function rt(r,t,s={}){const e=wt(r,t),i=s.size??"regular",a=ne(i),o=document.createElement("div");if(o.setAttribute("data-stage-medal-display",""),o.setAttribute("data-stage-medal-stage",String(r)),o.setAttribute("data-stage-medal-tier",e.tier),o.setAttribute("data-stage-medal-earned",String(e.earnedCount)),s.scope&&o.setAttribute("data-stage-medal-scope",s.scope),o.style.cssText=`
    display: flex;
    flex-direction: column;
    align-items: center;
    gap: ${a.gap};
  ...
  `,o.appendChild(l),o}const Et=2e3,K=new Map,J=new Map,tt=new Map;let q=null,Y=null;function X(r,t){if(typeof document>"u"){const e=typeof OffscreenCanvas=="function",i=e?new OffscreenCanvas(r,t):{width:r,height:t};return{canvas:i,ctx:e?i.getContext("2d"):null}}const s=document.createElement("canvas");return s.width=r,s.height=t,{canvas:s,ctx:s.getContext("2d")}}function _(r,t){let s=K.get(r);return s||(s=t(),s.generateMipmaps=!1,s.minFilter=Qt,s.needsUpdate=!0,K.set(r,s)),s}function P(r,t){let s=J.get(r);return s||(s=t(),J.set(r,s)),s}function O(r,t){let s=tt.get(r);return s||(s=t(),tt.set(r,s)),s}function R(r,t){const s=new Wt(r,t);return s.userData.sharedAssets=!0,s}function Mt(){if(!q){const r=new ct,t=new Float32Array(Et*3);for(let s=0;s<Et*3;s+=3)t[s]=(Math.random()-.5)*200,t[s+1]=(Math.random()-.5)*200,t[s+2]=(Math.random()-.5)*400;r.setAttribute("position",new dt(t,3)),q=r}Y||(Y=new ut({color:16777215,size:.2,sizeAttenuation:!0}))}function oe(){const{canvas:r,ctx:t}=X(256,256);if(!t)return new H(r);t.fillStyle="#888888",t.fillRect(0,0,256,256);for(let s=0;s<30;s++){const e=Math.random()*256,i=Math.random()*256,a=3+Math.random()*12;t.beginPath(),t.arc(e,i,a,0,Math.PI*2),t.fillStyle=`rgba(60,60,60,${.3+Math.random()*.4})`,t.fill()}return new H(r)}function re(){const{canvas:r,ctx:t}=X(256,256);if(!t)return new H(r);t.fillStyle="#ddaa44",t.fillRect(0,0,256,256);for(let s=0;s<8;s++){t.beginPath();const e=128+(Math.random()-.5)*100,i=128+(Math.random()-.5)*100;t.strokeStyle=`rgba(200,150,60,${.3+Math.random()*.3})`,t.lineWidth=3+Math.random()*5;for(let a=0;a<Math.PI*4;a+=.1){const o=10+a*8;t.lineTo(e+Math.cos(a)*o,i+Math.sin(a)*o)}t.stroke()}return new H(r)}function le(){const{canvas:r,ctx:t}=X(256,256);if(!t)return new H(r);const s=["#cc7733","#dd9955","#bb6622","#eebb77","#aa5511","#ddaa66"];for(let e=0;e<256;e++){const i=Math.floor(e/(256/s.length))%s.length;t.fillStyle=s[i],t.fillRect(0,e,256,1)}return new H(r)}function he(){const{canvas:r,ctx:t}=X(512,256);return t?(t.fillStyle="#2266aa",t.fillRect(0,0,512,256),t.fillStyle="#886644",t.beginPath(),t.ellipse(300,80,80,40,.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(280,150,30,50,.1,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(100,90,25,60,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(110,170,20,40,-.2,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(420,170,25,15,0,0,Math.PI*2),t.fill(),t.fillStyle="#447733",t.beginPath(),t.ellipse(290,75,40,20,.3,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(95,85,15,30,.2,0,Math.PI*2),t.fill(),new H(r)):new H(r)}function ce(){const{canvas:r,ctx:t}=X(512,256);if(!t)return new H(r);t.clearRect(0,0,512,256),t.fillStyle="rgba(255,255,255,0.6)";for(let s=0;s<20;s++){const e=Math.random()*512,i=Math.random()*256;t.beginPath(),t.ellipse(e,i,20+Math.random()*40,8+Math.random()*15,Math.random()*Math.PI,0,Math.PI*2),t.fill()}return new H(r)}function de(){K.clear(),J.clear(),tt.clear(),q=null,Y=null}const ue={planetTextureCache:K,planetGeometryCache:J,planetMaterialCache:tt,getBgStarsGeometry:()=>q,getBgStarsMaterial:()=>Y};function Bt(r,t,s){const e=new W;let i=null;switch(r){case 2:{const a=_("mercury",oe),o=P("mercury:sphere",()=>new k(10,24,24)),n=O("mercury:mat",()=>new B({map:a})),h=R(o,n);e.add(h),i=h;break}case 3:{const a=_("venus",re),o=P("venus:sphere",()=>new k(14,24,24)),n=O("venus:mat",()=>new B({map:a})),h=R(o,n);e.add(h),i=h;break}case 5:{const a=_("jupiter",le),o=P("jupiter:sphere",()=>new k(20,24,24)),n=O("jupiter:mat",()=>new B({map:a})),h=R(o,n);e.add(h),i=h;break}case 6:{const a=P("saturn:sphere",()=>new k(15,24,24)),o=t.planetColor,n=O(`saturn:mat:${o}`,()=>new B({color:o})),h=R(a,n);e.add(h);const l=P("saturn:ring",()=>new Ct(20,30,48)),u=O("saturn:ringMat",()=>new B({color:15645542,side:vt})),p=R(l,u);p.rotation.x=Math.PI/3,e.add(p),i=h;break}case 7:{const a=P("uranus:sphere",()=>new k(16,24,24)),o=O("uranus:mat",()=>new B({color:6737117})),n=R(a,o);e.add(n);const h=P("uranus:ring",()=>new Ct(21,28,48)),l=O("uranus:ringMat",()=>new B({color:10083822,side:vt})),u=R(h,l);u.rotation.z=Math.PI/2,e.add(u),i=n;break}case 9:{const a=P("pluto:sphere",()=>new k(8,24,24)),o=O("pluto:mat",()=>new B({color:12298922})),n=R(a,o);e.add(n),i=n;break}case 10:{const a=P("sun:sphere",()=>new k(25,24,24)),o=O("sun:mat",()=>new B({color:16763904,emissive:16755200,emissiveIntensity:.5})),n=R(a,o);e.add(n),e.add(new Vt(16763904,2,200)),i=n;break}case 11:{const a=_("earth",he),o=P("earth:sphere",()=>new k(15,32,32)),n=O("earth:mat",()=>new B({map:a})),h=_("earth:cloud",ce),l=P("earth:cloudSphere",()=>new k(15.5,32,32)),u=O("earth:cloudMat",()=>new B({map:h,transparent:!0,opacity:.3})),p=new W;p.add(R(o,n)),p.add(R(l,u)),e.add(p),i=p;break}default:{const a=P("default:sphere",()=>new k(15,24,24)),o=t.planetColor,n=O(`default:mat:${o}`,()=>new B({color:o})),h=R(a,n);e.add(h),i=h;break}}return e.position.set(0,0,s),{planet:e,spinTarget:i}}function me(r,t,s){return Bt(r,t,s)}function pe(r){Mt();const t=new ht(q,Y);return t.userData.sharedAssets=!0,t.geometry.setDrawRange(0,r),t}function bt(r){!Number.isInteger(r)||r<1||r>D||typeof document>"u"&&typeof OffscreenCanvas!="function"||(Mt(),Bt(r,et(r),0))}let $=null,j=null;function fe(){if(!$){const r=new ct,t=new Float32Array(3e3);for(let s=0;s<3e3;s++)t[s]=(Math.random()-.5)*200;r.setAttribute("position",new dt(t,3)),$=r}return $}function ge(){return j||(j=new ut({color:16777215,size:.3,sizeAttenuation:!0})),j}function ye(){$=null,j=null}const be={getBgStarsGeometry:()=>$,getBgStarsMaterial:()=>j};function ve(r){const t=window.requestIdleCallback;if(typeof t=="function"){t(r,{timeout:1500});return}window.setTimeout(r,800)}function Pt(r){return new Set(r.filter(t=>Number.isInteger(t)&&t>=1&&t<=D)).size}function Ce(r){return Pt(r)>=D}function at(r){const t=Ce(r.unlockedPlanets),s=t?1:Math.min(r.clearedStage+1,D),e=et(s),i=r.bestStageStars?.[s]??0;return t?{startStage:s,destination:e.destinationReading,emoji:e.emoji,statusLabel:"ぜんぶ あつめたよ！",destinationLabel:`${e.destinationReading}へ もういちど しゅっぱつ！`,buttonHint:`${e.emoji} ステージ ${s} から もういちど あそぶ`,bestStars:i}:{startStage:s,destination:e.destinationReading,emoji:e.emoji,statusLabel:r.clearedStage>0?"つづきから しゅっぱつ！":"はじめての しゅっぱつ！",destinationLabel:`${e.destinationReading}へ むかおう！`,buttonHint:`${e.emoji} ステージ ${s} から スタート`,bestStars:i}}function xe(r){return r.clearedStage>0||Pt(r.unlockedPlanets)>0||Object.keys(r.bestStageStars??{}).length>0}class Ee{threeScene;ambientLight=new mt(16777215,1);camera;lastAspect=0;sceneManager;saveManager;audioManager;stars=null;companionParade=null;overlay=null;muteHandle=null;tutorialOverlay=new gt;titleResetConfirmOverlay=new Jt;colorAccessibilitySettings=new te;spaceshipCustomizer=new ee;statsOverlay=new ae;encyclopediaOverlay=null;encyclopediaOverlayPromise=null;companionFactory=null;companionFactoryPromise=null;loadEncyclopediaOverlay;loadTitleCompanionFactory;loadingOverlay;loadFailureOverlay;scheduleIdleTask;encyclopediaBtn=null;isOpeningEncyclopedia=!1;isActive=!1;encyclopediaRequestToken=0;companionParadeRequestToken=0;bgmPending=!1;overlayButtonCleanups=new Set;constructor(t,s,e,i={}){this.sceneManager=t,this.saveManager=s,this.audioManager=e,this.loadingOverlay=i.loadingOverlay??new It,this.loadFailureOverlay=i.loadFailureOverlay??new kt,this.scheduleIdleTask=i.scheduleIdleTask??ve,this.loadEncyclopediaOverlay=i.loadEncyclopediaOverlay??(()=>ot(()=>import("./EncyclopediaOverlay-BBVFU9Ib.js"),__vite__mapDeps([0,1,2]))),this.loadTitleCompanionFactory=i.loadTitleCompanionFactory??(()=>ot(()=>import("./game-core-JM0zEBMC.js").then(n=>n.z),__vite__mapDeps([1,2]))),this.threeScene=new Q,this.threeScene.background=new pt(32);const{width:a,height:o}=G();this.camera=new ft(60,a/o,.1,1e3),this.camera.position.set(0,0,5)}enter(t){this.isActive=!0,this.encyclopediaRequestToken+=1,this.companionParadeRequestToken+=1,this.lastAspect=0,this.stars=new ht(fe(),ge()),this.stars.userData.sharedAssets=!0,this.stars.rotation.set(0,0,0),this.threeScene.add(this.stars),this.ambientLight.parent||this.threeScene.add(this.ambientLight);const s=this.saveManager.load();this.createCompanionParade(s.unlockedPlanets),this.createOverlay(),this.createMuteButton(),this.prefetchEncyclopediaOnIdle(),this.prewarmNextAdventureOnIdle(at(s).startStage),this.audioManager.isInitialized()?(this.audioManager.playBGM(0),this.bgmPending=!1):this.bgmPending=!0,s.tutorialShown||this.tutorialOverlay.show(()=>{this.ensureTitleAudioInitialized(!0),this.tutorialOverlay.hide(),this.saveManager.markTutorialShown()})}createMuteButton(){const t=document.getElementById("hud")??document.getElementById("ui-overlay");t&&(this.muteHandle=yt({initialMuted:this.audioManager.isMuted(),container:t,onToggle:()=>{this.ensureTitleAudioInitialized(!0);const s=this.audioManager.toggleMute();this.muteHandle?.setMuted(s);const e=this.saveManager.load();e.muted=s,this.saveManager.save(e)}}))}getEncyclopediaOverlay(){return this.encyclopediaOverlay?Promise.resolve(this.encyclopediaOverlay):this.encyclopediaOverlayPromise?this.encyclopediaOverlayPromise:(this.encyclopediaOverlayPromise=this.loadEncyclopediaOverlay().then(({EncyclopediaOverlay:t})=>{const s=new t;return this.encyclopediaOverlay=s,s}).finally(()=>{this.encyclopediaOverlayPromise=null}),this.encyclopediaOverlayPromise)}getTitleCompanionFactory(){return this.companionFactory?Promise.resolve(this.companionFactory):this.companionFactoryPromise?this.companionFactoryPromise:(this.companionFactoryPromise=this.loadTitleCompanionFactory().then(t=>(this.companionFactory=t,t)).finally(()=>{this.companionFactoryPromise=null}),this.companionFactoryPromise)}showEncyclopedia(){if(!this.isActive||!this.encyclopediaOverlay)return;const t=this.saveManager.load();this.encyclopediaOverlay.show(t.unlockedPlanets,()=>this.refreshEncyclopediaButtonLabel(),s=>{this.ensureTitleAudioInitialized(!1),this.sceneManager.requestTransition("stage",{stageNumber:s,totalScore:0,totalStarCount:0,launchSource:"encyclopedia"})},t.bestStageStars??{})}isCurrentEncyclopediaRequest(t){return this.isActive&&this.encyclopediaRequestToken===t}prefetchEncyclopediaOnIdle(){const t=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{!this.isCurrentEncyclopediaRequest(t)||this.encyclopediaOverlay||this.encyclopediaOverlayPromise||this.getEncyclopediaOverlay().catch(()=>{})})}prewarmNextAdventureOnIdle(t){if(t>D)return;const s=this.encyclopediaRequestToken;this.scheduleIdleTask(()=>{this.isCurrentEncyclopediaRequest(s)&&bt(t)})}async openEncyclopedia(){if(!this.isActive)return;if(this.loadFailureOverlay.hide(),this.encyclopediaOverlay){this.showEncyclopedia();return}if(this.isOpeningEncyclopedia)return;const t=this.encyclopediaRequestToken;this.isOpeningEncyclopedia=!0,this.loadingOverlay.show("ずかんを よんでるよ...");try{if(await this.getEncyclopediaOverlay(),!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),this.showEncyclopedia()}catch(s){if(!this.isCurrentEncyclopediaRequest(t))return;this.loadingOverlay.hide(),console.error("Failed to load encyclopedia overlay",s),this.loadFailureOverlay.show({title:"ずかんの じゅんびが できなかったよ",message:"「もういちど よむ」を おしてね",primaryAction:{label:"もういちど よむ",onSelect:()=>this.openEncyclopedia()}})}finally{this.encyclopediaRequestToken===t&&(this.isOpeningEncyclopedia=!1)}}persistHighContrastSetting(t){const s=this.saveManager.load();t?s.colorAccessibility={highContrast:!0}:delete s.colorAccessibility,this.saveManager.save(s)}createOverlay(){const t=document.getElementById("ui-overlay");if(!t)return;const s=this.saveManager.load(),e=at(s);this.overlay=document.createElement("div"),this.overlay.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: center;
      justify-content: center;
    ...
    `,document.head.appendChild(t)}}const Te=1,Me=.4;class St{overlayEl=null;numberEl=null;phase="idle";elapsed=0;currentStep=0;stepDuration;goDuration;onTick;onGo;onComplete=null;steps=["3","2","1"];constructor(t={}){this.stepDuration=t.stepDuration??Te,this.goDuration=t.goDuration??Me,this.onTick=t.onTick,this.onGo=t.onGo}show(t){if(this.phase!=="idle"&&this.phase!=="done")return;const s=document.getElementById("ui-overlay")??document.body;this.overlayEl=document.createElement("div"),this.overlayEl.setAttribute("data-countdown-overlay",""),this.overlayEl.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
